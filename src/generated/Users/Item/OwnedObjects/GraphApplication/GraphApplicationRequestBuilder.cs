...
using ApiSdk.Models;
using ApiSdk.Users.Item.OwnedObjects.GraphApplication.Count;
...
using System;
namespace ApiSdk.Users.Item.OwnedObjects.GraphApplication {
    /// <summary>
    ...
    public class GraphApplicationRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public GraphApplicationRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/ownedObjects/graph.application{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="GraphApplicationRequestBuilder"/> and sets the default values.
        ...
        public GraphApplicationRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/ownedObjects/graph.application{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get the items of type microsoft.graph.application in the microsoft.graph.directoryObject collection
