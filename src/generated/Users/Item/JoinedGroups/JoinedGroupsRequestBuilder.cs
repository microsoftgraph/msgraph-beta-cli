...
namespace ApiSdk.Users.Item.JoinedGroups {
    ...
    /// </summary>
    public class JoinedGroupsRequestBuilder : BaseCliRequestBuilder 
    {
        /// <summary>
        ...
        public JoinedGroupsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/joinedGroups{?%24count,%24filter,%24orderby,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="JoinedGroupsRequestBuilder"/> and sets the default values.
        ...
        public JoinedGroupsRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/joinedGroups{?%24count,%24filter,%24orderby,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get joinedGroups from users
