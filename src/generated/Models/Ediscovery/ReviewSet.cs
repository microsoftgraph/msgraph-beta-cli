...
namespace ApiSdk.Models.Ediscovery
{
    ...
    public partial class ReviewSet : global::ApiSdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.Ediscovery.ReviewSetQuery>? Queries { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.Ediscovery.ReviewSetQuery> Queries { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.Ediscovery.ReviewSet"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.Ediscovery.ReviewSet CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.Ediscovery.ReviewSet();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "queries", n => { Queries = n.GetCollectionOfObjectValues<global::ApiSdk.Models.Ediscovery.ReviewSetQuery>(global::ApiSdk.Models.Ediscovery.ReviewSetQuery.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.Ediscovery.ReviewSetQuery>("queries", Queries);
        }
    }
}
