...
namespace ApiSdk.DeviceManagement.VirtualEndpoint.UserSettings.Item
{
    ...
    public class CloudPcUserSettingItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAssignmentsNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.VirtualEndpoint.UserSettings.Item.Assignments.AssignmentsRequestBuilder(PathParameters);
        ...
        public Command BuildAssignNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.VirtualEndpoint.UserSettings.Item.Assign.AssignRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceManagement.VirtualEndpoint.UserSettings.Item.CloudPcUserSettingItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceManagement.VirtualEndpoint.UserSettings.Item.CloudPcUserSettingItemRequestBuilder.CloudPcUserSettingItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceManagement.VirtualEndpoint.UserSettings.Item.CloudPcUserSettingItemRequestBuilder.CloudPcUserSettingItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.CloudPcUserSetting body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.CloudPcUserSetting body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
