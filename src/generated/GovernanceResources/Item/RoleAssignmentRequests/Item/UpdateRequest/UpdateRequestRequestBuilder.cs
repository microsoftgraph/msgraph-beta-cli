    ...
    public class UpdateRequestRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.UpdateRequest.UpdateRequestPostRequestBody>(ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.UpdateRequest.UpdateRequestPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.UpdateRequest.UpdateRequestRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.UpdateRequest.UpdateRequestPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.UpdateRequest.UpdateRequestPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
