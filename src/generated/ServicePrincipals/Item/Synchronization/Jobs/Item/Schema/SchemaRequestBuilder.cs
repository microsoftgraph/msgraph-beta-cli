...
namespace ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Schema
{
    ...
    public class SchemaRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDirectoriesNavCommand()
        {
            ...
            var builder = new ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Schema.Directories.DirectoriesRequestBuilder(PathParameters);
        ...
        public Command BuildFilterOperatorsNavCommand()
        {
            ...
            var builder = new ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Schema.FilterOperators.FilterOperatorsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildFunctionsNavCommand()
        {
            ...
            var builder = new ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Schema.Functions.FunctionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildParseExpressionNavCommand()
        {
            ...
            var builder = new ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Schema.ParseExpression.ParseExpressionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Schema.SchemaRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Schema.SchemaRequestBuilder.SchemaRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Schema.SchemaRequestBuilder.SchemaRequestBuilderGetQueryParameters>> requestConfiguration = default)
