...
#nullable enable
        public List<AttackSimulationRepeatOffender>? Value { get; set; }
#nullable restore
#else
        public List<AttackSimulationRepeatOffender> Value { get; set; }
#endif
        ...
        public static new GetAttackSimulationRepeatOffendersGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new GetAttackSimulationRepeatOffendersGetResponse();
        }
        /// <summary>
