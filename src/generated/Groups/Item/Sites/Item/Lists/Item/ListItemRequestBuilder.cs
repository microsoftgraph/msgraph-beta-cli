...
namespace ApiSdk.Groups.Item.Sites.Item.Lists.Item
{
    ...
    public class ListItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildActivitiesNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.Lists.Item.Activities.ActivitiesRequestBuilder(PathParameters);
        ...
        public Command BuildColumnsNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.Lists.Item.Columns.ColumnsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildContentTypesNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.Lists.Item.ContentTypes.ContentTypesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildCreatedByUserNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.Lists.Item.CreatedByUser.CreatedByUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildDriveNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.Lists.Item.Drive.DriveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildItemsNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.Lists.Item.Items.ItemsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildLastModifiedByUserNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.Lists.Item.LastModifiedByUser.LastModifiedByUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            nonExecCommands.Add(builder.BuildMailboxSettingsNavCommand());
        ...
        public Command BuildOperationsNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.Lists.Item.Operations.OperationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildSubscriptionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.Lists.Item.Subscriptions.SubscriptionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.Sites.Item.Lists.Item.ListItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.Sites.Item.Lists.Item.ListItemRequestBuilder.ListItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.Sites.Item.Lists.Item.ListItemRequestBuilder.ListItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
