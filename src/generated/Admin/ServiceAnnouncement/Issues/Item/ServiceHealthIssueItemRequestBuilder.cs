...
namespace ApiSdk.Admin.ServiceAnnouncement.Issues.Item
{
    ...
    public class ServiceHealthIssueItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildIncidentReportNavCommand()
        {
            ...
            var builder = new ApiSdk.Admin.ServiceAnnouncement.Issues.Item.IncidentReport.IncidentReportRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Admin.ServiceAnnouncement.Issues.Item.ServiceHealthIssueItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public ServiceHealthIssueItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/admin/serviceAnnouncement/issues/{serviceHealthIssue%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Admin.ServiceAnnouncement.Issues.Item.ServiceHealthIssueItemRequestBuilder"/> and sets the default values.
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Admin.ServiceAnnouncement.Issues.Item.ServiceHealthIssueItemRequestBuilder.ServiceHealthIssueItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Admin.ServiceAnnouncement.Issues.Item.ServiceHealthIssueItemRequestBuilder.ServiceHealthIssueItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.ServiceHealthIssue body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.ServiceHealthIssue body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
