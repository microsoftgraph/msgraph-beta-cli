...
namespace ApiSdk.Models.Security
{
    ...
    public class AllowFileResponseAction : ApiSdk.Models.Security.ResponseAction, IParsable
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.Security.AllowFileResponseAction"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.Security.AllowFileResponseAction"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.Security.AllowFileResponseAction CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.Security.AllowFileResponseAction();
        }
        /// <summary>
