...
namespace ApiSdk.DeviceManagement.VirtualEndpoint.Reports
{
    ...
    public partial class ReportsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGetSharedUseLicenseUsageReportNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.GetSharedUseLicenseUsageReport.GetSharedUseLicenseUsageReportRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
