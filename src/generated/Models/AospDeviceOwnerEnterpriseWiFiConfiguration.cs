...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class AospDeviceOwnerEnterpriseWiFiConfiguration : ApiSdk.Models.AospDeviceOwnerWiFiConfiguration, IParsable
    {
...
#nullable enable
        public ApiSdk.Models.AospDeviceOwnerCertificateProfileBase? IdentityCertificateForClientAuthentication { get; set; }
#nullable restore
#else
        public ApiSdk.Models.AospDeviceOwnerCertificateProfileBase IdentityCertificateForClientAuthentication { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.AospDeviceOwnerTrustedRootCertificate? RootCertificateForServerValidation { get; set; }
#nullable restore
#else
        public ApiSdk.Models.AospDeviceOwnerTrustedRootCertificate RootCertificateForServerValidation { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.AospDeviceOwnerEnterpriseWiFiConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.AospDeviceOwnerEnterpriseWiFiConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.AospDeviceOwnerEnterpriseWiFiConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.AospDeviceOwnerEnterpriseWiFiConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "identityCertificateForClientAuthentication", n => { IdentityCertificateForClientAuthentication = n.GetObjectValue<ApiSdk.Models.AospDeviceOwnerCertificateProfileBase>(ApiSdk.Models.AospDeviceOwnerCertificateProfileBase.CreateFromDiscriminatorValue); } },
                ...
                { "rootCertificateForServerValidation", n => { RootCertificateForServerValidation = n.GetObjectValue<ApiSdk.Models.AospDeviceOwnerTrustedRootCertificate>(ApiSdk.Models.AospDeviceOwnerTrustedRootCertificate.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.AospDeviceOwnerCertificateProfileBase>("identityCertificateForClientAuthentication", IdentityCertificateForClientAuthentication);
            ...
            writer.WriteObjectValue<ApiSdk.Models.AospDeviceOwnerTrustedRootCertificate>("rootCertificateForServerValidation", RootCertificateForServerValidation);
