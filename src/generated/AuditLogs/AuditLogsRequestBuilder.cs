...
using ApiSdk.AuditLogs.CustomSecurityAttributeAudits;
using ApiSdk.AuditLogs.DirectoryAudits;
using ApiSdk.AuditLogs.DirectoryProvisioning;
using ApiSdk.AuditLogs.Provisioning;
using ApiSdk.AuditLogs.SignIns;
using ApiSdk.AuditLogs.SignUps;
...
namespace ApiSdk.AuditLogs
{
    ...
    public partial class AuditLogsRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildCustomSecurityAttributeAuditsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.AuditLogs.CustomSecurityAttributeAudits.CustomSecurityAttributeAuditsRequestBuilder(PathParameters);
        ...
        public Command BuildDirectoryAuditsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.AuditLogs.DirectoryAudits.DirectoryAuditsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildDirectoryProvisioningNavCommand()
        {
            ...
            var builder = new global::ApiSdk.AuditLogs.DirectoryProvisioning.DirectoryProvisioningRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.AuditLogRoot>(global::ApiSdk.Models.AuditLogRoot.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildProvisioningNavCommand()
        {
            ...
            var builder = new global::ApiSdk.AuditLogs.Provisioning.ProvisioningRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildSignInsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.AuditLogs.SignIns.SignInsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildSignUpsNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the signUps property of the microsoft.graph.auditLogRoot entity.";
            var builder = new global::ApiSdk.AuditLogs.SignUps.SignUpsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.AuditLogs.AuditLogsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.AuditLogs.AuditLogsRequestBuilder.AuditLogsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.AuditLogs.AuditLogsRequestBuilder.AuditLogsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.AuditLogRoot body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.AuditLogRoot body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
