...
namespace ApiSdk.ThreatSubmission
{
    ...
    public class ThreatSubmissionRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildEmailThreatsNavCommand()
        {
            ...
            var builder = new ApiSdk.ThreatSubmission.EmailThreats.EmailThreatsRequestBuilder(PathParameters);
        ...
        public Command BuildEmailThreatSubmissionPoliciesNavCommand()
        {
            ...
            var builder = new ApiSdk.ThreatSubmission.EmailThreatSubmissionPolicies.EmailThreatSubmissionPoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildFileThreatsNavCommand()
        {
            ...
            var builder = new ApiSdk.ThreatSubmission.FileThreats.FileThreatsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildUrlThreatsNavCommand()
        {
            ...
            var builder = new ApiSdk.ThreatSubmission.UrlThreats.UrlThreatsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.ThreatSubmission.ThreatSubmissionRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.ThreatSubmission.ThreatSubmissionRequestBuilder.ThreatSubmissionRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.ThreatSubmission.ThreatSubmissionRequestBuilder.ThreatSubmissionRequestBuilderGetQueryParameters>> requestConfiguration = default)
