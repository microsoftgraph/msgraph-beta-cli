...
using System;
namespace ApiSdk.IdentityGovernance.EntitlementManagement.AccessPackageAssignments.Item.AccessPackageAssignmentRequests.Item.Requestor.ConnectedOrganization
{
    /// <summary>
    ...
    public class ConnectedOrganizationRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.IdentityGovernance.EntitlementManagement.AccessPackageAssignments.Item.AccessPackageAssignmentRequests.Item.Requestor.ConnectedOrganization.ConnectedOrganizationRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        public ConnectedOrganizationRequestBuilder(string rawUrl) : base("{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment%2Did}/accessPackageAssignmentRequests/{accessPackageAssignmentRequest%2Did}/requestor/connectedOrganization{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// The connected organization of the subject. Read-only. Nullable.
