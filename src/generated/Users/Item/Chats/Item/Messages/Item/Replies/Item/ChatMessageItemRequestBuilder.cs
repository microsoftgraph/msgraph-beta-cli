...
using ApiSdk.Models;
using ApiSdk.Users.Item.Chats.Item.Messages.Item.Replies.Item.HostedContents;
using ApiSdk.Users.Item.Chats.Item.Messages.Item.Replies.Item.SetReaction;
using ApiSdk.Users.Item.Chats.Item.Messages.Item.Replies.Item.SoftDelete;
using ApiSdk.Users.Item.Chats.Item.Messages.Item.Replies.Item.UndoSoftDelete;
using ApiSdk.Users.Item.Chats.Item.Messages.Item.Replies.Item.UnsetReaction;
...
using System;
namespace ApiSdk.Users.Item.Chats.Item.Messages.Item.Replies.Item {
    /// <summary>
    ...
    public class ChatMessageItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public ChatMessageItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ChatMessageItemRequestBuilder"/> and sets the default values.
        ...
        public ChatMessageItemRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property replies for users
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}", PathParameters);
...
#nullable restore
        ...
        public RequestInformation ToPatchRequestInformation(ChatMessage body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.PATCH, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
