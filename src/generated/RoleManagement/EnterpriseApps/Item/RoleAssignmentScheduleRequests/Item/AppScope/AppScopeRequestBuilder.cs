...
using System;
namespace ApiSdk.RoleManagement.EnterpriseApps.Item.RoleAssignmentScheduleRequests.Item.AppScope
{
    /// <summary>
    ...
    public partial class AppScopeRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.RoleManagement.EnterpriseApps.Item.RoleAssignmentScheduleRequests.Item.AppScope.AppScopeRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public AppScopeRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleAssignmentScheduleRequests/{unifiedRoleAssignmentScheduleRequest%2Did}/appScope{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.RoleManagement.EnterpriseApps.Item.RoleAssignmentScheduleRequests.Item.AppScope.AppScopeRequestBuilder"/> and sets the default values.
        ...
        public AppScopeRequestBuilder(string rawUrl) : base("{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleAssignmentScheduleRequests/{unifiedRoleAssignmentScheduleRequest%2Did}/appScope{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Read-only property with details of the app-specific scope when the assignment is scoped to an app. Nullable. Supports $expand.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.RoleManagement.EnterpriseApps.Item.RoleAssignmentScheduleRequests.Item.AppScope.AppScopeRequestBuilder.AppScopeRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.RoleManagement.EnterpriseApps.Item.RoleAssignmentScheduleRequests.Item.AppScope.AppScopeRequestBuilder.AppScopeRequestBuilderGetQueryParameters>> requestConfiguration = default)
