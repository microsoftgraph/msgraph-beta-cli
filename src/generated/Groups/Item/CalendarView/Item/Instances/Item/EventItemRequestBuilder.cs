...
namespace ApiSdk.Groups.Item.CalendarView.Item.Instances.Item
{
    ...
    public class EventItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAcceptNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.Accept.AcceptRequestBuilder(PathParameters);
        ...
        public Command BuildAttachmentsNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.Attachments.AttachmentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCalendarNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.Calendar.CalendarRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCancelNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.Cancel.CancelRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDeclineNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.Decline.DeclineRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDismissReminderNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.DismissReminder.DismissReminderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildExceptionOccurrencesNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.ExceptionOccurrences.ExceptionOccurrencesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildExtensionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.Extensions.ExtensionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildForwardNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.Forward.ForwardRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSnoozeReminderNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.SnoozeReminder.SnoozeReminderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTentativelyAcceptNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.TentativelyAccept.TentativelyAcceptRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.EventItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}?endDateTime={endDateTime}&startDateTime={startDateTime}{&%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.EventItemRequestBuilder"/> and sets the default values.
        ...
        public EventItemRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}?endDateTime={endDateTime}&startDateTime={startDateTime}{&%24select}", rawUrl)
        {
        }
        /// <summary>
        /// The occurrences of a recurring series, if the event is a series master. This property includes occurrences that are part of the recurrence pattern, and exceptions that have been modified, but doesn&apos;t include occurrences that have been canceled from the series. Navigation property. Read-only. Nullable.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.EventItemRequestBuilder.EventItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.EventItemRequestBuilder.EventItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
