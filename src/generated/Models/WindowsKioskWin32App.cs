...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class WindowsKioskWin32App : ApiSdk.Models.WindowsKioskAppBase, IParsable
    {
...
#nullable restore
        ...
        public ApiSdk.Models.WindowsEdgeKioskType? EdgeKioskType { get; set; }
        /// <summary>Edge first run flag for Edge kiosk mode</summary>
        public bool? EdgeNoFirstRun { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.WindowsKioskWin32App"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.WindowsKioskWin32App"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.WindowsKioskWin32App CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.WindowsKioskWin32App();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "edgeKioskType", n => { EdgeKioskType = n.GetEnumValue<ApiSdk.Models.WindowsEdgeKioskType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.WindowsEdgeKioskType>("edgeKioskType", EdgeKioskType);
