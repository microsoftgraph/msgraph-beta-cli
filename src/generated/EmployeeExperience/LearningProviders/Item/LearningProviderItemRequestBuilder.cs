...
namespace ApiSdk.EmployeeExperience.LearningProviders.Item
{
    ...
    public partial class LearningProviderItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete a learningProvider resource and remove its registration in Viva Learning for the tenant.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/employeeexperience-delete-learningproviders?view=graph-rest-beta";
        ...
        public Command BuildLearningContentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.EmployeeExperience.LearningProviders.Item.LearningContents.LearningContentsRequestBuilder(PathParameters);
        ...
        public Command BuildLearningContentsWithExternalIdRbCommand()
        {
            ...
            command.Description = "Provides operations to manage the learningContents property of the microsoft.graph.learningProvider entity.";
            var builder = new global::ApiSdk.EmployeeExperience.LearningProviders.Item.LearningContentsWithExternalId.LearningContentsWithExternalIdRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildLearningCourseActivitiesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.EmployeeExperience.LearningProviders.Item.LearningCourseActivities.LearningCourseActivitiesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildLearningCourseActivitiesWithExternalcourseActivityIdRbCommand()
        {
            ...
            command.Description = "Provides operations to manage the learningCourseActivities property of the microsoft.graph.learningProvider entity.";
            var builder = new global::ApiSdk.EmployeeExperience.LearningProviders.Item.LearningCourseActivitiesWithExternalcourseActivityId.LearningCourseActivitiesWithExternalcourseActivityIdRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the properties of a learningProvider object.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/learningprovider-update?view=graph-rest-beta";
            var learningProviderIdOption = new Option<string>("--learning-provider-id", description: "The unique identifier of learningProvider") {
            };
            learningProviderIdOption.IsRequired = true;
            command.AddOption(learningProviderIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.LearningProvider>(global::ApiSdk.Models.LearningProvider.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.EmployeeExperience.LearningProviders.Item.LearningProviderItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.EmployeeExperience.LearningProviders.Item.LearningProviderItemRequestBuilder.LearningProviderItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.EmployeeExperience.LearningProviders.Item.LearningProviderItemRequestBuilder.LearningProviderItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.LearningProvider body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.LearningProvider body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class LearningProviderItemRequestBuilderGetQueryParameters 
        {
