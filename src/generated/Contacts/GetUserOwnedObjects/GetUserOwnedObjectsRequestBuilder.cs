    ...
    public class GetUserOwnedObjectsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Contacts.GetUserOwnedObjects.GetUserOwnedObjectsPostRequestBody>(ApiSdk.Contacts.GetUserOwnedObjects.GetUserOwnedObjectsPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Contacts.GetUserOwnedObjects.GetUserOwnedObjectsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Contacts.GetUserOwnedObjects.GetUserOwnedObjectsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Contacts.GetUserOwnedObjects.GetUserOwnedObjectsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
