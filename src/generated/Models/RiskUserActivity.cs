...
namespace ApiSdk.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::ApiSdk.Models.RiskDetail? Detail { get; set; }
        /// <summary>List of risk event types. Deprecated. Use riskEventType instead.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.RiskEventType?>? EventTypes { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.RiskEventType?> EventTypes { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Models.RiskUserActivity"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.RiskUserActivity"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ApiSdk.Models.RiskUserActivity CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.RiskUserActivity();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "detail", n => { Detail = n.GetEnumValue<global::ApiSdk.Models.RiskDetail>(); } },
                { "eventTypes", n => { EventTypes = n.GetCollectionOfEnumValues<global::ApiSdk.Models.RiskEventType>()?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.RiskDetail>("detail", Detail);
            writer.WriteCollectionOfEnumValues<global::ApiSdk.Models.RiskEventType>("eventTypes", EventTypes);
