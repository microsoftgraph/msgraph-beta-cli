...
namespace ApiSdk.Admin.Windows.Updates.DeploymentAudiences.Item.ApplicableContent.Item.CatalogEntry
{
    ...
    public partial class CatalogEntryRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Admin.Windows.Updates.DeploymentAudiences.Item.ApplicableContent.Item.CatalogEntry.CatalogEntryRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public CatalogEntryRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/applicableContent/{applicableContent%2DcatalogEntryId}/catalogEntry{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Admin.Windows.Updates.DeploymentAudiences.Item.ApplicableContent.Item.CatalogEntry.CatalogEntryRequestBuilder"/> and sets the default values.
        ...
        public CatalogEntryRequestBuilder(string rawUrl) : base("{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/applicableContent/{applicableContent%2DcatalogEntryId}/catalogEntry{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Catalog entry for the update or content.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Admin.Windows.Updates.DeploymentAudiences.Item.ApplicableContent.Item.CatalogEntry.CatalogEntryRequestBuilder.CatalogEntryRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Admin.Windows.Updates.DeploymentAudiences.Item.ApplicableContent.Item.CatalogEntry.CatalogEntryRequestBuilder.CatalogEntryRequestBuilderGetQueryParameters>> requestConfiguration = default)
