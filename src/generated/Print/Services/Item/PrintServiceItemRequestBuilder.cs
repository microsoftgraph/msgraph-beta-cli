...
namespace ApiSdk.Print.Services.Item
{
    ...
    public class PrintServiceItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildEndpointsNavCommand()
        {
            ...
            var builder = new ApiSdk.Print.Services.Item.Endpoints.EndpointsRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Print.Services.Item.PrintServiceItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Print.Services.Item.PrintServiceItemRequestBuilder.PrintServiceItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Print.Services.Item.PrintServiceItemRequestBuilder.PrintServiceItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.PrintService body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.PrintService body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
