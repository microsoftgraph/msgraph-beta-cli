...
namespace ApiSdk.Models
{
    ...
    public partial class DeviceHealthScriptAssignment : global::ApiSdk.Models.Entity, IParsable
    {
...
#nullable enable
        public global::ApiSdk.Models.DeviceHealthScriptRunSchedule? RunSchedule { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.DeviceHealthScriptRunSchedule RunSchedule { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.DeviceHealthScriptAssignment"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.DeviceHealthScriptAssignment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.DeviceHealthScriptAssignment();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "runSchedule", n => { RunSchedule = n.GetObjectValue<global::ApiSdk.Models.DeviceHealthScriptRunSchedule>(global::ApiSdk.Models.DeviceHealthScriptRunSchedule.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::ApiSdk.Models.DeviceHealthScriptRunSchedule>("runSchedule", RunSchedule);
