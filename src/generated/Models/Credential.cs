...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.Credential"/> and sets the default values.
        /// </summary>
        public Credential()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.Credential"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.Credential CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.Credential();
        }
        /// <summary>
