...
using ApiSdk.Models;
using ApiSdk.Print.PrinterShares.Item.AllowedGroups;
using ApiSdk.Print.PrinterShares.Item.AllowedUsers;
using ApiSdk.Print.PrinterShares.Item.Jobs;
using ApiSdk.Print.PrinterShares.Item.Printer;
...
using System;
namespace ApiSdk.Print.PrinterShares.Item
{
    /// <summary>
    /// Provides operations to manage the printerShares property of the microsoft.graph.print entity.
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class PrinterShareItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildAllowedGroupsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Print.PrinterShares.Item.AllowedGroups.AllowedGroupsRequestBuilder(PathParameters);
        ...
        public Command BuildAllowedUsersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Print.PrinterShares.Item.AllowedUsers.AllowedUsersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property printerShares for print";
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get printerShares from print";
            var printerShareIdOption = new Option<string>("--printer-share-id", description: "The unique identifier of printerShare") {
            };
            printerShareIdOption.IsRequired = true;
            command.AddOption(printerShareIdOption);
        ...
        public Command BuildJobsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Print.PrinterShares.Item.Jobs.JobsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property printerShares in print";
            var printerShareIdOption = new Option<string>("--printer-share-id", description: "The unique identifier of printerShare") {
            };
            printerShareIdOption.IsRequired = true;
            command.AddOption(printerShareIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.PrinterShare>(global::ApiSdk.Models.PrinterShare.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPrinterNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Print.PrinterShares.Item.Printer.PrinterRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Print.PrinterShares.Item.PrinterShareItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Print.PrinterShares.Item.PrinterShareItemRequestBuilder.PrinterShareItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Print.PrinterShares.Item.PrinterShareItemRequestBuilder.PrinterShareItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.PrinterShare body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.PrinterShare body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
