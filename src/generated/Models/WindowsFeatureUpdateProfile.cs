...
namespace ApiSdk.Models
{
    ...
    public partial class WindowsFeatureUpdateProfile : global::ApiSdk.Models.Entity, IParsable
    {
        /// <summary>The list of group assignments of the profile.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.WindowsFeatureUpdateProfileAssignment>? Assignments { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.WindowsFeatureUpdateProfileAssignment> Assignments { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.WindowsUpdateRolloutSettings? RolloutSettings { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.WindowsUpdateRolloutSettings RolloutSettings { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.WindowsFeatureUpdateProfile"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.WindowsFeatureUpdateProfile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.WindowsFeatureUpdateProfile();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "assignments", n => { Assignments = n.GetCollectionOfObjectValues<global::ApiSdk.Models.WindowsFeatureUpdateProfileAssignment>(global::ApiSdk.Models.WindowsFeatureUpdateProfileAssignment.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "rolloutSettings", n => { RolloutSettings = n.GetObjectValue<global::ApiSdk.Models.WindowsUpdateRolloutSettings>(global::ApiSdk.Models.WindowsUpdateRolloutSettings.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.WindowsFeatureUpdateProfileAssignment>("assignments", Assignments);
            ...
            writer.WriteObjectValue<global::ApiSdk.Models.WindowsUpdateRolloutSettings>("rolloutSettings", RolloutSettings);
        }
    }
}
