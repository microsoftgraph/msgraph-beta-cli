...
namespace ApiSdk.Models
{
    ...
    public partial class WorkbookDocumentTaskChange : global::ApiSdk.Models.Entity, IParsable
...
#nullable enable
        public global::ApiSdk.Models.WorkbookEmailIdentity? Assignee { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.WorkbookEmailIdentity Assignee { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.WorkbookEmailIdentity? ChangedBy { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.WorkbookEmailIdentity ChangedBy { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.WorkbookDocumentTaskChange"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.WorkbookDocumentTaskChange CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.WorkbookDocumentTaskChange();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "assignee", n => { Assignee = n.GetObjectValue<global::ApiSdk.Models.WorkbookEmailIdentity>(global::ApiSdk.Models.WorkbookEmailIdentity.CreateFromDiscriminatorValue); } },
                { "changedBy", n => { ChangedBy = n.GetObjectValue<global::ApiSdk.Models.WorkbookEmailIdentity>(global::ApiSdk.Models.WorkbookEmailIdentity.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::ApiSdk.Models.WorkbookEmailIdentity>("assignee", Assignee);
            writer.WriteObjectValue<global::ApiSdk.Models.WorkbookEmailIdentity>("changedBy", ChangedBy);
