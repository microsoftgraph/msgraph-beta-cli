...
using ApiSdk.Models;
using ApiSdk.Solutions.VirtualEvents.Webinars.Item.Presenters.Item.Sessions;
using ApiSdk.Solutions.VirtualEvents.Webinars.Item.Presenters.Item.SessionsWithJoinWebUrl;
...
namespace ApiSdk.Solutions.VirtualEvents.Webinars.Item.Presenters.Item
{
    ...
    public class VirtualEventPresenterItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildSessionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Solutions.VirtualEvents.Webinars.Item.Presenters.Item.Sessions.SessionsRequestBuilder(PathParameters);
        ...
        public Command BuildSessionsWithJoinWebUrlRbCommand()
        {
            ...
            command.Description = "Provides operations to manage the sessions property of the microsoft.graph.virtualEventPresenter entity.";
            var builder = new ApiSdk.Solutions.VirtualEvents.Webinars.Item.Presenters.Item.SessionsWithJoinWebUrl.SessionsWithJoinWebUrlRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Solutions.VirtualEvents.Webinars.Item.Presenters.Item.VirtualEventPresenterItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Solutions.VirtualEvents.Webinars.Item.Presenters.Item.VirtualEventPresenterItemRequestBuilder.VirtualEventPresenterItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Solutions.VirtualEvents.Webinars.Item.Presenters.Item.VirtualEventPresenterItemRequestBuilder.VirtualEventPresenterItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
