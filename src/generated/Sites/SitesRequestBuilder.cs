...
namespace ApiSdk.Sites
{
    ...
    public class SitesRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAddNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Add.AddRequestBuilder(PathParameters);
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.SiteItemRequestBuilder(PathParameters);
        ...
        public Command BuildCountNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Count.CountRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildDeltaNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Delta.DeltaRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetAllSitesNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.GetAllSites.GetAllSitesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
...
#nullable restore
        ...
        public Command BuildRemoveNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Remove.RemoveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Sites.SitesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Sites.SitesRequestBuilder.SitesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Sites.SitesRequestBuilder.SitesRequestBuilderGetQueryParameters>> requestConfiguration = default)
