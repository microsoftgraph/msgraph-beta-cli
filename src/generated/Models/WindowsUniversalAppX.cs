...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class WindowsUniversalAppX : ApiSdk.Models.MobileLobApp, IParsable
    {
        ...
        public ApiSdk.Models.WindowsDeviceType? ApplicableDeviceTypes { get; set; }
...
#nullable enable
        public List<ApiSdk.Models.MobileContainedApp>? CommittedContainedApps { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.MobileContainedApp> CommittedContainedApps { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.WindowsUniversalAppX"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.WindowsUniversalAppX"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.WindowsUniversalAppX CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.WindowsUniversalAppX();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "applicableDeviceTypes", n => { ApplicableDeviceTypes = n.GetEnumValue<ApiSdk.Models.WindowsDeviceType>(); } },
                { "committedContainedApps", n => { CommittedContainedApps = n.GetCollectionOfObjectValues<ApiSdk.Models.MobileContainedApp>(ApiSdk.Models.MobileContainedApp.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.WindowsDeviceType>("applicableDeviceTypes", ApplicableDeviceTypes);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.MobileContainedApp>("committedContainedApps", CommittedContainedApps);
