...
#nullable enable
        public List<GoalsExportJob>? ExportJobs { get; set; }
#nullable restore
#else
        public List<GoalsExportJob> ExportJobs { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="Goals"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new Goals CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<GoalsExportJob>("exportJobs", ExportJobs);
        }
    }
}
