...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.AdministrativeUnits.GetByIds.GetByIdsPostResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.AdministrativeUnits.GetByIds.GetByIdsPostResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.AdministrativeUnits.GetByIds.GetByIdsPostResponse();
        }
        /// <summary>
