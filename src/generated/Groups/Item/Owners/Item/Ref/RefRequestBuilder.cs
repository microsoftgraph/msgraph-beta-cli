...
using System;
namespace ApiSdk.Groups.Item.Owners.Item.Ref
{
    /// <summary>
    ...
    public partial class RefRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Owners.Item.Ref.RefRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public RefRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/owners/{directoryObject%2Did}/$ref", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Owners.Item.Ref.RefRequestBuilder"/> and sets the default values.
        ...
        public RefRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/owners/{directoryObject%2Did}/$ref", rawUrl)
        {
        }
        /// <summary>
        /// Use this API to remove an owner from a Microsoft 365 group or a security group through the owners navigation property. When owners are assigned to a group, the last owner (a user object) of the group cannot be removed.
