...
namespace ApiSdk.Reports.Partners.Billing
{
    ...
    public partial class BillingRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildManifestsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Reports.Partners.Billing.Manifests.ManifestsRequestBuilder(PathParameters);
        ...
        public Command BuildOperationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Reports.Partners.Billing.Operations.OperationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Partners.Billing.Billing>(global::ApiSdk.Models.Partners.Billing.Billing.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildReconciliationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Reports.Partners.Billing.Reconciliation.ReconciliationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            ...
            nonExecCommands.Add(builder.BuildUnbilledNavCommand());
            foreach (var cmd in execCommands)
            {
                command.AddCommand(cmd);
            }
        ...
        public Command BuildUsageNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Reports.Partners.Billing.Usage.UsageRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildBilledNavCommand());
            execCommands.Add(builder.BuildDeleteCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Reports.Partners.Billing.BillingRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Reports.Partners.Billing.BillingRequestBuilder.BillingRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Reports.Partners.Billing.BillingRequestBuilder.BillingRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Partners.Billing.Billing body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Partners.Billing.Billing body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
