...
namespace ApiSdk.Models.Security
{
    ...
    public class AnalyzedEmailSenderDetail : IAdditionalDataHolder, IParsable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.Security.AnalyzedEmailSenderDetail"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.Security.AnalyzedEmailSenderDetail"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.Security.AnalyzedEmailSenderDetail CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.Security.AnalyzedEmailSenderDetail();
        }
        /// <summary>
