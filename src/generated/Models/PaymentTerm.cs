...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.PaymentTerm"/> and sets the default values.
        /// </summary>
        public PaymentTerm()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.PaymentTerm"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.PaymentTerm CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.PaymentTerm();
        }
        /// <summary>
