...
using ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.OwnersWithUserPrincipalName;
...
namespace ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition
{
    ...
    public partial class TeamDefinitionRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAllChannelsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.AllChannels.AllChannelsRequestBuilder(PathParameters);
        ...
        public Command BuildArchiveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.Archive.ArchiveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildChannelsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.Channels.ChannelsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildCloneNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.Clone.CloneRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildCompleteMigrationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.CompleteMigration.CompleteMigrationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get the properties of the team associated with a teamTemplateDefinition object.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/teamtemplatedefinition-get-teamdefinition?view=graph-rest-beta";
            var teamTemplateIdOption = new Option<string>("--team-template-id", description: "The unique identifier of teamTemplate") {
            };
            teamTemplateIdOption.IsRequired = true;
            command.AddOption(teamTemplateIdOption);
        ...
        public Command BuildGroupNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.Group.GroupRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildIncomingChannelsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.IncomingChannels.IncomingChannelsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildInstalledAppsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.InstalledApps.InstalledAppsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildMembersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.Members.MembersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildOperationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.Operations.OperationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildOwnersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.Owners.OwnersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildOwnersWithUserPrincipalNameRbCommand()
        {
            ...
            command.Description = "Provides operations to manage the owners property of the microsoft.graph.team entity.";
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.OwnersWithUserPrincipalName.OwnersWithUserPrincipalNameRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPermissionGrantsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.PermissionGrants.PermissionGrantsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPhotoNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.Photo.PhotoRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildPrimaryChannelNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.PrimaryChannel.PrimaryChannelRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildScheduleNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.Schedule.ScheduleRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildSendActivityNotificationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.SendActivityNotification.SendActivityNotificationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTagsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.Tags.TagsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildTemplateDefinitionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.TemplateDefinition.TemplateDefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTemplateNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.Template.TemplateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUnarchiveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.Unarchive.UnarchiveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.TeamDefinitionRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.TeamDefinitionRequestBuilder.TeamDefinitionRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.TeamDefinitionRequestBuilder.TeamDefinitionRequestBuilderGetQueryParameters>> requestConfiguration = default)
