...
using ApiSdk.AdministrativeUnits.Item.CheckMemberGroups;
using ApiSdk.AdministrativeUnits.Item.CheckMemberObjects;
using ApiSdk.AdministrativeUnits.Item.DeletedMembers;
using ApiSdk.AdministrativeUnits.Item.Extensions;
using ApiSdk.AdministrativeUnits.Item.GetMemberGroups;
using ApiSdk.AdministrativeUnits.Item.GetMemberObjects;
using ApiSdk.AdministrativeUnits.Item.Members;
using ApiSdk.AdministrativeUnits.Item.Restore;
using ApiSdk.AdministrativeUnits.Item.ScopedRoleMembers;
...
namespace ApiSdk.AdministrativeUnits.Item
{
    ...
    public partial class AdministrativeUnitItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildCheckMemberGroupsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.AdministrativeUnits.Item.CheckMemberGroups.CheckMemberGroupsRequestBuilder(PathParameters);
        ...
        public Command BuildCheckMemberObjectsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.AdministrativeUnits.Item.CheckMemberObjects.CheckMemberObjectsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete an administrativeUnit.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/administrativeunit-delete?view=graph-rest-beta";
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildDeletedMembersNavCommand()
        {
            var command = new Command("deleted-members");
            command.Description = "Provides operations to manage the deletedMembers property of the microsoft.graph.administrativeUnit entity.";
            var builder = new global::ApiSdk.AdministrativeUnits.Item.DeletedMembers.DeletedMembersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildExtensionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.AdministrativeUnits.Item.Extensions.ExtensionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Retrieve the properties and relationships of an administrativeUnit object. Since the administrativeUnit resource supports extensions, you can also use the GET operation to get custom properties and extension data in an administrativeUnit instance.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/administrativeunit-get?view=graph-rest-beta";
            var administrativeUnitIdOption = new Option<string>("--administrative-unit-id", description: "The unique identifier of administrativeUnit") {
            };
            administrativeUnitIdOption.IsRequired = true;
            command.AddOption(administrativeUnitIdOption);
        ...
        public Command BuildGetMemberObjectsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.AdministrativeUnits.Item.GetMemberObjects.GetMemberObjectsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMembersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.AdministrativeUnits.Item.Members.MembersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.AdministrativeUnit>(global::ApiSdk.Models.AdministrativeUnit.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildRestoreNavCommand()
        {
            ...
            var builder = new global::ApiSdk.AdministrativeUnits.Item.Restore.RestoreRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.AdministrativeUnits.Item.AdministrativeUnitItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public AdministrativeUnitItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/administrativeUnits/{administrativeUnit%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.AdministrativeUnits.Item.AdministrativeUnitItemRequestBuilder"/> and sets the default values.
        ...
        public AdministrativeUnitItemRequestBuilder(string rawUrl) : base("{+baseurl}/administrativeUnits/{administrativeUnit%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete an administrativeUnit.
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.AdministrativeUnits.Item.AdministrativeUnitItemRequestBuilder.AdministrativeUnitItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.AdministrativeUnits.Item.AdministrativeUnitItemRequestBuilder.AdministrativeUnitItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.AdministrativeUnit body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.AdministrativeUnit body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
