...
namespace ApiSdk.Models
{
    ...
    public partial class WindowsDomainJoinConfiguration : global::ApiSdk.Models.DeviceConfiguration, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.DeviceConfiguration>? NetworkAccessConfigurations { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.DeviceConfiguration> NetworkAccessConfigurations { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Models.WindowsDomainJoinConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.WindowsDomainJoinConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.WindowsDomainJoinConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.WindowsDomainJoinConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "networkAccessConfigurations", n => { NetworkAccessConfigurations = n.GetCollectionOfObjectValues<global::ApiSdk.Models.DeviceConfiguration>(global::ApiSdk.Models.DeviceConfiguration.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.DeviceConfiguration>("networkAccessConfigurations", NetworkAccessConfigurations);
