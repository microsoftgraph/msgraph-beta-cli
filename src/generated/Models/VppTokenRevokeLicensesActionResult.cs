...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class VppTokenRevokeLicensesActionResult : ApiSdk.Models.VppTokenActionResult, IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.VppTokenRevokeLicensesActionResult"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.VppTokenRevokeLicensesActionResult CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.VppTokenRevokeLicensesActionResult();
        }
        /// <summary>
