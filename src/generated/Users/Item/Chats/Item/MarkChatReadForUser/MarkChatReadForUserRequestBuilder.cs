    ...
    public class MarkChatReadForUserRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Users.Item.Chats.Item.MarkChatReadForUser.MarkChatReadForUserPostRequestBody>(ApiSdk.Users.Item.Chats.Item.MarkChatReadForUser.MarkChatReadForUserPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Users.Item.Chats.Item.MarkChatReadForUser.MarkChatReadForUserRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Users.Item.Chats.Item.MarkChatReadForUser.MarkChatReadForUserPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Users.Item.Chats.Item.MarkChatReadForUser.MarkChatReadForUserPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
