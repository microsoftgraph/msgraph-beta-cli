...
namespace ApiSdk.Users.Item.InformationProtection
{
    ...
    public class InformationProtectionRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildBitlockerNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.InformationProtection.Bitlocker.BitlockerRequestBuilder(PathParameters);
        ...
        public Command BuildDataLossPreventionPoliciesNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.InformationProtection.DataLossPreventionPolicies.DataLossPreventionPoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildDecryptBufferNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.InformationProtection.DecryptBuffer.DecryptBufferRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildEncryptBufferNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.InformationProtection.EncryptBuffer.EncryptBufferRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPolicyNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.InformationProtection.Policy.PolicyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildSensitivityLabelsNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.InformationProtection.SensitivityLabels.SensitivityLabelsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildSensitivityPolicySettingsNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.InformationProtection.SensitivityPolicySettings.SensitivityPolicySettingsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildSignDigestNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.InformationProtection.SignDigest.SignDigestRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildThreatAssessmentRequestsNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.InformationProtection.ThreatAssessmentRequests.ThreatAssessmentRequestsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildVerifySignatureNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.InformationProtection.VerifySignature.VerifySignatureRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Users.Item.InformationProtection.InformationProtectionRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.InformationProtection.InformationProtectionRequestBuilder.InformationProtectionRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.InformationProtection.InformationProtectionRequestBuilder.InformationProtectionRequestBuilderGetQueryParameters>> requestConfiguration = default)
