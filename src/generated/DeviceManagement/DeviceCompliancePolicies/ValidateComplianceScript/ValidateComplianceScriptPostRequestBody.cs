...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceManagement.DeviceCompliancePolicies.ValidateComplianceScript.ValidateComplianceScriptPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.DeviceManagement.DeviceCompliancePolicies.ValidateComplianceScript.ValidateComplianceScriptPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.DeviceManagement.DeviceCompliancePolicies.ValidateComplianceScript.ValidateComplianceScriptPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.DeviceManagement.DeviceCompliancePolicies.ValidateComplianceScript.ValidateComplianceScriptPostRequestBody();
        }
        /// <summary>
