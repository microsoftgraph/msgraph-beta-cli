...
namespace ApiSdk.Admin.Edge.InternetExplorerMode.SiteLists.Item.SharedCookies
{
    ...
    public class SharedCookiesRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new ApiSdk.Admin.Edge.InternetExplorerMode.SiteLists.Item.SharedCookies.Item.BrowserSharedCookieItemRequestBuilder(PathParameters);
        ...
        public Command BuildCountNavCommand()
        {
            ...
            var builder = new ApiSdk.Admin.Edge.InternetExplorerMode.SiteLists.Item.SharedCookies.Count.CountRequestBuilder(PathParameters);
        ...
        public Command BuildCreateCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.BrowserSharedCookie>(ApiSdk.Models.BrowserSharedCookie.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildListCommand()
        {
            ...
            command.Description = "Get a list of the browserSharedCookie objects and their properties.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/browsersitelist-list-sharedcookies?view=graph-rest-beta";
            var browserSiteListIdOption = new Option<string>("--browser-site-list-id", description: "The unique identifier of browserSiteList") {
            };
            browserSiteListIdOption.IsRequired = true;
            command.AddOption(browserSiteListIdOption);
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Admin.Edge.InternetExplorerMode.SiteLists.Item.SharedCookies.SharedCookiesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Admin.Edge.InternetExplorerMode.SiteLists.Item.SharedCookies.SharedCookiesRequestBuilder.SharedCookiesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Admin.Edge.InternetExplorerMode.SiteLists.Item.SharedCookies.SharedCookiesRequestBuilder.SharedCookiesRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Models.BrowserSharedCookie body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Models.BrowserSharedCookie body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
