...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.ManagedEBookCategory>? Categories { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.ManagedEBookCategory> Categories { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "categories", n => { Categories = n.GetCollectionOfObjectValues<ApiSdk.Models.ManagedEBookCategory>(ApiSdk.Models.ManagedEBookCategory.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.ManagedEBookCategory>("categories", Categories);
