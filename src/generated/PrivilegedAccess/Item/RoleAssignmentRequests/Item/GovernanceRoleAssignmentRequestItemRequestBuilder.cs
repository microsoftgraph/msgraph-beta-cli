...
using ApiSdk.Models;
using ApiSdk.PrivilegedAccess.Item.RoleAssignmentRequests.Item.Cancel;
using ApiSdk.PrivilegedAccess.Item.RoleAssignmentRequests.Item.Resource;
using ApiSdk.PrivilegedAccess.Item.RoleAssignmentRequests.Item.RoleDefinition;
using ApiSdk.PrivilegedAccess.Item.RoleAssignmentRequests.Item.Subject;
using ApiSdk.PrivilegedAccess.Item.RoleAssignmentRequests.Item.UpdateRequest;
...
using System;
namespace ApiSdk.PrivilegedAccess.Item.RoleAssignmentRequests.Item
{
    /// <summary>
    ...
    public partial class GovernanceRoleAssignmentRequestItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCancelNavCommand()
        {
            ...
            var builder = new global::ApiSdk.PrivilegedAccess.Item.RoleAssignmentRequests.Item.Cancel.CancelRequestBuilder(PathParameters);
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "A collection of role assignment requests for the provider.";
            var privilegedAccessIdOption = new Option<string>("--privileged-access-id", description: "The unique identifier of privilegedAccess") {
            };
            privilegedAccessIdOption.IsRequired = true;
            command.AddOption(privilegedAccessIdOption);
        ...
        public Command BuildResourceNavCommand()
        {
            ...
            var builder = new global::ApiSdk.PrivilegedAccess.Item.RoleAssignmentRequests.Item.Resource.ResourceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildRoleDefinitionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.PrivilegedAccess.Item.RoleAssignmentRequests.Item.RoleDefinition.RoleDefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSubjectNavCommand()
        {
            ...
            var builder = new global::ApiSdk.PrivilegedAccess.Item.RoleAssignmentRequests.Item.Subject.SubjectRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildUpdateRequestNavCommand()
        {
            ...
            var builder = new global::ApiSdk.PrivilegedAccess.Item.RoleAssignmentRequests.Item.UpdateRequest.UpdateRequestRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.PrivilegedAccess.Item.RoleAssignmentRequests.Item.GovernanceRoleAssignmentRequestItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public GovernanceRoleAssignmentRequestItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.PrivilegedAccess.Item.RoleAssignmentRequests.Item.GovernanceRoleAssignmentRequestItemRequestBuilder"/> and sets the default values.
        ...
        public GovernanceRoleAssignmentRequestItemRequestBuilder(string rawUrl) : base("{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property roleAssignmentRequests for privilegedAccess
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.PrivilegedAccess.Item.RoleAssignmentRequests.Item.GovernanceRoleAssignmentRequestItemRequestBuilder.GovernanceRoleAssignmentRequestItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.PrivilegedAccess.Item.RoleAssignmentRequests.Item.GovernanceRoleAssignmentRequestItemRequestBuilder.GovernanceRoleAssignmentRequestItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
