...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class IntuneBrandingProfileAssignment : ApiSdk.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.IntuneBrandingProfileAssignment"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.IntuneBrandingProfileAssignment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.IntuneBrandingProfileAssignment();
        }
        /// <summary>
