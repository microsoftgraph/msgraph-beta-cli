...
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsMobileMSI.Assignments;
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsMobileMSI.Categories;
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsMobileMSI.ContentVersions;
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsMobileMSI.Relationships;
...
namespace ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsMobileMSI
{
    ...
    public partial class GraphWindowsMobileMSIRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildAssignmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsMobileMSI.Assignments.AssignmentsRequestBuilder(PathParameters);
        ...
        public Command BuildCategoriesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsMobileMSI.Categories.CategoriesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildContentVersionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsMobileMSI.ContentVersions.ContentVersionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRelationshipsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsMobileMSI.Relationships.RelationshipsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsMobileMSI.GraphWindowsMobileMSIRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsMobileMSI.GraphWindowsMobileMSIRequestBuilder.GraphWindowsMobileMSIRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsMobileMSI.GraphWindowsMobileMSIRequestBuilder.GraphWindowsMobileMSIRequestBuilderGetQueryParameters>> requestConfiguration = default)
