...
namespace ApiSdk.ServicePrincipals.Item.Synchronization
{
    ...
    public class SynchronizationRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAcquireAccessTokenNavCommand()
        {
            ...
            var builder = new ApiSdk.ServicePrincipals.Item.Synchronization.AcquireAccessToken.AcquireAccessTokenRequestBuilder(PathParameters);
        ...
        public Command BuildJobsNavCommand()
        {
            ...
            var builder = new ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.JobsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildPingNavCommand()
        {
            ...
            var builder = new ApiSdk.ServicePrincipals.Item.Synchronization.Ping.PingRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSecretsNavCommand()
        {
            ...
            var builder = new ApiSdk.ServicePrincipals.Item.Synchronization.Secrets.SecretsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildTemplatesNavCommand()
        {
            ...
            var builder = new ApiSdk.ServicePrincipals.Item.Synchronization.Templates.TemplatesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.ServicePrincipals.Item.Synchronization.SynchronizationRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.ServicePrincipals.Item.Synchronization.SynchronizationRequestBuilder.SynchronizationRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.ServicePrincipals.Item.Synchronization.SynchronizationRequestBuilder.SynchronizationRequestBuilderGetQueryParameters>> requestConfiguration = default)
