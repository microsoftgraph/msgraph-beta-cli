...
using ApiSdk.Models;
using ApiSdk.Users.Item.MemberOf.GraphAdministrativeUnit.Count;
...
using System;
namespace ApiSdk.Users.Item.MemberOf.GraphAdministrativeUnit {
    /// <summary>
    ...
    public class GraphAdministrativeUnitRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public GraphAdministrativeUnitRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/memberOf/graph.administrativeUnit{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="GraphAdministrativeUnitRequestBuilder"/> and sets the default values.
        ...
        public GraphAdministrativeUnitRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/memberOf/graph.administrativeUnit{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get the items of type microsoft.graph.administrativeUnit in the microsoft.graph.directoryObject collection
