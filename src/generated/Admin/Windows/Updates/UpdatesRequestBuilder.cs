...
namespace ApiSdk.Admin.Windows.Updates
{
    ...
    public class UpdatesRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDeploymentAudiencesNavCommand()
        {
            ...
            var builder = new DeploymentAudiencesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<AdminWindowsUpdates>(AdminWindowsUpdates.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildResourceConnectionsNavCommand()
        {
            ...
            var builder = new ResourceConnectionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildUpdatableAssetsNavCommand()
        {
            ...
            var builder = new UpdatableAssetsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildUpdatePoliciesNavCommand()
        {
            ...
            var builder = new UpdatePoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
