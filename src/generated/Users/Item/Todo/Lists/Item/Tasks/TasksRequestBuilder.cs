...
namespace ApiSdk.Users.Item.Todo.Lists.Item.Tasks {
    ...
    public class TasksRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new TodoTaskItemRequestBuilder(PathParameters);
            commands.Add(builder.BuildAttachmentSessionsNavCommand());
            commands.Add(builder.BuildAttachmentsNavCommand());
            commands.Add(builder.BuildChecklistItemsNavCommand());
            executables.Add(builder.BuildDeleteCommand());
            commands.Add(builder.BuildExtensionsNavCommand());
            executables.Add(builder.BuildGetCommand());
            commands.Add(builder.BuildLinkedResourcesNavCommand());
        ...
        public TasksRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/todo/lists/{todoTaskList%2Did}/tasks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="TasksRequestBuilder"/> and sets the default values.
        ...
        public TasksRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/todo/lists/{todoTaskList%2Did}/tasks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get the todoTask resources from the tasks navigation property of a specified todoTaskList.
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(TodoTask body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(TodoTask body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/users/{user%2Did}/todo/lists/{todoTaskList%2Did}/tasks", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
