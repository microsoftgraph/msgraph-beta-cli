...
namespace ApiSdk.DeviceManagement.OperationApprovalRequests.RetrieveMyRequestByIdWithId
{
    ...
    public partial class RetrieveMyRequestByIdWithIdRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Invoke function retrieveMyRequestById";
            var idOption = new Option<string>("--id", description: "Usage: id='{id}'") {
            };
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.DeviceManagement.OperationApprovalRequests.RetrieveMyRequestByIdWithId.RetrieveMyRequestByIdWithIdRequestBuilder"/> and sets the default values.
        /// </summary>
