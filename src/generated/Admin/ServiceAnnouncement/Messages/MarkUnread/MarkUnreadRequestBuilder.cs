    ...
    public class MarkUnreadRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Admin.ServiceAnnouncement.Messages.MarkUnread.MarkUnreadPostRequestBody>(ApiSdk.Admin.ServiceAnnouncement.Messages.MarkUnread.MarkUnreadPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Admin.ServiceAnnouncement.Messages.MarkUnread.MarkUnreadRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Admin.ServiceAnnouncement.Messages.MarkUnread.MarkUnreadPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Admin.ServiceAnnouncement.Messages.MarkUnread.MarkUnreadPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
