...
using ApiSdk.Models;
using ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.LinkedEligibleRoleAssignment;
using ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.Resource;
using ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.RoleDefinition;
using ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.Subject;
...
namespace ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item
{
    ...
    public partial class GovernanceRoleAssignmentItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "A collection of role assignments for the provider.";
            var privilegedAccessIdOption = new Option<string>("--privileged-access-id", description: "The unique identifier of privilegedAccess") {
            };
            privilegedAccessIdOption.IsRequired = true;
            command.AddOption(privilegedAccessIdOption);
        ...
        public Command BuildLinkedEligibleRoleAssignmentNavCommand()
        {
            ...
            var builder = new global::ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.LinkedEligibleRoleAssignment.LinkedEligibleRoleAssignmentRequestBuilder(PathParameters);
        ...
        public Command BuildResourceNavCommand()
        {
            ...
            var builder = new global::ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.Resource.ResourceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRoleDefinitionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.RoleDefinition.RoleDefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSubjectNavCommand()
        {
            ...
            var builder = new global::ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.Subject.SubjectRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.GovernanceRoleAssignmentItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public GovernanceRoleAssignmentItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleAssignments/{governanceRoleAssignment%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.GovernanceRoleAssignmentItemRequestBuilder"/> and sets the default values.
        ...
        public GovernanceRoleAssignmentItemRequestBuilder(string rawUrl) : base("{+baseurl}/privilegedAccess/{privilegedAccess%2Did}/roleAssignments/{governanceRoleAssignment%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property roleAssignments for privilegedAccess
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.GovernanceRoleAssignmentItemRequestBuilder.GovernanceRoleAssignmentItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.GovernanceRoleAssignmentItemRequestBuilder.GovernanceRoleAssignmentItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
