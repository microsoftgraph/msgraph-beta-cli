// <auto-generated/>
using ApiSdk.DeviceManagement.VirtualEndpoint.DeviceImages.Item.Reupload;
...
namespace ApiSdk.DeviceManagement.VirtualEndpoint.DeviceImages.Item
{
    ...
    public class CloudPcDeviceImageItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property deviceImages in deviceManagement";
            var cloudPcDeviceImageIdOption = new Option<string>("--cloud-pc-device-image-id", description: "The unique identifier of cloudPcDeviceImage") {
            };
            cloudPcDeviceImageIdOption.IsRequired = true;
            command.AddOption(cloudPcDeviceImageIdOption);
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildReuploadNavCommand()
        {
            var command = new Command("reupload");
            command.Description = "Provides operations to call the reupload method.";
            var builder = new ApiSdk.DeviceManagement.VirtualEndpoint.DeviceImages.Item.Reupload.ReuploadRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceManagement.VirtualEndpoint.DeviceImages.Item.CloudPcDeviceImageItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public CloudPcDeviceImageItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceManagement/virtualEndpoint/deviceImages/{cloudPcDeviceImage%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceManagement.VirtualEndpoint.DeviceImages.Item.CloudPcDeviceImageItemRequestBuilder"/> and sets the default values.
        ...
        public CloudPcDeviceImageItemRequestBuilder(string rawUrl) : base("{+baseurl}/deviceManagement/virtualEndpoint/deviceImages/{cloudPcDeviceImage%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete a cloudPcDeviceImage object.
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceManagement.VirtualEndpoint.DeviceImages.Item.CloudPcDeviceImageItemRequestBuilder.CloudPcDeviceImageItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceManagement.VirtualEndpoint.DeviceImages.Item.CloudPcDeviceImageItemRequestBuilder.CloudPcDeviceImageItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.CloudPcDeviceImage body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.CloudPcDeviceImage body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
