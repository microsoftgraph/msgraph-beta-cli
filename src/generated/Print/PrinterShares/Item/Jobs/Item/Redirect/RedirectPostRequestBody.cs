...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Print.PrinterShares.Item.Jobs.Item.Redirect.RedirectPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Print.PrinterShares.Item.Jobs.Item.Redirect.RedirectPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Print.PrinterShares.Item.Jobs.Item.Redirect.RedirectPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Print.PrinterShares.Item.Jobs.Item.Redirect.RedirectPostRequestBody();
        }
        /// <summary>
