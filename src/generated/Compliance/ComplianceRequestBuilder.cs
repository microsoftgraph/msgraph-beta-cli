...
namespace ApiSdk.Compliance
{
    ...
    public class ComplianceRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildEdiscoveryNavCommand()
        {
            ...
            var builder = new ApiSdk.Compliance.Ediscovery.EdiscoveryRequestBuilder(PathParameters);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.Compliance>(ApiSdk.Models.Compliance.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Compliance.ComplianceRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Compliance.ComplianceRequestBuilder.ComplianceRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Compliance.ComplianceRequestBuilder.ComplianceRequestBuilderGetQueryParameters>> requestConfiguration = default)
