...
using ApiSdk.Models;
using ApiSdk.Storage.FileStorage.Containers.Item.Permissions.Item.Grant;
using ApiSdk.Storage.FileStorage.Containers.Item.Permissions.Item.RevokeGrants;
...
using System;
namespace ApiSdk.Storage.FileStorage.Containers.Item.Permissions.Item
{
    /// <summary>
    ...
    public class PermissionItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete permissions from a fileStorageContainer object.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/filestoragecontainer-delete-permissions?view=graph-rest-beta";
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "The set of permissions for users in the fileStorageContainer. The permission for each user is set by the roles property. The possible values are 'reader', 'writer', 'manager', and 'owner'. Read-write.";
            var fileStorageContainerIdOption = new Option<string>("--file-storage-container-id", description: "The unique identifier of fileStorageContainer") {
            };
            fileStorageContainerIdOption.IsRequired = true;
            command.AddOption(fileStorageContainerIdOption);
        ...
        public Command BuildGrantNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.Containers.Item.Permissions.Item.Grant.GrantRequestBuilder(PathParameters);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update an existing permission on a fileStorageContainer by making a PATCH request on the permission resource. Only the roles property can be updated.  One role per user is supported. A new ID is generated for the updated permissions object.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/filestoragecontainer-update-permissions?view=graph-rest-beta";
            var fileStorageContainerIdOption = new Option<string>("--file-storage-container-id", description: "The unique identifier of fileStorageContainer") {
            };
            fileStorageContainerIdOption.IsRequired = true;
            command.AddOption(fileStorageContainerIdOption);
        ...
        public Command BuildRevokeGrantsNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.Containers.Item.Permissions.Item.RevokeGrants.RevokeGrantsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.Containers.Item.Permissions.Item.PermissionItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public PermissionItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/permissions/{permission%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.Containers.Item.Permissions.Item.PermissionItemRequestBuilder"/> and sets the default values.
        ...
        public PermissionItemRequestBuilder(string rawUrl) : base("{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/permissions/{permission%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete permissions from a fileStorageContainer object.
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Storage.FileStorage.Containers.Item.Permissions.Item.PermissionItemRequestBuilder.PermissionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Storage.FileStorage.Containers.Item.Permissions.Item.PermissionItemRequestBuilder.PermissionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
