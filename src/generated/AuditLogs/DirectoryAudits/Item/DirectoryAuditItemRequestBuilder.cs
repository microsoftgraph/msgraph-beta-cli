...
namespace ApiSdk.AuditLogs.DirectoryAudits.Item
{
    ...
    public partial class DirectoryAuditItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                var directoryAuditId = invocationContext.ParseResult.GetValueForOption(directoryAuditIdOption);
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get a specific Microsoft Entra audit log item. This includes an audit log item generated by various services within Microsoft Entra ID like user, application, device and group management, privileged identity management (PIM), access reviews, terms of use, identity protection, password management (self-service and admin password resets), self-service group management, and so on.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/directoryaudit-get?view=graph-rest-beta";
            var directoryAuditIdOption = new Option<string>("--directory-audit-id", description: "The unique identifier of directoryAudit") {
            };
            directoryAuditIdOption.IsRequired = true;
            command.AddOption(directoryAuditIdOption);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.AuditLogs.DirectoryAudits.Item.DirectoryAuditItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.AuditLogs.DirectoryAudits.Item.DirectoryAuditItemRequestBuilder.DirectoryAuditItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.AuditLogs.DirectoryAudits.Item.DirectoryAuditItemRequestBuilder.DirectoryAuditItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.DirectoryAudit body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.DirectoryAudit body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
