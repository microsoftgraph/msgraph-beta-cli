...
namespace ApiSdk.DeviceManagement.VirtualEndpoint.DeviceImages.Item {
    ...
    public class CloudPcDeviceImageItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildReuploadNavCommand()
        {
            ...
            var builder = new ReuploadRequestBuilder(PathParameters);
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/deviceManagement/virtualEndpoint/deviceImages/{cloudPcDeviceImage%2Did}", PathParameters);
...
#nullable restore
        ...
        public RequestInformation ToPatchRequestInformation(CloudPcDeviceImage body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.PATCH, "{+baseurl}/deviceManagement/virtualEndpoint/deviceImages/{cloudPcDeviceImage%2Did}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
