...
namespace ApiSdk.Users.Item.OnlineMeetings.Item.AttendanceReports.Item {
    ...
    public class MeetingAttendanceReportItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public MeetingAttendanceReportItemRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/attendanceReports/{meetingAttendanceReport%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property attendanceReports for users
        /// </summary>
