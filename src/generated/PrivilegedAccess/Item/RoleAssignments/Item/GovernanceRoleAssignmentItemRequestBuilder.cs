...
namespace ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item
{
    ...
    public class GovernanceRoleAssignmentItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildLinkedEligibleRoleAssignmentNavCommand()
        {
            ...
            var builder = new ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.LinkedEligibleRoleAssignment.LinkedEligibleRoleAssignmentRequestBuilder(PathParameters);
        ...
        public Command BuildResourceNavCommand()
        {
            ...
            var builder = new ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.Resource.ResourceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRoleDefinitionNavCommand()
        {
            ...
            var builder = new ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.RoleDefinition.RoleDefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSubjectNavCommand()
        {
            ...
            var builder = new ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.Subject.SubjectRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.GovernanceRoleAssignmentItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.GovernanceRoleAssignmentItemRequestBuilder.GovernanceRoleAssignmentItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.GovernanceRoleAssignmentItemRequestBuilder.GovernanceRoleAssignmentItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
