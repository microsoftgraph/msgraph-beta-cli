...
using ApiSdk.DataClassification.ClassifyExactMatches;
using ApiSdk.DataClassification.ClassifyFile;
using ApiSdk.DataClassification.ClassifyFileJobs;
using ApiSdk.DataClassification.ClassifyTextJobs;
using ApiSdk.DataClassification.EvaluateDlpPoliciesJobs;
using ApiSdk.DataClassification.EvaluateLabelJobs;
using ApiSdk.DataClassification.ExactMatchDataStores;
using ApiSdk.DataClassification.ExactMatchUploadAgents;
using ApiSdk.DataClassification.Jobs;
using ApiSdk.DataClassification.SensitiveTypes;
using ApiSdk.DataClassification.SensitivityLabels;
...
namespace ApiSdk.DataClassification
{
    ...
    public partial class DataClassificationRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        /// Provides operations to call the classifyExactMatches method.
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildClassifyExactMatchesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DataClassification.ClassifyExactMatches.ClassifyExactMatchesRequestBuilder(PathParameters);
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildClassifyFileJobsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DataClassification.ClassifyFileJobs.ClassifyFileJobsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildClassifyFileNavCommand()
        {
            var command = new Command("classify-file");
            command.Description = "Provides operations to call the classifyFile method.";
            var builder = new global::ApiSdk.DataClassification.ClassifyFile.ClassifyFileRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildClassifyTextJobsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DataClassification.ClassifyTextJobs.ClassifyTextJobsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildEvaluateDlpPoliciesJobsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DataClassification.EvaluateDlpPoliciesJobs.EvaluateDlpPoliciesJobsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildEvaluateLabelJobsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DataClassification.EvaluateLabelJobs.EvaluateLabelJobsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildExactMatchDataStoresNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DataClassification.ExactMatchDataStores.ExactMatchDataStoresRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildExactMatchUploadAgentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DataClassification.ExactMatchUploadAgents.ExactMatchUploadAgentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get dataClassification";
        ...
        public Command BuildJobsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DataClassification.Jobs.JobsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update dataClassification";
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.DataClassificationService>(global::ApiSdk.Models.DataClassificationService.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildSensitiveTypesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DataClassification.SensitiveTypes.SensitiveTypesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildSensitivityLabelsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DataClassification.SensitivityLabels.SensitivityLabelsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.DataClassification.DataClassificationRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DataClassification.DataClassificationRequestBuilder.DataClassificationRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DataClassification.DataClassificationRequestBuilder.DataClassificationRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.DataClassificationService body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.DataClassificationService body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class DataClassificationRequestBuilderGetQueryParameters 
        {
