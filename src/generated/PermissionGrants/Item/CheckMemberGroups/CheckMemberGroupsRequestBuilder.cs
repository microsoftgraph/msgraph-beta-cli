...
using System;
namespace ApiSdk.PermissionGrants.Item.CheckMemberGroups
{
    /// <summary>
    ...
    public partial class CheckMemberGroupsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.PermissionGrants.Item.CheckMemberGroups.CheckMemberGroupsPostRequestBody>(global::ApiSdk.PermissionGrants.Item.CheckMemberGroups.CheckMemberGroupsPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.PermissionGrants.Item.CheckMemberGroups.CheckMemberGroupsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public CheckMemberGroupsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/permissionGrants/{resourceSpecificPermissionGrant%2Did}/checkMemberGroups", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.PermissionGrants.Item.CheckMemberGroups.CheckMemberGroupsRequestBuilder"/> and sets the default values.
        ...
        public CheckMemberGroupsRequestBuilder(string rawUrl) : base("{+baseurl}/permissionGrants/{resourceSpecificPermissionGrant%2Did}/checkMemberGroups", rawUrl)
        {
        }
        /// <summary>
        /// Check for membership in a specified list of group IDs, and return from that list those groups (identified by IDs) of which the specified user, group, service principal, organizational contact, device, or directory object is a member. This function is transitive. You can check up to a maximum of 20 groups per request. This function supports all groups provisioned in Microsoft Entra ID. Because Microsoft 365 groups cannot contain other groups, membership in a Microsoft 365 group is always direct.
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.PermissionGrants.Item.CheckMemberGroups.CheckMemberGroupsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.PermissionGrants.Item.CheckMemberGroups.CheckMemberGroupsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
