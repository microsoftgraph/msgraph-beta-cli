...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ShiftAvailability>? ShiftPreferencesAvailability { get; set; }
#nullable restore
#else
        public List<ShiftAvailability> ShiftPreferencesAvailability { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ShiftAvailability>? ShiftPreferencesAvailability0 { get; set; }
#nullable restore
#else
        public List<ShiftAvailability> ShiftPreferencesAvailability0 { get; set; }
#endif
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"availability", n => { ShiftPreferencesAvailability = n.GetCollectionOfObjectValues<ShiftAvailability>(ShiftAvailability.CreateFromDiscriminatorValue)?.ToList(); } },
                {"availability", n => { ShiftPreferencesAvailability0 = n.GetCollectionOfObjectValues<ShiftAvailability>(ShiftAvailability.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ShiftAvailability>("availability", ShiftPreferencesAvailability);
            writer.WriteCollectionOfObjectValues<ShiftAvailability>("availability", ShiftPreferencesAvailability0);
        }
    }
}
