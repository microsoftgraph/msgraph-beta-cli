...
using System;
namespace ApiSdk.Users.Item.PendingAccessReviewInstances.Item.Definition
{
    /// <summary>
    ...
    public partial class DefinitionRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.PendingAccessReviewInstances.Item.Definition.DefinitionRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public DefinitionRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/definition{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.PendingAccessReviewInstances.Item.Definition.DefinitionRequestBuilder"/> and sets the default values.
        ...
        public DefinitionRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/pendingAccessReviewInstances/{accessReviewInstance%2Did}/definition{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// There&apos;s exactly one accessReviewScheduleDefinition associated with each instance. It&apos;s the parent schedule for the instance, where instances are created for each recurrence of a review definition and each group selected to review by the definition.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.PendingAccessReviewInstances.Item.Definition.DefinitionRequestBuilder.DefinitionRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.PendingAccessReviewInstances.Item.Definition.DefinitionRequestBuilder.DefinitionRequestBuilderGetQueryParameters>> requestConfiguration = default)
