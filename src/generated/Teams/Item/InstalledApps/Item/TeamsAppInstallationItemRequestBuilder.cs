...
namespace ApiSdk.Teams.Item.InstalledApps.Item
{
    ...
    public class TeamsAppInstallationItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildTeamsAppDefinitionNavCommand()
        {
            ...
            var builder = new ApiSdk.Teams.Item.InstalledApps.Item.TeamsAppDefinition.TeamsAppDefinitionRequestBuilder(PathParameters);
        ...
        public Command BuildTeamsAppNavCommand()
        {
            ...
            var builder = new ApiSdk.Teams.Item.InstalledApps.Item.TeamsApp.TeamsAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUpgradeNavCommand()
        {
            ...
            var builder = new ApiSdk.Teams.Item.InstalledApps.Item.Upgrade.UpgradeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Teams.Item.InstalledApps.Item.TeamsAppInstallationItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Teams.Item.InstalledApps.Item.TeamsAppInstallationItemRequestBuilder.TeamsAppInstallationItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Teams.Item.InstalledApps.Item.TeamsAppInstallationItemRequestBuilder.TeamsAppInstallationItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
