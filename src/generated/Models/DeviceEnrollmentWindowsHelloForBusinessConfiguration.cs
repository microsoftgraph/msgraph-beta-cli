...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class DeviceEnrollmentWindowsHelloForBusinessConfiguration : ApiSdk.Models.DeviceEnrollmentConfiguration, IParsable
    {
        /// <summary>Possible values of a property</summary>
        public ApiSdk.Models.Enablement? EnhancedBiometricsState { get; set; }
        ...
        public ApiSdk.Models.WindowsHelloForBusinessPinUsage? PinLowercaseCharactersUsage { get; set; }
        ...
        /// <summary>Windows Hello for Business pin usage options</summary>
        public ApiSdk.Models.WindowsHelloForBusinessPinUsage? PinSpecialCharactersUsage { get; set; }
        /// <summary>Windows Hello for Business pin usage options</summary>
        public ApiSdk.Models.WindowsHelloForBusinessPinUsage? PinUppercaseCharactersUsage { get; set; }
        ...
        /// <summary>Possible values of a property</summary>
        public ApiSdk.Models.Enablement? SecurityKeyForSignIn { get; set; }
        /// <summary>Possible values of a property</summary>
        public ApiSdk.Models.Enablement? State { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.DeviceEnrollmentWindowsHelloForBusinessConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.DeviceEnrollmentWindowsHelloForBusinessConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.DeviceEnrollmentWindowsHelloForBusinessConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.DeviceEnrollmentWindowsHelloForBusinessConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "enhancedBiometricsState", n => { EnhancedBiometricsState = n.GetEnumValue<ApiSdk.Models.Enablement>(); } },
                { "enhancedSignInSecurity", n => { EnhancedSignInSecurity = n.GetIntValue(); } },
                { "pinExpirationInDays", n => { PinExpirationInDays = n.GetIntValue(); } },
                { "pinLowercaseCharactersUsage", n => { PinLowercaseCharactersUsage = n.GetEnumValue<ApiSdk.Models.WindowsHelloForBusinessPinUsage>(); } },
                ...
                { "pinSpecialCharactersUsage", n => { PinSpecialCharactersUsage = n.GetEnumValue<ApiSdk.Models.WindowsHelloForBusinessPinUsage>(); } },
                { "pinUppercaseCharactersUsage", n => { PinUppercaseCharactersUsage = n.GetEnumValue<ApiSdk.Models.WindowsHelloForBusinessPinUsage>(); } },
                ...
                { "securityKeyForSignIn", n => { SecurityKeyForSignIn = n.GetEnumValue<ApiSdk.Models.Enablement>(); } },
                { "state", n => { State = n.GetEnumValue<ApiSdk.Models.Enablement>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.Enablement>("enhancedBiometricsState", EnhancedBiometricsState);
            ...
            writer.WriteEnumValue<ApiSdk.Models.WindowsHelloForBusinessPinUsage>("pinLowercaseCharactersUsage", PinLowercaseCharactersUsage);
            ...
            writer.WriteEnumValue<ApiSdk.Models.WindowsHelloForBusinessPinUsage>("pinSpecialCharactersUsage", PinSpecialCharactersUsage);
            writer.WriteEnumValue<ApiSdk.Models.WindowsHelloForBusinessPinUsage>("pinUppercaseCharactersUsage", PinUppercaseCharactersUsage);
            ...
            writer.WriteEnumValue<ApiSdk.Models.Enablement>("securityKeyForSignIn", SecurityKeyForSignIn);
            writer.WriteEnumValue<ApiSdk.Models.Enablement>("state", State);
