...
namespace ApiSdk.DeviceAppManagement.MobileApps.Item {
    ...
    public class MobileAppItemRequestBuilder : BaseCliRequestBuilder {
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/intune-apps-iosstoreapp-delete?view=graph-rest-1.0" />
        /// </summary>
        public Command BuildDeleteCommand() {
            var command = new Command("delete");
            command.Description = "Deletes a iosStoreApp.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/intune-apps-iosstoreapp-delete?view=graph-rest-1.0";
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/intune-apps-windowswebapp-get?view=graph-rest-1.0" />
        /// </summary>
        public Command BuildGetCommand() {
            var command = new Command("get");
            command.Description = "Read properties and relationships of the windowsWebApp object.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/intune-apps-windowswebapp-get?view=graph-rest-1.0";
            var mobileAppIdOption = new Option<string>("--mobile-app-id", description: "The unique identifier of mobileApp") {
            };
            mobileAppIdOption.IsRequired = true;
            command.AddOption(mobileAppIdOption);
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/intune-apps-windowsmicrosoftedgeapp-update?view=graph-rest-1.0" />
        /// </summary>
        public Command BuildPatchCommand() {
            var command = new Command("patch");
            command.Description = "Update the properties of a windowsMicrosoftEdgeApp object.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/intune-apps-windowsmicrosoftedgeapp-update?view=graph-rest-1.0";
            var mobileAppIdOption = new Option<string>("--mobile-app-id", description: "The unique identifier of mobileApp") {
            };
            mobileAppIdOption.IsRequired = true;
            command.AddOption(mobileAppIdOption);
