...
namespace ApiSdk.RoleManagement.CloudPC.ResourceNamespaces.Item.ResourceActions.Item {
    ...
    public class UnifiedRbacResourceActionItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildAuthenticationContextNavCommand()
        {
            ...
            var builder = new AuthenticationContextRequestBuilder(PathParameters);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<UnifiedRbacResourceAction>(UnifiedRbacResourceAction.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildResourceScopeNavCommand()
        {
            ...
            var builder = new ResourceScopeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/roleManagement/cloudPC/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}", PathParameters);
...
#nullable restore
        ...
        public RequestInformation ToPatchRequestInformation(UnifiedRbacResourceAction body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.PATCH, "{+baseurl}/roleManagement/cloudPC/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
