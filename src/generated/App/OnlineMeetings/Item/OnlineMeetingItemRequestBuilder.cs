...
namespace ApiSdk.App.OnlineMeetings.Item
{
    ...
    public class OnlineMeetingItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAlternativeRecordingNavCommand()
        {
            ...
            var builder = new ApiSdk.App.OnlineMeetings.Item.AlternativeRecording.AlternativeRecordingRequestBuilder(PathParameters);
        ...
        public Command BuildAttendanceReportsNavCommand()
        {
            ...
            var builder = new ApiSdk.App.OnlineMeetings.Item.AttendanceReports.AttendanceReportsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildAttendeeReportNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the commsApplication entity.";
            var builder = new ApiSdk.App.OnlineMeetings.Item.AttendeeReport.AttendeeReportRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        public Command BuildBroadcastRecordingNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the commsApplication entity.";
            var builder = new ApiSdk.App.OnlineMeetings.Item.BroadcastRecording.BroadcastRecordingRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        public Command BuildGetVirtualAppointmentJoinWebUrlNavCommand()
        {
            ...
            var builder = new ApiSdk.App.OnlineMeetings.Item.GetVirtualAppointmentJoinWebUrl.GetVirtualAppointmentJoinWebUrlRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMeetingAttendanceReportNavCommand()
        {
            ...
            var builder = new ApiSdk.App.OnlineMeetings.Item.MeetingAttendanceReport.MeetingAttendanceReportRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildRecordingNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the commsApplication entity.";
            var builder = new ApiSdk.App.OnlineMeetings.Item.Recording.RecordingRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        public Command BuildRecordingsNavCommand()
        {
            ...
            var builder = new ApiSdk.App.OnlineMeetings.Item.Recordings.RecordingsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRegistrationNavCommand()
        {
            ...
            var builder = new ApiSdk.App.OnlineMeetings.Item.Registration.RegistrationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildSendVirtualAppointmentReminderSmsNavCommand()
        {
            ...
            var builder = new ApiSdk.App.OnlineMeetings.Item.SendVirtualAppointmentReminderSms.SendVirtualAppointmentReminderSmsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSendVirtualAppointmentSmsNavCommand()
        {
            ...
            var builder = new ApiSdk.App.OnlineMeetings.Item.SendVirtualAppointmentSms.SendVirtualAppointmentSmsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTranscriptsNavCommand()
        {
            ...
            var builder = new ApiSdk.App.OnlineMeetings.Item.Transcripts.TranscriptsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.App.OnlineMeetings.Item.OnlineMeetingItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.App.OnlineMeetings.Item.OnlineMeetingItemRequestBuilder.OnlineMeetingItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.App.OnlineMeetings.Item.OnlineMeetingItemRequestBuilder.OnlineMeetingItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
