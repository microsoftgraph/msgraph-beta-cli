...
using ApiSdk.AdministrativeUnits.Item.Members.Count;
using ApiSdk.AdministrativeUnits.Item.Members.GraphApplication;
using ApiSdk.AdministrativeUnits.Item.Members.GraphDevice;
using ApiSdk.AdministrativeUnits.Item.Members.GraphGroup;
using ApiSdk.AdministrativeUnits.Item.Members.GraphOrgContact;
using ApiSdk.AdministrativeUnits.Item.Members.GraphServicePrincipal;
using ApiSdk.AdministrativeUnits.Item.Members.GraphUser;
using ApiSdk.AdministrativeUnits.Item.Members.Item;
using ApiSdk.AdministrativeUnits.Item.Members.Ref;
...
namespace ApiSdk.AdministrativeUnits.Item.Members
{
    ...
    public partial class MembersRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new global::ApiSdk.AdministrativeUnits.Item.Members.Item.DirectoryObjectItemRequestBuilder(PathParameters);
        ...
        public Command BuildCountNavCommand()
        {
            ...
            var builder = new global::ApiSdk.AdministrativeUnits.Item.Members.Count.CountRequestBuilder(PathParameters);
        ...
        public Command BuildCreateCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.DirectoryObject>(global::ApiSdk.Models.DirectoryObject.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildGraphApplicationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.AdministrativeUnits.Item.Members.GraphApplication.GraphApplicationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGraphDeviceNavCommand()
        {
            ...
            var builder = new global::ApiSdk.AdministrativeUnits.Item.Members.GraphDevice.GraphDeviceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildGraphOrgContactNavCommand()
        {
            ...
            var builder = new global::ApiSdk.AdministrativeUnits.Item.Members.GraphOrgContact.GraphOrgContactRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildGraphServicePrincipalNavCommand()
        {
            ...
            var builder = new global::ApiSdk.AdministrativeUnits.Item.Members.GraphServicePrincipal.GraphServicePrincipalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildGraphUserNavCommand()
        {
            ...
            var builder = new global::ApiSdk.AdministrativeUnits.Item.Members.GraphUser.GraphUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
...
#nullable restore
        ...
        public Command BuildRefNavCommand()
        {
            ...
            var builder = new global::ApiSdk.AdministrativeUnits.Item.Members.Ref.RefRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.AdministrativeUnits.Item.Members.MembersRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public MembersRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.AdministrativeUnits.Item.Members.MembersRequestBuilder"/> and sets the default values.
        ...
        public MembersRequestBuilder(string rawUrl) : base("{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/members{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Users and groups that are members of this administrative unit. Supports $expand.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.AdministrativeUnits.Item.Members.MembersRequestBuilder.MembersRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.AdministrativeUnits.Item.Members.MembersRequestBuilder.MembersRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Models.DirectoryObject body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Models.DirectoryObject body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
