...
namespace ApiSdk.Security.ThreatIntelligence.Articles.Item
{
    ...
    public class ArticleItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildIndicatorsNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.ThreatIntelligence.Articles.Item.Indicators.IndicatorsRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Security.ThreatIntelligence.Articles.Item.ArticleItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.ThreatIntelligence.Articles.Item.ArticleItemRequestBuilder.ArticleItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.ThreatIntelligence.Articles.Item.ArticleItemRequestBuilder.ArticleItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Security.Article body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Security.Article body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
