...
namespace ApiSdk.Applications.Item.Synchronization.Templates.Item
{
    ...
    public class SynchronizationTemplateItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildSchemaNavCommand()
        {
            ...
            var builder = new ApiSdk.Applications.Item.Synchronization.Templates.Item.Schema.SchemaRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Applications.Item.Synchronization.Templates.Item.SynchronizationTemplateItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Applications.Item.Synchronization.Templates.Item.SynchronizationTemplateItemRequestBuilder.SynchronizationTemplateItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Applications.Item.Synchronization.Templates.Item.SynchronizationTemplateItemRequestBuilder.SynchronizationTemplateItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
