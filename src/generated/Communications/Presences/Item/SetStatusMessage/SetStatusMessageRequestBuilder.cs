    ...
    public class SetStatusMessageRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Communications.Presences.Item.SetStatusMessage.SetStatusMessagePostRequestBody>(ApiSdk.Communications.Presences.Item.SetStatusMessage.SetStatusMessagePostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Communications.Presences.Item.SetStatusMessage.SetStatusMessageRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Communications.Presences.Item.SetStatusMessage.SetStatusMessagePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Communications.Presences.Item.SetStatusMessage.SetStatusMessagePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
