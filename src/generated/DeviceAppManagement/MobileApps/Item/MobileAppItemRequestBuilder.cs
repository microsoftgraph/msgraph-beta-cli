...
namespace ApiSdk.DeviceAppManagement.MobileApps.Item
{
    ...
    public class MobileAppItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAssignmentsNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.Assignments.AssignmentsRequestBuilder(PathParameters);
        ...
        public Command BuildAssignNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.Assign.AssignRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCategoriesNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.Categories.CategoriesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildGraphAndroidForWorkAppByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidForWorkApp.GraphAndroidForWorkAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildGraphAndroidLobAppByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidLobApp.GraphAndroidLobAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAssignmentsNavCommand());
            nonExecCommands.Add(builder.BuildCategoriesNavCommand());
        ...
        public Command BuildGraphAndroidManagedStoreAppByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidManagedStoreApp.GraphAndroidManagedStoreAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAssignmentsNavCommand());
            nonExecCommands.Add(builder.BuildCategoriesNavCommand());
        ...
        public Command BuildGraphAndroidStoreAppByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidStoreApp.GraphAndroidStoreAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAssignmentsNavCommand());
            nonExecCommands.Add(builder.BuildCategoriesNavCommand());
        ...
        public Command BuildGraphIosLobAppByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphIosLobApp.GraphIosLobAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAssignmentsNavCommand());
            nonExecCommands.Add(builder.BuildCategoriesNavCommand());
        ...
        public Command BuildGraphIosStoreAppByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphIosStoreApp.GraphIosStoreAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAssignmentsNavCommand());
            nonExecCommands.Add(builder.BuildCategoriesNavCommand());
        ...
        public Command BuildGraphIosVppAppByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphIosVppApp.GraphIosVppAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildGraphMacOSDmgAppByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSDmgApp.GraphMacOSDmgAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAssignmentsNavCommand());
            nonExecCommands.Add(builder.BuildCategoriesNavCommand());
        ...
        public Command BuildGraphMacOSLobAppByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSLobApp.GraphMacOSLobAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAssignmentsNavCommand());
            nonExecCommands.Add(builder.BuildCategoriesNavCommand());
        ...
        public Command BuildGraphMacOSPkgAppByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp.GraphMacOSPkgAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAssignmentsNavCommand());
            nonExecCommands.Add(builder.BuildCategoriesNavCommand());
        ...
        public Command BuildGraphManagedAndroidLobAppByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphManagedAndroidLobApp.GraphManagedAndroidLobAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAssignmentsNavCommand());
            nonExecCommands.Add(builder.BuildCategoriesNavCommand());
        ...
        public Command BuildGraphManagedIOSLobAppByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphManagedIOSLobApp.GraphManagedIOSLobAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAssignmentsNavCommand());
            nonExecCommands.Add(builder.BuildCategoriesNavCommand());
        ...
        public Command BuildGraphManagedMobileLobAppByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphManagedMobileLobApp.GraphManagedMobileLobAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAssignmentsNavCommand());
            nonExecCommands.Add(builder.BuildCategoriesNavCommand());
        ...
        public Command BuildGraphMicrosoftStoreForBusinessAppByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMicrosoftStoreForBusinessApp.GraphMicrosoftStoreForBusinessAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAssignmentsNavCommand());
            nonExecCommands.Add(builder.BuildCategoriesNavCommand());
        ...
        public Command BuildGraphWin32LobAppByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWin32LobApp.GraphWin32LobAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAssignmentsNavCommand());
            nonExecCommands.Add(builder.BuildCategoriesNavCommand());
        ...
        public Command BuildGraphWindowsAppXByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsAppX.GraphWindowsAppXRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAssignmentsNavCommand());
            nonExecCommands.Add(builder.BuildCategoriesNavCommand());
        ...
        public Command BuildGraphWindowsMobileMSIByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsMobileMSI.GraphWindowsMobileMSIRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAssignmentsNavCommand());
            nonExecCommands.Add(builder.BuildCategoriesNavCommand());
        ...
        public Command BuildGraphWindowsStoreAppByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsStoreApp.GraphWindowsStoreAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAssignmentsNavCommand());
            nonExecCommands.Add(builder.BuildCategoriesNavCommand());
        ...
        public Command BuildGraphWindowsUniversalAppXByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsUniversalAppX.GraphWindowsUniversalAppXRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAssignmentsNavCommand());
            nonExecCommands.Add(builder.BuildCategoriesNavCommand());
        ...
        public Command BuildGraphWindowsWebAppByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsWebApp.GraphWindowsWebAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAssignmentsNavCommand());
            nonExecCommands.Add(builder.BuildCategoriesNavCommand());
        ...
        public Command BuildGraphWinGetAppByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWinGetApp.GraphWinGetAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAssignmentsNavCommand());
            nonExecCommands.Add(builder.BuildCategoriesNavCommand());
        ...
        public Command BuildRelationshipsNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.Relationships.RelationshipsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildUpdateRelationshipsNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.UpdateRelationships.UpdateRelationshipsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceAppManagement.MobileApps.Item.MobileAppItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceAppManagement.MobileApps.Item.MobileAppItemRequestBuilder.MobileAppItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceAppManagement.MobileApps.Item.MobileAppItemRequestBuilder.MobileAppItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.MobileApp body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.MobileApp body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
