...
using System;
namespace ApiSdk.Solutions.VirtualEvents.Webinars.Item.Sessions.Item
{
    /// <summary>
    ...
    public partial class VirtualEventSessionItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAttendanceReportsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Solutions.VirtualEvents.Webinars.Item.Sessions.Item.AttendanceReports.AttendanceReportsRequestBuilder(PathParameters);
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Read the properties and relationships of a virtualEventSession object.  Currently, the following virtual event types are supported: virtualEventTownhall and virtualEventWebinar.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/virtualeventsession-get?view=graph-rest-beta";
            var virtualEventWebinarIdOption = new Option<string>("--virtual-event-webinar-id", description: "The unique identifier of virtualEventWebinar") {
            };
            virtualEventWebinarIdOption.IsRequired = true;
            command.AddOption(virtualEventWebinarIdOption);
        ...
        public Command BuildPresentersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Solutions.VirtualEvents.Webinars.Item.Sessions.Item.Presenters.PresentersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildRegistrationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Solutions.VirtualEvents.Webinars.Item.Sessions.Item.Registrations.RegistrationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildRegistrationsWithEmailRbCommand()
        {
            ...
            command.Description = "Provides operations to manage the registrations property of the microsoft.graph.virtualEventSession entity.";
            var builder = new global::ApiSdk.Solutions.VirtualEvents.Webinars.Item.Sessions.Item.RegistrationsWithEmail.RegistrationsWithEmailRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildRegistrationsWithUserIdRbCommand()
        {
            ...
            command.Description = "Provides operations to manage the registrations property of the microsoft.graph.virtualEventSession entity.";
            var builder = new global::ApiSdk.Solutions.VirtualEvents.Webinars.Item.Sessions.Item.RegistrationsWithUserId.RegistrationsWithUserIdRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Solutions.VirtualEvents.Webinars.Item.Sessions.Item.VirtualEventSessionItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Solutions.VirtualEvents.Webinars.Item.Sessions.Item.VirtualEventSessionItemRequestBuilder.VirtualEventSessionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Solutions.VirtualEvents.Webinars.Item.Sessions.Item.VirtualEventSessionItemRequestBuilder.VirtualEventSessionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
