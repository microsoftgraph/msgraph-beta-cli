...
namespace ApiSdk.DirectoryNamespace.InboundSharedUserProfiles.Item.ExportPersonalData {
    ...
    public class ExportPersonalDataRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/inboundshareduserprofile-exportpersonaldata?view=graph-rest-1.0" />
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildPostCommand()
        {
            var command = new Command("post");
            command.Description = "Create a request to export the personal data for an inboundSharedUserProfile.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/inboundshareduserprofile-exportpersonaldata?view=graph-rest-1.0";
