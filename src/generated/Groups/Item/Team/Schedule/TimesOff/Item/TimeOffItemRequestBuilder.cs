...
using System;
namespace ApiSdk.Groups.Item.Team.Schedule.TimesOff.Item {
    /// <summary>
    ...
    public class TimeOffItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public TimeOffItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/team/schedule/timesOff/{timeOff%2Did}{?%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="TimeOffItemRequestBuilder"/> and sets the default values.
        ...
        public TimeOffItemRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/team/schedule/timesOff/{timeOff%2Did}{?%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete a timeOff instance from a schedule.
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/groups/{group%2Did}/team/schedule/timesOff/{timeOff%2Did}", PathParameters);
...
#nullable restore
        ...
        public RequestInformation ToPatchRequestInformation(TimeOff body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.PATCH, "{+baseurl}/groups/{group%2Did}/team/schedule/timesOff/{timeOff%2Did}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
