...
using ApiSdk.Identity.B2cUserFlows.Item.IdentityProviders;
using ApiSdk.Identity.B2cUserFlows.Item.Languages;
using ApiSdk.Identity.B2cUserFlows.Item.UserAttributeAssignments;
using ApiSdk.Identity.B2cUserFlows.Item.UserFlowIdentityProviders;
...
namespace ApiSdk.Identity.B2cUserFlows.Item
{
    ...
    public partial class B2cIdentityUserFlowItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildIdentityProvidersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Identity.B2cUserFlows.Item.IdentityProviders.IdentityProvidersRequestBuilder(PathParameters);
        ...
        public Command BuildLanguagesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Identity.B2cUserFlows.Item.Languages.LanguagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.B2cIdentityUserFlow>(global::ApiSdk.Models.B2cIdentityUserFlow.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildUserAttributeAssignmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Identity.B2cUserFlows.Item.UserAttributeAssignments.UserAttributeAssignmentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
            nonExecCommands.Add(builder.BuildGetOrderNavCommand());
            execCommands.Add(builder.BuildListCommand());
            nonExecCommands.Add(builder.BuildSetOrderNavCommand());
            var cmds = builder.BuildCommand();
            execCommands.AddRange(cmds.Item1);
            nonExecCommands.AddRange(cmds.Item2);
            foreach (var cmd in execCommands)
        ...
        public Command BuildUserFlowIdentityProvidersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Identity.B2cUserFlows.Item.UserFlowIdentityProviders.UserFlowIdentityProvidersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Identity.B2cUserFlows.Item.B2cIdentityUserFlowItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Identity.B2cUserFlows.Item.B2cIdentityUserFlowItemRequestBuilder.B2cIdentityUserFlowItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Identity.B2cUserFlows.Item.B2cIdentityUserFlowItemRequestBuilder.B2cIdentityUserFlowItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.B2cIdentityUserFlow body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.B2cIdentityUserFlow body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class B2cIdentityUserFlowItemRequestBuilderGetQueryParameters 
        {
