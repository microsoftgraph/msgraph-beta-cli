...
using ApiSdk.Models;
using ApiSdk.RoleManagement.CloudPC.RoleAssignments.Item.AppScopes;
using ApiSdk.RoleManagement.CloudPC.RoleAssignments.Item.DirectoryScopes;
using ApiSdk.RoleManagement.CloudPC.RoleAssignments.Item.Principals;
using ApiSdk.RoleManagement.CloudPC.RoleAssignments.Item.RoleDefinition;
...
using System;
namespace ApiSdk.RoleManagement.CloudPC.RoleAssignments.Item
{
    /// <summary>
    ...
    public partial class UnifiedRoleAssignmentMultipleItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAppScopesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.CloudPC.RoleAssignments.Item.AppScopes.AppScopesRequestBuilder(PathParameters);
        ...
        public Command BuildDirectoryScopesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.CloudPC.RoleAssignments.Item.DirectoryScopes.DirectoryScopesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildPrincipalsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.CloudPC.RoleAssignments.Item.Principals.PrincipalsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildRoleDefinitionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.CloudPC.RoleAssignments.Item.RoleDefinition.RoleDefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.RoleManagement.CloudPC.RoleAssignments.Item.UnifiedRoleAssignmentMultipleItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.RoleManagement.CloudPC.RoleAssignments.Item.UnifiedRoleAssignmentMultipleItemRequestBuilder.UnifiedRoleAssignmentMultipleItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.RoleManagement.CloudPC.RoleAssignments.Item.UnifiedRoleAssignmentMultipleItemRequestBuilder.UnifiedRoleAssignmentMultipleItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
