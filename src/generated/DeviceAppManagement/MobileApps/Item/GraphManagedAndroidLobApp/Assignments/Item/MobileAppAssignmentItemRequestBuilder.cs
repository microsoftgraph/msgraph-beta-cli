...
using System;
namespace ApiSdk.DeviceAppManagement.MobileApps.Item.GraphManagedAndroidLobApp.Assignments.Item {
    /// <summary>
    ...
    public class MobileAppAssignmentItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public MobileAppAssignmentItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.managedAndroidLobApp/assignments/{mobileAppAssignment%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="MobileAppAssignmentItemRequestBuilder"/> and sets the default values.
        ...
        public MobileAppAssignmentItemRequestBuilder(string rawUrl) : base("{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.managedAndroidLobApp/assignments/{mobileAppAssignment%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property assignments for deviceAppManagement
