...
#nullable enable
        public List<AgreementFileLocalization>? AgreementFileLocalizations { get; set; }
#nullable restore
#else
        public List<AgreementFileLocalization> AgreementFileLocalizations { get; set; }
#endif
...
#nullable restore
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"localizations", n => { AgreementFileLocalizations = n.GetCollectionOfObjectValues<AgreementFileLocalization>(AgreementFileLocalization.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<AgreementFileLocalization>("localizations", AgreementFileLocalizations);
