...
using ApiSdk.Models;
using ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Workbook.Tables.Item.Rows.ItemAtWithIndex.RangeNamespace;
...
using System;
namespace ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Workbook.Tables.Item.Rows.ItemAtWithIndex
{
    /// <summary>
    ...
    public class ItemAtWithIndexRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildRangeNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Workbook.Tables.Item.Rows.ItemAtWithIndex.RangeNamespace.RangeRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Workbook.Tables.Item.Rows.ItemAtWithIndex.ItemAtWithIndexRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public ItemAtWithIndexRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/rows/itemAt(index={index})", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Workbook.Tables.Item.Rows.ItemAtWithIndex.ItemAtWithIndexRequestBuilder"/> and sets the default values.
        ...
        public ItemAtWithIndexRequestBuilder(string rawUrl) : base("{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/rows/itemAt(index={index})", rawUrl)
        {
        }
        /// <summary>
        /// Gets a row based on its position in the collection.
