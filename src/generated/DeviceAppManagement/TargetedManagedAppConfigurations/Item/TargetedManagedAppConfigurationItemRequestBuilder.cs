...
using ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.ChangeSettings;
using ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.DeploymentSummary;
using ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.Settings;
...
namespace ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item
{
    ...
    public partial class TargetedManagedAppConfigurationItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildAppsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.Apps.AppsRequestBuilder(PathParameters);
        ...
        public Command BuildAssignmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.Assignments.AssignmentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildAssignNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.Assign.AssignRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildChangeSettingsNavCommand()
        {
            var command = new Command("change-settings");
            command.Description = "Provides operations to call the changeSettings method.";
            var builder = new global::ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.ChangeSettings.ChangeSettingsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDeploymentSummaryNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.DeploymentSummary.DeploymentSummaryRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.TargetedManagedAppConfiguration>(global::ApiSdk.Models.TargetedManagedAppConfiguration.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildSettingsNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the settings property of the microsoft.graph.managedAppConfiguration entity.";
            var builder = new global::ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.Settings.SettingsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildTargetAppsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.TargetApps.TargetAppsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.TargetedManagedAppConfigurationItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public TargetedManagedAppConfigurationItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceAppManagement/targetedManagedAppConfigurations/{targetedManagedAppConfiguration%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.TargetedManagedAppConfigurationItemRequestBuilder"/> and sets the default values.
        ...
        public TargetedManagedAppConfigurationItemRequestBuilder(string rawUrl) : base("{+baseurl}/deviceAppManagement/targetedManagedAppConfigurations/{targetedManagedAppConfiguration%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property targetedManagedAppConfigurations for deviceAppManagement
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.TargetedManagedAppConfigurationItemRequestBuilder.TargetedManagedAppConfigurationItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.TargetedManagedAppConfigurationItemRequestBuilder.TargetedManagedAppConfigurationItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.TargetedManagedAppConfiguration body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.TargetedManagedAppConfiguration body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
