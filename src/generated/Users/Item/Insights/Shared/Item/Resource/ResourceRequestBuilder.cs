...
namespace ApiSdk.Users.Item.Insights.Shared.Item.Resource {
    ...
    public class ResourceRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public ResourceRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/insights/shared/{sharedInsight%2Did}/resource{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ResourceRequestBuilder"/> and sets the default values.
        ...
        public ResourceRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/insights/shared/{sharedInsight%2Did}/resource{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Used for navigating to the item that was shared. For file attachments, the type is fileAttachment. For linked attachments, the type is driveItem.
