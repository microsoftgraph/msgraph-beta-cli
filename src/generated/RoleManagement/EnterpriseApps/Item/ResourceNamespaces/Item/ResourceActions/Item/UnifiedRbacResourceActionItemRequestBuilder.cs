...
using ApiSdk.Models;
using ApiSdk.RoleManagement.EnterpriseApps.Item.ResourceNamespaces.Item.ResourceActions.Item.AuthenticationContext;
using ApiSdk.RoleManagement.EnterpriseApps.Item.ResourceNamespaces.Item.ResourceActions.Item.ResourceScope;
...
using System;
namespace ApiSdk.RoleManagement.EnterpriseApps.Item.ResourceNamespaces.Item.ResourceActions.Item
{
    /// <summary>
    ...
    public class UnifiedRbacResourceActionItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAuthenticationContextNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EnterpriseApps.Item.ResourceNamespaces.Item.ResourceActions.Item.AuthenticationContext.AuthenticationContextRequestBuilder(PathParameters);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.UnifiedRbacResourceAction>(ApiSdk.Models.UnifiedRbacResourceAction.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildResourceScopeNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EnterpriseApps.Item.ResourceNamespaces.Item.ResourceActions.Item.ResourceScope.ResourceScopeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.RoleManagement.EnterpriseApps.Item.ResourceNamespaces.Item.ResourceActions.Item.UnifiedRbacResourceActionItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public UnifiedRbacResourceActionItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.RoleManagement.EnterpriseApps.Item.ResourceNamespaces.Item.ResourceActions.Item.UnifiedRbacResourceActionItemRequestBuilder"/> and sets the default values.
        ...
        public UnifiedRbacResourceActionItemRequestBuilder(string rawUrl) : base("{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property resourceActions for roleManagement
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.EnterpriseApps.Item.ResourceNamespaces.Item.ResourceActions.Item.UnifiedRbacResourceActionItemRequestBuilder.UnifiedRbacResourceActionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.EnterpriseApps.Item.ResourceNamespaces.Item.ResourceActions.Item.UnifiedRbacResourceActionItemRequestBuilder.UnifiedRbacResourceActionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.UnifiedRbacResourceAction body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.UnifiedRbacResourceAction body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
