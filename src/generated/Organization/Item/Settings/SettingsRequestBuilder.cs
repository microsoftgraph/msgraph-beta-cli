...
using ApiSdk.Models;
using ApiSdk.Organization.Item.Settings.ContactInsights;
using ApiSdk.Organization.Item.Settings.ItemInsights;
using ApiSdk.Organization.Item.Settings.MicrosoftApplicationDataAccess;
using ApiSdk.Organization.Item.Settings.PeopleInsights;
...
namespace ApiSdk.Organization.Item.Settings
{
    ...
    public partial class SettingsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildContactInsightsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Organization.Item.Settings.ContactInsights.ContactInsightsRequestBuilder(PathParameters);
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property settings for organization";
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Retrieve the properties and relationships of organizationSettings object. Nullable.";
            var organizationIdOption = new Option<string>("--organization-id", description: "The unique identifier of organization") {
            };
            organizationIdOption.IsRequired = true;
            command.AddOption(organizationIdOption);
        ...
        public Command BuildItemInsightsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Organization.Item.Settings.ItemInsights.ItemInsightsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildMicrosoftApplicationDataAccessNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Organization.Item.Settings.MicrosoftApplicationDataAccess.MicrosoftApplicationDataAccessRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property settings in organization";
            var organizationIdOption = new Option<string>("--organization-id", description: "The unique identifier of organization") {
            };
            organizationIdOption.IsRequired = true;
            command.AddOption(organizationIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.OrganizationSettings>(global::ApiSdk.Models.OrganizationSettings.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildPeopleInsightsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Organization.Item.Settings.PeopleInsights.PeopleInsightsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Organization.Item.Settings.SettingsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Organization.Item.Settings.SettingsRequestBuilder.SettingsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Organization.Item.Settings.SettingsRequestBuilder.SettingsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.OrganizationSettings body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.OrganizationSettings body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
