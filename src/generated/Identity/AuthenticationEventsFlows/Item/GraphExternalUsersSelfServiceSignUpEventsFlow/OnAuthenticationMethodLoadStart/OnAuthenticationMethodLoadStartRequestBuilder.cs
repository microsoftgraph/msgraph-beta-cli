...
namespace ApiSdk.Identity.AuthenticationEventsFlows.Item.GraphExternalUsersSelfServiceSignUpEventsFlow.OnAuthenticationMethodLoadStart {
    ...
    public class OnAuthenticationMethodLoadStartRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Required. The configuration for what to invoke when authentication methods are ready to be presented to the user. Must have at least one identity provider linked.";
        ...
        public Command BuildGraphOnAuthenticationMethodLoadStartExternalUsersSelfServiceSignUpNavCommand()
        {
            ...
            var builder = new GraphOnAuthenticationMethodLoadStartExternalUsersSelfServiceSignUpRequestBuilder(PathParameters);
