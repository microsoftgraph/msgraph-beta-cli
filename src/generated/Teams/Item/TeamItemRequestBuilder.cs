...
using ApiSdk.Teams.Item.Owners;
using ApiSdk.Teams.Item.OwnersWithUserPrincipalName;
using ApiSdk.Teams.Item.PermissionGrants;
...
using ApiSdk.Teams.Item.TemplateDefinition;
...
namespace ApiSdk.Teams.Item
{
    ...
    public partial class TeamItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAllChannelsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.AllChannels.AllChannelsRequestBuilder(PathParameters);
        ...
        public Command BuildArchiveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Archive.ArchiveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildChannelsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Channels.ChannelsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildCloneNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Clone.CloneRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildCompleteMigrationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.CompleteMigration.CompleteMigrationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGroupNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Group.GroupRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildIncomingChannelsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.IncomingChannels.IncomingChannelsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildInstalledAppsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.InstalledApps.InstalledAppsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildMembersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Members.MembersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildOperationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Operations.OperationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildOwnersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Owners.OwnersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildOwnersWithUserPrincipalNameRbCommand()
        {
            ...
            command.Description = "Provides operations to manage the owners property of the microsoft.graph.team entity.";
            var builder = new global::ApiSdk.Teams.Item.OwnersWithUserPrincipalName.OwnersWithUserPrincipalNameRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPermissionGrantsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.PermissionGrants.PermissionGrantsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPhotoNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Photo.PhotoRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildPrimaryChannelNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.PrimaryChannel.PrimaryChannelRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildScheduleNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Schedule.ScheduleRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildSendActivityNotificationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.SendActivityNotification.SendActivityNotificationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTagsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Tags.TagsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildTemplateDefinitionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.TemplateDefinition.TemplateDefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTemplateNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Template.TemplateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUnarchiveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Unarchive.UnarchiveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Teams.Item.TeamItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Teams.Item.TeamItemRequestBuilder.TeamItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Teams.Item.TeamItemRequestBuilder.TeamItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
