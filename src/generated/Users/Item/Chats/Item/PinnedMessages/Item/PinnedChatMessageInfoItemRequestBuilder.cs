...
using ApiSdk.Models;
using ApiSdk.Users.Item.Chats.Item.PinnedMessages.Item.Message;
...
namespace ApiSdk.Users.Item.Chats.Item.PinnedMessages.Item {
    ...
    public class PinnedChatMessageInfoItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public PinnedChatMessageInfoItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/pinnedMessages/{pinnedChatMessageInfo%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PinnedChatMessageInfoItemRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public PinnedChatMessageInfoItemRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/pinnedMessages/{pinnedChatMessageInfo%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Unpin a message from a chat.
        /// </summary>
