...
namespace ApiSdk.Models
{
    ...
    public class RecommendationBase : ApiSdk.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>List of actions to take to complete a recommendation.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.ActionStep>? ActionSteps { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.ActionStep> ActionSteps { get; set; }
#endif
...
#nullable restore
        ...
        public ApiSdk.Models.RecommendationCategory? Category { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.RecommendationFeatureAreas?>? FeatureAreas { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.RecommendationFeatureAreas?> FeatureAreas { get; set; }
#endif
...
#nullable restore
        ...
        public ApiSdk.Models.RecommendationPriority? Priority { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.RecommendationBase"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.RecommendationBase CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            return mappingValue switch
            {
                ...
                _ => new ApiSdk.Models.RecommendationBase(),
            };
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "actionSteps", n => { ActionSteps = n.GetCollectionOfObjectValues<ApiSdk.Models.ActionStep>(ApiSdk.Models.ActionStep.CreateFromDiscriminatorValue)?.ToList(); } },
                { "benefits", n => { Benefits = n.GetStringValue(); } },
                { "category", n => { Category = n.GetEnumValue<ApiSdk.Models.RecommendationCategory>(); } },
                { "createdDateTime", n => { CreatedDateTime = n.GetDateTimeOffsetValue(); } },
                { "currentScore", n => { CurrentScore = n.GetDoubleValue(); } },
                { "displayName", n => { DisplayName = n.GetStringValue(); } },
                { "featureAreas", n => { FeatureAreas = n.GetCollectionOfEnumValues<ApiSdk.Models.RecommendationFeatureAreas>()?.ToList(); } },
                ...
                { "priority", n => { Priority = n.GetEnumValue<ApiSdk.Models.RecommendationPriority>(); } },
                { "recommendationType", n => { RecommendationType = n.GetEnumValue<ApiSdk.Models.RecommendationType>(); } },
                { "releaseType", n => { ReleaseType = n.GetStringValue(); } },
                { "remediationImpact", n => { RemediationImpact = n.GetStringValue(); } },
                { "requiredLicenses", n => { RequiredLicenses = n.GetEnumValue<ApiSdk.Models.RequiredLicenses>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.ActionStep>("actionSteps", ActionSteps);
            writer.WriteStringValue("benefits", Benefits);
            writer.WriteEnumValue<ApiSdk.Models.RecommendationCategory>("category", Category);
            writer.WriteDateTimeOffsetValue("createdDateTime", CreatedDateTime);
            writer.WriteDoubleValue("currentScore", CurrentScore);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteCollectionOfEnumValues<ApiSdk.Models.RecommendationFeatureAreas>("featureAreas", FeatureAreas);
            ...
            writer.WriteEnumValue<ApiSdk.Models.RecommendationPriority>("priority", Priority);
            writer.WriteEnumValue<ApiSdk.Models.RecommendationType>("recommendationType", RecommendationType);
            writer.WriteStringValue("releaseType", ReleaseType);
            writer.WriteStringValue("remediationImpact", RemediationImpact);
            writer.WriteEnumValue<ApiSdk.Models.RequiredLicenses>("requiredLicenses", RequiredLicenses);
