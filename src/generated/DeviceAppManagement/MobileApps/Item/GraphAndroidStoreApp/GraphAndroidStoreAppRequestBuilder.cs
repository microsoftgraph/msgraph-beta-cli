...
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidStoreApp.Assignments;
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidStoreApp.Categories;
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidStoreApp.Relationships;
...
namespace ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidStoreApp
{
    ...
    public partial class GraphAndroidStoreAppRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildAssignmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidStoreApp.Assignments.AssignmentsRequestBuilder(PathParameters);
        ...
        public Command BuildCategoriesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidStoreApp.Categories.CategoriesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get the item of type microsoft.graph.mobileApp as microsoft.graph.androidStoreApp";
        ...
        public Command BuildRelationshipsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidStoreApp.Relationships.RelationshipsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidStoreApp.GraphAndroidStoreAppRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidStoreApp.GraphAndroidStoreAppRequestBuilder.GraphAndroidStoreAppRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidStoreApp.GraphAndroidStoreAppRequestBuilder.GraphAndroidStoreAppRequestBuilderGetQueryParameters>> requestConfiguration = default)
