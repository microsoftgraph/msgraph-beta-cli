...
namespace ApiSdk.BookingBusinesses.Item
{
    ...
    public partial class BookingBusinessItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildCalendarViewNavCommand()
        {
            ...
            var builder = new global::ApiSdk.BookingBusinesses.Item.CalendarView.CalendarViewRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildCustomersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.BookingBusinesses.Item.Customers.CustomersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildGetStaffAvailabilityNavCommand()
        {
            ...
            var builder = new global::ApiSdk.BookingBusinesses.Item.GetStaffAvailability.GetStaffAvailabilityRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.BookingBusiness>(global::ApiSdk.Models.BookingBusiness.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPublishNavCommand()
        {
            ...
            var builder = new global::ApiSdk.BookingBusinesses.Item.Publish.PublishRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildServicesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.BookingBusinesses.Item.Services.ServicesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildStaffMembersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.BookingBusinesses.Item.StaffMembers.StaffMembersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildUnpublishNavCommand()
        {
            ...
            var builder = new global::ApiSdk.BookingBusinesses.Item.Unpublish.UnpublishRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.BookingBusinesses.Item.BookingBusinessItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.BookingBusinesses.Item.BookingBusinessItemRequestBuilder.BookingBusinessItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.BookingBusinesses.Item.BookingBusinessItemRequestBuilder.BookingBusinessItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.BookingBusiness body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.BookingBusiness body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
