...
using ApiSdk.Models;
using ApiSdk.Teams.Item.Schedule.TimeCards.Item.ClockOut;
using ApiSdk.Teams.Item.Schedule.TimeCards.Item.Confirm;
using ApiSdk.Teams.Item.Schedule.TimeCards.Item.ConfirmForUser;
using ApiSdk.Teams.Item.Schedule.TimeCards.Item.EndBreak;
using ApiSdk.Teams.Item.Schedule.TimeCards.Item.StartBreak;
...
namespace ApiSdk.Teams.Item.Schedule.TimeCards.Item
{
    ...
    public partial class TimeCardItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildClockOutNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Schedule.TimeCards.Item.ClockOut.ClockOutRequestBuilder(PathParameters);
        ...
        public Command BuildConfirmForUserNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Schedule.TimeCards.Item.ConfirmForUser.ConfirmForUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildConfirmNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Schedule.TimeCards.Item.Confirm.ConfirmRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildEndBreakNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Schedule.TimeCards.Item.EndBreak.EndBreakRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildStartBreakNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Schedule.TimeCards.Item.StartBreak.StartBreakRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Teams.Item.Schedule.TimeCards.Item.TimeCardItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Teams.Item.Schedule.TimeCards.Item.TimeCardItemRequestBuilder.TimeCardItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Teams.Item.Schedule.TimeCards.Item.TimeCardItemRequestBuilder.TimeCardItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
