...
namespace ApiSdk.DirectoryRoleTemplates
{
    ...
    public class DirectoryRoleTemplatesRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new ApiSdk.DirectoryRoleTemplates.Item.DirectoryRoleTemplateItemRequestBuilder(PathParameters);
        ...
        public Command BuildCountNavCommand()
        {
            ...
            var builder = new ApiSdk.DirectoryRoleTemplates.Count.CountRequestBuilder(PathParameters);
        ...
        public Command BuildDeltaNavCommand()
        {
            ...
            var builder = new ApiSdk.DirectoryRoleTemplates.Delta.DeltaRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetByIdsNavCommand()
        {
            ...
            var builder = new ApiSdk.DirectoryRoleTemplates.GetByIds.GetByIdsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGetUserOwnedObjectsNavCommand()
        {
            ...
            var builder = new ApiSdk.DirectoryRoleTemplates.GetUserOwnedObjects.GetUserOwnedObjectsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
...
#nullable restore
        ...
        public Command BuildValidatePropertiesNavCommand()
        {
            ...
            var builder = new ApiSdk.DirectoryRoleTemplates.ValidateProperties.ValidatePropertiesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DirectoryRoleTemplates.DirectoryRoleTemplatesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DirectoryRoleTemplates.DirectoryRoleTemplatesRequestBuilder.DirectoryRoleTemplatesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DirectoryRoleTemplates.DirectoryRoleTemplatesRequestBuilder.DirectoryRoleTemplatesRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Models.DirectoryRoleTemplate body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Models.DirectoryRoleTemplate body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
