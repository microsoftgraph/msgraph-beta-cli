...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class AndroidDeviceOwnerEnrollmentProfile : ApiSdk.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        public ApiSdk.Models.AndroidDeviceOwnerEnrollmentMode? EnrollmentMode { get; set; }
        /// <summary>The enrollment token type for an enrollment profile.</summary>
        public ApiSdk.Models.AndroidDeviceOwnerEnrollmentTokenType? EnrollmentTokenType { get; set; }
...
#nullable restore
        ...
        public ApiSdk.Models.AospWifiSecurityType? WifiSecurityType { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.AndroidDeviceOwnerEnrollmentProfile"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.AndroidDeviceOwnerEnrollmentProfile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.AndroidDeviceOwnerEnrollmentProfile();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "enrollmentMode", n => { EnrollmentMode = n.GetEnumValue<ApiSdk.Models.AndroidDeviceOwnerEnrollmentMode>(); } },
                { "enrollmentTokenType", n => { EnrollmentTokenType = n.GetEnumValue<ApiSdk.Models.AndroidDeviceOwnerEnrollmentTokenType>(); } },
                ...
                { "wifiSecurityType", n => { WifiSecurityType = n.GetEnumValue<ApiSdk.Models.AospWifiSecurityType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.AndroidDeviceOwnerEnrollmentMode>("enrollmentMode", EnrollmentMode);
            writer.WriteEnumValue<ApiSdk.Models.AndroidDeviceOwnerEnrollmentTokenType>("enrollmentTokenType", EnrollmentTokenType);
            ...
            writer.WriteEnumValue<ApiSdk.Models.AospWifiSecurityType>("wifiSecurityType", WifiSecurityType);
