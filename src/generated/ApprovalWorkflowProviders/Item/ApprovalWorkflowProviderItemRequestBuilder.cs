...
using ApiSdk.ApprovalWorkflowProviders.Item.BusinessFlows;
using ApiSdk.ApprovalWorkflowProviders.Item.BusinessFlowsWithRequestsAwaitingMyDecision;
using ApiSdk.ApprovalWorkflowProviders.Item.PolicyTemplates;
...
namespace ApiSdk.ApprovalWorkflowProviders.Item
{
    ...
    public partial class ApprovalWorkflowProviderItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        /// Provides operations to manage the businessFlows property of the microsoft.graph.approvalWorkflowProvider entity.
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildBusinessFlowsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.ApprovalWorkflowProviders.Item.BusinessFlows.BusinessFlowsRequestBuilder(PathParameters);
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildBusinessFlowsWithRequestsAwaitingMyDecisionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.ApprovalWorkflowProviders.Item.BusinessFlowsWithRequestsAwaitingMyDecision.BusinessFlowsWithRequestsAwaitingMyDecisionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete entity from approvalWorkflowProviders";
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get entity from approvalWorkflowProviders by key";
            var approvalWorkflowProviderIdOption = new Option<string>("--approval-workflow-provider-id", description: "The unique identifier of approvalWorkflowProvider") {
            };
            approvalWorkflowProviderIdOption.IsRequired = true;
            command.AddOption(approvalWorkflowProviderIdOption);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update entity in approvalWorkflowProviders";
            var approvalWorkflowProviderIdOption = new Option<string>("--approval-workflow-provider-id", description: "The unique identifier of approvalWorkflowProvider") {
            };
            approvalWorkflowProviderIdOption.IsRequired = true;
            command.AddOption(approvalWorkflowProviderIdOption);
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildPolicyTemplatesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.ApprovalWorkflowProviders.Item.PolicyTemplates.PolicyTemplatesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.ApprovalWorkflowProviders.Item.ApprovalWorkflowProviderItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.ApprovalWorkflowProviders.Item.ApprovalWorkflowProviderItemRequestBuilder.ApprovalWorkflowProviderItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.ApprovalWorkflowProviders.Item.ApprovalWorkflowProviderItemRequestBuilder.ApprovalWorkflowProviderItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.ApprovalWorkflowProvider body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.ApprovalWorkflowProvider body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ApprovalWorkflowProviderItemRequestBuilderGetQueryParameters 
        {
