...
namespace ApiSdk.Security.ThreatIntelligence.Vulnerabilities.Item.Components
{
    ...
    public class ComponentsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new VulnerabilityComponentItemRequestBuilder(PathParameters);
        ...
        public Command BuildCreateCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<VulnerabilityComponent>(VulnerabilityComponent.CreateFromDiscriminatorValue);
                if (model is null) {
