...
namespace ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.PrimaryChannel.Members.Item
{
    ...
    public class ConversationMemberItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.PrimaryChannel.Members.Item.ConversationMemberItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public ConversationMemberItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/members/{conversationMember%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.PrimaryChannel.Members.Item.ConversationMemberItemRequestBuilder"/> and sets the default values.
        ...
        public ConversationMemberItemRequestBuilder(string rawUrl) : base("{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/primaryChannel/members/{conversationMember%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property members for teamTemplateDefinition
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.PrimaryChannel.Members.Item.ConversationMemberItemRequestBuilder.ConversationMemberItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.PrimaryChannel.Members.Item.ConversationMemberItemRequestBuilder.ConversationMemberItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
