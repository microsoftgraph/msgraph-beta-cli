...
using System;
namespace ApiSdk.Groups.Item.TransitiveMembers.Item.GraphGroup
{
    /// <summary>
    ...
    public partial class GraphGroupRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.TransitiveMembers.Item.GraphGroup.GraphGroupRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public GraphGroupRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/transitiveMembers/{directoryObject%2Did}/graph.group{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.TransitiveMembers.Item.GraphGroup.GraphGroupRequestBuilder"/> and sets the default values.
        ...
        public GraphGroupRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/transitiveMembers/{directoryObject%2Did}/graph.group{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Get a list of a group&apos;s members. A group can have different object types as members. For more information about supported member types for different groups, see Group membership. This operation is transitive and returns a flat list of all nested members. An attempt to filter by an OData cast that represents an unsupported member type returns a 400 Bad Request error with the Request_UnsupportedQuery code.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.TransitiveMembers.Item.GraphGroup.GraphGroupRequestBuilder.GraphGroupRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.TransitiveMembers.Item.GraphGroup.GraphGroupRequestBuilder.GraphGroupRequestBuilderGetQueryParameters>> requestConfiguration = default)
