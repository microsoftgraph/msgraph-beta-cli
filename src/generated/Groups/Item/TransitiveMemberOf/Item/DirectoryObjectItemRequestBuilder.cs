...
namespace ApiSdk.Groups.Item.TransitiveMemberOf.Item
{
    ...
    public class DirectoryObjectItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGraphAdministrativeUnitByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.TransitiveMemberOf.Item.GraphAdministrativeUnit.GraphAdministrativeUnitRequestBuilder(PathParameters);
        ...
        public Command BuildGraphGroupByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.TransitiveMemberOf.Item.GraphGroup.GraphGroupRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.TransitiveMemberOf.Item.DirectoryObjectItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.TransitiveMemberOf.Item.DirectoryObjectItemRequestBuilder.DirectoryObjectItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.TransitiveMemberOf.Item.DirectoryObjectItemRequestBuilder.DirectoryObjectItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
