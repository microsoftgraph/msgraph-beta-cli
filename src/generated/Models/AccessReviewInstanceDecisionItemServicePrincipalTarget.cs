...
namespace ApiSdk.Models
{
    ...
    public class AccessReviewInstanceDecisionItemServicePrincipalTarget : ApiSdk.Models.AccessReviewInstanceDecisionItemTarget, IParsable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.AccessReviewInstanceDecisionItemServicePrincipalTarget"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.AccessReviewInstanceDecisionItemServicePrincipalTarget"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.AccessReviewInstanceDecisionItemServicePrincipalTarget CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.AccessReviewInstanceDecisionItemServicePrincipalTarget();
        }
        /// <summary>
