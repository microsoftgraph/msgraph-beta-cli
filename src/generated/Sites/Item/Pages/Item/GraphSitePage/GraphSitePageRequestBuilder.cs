...
namespace ApiSdk.Sites.Item.Pages.Item.GraphSitePage
{
    ...
    public class GraphSitePageRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCanvasLayoutNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.Pages.Item.GraphSitePage.CanvasLayout.CanvasLayoutRequestBuilder(PathParameters);
        ...
        public Command BuildCreatedByUserNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.Pages.Item.GraphSitePage.CreatedByUser.CreatedByUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildLastModifiedByUserNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.Pages.Item.GraphSitePage.LastModifiedByUser.LastModifiedByUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            nonExecCommands.Add(builder.BuildMailboxSettingsNavCommand());
        ...
        public Command BuildWebPartsNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.Pages.Item.GraphSitePage.WebParts.WebPartsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Sites.Item.Pages.Item.GraphSitePage.GraphSitePageRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Sites.Item.Pages.Item.GraphSitePage.GraphSitePageRequestBuilder.GraphSitePageRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Sites.Item.Pages.Item.GraphSitePage.GraphSitePageRequestBuilder.GraphSitePageRequestBuilderGetQueryParameters>> requestConfiguration = default)
