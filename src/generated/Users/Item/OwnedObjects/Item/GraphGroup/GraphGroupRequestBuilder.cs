...
using System;
namespace ApiSdk.Users.Item.OwnedObjects.Item.GraphGroup {
    /// <summary>
    ...
    public class GraphGroupRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public GraphGroupRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/ownedObjects/{directoryObject%2Did}/graph.group{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="GraphGroupRequestBuilder"/> and sets the default values.
        ...
        public GraphGroupRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/ownedObjects/{directoryObject%2Did}/graph.group{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.group
