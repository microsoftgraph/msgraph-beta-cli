...
namespace ApiSdk.PrivilegedSignupStatus.CompleteSetup
{
    ...
    public class CompleteSetupPostRequestBody : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "tenantSetupInfo", n => { TenantSetupInfo = n.GetObjectValue<ApiSdk.Models.TenantSetupInfo>(ApiSdk.Models.TenantSetupInfo.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.TenantSetupInfo>("tenantSetupInfo", TenantSetupInfo);
