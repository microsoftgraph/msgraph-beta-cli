...
using ApiSdk.Groups.Item.Team.PrimaryChannel.Planner.Plans.Item.Archive;
using ApiSdk.Groups.Item.Team.PrimaryChannel.Planner.Plans.Item.Buckets;
using ApiSdk.Groups.Item.Team.PrimaryChannel.Planner.Plans.Item.Details;
using ApiSdk.Groups.Item.Team.PrimaryChannel.Planner.Plans.Item.MoveToContainer;
using ApiSdk.Groups.Item.Team.PrimaryChannel.Planner.Plans.Item.Tasks;
using ApiSdk.Groups.Item.Team.PrimaryChannel.Planner.Plans.Item.Unarchive;
...
using System;
namespace ApiSdk.Groups.Item.Team.PrimaryChannel.Planner.Plans.Item
{
    /// <summary>
    ...
    public partial class PlannerPlanItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildArchiveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PrimaryChannel.Planner.Plans.Item.Archive.ArchiveRequestBuilder(PathParameters);
        ...
        public Command BuildBucketsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PrimaryChannel.Planner.Plans.Item.Buckets.BucketsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildDetailsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PrimaryChannel.Planner.Plans.Item.Details.DetailsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildMoveToContainerNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PrimaryChannel.Planner.Plans.Item.MoveToContainer.MoveToContainerRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTasksNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PrimaryChannel.Planner.Plans.Item.Tasks.TasksRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildUnarchiveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PrimaryChannel.Planner.Plans.Item.Unarchive.UnarchiveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Team.PrimaryChannel.Planner.Plans.Item.PlannerPlanItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public PlannerPlanItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/team/primaryChannel/planner/plans/{plannerPlan%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Team.PrimaryChannel.Planner.Plans.Item.PlannerPlanItemRequestBuilder"/> and sets the default values.
        ...
        public PlannerPlanItemRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/team/primaryChannel/planner/plans/{plannerPlan%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property plans for groups
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.Team.PrimaryChannel.Planner.Plans.Item.PlannerPlanItemRequestBuilder.PlannerPlanItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.Team.PrimaryChannel.Planner.Plans.Item.PlannerPlanItemRequestBuilder.PlannerPlanItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
