...
namespace ApiSdk.RoleManagement.EnterpriseApps.Item.RoleEligibilitySchedules.Item
{
    ...
    public class UnifiedRoleEligibilityScheduleItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAppScopeNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EnterpriseApps.Item.RoleEligibilitySchedules.Item.AppScope.AppScopeRequestBuilder(PathParameters);
        ...
        public Command BuildDirectoryScopeNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EnterpriseApps.Item.RoleEligibilitySchedules.Item.DirectoryScope.DirectoryScopeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.UnifiedRoleEligibilitySchedule>(ApiSdk.Models.UnifiedRoleEligibilitySchedule.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPrincipalNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EnterpriseApps.Item.RoleEligibilitySchedules.Item.Principal.PrincipalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRoleDefinitionNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EnterpriseApps.Item.RoleEligibilitySchedules.Item.RoleDefinition.RoleDefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.RoleManagement.EnterpriseApps.Item.RoleEligibilitySchedules.Item.UnifiedRoleEligibilityScheduleItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.EnterpriseApps.Item.RoleEligibilitySchedules.Item.UnifiedRoleEligibilityScheduleItemRequestBuilder.UnifiedRoleEligibilityScheduleItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.EnterpriseApps.Item.RoleEligibilitySchedules.Item.UnifiedRoleEligibilityScheduleItemRequestBuilder.UnifiedRoleEligibilityScheduleItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.UnifiedRoleEligibilitySchedule body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.UnifiedRoleEligibilitySchedule body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
