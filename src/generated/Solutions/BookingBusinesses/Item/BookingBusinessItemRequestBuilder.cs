...
namespace ApiSdk.Solutions.BookingBusinesses.Item
{
    ...
    public class BookingBusinessItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAppointmentsNavCommand()
        {
            ...
            var builder = new ApiSdk.Solutions.BookingBusinesses.Item.Appointments.AppointmentsRequestBuilder(PathParameters);
        ...
        public Command BuildCalendarViewNavCommand()
        {
            ...
            var builder = new ApiSdk.Solutions.BookingBusinesses.Item.CalendarView.CalendarViewRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildCustomersNavCommand()
        {
            ...
            var builder = new ApiSdk.Solutions.BookingBusinesses.Item.Customers.CustomersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildCustomQuestionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Solutions.BookingBusinesses.Item.CustomQuestions.CustomQuestionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildGetStaffAvailabilityNavCommand()
        {
            ...
            var builder = new ApiSdk.Solutions.BookingBusinesses.Item.GetStaffAvailability.GetStaffAvailabilityRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildPublishNavCommand()
        {
            ...
            var builder = new ApiSdk.Solutions.BookingBusinesses.Item.Publish.PublishRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildServicesNavCommand()
        {
            ...
            var builder = new ApiSdk.Solutions.BookingBusinesses.Item.Services.ServicesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildStaffMembersNavCommand()
        {
            ...
            var builder = new ApiSdk.Solutions.BookingBusinesses.Item.StaffMembers.StaffMembersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildUnpublishNavCommand()
        {
            ...
            var builder = new ApiSdk.Solutions.BookingBusinesses.Item.Unpublish.UnpublishRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Solutions.BookingBusinesses.Item.BookingBusinessItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Solutions.BookingBusinesses.Item.BookingBusinessItemRequestBuilder.BookingBusinessItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Solutions.BookingBusinesses.Item.BookingBusinessItemRequestBuilder.BookingBusinessItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
