    ...
    public class AddCopyFromContentTypeHubRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Shares.Item.List.ContentTypes.AddCopyFromContentTypeHub.AddCopyFromContentTypeHubPostRequestBody>(ApiSdk.Shares.Item.List.ContentTypes.AddCopyFromContentTypeHub.AddCopyFromContentTypeHubPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Shares.Item.List.ContentTypes.AddCopyFromContentTypeHub.AddCopyFromContentTypeHubRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Shares.Item.List.ContentTypes.AddCopyFromContentTypeHub.AddCopyFromContentTypeHubPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Shares.Item.List.ContentTypes.AddCopyFromContentTypeHub.AddCopyFromContentTypeHubPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
