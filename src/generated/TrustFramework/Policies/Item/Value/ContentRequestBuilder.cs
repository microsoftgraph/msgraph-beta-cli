...
using System;
namespace ApiSdk.TrustFramework.Policies.Item.Value {
    /// <summary>
    ...
    public class ContentRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get media content for the navigation property policies from trustFramework\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/trustframework-list-trustframeworkpolicies?view=graph-rest-1.0";
        ...
        public Command BuildPutCommand()
        {
            ...
            command.Description = "Update media content for the navigation property policies in trustFramework";
            var trustFrameworkPolicyIdOption = new Option<string>("--trust-framework-policy-id", description: "The unique identifier of trustFrameworkPolicy") {
            };
            trustFrameworkPolicyIdOption.IsRequired = true;
            command.AddOption(trustFrameworkPolicyIdOption);
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/trustFramework/policies/{trustFrameworkPolicy%2Did}/$value{?%24format*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ContentRequestBuilder"/> and sets the default values.
        ...
        public ContentRequestBuilder(string rawUrl) : base("{+baseurl}/trustFramework/policies/{trustFrameworkPolicy%2Did}/$value{?%24format*}", rawUrl)
        {
        }
        /// <summary>
        /// Get media content for the navigation property policies from trustFramework
...
#nullable restore
        ...
        public RequestInformation ToPutRequestInformation(Stream body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.PUT, "{+baseurl}/trustFramework/policies/{trustFrameworkPolicy%2Did}/$value", PathParameters);
            requestInfo.Configure(requestConfiguration);
