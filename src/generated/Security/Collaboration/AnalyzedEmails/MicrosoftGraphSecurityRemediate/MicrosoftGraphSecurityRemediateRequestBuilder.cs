...
namespace ApiSdk.Security.Collaboration.AnalyzedEmails.MicrosoftGraphSecurityRemediate
{
    ...
    public partial class MicrosoftGraphSecurityRemediateRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Security.Collaboration.AnalyzedEmails.MicrosoftGraphSecurityRemediate.RemediatePostRequestBody>(global::ApiSdk.Security.Collaboration.AnalyzedEmails.MicrosoftGraphSecurityRemediate.RemediatePostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Security.Collaboration.AnalyzedEmails.MicrosoftGraphSecurityRemediate.MicrosoftGraphSecurityRemediateRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Security.Collaboration.AnalyzedEmails.MicrosoftGraphSecurityRemediate.RemediatePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Security.Collaboration.AnalyzedEmails.MicrosoftGraphSecurityRemediate.RemediatePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
