...
namespace ApiSdk.Organization.Item.Branding.Localizations.Item
{
    ...
    public class OrganizationalBrandingLocalizationItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildBackgroundImageNavCommand()
        {
            ...
            var builder = new ApiSdk.Organization.Item.Branding.Localizations.Item.BackgroundImage.BackgroundImageRequestBuilder(PathParameters);
        ...
        public Command BuildBannerLogoNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the organization entity.";
            var builder = new ApiSdk.Organization.Item.Branding.Localizations.Item.BannerLogo.BannerLogoRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        public Command BuildCustomCSSNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the organization entity.";
            var builder = new ApiSdk.Organization.Item.Branding.Localizations.Item.CustomCSS.CustomCSSRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        public Command BuildFaviconNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the organization entity.";
            var builder = new ApiSdk.Organization.Item.Branding.Localizations.Item.Favicon.FaviconRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        public Command BuildHeaderLogoNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the organization entity.";
            var builder = new ApiSdk.Organization.Item.Branding.Localizations.Item.HeaderLogo.HeaderLogoRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.OrganizationalBrandingLocalization>(ApiSdk.Models.OrganizationalBrandingLocalization.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildSquareLogoDarkNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the organization entity.";
            var builder = new ApiSdk.Organization.Item.Branding.Localizations.Item.SquareLogoDark.SquareLogoDarkRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        public Command BuildSquareLogoNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the organization entity.";
            var builder = new ApiSdk.Organization.Item.Branding.Localizations.Item.SquareLogo.SquareLogoRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Organization.Item.Branding.Localizations.Item.OrganizationalBrandingLocalizationItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Organization.Item.Branding.Localizations.Item.OrganizationalBrandingLocalizationItemRequestBuilder.OrganizationalBrandingLocalizationItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Organization.Item.Branding.Localizations.Item.OrganizationalBrandingLocalizationItemRequestBuilder.OrganizationalBrandingLocalizationItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.OrganizationalBrandingLocalization body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.OrganizationalBrandingLocalization body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
