...
namespace ApiSdk.Models
{
    ...
    public class AdminReportSettings : ApiSdk.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.AdminReportSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.AdminReportSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.AdminReportSettings();
        }
        /// <summary>
