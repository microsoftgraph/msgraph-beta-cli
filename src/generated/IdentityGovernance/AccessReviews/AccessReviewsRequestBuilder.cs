...
using ApiSdk.IdentityGovernance.AccessReviews.Decisions;
using ApiSdk.IdentityGovernance.AccessReviews.Definitions;
using ApiSdk.IdentityGovernance.AccessReviews.HistoryDefinitions;
using ApiSdk.IdentityGovernance.AccessReviews.Policy;
...
namespace ApiSdk.IdentityGovernance.AccessReviews
{
    ...
    public partial class AccessReviewsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDecisionsNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the decisions property of the microsoft.graph.accessReviewSet entity.";
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Decisions.DecisionsRequestBuilder(PathParameters);
        ...
        public Command BuildDefinitionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Definitions.DefinitionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildHistoryDefinitionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.HistoryDefinitions.HistoryDefinitionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.AccessReviewSet>(global::ApiSdk.Models.AccessReviewSet.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPolicyNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the policy property of the microsoft.graph.accessReviewSet entity.";
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Policy.PolicyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.IdentityGovernance.AccessReviews.AccessReviewsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.IdentityGovernance.AccessReviews.AccessReviewsRequestBuilder.AccessReviewsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.IdentityGovernance.AccessReviews.AccessReviewsRequestBuilder.AccessReviewsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.AccessReviewSet body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.AccessReviewSet body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
