...
using ApiSdk.Models;
using ApiSdk.Users.Item.DirectReports.GraphUser.Count;
...
using System;
namespace ApiSdk.Users.Item.DirectReports.GraphUser {
    /// <summary>
    ...
    public class GraphUserRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public GraphUserRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/directReports/graph.user{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="GraphUserRequestBuilder"/> and sets the default values.
        ...
        public GraphUserRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/directReports/graph.user{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get the items of type microsoft.graph.user in the microsoft.graph.directoryObject collection
