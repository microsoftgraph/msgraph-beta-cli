...
namespace ApiSdk.Users.Item.Onenote.Notebooks {
    ...
    public class NotebooksRequestBuilder : BaseCliRequestBuilder {
        ...
        public NotebooksRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/onenote/notebooks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Retrieve a list of notebook objects.
        /// </summary>
