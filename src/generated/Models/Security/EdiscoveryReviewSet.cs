...
#nullable enable
        public List<EdiscoveryReviewSetQuery>? EdiscoveryReviewSetQueries { get; set; }
#nullable restore
#else
        public List<EdiscoveryReviewSetQuery> EdiscoveryReviewSetQueries { get; set; }
#endif
...
#nullable restore
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"queries", n => { EdiscoveryReviewSetQueries = n.GetCollectionOfObjectValues<EdiscoveryReviewSetQuery>(EdiscoveryReviewSetQuery.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<EdiscoveryReviewSetQuery>("queries", EdiscoveryReviewSetQueries);
