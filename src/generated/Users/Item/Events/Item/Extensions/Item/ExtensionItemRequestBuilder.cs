...
namespace ApiSdk.Users.Item.Events.Item.Extensions.Item {
    ...
    public class ExtensionItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public ExtensionItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/events/{event%2Did}/extensions/{extension%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ExtensionItemRequestBuilder"/> and sets the default values.
        ...
        public ExtensionItemRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/events/{event%2Did}/extensions/{extension%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property extensions for users
