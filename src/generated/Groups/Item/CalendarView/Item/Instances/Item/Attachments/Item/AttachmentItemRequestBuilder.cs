...
using System;
namespace ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.Attachments.Item {
    /// <summary>
    ...
    public class AttachmentItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public AttachmentItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/attachments/{attachment%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="AttachmentItemRequestBuilder"/> and sets the default values.
        ...
        public AttachmentItemRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/attachments/{attachment%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete an attachment from a user calendar event, message, Outlook task, or post.
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/attachments/{attachment%2Did}", PathParameters);
