...
namespace ApiSdk.Users.Item.Devices.Item.RegisteredUsers.Ref {
    ...
    public class RefRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public RefRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredUsers/$ref{?%24count,%24filter,%24orderby,%24search,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="RefRequestBuilder"/> and sets the default values.
        ...
        public RefRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredUsers/$ref{?%24count,%24filter,%24orderby,%24search,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Remove a user as a registered user of the device.
