...
using ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.LastIndexOperation;
using ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.MicrosoftGraphEdiscoveryActivate;
using ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.MicrosoftGraphEdiscoveryApplyHold;
using ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.MicrosoftGraphEdiscoveryRelease;
using ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.MicrosoftGraphEdiscoveryRemoveHold;
using ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.MicrosoftGraphEdiscoveryUpdateIndex;
using ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.SiteSources;
using ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.UnifiedGroupSources;
using ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.UserSources;
...
namespace ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item
{
    ...
    public partial class CustodianItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property custodians for compliance";
        ...
        public Command BuildLastIndexOperationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.LastIndexOperation.LastIndexOperationRequestBuilder(PathParameters);
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildMicrosoftGraphEdiscoveryActivateNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.MicrosoftGraphEdiscoveryActivate.MicrosoftGraphEdiscoveryActivateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildMicrosoftGraphEdiscoveryApplyHoldByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.MicrosoftGraphEdiscoveryApplyHold.MicrosoftGraphEdiscoveryApplyHoldRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMicrosoftGraphEdiscoveryReleaseNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.MicrosoftGraphEdiscoveryRelease.MicrosoftGraphEdiscoveryReleaseRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMicrosoftGraphEdiscoveryRemoveHoldByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.MicrosoftGraphEdiscoveryRemoveHold.MicrosoftGraphEdiscoveryRemoveHoldRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMicrosoftGraphEdiscoveryUpdateIndexNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.MicrosoftGraphEdiscoveryUpdateIndex.MicrosoftGraphEdiscoveryUpdateIndexRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Ediscovery.Custodian>(global::ApiSdk.Models.Ediscovery.Custodian.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildSiteSourcesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.SiteSources.SiteSourcesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildUnifiedGroupSourcesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.UnifiedGroupSources.UnifiedGroupSourcesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildUserSourcesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.UserSources.UserSourcesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.CustodianItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.CustodianItemRequestBuilder.CustodianItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Compliance.Ediscovery.Cases.Item.Custodians.Item.CustodianItemRequestBuilder.CustodianItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Ediscovery.Custodian body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Ediscovery.Custodian body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class CustodianItemRequestBuilderGetQueryParameters 
        {
