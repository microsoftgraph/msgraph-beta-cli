...
using System;
namespace ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.CopyToNotebook
{
    /// <summary>
    ...
    public class CopyToNotebookRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.CopyToNotebook.CopyToNotebookPostRequestBody>(ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.CopyToNotebook.CopyToNotebookPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.CopyToNotebook.CopyToNotebookRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public CopyToNotebookRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}/copyToNotebook", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.CopyToNotebook.CopyToNotebookRequestBuilder"/> and sets the default values.
        ...
        public CopyToNotebookRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}/copyToNotebook", rawUrl)
        {
        }
        /// <summary>
        /// Copies a section to a specific notebook. For Copy operations, you follow an asynchronous calling pattern:  First call the Copy action, and then poll the operation endpoint for the result.
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.CopyToNotebook.CopyToNotebookPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.CopyToNotebook.CopyToNotebookPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
