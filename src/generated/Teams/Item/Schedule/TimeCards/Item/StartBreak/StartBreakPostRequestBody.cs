...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Teams.Item.Schedule.TimeCards.Item.StartBreak.StartBreakPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Teams.Item.Schedule.TimeCards.Item.StartBreak.StartBreakPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Teams.Item.Schedule.TimeCards.Item.StartBreak.StartBreakPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Teams.Item.Schedule.TimeCards.Item.StartBreak.StartBreakPostRequestBody();
        }
        /// <summary>
