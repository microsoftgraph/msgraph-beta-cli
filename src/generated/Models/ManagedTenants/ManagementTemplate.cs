...
namespace ApiSdk.Models.ManagedTenants
{
    ...
    public partial class ManagementTemplate : global::ApiSdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.ManagedTenants.TemplateParameter>? Parameters { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.ManagedTenants.TemplateParameter> Parameters { get; set; }
#endif
        ...
        public global::ApiSdk.Models.ManagedTenants.ManagementProvider? Provider { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.ManagedTenants.ManagementTemplate"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.ManagedTenants.ManagementTemplate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.ManagedTenants.ManagementTemplate();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "parameters", n => { Parameters = n.GetCollectionOfObjectValues<global::ApiSdk.Models.ManagedTenants.TemplateParameter>(global::ApiSdk.Models.ManagedTenants.TemplateParameter.CreateFromDiscriminatorValue)?.AsList(); } },
                { "priority", n => { Priority = n.GetIntValue(); } },
                { "provider", n => { Provider = n.GetEnumValue<global::ApiSdk.Models.ManagedTenants.ManagementProvider>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.ManagedTenants.TemplateParameter>("parameters", Parameters);
            writer.WriteIntValue("priority", Priority);
            writer.WriteEnumValue<global::ApiSdk.Models.ManagedTenants.ManagementProvider>("provider", Provider);
