...
using System;
namespace ApiSdk.TermStore.Sets.Item.ParentGroup.Sets.Item.Children.Item.Children.Count
{
    /// <summary>
    ...
    public partial class CountRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.TermStore.Sets.Item.ParentGroup.Sets.Item.Children.Item.Children.Count.CountRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public CountRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/children/{term%2Did}/children/$count{?%24filter,%24search}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.TermStore.Sets.Item.ParentGroup.Sets.Item.Children.Item.Children.Count.CountRequestBuilder"/> and sets the default values.
        ...
        public CountRequestBuilder(string rawUrl) : base("{+baseurl}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/children/{term%2Did}/children/$count{?%24filter,%24search}", rawUrl)
        {
        }
        /// <summary>
        /// Get the number of the resource
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.TermStore.Sets.Item.ParentGroup.Sets.Item.Children.Item.Children.Count.CountRequestBuilder.CountRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.TermStore.Sets.Item.ParentGroup.Sets.Item.Children.Item.Children.Count.CountRequestBuilder.CountRequestBuilderGetQueryParameters>> requestConfiguration = default)
