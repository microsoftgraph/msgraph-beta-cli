    ...
    public class SelfActivateRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.PrivilegedApproval.Item.RoleInfo.SelfActivate.SelfActivatePostRequestBody>(ApiSdk.PrivilegedApproval.Item.RoleInfo.SelfActivate.SelfActivatePostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.PrivilegedApproval.Item.RoleInfo.SelfActivate.SelfActivateRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.PrivilegedApproval.Item.RoleInfo.SelfActivate.SelfActivatePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.PrivilegedApproval.Item.RoleInfo.SelfActivate.SelfActivatePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
