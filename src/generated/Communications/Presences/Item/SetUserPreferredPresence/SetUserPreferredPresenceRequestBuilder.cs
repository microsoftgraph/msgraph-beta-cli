...
namespace ApiSdk.Communications.Presences.Item.SetUserPreferredPresence
{
    ...
    public class SetUserPreferredPresenceRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/presence-setuserpreferredpresence?view=graph-rest-beta" />
        /// </summary>
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Communications.Presences.Item.SetUserPreferredPresence.SetUserPreferredPresencePostRequestBody>(ApiSdk.Communications.Presences.Item.SetUserPreferredPresence.SetUserPreferredPresencePostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Communications.Presences.Item.SetUserPreferredPresence.SetUserPreferredPresenceRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Communications.Presences.Item.SetUserPreferredPresence.SetUserPreferredPresencePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Communications.Presences.Item.SetUserPreferredPresence.SetUserPreferredPresencePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
