...
using ApiSdk.Models;
using ApiSdk.Users.Item.DirectReports.GraphOrgContact.Count;
...
using System;
namespace ApiSdk.Users.Item.DirectReports.GraphOrgContact {
    /// <summary>
    ...
    public class GraphOrgContactRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public GraphOrgContactRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/directReports/graph.orgContact{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="GraphOrgContactRequestBuilder"/> and sets the default values.
        ...
        public GraphOrgContactRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/directReports/graph.orgContact{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get the items of type microsoft.graph.orgContact in the microsoft.graph.directoryObject collection
