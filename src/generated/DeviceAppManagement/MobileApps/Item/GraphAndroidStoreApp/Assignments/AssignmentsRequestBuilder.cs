// <auto-generated/>
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidStoreApp.Assignments.Count;
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidStoreApp.Assignments.Item;
...
using System;
namespace ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidStoreApp.Assignments {
    /// <summary>
    ...
    public class AssignmentsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public AssignmentsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.androidStoreApp/assignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="AssignmentsRequestBuilder"/> and sets the default values.
        ...
        public AssignmentsRequestBuilder(string rawUrl) : base("{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.androidStoreApp/assignments{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// The list of group assignments for this mobile app.
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(MobileAppAssignment body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.androidStoreApp/assignments", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
