...
namespace ApiSdk.RoleManagement.EnterpriseApps.Item.RoleEligibilityScheduleRequests {
    ...
    public class RoleEligibilityScheduleRequestsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildListCommand()
        {
            ...
            command.Description = "Get a list of the unifiedRoleEligibilityScheduleRequest objects and their properties.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/rbacapplication-list-roleeligibilityschedulerequests?view=graph-rest-1.0";
            var rbacApplicationIdOption = new Option<string>("--rbac-application-id", description: "The unique identifier of rbacApplication") {
            };
            rbacApplicationIdOption.IsRequired = true;
            command.AddOption(rbacApplicationIdOption);
        ...
        /// <summary>
        /// Instantiates a new <see cref="RoleEligibilityScheduleRequestsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(UnifiedRoleEligibilityScheduleRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleEligibilityScheduleRequests", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
