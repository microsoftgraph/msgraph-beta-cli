...
namespace ApiSdk.Users.Item.Calendar.CalendarPermissions {
    ...
    public class CalendarPermissionsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public CalendarPermissionsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/calendar/calendarPermissions{?%24count,%24filter,%24orderby,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="CalendarPermissionsRequestBuilder"/> and sets the default values.
        ...
        public CalendarPermissionsRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/calendar/calendarPermissions{?%24count,%24filter,%24orderby,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get the specified permissions object of a user or group calendar that has been shared.
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(CalendarPermission body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/users/{user%2Did}/calendar/calendarPermissions", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
