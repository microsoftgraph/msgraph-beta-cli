...
using System;
namespace ApiSdk.Print.Shares.Item.Jobs.Item.Redirect
{
    /// <summary>
    ...
    public partial class RedirectRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Print.Shares.Item.Jobs.Item.Redirect.RedirectPostRequestBody>(global::ApiSdk.Print.Shares.Item.Jobs.Item.Redirect.RedirectPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Print.Shares.Item.Jobs.Item.Redirect.RedirectRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public RedirectRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/redirect", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Print.Shares.Item.Jobs.Item.Redirect.RedirectRequestBuilder"/> and sets the default values.
        ...
        public RedirectRequestBuilder(string rawUrl) : base("{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/redirect", rawUrl)
        {
        }
        /// <summary>
        /// Redirect a print job to a different printer. Redirecting a print job will only succeed if there is a printTask in a processing state on the associated print job, started by a trigger that the requesting app created.  For details about how to use this API to add pull printing support to Universal Print, see Extending Universal Print to support pull printing.
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Print.Shares.Item.Jobs.Item.Redirect.RedirectPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Print.Shares.Item.Jobs.Item.Redirect.RedirectPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
