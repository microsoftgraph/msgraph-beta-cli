...
namespace ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentSchedules.Item
{
    ...
    public class UnifiedRoleAssignmentScheduleItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildActivatedUsingNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentSchedules.Item.ActivatedUsing.ActivatedUsingRequestBuilder(PathParameters);
        ...
        public Command BuildAppScopeNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentSchedules.Item.AppScope.AppScopeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDirectoryScopeNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentSchedules.Item.DirectoryScope.DirectoryScopeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPrincipalNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentSchedules.Item.Principal.PrincipalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRoleDefinitionNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentSchedules.Item.RoleDefinition.RoleDefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentSchedules.Item.UnifiedRoleAssignmentScheduleItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentSchedules.Item.UnifiedRoleAssignmentScheduleItemRequestBuilder.UnifiedRoleAssignmentScheduleItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentSchedules.Item.UnifiedRoleAssignmentScheduleItemRequestBuilder.UnifiedRoleAssignmentScheduleItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
