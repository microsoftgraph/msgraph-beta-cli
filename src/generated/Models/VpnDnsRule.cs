...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.VpnDnsRule"/> and sets the default values.
        /// </summary>
        public VpnDnsRule()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.VpnDnsRule"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.VpnDnsRule CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.VpnDnsRule();
        }
        /// <summary>
