...
using ApiSdk.Policies.PermissionGrantPreApprovalPolicies;
...
namespace ApiSdk.Policies
{
    ...
    public partial class PoliciesRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAccessReviewPolicyNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Policies.AccessReviewPolicy.AccessReviewPolicyRequestBuilder(PathParameters);
        ...
        public Command BuildB2cAuthenticationMethodsPolicyNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Policies.B2cAuthenticationMethodsPolicy.B2cAuthenticationMethodsPolicyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildDirectoryRoleAccessReviewPolicyNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Policies.DirectoryRoleAccessReviewPolicy.DirectoryRoleAccessReviewPolicyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildExternalIdentitiesPolicyNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Policies.ExternalIdentitiesPolicy.ExternalIdentitiesPolicyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildFederatedTokenValidationPolicyNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Policies.FederatedTokenValidationPolicy.FederatedTokenValidationPolicyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildMobileAppManagementPoliciesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Policies.MobileAppManagementPolicies.MobileAppManagementPoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildMobileDeviceManagementPoliciesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Policies.MobileDeviceManagementPolicies.MobileDeviceManagementPoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildPermissionGrantPreApprovalPoliciesNavCommand()
        {
            var command = new Command("permission-grant-pre-approval-policies");
            command.Description = "Provides operations to manage the permissionGrantPreApprovalPolicies property of the microsoft.graph.policyRoot entity.";
            var builder = new global::ApiSdk.Policies.PermissionGrantPreApprovalPolicies.PermissionGrantPreApprovalPoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildServicePrincipalCreationPoliciesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Policies.ServicePrincipalCreationPolicies.ServicePrincipalCreationPoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
