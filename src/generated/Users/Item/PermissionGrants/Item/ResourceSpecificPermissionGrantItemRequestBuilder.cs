...
using System;
namespace ApiSdk.Users.Item.PermissionGrants.Item {
    /// <summary>
    ...
    public class ResourceSpecificPermissionGrantItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public ResourceSpecificPermissionGrantItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ResourceSpecificPermissionGrantItemRequestBuilder"/> and sets the default values.
        ...
        public ResourceSpecificPermissionGrantItemRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property permissionGrants for users
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/users/{user%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}", PathParameters);
...
#nullable restore
        ...
        public RequestInformation ToPatchRequestInformation(ResourceSpecificPermissionGrant body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.PATCH, "{+baseurl}/users/{user%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
