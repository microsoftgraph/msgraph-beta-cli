...
using ApiSdk.Models;
using ApiSdk.Users.Item.Chats.Item.Members.Add;
using ApiSdk.Users.Item.Chats.Item.Members.Count;
using ApiSdk.Users.Item.Chats.Item.Members.Item;
...
using System;
namespace ApiSdk.Users.Item.Chats.Item.Members {
    /// <summary>
    ...
    public class MembersRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/chat-list-members?view=graph-rest-1.0" />
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        ...
        public MembersRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/members{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="MembersRequestBuilder"/> and sets the default values.
        ...
        public MembersRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/members{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Retrieve a conversationMember from a chat.
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(ConversationMember body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/members", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
