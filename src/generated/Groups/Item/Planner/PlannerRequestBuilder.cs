...
using ApiSdk.Groups.Item.Planner.Plans;
    ...
    public partial class PlannerRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.PlannerGroup>(global::ApiSdk.Models.PlannerGroup.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPlansNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Planner.Plans.PlansRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Planner.PlannerRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.Planner.PlannerRequestBuilder.PlannerRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.Planner.PlannerRequestBuilder.PlannerRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.PlannerGroup body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.PlannerGroup body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
