...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.ConfigurationUri>? ConfigurationUris { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.ConfigurationUri> ConfigurationUris { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.InformationalUrls? InformationalUrls { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.InformationalUrls InformationalUrls { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.SupportedClaimConfiguration? SupportedClaimConfiguration { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.SupportedClaimConfiguration SupportedClaimConfiguration { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "configurationUris", n => { ConfigurationUris = n.GetCollectionOfObjectValues<global::ApiSdk.Models.ConfigurationUri>(global::ApiSdk.Models.ConfigurationUri.CreateFromDiscriminatorValue)?.AsList(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "displayName", n => { DisplayName = n.GetStringValue(); } },
                { "homePageUrl", n => { HomePageUrl = n.GetStringValue(); } },
                { "informationalUrls", n => { InformationalUrls = n.GetObjectValue<global::ApiSdk.Models.InformationalUrls>(global::ApiSdk.Models.InformationalUrls.CreateFromDiscriminatorValue); } },
                { "logoUrl", n => { LogoUrl = n.GetStringValue(); } },
                { "publisher", n => { Publisher = n.GetStringValue(); } },
                { "supportedClaimConfiguration", n => { SupportedClaimConfiguration = n.GetObjectValue<global::ApiSdk.Models.SupportedClaimConfiguration>(global::ApiSdk.Models.SupportedClaimConfiguration.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.ConfigurationUri>("configurationUris", ConfigurationUris);
            writer.WriteStringValue("description", Description);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteStringValue("homePageUrl", HomePageUrl);
            writer.WriteObjectValue<global::ApiSdk.Models.InformationalUrls>("informationalUrls", InformationalUrls);
            writer.WriteStringValue("logoUrl", LogoUrl);
            writer.WriteStringValue("publisher", Publisher);
            writer.WriteObjectValue<global::ApiSdk.Models.SupportedClaimConfiguration>("supportedClaimConfiguration", SupportedClaimConfiguration);
