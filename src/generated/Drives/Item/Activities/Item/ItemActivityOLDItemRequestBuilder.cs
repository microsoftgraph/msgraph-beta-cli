...
namespace ApiSdk.Drives.Item.Activities.Item
{
    ...
    public class ItemActivityOLDItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDriveItemNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Activities.Item.DriveItem.DriveItemRequestBuilder(PathParameters);
        ...
        public Command BuildListItemNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Activities.Item.ListItem.ListItemRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Drives.Item.Activities.Item.ItemActivityOLDItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Drives.Item.Activities.Item.ItemActivityOLDItemRequestBuilder.ItemActivityOLDItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Drives.Item.Activities.Item.ItemActivityOLDItemRequestBuilder.ItemActivityOLDItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
