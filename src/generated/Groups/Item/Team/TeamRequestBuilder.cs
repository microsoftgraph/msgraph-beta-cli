...
using ApiSdk.Groups.Item.Team.OwnersWithUserPrincipalName;
...
namespace ApiSdk.Groups.Item.Team
{
    ...
    public partial class TeamRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildAllChannelsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.AllChannels.AllChannelsRequestBuilder(PathParameters);
        ...
        public Command BuildArchiveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.Archive.ArchiveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildChannelsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.Channels.ChannelsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildCloneNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.Clone.CloneRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildCompleteMigrationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.CompleteMigration.CompleteMigrationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGroupNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.Group.GroupRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildIncomingChannelsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.IncomingChannels.IncomingChannelsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildInstalledAppsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.InstalledApps.InstalledAppsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildMembersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.Members.MembersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildOperationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.Operations.OperationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildOwnersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.Owners.OwnersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildOwnersWithUserPrincipalNameRbCommand()
        {
            ...
            command.Description = "Provides operations to manage the owners property of the microsoft.graph.team entity.";
            var builder = new global::ApiSdk.Groups.Item.Team.OwnersWithUserPrincipalName.OwnersWithUserPrincipalNameRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPermissionGrantsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PermissionGrants.PermissionGrantsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPhotoNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.Photo.PhotoRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildPrimaryChannelNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PrimaryChannel.PrimaryChannelRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildPutCommand()
        {
            ...
            command.Description = "Create a new team from a group. In order to create a team, the group must have a least one owner. If the creation of the team call is delayed, you can retry the call up to three times before you have to wait for 15 minutes due to a propagation delay. If the group was created less than 15 minutes ago, the call might fail with a 404 error code due to replication delays. If the group was created less than 15 minutes ago, it's possible for a call to create a team to fail with a 404 error code, due to ongoing replication delays.The recommended pattern is to retry the Create team call three times, with a 10 second delay between calls.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/team-put-teams?view=graph-rest-beta";
            var groupIdOption = new Option<string>("--group-id", description: "The unique identifier of group") {
            };
            groupIdOption.IsRequired = true;
            command.AddOption(groupIdOption);
        ...
        public Command BuildScheduleNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.Schedule.ScheduleRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildSendActivityNotificationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.SendActivityNotification.SendActivityNotificationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTagsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.Tags.TagsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildTemplateDefinitionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.TemplateDefinition.TemplateDefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTemplateNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.Template.TemplateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUnarchiveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.Unarchive.UnarchiveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Team.TeamRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.Team.TeamRequestBuilder.TeamRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.Team.TeamRequestBuilder.TeamRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(global::ApiSdk.Models.Team body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(global::ApiSdk.Models.Team body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
