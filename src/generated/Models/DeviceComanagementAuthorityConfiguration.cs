...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class DeviceComanagementAuthorityConfiguration : ApiSdk.Models.DeviceEnrollmentConfiguration, IParsable
    {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.DeviceComanagementAuthorityConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.DeviceComanagementAuthorityConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.DeviceComanagementAuthorityConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.DeviceComanagementAuthorityConfiguration();
        }
        /// <summary>
