...
using System;
namespace ApiSdk.Reports.UserInsights.Monthly.ActiveUsersBreakdown.Item {
    /// <summary>
    ...
    public class ActiveUsersBreakdownMetricItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public ActiveUsersBreakdownMetricItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/reports/userInsights/monthly/activeUsersBreakdown/{activeUsersBreakdownMetric%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ActiveUsersBreakdownMetricItemRequestBuilder"/> and sets the default values.
        ...
        public ActiveUsersBreakdownMetricItemRequestBuilder(string rawUrl) : base("{+baseurl}/reports/userInsights/monthly/activeUsersBreakdown/{activeUsersBreakdownMetric%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Get activeUsersBreakdown from reports
