...
#nullable enable
        public List<global::ApiSdk.Models.ProxiedDomain>? EnterpriseCloudResources { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.ProxiedDomain> EnterpriseCloudResources { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.IpRange>? EnterpriseIPRanges { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.IpRange> EnterpriseIPRanges { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Models.WindowsNetworkIsolationPolicy"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.WindowsNetworkIsolationPolicy"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ApiSdk.Models.WindowsNetworkIsolationPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.WindowsNetworkIsolationPolicy();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "enterpriseCloudResources", n => { EnterpriseCloudResources = n.GetCollectionOfObjectValues<global::ApiSdk.Models.ProxiedDomain>(global::ApiSdk.Models.ProxiedDomain.CreateFromDiscriminatorValue)?.AsList(); } },
                { "enterpriseIPRanges", n => { EnterpriseIPRanges = n.GetCollectionOfObjectValues<global::ApiSdk.Models.IpRange>(global::ApiSdk.Models.IpRange.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.ProxiedDomain>("enterpriseCloudResources", EnterpriseCloudResources);
            writer.WriteCollectionOfPrimitiveValues<string>("enterpriseInternalProxyServers", EnterpriseInternalProxyServers);
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.IpRange>("enterpriseIPRanges", EnterpriseIPRanges);
