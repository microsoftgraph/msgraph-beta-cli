...
namespace ApiSdk.Users.Item.PermissionGrants.Item {
    ...
    public class ResourceSpecificPermissionGrantItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public ResourceSpecificPermissionGrantItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ResourceSpecificPermissionGrantItemRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public ResourceSpecificPermissionGrantItemRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property permissionGrants for users
        /// </summary>
