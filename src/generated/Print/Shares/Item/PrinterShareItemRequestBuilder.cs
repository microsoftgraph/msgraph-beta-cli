...
namespace ApiSdk.Print.Shares.Item
{
    ...
    public class PrinterShareItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAllowedGroupsNavCommand()
        {
            ...
            var builder = new ApiSdk.Print.Shares.Item.AllowedGroups.AllowedGroupsRequestBuilder(PathParameters);
        ...
        public Command BuildAllowedUsersNavCommand()
        {
            ...
            var builder = new ApiSdk.Print.Shares.Item.AllowedUsers.AllowedUsersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildJobsNavCommand()
        {
            ...
            var builder = new ApiSdk.Print.Shares.Item.Jobs.JobsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildPrinterNavCommand()
        {
            ...
            var builder = new ApiSdk.Print.Shares.Item.Printer.PrinterRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Print.Shares.Item.PrinterShareItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Print.Shares.Item.PrinterShareItemRequestBuilder.PrinterShareItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Print.Shares.Item.PrinterShareItemRequestBuilder.PrinterShareItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
