...
namespace ApiSdk.DeviceManagement.VirtualEndpoint.ProvisioningPolicies.Item
{
    ...
    public class CloudPcProvisioningPolicyItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildApplyNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.VirtualEndpoint.ProvisioningPolicies.Item.Apply.ApplyRequestBuilder(PathParameters);
        ...
        public Command BuildAssignmentsNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.VirtualEndpoint.ProvisioningPolicies.Item.Assignments.AssignmentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildAssignNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.VirtualEndpoint.ProvisioningPolicies.Item.Assign.AssignRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceManagement.VirtualEndpoint.ProvisioningPolicies.Item.CloudPcProvisioningPolicyItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceManagement.VirtualEndpoint.ProvisioningPolicies.Item.CloudPcProvisioningPolicyItemRequestBuilder.CloudPcProvisioningPolicyItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceManagement.VirtualEndpoint.ProvisioningPolicies.Item.CloudPcProvisioningPolicyItemRequestBuilder.CloudPcProvisioningPolicyItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.CloudPcProvisioningPolicy body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.CloudPcProvisioningPolicy body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
