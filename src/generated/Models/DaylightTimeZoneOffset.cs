...
namespace ApiSdk.Models {
    public class DaylightTimeZoneOffset : StandardTimeZoneOffset, IParsable {
        ...
        /// <summary>The time offset from Coordinated Universal Time (UTC) for daylight saving time. This value is in minutes.</summary>
        public int? DaylightTimeZoneOffsetDaylightBias { get; set; }
        /// <summary>
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"daylightBias", n => { DaylightTimeZoneOffsetDaylightBias = n.GetIntValue(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteIntValue("daylightBias", DaylightTimeZoneOffsetDaylightBias);
        }
    }
}
