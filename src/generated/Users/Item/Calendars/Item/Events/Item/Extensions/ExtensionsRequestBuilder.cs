...
using ApiSdk.Models;
using ApiSdk.Users.Item.Calendars.Item.Events.Item.Extensions.Count;
using ApiSdk.Users.Item.Calendars.Item.Events.Item.Extensions.Item;
...
using System;
namespace ApiSdk.Users.Item.Calendars.Item.Events.Item.Extensions {
    /// <summary>
    ...
    public class ExtensionsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/extensions{?%24count,%24expand,%24filter,%24orderby,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ExtensionsRequestBuilder"/> and sets the default values.
        ...
        public ExtensionsRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/extensions{?%24count,%24expand,%24filter,%24orderby,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get an open extension (openTypeExtension object) identified by name or fully qualified name. The table in the Permissions section lists the resources that support open extensions. The following table lists the three scenarios where you can get an open extension from a supported resource instance.
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(Extension body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/extensions", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
