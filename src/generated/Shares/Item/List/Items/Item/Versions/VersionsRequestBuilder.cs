...
using ApiSdk.Models;
using ApiSdk.Shares.Item.List.Items.Item.Versions.Count;
using ApiSdk.Shares.Item.List.Items.Item.Versions.Item;
...
using System;
namespace ApiSdk.Shares.Item.List.Items.Item.Versions {
    /// <summary>
    ...
    public class VersionsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public VersionsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/versions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="VersionsRequestBuilder"/> and sets the default values.
        ...
        public VersionsRequestBuilder(string rawUrl) : base("{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/versions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// The list of previous versions of the list item.
