...
namespace ApiSdk.Groups.Item.Sites.Item.Lists.Item.Items.Item.Activities.Item.DriveItem.Content {
    ...
    public class ContentRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get content for the navigation property driveItem from groups";
        ...
        public Command BuildPutCommand()
        {
            ...
            command.Description = "Update content for the navigation property driveItem in groups";
            var groupIdOption = new Option<string>("--group-id", description: "The unique identifier of group") {
            };
            groupIdOption.IsRequired = true;
            command.AddOption(groupIdOption);
...
#nullable restore
        ...
        public RequestInformation ToPutRequestInformation(Stream body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.PUT, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/activities/{itemActivityOLD%2Did}/driveItem/content", PathParameters);
            requestInfo.Configure(requestConfiguration);
