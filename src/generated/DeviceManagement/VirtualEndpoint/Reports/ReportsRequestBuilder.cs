...
using ApiSdk.DeviceManagement.VirtualEndpoint.Reports.RetrieveBulkActionStatusReport;
using ApiSdk.DeviceManagement.VirtualEndpoint.Reports.RetrieveCloudPcRecommendationReports;
using ApiSdk.DeviceManagement.VirtualEndpoint.Reports.RetrieveCloudPcTenantMetricsReport;
using ApiSdk.DeviceManagement.VirtualEndpoint.Reports.RetrieveCloudPcTroubleshootReports;
using ApiSdk.DeviceManagement.VirtualEndpoint.Reports.RetrieveConnectionQualityReports;
using ApiSdk.DeviceManagement.VirtualEndpoint.Reports.RetrieveCrossRegionDisasterRecoveryReport;
using ApiSdk.DeviceManagement.VirtualEndpoint.Reports.RetrieveFrontlineReports;
...
namespace ApiSdk.DeviceManagement.VirtualEndpoint.Reports
{
    ...
    public partial class ReportsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildExportJobsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.ExportJobs.ExportJobsRequestBuilder(PathParameters);
        ...
        public Command BuildGetActionStatusReportsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.GetActionStatusReports.GetActionStatusReportsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGetCloudPcPerformanceReportNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.GetCloudPcPerformanceReport.GetCloudPcPerformanceReportRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetCloudPcRecommendationReportsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.GetCloudPcRecommendationReports.GetCloudPcRecommendationReportsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetConnectionQualityReportsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.GetConnectionQualityReports.GetConnectionQualityReportsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetDailyAggregatedRemoteConnectionReportsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.GetDailyAggregatedRemoteConnectionReports.GetDailyAggregatedRemoteConnectionReportsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetFrontlineReportNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.GetFrontlineReport.GetFrontlineReportRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetInaccessibleCloudPcReportsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.GetInaccessibleCloudPcReports.GetInaccessibleCloudPcReportsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetRawRemoteConnectionReportsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.GetRawRemoteConnectionReports.GetRawRemoteConnectionReportsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetRealTimeRemoteConnectionStatusWithCloudPcIdRbCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.GetRealTimeRemoteConnectionStatusWithCloudPcId.GetRealTimeRemoteConnectionStatusWithCloudPcIdRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetRemoteConnectionHistoricalReportsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.GetRemoteConnectionHistoricalReports.GetRemoteConnectionHistoricalReportsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetTotalAggregatedRemoteConnectionReportsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.GetTotalAggregatedRemoteConnectionReports.GetTotalAggregatedRemoteConnectionReportsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.CloudPcReports>(global::ApiSdk.Models.CloudPcReports.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildRetrieveBulkActionStatusReportNavCommand()
        {
            var command = new Command("retrieve-bulk-action-status-report");
            command.Description = "Provides operations to call the retrieveBulkActionStatusReport method.";
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.RetrieveBulkActionStatusReport.RetrieveBulkActionStatusReportRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildRetrieveCloudPcRecommendationReportsNavCommand()
        {
            var command = new Command("retrieve-cloud-pc-recommendation-reports");
            command.Description = "Provides operations to call the retrieveCloudPcRecommendationReports method.";
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.RetrieveCloudPcRecommendationReports.RetrieveCloudPcRecommendationReportsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildRetrieveCloudPcTenantMetricsReportNavCommand()
        {
            var command = new Command("retrieve-cloud-pc-tenant-metrics-report");
            command.Description = "Provides operations to call the retrieveCloudPcTenantMetricsReport method.";
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.RetrieveCloudPcTenantMetricsReport.RetrieveCloudPcTenantMetricsReportRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildRetrieveCloudPcTroubleshootReportsNavCommand()
        {
            var command = new Command("retrieve-cloud-pc-troubleshoot-reports");
            command.Description = "Provides operations to call the retrieveCloudPcTroubleshootReports method.";
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.RetrieveCloudPcTroubleshootReports.RetrieveCloudPcTroubleshootReportsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildRetrieveConnectionQualityReportsNavCommand()
        {
            var command = new Command("retrieve-connection-quality-reports");
            command.Description = "Provides operations to call the retrieveConnectionQualityReports method.";
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.RetrieveConnectionQualityReports.RetrieveConnectionQualityReportsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRetrieveCrossRegionDisasterRecoveryReportNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.RetrieveCrossRegionDisasterRecoveryReport.RetrieveCrossRegionDisasterRecoveryReportRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildRetrieveFrontlineReportsNavCommand()
        {
            var command = new Command("retrieve-frontline-reports");
            command.Description = "Provides operations to call the retrieveFrontlineReports method.";
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.RetrieveFrontlineReports.RetrieveFrontlineReportsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.ReportsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.ReportsRequestBuilder.ReportsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceManagement.VirtualEndpoint.Reports.ReportsRequestBuilder.ReportsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.CloudPcReports body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.CloudPcReports body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
