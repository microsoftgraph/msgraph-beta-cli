...
namespace ApiSdk.AuditLogs.SignIns {
    ...
    public class SignInsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new SignInItemRequestBuilder(PathParameters);
        ...
        public Command BuildConfirmSafeNavCommand()
        {
            ...
            var builder = new ConfirmSafeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildCreateCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<SignIn>(SignIn.CreateFromDiscriminatorValue);
                if (model is null) {
