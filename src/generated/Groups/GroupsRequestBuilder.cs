...
using ApiSdk.Groups.EvaluateDynamicMembership;
using ApiSdk.Groups.GetByIds;
using ApiSdk.Groups.GetUserOwnedObjects;
...
namespace ApiSdk.Groups
{
    ...
    public class GroupsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.GroupItemRequestBuilder(PathParameters);
            ...
            commands.Add(builder.BuildEvaluateDynamicMembershipByIdNavCommand());
        ...
        public Command BuildCountNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Count.CountRequestBuilder(PathParameters);
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/group-post-groups?view=graph-rest-beta" />
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        ...
        public Command BuildDeltaNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Delta.DeltaRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildEvaluateDynamicMembershipNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.EvaluateDynamicMembership.EvaluateDynamicMembershipRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGetByIdsNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.GetByIds.GetByIdsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetUserOwnedObjectsNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.GetUserOwnedObjects.GetUserOwnedObjectsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/group-list?view=graph-rest-beta" />
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
...
#nullable restore
        ...
        public Command BuildValidatePropertiesNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.ValidateProperties.ValidatePropertiesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.GroupsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.GroupsRequestBuilder.GroupsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.GroupsRequestBuilder.GroupsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Models.Group body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Models.Group body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
