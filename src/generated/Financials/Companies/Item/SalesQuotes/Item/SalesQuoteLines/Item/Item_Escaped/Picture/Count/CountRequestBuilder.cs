...
using System;
namespace ApiSdk.Financials.Companies.Item.SalesQuotes.Item.SalesQuoteLines.Item.Item_Escaped.Picture.Count
{
    /// <summary>
    ...
    public partial class CountRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Financials.Companies.Item.SalesQuotes.Item.SalesQuoteLines.Item.Item_Escaped.Picture.Count.CountRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public CountRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/financials/companies/{company%2Did}/salesQuotes/{salesQuote%2Did}/salesQuoteLines/{salesQuoteLine%2Did}/item/picture/$count{?%24filter,%24search}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Financials.Companies.Item.SalesQuotes.Item.SalesQuoteLines.Item.Item_Escaped.Picture.Count.CountRequestBuilder"/> and sets the default values.
        ...
        public CountRequestBuilder(string rawUrl) : base("{+baseurl}/financials/companies/{company%2Did}/salesQuotes/{salesQuote%2Did}/salesQuoteLines/{salesQuoteLine%2Did}/item/picture/$count{?%24filter,%24search}", rawUrl)
        {
        }
        /// <summary>
        /// Get the number of the resource
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Financials.Companies.Item.SalesQuotes.Item.SalesQuoteLines.Item.Item_Escaped.Picture.Count.CountRequestBuilder.CountRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Financials.Companies.Item.SalesQuotes.Item.SalesQuoteLines.Item.Item_Escaped.Picture.Count.CountRequestBuilder.CountRequestBuilderGetQueryParameters>> requestConfiguration = default)
