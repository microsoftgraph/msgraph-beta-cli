...
namespace ApiSdk.Models
{
    ...
    public class CloudPcSnapshot : ApiSdk.Models.Entity, IParsable
...
#nullable restore
        ...
        public ApiSdk.Models.CloudPcSnapshotType? SnapshotType { get; set; }
        /// <summary>The status of the Cloud PC snapshot. The possible values are: ready, unknownFutureValue.</summary>
        public ApiSdk.Models.CloudPcSnapshotStatus? Status { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.CloudPcSnapshot"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.CloudPcSnapshot CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.CloudPcSnapshot();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "snapshotType", n => { SnapshotType = n.GetEnumValue<ApiSdk.Models.CloudPcSnapshotType>(); } },
                { "status", n => { Status = n.GetEnumValue<ApiSdk.Models.CloudPcSnapshotStatus>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.CloudPcSnapshotType>("snapshotType", SnapshotType);
            writer.WriteEnumValue<ApiSdk.Models.CloudPcSnapshotStatus>("status", Status);
        }
    }
}
