...
namespace ApiSdk.DeviceAppManagement.DefaultManagedAppProtections.Item
{
    ...
    public class DefaultManagedAppProtectionItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAppsNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.DefaultManagedAppProtections.Item.Apps.AppsRequestBuilder(PathParameters);
        ...
        public Command BuildDeploymentSummaryNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.DefaultManagedAppProtections.Item.DeploymentSummary.DeploymentSummaryRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceAppManagement.DefaultManagedAppProtections.Item.DefaultManagedAppProtectionItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceAppManagement.DefaultManagedAppProtections.Item.DefaultManagedAppProtectionItemRequestBuilder.DefaultManagedAppProtectionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceAppManagement.DefaultManagedAppProtections.Item.DefaultManagedAppProtectionItemRequestBuilder.DefaultManagedAppProtectionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.DefaultManagedAppProtection body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.DefaultManagedAppProtection body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
