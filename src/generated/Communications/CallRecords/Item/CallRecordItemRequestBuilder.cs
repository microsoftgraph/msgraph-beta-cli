...
namespace ApiSdk.Communications.CallRecords.Item
{
    ...
    public class CallRecordItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildOrganizer_v2NavCommand()
        {
            ...
            var builder = new ApiSdk.Communications.CallRecords.Item.Organizer_v2.Organizer_v2RequestBuilder(PathParameters);
        ...
        public Command BuildParticipants_v2NavCommand()
        {
            ...
            var builder = new ApiSdk.Communications.CallRecords.Item.Participants_v2.Participants_v2RequestBuilder(PathParameters);
            var execCommands = new List<Command>();
