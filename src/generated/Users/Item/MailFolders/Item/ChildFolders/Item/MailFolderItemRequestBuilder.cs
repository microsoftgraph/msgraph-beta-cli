...
using ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Operations;
using ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.PermanentDelete;
using ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.UpdateAllMessagesReadState;
using ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.UserConfigurations;
...
namespace ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item
{
    ...
    public partial class MailFolderItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildCopyNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Copy.CopyRequestBuilder(PathParameters);
        ...
        public Command BuildMessageRulesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.MessageRules.MessageRulesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildMessagesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.MessagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildMoveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Move.MoveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildOperationsNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the operations property of the microsoft.graph.mailFolder entity.";
            var builder = new global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Operations.OperationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.MailFolder>(global::ApiSdk.Models.MailFolder.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPermanentDeleteNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.PermanentDelete.PermanentDeleteRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildUpdateAllMessagesReadStateNavCommand()
        {
            var command = new Command("update-all-messages-read-state");
            command.Description = "Provides operations to call the updateAllMessagesReadState method.";
            var builder = new global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.UpdateAllMessagesReadState.UpdateAllMessagesReadStateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildUserConfigurationsNavCommand()
        {
            var command = new Command("user-configurations");
            command.Description = "Provides operations to manage the userConfigurations property of the microsoft.graph.mailFolder entity.";
            var builder = new global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.UserConfigurations.UserConfigurationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.MailFolderItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.MailFolderItemRequestBuilder.MailFolderItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.MailFolderItemRequestBuilder.MailFolderItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.MailFolder body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.MailFolder body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
