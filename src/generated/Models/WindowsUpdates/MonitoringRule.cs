...
namespace ApiSdk.Models.WindowsUpdates
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public ApiSdk.Models.WindowsUpdates.MonitoringAction? Action { get; set; }
...
#nullable restore
        ...
        public ApiSdk.Models.WindowsUpdates.MonitoringSignal? Signal { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.WindowsUpdates.MonitoringRule"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.WindowsUpdates.MonitoringRule"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.WindowsUpdates.MonitoringRule CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.WindowsUpdates.MonitoringRule();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "action", n => { Action = n.GetEnumValue<ApiSdk.Models.WindowsUpdates.MonitoringAction>(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "signal", n => { Signal = n.GetEnumValue<ApiSdk.Models.WindowsUpdates.MonitoringSignal>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.WindowsUpdates.MonitoringAction>("action", Action);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteEnumValue<ApiSdk.Models.WindowsUpdates.MonitoringSignal>("signal", Signal);
