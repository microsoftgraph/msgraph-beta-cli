...
using ApiSdk.Models;
using ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.AppScope;
using ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.DirectoryScope;
using ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.Principal;
using ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.RoleDefinition;
...
using System;
namespace ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item
{
    /// <summary>
    ...
    public class UnifiedRoleAssignmentItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAppScopeNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.AppScope.AppScopeRequestBuilder(PathParameters);
        ...
        public Command BuildDirectoryScopeNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.DirectoryScope.DirectoryScopeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Resource to grant access to users or groups that are transitive.";
            var unifiedRoleAssignmentIdOption = new Option<string>("--unified-role-assignment-id", description: "The unique identifier of unifiedRoleAssignment") {
            };
            unifiedRoleAssignmentIdOption.IsRequired = true;
            command.AddOption(unifiedRoleAssignmentIdOption);
        ...
        public Command BuildPrincipalNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.Principal.PrincipalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRoleDefinitionNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.RoleDefinition.RoleDefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.UnifiedRoleAssignmentItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public UnifiedRoleAssignmentItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/roleManagement/exchange/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.UnifiedRoleAssignmentItemRequestBuilder"/> and sets the default values.
        ...
        public UnifiedRoleAssignmentItemRequestBuilder(string rawUrl) : base("{+baseurl}/roleManagement/exchange/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property transitiveRoleAssignments for roleManagement
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.UnifiedRoleAssignmentItemRequestBuilder.UnifiedRoleAssignmentItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.UnifiedRoleAssignmentItemRequestBuilder.UnifiedRoleAssignmentItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
