...
using ApiSdk.Models;
using ApiSdk.Users.Item.Onenote.Notebooks;
using ApiSdk.Users.Item.Onenote.Operations;
using ApiSdk.Users.Item.Onenote.Pages;
using ApiSdk.Users.Item.Onenote.Resources;
using ApiSdk.Users.Item.Onenote.SectionGroups;
using ApiSdk.Users.Item.Onenote.Sections;
...
using System;
namespace ApiSdk.Users.Item.Onenote {
    /// <summary>
    ...
    public class OnenoteRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public OnenoteRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/onenote{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="OnenoteRequestBuilder"/> and sets the default values.
        ...
        public OnenoteRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/onenote{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property onenote for users
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/users/{user%2Did}/onenote", PathParameters);
...
#nullable restore
        ...
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Onenote body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.PATCH, "{+baseurl}/users/{user%2Did}/onenote", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
