...
using System;
namespace ApiSdk.Users.Item.Onenote.Notebooks.Item.SectionGroups.Item.ParentSectionGroup {
    /// <summary>
    ...
    public class ParentSectionGroupRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public ParentSectionGroupRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/parentSectionGroup{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ParentSectionGroupRequestBuilder"/> and sets the default values.
        ...
        public ParentSectionGroupRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/parentSectionGroup{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// The section group that contains the section group. Read-only.
