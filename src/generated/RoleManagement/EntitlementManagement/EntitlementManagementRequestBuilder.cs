...
namespace ApiSdk.RoleManagement.EntitlementManagement
{
    ...
    public partial class EntitlementManagementRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildResourceNamespacesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EntitlementManagement.ResourceNamespaces.ResourceNamespacesRequestBuilder(PathParameters);
        ...
        public Command BuildRoleAssignmentApprovalsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentApprovals.RoleAssignmentApprovalsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRoleAssignmentScheduleInstancesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentScheduleInstances.RoleAssignmentScheduleInstancesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRoleAssignmentScheduleRequestsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentScheduleRequests.RoleAssignmentScheduleRequestsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRoleAssignmentSchedulesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentSchedules.RoleAssignmentSchedulesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRoleAssignmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EntitlementManagement.RoleAssignments.RoleAssignmentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRoleDefinitionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EntitlementManagement.RoleDefinitions.RoleDefinitionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRoleEligibilityScheduleInstancesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EntitlementManagement.RoleEligibilityScheduleInstances.RoleEligibilityScheduleInstancesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRoleEligibilityScheduleRequestsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EntitlementManagement.RoleEligibilityScheduleRequests.RoleEligibilityScheduleRequestsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRoleEligibilitySchedulesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EntitlementManagement.RoleEligibilitySchedules.RoleEligibilitySchedulesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildTransitiveRoleAssignmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EntitlementManagement.TransitiveRoleAssignments.TransitiveRoleAssignmentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.RoleManagement.EntitlementManagement.EntitlementManagementRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.RoleManagement.EntitlementManagement.EntitlementManagementRequestBuilder.EntitlementManagementRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.RoleManagement.EntitlementManagement.EntitlementManagementRequestBuilder.EntitlementManagementRequestBuilderGetQueryParameters>> requestConfiguration = default)
