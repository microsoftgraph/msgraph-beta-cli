...
namespace ApiSdk.Users.Item.Todo.Lists.Item {
    ...
    public class TodoTaskListItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public TodoTaskListItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/todo/lists/{todoTaskList%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new TodoTaskListItemRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public TodoTaskListItemRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/todo/lists/{todoTaskList%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Deletes a todoTaskList object.
        /// </summary>
