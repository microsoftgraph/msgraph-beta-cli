...
namespace ApiSdk.Users.Item.Authentication {
    ...
    public class AuthenticationRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildPasswordlessMicrosoftAuthenticatorMethodsNavCommand()
        {
            ...
            var builder = new PasswordlessMicrosoftAuthenticatorMethodsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildPlatformCredentialMethodsNavCommand()
        {
            ...
            var builder = new PlatformCredentialMethodsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildSignInPreferencesNavCommand()
        {
            ...
            var builder = new SignInPreferencesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
