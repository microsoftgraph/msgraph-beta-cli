...
using System;
namespace ApiSdk.Shares.Item.List.Items.Item.Permissions.Item.Grant
{
    /// <summary>
    ...
    public partial class GrantRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Shares.Item.List.Items.Item.Permissions.Item.Grant.GrantPostRequestBody>(global::ApiSdk.Shares.Item.List.Items.Item.Permissions.Item.Grant.GrantPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Shares.Item.List.Items.Item.Permissions.Item.Grant.GrantRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public GrantRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/permissions/{permission%2Did}/grant", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Shares.Item.List.Items.Item.Permissions.Item.Grant.GrantRequestBuilder"/> and sets the default values.
        ...
        public GrantRequestBuilder(string rawUrl) : base("{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/permissions/{permission%2Did}/grant", rawUrl)
        {
        }
        /// <summary>
        /// Grant users access to a link represented by a permission.
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Shares.Item.List.Items.Item.Permissions.Item.Grant.GrantPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Shares.Item.List.Items.Item.Permissions.Item.Grant.GrantPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
