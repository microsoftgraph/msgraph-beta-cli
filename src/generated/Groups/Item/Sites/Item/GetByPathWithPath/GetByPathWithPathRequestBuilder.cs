...
using ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.Archive;
using ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.Columns;
using ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.ContentModels;
...
using ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.DocumentProcessingJobs;
...
using ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.InformationProtection;
...
using ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.PageTemplates;
using ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.Pages;
using ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.Permissions;
using ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.RecycleBin;
...
using ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.Unarchive;
...
namespace ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath
{
    ...
    public partial class GetByPathWithPathRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAnalyticsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.Analytics.AnalyticsRequestBuilder(PathParameters);
        ...
        public Command BuildArchiveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.Archive.ArchiveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildColumnsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.Columns.ColumnsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
        ...
        public Command BuildContentModelsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.ContentModels.ContentModelsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
        ...
        public Command BuildContentTypesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.ContentTypes.ContentTypesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
        ...
        public Command BuildCreatedByUserNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.CreatedByUser.CreatedByUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDocumentProcessingJobsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.DocumentProcessingJobs.DocumentProcessingJobsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
        ...
        public Command BuildDriveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.Drive.DriveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDrivesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.Drives.DrivesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildExternalColumnsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.ExternalColumns.ExternalColumnsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRbCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetApplicableContentTypesForListWithListIdRbCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.GetApplicableContentTypesForListWithListId.GetApplicableContentTypesForListWithListIdRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildInformationProtectionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.InformationProtection.InformationProtectionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildItemsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.Items.ItemsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildLastModifiedByUserNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.LastModifiedByUser.LastModifiedByUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildListsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.Lists.ListsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
        ...
        public Command BuildOnenoteNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.Onenote.OnenoteRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildOperationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.Operations.OperationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
        ...
        public Command BuildPagesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.Pages.PagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
        ...
        public Command BuildPageTemplatesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.PageTemplates.PageTemplatesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
        ...
        public Command BuildPermissionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.Permissions.PermissionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
        ...
        public Command BuildRecycleBinNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.RecycleBin.RecycleBinRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildSitesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.Sites.SitesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTermStoreNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.TermStore.TermStoreRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildUnarchiveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.Unarchive.UnarchiveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.GetByPathWithPathRequestBuilder"/> and sets the default values.
        /// </summary>
