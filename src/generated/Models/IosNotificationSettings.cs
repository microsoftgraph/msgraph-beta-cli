...
namespace ApiSdk.Models
{
    ...
    public partial class IosNotificationSettings : IAdditionalDataHolder, IParsable
    {
        ...
        public global::ApiSdk.Models.IosNotificationAlertType? AlertType { get; set; }
...
#nullable restore
        ...
        public global::ApiSdk.Models.IosNotificationPreviewVisibility? PreviewVisibility { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Models.IosNotificationSettings"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.IosNotificationSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ApiSdk.Models.IosNotificationSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.IosNotificationSettings();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "alertType", n => { AlertType = n.GetEnumValue<global::ApiSdk.Models.IosNotificationAlertType>(); } },
                { "appName", n => { AppName = n.GetStringValue(); } },
                { "badgesEnabled", n => { BadgesEnabled = n.GetBoolValue(); } },
                { "bundleID", n => { BundleID = n.GetStringValue(); } },
                { "enabled", n => { Enabled = n.GetBoolValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "previewVisibility", n => { PreviewVisibility = n.GetEnumValue<global::ApiSdk.Models.IosNotificationPreviewVisibility>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.IosNotificationAlertType>("alertType", AlertType);
            writer.WriteStringValue("appName", AppName);
            writer.WriteBoolValue("badgesEnabled", BadgesEnabled);
            writer.WriteStringValue("bundleID", BundleID);
            writer.WriteBoolValue("enabled", Enabled);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteEnumValue<global::ApiSdk.Models.IosNotificationPreviewVisibility>("previewVisibility", PreviewVisibility);
