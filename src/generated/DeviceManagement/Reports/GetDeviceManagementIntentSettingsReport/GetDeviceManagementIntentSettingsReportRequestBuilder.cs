    ...
    public class GetDeviceManagementIntentSettingsReportRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<GetDeviceManagementIntentSettingsReportPostRequestBody>(GetDeviceManagementIntentSettingsReportPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
...
#nullable enable
        public RequestInformation ToPostRequestInformation(GetDeviceManagementIntentSettingsReportPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(GetDeviceManagementIntentSettingsReportPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
