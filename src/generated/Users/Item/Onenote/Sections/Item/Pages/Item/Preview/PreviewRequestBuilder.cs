...
using System;
namespace ApiSdk.Users.Item.Onenote.Sections.Item.Pages.Item.Preview {
    /// <summary>
    ...
    public class PreviewRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public PreviewRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/preview()", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="PreviewRequestBuilder"/> and sets the default values.
        ...
        public PreviewRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/preview()", rawUrl)
        {
        }
        /// <summary>
        /// Invoke function preview
