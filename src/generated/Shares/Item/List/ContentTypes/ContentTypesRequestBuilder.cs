...
namespace ApiSdk.Shares.Item.List.ContentTypes {
    ...
    public class ContentTypesRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildCreateCommand()
        {
            ...
            command.Description = "Create new navigation property to contentTypes for shares";
        ...
        public ContentTypesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ContentTypesRequestBuilder"/> and sets the default values.
        ...
        public ContentTypesRequestBuilder(string rawUrl) : base("{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// The collection of content types present in this list.
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(ContentType body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
