// <auto-generated/>
using ApiSdk.Drives.Item.List.ContentTypes.Item.ColumnLinks.Count;
using ApiSdk.Drives.Item.List.ContentTypes.Item.ColumnLinks.Item;
...
namespace ApiSdk.Drives.Item.List.ContentTypes.Item.ColumnLinks {
    ...
    public class ColumnLinksRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildCreateCommand()
        {
            ...
            command.Description = "Create new navigation property to columnLinks for drives";
        ...
        public ColumnLinksRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/columnLinks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ColumnLinksRequestBuilder"/> and sets the default values.
        ...
        public ColumnLinksRequestBuilder(string rawUrl) : base("{+baseurl}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/columnLinks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// The collection of columns that are required by this content type
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(ColumnLink body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/columnLinks", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
