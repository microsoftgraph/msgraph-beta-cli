...
namespace ApiSdk.Users.Item.Calendar.Events.Item.ExceptionOccurrences {
    ...
    public class ExceptionOccurrencesRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public ExceptionOccurrencesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/calendar/events/{event%2Did}/exceptionOccurrences{?%24count,%24expand,%24filter,%24orderby,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ExceptionOccurrencesRequestBuilder"/> and sets the default values.
        ...
        public ExceptionOccurrencesRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/calendar/events/{event%2Did}/exceptionOccurrences{?%24count,%24expand,%24filter,%24orderby,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get exceptionOccurrences from users
