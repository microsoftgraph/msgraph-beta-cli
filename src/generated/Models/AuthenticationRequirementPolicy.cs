...
#nullable restore
        ...
        public ApiSdk.Models.RequirementProvider? RequirementProvider { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.AuthenticationRequirementPolicy"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.AuthenticationRequirementPolicy"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.AuthenticationRequirementPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.AuthenticationRequirementPolicy();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "requirementProvider", n => { RequirementProvider = n.GetEnumValue<ApiSdk.Models.RequirementProvider>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.RequirementProvider>("requirementProvider", RequirementProvider);
