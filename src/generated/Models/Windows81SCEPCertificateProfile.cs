...
namespace ApiSdk.Models
{
    ...
    public partial class Windows81SCEPCertificateProfile : global::ApiSdk.Models.Windows81CertificateProfileBase, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.Windows81TrustedRootCertificate? RootCertificate { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.Windows81TrustedRootCertificate RootCertificate { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Models.Windows81SCEPCertificateProfile"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.Windows81SCEPCertificateProfile"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.Windows81SCEPCertificateProfile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.Windows81SCEPCertificateProfile();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "rootCertificate", n => { RootCertificate = n.GetObjectValue<global::ApiSdk.Models.Windows81TrustedRootCertificate>(global::ApiSdk.Models.Windows81TrustedRootCertificate.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::ApiSdk.Models.Windows81TrustedRootCertificate>("rootCertificate", RootCertificate);
