...
namespace ApiSdk.AppCatalogs.TeamsApps {
    ...
    /// </summary>
    public class TeamsAppsRequestBuilder : BaseCliRequestBuilder 
    {
        /// <summary>
        /// Provides operations to manage the teamsApps property of the microsoft.graph.appCatalogs entity.
        /// </summary>
        ...
        public Command BuildListCommand()
        {
            ...
            command.Description = "List apps from the Microsoft Teams app catalog.It includes apps from the Microsoft Teams store, and apps from your organization's app catalog (the tenant app catalog). To get apps from your organization's app catalog only, specify organization as the distributionMethod in the request.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/appcatalogs-list-teamsapps?view=graph-rest-1.0";
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Models.TeamsApp body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Models.TeamsApp body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
