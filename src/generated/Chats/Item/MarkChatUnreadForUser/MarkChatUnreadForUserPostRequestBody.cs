...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Chats.Item.MarkChatUnreadForUser.MarkChatUnreadForUserPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Chats.Item.MarkChatUnreadForUser.MarkChatUnreadForUserPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Chats.Item.MarkChatUnreadForUser.MarkChatUnreadForUserPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Chats.Item.MarkChatUnreadForUser.MarkChatUnreadForUserPostRequestBody();
        }
        /// <summary>
