...
using System;
namespace ApiSdk.Users.Item.Calendar.Events.Item.Instances.Item.Forward
{
    /// <summary>
    ...
    public partial class ForwardRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Users.Item.Calendar.Events.Item.Instances.Item.Forward.ForwardPostRequestBody>(global::ApiSdk.Users.Item.Calendar.Events.Item.Instances.Item.Forward.ForwardPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.Calendar.Events.Item.Instances.Item.Forward.ForwardRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public ForwardRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/calendar/events/{event%2Did}/instances/{event%2Did1}/forward", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.Calendar.Events.Item.Instances.Item.Forward.ForwardRequestBuilder"/> and sets the default values.
        ...
        public ForwardRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/calendar/events/{event%2Did}/instances/{event%2Did1}/forward", rawUrl)
        {
        }
        /// <summary>
        /// This action allows the organizer or attendee of a meeting event to forward themeeting request to a new recipient. If the meeting event is forwarded from an attendee&apos;s Microsoft 365 mailbox to another recipient, this actionalso sends a message to notify the organizer of the forwarding, and adds the recipient to the organizer&apos;scopy of the meeting event. This convenience is not available when forwarding from an Outlook.com account.
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Users.Item.Calendar.Events.Item.Instances.Item.Forward.ForwardPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Users.Item.Calendar.Events.Item.Instances.Item.Forward.ForwardPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
