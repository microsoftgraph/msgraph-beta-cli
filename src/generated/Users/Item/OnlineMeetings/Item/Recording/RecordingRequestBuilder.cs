...
namespace ApiSdk.Users.Item.OnlineMeetings.Item.Recording {
    ...
    public class RecordingRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get recording for the navigation property onlineMeetings from users\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/onlinemeeting-get?view=graph-rest-1.0";
        ...
        public Command BuildPutCommand()
        {
            ...
            command.Description = "Update recording for the navigation property onlineMeetings in users";
            var userIdOption = new Option<string>("--user-id", description: "The unique identifier of user. Use 'me' for the currently signed in user.") {
            };
            userIdOption.IsRequired = true;
            command.AddOption(userIdOption);
