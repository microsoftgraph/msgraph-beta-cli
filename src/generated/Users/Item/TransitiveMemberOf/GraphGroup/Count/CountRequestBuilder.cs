...
using System;
namespace ApiSdk.Users.Item.TransitiveMemberOf.GraphGroup.Count {
    /// <summary>
    ...
    public class CountRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/transitiveMemberOf/graph.group/$count{?%24filter,%24search}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="CountRequestBuilder"/> and sets the default values.
        ...
        public CountRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/transitiveMemberOf/graph.group/$count{?%24filter,%24search}", rawUrl)
        {
        }
        /// <summary>
        /// Get the number of the resource
