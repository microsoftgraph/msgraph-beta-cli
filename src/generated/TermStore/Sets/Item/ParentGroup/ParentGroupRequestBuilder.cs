...
namespace ApiSdk.TermStore.Sets.Item.ParentGroup
{
    ...
    public class ParentGroupRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildSetsNavCommand()
        {
            ...
            var builder = new ApiSdk.TermStore.Sets.Item.ParentGroup.Sets.SetsRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.TermStore.Sets.Item.ParentGroup.ParentGroupRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.TermStore.Sets.Item.ParentGroup.ParentGroupRequestBuilder.ParentGroupRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.TermStore.Sets.Item.ParentGroup.ParentGroupRequestBuilder.ParentGroupRequestBuilderGetQueryParameters>> requestConfiguration = default)
