...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class RemoteAssistanceSettings : ApiSdk.Models.Entity, IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.RemoteAssistanceSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.RemoteAssistanceSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.RemoteAssistanceSettings();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "remoteAssistanceState", n => { RemoteAssistanceState = n.GetEnumValue<ApiSdk.Models.RemoteAssistanceState>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.RemoteAssistanceState>("remoteAssistanceState", RemoteAssistanceState);
        }
    }
}
