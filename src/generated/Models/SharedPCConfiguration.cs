...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class SharedPCConfiguration : ApiSdk.Models.DeviceConfiguration, IParsable
    {
...
#nullable enable
        public ApiSdk.Models.SharedPCAccountManagerPolicy? AccountManagerPolicy { get; set; }
#nullable restore
#else
        public ApiSdk.Models.SharedPCAccountManagerPolicy AccountManagerPolicy { get; set; }
#endif
        /// <summary>Type of accounts that are allowed to share the PC.</summary>
        public ApiSdk.Models.SharedPCAllowedAccountType? AllowedAccounts { get; set; }
        ...
        public ApiSdk.Models.Enablement? FastFirstSignIn { get; set; }
...
#nullable restore
...
#endif
        /// <summary>Possible values of a property</summary>
        public ApiSdk.Models.Enablement? LocalStorage { get; set; }
        /// <summary>Specifies the daily start time of maintenance hour.</summary>
        public Time? MaintenanceStartTime { get; set; }
        /// <summary>Possible values of a property</summary>
        public ApiSdk.Models.Enablement? SetAccountManager { get; set; }
        /// <summary>Possible values of a property</summary>
        public ApiSdk.Models.Enablement? SetEduPolicies { get; set; }
        /// <summary>Possible values of a property</summary>
        public ApiSdk.Models.Enablement? SetPowerPolicies { get; set; }
        /// <summary>Possible values of a property</summary>
        public ApiSdk.Models.Enablement? SignInOnResume { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.SharedPCConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.SharedPCConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.SharedPCConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.SharedPCConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "accountManagerPolicy", n => { AccountManagerPolicy = n.GetObjectValue<ApiSdk.Models.SharedPCAccountManagerPolicy>(ApiSdk.Models.SharedPCAccountManagerPolicy.CreateFromDiscriminatorValue); } },
                { "allowLocalStorage", n => { AllowLocalStorage = n.GetBoolValue(); } },
                { "allowedAccounts", n => { AllowedAccounts = n.GetEnumValue<ApiSdk.Models.SharedPCAllowedAccountType>(); } },
                ...
                { "fastFirstSignIn", n => { FastFirstSignIn = n.GetEnumValue<ApiSdk.Models.Enablement>(); } },
                ...
                { "localStorage", n => { LocalStorage = n.GetEnumValue<ApiSdk.Models.Enablement>(); } },
                { "maintenanceStartTime", n => { MaintenanceStartTime = n.GetTimeValue(); } },
                { "setAccountManager", n => { SetAccountManager = n.GetEnumValue<ApiSdk.Models.Enablement>(); } },
                { "setEduPolicies", n => { SetEduPolicies = n.GetEnumValue<ApiSdk.Models.Enablement>(); } },
                { "setPowerPolicies", n => { SetPowerPolicies = n.GetEnumValue<ApiSdk.Models.Enablement>(); } },
                { "signInOnResume", n => { SignInOnResume = n.GetEnumValue<ApiSdk.Models.Enablement>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.SharedPCAccountManagerPolicy>("accountManagerPolicy", AccountManagerPolicy);
            writer.WriteEnumValue<ApiSdk.Models.SharedPCAllowedAccountType>("allowedAccounts", AllowedAccounts);
            ...
            writer.WriteEnumValue<ApiSdk.Models.Enablement>("fastFirstSignIn", FastFirstSignIn);
            ...
            writer.WriteEnumValue<ApiSdk.Models.Enablement>("localStorage", LocalStorage);
            writer.WriteTimeValue("maintenanceStartTime", MaintenanceStartTime);
            writer.WriteEnumValue<ApiSdk.Models.Enablement>("setAccountManager", SetAccountManager);
            writer.WriteEnumValue<ApiSdk.Models.Enablement>("setEduPolicies", SetEduPolicies);
            writer.WriteEnumValue<ApiSdk.Models.Enablement>("setPowerPolicies", SetPowerPolicies);
            writer.WriteEnumValue<ApiSdk.Models.Enablement>("signInOnResume", SignInOnResume);
        }
    }
}
