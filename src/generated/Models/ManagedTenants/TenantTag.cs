...
namespace ApiSdk.Models.ManagedTenants
{
    ...
    public partial class TenantTag : global::ApiSdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.ManagedTenants.TenantInfo>? Tenants { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.ManagedTenants.TenantInfo> Tenants { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.ManagedTenants.TenantTag"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.ManagedTenants.TenantTag CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.ManagedTenants.TenantTag();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "tenants", n => { Tenants = n.GetCollectionOfObjectValues<global::ApiSdk.Models.ManagedTenants.TenantInfo>(global::ApiSdk.Models.ManagedTenants.TenantInfo.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.ManagedTenants.TenantInfo>("tenants", Tenants);
        }
    }
}
