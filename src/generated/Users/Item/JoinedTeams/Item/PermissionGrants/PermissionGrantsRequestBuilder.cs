...
using ApiSdk.Models;
using ApiSdk.Users.Item.JoinedTeams.Item.PermissionGrants.Count;
using ApiSdk.Users.Item.JoinedTeams.Item.PermissionGrants.Item;
...
using System;
namespace ApiSdk.Users.Item.JoinedTeams.Item.PermissionGrants {
    /// <summary>
    ...
    public class PermissionGrantsRequestBuilder : BaseCliRequestBuilder {
        ...
        public PermissionGrantsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PermissionGrantsRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public PermissionGrantsRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// List all resource-specific permission grants on the team. This list specifies the Microsoft Entra apps that have access to the team, along with each app&apos;s corresponding type of resource-specific access.
        /// </summary>
