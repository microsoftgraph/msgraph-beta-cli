...
using ApiSdk.Groups.Item.Planner.Plans.Item.Tasks.Item.AssignedToTaskBoardFormat;
using ApiSdk.Groups.Item.Planner.Plans.Item.Tasks.Item.BucketTaskBoardFormat;
using ApiSdk.Groups.Item.Planner.Plans.Item.Tasks.Item.Details;
using ApiSdk.Groups.Item.Planner.Plans.Item.Tasks.Item.ProgressTaskBoardFormat;
...
using System;
namespace ApiSdk.Groups.Item.Planner.Plans.Item.Tasks.Item
{
    /// <summary>
    ...
    public partial class PlannerTaskItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAssignedToTaskBoardFormatNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Planner.Plans.Item.Tasks.Item.AssignedToTaskBoardFormat.AssignedToTaskBoardFormatRequestBuilder(PathParameters);
        ...
        public Command BuildBucketTaskBoardFormatNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Planner.Plans.Item.Tasks.Item.BucketTaskBoardFormat.BucketTaskBoardFormatRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildDetailsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Planner.Plans.Item.Tasks.Item.Details.DetailsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildProgressTaskBoardFormatNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Planner.Plans.Item.Tasks.Item.ProgressTaskBoardFormat.ProgressTaskBoardFormatRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Planner.Plans.Item.Tasks.Item.PlannerTaskItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.Planner.Plans.Item.Tasks.Item.PlannerTaskItemRequestBuilder.PlannerTaskItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.Planner.Plans.Item.Tasks.Item.PlannerTaskItemRequestBuilder.PlannerTaskItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
