...
namespace ApiSdk.Sites.Item.Analytics.ItemActivityStats.Item.Activities.Item.DriveItem
{
    ...
    public class DriveItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildContentNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.Analytics.ItemActivityStats.Item.Activities.Item.DriveItem.Content.ContentRequestBuilder(PathParameters);
        ...
        public Command BuildContentStreamNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the site entity.";
            var builder = new ApiSdk.Sites.Item.Analytics.ItemActivityStats.Item.Activities.Item.DriveItem.ContentStream.ContentStreamRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
            foreach (var cmd in execCommands)
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Sites.Item.Analytics.ItemActivityStats.Item.Activities.Item.DriveItem.DriveItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Sites.Item.Analytics.ItemActivityStats.Item.Activities.Item.DriveItem.DriveItemRequestBuilder.DriveItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Sites.Item.Analytics.ItemActivityStats.Item.Activities.Item.DriveItem.DriveItemRequestBuilder.DriveItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
