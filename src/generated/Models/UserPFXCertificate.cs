...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class UserPFXCertificate : ApiSdk.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        public ApiSdk.Models.UserPfxIntendedPurpose? IntendedPurpose { get; set; }
...
#nullable restore
        ...
        public ApiSdk.Models.UserPfxPaddingScheme? PaddingScheme { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.UserPFXCertificate"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.UserPFXCertificate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.UserPFXCertificate();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "intendedPurpose", n => { IntendedPurpose = n.GetEnumValue<ApiSdk.Models.UserPfxIntendedPurpose>(); } },
                { "keyName", n => { KeyName = n.GetStringValue(); } },
                { "lastModifiedDateTime", n => { LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                { "paddingScheme", n => { PaddingScheme = n.GetEnumValue<ApiSdk.Models.UserPfxPaddingScheme>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.UserPfxIntendedPurpose>("intendedPurpose", IntendedPurpose);
            writer.WriteStringValue("keyName", KeyName);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteEnumValue<ApiSdk.Models.UserPfxPaddingScheme>("paddingScheme", PaddingScheme);
