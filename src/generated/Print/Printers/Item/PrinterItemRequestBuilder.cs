...
using ApiSdk.Print.Printers.Item.GetCapabilities;
using ApiSdk.Print.Printers.Item.Jobs;
using ApiSdk.Print.Printers.Item.ResetDefaults;
using ApiSdk.Print.Printers.Item.RestoreFactoryDefaults;
using ApiSdk.Print.Printers.Item.Share;
...
namespace ApiSdk.Print.Printers.Item
{
    ...
    public partial class PrinterItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildConnectorsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Print.Printers.Item.Connectors.ConnectorsRequestBuilder(PathParameters);
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildGetCapabilitiesNavCommand()
        {
            var command = new Command("get-capabilities");
            command.Description = "Provides operations to call the getCapabilities method.";
            var builder = new global::ApiSdk.Print.Printers.Item.GetCapabilities.GetCapabilitiesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildJobsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Print.Printers.Item.Jobs.JobsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Printer>(global::ApiSdk.Models.Printer.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildResetDefaultsNavCommand()
        {
            var command = new Command("reset-defaults");
            command.Description = "Provides operations to call the resetDefaults method.";
            var builder = new global::ApiSdk.Print.Printers.Item.ResetDefaults.ResetDefaultsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildRestoreFactoryDefaultsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Print.Printers.Item.RestoreFactoryDefaults.RestoreFactoryDefaultsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildShareNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Print.Printers.Item.Share.ShareRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSharesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Print.Printers.Item.Shares.SharesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildTaskTriggersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Print.Printers.Item.TaskTriggers.TaskTriggersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Print.Printers.Item.PrinterItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Print.Printers.Item.PrinterItemRequestBuilder.PrinterItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Print.Printers.Item.PrinterItemRequestBuilder.PrinterItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Printer body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Printer body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
