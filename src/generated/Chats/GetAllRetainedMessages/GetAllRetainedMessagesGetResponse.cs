...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Chats.GetAllRetainedMessages.GetAllRetainedMessagesGetResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Chats.GetAllRetainedMessages.GetAllRetainedMessagesGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Chats.GetAllRetainedMessages.GetAllRetainedMessagesGetResponse();
        }
        /// <summary>
