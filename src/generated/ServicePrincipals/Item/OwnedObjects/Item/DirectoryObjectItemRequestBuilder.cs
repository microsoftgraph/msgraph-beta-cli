...
namespace ApiSdk.ServicePrincipals.Item.OwnedObjects.Item
{
    ...
    public partial class DirectoryObjectItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGraphApplicationByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.ServicePrincipals.Item.OwnedObjects.Item.GraphApplication.GraphApplicationRequestBuilder(PathParameters);
        ...
        public Command BuildGraphAppRoleAssignmentByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.ServicePrincipals.Item.OwnedObjects.Item.GraphAppRoleAssignment.GraphAppRoleAssignmentRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGraphEndpointByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.ServicePrincipals.Item.OwnedObjects.Item.GraphEndpoint.GraphEndpointRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGraphGroupByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.ServicePrincipals.Item.OwnedObjects.Item.GraphGroup.GraphGroupRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGraphServicePrincipalByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.ServicePrincipals.Item.OwnedObjects.Item.GraphServicePrincipal.GraphServicePrincipalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.ServicePrincipals.Item.OwnedObjects.Item.DirectoryObjectItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.ServicePrincipals.Item.OwnedObjects.Item.DirectoryObjectItemRequestBuilder.DirectoryObjectItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.ServicePrincipals.Item.OwnedObjects.Item.DirectoryObjectItemRequestBuilder.DirectoryObjectItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
