...
using System;
namespace ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item.GraphAppRoleAssignment
{
    /// <summary>
    ...
    public partial class GraphAppRoleAssignmentRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item.GraphAppRoleAssignment.GraphAppRoleAssignmentRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public GraphAppRoleAssignmentRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}/graph.appRoleAssignment{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item.GraphAppRoleAssignment.GraphAppRoleAssignmentRequestBuilder"/> and sets the default values.
        ...
        public GraphAppRoleAssignmentRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}/graph.appRoleAssignment{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.appRoleAssignment
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item.GraphAppRoleAssignment.GraphAppRoleAssignmentRequestBuilder.GraphAppRoleAssignmentRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item.GraphAppRoleAssignment.GraphAppRoleAssignmentRequestBuilder.GraphAppRoleAssignmentRequestBuilderGetQueryParameters>> requestConfiguration = default)
