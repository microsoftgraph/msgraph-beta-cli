...
namespace ApiSdk.Domains.Item.ServiceConfigurationRecords.Item
{
    ...
    public partial class DomainDnsRecordItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "DNS records the customer adds to the DNS zone file of the domain before the domain can be used by Microsoft Online services. Read-only, Nullable. Does not support $expand.";
            var domainIdOption = new Option<string>("--domain-id", description: "The unique identifier of domain") {
            };
            domainIdOption.IsRequired = true;
            command.AddOption(domainIdOption);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Domains.Item.ServiceConfigurationRecords.Item.DomainDnsRecordItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Domains.Item.ServiceConfigurationRecords.Item.DomainDnsRecordItemRequestBuilder.DomainDnsRecordItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Domains.Item.ServiceConfigurationRecords.Item.DomainDnsRecordItemRequestBuilder.DomainDnsRecordItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
