...
namespace ApiSdk.External.IndustryData.InboundFlows.Item
{
    ...
    public class InboundFlowItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDataConnectorNavCommand()
        {
            ...
            var builder = new DataConnectorRequestBuilder(PathParameters);
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Read the properties and relationships of an inboundFileFlow object.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/industrydata-inboundfileflow-get?view=graph-rest-beta";
            var inboundFlowIdOption = new Option<string>("--inbound-flow-id", description: "The unique identifier of inboundFlow") {
            };
            inboundFlowIdOption.IsRequired = true;
            command.AddOption(inboundFlowIdOption);
