...
using ApiSdk.Models;
using ApiSdk.Users.Item.Chats.Item.PermissionGrants.Count;
using ApiSdk.Users.Item.Chats.Item.PermissionGrants.Item;
...
namespace ApiSdk.Users.Item.Chats.Item.PermissionGrants {
    ...
    public class PermissionGrantsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public PermissionGrantsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/permissionGrants{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="PermissionGrantsRequestBuilder"/> and sets the default values.
        ...
        public PermissionGrantsRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/permissionGrants{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// List all resource-specific permission grants on the chat. This list specifies the Microsoft Entra apps that have access to the chat, along with the corresponding resource-specific access that each app has.
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(ResourceSpecificPermissionGrant body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/permissionGrants", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
