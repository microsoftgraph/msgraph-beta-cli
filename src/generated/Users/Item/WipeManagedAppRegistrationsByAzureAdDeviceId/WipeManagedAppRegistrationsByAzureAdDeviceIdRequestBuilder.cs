    ...
    public class WipeManagedAppRegistrationsByAzureAdDeviceIdRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<WipeManagedAppRegistrationsByAzureAdDeviceIdPostRequestBody>(WipeManagedAppRegistrationsByAzureAdDeviceIdPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
