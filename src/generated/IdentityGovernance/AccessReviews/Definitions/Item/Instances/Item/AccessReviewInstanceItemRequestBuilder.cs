...
namespace ApiSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item
{
    ...
    public partial class AccessReviewInstanceItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAcceptRecommendationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.AcceptRecommendations.AcceptRecommendationsRequestBuilder(PathParameters);
        ...
        public Command BuildApplyDecisionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.ApplyDecisions.ApplyDecisionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildBatchRecordDecisionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.BatchRecordDecisions.BatchRecordDecisionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildContactedReviewersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.ContactedReviewers.ContactedReviewersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildDecisionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.Decisions.DecisionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildDefinitionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.Definition.DefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildResetDecisionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.ResetDecisions.ResetDecisionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSendReminderNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.SendReminder.SendReminderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildStagesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.Stages.StagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildStopApplyDecisionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.StopApplyDecisions.StopApplyDecisionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildStopNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.Stop.StopRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.AccessReviewInstanceItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.AccessReviewInstanceItemRequestBuilder.AccessReviewInstanceItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.AccessReviewInstanceItemRequestBuilder.AccessReviewInstanceItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
