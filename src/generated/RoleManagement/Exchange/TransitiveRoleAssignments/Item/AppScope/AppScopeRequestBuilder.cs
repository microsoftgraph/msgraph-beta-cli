...
using System;
namespace ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.AppScope
{
    /// <summary>
    ...
    public class AppScopeRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.AppScope.AppScopeRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public AppScopeRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/roleManagement/exchange/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}/appScope{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.AppScope.AppScopeRequestBuilder"/> and sets the default values.
        ...
        public AppScopeRequestBuilder(string rawUrl) : base("{+baseurl}/roleManagement/exchange/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}/appScope{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property appScope for roleManagement
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.AppScope.AppScopeRequestBuilder.AppScopeRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.AppScope.AppScopeRequestBuilder.AppScopeRequestBuilderGetQueryParameters>> requestConfiguration = default)
