...
#nullable enable
        public List<ApiSdk.Models.IndustryData.IndustryDataRunActivity>? Activities { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.IndustryData.IndustryDataRunActivity> Activities { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.IndustryData.IndustryDataRun"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.IndustryData.IndustryDataRun CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.IndustryData.IndustryDataRun();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "activities", n => { Activities = n.GetCollectionOfObjectValues<ApiSdk.Models.IndustryData.IndustryDataRunActivity>(ApiSdk.Models.IndustryData.IndustryDataRunActivity.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.IndustryData.IndustryDataRunActivity>("activities", Activities);
