...
using System;
namespace ApiSdk.Admin.Exchange.Mailboxes.Item.Folders.Item.ChildFolders.Delta
{
    /// <summary>
    ...
    public partial class DeltaRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get a set of mailboxFolder objects that have been added, deleted, or removed from the user's mailbox. A delta function call for folders in a mailbox is similar to a GET request, except that by appropriately applying state tokens in one or more of these calls, you can query for incremental changes in the folders. This approach allows you to maintain and synchronize a local store of a user's mail folders without having to fetch all the folders of that mailbox from the server every time.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/mailboxfolder-delta?view=graph-rest-beta";
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Admin.Exchange.Mailboxes.Item.Folders.Item.ChildFolders.Delta.DeltaRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public DeltaRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/admin/exchange/mailboxes/{mailbox%2Did}/folders/{mailboxFolder%2Did}/childFolders/delta(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Admin.Exchange.Mailboxes.Item.Folders.Item.ChildFolders.Delta.DeltaRequestBuilder"/> and sets the default values.
        ...
        public DeltaRequestBuilder(string rawUrl) : base("{+baseurl}/admin/exchange/mailboxes/{mailbox%2Did}/folders/{mailboxFolder%2Did}/childFolders/delta(){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get a set of mailboxFolder objects that have been added, deleted, or removed from the user&apos;s mailbox. A delta function call for folders in a mailbox is similar to a GET request, except that by appropriately applying state tokens in one or more of these calls, you can query for incremental changes in the folders. This approach allows you to maintain and synchronize a local store of a user&apos;s mail folders without having to fetch all the folders of that mailbox from the server every time.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Admin.Exchange.Mailboxes.Item.Folders.Item.ChildFolders.Delta.DeltaRequestBuilder.DeltaRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Admin.Exchange.Mailboxes.Item.Folders.Item.ChildFolders.Delta.DeltaRequestBuilder.DeltaRequestBuilderGetQueryParameters>> requestConfiguration = default)
