...
using System;
namespace ApiSdk.Users.Item.Events.Item.Calendar {
    /// <summary>
    ...
    public class CalendarRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public CalendarRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/events/{event%2Did}/calendar{?%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="CalendarRequestBuilder"/> and sets the default values.
        ...
        public CalendarRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/events/{event%2Did}/calendar{?%24select}", rawUrl)
        {
        }
        /// <summary>
        /// The calendar that contains the event. Navigation property. Read-only.
