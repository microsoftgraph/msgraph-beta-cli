...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class MicrosoftTunnelServerLogCollectionResponse : ApiSdk.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        public ApiSdk.Models.MicrosoftTunnelLogCollectionStatus? Status { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.MicrosoftTunnelServerLogCollectionResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.MicrosoftTunnelServerLogCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.MicrosoftTunnelServerLogCollectionResponse();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "status", n => { Status = n.GetEnumValue<ApiSdk.Models.MicrosoftTunnelLogCollectionStatus>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.MicrosoftTunnelLogCollectionStatus>("status", Status);
        }
    }
}
