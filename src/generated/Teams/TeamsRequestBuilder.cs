...
namespace ApiSdk.Teams {
    ...
    public class TeamsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildGetOpenShiftsNavCommand()
        {
            ...
            var builder = new GetOpenShiftsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetShiftsNavCommand()
        {
            ...
            var builder = new GetShiftsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetTimesOffNavCommand()
        {
            ...
            var builder = new GetTimesOffRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
