    ...
    public partial class EvaluateRemovalRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.InformationProtection.Policy.Labels.EvaluateRemoval.EvaluateRemovalPostRequestBody>(global::ApiSdk.InformationProtection.Policy.Labels.EvaluateRemoval.EvaluateRemovalPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.InformationProtection.Policy.Labels.EvaluateRemoval.EvaluateRemovalRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public EvaluateRemovalRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/informationProtection/policy/labels/evaluateRemoval", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.InformationProtection.Policy.Labels.EvaluateRemoval.EvaluateRemovalRequestBuilder"/> and sets the default values.
        ...
        public EvaluateRemovalRequestBuilder(string rawUrl) : base("{+baseurl}/informationProtection/policy/labels/evaluateRemoval", rawUrl)
        {
        }
        /// <summary>
        /// Indicate to the consuming application what actions it should take to remove the label information. Given contentInfo as an input, which includes existing content metadata key/value pairs, the API returns an informationProtectionAction that contains some combination of one of more of the following: 
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.InformationProtection.Policy.Labels.EvaluateRemoval.EvaluateRemovalPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.InformationProtection.Policy.Labels.EvaluateRemoval.EvaluateRemovalPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
