...
using System;
namespace ApiSdk.Solutions.VirtualEvents.Townhalls.Item.Presenters.Item.SessionsWithJoinWebUrl
{
    /// <summary>
    ...
    public partial class SessionsWithJoinWebUrlRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Solutions.VirtualEvents.Townhalls.Item.Presenters.Item.SessionsWithJoinWebUrl.SessionsWithJoinWebUrlRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public SessionsWithJoinWebUrlRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/presenters/{virtualEventPresenter%2Did}/sessions(joinWebUrl='{joinWebUrl}'){?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Solutions.VirtualEvents.Townhalls.Item.Presenters.Item.SessionsWithJoinWebUrl.SessionsWithJoinWebUrlRequestBuilder"/> and sets the default values.
        ...
        public SessionsWithJoinWebUrlRequestBuilder(string rawUrl) : base("{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/presenters/{virtualEventPresenter%2Did}/sessions(joinWebUrl='{joinWebUrl}'){?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Get sessions from solutions
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Solutions.VirtualEvents.Townhalls.Item.Presenters.Item.SessionsWithJoinWebUrl.SessionsWithJoinWebUrlRequestBuilder.SessionsWithJoinWebUrlRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Solutions.VirtualEvents.Townhalls.Item.Presenters.Item.SessionsWithJoinWebUrl.SessionsWithJoinWebUrlRequestBuilder.SessionsWithJoinWebUrlRequestBuilderGetQueryParameters>> requestConfiguration = default)
