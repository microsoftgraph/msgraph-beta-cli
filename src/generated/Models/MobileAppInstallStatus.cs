...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class MobileAppInstallStatus : ApiSdk.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        public ApiSdk.Models.ResultantAppStateDetail? InstallStateDetail { get; set; }
        /// <summary>Last sync date time</summary>
        public DateTimeOffset? LastSyncDateTime { get; set; }
        /// <summary>A list of possible states for application status on an individual device. When devices contact the Intune service and find targeted application enforcement intent, the status of the enforcement is recorded and becomes accessible in the Graph API. Since the application status is identified during device interaction with the Intune service, status records do not immediately appear upon application group assignment; it is created only after the assignment is evaluated in the service and devices start receiving the policy during check-ins.</summary>
        public ApiSdk.Models.ResultantAppState? MobileAppInstallStatusValue { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.MobileAppInstallStatus"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.MobileAppInstallStatus CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.MobileAppInstallStatus();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "installStateDetail", n => { InstallStateDetail = n.GetEnumValue<ApiSdk.Models.ResultantAppStateDetail>(); } },
                { "lastSyncDateTime", n => { LastSyncDateTime = n.GetDateTimeOffsetValue(); } },
                { "mobileAppInstallStatusValue", n => { MobileAppInstallStatusValue = n.GetEnumValue<ApiSdk.Models.ResultantAppState>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.ResultantAppStateDetail>("installStateDetail", InstallStateDetail);
            writer.WriteDateTimeOffsetValue("lastSyncDateTime", LastSyncDateTime);
            writer.WriteEnumValue<ApiSdk.Models.ResultantAppState>("mobileAppInstallStatusValue", MobileAppInstallStatusValue);
