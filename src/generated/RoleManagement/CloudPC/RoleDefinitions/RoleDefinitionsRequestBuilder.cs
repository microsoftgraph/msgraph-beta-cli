...
using ApiSdk.Models;
using ApiSdk.RoleManagement.CloudPC.RoleDefinitions.Count;
using ApiSdk.RoleManagement.CloudPC.RoleDefinitions.Item;
...
namespace ApiSdk.RoleManagement.CloudPC.RoleDefinitions
{
    ...
    public class RoleDefinitionsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.CloudPC.RoleDefinitions.Item.UnifiedRoleDefinitionItemRequestBuilder(PathParameters);
        ...
        public Command BuildCountNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.CloudPC.RoleDefinitions.Count.CountRequestBuilder(PathParameters);
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.RoleManagement.CloudPC.RoleDefinitions.RoleDefinitionsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public RoleDefinitionsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/roleManagement/cloudPC/roleDefinitions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.RoleManagement.CloudPC.RoleDefinitions.RoleDefinitionsRequestBuilder"/> and sets the default values.
        ...
        public RoleDefinitionsRequestBuilder(string rawUrl) : base("{+baseurl}/roleManagement/cloudPC/roleDefinitions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get a list of unifiedRoleDefinition objects for an RBAC provider. The following RBAC providers are currently supported:- Cloud PC - device management (Intune)- directory (Microsoft Entra ID) - entitlement management (Microsoft Entra ID)- Exchange Online
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.CloudPC.RoleDefinitions.RoleDefinitionsRequestBuilder.RoleDefinitionsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.CloudPC.RoleDefinitions.RoleDefinitionsRequestBuilder.RoleDefinitionsRequestBuilderGetQueryParameters>> requestConfiguration = default)
