...
namespace ApiSdk.DeviceAppManagement.ManagedAppRegistrations {
    ...
    public class ManagedAppRegistrationsRequestBuilder : BaseCliRequestBuilder {
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/intune-mam-androidmanagedappregistration-list?view=graph-rest-1.0" />
        /// </summary>
        public Command BuildListCommand() {
            var command = new Command("list");
            command.Description = "List properties and relationships of the androidManagedAppRegistration objects.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/intune-mam-androidmanagedappregistration-list?view=graph-rest-1.0";
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ManagedAppRegistrationsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<ManagedAppRegistrationsRequestBuilderGetQueryParameters>();
