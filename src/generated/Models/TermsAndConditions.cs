...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.TermsAndConditionsGroupAssignment>? GroupAssignments { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.TermsAndConditionsGroupAssignment> GroupAssignments { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "groupAssignments", n => { GroupAssignments = n.GetCollectionOfObjectValues<ApiSdk.Models.TermsAndConditionsGroupAssignment>(ApiSdk.Models.TermsAndConditionsGroupAssignment.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.TermsAndConditionsGroupAssignment>("groupAssignments", GroupAssignments);
