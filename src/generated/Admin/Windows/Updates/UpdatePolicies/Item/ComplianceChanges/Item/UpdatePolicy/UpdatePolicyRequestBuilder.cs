...
namespace ApiSdk.Admin.Windows.Updates.UpdatePolicies.Item.ComplianceChanges.Item.UpdatePolicy
{
    ...
    public class UpdatePolicyRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Admin.Windows.Updates.UpdatePolicies.Item.ComplianceChanges.Item.UpdatePolicy.UpdatePolicyRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Admin.Windows.Updates.UpdatePolicies.Item.ComplianceChanges.Item.UpdatePolicy.UpdatePolicyRequestBuilder.UpdatePolicyRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Admin.Windows.Updates.UpdatePolicies.Item.ComplianceChanges.Item.UpdatePolicy.UpdatePolicyRequestBuilder.UpdatePolicyRequestBuilderGetQueryParameters>> requestConfiguration = default)
