...
namespace ApiSdk.ServicePrincipals.Item.Owners.Item
{
    ...
    public partial class DirectoryObjectItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGraphEndpointByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.ServicePrincipals.Item.Owners.Item.GraphEndpoint.GraphEndpointRequestBuilder(PathParameters);
        ...
        public Command BuildGraphServicePrincipalByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.ServicePrincipals.Item.Owners.Item.GraphServicePrincipal.GraphServicePrincipalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGraphUserByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.ServicePrincipals.Item.Owners.Item.GraphUser.GraphUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRefByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.ServicePrincipals.Item.Owners.Item.Ref.RefRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.ServicePrincipals.Item.Owners.Item.DirectoryObjectItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        public DirectoryObjectItemRequestBuilder(string rawUrl) : base("{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/owners/{directoryObject%2Did}", rawUrl)
        {
        }
    }
}
