...
using ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.MarkAsJunk;
using ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.MarkAsNotJunk;
using ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Mentions;
...
using ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Unsubscribe;
...
namespace ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item
{
    ...
    public class MessageItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAttachmentsNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Attachments.AttachmentsRequestBuilder(PathParameters);
        ...
        public Command BuildContentNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Value.ContentRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCopyNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Copy.CopyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCreateForwardNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.CreateForward.CreateForwardRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildCreateReplyAllNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.CreateReplyAll.CreateReplyAllRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildCreateReplyNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.CreateReply.CreateReplyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildExtensionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Extensions.ExtensionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildForwardNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Forward.ForwardRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMarkAsJunkNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.MarkAsJunk.MarkAsJunkRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMarkAsNotJunkNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.MarkAsNotJunk.MarkAsNotJunkRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMentionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Mentions.MentionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildMoveNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Move.MoveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildReplyAllNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.ReplyAll.ReplyAllRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildReplyNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Reply.ReplyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSendNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Send.SendRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUnsubscribeNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Unsubscribe.UnsubscribeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.MessageItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.MessageItemRequestBuilder.MessageItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.MessageItemRequestBuilder.MessageItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
