...
namespace ApiSdk.Models {
    ...
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="VirtualEventWebinarRegistrationConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new VirtualEventWebinarRegistrationConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
