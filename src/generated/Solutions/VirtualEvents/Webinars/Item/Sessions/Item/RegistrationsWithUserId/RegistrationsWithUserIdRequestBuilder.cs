...
namespace ApiSdk.Solutions.VirtualEvents.Webinars.Item.Sessions.Item.RegistrationsWithUserId
{
    ...
    public partial class RegistrationsWithUserIdRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Solutions.VirtualEvents.Webinars.Item.Sessions.Item.RegistrationsWithUserId.RegistrationsWithUserIdRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public RegistrationsWithUserIdRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/sessions/{virtualEventSession%2Did}/registrations(userId='{userId}'){?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Solutions.VirtualEvents.Webinars.Item.Sessions.Item.RegistrationsWithUserId.RegistrationsWithUserIdRequestBuilder"/> and sets the default values.
        ...
        public RegistrationsWithUserIdRequestBuilder(string rawUrl) : base("{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/sessions/{virtualEventSession%2Did}/registrations(userId='{userId}'){?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Get registrations from solutions
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Solutions.VirtualEvents.Webinars.Item.Sessions.Item.RegistrationsWithUserId.RegistrationsWithUserIdRequestBuilder.RegistrationsWithUserIdRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Solutions.VirtualEvents.Webinars.Item.Sessions.Item.RegistrationsWithUserId.RegistrationsWithUserIdRequestBuilder.RegistrationsWithUserIdRequestBuilderGetQueryParameters>> requestConfiguration = default)
