    ...
    public class RevokeGrantsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Storage.FileStorage.DeletedContainers.Item.Permissions.Item.RevokeGrants.RevokeGrantsPostRequestBody>(ApiSdk.Storage.FileStorage.DeletedContainers.Item.Permissions.Item.RevokeGrants.RevokeGrantsPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.DeletedContainers.Item.Permissions.Item.RevokeGrants.RevokeGrantsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Storage.FileStorage.DeletedContainers.Item.Permissions.Item.RevokeGrants.RevokeGrantsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Storage.FileStorage.DeletedContainers.Item.Permissions.Item.RevokeGrants.RevokeGrantsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
