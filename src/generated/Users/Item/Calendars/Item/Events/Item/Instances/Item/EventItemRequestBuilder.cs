...
namespace ApiSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item
{
    ...
    public class EventItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAcceptNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.Accept.AcceptRequestBuilder(PathParameters);
        ...
        public Command BuildAttachmentsNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.Attachments.AttachmentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCalendarNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.Calendar.CalendarRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCancelNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.Cancel.CancelRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDeclineNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.Decline.DeclineRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDismissReminderNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.DismissReminder.DismissReminderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildExceptionOccurrencesNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.ExceptionOccurrences.ExceptionOccurrencesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildExtensionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.Extensions.ExtensionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildForwardNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.Forward.ForwardRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSnoozeReminderNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.SnoozeReminder.SnoozeReminderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTentativelyAcceptNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.TentativelyAccept.TentativelyAcceptRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.EventItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.EventItemRequestBuilder.EventItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.EventItemRequestBuilder.EventItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
