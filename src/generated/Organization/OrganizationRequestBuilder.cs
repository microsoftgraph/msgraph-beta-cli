...
using ApiSdk.Organization.Delta;
using ApiSdk.Organization.GetByIds;
using ApiSdk.Organization.GetUserOwnedObjects;
...
namespace ApiSdk.Organization
{
    ...
    public partial class OrganizationRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        /// Provides operations to manage the collection of organization entities.
        /// </summary>
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new global::ApiSdk.Organization.Item.OrganizationItemRequestBuilder(PathParameters);
            ...
            commands.Add(builder.BuildPartnerInformationNavCommand());
            executables.Add(builder.BuildPatchCommand());
            commands.Add(builder.BuildRestoreNavCommand());
            commands.Add(builder.BuildSetMobileDeviceManagementAuthorityNavCommand());
        ...
        public Command BuildCountNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Organization.Count.CountRequestBuilder(PathParameters);
        ...
        public Command BuildDeltaNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Organization.Delta.DeltaRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetByIdsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Organization.GetByIds.GetByIdsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGetUserOwnedObjectsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Organization.GetUserOwnedObjects.GetUserOwnedObjectsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
...
#nullable restore
        ...
        public Command BuildValidatePropertiesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Organization.ValidateProperties.ValidatePropertiesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Organization.OrganizationRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Organization.OrganizationRequestBuilder.OrganizationRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Organization.OrganizationRequestBuilder.OrganizationRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Models.Organization body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Models.Organization body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
