...
using System;
namespace ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.ContentTypes.Item.ColumnPositions.Item
{
    /// <summary>
    ...
    public class ColumnDefinitionItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.ContentTypes.Item.ColumnPositions.Item.ColumnDefinitionItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public ColumnDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list/contentTypes/{contentType%2Did}/columnPositions/{columnDefinition%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.ContentTypes.Item.ColumnPositions.Item.ColumnDefinitionItemRequestBuilder"/> and sets the default values.
        ...
        public ColumnDefinitionItemRequestBuilder(string rawUrl) : base("{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list/contentTypes/{contentType%2Did}/columnPositions/{columnDefinition%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Column order information in a content type.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.ContentTypes.Item.ColumnPositions.Item.ColumnDefinitionItemRequestBuilder.ColumnDefinitionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.ContentTypes.Item.ColumnPositions.Item.ColumnDefinitionItemRequestBuilder.ColumnDefinitionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
