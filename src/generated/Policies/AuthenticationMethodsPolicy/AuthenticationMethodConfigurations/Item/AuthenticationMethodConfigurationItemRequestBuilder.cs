...
namespace ApiSdk.Policies.AuthenticationMethodsPolicy.AuthenticationMethodConfigurations.Item
{
    ...
    public partial class AuthenticationMethodConfigurationItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                var authenticationMethodConfigurationId = invocationContext.ParseResult.GetValueForOption(authenticationMethodConfigurationIdOption);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.AuthenticationMethodConfiguration>(global::ApiSdk.Models.AuthenticationMethodConfiguration.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Policies.AuthenticationMethodsPolicy.AuthenticationMethodConfigurations.Item.AuthenticationMethodConfigurationItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public AuthenticationMethodConfigurationItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/policies/authenticationMethodsPolicy/authenticationMethodConfigurations/{authenticationMethodConfiguration%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Policies.AuthenticationMethodsPolicy.AuthenticationMethodConfigurations.Item.AuthenticationMethodConfigurationItemRequestBuilder"/> and sets the default values.
        ...
        public AuthenticationMethodConfigurationItemRequestBuilder(string rawUrl) : base("{+baseurl}/policies/authenticationMethodsPolicy/authenticationMethodConfigurations/{authenticationMethodConfiguration%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete an externalAuthenticationMethodConfiguration object.
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Policies.AuthenticationMethodsPolicy.AuthenticationMethodConfigurations.Item.AuthenticationMethodConfigurationItemRequestBuilder.AuthenticationMethodConfigurationItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Policies.AuthenticationMethodsPolicy.AuthenticationMethodConfigurations.Item.AuthenticationMethodConfigurationItemRequestBuilder.AuthenticationMethodConfigurationItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.AuthenticationMethodConfiguration body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.AuthenticationMethodConfiguration body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class AuthenticationMethodConfigurationItemRequestBuilderGetQueryParameters 
        {
