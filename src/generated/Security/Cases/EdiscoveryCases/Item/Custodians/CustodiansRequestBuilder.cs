...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians
{
    ...
    public class CustodiansRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.Item.EdiscoveryCustodianItemRequestBuilder(PathParameters);
            executables.Add(builder.BuildDeleteCommand());
            executables.Add(builder.BuildGetCommand());
            commands.Add(builder.BuildLastIndexOperationNavCommand());
            commands.Add(builder.BuildMicrosoftGraphSecurityActivateNavCommand());
        ...
        public Command BuildCountNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.Count.CountRequestBuilder(PathParameters);
...
#nullable restore
        ...
        public Command BuildMicrosoftGraphSecurityApplyHoldNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.MicrosoftGraphSecurityApplyHold.MicrosoftGraphSecurityApplyHoldRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildMicrosoftGraphSecurityRemoveHoldNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.MicrosoftGraphSecurityRemoveHold.MicrosoftGraphSecurityRemoveHoldRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMicrosoftGraphSecurityUpdateIndexNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.MicrosoftGraphSecurityUpdateIndex.MicrosoftGraphSecurityUpdateIndexRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.CustodiansRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.CustodiansRequestBuilder.CustodiansRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.CustodiansRequestBuilder.CustodiansRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Models.Security.EdiscoveryCustodian body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Models.Security.EdiscoveryCustodian body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
