...
using System;
namespace ApiSdk.Users.Item.TransitiveMemberOf.Item.GraphAdministrativeUnit {
    /// <summary>
    ...
    public class GraphAdministrativeUnitRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public GraphAdministrativeUnitRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/transitiveMemberOf/{directoryObject%2Did}/graph.administrativeUnit{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="GraphAdministrativeUnitRequestBuilder"/> and sets the default values.
        ...
        public GraphAdministrativeUnitRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/transitiveMemberOf/{directoryObject%2Did}/graph.administrativeUnit{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.administrativeUnit
