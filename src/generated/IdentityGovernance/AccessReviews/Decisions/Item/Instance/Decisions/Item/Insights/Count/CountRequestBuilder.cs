...
namespace ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Decisions.Item.Insights.Count
{
    ...
    public class CountRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Decisions.Item.Insights.Count.CountRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Decisions.Item.Insights.Count.CountRequestBuilder.CountRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Decisions.Item.Insights.Count.CountRequestBuilder.CountRequestBuilderGetQueryParameters>> requestConfiguration = default)
