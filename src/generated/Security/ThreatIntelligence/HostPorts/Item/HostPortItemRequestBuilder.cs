...
using ApiSdk.Security.ThreatIntelligence.HostPorts.Item.Host;
using ApiSdk.Security.ThreatIntelligence.HostPorts.Item.MostRecentSslCertificate;
...
namespace ApiSdk.Security.ThreatIntelligence.HostPorts.Item
{
    ...
    public partial class HostPortItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property hostPorts for security";
        ...
        public Command BuildHostNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.ThreatIntelligence.HostPorts.Item.Host.HostRequestBuilder(PathParameters);
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildMostRecentSslCertificateNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.ThreatIntelligence.HostPorts.Item.MostRecentSslCertificate.MostRecentSslCertificateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property hostPorts in security";
            var hostPortIdOption = new Option<string>("--host-port-id", description: "The unique identifier of hostPort") {
            };
            hostPortIdOption.IsRequired = true;
            command.AddOption(hostPortIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Security.HostPort>(global::ApiSdk.Models.Security.HostPort.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Security.ThreatIntelligence.HostPorts.Item.HostPortItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.ThreatIntelligence.HostPorts.Item.HostPortItemRequestBuilder.HostPortItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.ThreatIntelligence.HostPorts.Item.HostPortItemRequestBuilder.HostPortItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Security.HostPort body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Security.HostPort body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class HostPortItemRequestBuilderGetQueryParameters 
        {
