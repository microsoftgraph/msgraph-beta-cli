...
using ApiSdk.Models;
using ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.Activities;
using ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.Columns;
using ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.ContentTypes;
using ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.CreatedByUser;
using ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.Drive;
using ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.Items;
using ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.LastModifiedByUser;
using ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.Operations;
using ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.Subscriptions;
...
using System;
namespace ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List
{
    /// <summary>
    ...
    public class ListRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildActivitiesNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.Activities.ActivitiesRequestBuilder(PathParameters);
        ...
        public Command BuildColumnsNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.Columns.ColumnsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildContentTypesNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.ContentTypes.ContentTypesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildCreatedByUserNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.CreatedByUser.CreatedByUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property list for storage";
        ...
        public Command BuildDriveNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.Drive.DriveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildItemsNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.Items.ItemsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildCreateCommand());
            nonExecCommands.Add(builder.BuildDeltaNavCommand());
            nonExecCommands.Add(builder.BuildDeltaWithTokenRbCommand());
            execCommands.Add(builder.BuildListCommand());
            var cmds = builder.BuildCommand();
            execCommands.AddRange(cmds.Item1);
            nonExecCommands.AddRange(cmds.Item2);
        ...
        public Command BuildLastModifiedByUserNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.LastModifiedByUser.LastModifiedByUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            nonExecCommands.Add(builder.BuildMailboxSettingsNavCommand());
        ...
        public Command BuildOperationsNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.Operations.OperationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property list in storage";
            var fileStorageContainerIdOption = new Option<string>("--file-storage-container-id", description: "The unique identifier of fileStorageContainer") {
            };
            fileStorageContainerIdOption.IsRequired = true;
            command.AddOption(fileStorageContainerIdOption);
        ...
        public Command BuildSubscriptionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.Subscriptions.SubscriptionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.ListRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public ListRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.ListRequestBuilder"/> and sets the default values.
        ...
        public ListRequestBuilder(string rawUrl) : base("{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property list for storage
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.ListRequestBuilder.ListRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.ListRequestBuilder.ListRequestBuilderGetQueryParameters>> requestConfiguration = default)
