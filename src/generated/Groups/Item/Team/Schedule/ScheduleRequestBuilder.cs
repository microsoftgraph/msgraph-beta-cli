...
namespace ApiSdk.Groups.Item.Team.Schedule
{
    ...
    public class ScheduleRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDayNotesNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Team.Schedule.DayNotes.DayNotesRequestBuilder(PathParameters);
        ...
        public Command BuildShiftsRoleDefinitionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Team.Schedule.ShiftsRoleDefinitions.ShiftsRoleDefinitionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildTimeCardsNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Team.Schedule.TimeCards.TimeCardsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
