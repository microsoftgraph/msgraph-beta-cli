...
namespace ApiSdk.DeviceManagement.RoleAssignments.Item
{
    ...
    public class DeviceAndAppManagementRoleAssignmentItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildRoleDefinitionNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.RoleAssignments.Item.RoleDefinition.RoleDefinitionRequestBuilder(PathParameters);
        ...
        public Command BuildRoleScopeTagsNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.RoleAssignments.Item.RoleScopeTags.RoleScopeTagsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceManagement.RoleAssignments.Item.DeviceAndAppManagementRoleAssignmentItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceManagement.RoleAssignments.Item.DeviceAndAppManagementRoleAssignmentItemRequestBuilder.DeviceAndAppManagementRoleAssignmentItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceManagement.RoleAssignments.Item.DeviceAndAppManagementRoleAssignmentItemRequestBuilder.DeviceAndAppManagementRoleAssignmentItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.DeviceAndAppManagementRoleAssignment body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.DeviceAndAppManagementRoleAssignment body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
