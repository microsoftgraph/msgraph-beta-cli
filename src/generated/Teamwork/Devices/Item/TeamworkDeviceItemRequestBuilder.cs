...
using ApiSdk.Models;
using ApiSdk.Teamwork.Devices.Item.Activity;
using ApiSdk.Teamwork.Devices.Item.Configuration;
using ApiSdk.Teamwork.Devices.Item.Health;
using ApiSdk.Teamwork.Devices.Item.Operations;
using ApiSdk.Teamwork.Devices.Item.Restart;
using ApiSdk.Teamwork.Devices.Item.RunDiagnostics;
using ApiSdk.Teamwork.Devices.Item.UpdateSoftware;
...
namespace ApiSdk.Teamwork.Devices.Item
{
    ...
    public partial class TeamworkDeviceItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildActivityNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.Devices.Item.Activity.ActivityRequestBuilder(PathParameters);
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildConfigurationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.Devices.Item.Configuration.ConfigurationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property devices for teamwork";
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildHealthNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.Devices.Item.Health.HealthRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildOperationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.Devices.Item.Operations.OperationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property devices in teamwork";
            var teamworkDeviceIdOption = new Option<string>("--teamwork-device-id", description: "The unique identifier of teamworkDevice") {
            };
            teamworkDeviceIdOption.IsRequired = true;
            command.AddOption(teamworkDeviceIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.TeamworkDevice>(global::ApiSdk.Models.TeamworkDevice.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildRestartNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.Devices.Item.Restart.RestartRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildRunDiagnosticsNavCommand()
        {
            var command = new Command("run-diagnostics");
            command.Description = "Provides operations to call the runDiagnostics method.";
            var builder = new global::ApiSdk.Teamwork.Devices.Item.RunDiagnostics.RunDiagnosticsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildUpdateSoftwareNavCommand()
        {
            var command = new Command("update-software");
            command.Description = "Provides operations to call the updateSoftware method.";
            var builder = new global::ApiSdk.Teamwork.Devices.Item.UpdateSoftware.UpdateSoftwareRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Teamwork.Devices.Item.TeamworkDeviceItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Teamwork.Devices.Item.TeamworkDeviceItemRequestBuilder.TeamworkDeviceItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Teamwork.Devices.Item.TeamworkDeviceItemRequestBuilder.TeamworkDeviceItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.TeamworkDevice body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.TeamworkDevice body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
