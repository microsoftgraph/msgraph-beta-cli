...
namespace ApiSdk.Users.Item.Onenote.Notebooks.Item.Sections {
    ...
    public class SectionsRequestBuilder : BaseCliRequestBuilder {
        ...
        public SectionsRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/onenote/notebooks/{notebook%2Did}/sections{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Retrieve a list of onenoteSection objects from the specified notebook.
        /// </summary>
