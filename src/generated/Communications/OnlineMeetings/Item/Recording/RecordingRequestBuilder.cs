...
namespace ApiSdk.Communications.OnlineMeetings.Item.Recording {
    ...
    public class RecordingRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get recording for the navigation property onlineMeetings from communications\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/onlinemeeting-get?view=graph-rest-1.0";
        ...
        public Command BuildPutCommand()
        {
            ...
            command.Description = "Update recording for the navigation property onlineMeetings in communications";
            var onlineMeetingIdOption = new Option<string>("--online-meeting-id", description: "The unique identifier of onlineMeeting") {
            };
            onlineMeetingIdOption.IsRequired = true;
            command.AddOption(onlineMeetingIdOption);
