...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class AndroidWorkProfileEnterpriseWiFiConfiguration : ApiSdk.Models.AndroidWorkProfileWiFiConfiguration, IParsable
    {
...
#nullable enable
        public ApiSdk.Models.AndroidWorkProfileCertificateProfileBase? IdentityCertificateForClientAuthentication { get; set; }
#nullable restore
#else
        public ApiSdk.Models.AndroidWorkProfileCertificateProfileBase IdentityCertificateForClientAuthentication { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.AndroidWorkProfileTrustedRootCertificate? RootCertificateForServerValidation { get; set; }
#nullable restore
#else
        public ApiSdk.Models.AndroidWorkProfileTrustedRootCertificate RootCertificateForServerValidation { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.AndroidWorkProfileEnterpriseWiFiConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.AndroidWorkProfileEnterpriseWiFiConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.AndroidWorkProfileEnterpriseWiFiConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.AndroidWorkProfileEnterpriseWiFiConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "identityCertificateForClientAuthentication", n => { IdentityCertificateForClientAuthentication = n.GetObjectValue<ApiSdk.Models.AndroidWorkProfileCertificateProfileBase>(ApiSdk.Models.AndroidWorkProfileCertificateProfileBase.CreateFromDiscriminatorValue); } },
                ...
                { "rootCertificateForServerValidation", n => { RootCertificateForServerValidation = n.GetObjectValue<ApiSdk.Models.AndroidWorkProfileTrustedRootCertificate>(ApiSdk.Models.AndroidWorkProfileTrustedRootCertificate.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.AndroidWorkProfileCertificateProfileBase>("identityCertificateForClientAuthentication", IdentityCertificateForClientAuthentication);
            ...
            writer.WriteObjectValue<ApiSdk.Models.AndroidWorkProfileTrustedRootCertificate>("rootCertificateForServerValidation", RootCertificateForServerValidation);
