    ...
    public class ClockOutRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Schedule.TimeCards.Item.ClockOut.ClockOutPostRequestBody>(ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Schedule.TimeCards.Item.ClockOut.ClockOutPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Schedule.TimeCards.Item.ClockOut.ClockOutRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Schedule.TimeCards.Item.ClockOut.ClockOutPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Schedule.TimeCards.Item.ClockOut.ClockOutPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
