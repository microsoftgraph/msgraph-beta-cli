...
using ApiSdk.Models;
using ApiSdk.Users.Item.Settings.ContactMergeSuggestions;
using ApiSdk.Users.Item.Settings.Exchange;
...
namespace ApiSdk.Users.Item.Settings
{
    ...
    public partial class SettingsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildContactMergeSuggestionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Settings.ContactMergeSuggestions.ContactMergeSuggestionsRequestBuilder(PathParameters);
        ...
        public Command BuildExchangeNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the exchange property of the microsoft.graph.userSettings entity.";
            var builder = new global::ApiSdk.Users.Item.Settings.Exchange.ExchangeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildItemInsightsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Settings.ItemInsights.ItemInsightsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.UserSettings>(global::ApiSdk.Models.UserSettings.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildRegionalAndLanguageSettingsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Settings.RegionalAndLanguageSettings.RegionalAndLanguageSettingsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildStorageNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Settings.Storage.StorageRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildWindowsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Settings.Windows.WindowsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.Settings.SettingsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.Settings.SettingsRequestBuilder.SettingsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.Settings.SettingsRequestBuilder.SettingsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.UserSettings body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.UserSettings body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
