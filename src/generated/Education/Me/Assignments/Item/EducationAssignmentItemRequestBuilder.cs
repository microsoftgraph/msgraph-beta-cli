// <auto-generated/>
using ApiSdk.Education.Me.Assignments.Item.Activate;
using ApiSdk.Education.Me.Assignments.Item.Categories;
using ApiSdk.Education.Me.Assignments.Item.Deactivate;
using ApiSdk.Education.Me.Assignments.Item.GradingCategory;
using ApiSdk.Education.Me.Assignments.Item.GradingScheme;
...
namespace ApiSdk.Education.Me.Assignments.Item
{
    ...
    public class EducationAssignmentItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildActivateNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Me.Assignments.Item.Activate.ActivateRequestBuilder(PathParameters);
        ...
        public Command BuildCategoriesNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Me.Assignments.Item.Categories.CategoriesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildDeactivateNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Me.Assignments.Item.Deactivate.DeactivateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGradingCategoryNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Me.Assignments.Item.GradingCategory.GradingCategoryRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGradingSchemeNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Me.Assignments.Item.GradingScheme.GradingSchemeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPublishNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Me.Assignments.Item.Publish.PublishRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildResourcesNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Me.Assignments.Item.Resources.ResourcesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRubricNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Me.Assignments.Item.Rubric.RubricRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildSetUpFeedbackResourcesFolderNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Me.Assignments.Item.SetUpFeedbackResourcesFolder.SetUpFeedbackResourcesFolderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSetUpResourcesFolderNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Me.Assignments.Item.SetUpResourcesFolder.SetUpResourcesFolderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSubmissionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Me.Assignments.Item.Submissions.SubmissionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Education.Me.Assignments.Item.EducationAssignmentItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public EducationAssignmentItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/education/me/assignments/{educationAssignment%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Education.Me.Assignments.Item.EducationAssignmentItemRequestBuilder"/> and sets the default values.
        ...
        public EducationAssignmentItemRequestBuilder(string rawUrl) : base("{+baseurl}/education/me/assignments/{educationAssignment%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property assignments for education
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Education.Me.Assignments.Item.EducationAssignmentItemRequestBuilder.EducationAssignmentItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Education.Me.Assignments.Item.EducationAssignmentItemRequestBuilder.EducationAssignmentItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
