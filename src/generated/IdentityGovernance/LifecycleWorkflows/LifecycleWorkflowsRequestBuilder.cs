// <auto-generated/>
using ApiSdk.IdentityGovernance.LifecycleWorkflows.CustomTaskExtensions;
using ApiSdk.IdentityGovernance.LifecycleWorkflows.DeletedItems;
using ApiSdk.IdentityGovernance.LifecycleWorkflows.Insights;
using ApiSdk.IdentityGovernance.LifecycleWorkflows.Settings;
using ApiSdk.IdentityGovernance.LifecycleWorkflows.TaskDefinitions;
using ApiSdk.IdentityGovernance.LifecycleWorkflows.WorkflowTemplates;
using ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows;
...
namespace ApiSdk.IdentityGovernance.LifecycleWorkflows
{
    ...
    public class LifecycleWorkflowsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCustomTaskExtensionsNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.LifecycleWorkflows.CustomTaskExtensions.CustomTaskExtensionsRequestBuilder(PathParameters);
        ...
        public Command BuildDeletedItemsNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.LifecycleWorkflows.DeletedItems.DeletedItemsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildInsightsNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the insights property of the microsoft.graph.identityGovernance.lifecycleWorkflowsContainer entity.";
            var builder = new ApiSdk.IdentityGovernance.LifecycleWorkflows.Insights.InsightsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            nonExecCommands.Add(builder.BuildMicrosoftGraphIdentityGovernanceTopTasksProcessedSummaryWithStartDateTimeWithEndDateTimeRbCommand());
            nonExecCommands.Add(builder.BuildMicrosoftGraphIdentityGovernanceTopWorkflowsProcessedSummaryWithStartDateTimeWithEndDateTimeRbCommand());
            nonExecCommands.Add(builder.BuildMicrosoftGraphIdentityGovernanceWorkflowsProcessedByCategoryWithStartDateTimeWithEndDateTimeRbCommand());
            nonExecCommands.Add(builder.BuildMicrosoftGraphIdentityGovernanceWorkflowsProcessedSummaryWithStartDateTimeWithEndDateTimeRbCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.IdentityGovernance.LifecycleWorkflowsContainer>(ApiSdk.Models.IdentityGovernance.LifecycleWorkflowsContainer.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildSettingsNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.LifecycleWorkflows.Settings.SettingsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
            foreach (var cmd in execCommands)
        ...
        public Command BuildTaskDefinitionsNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.LifecycleWorkflows.TaskDefinitions.TaskDefinitionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildWorkflowsNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.WorkflowsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildWorkflowTemplatesNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.LifecycleWorkflows.WorkflowTemplates.WorkflowTemplatesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.IdentityGovernance.LifecycleWorkflows.LifecycleWorkflowsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.IdentityGovernance.LifecycleWorkflows.LifecycleWorkflowsRequestBuilder.LifecycleWorkflowsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.IdentityGovernance.LifecycleWorkflows.LifecycleWorkflowsRequestBuilder.LifecycleWorkflowsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.IdentityGovernance.LifecycleWorkflowsContainer body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.IdentityGovernance.LifecycleWorkflowsContainer body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
