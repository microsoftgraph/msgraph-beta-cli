...
using ApiSdk.Models;
using ApiSdk.RoleManagement.EntitlementManagement.RoleAssignments.Item.AppScope;
...
using System;
namespace ApiSdk.RoleManagement.EntitlementManagement.RoleAssignments.Item
{
    /// <summary>
    ...
    public class UnifiedRoleAssignmentItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAppScopeNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EntitlementManagement.RoleAssignments.Item.AppScope.AppScopeRequestBuilder(PathParameters);
        ...
        public Command BuildDirectoryScopeNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EntitlementManagement.RoleAssignments.Item.DirectoryScope.DirectoryScopeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPrincipalNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EntitlementManagement.RoleAssignments.Item.Principal.PrincipalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRoleDefinitionNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EntitlementManagement.RoleAssignments.Item.RoleDefinition.RoleDefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.RoleManagement.EntitlementManagement.RoleAssignments.Item.UnifiedRoleAssignmentItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public UnifiedRoleAssignmentItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/roleManagement/entitlementManagement/roleAssignments/{unifiedRoleAssignment%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.RoleManagement.EntitlementManagement.RoleAssignments.Item.UnifiedRoleAssignmentItemRequestBuilder"/> and sets the default values.
        ...
        public UnifiedRoleAssignmentItemRequestBuilder(string rawUrl) : base("{+baseurl}/roleManagement/entitlementManagement/roleAssignments/{unifiedRoleAssignment%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property roleAssignments for roleManagement
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.EntitlementManagement.RoleAssignments.Item.UnifiedRoleAssignmentItemRequestBuilder.UnifiedRoleAssignmentItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.EntitlementManagement.RoleAssignments.Item.UnifiedRoleAssignmentItemRequestBuilder.UnifiedRoleAssignmentItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
