    ...
    public class GrantRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Groups.Item.Sites.Item.Permissions.Item.Grant.GrantPostRequestBody>(ApiSdk.Groups.Item.Sites.Item.Permissions.Item.Grant.GrantPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.Sites.Item.Permissions.Item.Grant.GrantRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Groups.Item.Sites.Item.Permissions.Item.Grant.GrantPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Groups.Item.Sites.Item.Permissions.Item.Grant.GrantPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
