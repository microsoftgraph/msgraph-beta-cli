...
namespace ApiSdk.Groups.Item.Threads.Item
{
    ...
    public class ConversationThreadItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostsNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Threads.Item.Posts.PostsRequestBuilder(PathParameters);
        ...
        public Command BuildReplyNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Threads.Item.Reply.ReplyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.Threads.Item.ConversationThreadItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.Threads.Item.ConversationThreadItemRequestBuilder.ConversationThreadItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.Threads.Item.ConversationThreadItemRequestBuilder.ConversationThreadItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.ConversationThread body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.ConversationThread body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
