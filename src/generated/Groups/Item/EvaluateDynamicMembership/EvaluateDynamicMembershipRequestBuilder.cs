    ...
    public class EvaluateDynamicMembershipRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Groups.Item.EvaluateDynamicMembership.EvaluateDynamicMembershipPostRequestBody>(ApiSdk.Groups.Item.EvaluateDynamicMembership.EvaluateDynamicMembershipPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.EvaluateDynamicMembership.EvaluateDynamicMembershipRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Groups.Item.EvaluateDynamicMembership.EvaluateDynamicMembershipPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Groups.Item.EvaluateDynamicMembership.EvaluateDynamicMembershipPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
