...
namespace ApiSdk.Compliance.Ediscovery.Cases.Item
{
    ...
    public class CaseItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildMicrosoftGraphEdiscoveryCloseNavCommand()
        {
            ...
            var builder = new MicrosoftGraphEdiscoveryCloseRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildMicrosoftGraphEdiscoveryReopenNavCommand()
        {
            ...
            var builder = new MicrosoftGraphEdiscoveryReopenRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<Case>(Case.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildSourceCollectionsNavCommand()
        {
            ...
            var builder = new SourceCollectionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
