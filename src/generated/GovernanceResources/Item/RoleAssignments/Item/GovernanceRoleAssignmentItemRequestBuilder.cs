...
using ApiSdk.GovernanceResources.Item.RoleAssignments.Item.LinkedEligibleRoleAssignment;
using ApiSdk.GovernanceResources.Item.RoleAssignments.Item.Resource;
using ApiSdk.GovernanceResources.Item.RoleAssignments.Item.RoleDefinition;
using ApiSdk.GovernanceResources.Item.RoleAssignments.Item.Subject;
...
namespace ApiSdk.GovernanceResources.Item.RoleAssignments.Item
{
    ...
    public partial class GovernanceRoleAssignmentItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property roleAssignments for governanceResources";
        ...
        public Command BuildLinkedEligibleRoleAssignmentNavCommand()
        {
            ...
            var builder = new global::ApiSdk.GovernanceResources.Item.RoleAssignments.Item.LinkedEligibleRoleAssignment.LinkedEligibleRoleAssignmentRequestBuilder(PathParameters);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property roleAssignments in governanceResources";
            var governanceResourceIdOption = new Option<string>("--governance-resource-id", description: "The unique identifier of governanceResource") {
            };
            governanceResourceIdOption.IsRequired = true;
            command.AddOption(governanceResourceIdOption);
        ...
        public Command BuildResourceNavCommand()
        {
            ...
            var builder = new global::ApiSdk.GovernanceResources.Item.RoleAssignments.Item.Resource.ResourceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRoleDefinitionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.GovernanceResources.Item.RoleAssignments.Item.RoleDefinition.RoleDefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSubjectNavCommand()
        {
            ...
            var builder = new global::ApiSdk.GovernanceResources.Item.RoleAssignments.Item.Subject.SubjectRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.GovernanceResources.Item.RoleAssignments.Item.GovernanceRoleAssignmentItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.GovernanceResources.Item.RoleAssignments.Item.GovernanceRoleAssignmentItemRequestBuilder.GovernanceRoleAssignmentItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.GovernanceResources.Item.RoleAssignments.Item.GovernanceRoleAssignmentItemRequestBuilder.GovernanceRoleAssignmentItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
