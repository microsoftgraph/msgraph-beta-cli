    ...
    public class MarkChatUnreadForUserRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Chats.Item.MarkChatUnreadForUser.MarkChatUnreadForUserPostRequestBody>(ApiSdk.Chats.Item.MarkChatUnreadForUser.MarkChatUnreadForUserPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Chats.Item.MarkChatUnreadForUser.MarkChatUnreadForUserRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Chats.Item.MarkChatUnreadForUser.MarkChatUnreadForUserPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Chats.Item.MarkChatUnreadForUser.MarkChatUnreadForUserPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
