...
namespace ApiSdk.Models
{
    ...
    public class Community : Entity, IParsable
...
#nullable restore
        ...
        public static new Community CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "privacy", n => { Privacy = n.GetEnumValue<CommunityPrivacy>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<CommunityPrivacy>("privacy", Privacy);
        }
    }
}
