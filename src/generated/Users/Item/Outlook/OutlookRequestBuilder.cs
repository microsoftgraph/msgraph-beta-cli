...
namespace ApiSdk.Users.Item.Outlook
{
    ...
    public partial class OutlookRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildMasterCategoriesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Outlook.MasterCategories.MasterCategoriesRequestBuilder(PathParameters);
        ...
        public Command BuildSupportedLanguagesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Outlook.SupportedLanguages.SupportedLanguagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSupportedTimeZonesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Outlook.SupportedTimeZones.SupportedTimeZonesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSupportedTimeZonesWithTimeZoneStandardRbCommand()
        {
            ...
            command.Description = "Provides operations to call the supportedTimeZones method.";
            var builder = new global::ApiSdk.Users.Item.Outlook.SupportedTimeZonesWithTimeZoneStandard.SupportedTimeZonesWithTimeZoneStandardRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTaskFoldersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Outlook.TaskFolders.TaskFoldersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildTaskGroupsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Outlook.TaskGroups.TaskGroupsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildTasksNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Outlook.Tasks.TasksRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.Outlook.OutlookRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public OutlookRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/outlook{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.Outlook.OutlookRequestBuilder"/> and sets the default values.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.Outlook.OutlookRequestBuilder.OutlookRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.Outlook.OutlookRequestBuilder.OutlookRequestBuilderGetQueryParameters>> requestConfiguration = default)
