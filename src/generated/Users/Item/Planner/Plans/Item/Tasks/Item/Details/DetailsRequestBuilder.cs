...
namespace ApiSdk.Users.Item.Planner.Plans.Item.Tasks.Item.Details {
    ...
    public class DetailsRequestBuilder : BaseCliRequestBuilder {
        ...
        public DetailsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}/details{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new DetailsRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public DetailsRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}/details{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property details for users
        /// </summary>
