...
using ApiSdk.Models;
using ApiSdk.PrivilegedApproval.Item.Request;
using ApiSdk.PrivilegedApproval.Item.RoleInfo;
...
namespace ApiSdk.PrivilegedApproval.Item
{
    ...
    public partial class PrivilegedApprovalItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete entity from privilegedApproval";
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get entity from privilegedApproval by key";
            var privilegedApprovalIdOption = new Option<string>("--privileged-approval-id", description: "The unique identifier of privilegedApproval") {
            };
            privilegedApprovalIdOption.IsRequired = true;
            command.AddOption(privilegedApprovalIdOption);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update entity in privilegedApproval";
            var privilegedApprovalIdOption = new Option<string>("--privileged-approval-id", description: "The unique identifier of privilegedApproval") {
            };
            privilegedApprovalIdOption.IsRequired = true;
            command.AddOption(privilegedApprovalIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.PrivilegedApproval>(global::ApiSdk.Models.PrivilegedApproval.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildRequestNavCommand()
        {
            ...
            var builder = new global::ApiSdk.PrivilegedApproval.Item.Request.RequestRequestBuilder(PathParameters);
        ...
        public Command BuildRoleInfoNavCommand()
        {
            ...
            var builder = new global::ApiSdk.PrivilegedApproval.Item.RoleInfo.RoleInfoRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.PrivilegedApproval.Item.PrivilegedApprovalItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.PrivilegedApproval.Item.PrivilegedApprovalItemRequestBuilder.PrivilegedApprovalItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.PrivilegedApproval.Item.PrivilegedApprovalItemRequestBuilder.PrivilegedApprovalItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.PrivilegedApproval body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.PrivilegedApproval body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class PrivilegedApprovalItemRequestBuilderGetQueryParameters 
        {
