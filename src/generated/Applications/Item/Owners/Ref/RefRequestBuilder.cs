...
#nullable restore
        ...
        public Command BuildPostCommand()
        {
            ...
            command.Description = "Use this API to add an owner to an application by posting to the owners collection.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/application-post-owners?view=graph-rest-beta";
            var applicationIdOption = new Option<string>("--application-id", description: "The unique identifier of application") {
            };
            applicationIdOption.IsRequired = true;
            command.AddOption(applicationIdOption);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Applications.Item.Owners.Ref.RefRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToDeleteRequestInformation(Action<RequestConfiguration<ApiSdk.Applications.Item.Owners.Ref.RefRequestBuilder.RefRequestBuilderDeleteQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToDeleteRequestInformation(Action<RequestConfiguration<ApiSdk.Applications.Item.Owners.Ref.RefRequestBuilder.RefRequestBuilderDeleteQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Applications.Item.Owners.Ref.RefRequestBuilder.RefRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Applications.Item.Owners.Ref.RefRequestBuilder.RefRequestBuilderGetQueryParameters>> requestConfiguration = default)
