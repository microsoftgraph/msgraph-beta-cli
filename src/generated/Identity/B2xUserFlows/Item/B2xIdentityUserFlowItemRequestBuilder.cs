...
using ApiSdk.Identity.B2xUserFlows.Item.ApiConnectorConfiguration;
...
namespace ApiSdk.Identity.B2xUserFlows.Item
{
    ...
    public partial class B2xIdentityUserFlowItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildApiConnectorConfigurationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Identity.B2xUserFlows.Item.ApiConnectorConfiguration.ApiConnectorConfigurationRequestBuilder(PathParameters);
        ...
        public Command BuildIdentityProvidersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Identity.B2xUserFlows.Item.IdentityProviders.IdentityProvidersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildLanguagesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Identity.B2xUserFlows.Item.Languages.LanguagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.B2xIdentityUserFlow>(global::ApiSdk.Models.B2xIdentityUserFlow.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildUserAttributeAssignmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Identity.B2xUserFlows.Item.UserAttributeAssignments.UserAttributeAssignmentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildUserFlowIdentityProvidersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Identity.B2xUserFlows.Item.UserFlowIdentityProviders.UserFlowIdentityProvidersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Identity.B2xUserFlows.Item.B2xIdentityUserFlowItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Identity.B2xUserFlows.Item.B2xIdentityUserFlowItemRequestBuilder.B2xIdentityUserFlowItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Identity.B2xUserFlows.Item.B2xIdentityUserFlowItemRequestBuilder.B2xIdentityUserFlowItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.B2xIdentityUserFlow body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.B2xIdentityUserFlow body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
