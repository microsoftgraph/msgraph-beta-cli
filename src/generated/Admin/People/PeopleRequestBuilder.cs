...
using ApiSdk.Admin.People.NamePronunciation;
using ApiSdk.Admin.People.ProfileCardProperties;
using ApiSdk.Admin.People.ProfilePropertySettings;
using ApiSdk.Admin.People.ProfileSources;
using ApiSdk.Admin.People.ProfileSourcesWithSourceId;
...
namespace ApiSdk.Admin.People
{
    ...
    public partial class PeopleRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property people for admin";
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildNamePronunciationNavCommand()
        {
            var command = new Command("name-pronunciation");
            command.Description = "Provides operations to manage the namePronunciation property of the microsoft.graph.peopleAdminSettings entity.";
            var builder = new global::ApiSdk.Admin.People.NamePronunciation.NamePronunciationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.PeopleAdminSettings>(global::ApiSdk.Models.PeopleAdminSettings.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildProfilePropertySettingsNavCommand()
        {
            var command = new Command("profile-property-settings");
            command.Description = "Provides operations to manage the profilePropertySettings property of the microsoft.graph.peopleAdminSettings entity.";
            var builder = new global::ApiSdk.Admin.People.ProfilePropertySettings.ProfilePropertySettingsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildProfileSourcesNavCommand()
        {
            var command = new Command("profile-sources");
            command.Description = "Provides operations to manage the profileSources property of the microsoft.graph.peopleAdminSettings entity.";
            var builder = new global::ApiSdk.Admin.People.ProfileSources.ProfileSourcesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildProfileSourcesWithSourceIdRbCommand()
        {
            var command = new Command("profile-sources-with-source-id");
            command.Description = "Provides operations to manage the profileSources property of the microsoft.graph.peopleAdminSettings entity.";
            var builder = new global::ApiSdk.Admin.People.ProfileSourcesWithSourceId.ProfileSourcesWithSourceIdRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Admin.People.PeopleRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Admin.People.PeopleRequestBuilder.PeopleRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Admin.People.PeopleRequestBuilder.PeopleRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.PeopleAdminSettings body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.PeopleAdminSettings body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
