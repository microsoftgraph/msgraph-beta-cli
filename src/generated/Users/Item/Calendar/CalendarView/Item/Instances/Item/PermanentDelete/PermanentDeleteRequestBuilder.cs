...
using System;
namespace ApiSdk.Users.Item.Calendar.CalendarView.Item.Instances.Item.PermanentDelete
{
    /// <summary>
    ...
    public partial class PermanentDeleteRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.Calendar.CalendarView.Item.Instances.Item.PermanentDelete.PermanentDeleteRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public PermanentDeleteRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/calendar/calendarView/{event%2Did}/instances/{event%2Did1}/permanentDelete", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.Calendar.CalendarView.Item.Instances.Item.PermanentDelete.PermanentDeleteRequestBuilder"/> and sets the default values.
        ...
        public PermanentDeleteRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/calendar/calendarView/{event%2Did}/instances/{event%2Did1}/permanentDelete", rawUrl)
        {
        }
        /// <summary>
        /// Permanently delete an event and place it in the Purges folder in the dumpster in the user&apos;s mailbox. Email clients such as Outlook or the Outlook on the web can&apos;t access permanently deleted items. Unless there&apos;s a hold set on the mailbox, the items are permanently deleted after a set period of time. For more information about item retention, see Configure Deleted Item retention and Recoverable Items quotas.
