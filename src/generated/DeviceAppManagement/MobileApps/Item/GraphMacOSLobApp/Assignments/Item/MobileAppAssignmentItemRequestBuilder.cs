...
using System;
namespace ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSLobApp.Assignments.Item {
    /// <summary>
    ...
    public class MobileAppAssignmentItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public MobileAppAssignmentItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.macOSLobApp/assignments/{mobileAppAssignment%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="MobileAppAssignmentItemRequestBuilder"/> and sets the default values.
        ...
        public MobileAppAssignmentItemRequestBuilder(string rawUrl) : base("{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.macOSLobApp/assignments/{mobileAppAssignment%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property assignments for deviceAppManagement
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.macOSLobApp/assignments/{mobileAppAssignment%2Did}", PathParameters);
...
#nullable restore
        ...
        public RequestInformation ToPatchRequestInformation(MobileAppAssignment body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.PATCH, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.macOSLobApp/assignments/{mobileAppAssignment%2Did}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
