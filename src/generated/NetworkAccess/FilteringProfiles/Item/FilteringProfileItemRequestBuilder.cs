...
namespace ApiSdk.NetworkAccess.FilteringProfiles.Item
{
    ...
    public class FilteringProfileItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildConditionalAccessPoliciesNavCommand()
        {
            ...
            var builder = new ApiSdk.NetworkAccess.FilteringProfiles.Item.ConditionalAccessPolicies.ConditionalAccessPoliciesRequestBuilder(PathParameters);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.Networkaccess.FilteringProfile>(ApiSdk.Models.Networkaccess.FilteringProfile.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPoliciesNavCommand()
        {
            ...
            var builder = new ApiSdk.NetworkAccess.FilteringProfiles.Item.Policies.PoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.NetworkAccess.FilteringProfiles.Item.FilteringProfileItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.NetworkAccess.FilteringProfiles.Item.FilteringProfileItemRequestBuilder.FilteringProfileItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.NetworkAccess.FilteringProfiles.Item.FilteringProfileItemRequestBuilder.FilteringProfileItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Networkaccess.FilteringProfile body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Networkaccess.FilteringProfile body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
