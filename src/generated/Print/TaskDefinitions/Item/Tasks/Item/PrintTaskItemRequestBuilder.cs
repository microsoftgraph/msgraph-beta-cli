...
namespace ApiSdk.Print.TaskDefinitions.Item.Tasks.Item
{
    ...
    public class PrintTaskItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDefinitionNavCommand()
        {
            ...
            var builder = new ApiSdk.Print.TaskDefinitions.Item.Tasks.Item.Definition.DefinitionRequestBuilder(PathParameters);
        ...
        public Command BuildTriggerNavCommand()
        {
            ...
            var builder = new ApiSdk.Print.TaskDefinitions.Item.Tasks.Item.Trigger.TriggerRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Print.TaskDefinitions.Item.Tasks.Item.PrintTaskItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Print.TaskDefinitions.Item.Tasks.Item.PrintTaskItemRequestBuilder.PrintTaskItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Print.TaskDefinitions.Item.Tasks.Item.PrintTaskItemRequestBuilder.PrintTaskItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
