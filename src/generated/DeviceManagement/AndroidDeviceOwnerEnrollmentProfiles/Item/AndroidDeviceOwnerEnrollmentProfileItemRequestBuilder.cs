...
using ApiSdk.DeviceManagement.AndroidDeviceOwnerEnrollmentProfiles.Item.ClearEnrollmentTimeDeviceMembershipTarget;
using ApiSdk.DeviceManagement.AndroidDeviceOwnerEnrollmentProfiles.Item.CreateToken;
using ApiSdk.DeviceManagement.AndroidDeviceOwnerEnrollmentProfiles.Item.RetrieveEnrollmentTimeDeviceMembershipTarget;
using ApiSdk.DeviceManagement.AndroidDeviceOwnerEnrollmentProfiles.Item.RevokeToken;
using ApiSdk.DeviceManagement.AndroidDeviceOwnerEnrollmentProfiles.Item.SetEnrollmentTimeDeviceMembershipTarget;
...
namespace ApiSdk.DeviceManagement.AndroidDeviceOwnerEnrollmentProfiles.Item
{
    ...
    public partial class AndroidDeviceOwnerEnrollmentProfileItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildClearEnrollmentTimeDeviceMembershipTargetNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.AndroidDeviceOwnerEnrollmentProfiles.Item.ClearEnrollmentTimeDeviceMembershipTarget.ClearEnrollmentTimeDeviceMembershipTargetRequestBuilder(PathParameters);
        ...
        public Command BuildRetrieveEnrollmentTimeDeviceMembershipTargetNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.AndroidDeviceOwnerEnrollmentProfiles.Item.RetrieveEnrollmentTimeDeviceMembershipTarget.RetrieveEnrollmentTimeDeviceMembershipTargetRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSetEnrollmentTimeDeviceMembershipTargetNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.AndroidDeviceOwnerEnrollmentProfiles.Item.SetEnrollmentTimeDeviceMembershipTarget.SetEnrollmentTimeDeviceMembershipTargetRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
