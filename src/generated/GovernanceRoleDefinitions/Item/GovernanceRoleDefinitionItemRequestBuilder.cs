...
using ApiSdk.GovernanceRoleDefinitions.Item.Resource;
using ApiSdk.GovernanceRoleDefinitions.Item.RoleSetting;
...
using System;
namespace ApiSdk.GovernanceRoleDefinitions.Item
{
    /// <summary>
    ...
    public partial class GovernanceRoleDefinitionItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete entity from governanceRoleDefinitions";
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get entity from governanceRoleDefinitions by key";
            var governanceRoleDefinitionIdOption = new Option<string>("--governance-role-definition-id", description: "The unique identifier of governanceRoleDefinition") {
            };
            governanceRoleDefinitionIdOption.IsRequired = true;
            command.AddOption(governanceRoleDefinitionIdOption);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update entity in governanceRoleDefinitions";
            var governanceRoleDefinitionIdOption = new Option<string>("--governance-role-definition-id", description: "The unique identifier of governanceRoleDefinition") {
            };
            governanceRoleDefinitionIdOption.IsRequired = true;
            command.AddOption(governanceRoleDefinitionIdOption);
        ...
        public Command BuildResourceNavCommand()
        {
            ...
            var builder = new global::ApiSdk.GovernanceRoleDefinitions.Item.Resource.ResourceRequestBuilder(PathParameters);
        ...
        public Command BuildRoleSettingNavCommand()
        {
            ...
            var builder = new global::ApiSdk.GovernanceRoleDefinitions.Item.RoleSetting.RoleSettingRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.GovernanceRoleDefinitions.Item.GovernanceRoleDefinitionItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public GovernanceRoleDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/governanceRoleDefinitions/{governanceRoleDefinition%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.GovernanceRoleDefinitions.Item.GovernanceRoleDefinitionItemRequestBuilder"/> and sets the default values.
        ...
        public GovernanceRoleDefinitionItemRequestBuilder(string rawUrl) : base("{+baseurl}/governanceRoleDefinitions/{governanceRoleDefinition%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete entity from governanceRoleDefinitions
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.GovernanceRoleDefinitions.Item.GovernanceRoleDefinitionItemRequestBuilder.GovernanceRoleDefinitionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.GovernanceRoleDefinitions.Item.GovernanceRoleDefinitionItemRequestBuilder.GovernanceRoleDefinitionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
