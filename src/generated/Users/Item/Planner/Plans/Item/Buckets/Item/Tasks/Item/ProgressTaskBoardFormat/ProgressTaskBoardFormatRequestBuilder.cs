...
namespace ApiSdk.Users.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item.ProgressTaskBoardFormat {
    ...
    public class ProgressTaskBoardFormatRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public ProgressTaskBoardFormatRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}/progressTaskBoardFormat{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ProgressTaskBoardFormatRequestBuilder"/> and sets the default values.
        ...
        public ProgressTaskBoardFormatRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}/progressTaskBoardFormat{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property progressTaskBoardFormat for users
