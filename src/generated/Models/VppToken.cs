...
namespace ApiSdk.Models
{
    ...
    public partial class VppToken : global::ApiSdk.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        public global::ApiSdk.Models.VppTokenSyncStatus? LastSyncStatus { get; set; }
...
#nullable restore
        ...
        public global::ApiSdk.Models.VppTokenState? State { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.VppTokenActionResult>? TokenActionResults { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.VppTokenActionResult> TokenActionResults { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.VppToken"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.VppToken CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.VppToken();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "lastSyncStatus", n => { LastSyncStatus = n.GetEnumValue<global::ApiSdk.Models.VppTokenSyncStatus>(); } },
                ...
                { "state", n => { State = n.GetEnumValue<global::ApiSdk.Models.VppTokenState>(); } },
                { "token", n => { Token = n.GetStringValue(); } },
                { "tokenActionResults", n => { TokenActionResults = n.GetCollectionOfObjectValues<global::ApiSdk.Models.VppTokenActionResult>(global::ApiSdk.Models.VppTokenActionResult.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.VppTokenSyncStatus>("lastSyncStatus", LastSyncStatus);
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.VppTokenState>("state", State);
            writer.WriteStringValue("token", Token);
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.VppTokenActionResult>("tokenActionResults", TokenActionResults);
