...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class ManagedAppProtectionPolicySetItem : ApiSdk.Models.PolicySetItem, IParsable
    {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.ManagedAppProtectionPolicySetItem"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.ManagedAppProtectionPolicySetItem"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.ManagedAppProtectionPolicySetItem CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.ManagedAppProtectionPolicySetItem();
        }
        /// <summary>
