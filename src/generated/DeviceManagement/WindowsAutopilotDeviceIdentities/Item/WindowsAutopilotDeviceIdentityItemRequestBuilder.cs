...
using ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.AllowNextEnrollment;
using ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.AssignResourceAccountToDevice;
using ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.AssignUserToDevice;
using ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.DeploymentProfile;
using ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.IntendedDeploymentProfile;
using ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.UnassignResourceAccountFromDevice;
...
namespace ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item
{
    ...
    public partial class WindowsAutopilotDeviceIdentityItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAllowNextEnrollmentNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.AllowNextEnrollment.AllowNextEnrollmentRequestBuilder(PathParameters);
        ...
        public Command BuildAssignResourceAccountToDeviceNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.AssignResourceAccountToDevice.AssignResourceAccountToDeviceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildAssignUserToDeviceNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.AssignUserToDevice.AssignUserToDeviceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDeploymentProfileNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.DeploymentProfile.DeploymentProfileRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildIntendedDeploymentProfileNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.IntendedDeploymentProfile.IntendedDeploymentProfileRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUnassignResourceAccountFromDeviceNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.UnassignResourceAccountFromDevice.UnassignResourceAccountFromDeviceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUnassignUserFromDeviceNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.UnassignUserFromDevice.UnassignUserFromDeviceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUpdateDevicePropertiesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.UpdateDeviceProperties.UpdateDevicePropertiesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.WindowsAutopilotDeviceIdentityItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.WindowsAutopilotDeviceIdentityItemRequestBuilder.WindowsAutopilotDeviceIdentityItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.WindowsAutopilotDeviceIdentityItemRequestBuilder.WindowsAutopilotDeviceIdentityItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
