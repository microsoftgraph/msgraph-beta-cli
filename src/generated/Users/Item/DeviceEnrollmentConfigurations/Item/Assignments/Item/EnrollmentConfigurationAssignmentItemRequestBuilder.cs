...
using System;
namespace ApiSdk.Users.Item.DeviceEnrollmentConfigurations.Item.Assignments.Item
{
    /// <summary>
    ...
    public class EnrollmentConfigurationAssignmentItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property assignments for users";
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property assignments in users";
            var userIdOption = new Option<string>("--user-id", description: "The unique identifier of user. Use 'me' for the currently signed in user.") {
            };
            userIdOption.IsRequired = true;
            command.AddOption(userIdOption);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Users.Item.DeviceEnrollmentConfigurations.Item.Assignments.Item.EnrollmentConfigurationAssignmentItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public EnrollmentConfigurationAssignmentItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration%2Did}/assignments/{enrollmentConfigurationAssignment%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Users.Item.DeviceEnrollmentConfigurations.Item.Assignments.Item.EnrollmentConfigurationAssignmentItemRequestBuilder"/> and sets the default values.
        ...
        public EnrollmentConfigurationAssignmentItemRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration%2Did}/assignments/{enrollmentConfigurationAssignment%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property assignments for users
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.DeviceEnrollmentConfigurations.Item.Assignments.Item.EnrollmentConfigurationAssignmentItemRequestBuilder.EnrollmentConfigurationAssignmentItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.DeviceEnrollmentConfigurations.Item.Assignments.Item.EnrollmentConfigurationAssignmentItemRequestBuilder.EnrollmentConfigurationAssignmentItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.EnrollmentConfigurationAssignment body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.EnrollmentConfigurationAssignment body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
