...
using System;
namespace ApiSdk.Compliance.Ediscovery.Cases.Item.SourceCollections.Item.AdditionalSources.Item
{
    /// <summary>
    ...
    public class DataSourceItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property additionalSources for compliance";
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property additionalSources in compliance";
            var caseIdOption = new Option<string>("--case-id", description: "The unique identifier of case") {
            };
            caseIdOption.IsRequired = true;
            command.AddOption(caseIdOption);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Compliance.Ediscovery.Cases.Item.SourceCollections.Item.AdditionalSources.Item.DataSourceItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public DataSourceItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/compliance/ediscovery/cases/{case%2Did}/sourceCollections/{sourceCollection%2Did}/additionalSources/{dataSource%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Compliance.Ediscovery.Cases.Item.SourceCollections.Item.AdditionalSources.Item.DataSourceItemRequestBuilder"/> and sets the default values.
        ...
        public DataSourceItemRequestBuilder(string rawUrl) : base("{+baseurl}/compliance/ediscovery/cases/{case%2Did}/sourceCollections/{sourceCollection%2Did}/additionalSources/{dataSource%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property additionalSources for compliance
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Compliance.Ediscovery.Cases.Item.SourceCollections.Item.AdditionalSources.Item.DataSourceItemRequestBuilder.DataSourceItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Compliance.Ediscovery.Cases.Item.SourceCollections.Item.AdditionalSources.Item.DataSourceItemRequestBuilder.DataSourceItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Ediscovery.DataSource body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Ediscovery.DataSource body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
