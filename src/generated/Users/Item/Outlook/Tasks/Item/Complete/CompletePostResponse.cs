...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Users.Item.Outlook.Tasks.Item.Complete.CompletePostResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Users.Item.Outlook.Tasks.Item.Complete.CompletePostResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Users.Item.Outlook.Tasks.Item.Complete.CompletePostResponse();
        }
        /// <summary>
