...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class DeviceManagementScriptRunSummary : ApiSdk.Models.Entity, IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.DeviceManagementScriptRunSummary"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.DeviceManagementScriptRunSummary CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.DeviceManagementScriptRunSummary();
        }
        /// <summary>
