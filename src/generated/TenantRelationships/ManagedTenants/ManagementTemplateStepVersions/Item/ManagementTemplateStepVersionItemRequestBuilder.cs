...
namespace ApiSdk.TenantRelationships.ManagedTenants.ManagementTemplateStepVersions.Item
{
    ...
    public class ManagementTemplateStepVersionItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAcceptedForNavCommand()
        {
            ...
            var builder = new ApiSdk.TenantRelationships.ManagedTenants.ManagementTemplateStepVersions.Item.AcceptedFor.AcceptedForRequestBuilder(PathParameters);
        ...
        public Command BuildDeploymentsNavCommand()
        {
            ...
            var builder = new ApiSdk.TenantRelationships.ManagedTenants.ManagementTemplateStepVersions.Item.Deployments.DeploymentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildTemplateStepNavCommand()
        {
            ...
            var builder = new ApiSdk.TenantRelationships.ManagedTenants.ManagementTemplateStepVersions.Item.TemplateStep.TemplateStepRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.TenantRelationships.ManagedTenants.ManagementTemplateStepVersions.Item.ManagementTemplateStepVersionItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.TenantRelationships.ManagedTenants.ManagementTemplateStepVersions.Item.ManagementTemplateStepVersionItemRequestBuilder.ManagementTemplateStepVersionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.TenantRelationships.ManagedTenants.ManagementTemplateStepVersions.Item.ManagementTemplateStepVersionItemRequestBuilder.ManagementTemplateStepVersionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.ManagedTenants.ManagementTemplateStepVersion body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.ManagedTenants.ManagementTemplateStepVersion body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
