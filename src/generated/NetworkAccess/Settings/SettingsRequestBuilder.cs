...
using ApiSdk.NetworkAccess.Settings.ConditionalAccess;
using ApiSdk.NetworkAccess.Settings.CrossTenantAccess;
using ApiSdk.NetworkAccess.Settings.EnrichedAuditLogs;
using ApiSdk.NetworkAccess.Settings.ForwardingOptions;
...
namespace ApiSdk.NetworkAccess.Settings
{
    ...
    public partial class SettingsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildConditionalAccessNavCommand()
        {
            ...
            var builder = new global::ApiSdk.NetworkAccess.Settings.ConditionalAccess.ConditionalAccessRequestBuilder(PathParameters);
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildCrossTenantAccessNavCommand()
        {
            ...
            var builder = new global::ApiSdk.NetworkAccess.Settings.CrossTenantAccess.CrossTenantAccessRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property settings for networkAccess";
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildEnrichedAuditLogsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.NetworkAccess.Settings.EnrichedAuditLogs.EnrichedAuditLogsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildForwardingOptionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.NetworkAccess.Settings.ForwardingOptions.ForwardingOptionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Global Secure Access settings.";
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property settings in networkAccess";
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Networkaccess.Settings>(global::ApiSdk.Models.Networkaccess.Settings.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.NetworkAccess.Settings.SettingsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.NetworkAccess.Settings.SettingsRequestBuilder.SettingsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.NetworkAccess.Settings.SettingsRequestBuilder.SettingsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Networkaccess.Settings body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Networkaccess.Settings body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
