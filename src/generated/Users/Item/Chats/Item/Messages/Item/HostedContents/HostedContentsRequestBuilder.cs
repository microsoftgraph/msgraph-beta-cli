...
using ApiSdk.Models;
using ApiSdk.Users.Item.Chats.Item.Messages.Item.HostedContents.Count;
using ApiSdk.Users.Item.Chats.Item.Messages.Item.HostedContents.Item;
...
using System;
namespace ApiSdk.Users.Item.Chats.Item.Messages.Item.HostedContents {
    /// <summary>
    ...
    public class HostedContentsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public HostedContentsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/messages/{chatMessage%2Did}/hostedContents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="HostedContentsRequestBuilder"/> and sets the default values.
        ...
        public HostedContentsRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/messages/{chatMessage%2Did}/hostedContents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Retrieve the list of chatMessageHostedContent objects from a message. This API only lists the hosted content objects. To get the content bytes, see get chatmessage hosted content
