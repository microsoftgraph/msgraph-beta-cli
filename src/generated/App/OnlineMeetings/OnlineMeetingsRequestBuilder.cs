...
using ApiSdk.App.OnlineMeetings.GetAllRecordings;
using ApiSdk.App.OnlineMeetings.GetAllTranscripts;
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(OnlineMeeting body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/app/onlineMeetings", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
