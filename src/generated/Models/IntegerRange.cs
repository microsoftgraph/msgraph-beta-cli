...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.IntegerRange"/> and sets the default values.
        /// </summary>
        public IntegerRange()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.IntegerRange"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.IntegerRange CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.IntegerRange();
        }
        /// <summary>
