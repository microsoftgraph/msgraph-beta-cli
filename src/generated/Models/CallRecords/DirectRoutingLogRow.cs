...
namespace ApiSdk.Models.CallRecords
{
    ...
    public class DirectRoutingLogRow : ApiSdk.Models.CallRecords.CallLogRow, IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.CallRecords.DirectRoutingLogRow"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.CallRecords.DirectRoutingLogRow CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.CallRecords.DirectRoutingLogRow();
        }
        /// <summary>
