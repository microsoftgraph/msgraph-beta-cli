using ApiSdk.Groups.Item.Sites.Item.Onenote.Pages.Count;
using ApiSdk.Groups.Item.Sites.Item.Onenote.Pages.Item;
...
namespace ApiSdk.Groups.Item.Sites.Item.Onenote.Pages {
    ...
    public class PagesRequestBuilder : BaseCliRequestBuilder {
        ...
        public PagesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/pages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Retrieve the properties and relationships of a page object. **Getting page information** Access a page&apos;s metadata by page identifier: **Getting page content** You can use the page&apos;s `content` endpoint to get the HTML content of a page: The `includeIDs=true` query option is used to update pages.
        /// </summary>
