...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.ManagedTenants.AggregatedPolicyCompliance"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.ManagedTenants.AggregatedPolicyCompliance CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.ManagedTenants.AggregatedPolicyCompliance();
        }
        /// <summary>
