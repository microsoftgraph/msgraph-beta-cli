...
using System;
namespace ApiSdk.Groups.Item.Team.Channels.Item.RemoveEmail
{
    /// <summary>
    ...
    public partial class RemoveEmailRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Team.Channels.Item.RemoveEmail.RemoveEmailRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        public RemoveEmailRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/removeEmail", rawUrl)
        {
        }
        /// <summary>
        /// Remove the email address of a channel. You can remove an email address only if it was provisioned using the provisionEmail method or through the Microsoft Teams client.
