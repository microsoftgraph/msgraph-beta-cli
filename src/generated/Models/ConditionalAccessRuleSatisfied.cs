...
namespace ApiSdk.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public ApiSdk.Models.ConditionalAccessConditions? ConditionalAccessCondition { get; set; }
...
#nullable restore
        ...
        public ApiSdk.Models.ConditionalAccessRule? RuleSatisfied { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.ConditionalAccessRuleSatisfied"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.ConditionalAccessRuleSatisfied"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.ConditionalAccessRuleSatisfied CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.ConditionalAccessRuleSatisfied();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "conditionalAccessCondition", n => { ConditionalAccessCondition = n.GetEnumValue<ApiSdk.Models.ConditionalAccessConditions>(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "ruleSatisfied", n => { RuleSatisfied = n.GetEnumValue<ApiSdk.Models.ConditionalAccessRule>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.ConditionalAccessConditions>("conditionalAccessCondition", ConditionalAccessCondition);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteEnumValue<ApiSdk.Models.ConditionalAccessRule>("ruleSatisfied", RuleSatisfied);
