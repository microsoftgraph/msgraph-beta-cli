...
namespace ApiSdk.Models
{
    ...
    public class VirtualEventWebinarRegistrationConfiguration : ApiSdk.Models.VirtualEventRegistrationConfiguration, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.VirtualEventWebinarRegistrationConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.VirtualEventWebinarRegistrationConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.VirtualEventWebinarRegistrationConfiguration();
        }
        /// <summary>
