...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.WorkbookDocumentTask>? Tasks { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.WorkbookDocumentTask> Tasks { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "tasks", n => { Tasks = n.GetCollectionOfObjectValues<ApiSdk.Models.WorkbookDocumentTask>(ApiSdk.Models.WorkbookDocumentTask.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.WorkbookDocumentTask>("tasks", Tasks);
