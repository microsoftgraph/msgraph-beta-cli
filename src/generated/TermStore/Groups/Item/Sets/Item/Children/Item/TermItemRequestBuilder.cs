...
namespace ApiSdk.TermStore.Groups.Item.Sets.Item.Children.Item
{
    ...
    public class TermItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildRelationsNavCommand()
        {
            ...
            var builder = new ApiSdk.TermStore.Groups.Item.Sets.Item.Children.Item.Relations.RelationsRequestBuilder(PathParameters);
        ...
        public Command BuildSetNavCommand()
        {
            ...
            var builder = new ApiSdk.TermStore.Groups.Item.Sets.Item.Children.Item.Set.SetRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSubChildrenNavCommand()
        {
            ...
            var builder = new ApiSdk.TermStore.Groups.Item.Sets.Item.Children.Item.Children.ChildrenRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.TermStore.Groups.Item.Sets.Item.Children.Item.TermItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.TermStore.Groups.Item.Sets.Item.Children.Item.TermItemRequestBuilder.TermItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.TermStore.Groups.Item.Sets.Item.Children.Item.TermItemRequestBuilder.TermItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
