...
using ApiSdk.DirectoryNamespace.Recommendations.Item.ImpactedResources.Item.Complete;
using ApiSdk.DirectoryNamespace.Recommendations.Item.ImpactedResources.Item.Dismiss;
using ApiSdk.DirectoryNamespace.Recommendations.Item.ImpactedResources.Item.Postpone;
using ApiSdk.DirectoryNamespace.Recommendations.Item.ImpactedResources.Item.Reactivate;
...
namespace ApiSdk.DirectoryNamespace.Recommendations.Item.ImpactedResources.Item
{
    ...
    public partial class ImpactedResourceItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCompleteNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DirectoryNamespace.Recommendations.Item.ImpactedResources.Item.Complete.CompleteRequestBuilder(PathParameters);
        ...
        public Command BuildDismissNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DirectoryNamespace.Recommendations.Item.ImpactedResources.Item.Dismiss.DismissRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPostponeNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DirectoryNamespace.Recommendations.Item.ImpactedResources.Item.Postpone.PostponeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildReactivateNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DirectoryNamespace.Recommendations.Item.ImpactedResources.Item.Reactivate.ReactivateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.DirectoryNamespace.Recommendations.Item.ImpactedResources.Item.ImpactedResourceItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DirectoryNamespace.Recommendations.Item.ImpactedResources.Item.ImpactedResourceItemRequestBuilder.ImpactedResourceItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DirectoryNamespace.Recommendations.Item.ImpactedResources.Item.ImpactedResourceItemRequestBuilder.ImpactedResourceItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
