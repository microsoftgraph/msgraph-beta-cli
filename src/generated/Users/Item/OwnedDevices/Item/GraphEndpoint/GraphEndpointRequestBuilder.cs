...
using System;
namespace ApiSdk.Users.Item.OwnedDevices.Item.GraphEndpoint {
    /// <summary>
    ...
    public class GraphEndpointRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public GraphEndpointRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/ownedDevices/{directoryObject%2Did}/graph.endpoint{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="GraphEndpointRequestBuilder"/> and sets the default values.
        ...
        public GraphEndpointRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/ownedDevices/{directoryObject%2Did}/graph.endpoint{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.endpoint
