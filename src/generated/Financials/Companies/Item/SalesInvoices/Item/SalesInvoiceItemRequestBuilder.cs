...
namespace ApiSdk.Financials.Companies.Item.SalesInvoices.Item
{
    ...
    public partial class SalesInvoiceItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildCancelAndSendNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Financials.Companies.Item.SalesInvoices.Item.CancelAndSend.CancelAndSendRequestBuilder(PathParameters);
        ...
        public Command BuildCancelNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Financials.Companies.Item.SalesInvoices.Item.Cancel.CancelRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildCurrencyNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Financials.Companies.Item.SalesInvoices.Item.Currency.CurrencyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCustomerNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Financials.Companies.Item.SalesInvoices.Item.Customer.CustomerRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.SalesInvoice>(global::ApiSdk.Models.SalesInvoice.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPaymentTermNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Financials.Companies.Item.SalesInvoices.Item.PaymentTerm.PaymentTermRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildPostAndSendNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Financials.Companies.Item.SalesInvoices.Item.PostAndSend.PostAndSendRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPostPathNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Financials.Companies.Item.SalesInvoices.Item.Post.PostRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSalesInvoiceLinesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Financials.Companies.Item.SalesInvoices.Item.SalesInvoiceLines.SalesInvoiceLinesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildSendNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Financials.Companies.Item.SalesInvoices.Item.Send.SendRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildShipmentMethodNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Financials.Companies.Item.SalesInvoices.Item.ShipmentMethod.ShipmentMethodRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Financials.Companies.Item.SalesInvoices.Item.SalesInvoiceItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Financials.Companies.Item.SalesInvoices.Item.SalesInvoiceItemRequestBuilder.SalesInvoiceItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Financials.Companies.Item.SalesInvoices.Item.SalesInvoiceItemRequestBuilder.SalesInvoiceItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.SalesInvoice body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.SalesInvoice body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class SalesInvoiceItemRequestBuilderGetQueryParameters 
        {
