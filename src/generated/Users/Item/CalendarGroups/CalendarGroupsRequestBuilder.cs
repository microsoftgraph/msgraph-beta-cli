...
using ApiSdk.Models;
using ApiSdk.Users.Item.CalendarGroups.Count;
using ApiSdk.Users.Item.CalendarGroups.Item;
...
using System;
namespace ApiSdk.Users.Item.CalendarGroups {
    /// <summary>
    /// Provides operations to manage the calendarGroups property of the microsoft.graph.user entity.
    /// </summary>
    public class CalendarGroupsRequestBuilder : BaseCliRequestBuilder 
    {
        /// <summary>
        /// Provides operations to manage the calendarGroups property of the microsoft.graph.user entity.
        /// </summary>
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new CalendarGroupItemRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="CalendarGroupsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public CalendarGroupsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/calendarGroups{?%24count,%24filter,%24orderby,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="CalendarGroupsRequestBuilder"/> and sets the default values.
        ...
        public CalendarGroupsRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/calendarGroups{?%24count,%24filter,%24orderby,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get the user&apos;s calendar groups.
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(CalendarGroup body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/users/{user%2Did}/calendarGroups", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
