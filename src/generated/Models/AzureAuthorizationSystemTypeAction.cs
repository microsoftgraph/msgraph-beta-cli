...
namespace ApiSdk.Models
{
    ...
    public class AzureAuthorizationSystemTypeAction : AuthorizationSystemTypeAction, IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="AzureAuthorizationSystemTypeAction"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new AzureAuthorizationSystemTypeAction CreateFromDiscriminatorValue(IParseNode parseNode)
        {
