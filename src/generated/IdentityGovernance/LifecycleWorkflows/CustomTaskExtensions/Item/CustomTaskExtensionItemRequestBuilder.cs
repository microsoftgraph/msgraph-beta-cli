...
using ApiSdk.IdentityGovernance.LifecycleWorkflows.CustomTaskExtensions.Item.CreatedBy;
using ApiSdk.IdentityGovernance.LifecycleWorkflows.CustomTaskExtensions.Item.LastModifiedBy;
...
namespace ApiSdk.IdentityGovernance.LifecycleWorkflows.CustomTaskExtensions.Item
{
    ...
    public partial class CustomTaskExtensionItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildCreatedByNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.LifecycleWorkflows.CustomTaskExtensions.Item.CreatedBy.CreatedByRequestBuilder(PathParameters);
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.AddOption(customTaskExtensionIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                var customTaskExtensionId = invocationContext.ParseResult.GetValueForOption(customTaskExtensionIdOption);
                var ifMatch = invocationContext.ParseResult.GetValueForOption(ifMatchOption);
                var cancellationToken = invocationContext.GetCancellationToken();
                var reqAdapter = invocationContext.GetRequestAdapter();
                var requestInfo = ToDeleteRequestInformation(q => {
                });
                if (customTaskExtensionId is not null) requestInfo.PathParameters.Add("customTaskExtension%2Did", customTaskExtensionId);
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Read the properties and relationships of a customTaskExtension object.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/identitygovernance-customtaskextension-get?view=graph-rest-beta";
            var customTaskExtensionIdOption = new Option<string>("--custom-task-extension-id", description: "The unique identifier of customTaskExtension") {
            };
            customTaskExtensionIdOption.IsRequired = true;
            command.AddOption(customTaskExtensionIdOption);
        ...
        public Command BuildLastModifiedByNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.LifecycleWorkflows.CustomTaskExtensions.Item.LastModifiedBy.LastModifiedByRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            nonExecCommands.Add(builder.BuildMailboxSettingsNavCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the properties of a customTaskExtension object.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/identitygovernance-customtaskextension-update?view=graph-rest-beta";
            var customTaskExtensionIdOption = new Option<string>("--custom-task-extension-id", description: "The unique identifier of customTaskExtension") {
            };
            customTaskExtensionIdOption.IsRequired = true;
            command.AddOption(customTaskExtensionIdOption);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.IdentityGovernance.LifecycleWorkflows.CustomTaskExtensions.Item.CustomTaskExtensionItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.IdentityGovernance.LifecycleWorkflows.CustomTaskExtensions.Item.CustomTaskExtensionItemRequestBuilder.CustomTaskExtensionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.IdentityGovernance.LifecycleWorkflows.CustomTaskExtensions.Item.CustomTaskExtensionItemRequestBuilder.CustomTaskExtensionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.IdentityGovernance.CustomTaskExtension body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.IdentityGovernance.CustomTaskExtension body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
