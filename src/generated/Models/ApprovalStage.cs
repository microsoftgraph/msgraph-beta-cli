...
#nullable enable
        public List<global::ApiSdk.Models.UserSet>? EscalationApprovers { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.UserSet> EscalationApprovers { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.UserSet>? PrimaryApprovers { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.UserSet> PrimaryApprovers { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Models.ApprovalStage"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.ApprovalStage"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ApiSdk.Models.ApprovalStage CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.ApprovalStage();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "escalationApprovers", n => { EscalationApprovers = n.GetCollectionOfObjectValues<global::ApiSdk.Models.UserSet>(global::ApiSdk.Models.UserSet.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "primaryApprovers", n => { PrimaryApprovers = n.GetCollectionOfObjectValues<global::ApiSdk.Models.UserSet>(global::ApiSdk.Models.UserSet.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.UserSet>("escalationApprovers", EscalationApprovers);
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.UserSet>("primaryApprovers", PrimaryApprovers);
