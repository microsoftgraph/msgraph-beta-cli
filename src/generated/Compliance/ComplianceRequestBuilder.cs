...
namespace ApiSdk.Compliance {
    ...
    public class ComplianceRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildEdiscoveryNavCommand()
        {
            ...
            var builder = new EdiscoveryRequestBuilder(PathParameters);
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ComplianceRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ComplianceRequestBuilderGetQueryParameters>> requestConfiguration = default)
