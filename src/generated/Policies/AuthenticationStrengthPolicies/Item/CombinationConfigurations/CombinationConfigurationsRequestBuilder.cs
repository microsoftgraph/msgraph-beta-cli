...
using ApiSdk.Models;
using ApiSdk.Policies.AuthenticationStrengthPolicies.Item.CombinationConfigurations.Count;
using ApiSdk.Policies.AuthenticationStrengthPolicies.Item.CombinationConfigurations.Item;
...
using System;
namespace ApiSdk.Policies.AuthenticationStrengthPolicies.Item.CombinationConfigurations {
    /// <summary>
    ...
    public class CombinationConfigurationsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public CombinationConfigurationsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/policies/authenticationStrengthPolicies/{authenticationStrengthPolicy%2Did}/combinationConfigurations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="CombinationConfigurationsRequestBuilder"/> and sets the default values.
        ...
        public CombinationConfigurationsRequestBuilder(string rawUrl) : base("{+baseurl}/policies/authenticationStrengthPolicies/{authenticationStrengthPolicy%2Did}/combinationConfigurations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get the authenticationCombinationConfiguration objects for an authentication strength policy. The objects can be of one or more of the following derived types:* fido2combinationConfigurations* x509certificatecombinationconfiguration authenticationCombinationConfiguration objects are supported only for custom authentication strengths.
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(AuthenticationCombinationConfiguration body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/policies/authenticationStrengthPolicies/{authenticationStrengthPolicy%2Did}/combinationConfigurations", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
