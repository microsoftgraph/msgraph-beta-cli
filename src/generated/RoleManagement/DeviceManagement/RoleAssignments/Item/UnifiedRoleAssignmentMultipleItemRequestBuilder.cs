...
namespace ApiSdk.RoleManagement.DeviceManagement.RoleAssignments.Item
{
    ...
    public class UnifiedRoleAssignmentMultipleItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAppScopesNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.DeviceManagement.RoleAssignments.Item.AppScopes.AppScopesRequestBuilder(PathParameters);
        ...
        public Command BuildDirectoryScopesNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.DeviceManagement.RoleAssignments.Item.DirectoryScopes.DirectoryScopesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildPrincipalsNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.DeviceManagement.RoleAssignments.Item.Principals.PrincipalsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildRoleDefinitionNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.DeviceManagement.RoleAssignments.Item.RoleDefinition.RoleDefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.RoleManagement.DeviceManagement.RoleAssignments.Item.UnifiedRoleAssignmentMultipleItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.DeviceManagement.RoleAssignments.Item.UnifiedRoleAssignmentMultipleItemRequestBuilder.UnifiedRoleAssignmentMultipleItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.DeviceManagement.RoleAssignments.Item.UnifiedRoleAssignmentMultipleItemRequestBuilder.UnifiedRoleAssignmentMultipleItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
