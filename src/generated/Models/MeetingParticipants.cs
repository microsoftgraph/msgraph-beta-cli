...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.MeetingParticipantInfo>? Contributors { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.MeetingParticipantInfo> Contributors { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.MeetingParticipantInfo>? Producers { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.MeetingParticipantInfo> Producers { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "contributors", n => { Contributors = n.GetCollectionOfObjectValues<ApiSdk.Models.MeetingParticipantInfo>(ApiSdk.Models.MeetingParticipantInfo.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                { "producers", n => { Producers = n.GetCollectionOfObjectValues<ApiSdk.Models.MeetingParticipantInfo>(ApiSdk.Models.MeetingParticipantInfo.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.MeetingParticipantInfo>("contributors", Contributors);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteObjectValue<ApiSdk.Models.MeetingParticipantInfo>("organizer", Organizer);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.MeetingParticipantInfo>("producers", Producers);
