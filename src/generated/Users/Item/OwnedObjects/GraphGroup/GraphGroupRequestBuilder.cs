...
using ApiSdk.Models;
using ApiSdk.Users.Item.OwnedObjects.GraphGroup.Count;
...
using System;
namespace ApiSdk.Users.Item.OwnedObjects.GraphGroup {
    /// <summary>
    ...
    public class GraphGroupRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public GraphGroupRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/ownedObjects/graph.group{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="GraphGroupRequestBuilder"/> and sets the default values.
        ...
        public GraphGroupRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/ownedObjects/graph.group{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get the items of type microsoft.graph.group in the microsoft.graph.directoryObject collection
