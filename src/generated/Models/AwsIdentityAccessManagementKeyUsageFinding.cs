...
namespace ApiSdk.Models
{
    ...
    public class AwsIdentityAccessManagementKeyUsageFinding : ApiSdk.Models.Finding, IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.AwsIdentityAccessManagementKeyUsageFinding"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.AwsIdentityAccessManagementKeyUsageFinding CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.AwsIdentityAccessManagementKeyUsageFinding();
        }
        /// <summary>
