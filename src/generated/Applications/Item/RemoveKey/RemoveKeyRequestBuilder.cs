...
namespace ApiSdk.Applications.Item.RemoveKey
{
    ...
    public partial class RemoveKeyRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Applications.Item.RemoveKey.RemoveKeyPostRequestBody>(global::ApiSdk.Applications.Item.RemoveKey.RemoveKeyPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Applications.Item.RemoveKey.RemoveKeyRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        public RemoveKeyRequestBuilder(string rawUrl) : base("{+baseurl}/applications/{application%2Did}/removeKey", rawUrl)
        {
        }
        /// <summary>
        /// Remove a key credential from an application. This method along with addKey can be used by an application to automate rolling its expiring keys. As part of the request validation for this method, a proof of possession of an existing key is verified before the action can be performed.
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Applications.Item.RemoveKey.RemoveKeyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Applications.Item.RemoveKey.RemoveKeyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
