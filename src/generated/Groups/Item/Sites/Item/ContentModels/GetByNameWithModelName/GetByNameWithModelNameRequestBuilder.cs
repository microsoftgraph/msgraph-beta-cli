...
using ApiSdk.Groups.Item.Sites.Item.ContentModels.GetByNameWithModelName.AddToDrive;
using ApiSdk.Groups.Item.Sites.Item.ContentModels.GetByNameWithModelName.GetAppliedDrives;
using ApiSdk.Groups.Item.Sites.Item.ContentModels.GetByNameWithModelName.RemoveFromDrive;
...
using System;
namespace ApiSdk.Groups.Item.Sites.Item.ContentModels.GetByNameWithModelName
{
    /// <summary>
    ...
    public partial class GetByNameWithModelNameRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAddToDriveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.ContentModels.GetByNameWithModelName.AddToDrive.AddToDriveRequestBuilder(PathParameters);
        ...
        public Command BuildGetAppliedDrivesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.ContentModels.GetByNameWithModelName.GetAppliedDrives.GetAppliedDrivesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildRemoveFromDriveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.ContentModels.GetByNameWithModelName.RemoveFromDrive.RemoveFromDriveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Sites.Item.ContentModels.GetByNameWithModelName.GetByNameWithModelNameRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public GetByNameWithModelNameRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentModels/getByName(modelName='{modelName}')", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Sites.Item.ContentModels.GetByNameWithModelName.GetByNameWithModelNameRequestBuilder"/> and sets the default values.
        ...
        public GetByNameWithModelNameRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentModels/getByName(modelName='{modelName}')", rawUrl)
        {
        }
        /// <summary>
        /// Read the properties and relationships of a contentModel object by its model name. The name should be the full model filename, including the file extension; for example, exampleModel.classifier.
