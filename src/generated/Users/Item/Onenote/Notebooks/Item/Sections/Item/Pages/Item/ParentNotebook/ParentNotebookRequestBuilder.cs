...
using System;
namespace ApiSdk.Users.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.ParentNotebook {
    /// <summary>
    ...
    public class ParentNotebookRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public ParentNotebookRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/parentNotebook{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ParentNotebookRequestBuilder"/> and sets the default values.
        ...
        public ParentNotebookRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/parentNotebook{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// The notebook that contains the page.  Read-only.
