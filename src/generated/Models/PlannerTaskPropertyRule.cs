...
namespace ApiSdk.Models
{
    ...
    public class PlannerTaskPropertyRule : ApiSdk.Models.PlannerPropertyRule, IParsable
...
#nullable enable
        public ApiSdk.Models.PlannerFieldRules? AppliedCategories { get; set; }
#nullable restore
#else
        public ApiSdk.Models.PlannerFieldRules AppliedCategories { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.PlannerFieldRules? ApprovalAttachment { get; set; }
#nullable restore
#else
        public ApiSdk.Models.PlannerFieldRules ApprovalAttachment { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.PlannerFieldRules? Assignments { get; set; }
#nullable restore
#else
        public ApiSdk.Models.PlannerFieldRules Assignments { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.PlannerFieldRules? CheckLists { get; set; }
#nullable restore
#else
        public ApiSdk.Models.PlannerFieldRules CheckLists { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.PlannerFieldRules? Forms { get; set; }
#nullable restore
#else
        public ApiSdk.Models.PlannerFieldRules Forms { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.PlannerFieldRules? References { get; set; }
#nullable restore
#else
        public ApiSdk.Models.PlannerFieldRules References { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.PlannerTaskPropertyRule"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.PlannerTaskPropertyRule"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.PlannerTaskPropertyRule CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.PlannerTaskPropertyRule();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "appliedCategories", n => { AppliedCategories = n.GetObjectValue<ApiSdk.Models.PlannerFieldRules>(ApiSdk.Models.PlannerFieldRules.CreateFromDiscriminatorValue); } },
                { "approvalAttachment", n => { ApprovalAttachment = n.GetObjectValue<ApiSdk.Models.PlannerFieldRules>(ApiSdk.Models.PlannerFieldRules.CreateFromDiscriminatorValue); } },
                { "assignments", n => { Assignments = n.GetObjectValue<ApiSdk.Models.PlannerFieldRules>(ApiSdk.Models.PlannerFieldRules.CreateFromDiscriminatorValue); } },
                { "checkLists", n => { CheckLists = n.GetObjectValue<ApiSdk.Models.PlannerFieldRules>(ApiSdk.Models.PlannerFieldRules.CreateFromDiscriminatorValue); } },
                ...
                { "forms", n => { Forms = n.GetObjectValue<ApiSdk.Models.PlannerFieldRules>(ApiSdk.Models.PlannerFieldRules.CreateFromDiscriminatorValue); } },
                ...
                { "references", n => { References = n.GetObjectValue<ApiSdk.Models.PlannerFieldRules>(ApiSdk.Models.PlannerFieldRules.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.PlannerFieldRules>("appliedCategories", AppliedCategories);
            writer.WriteObjectValue<ApiSdk.Models.PlannerFieldRules>("approvalAttachment", ApprovalAttachment);
            writer.WriteObjectValue<ApiSdk.Models.PlannerFieldRules>("assignments", Assignments);
            writer.WriteObjectValue<ApiSdk.Models.PlannerFieldRules>("checkLists", CheckLists);
            ...
            writer.WriteObjectValue<ApiSdk.Models.PlannerFieldRules>("forms", Forms);
            ...
            writer.WriteObjectValue<ApiSdk.Models.PlannerFieldRules>("references", References);
