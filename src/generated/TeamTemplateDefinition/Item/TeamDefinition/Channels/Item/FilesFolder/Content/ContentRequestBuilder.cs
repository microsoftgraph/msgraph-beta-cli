...
namespace ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.FilesFolder.Content {
    ...
    public class ContentRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get content for the navigation property filesFolder from teamTemplateDefinition\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/channel-get-filesfolder?view=graph-rest-1.0";
        ...
        public Command BuildPutCommand()
        {
            ...
            command.Description = "Update content for the navigation property filesFolder in teamTemplateDefinition";
            var teamTemplateDefinitionIdOption = new Option<string>("--team-template-definition-id", description: "The unique identifier of teamTemplateDefinition") {
            };
            teamTemplateDefinitionIdOption.IsRequired = true;
            command.AddOption(teamTemplateDefinitionIdOption);
...
#nullable restore
        ...
        public RequestInformation ToPutRequestInformation(Stream body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.PUT, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}/filesFolder/content", PathParameters);
            requestInfo.Configure(requestConfiguration);
