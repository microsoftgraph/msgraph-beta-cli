...
using ApiSdk.Models;
using ApiSdk.Users.Item.OnlineMeetings.Item.AiInsights;
...
namespace ApiSdk.Users.Item.OnlineMeetings.Item
{
    ...
    public partial class OnlineMeetingItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAiInsightsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.OnlineMeetings.Item.AiInsights.AiInsightsRequestBuilder(PathParameters);
        ...
        public Command BuildAlternativeRecordingNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.OnlineMeetings.Item.AlternativeRecording.AlternativeRecordingRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildAttendanceReportsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.OnlineMeetings.Item.AttendanceReports.AttendanceReportsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildAttendeeReportNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the user entity.";
            var builder = new global::ApiSdk.Users.Item.OnlineMeetings.Item.AttendeeReport.AttendeeReportRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        public Command BuildBroadcastRecordingNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the user entity.";
            var builder = new global::ApiSdk.Users.Item.OnlineMeetings.Item.BroadcastRecording.BroadcastRecordingRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        public Command BuildGetVirtualAppointmentJoinWebUrlNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.OnlineMeetings.Item.GetVirtualAppointmentJoinWebUrl.GetVirtualAppointmentJoinWebUrlRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMeetingAttendanceReportNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.OnlineMeetings.Item.MeetingAttendanceReport.MeetingAttendanceReportRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildRecordingNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the user entity.";
            var builder = new global::ApiSdk.Users.Item.OnlineMeetings.Item.Recording.RecordingRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        public Command BuildRecordingsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.OnlineMeetings.Item.Recordings.RecordingsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRegistrationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.OnlineMeetings.Item.Registration.RegistrationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildSendVirtualAppointmentReminderSmsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.OnlineMeetings.Item.SendVirtualAppointmentReminderSms.SendVirtualAppointmentReminderSmsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSendVirtualAppointmentSmsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.OnlineMeetings.Item.SendVirtualAppointmentSms.SendVirtualAppointmentSmsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTranscriptsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.OnlineMeetings.Item.Transcripts.TranscriptsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.OnlineMeetings.Item.OnlineMeetingItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.OnlineMeetings.Item.OnlineMeetingItemRequestBuilder.OnlineMeetingItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.OnlineMeetings.Item.OnlineMeetingItemRequestBuilder.OnlineMeetingItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
