...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<OrganizationalBrandingLocalization>? OrganizationalBrandingLocalizations { get; set; }
#nullable restore
#else
        public List<OrganizationalBrandingLocalization> OrganizationalBrandingLocalizations { get; set; }
#endif
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"localizations", n => { OrganizationalBrandingLocalizations = n.GetCollectionOfObjectValues<OrganizationalBrandingLocalization>(OrganizationalBrandingLocalization.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<OrganizationalBrandingLocalization>("localizations", OrganizationalBrandingLocalizations);
        }
    }
}
