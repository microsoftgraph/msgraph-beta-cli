...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.LoggedOnUser"/> and sets the default values.
        /// </summary>
        public LoggedOnUser()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.LoggedOnUser"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.LoggedOnUser CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.LoggedOnUser();
        }
        /// <summary>
