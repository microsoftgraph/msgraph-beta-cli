...
using System;
namespace ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Calendar
{
    /// <summary>
    ...
    public class CalendarRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Calendar.CalendarRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public CalendarRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/calendar{?%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Calendar.CalendarRequestBuilder"/> and sets the default values.
        ...
        public CalendarRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/calendar{?%24select}", rawUrl)
        {
        }
        /// <summary>
        /// The calendar that contains the event. Navigation property. Read-only.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Calendar.CalendarRequestBuilder.CalendarRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Calendar.CalendarRequestBuilder.CalendarRequestBuilderGetQueryParameters>> requestConfiguration = default)
