...
namespace ApiSdk.Shares.Item.List.Items.Item.DocumentSetVersions.Item.Restore
{
    ...
    public partial class RestoreRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Shares.Item.List.Items.Item.DocumentSetVersions.Item.Restore.RestoreRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        public RestoreRequestBuilder(string rawUrl) : base("{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/documentSetVersions/{documentSetVersion%2Did}/restore", rawUrl)
        {
        }
        /// <summary>
        /// Restore a document set version.
