...
namespace ApiSdk.Education.Classes
{
    ...
    public partial class ClassesRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        /// Provides operations to manage the classes property of the microsoft.graph.educationRoot entity.
        /// </summary>
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Classes.Item.EducationClassItemRequestBuilder(PathParameters);
            commands.Add(builder.BuildAssignmentCategoriesNavCommand());
            commands.Add(builder.BuildAssignmentDefaultsNavCommand());
            commands.Add(builder.BuildAssignmentSettingsNavCommand());
            commands.Add(builder.BuildAssignmentsNavCommand());
            executables.Add(builder.BuildDeleteCommand());
            executables.Add(builder.BuildGetCommand());
            commands.Add(builder.BuildGetRecentlyModifiedSubmissionsNavCommand());
            commands.Add(builder.BuildGroupNavCommand());
            commands.Add(builder.BuildMembersNavCommand());
            commands.Add(builder.BuildModulesNavCommand());
            executables.Add(builder.BuildPatchCommand());
            commands.Add(builder.BuildSchoolsNavCommand());
            commands.Add(builder.BuildTeachersNavCommand());
        ...
        public Command BuildCountNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Classes.Count.CountRequestBuilder(PathParameters);
        ...
        public Command BuildDeltaNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Classes.Delta.DeltaRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildListCommand()
        {
            ...
            command.Description = "Retrieve a list of all class objects. \n\nFind more info here:\n  https://learn.microsoft.com/graph/api/educationroot-list-classes?view=graph-rest-beta";
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Education.Classes.ClassesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Education.Classes.ClassesRequestBuilder.ClassesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Education.Classes.ClassesRequestBuilder.ClassesRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Models.EducationClass body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Models.EducationClass body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
