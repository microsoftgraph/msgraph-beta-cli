...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class DeviceManagementConfigurationPolicyAssignment : ApiSdk.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.DeviceManagementConfigurationPolicyAssignment"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.DeviceManagementConfigurationPolicyAssignment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.DeviceManagementConfigurationPolicyAssignment();
        }
        /// <summary>
