...
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphIosVppApp.AssignedLicenses;
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphIosVppApp.Assignments;
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphIosVppApp.Categories;
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphIosVppApp.Relationships;
...
namespace ApiSdk.DeviceAppManagement.MobileApps.Item.GraphIosVppApp
{
    ...
    public partial class GraphIosVppAppRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        /// Provides operations to manage the assignedLicenses property of the microsoft.graph.iosVppApp entity.
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildAssignedLicensesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphIosVppApp.AssignedLicenses.AssignedLicensesRequestBuilder(PathParameters);
        ...
        public Command BuildAssignmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphIosVppApp.Assignments.AssignmentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildCategoriesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphIosVppApp.Categories.CategoriesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get the item of type microsoft.graph.mobileApp as microsoft.graph.iosVppApp";
        ...
        public Command BuildRelationshipsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphIosVppApp.Relationships.RelationshipsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphIosVppApp.GraphIosVppAppRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphIosVppApp.GraphIosVppAppRequestBuilder.GraphIosVppAppRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphIosVppApp.GraphIosVppAppRequestBuilder.GraphIosVppAppRequestBuilderGetQueryParameters>> requestConfiguration = default)
