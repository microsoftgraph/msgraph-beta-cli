...
using ApiSdk.Groups.Item.Team.PrimaryChannel.GetAllMembers;
...
namespace ApiSdk.Groups.Item.Team.PrimaryChannel
{
    ...
    public partial class PrimaryChannelRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGetAllMembersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PrimaryChannel.GetAllMembers.GetAllMembersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
