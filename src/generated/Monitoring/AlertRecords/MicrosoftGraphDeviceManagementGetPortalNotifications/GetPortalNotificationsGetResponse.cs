...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Monitoring.AlertRecords.MicrosoftGraphDeviceManagementGetPortalNotifications.GetPortalNotificationsGetResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Monitoring.AlertRecords.MicrosoftGraphDeviceManagementGetPortalNotifications.GetPortalNotificationsGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Monitoring.AlertRecords.MicrosoftGraphDeviceManagementGetPortalNotifications.GetPortalNotificationsGetResponse();
        }
        /// <summary>
