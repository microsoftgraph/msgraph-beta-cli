...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.Item
{
    ...
    public class EdiscoveryCustodianItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildLastIndexOperationNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.Item.LastIndexOperation.LastIndexOperationRequestBuilder(PathParameters);
        ...
        public Command BuildMicrosoftGraphSecurityActivateNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.Item.MicrosoftGraphSecurityActivate.MicrosoftGraphSecurityActivateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildMicrosoftGraphSecurityApplyHoldByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.Item.MicrosoftGraphSecurityApplyHold.MicrosoftGraphSecurityApplyHoldRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMicrosoftGraphSecurityReleaseNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.Item.MicrosoftGraphSecurityRelease.MicrosoftGraphSecurityReleaseRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMicrosoftGraphSecurityRemoveHoldByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.Item.MicrosoftGraphSecurityRemoveHold.MicrosoftGraphSecurityRemoveHoldRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildMicrosoftGraphSecurityUpdateIndexByIdNavCommand()
        {
            var command = new Command("microsoft-graph-security-update-index-by-id");
            command.Description = "Provides operations to call the updateIndex method.";
            var builder = new ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.Item.MicrosoftGraphSecurityUpdateIndex.MicrosoftGraphSecurityUpdateIndexRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.Security.EdiscoveryCustodian>(ApiSdk.Models.Security.EdiscoveryCustodian.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildSiteSourcesNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.Item.SiteSources.SiteSourcesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildUnifiedGroupSourcesNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.Item.UnifiedGroupSources.UnifiedGroupSourcesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildUserSourcesNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.Item.UserSources.UserSourcesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.Item.EdiscoveryCustodianItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.Item.EdiscoveryCustodianItemRequestBuilder.EdiscoveryCustodianItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.Item.EdiscoveryCustodianItemRequestBuilder.EdiscoveryCustodianItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Security.EdiscoveryCustodian body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Security.EdiscoveryCustodian body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
