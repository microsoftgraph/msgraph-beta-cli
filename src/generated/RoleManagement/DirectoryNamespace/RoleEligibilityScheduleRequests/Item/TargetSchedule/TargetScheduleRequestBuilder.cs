...
namespace ApiSdk.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item.TargetSchedule
{
    ...
    public partial class TargetScheduleRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item.TargetSchedule.TargetScheduleRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public TargetScheduleRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/roleManagement/directory/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest%2Did}/targetSchedule{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item.TargetSchedule.TargetScheduleRequestBuilder"/> and sets the default values.
        ...
        public TargetScheduleRequestBuilder(string rawUrl) : base("{+baseurl}/roleManagement/directory/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest%2Did}/targetSchedule{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// The schedule for a role eligibility that is referenced through the targetScheduleId property. Supports $expand.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item.TargetSchedule.TargetScheduleRequestBuilder.TargetScheduleRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item.TargetSchedule.TargetScheduleRequestBuilder.TargetScheduleRequestBuilderGetQueryParameters>> requestConfiguration = default)
