...
namespace ApiSdk.TrustFramework.Policies.Item.Value {
    ...
    public class ContentRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/trustFramework/policies/{trustFrameworkPolicy%2Did}/$value", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ContentRequestBuilder"/> and sets the default values.
        ...
        public ContentRequestBuilder(string rawUrl) : base("{+baseurl}/trustFramework/policies/{trustFrameworkPolicy%2Did}/$value", rawUrl)
        {
        }
        /// <summary>
        /// Get media content for the navigation property policies from trustFramework
