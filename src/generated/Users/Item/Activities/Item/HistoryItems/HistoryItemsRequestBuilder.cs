...
namespace ApiSdk.Users.Item.Activities.Item.HistoryItems {
    ...
    public class HistoryItemsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new ActivityHistoryItemItemRequestBuilder(PathParameters);
        ...
        public Command BuildCreateCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ActivityHistoryItem>(ActivityHistoryItem.CreateFromDiscriminatorValue);
                if (model is null) {
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(ActivityHistoryItem body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/users/{user%2Did}/activities/{userActivity%2Did}/historyItems", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
