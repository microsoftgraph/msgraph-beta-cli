// <auto-generated/>
using ApiSdk.DeviceManagement.ManagedDevices.Item.ActivateDeviceEsim;
using ApiSdk.DeviceManagement.ManagedDevices.Item.AssignmentFilterEvaluationStatusDetails;
...
using ApiSdk.DeviceManagement.ManagedDevices.Item.CreateDeviceLogCollectionRequest;
using ApiSdk.DeviceManagement.ManagedDevices.Item.DeleteUserFromSharedAppleDevice;
using ApiSdk.DeviceManagement.ManagedDevices.Item.Deprovision;
using ApiSdk.DeviceManagement.ManagedDevices.Item.DetectedApps;
...
using ApiSdk.DeviceManagement.ManagedDevices.Item.DeviceHealthScriptStates;
using ApiSdk.DeviceManagement.ManagedDevices.Item.Disable;
using ApiSdk.DeviceManagement.ManagedDevices.Item.DisableLostMode;
using ApiSdk.DeviceManagement.ManagedDevices.Item.EnableLostMode;
using ApiSdk.DeviceManagement.ManagedDevices.Item.EnrollNowAction;
using ApiSdk.DeviceManagement.ManagedDevices.Item.GetCloudPcRemoteActionResults;
using ApiSdk.DeviceManagement.ManagedDevices.Item.GetCloudPcReviewStatus;
using ApiSdk.DeviceManagement.ManagedDevices.Item.GetFileVaultKey;
using ApiSdk.DeviceManagement.ManagedDevices.Item.GetNonCompliantSettings;
using ApiSdk.DeviceManagement.ManagedDevices.Item.InitiateDeviceAttestation;
using ApiSdk.DeviceManagement.ManagedDevices.Item.InitiateMobileDeviceManagementKeyRecovery;
using ApiSdk.DeviceManagement.ManagedDevices.Item.InitiateOnDemandProactiveRemediation;
...
using ApiSdk.DeviceManagement.ManagedDevices.Item.ManagedDeviceMobileAppConfigurationStates;
using ApiSdk.DeviceManagement.ManagedDevices.Item.OverrideComplianceState;
using ApiSdk.DeviceManagement.ManagedDevices.Item.PauseConfigurationRefresh;
using ApiSdk.DeviceManagement.ManagedDevices.Item.PlayLostModeSound;
...
using ApiSdk.DeviceManagement.ManagedDevices.Item.Reenable;
using ApiSdk.DeviceManagement.ManagedDevices.Item.RemoteLock;
using ApiSdk.DeviceManagement.ManagedDevices.Item.RemoveDeviceFirmwareConfigurationInterfaceManagement;
using ApiSdk.DeviceManagement.ManagedDevices.Item.ReprovisionCloudPc;
...
using ApiSdk.DeviceManagement.ManagedDevices.Item.ResizeCloudPc;
using ApiSdk.DeviceManagement.ManagedDevices.Item.RestoreCloudPc;
using ApiSdk.DeviceManagement.ManagedDevices.Item.Retire;
using ApiSdk.DeviceManagement.ManagedDevices.Item.RevokeAppleVppLicenses;
using ApiSdk.DeviceManagement.ManagedDevices.Item.RotateBitLockerKeys;
using ApiSdk.DeviceManagement.ManagedDevices.Item.RotateFileVaultKey;
using ApiSdk.DeviceManagement.ManagedDevices.Item.RotateLocalAdminPassword;
using ApiSdk.DeviceManagement.ManagedDevices.Item.SecurityBaselineStates;
using ApiSdk.DeviceManagement.ManagedDevices.Item.SendCustomNotificationToCompanyPortal;
using ApiSdk.DeviceManagement.ManagedDevices.Item.SetCloudPcReviewStatus;
using ApiSdk.DeviceManagement.ManagedDevices.Item.SetDeviceName;
using ApiSdk.DeviceManagement.ManagedDevices.Item.ShutDown;
using ApiSdk.DeviceManagement.ManagedDevices.Item.SyncDevice;
using ApiSdk.DeviceManagement.ManagedDevices.Item.TriggerConfigurationManagerAction;
...
namespace ApiSdk.DeviceManagement.ManagedDevices.Item
{
    ...
    public class ManagedDeviceItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildActivateDeviceEsimNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.ActivateDeviceEsim.ActivateDeviceEsimRequestBuilder(PathParameters);
        ...
        public Command BuildAssignmentFilterEvaluationStatusDetailsNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.AssignmentFilterEvaluationStatusDetails.AssignmentFilterEvaluationStatusDetailsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildBypassActivationLockNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.BypassActivationLock.BypassActivationLockRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildCleanWindowsDeviceNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.CleanWindowsDevice.CleanWindowsDeviceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildCreateDeviceLogCollectionRequestNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.CreateDeviceLogCollectionRequest.CreateDeviceLogCollectionRequestRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDeleteUserFromSharedAppleDeviceNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.DeleteUserFromSharedAppleDevice.DeleteUserFromSharedAppleDeviceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDeprovisionNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.Deprovision.DeprovisionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDetectedAppsNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.DetectedApps.DetectedAppsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildDeviceCategoryNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.DeviceCategory.DeviceCategoryRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildDeviceCompliancePolicyStatesNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.DeviceCompliancePolicyStates.DeviceCompliancePolicyStatesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildDeviceConfigurationStatesNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.DeviceConfigurationStates.DeviceConfigurationStatesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildDeviceHealthScriptStatesNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.DeviceHealthScriptStates.DeviceHealthScriptStatesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildDisableLostModeNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.DisableLostMode.DisableLostModeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDisableNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.Disable.DisableRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildEnableLostModeNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.EnableLostMode.EnableLostModeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildEnrollNowActionNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.EnrollNowAction.EnrollNowActionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetCloudPcRemoteActionResultsNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.GetCloudPcRemoteActionResults.GetCloudPcRemoteActionResultsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetCloudPcReviewStatusNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.GetCloudPcReviewStatus.GetCloudPcReviewStatusRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetFileVaultKeyNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.GetFileVaultKey.GetFileVaultKeyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetNonCompliantSettingsNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.GetNonCompliantSettings.GetNonCompliantSettingsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildInitiateDeviceAttestationNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.InitiateDeviceAttestation.InitiateDeviceAttestationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildInitiateMobileDeviceManagementKeyRecoveryNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.InitiateMobileDeviceManagementKeyRecovery.InitiateMobileDeviceManagementKeyRecoveryRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildInitiateOnDemandProactiveRemediationNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.InitiateOnDemandProactiveRemediation.InitiateOnDemandProactiveRemediationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildLocateDeviceNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.LocateDevice.LocateDeviceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildLogCollectionRequestsNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.LogCollectionRequests.LogCollectionRequestsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildLogoutSharedAppleDeviceActiveUserNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.LogoutSharedAppleDeviceActiveUser.LogoutSharedAppleDeviceActiveUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildManagedDeviceMobileAppConfigurationStatesNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.ManagedDeviceMobileAppConfigurationStates.ManagedDeviceMobileAppConfigurationStatesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildOverrideComplianceStateNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.OverrideComplianceState.OverrideComplianceStateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPauseConfigurationRefreshNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.PauseConfigurationRefresh.PauseConfigurationRefreshRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPlayLostModeSoundNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.PlayLostModeSound.PlayLostModeSoundRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRebootNowNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.RebootNow.RebootNowRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRecoverPasscodeNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.RecoverPasscode.RecoverPasscodeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildReenableNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.Reenable.ReenableRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRemoteLockNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.RemoteLock.RemoteLockRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRemoveDeviceFirmwareConfigurationInterfaceManagementNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.RemoveDeviceFirmwareConfigurationInterfaceManagement.RemoveDeviceFirmwareConfigurationInterfaceManagementRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildReprovisionCloudPcNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.ReprovisionCloudPc.ReprovisionCloudPcRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRequestRemoteAssistanceNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.RequestRemoteAssistance.RequestRemoteAssistanceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildResetPasscodeNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.ResetPasscode.ResetPasscodeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildResizeCloudPcNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.ResizeCloudPc.ResizeCloudPcRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRestoreCloudPcNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.RestoreCloudPc.RestoreCloudPcRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRetireNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.Retire.RetireRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRevokeAppleVppLicensesNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.RevokeAppleVppLicenses.RevokeAppleVppLicensesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRotateBitLockerKeysNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.RotateBitLockerKeys.RotateBitLockerKeysRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRotateFileVaultKeyNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.RotateFileVaultKey.RotateFileVaultKeyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRotateLocalAdminPasswordNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.RotateLocalAdminPassword.RotateLocalAdminPasswordRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSecurityBaselineStatesNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.SecurityBaselineStates.SecurityBaselineStatesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildSendCustomNotificationToCompanyPortalNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.SendCustomNotificationToCompanyPortal.SendCustomNotificationToCompanyPortalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSetCloudPcReviewStatusNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.SetCloudPcReviewStatus.SetCloudPcReviewStatusRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSetDeviceNameNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.SetDeviceName.SetDeviceNameRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildShutDownNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.ShutDown.ShutDownRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSyncDeviceNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.SyncDevice.SyncDeviceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTriggerConfigurationManagerActionNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.TriggerConfigurationManagerAction.TriggerConfigurationManagerActionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUpdateWindowsDeviceAccountNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.UpdateWindowsDeviceAccount.UpdateWindowsDeviceAccountRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUsersNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.Users.UsersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildWindowsDefenderScanNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.WindowsDefenderScan.WindowsDefenderScanRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildWindowsDefenderUpdateSignaturesNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.WindowsDefenderUpdateSignatures.WindowsDefenderUpdateSignaturesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildWindowsProtectionStateNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.WindowsProtectionState.WindowsProtectionStateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
        ...
        public Command BuildWipeNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ManagedDevices.Item.Wipe.WipeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceManagement.ManagedDevices.Item.ManagedDeviceItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceManagement.ManagedDevices.Item.ManagedDeviceItemRequestBuilder.ManagedDeviceItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceManagement.ManagedDevices.Item.ManagedDeviceItemRequestBuilder.ManagedDeviceItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
