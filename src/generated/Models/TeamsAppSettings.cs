...
namespace ApiSdk.Models
{
    ...
    public class TeamsAppSettings : ApiSdk.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.TeamsAppSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.TeamsAppSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.TeamsAppSettings();
        }
        /// <summary>
