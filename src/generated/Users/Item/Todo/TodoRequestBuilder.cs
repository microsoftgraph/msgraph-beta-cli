...
using ApiSdk.Models;
using ApiSdk.Users.Item.Todo.Lists;
...
using System;
namespace ApiSdk.Users.Item.Todo {
    /// <summary>
    ...
    public class TodoRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.Todo>(ApiSdk.Models.Todo.CreateFromDiscriminatorValue);
                if (model is null) {
