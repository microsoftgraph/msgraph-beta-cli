    ...
    public class EndBreakRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Teams.Item.Schedule.TimeCards.Item.EndBreak.EndBreakPostRequestBody>(ApiSdk.Teams.Item.Schedule.TimeCards.Item.EndBreak.EndBreakPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Teams.Item.Schedule.TimeCards.Item.EndBreak.EndBreakRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Teams.Item.Schedule.TimeCards.Item.EndBreak.EndBreakPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Teams.Item.Schedule.TimeCards.Item.EndBreak.EndBreakPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
