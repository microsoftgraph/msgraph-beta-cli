...
namespace ApiSdk.Teams.Item.Channels.Item.Messages.Item
{
    ...
    public class ChatMessageItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildHostedContentsNavCommand()
        {
            ...
            var builder = new ApiSdk.Teams.Item.Channels.Item.Messages.Item.HostedContents.HostedContentsRequestBuilder(PathParameters);
        ...
        public Command BuildRepliesNavCommand()
        {
            ...
            var builder = new ApiSdk.Teams.Item.Channels.Item.Messages.Item.Replies.RepliesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildSetReactionNavCommand()
        {
            ...
            var builder = new ApiSdk.Teams.Item.Channels.Item.Messages.Item.SetReaction.SetReactionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSoftDeleteNavCommand()
        {
            ...
            var builder = new ApiSdk.Teams.Item.Channels.Item.Messages.Item.SoftDelete.SoftDeleteRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUndoSoftDeleteNavCommand()
        {
            ...
            var builder = new ApiSdk.Teams.Item.Channels.Item.Messages.Item.UndoSoftDelete.UndoSoftDeleteRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUnsetReactionNavCommand()
        {
            ...
            var builder = new ApiSdk.Teams.Item.Channels.Item.Messages.Item.UnsetReaction.UnsetReactionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Teams.Item.Channels.Item.Messages.Item.ChatMessageItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Teams.Item.Channels.Item.Messages.Item.ChatMessageItemRequestBuilder.ChatMessageItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Teams.Item.Channels.Item.Messages.Item.ChatMessageItemRequestBuilder.ChatMessageItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
