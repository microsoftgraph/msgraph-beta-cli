...
namespace ApiSdk.GovernanceResources.Item
{
    ...
    public class GovernanceResourceItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildParentNavCommand()
        {
            ...
            var builder = new ApiSdk.GovernanceResources.Item.Parent.ParentRequestBuilder(PathParameters);
        ...
        public Command BuildRoleAssignmentRequestsNavCommand()
        {
            ...
            var builder = new ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.RoleAssignmentRequestsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildRoleAssignmentsNavCommand()
        {
            ...
            var builder = new ApiSdk.GovernanceResources.Item.RoleAssignments.RoleAssignmentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRoleDefinitionsNavCommand()
        {
            ...
            var builder = new ApiSdk.GovernanceResources.Item.RoleDefinitions.RoleDefinitionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRoleSettingsNavCommand()
        {
            ...
            var builder = new ApiSdk.GovernanceResources.Item.RoleSettings.RoleSettingsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.GovernanceResources.Item.GovernanceResourceItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.GovernanceResources.Item.GovernanceResourceItemRequestBuilder.GovernanceResourceItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.GovernanceResources.Item.GovernanceResourceItemRequestBuilder.GovernanceResourceItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
