...
namespace ApiSdk.Models
{
    ...
    public partial class RestrictedAppsViolation : global::ApiSdk.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.ManagedDeviceReportedApp>? RestrictedApps { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.ManagedDeviceReportedApp> RestrictedApps { get; set; }
#endif
        /// <summary>Restricted apps state</summary>
        public global::ApiSdk.Models.RestrictedAppsState? RestrictedAppsState { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.RestrictedAppsViolation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.RestrictedAppsViolation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.RestrictedAppsViolation();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "restrictedApps", n => { RestrictedApps = n.GetCollectionOfObjectValues<global::ApiSdk.Models.ManagedDeviceReportedApp>(global::ApiSdk.Models.ManagedDeviceReportedApp.CreateFromDiscriminatorValue)?.AsList(); } },
                { "restrictedAppsState", n => { RestrictedAppsState = n.GetEnumValue<global::ApiSdk.Models.RestrictedAppsState>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.ManagedDeviceReportedApp>("restrictedApps", RestrictedApps);
            writer.WriteEnumValue<global::ApiSdk.Models.RestrictedAppsState>("restrictedAppsState", RestrictedAppsState);
