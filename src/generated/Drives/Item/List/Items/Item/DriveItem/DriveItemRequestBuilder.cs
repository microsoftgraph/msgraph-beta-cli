...
namespace ApiSdk.Drives.Item.List.Items.Item.DriveItem
{
    ...
    public class DriveItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildContentNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.List.Items.Item.DriveItem.Content.ContentRequestBuilder(PathParameters);
        ...
        public Command BuildContentStreamNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the drive entity.";
            var builder = new ApiSdk.Drives.Item.List.Items.Item.DriveItem.ContentStream.ContentStreamRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Drives.Item.List.Items.Item.DriveItem.DriveItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Drives.Item.List.Items.Item.DriveItem.DriveItemRequestBuilder.DriveItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Drives.Item.List.Items.Item.DriveItem.DriveItemRequestBuilder.DriveItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
