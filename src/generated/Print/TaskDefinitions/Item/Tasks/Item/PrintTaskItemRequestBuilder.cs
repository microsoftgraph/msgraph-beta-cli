...
namespace ApiSdk.Print.TaskDefinitions.Item.Tasks.Item
{
    ...
    public partial class PrintTaskItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDefinitionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Print.TaskDefinitions.Item.Tasks.Item.Definition.DefinitionRequestBuilder(PathParameters);
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/printtaskdefinition-update-task?view=graph-rest-beta" />
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildPatchCommand()
        {
            var command = new Command("patch");
            command.Description = "Update a print task. For details about how to use this API to add pull printing support to Universal Print, see Extending Universal Print to support pull printing.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/printtaskdefinition-update-task?view=graph-rest-beta";
            var printTaskDefinitionIdOption = new Option<string>("--print-task-definition-id", description: "The unique identifier of printTaskDefinition") {
            };
            printTaskDefinitionIdOption.IsRequired = true;
            command.AddOption(printTaskDefinitionIdOption);
        ...
        public Command BuildTriggerNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Print.TaskDefinitions.Item.Tasks.Item.Trigger.TriggerRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Print.TaskDefinitions.Item.Tasks.Item.PrintTaskItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Print.TaskDefinitions.Item.Tasks.Item.PrintTaskItemRequestBuilder.PrintTaskItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Print.TaskDefinitions.Item.Tasks.Item.PrintTaskItemRequestBuilder.PrintTaskItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
