...
namespace ApiSdk.GovernanceResources.Item.RoleDefinitions.Item
{
    ...
    public class GovernanceRoleDefinitionItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildResourceNavCommand()
        {
            ...
            var builder = new ApiSdk.GovernanceResources.Item.RoleDefinitions.Item.Resource.ResourceRequestBuilder(PathParameters);
        ...
        public Command BuildRoleSettingNavCommand()
        {
            ...
            var builder = new ApiSdk.GovernanceResources.Item.RoleDefinitions.Item.RoleSetting.RoleSettingRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.GovernanceResources.Item.RoleDefinitions.Item.GovernanceRoleDefinitionItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.GovernanceResources.Item.RoleDefinitions.Item.GovernanceRoleDefinitionItemRequestBuilder.GovernanceRoleDefinitionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.GovernanceResources.Item.RoleDefinitions.Item.GovernanceRoleDefinitionItemRequestBuilder.GovernanceRoleDefinitionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
