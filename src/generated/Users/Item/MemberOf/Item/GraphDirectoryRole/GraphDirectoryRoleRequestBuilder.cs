...
using System;
namespace ApiSdk.Users.Item.MemberOf.Item.GraphDirectoryRole {
    /// <summary>
    ...
    public class GraphDirectoryRoleRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public GraphDirectoryRoleRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/memberOf/{directoryObject%2Did}/graph.directoryRole{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="GraphDirectoryRoleRequestBuilder"/> and sets the default values.
        ...
        public GraphDirectoryRoleRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/memberOf/{directoryObject%2Did}/graph.directoryRole{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.directoryRole
