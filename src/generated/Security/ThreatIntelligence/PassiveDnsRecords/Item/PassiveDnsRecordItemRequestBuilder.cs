...
namespace ApiSdk.Security.ThreatIntelligence.PassiveDnsRecords.Item
{
    ...
    public class PassiveDnsRecordItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildArtifactNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.ThreatIntelligence.PassiveDnsRecords.Item.Artifact.ArtifactRequestBuilder(PathParameters);
        ...
        public Command BuildParentHostNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.ThreatIntelligence.PassiveDnsRecords.Item.ParentHost.ParentHostRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.Security.PassiveDnsRecord>(ApiSdk.Models.Security.PassiveDnsRecord.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Security.ThreatIntelligence.PassiveDnsRecords.Item.PassiveDnsRecordItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.ThreatIntelligence.PassiveDnsRecords.Item.PassiveDnsRecordItemRequestBuilder.PassiveDnsRecordItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.ThreatIntelligence.PassiveDnsRecords.Item.PassiveDnsRecordItemRequestBuilder.PassiveDnsRecordItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Security.PassiveDnsRecord body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Security.PassiveDnsRecord body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
