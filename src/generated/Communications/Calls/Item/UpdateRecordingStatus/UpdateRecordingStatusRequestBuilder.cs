    ...
    public class UpdateRecordingStatusRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Communications.Calls.Item.UpdateRecordingStatus.UpdateRecordingStatusPostRequestBody>(ApiSdk.Communications.Calls.Item.UpdateRecordingStatus.UpdateRecordingStatusPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Communications.Calls.Item.UpdateRecordingStatus.UpdateRecordingStatusRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Communications.Calls.Item.UpdateRecordingStatus.UpdateRecordingStatusPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Communications.Calls.Item.UpdateRecordingStatus.UpdateRecordingStatusPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
