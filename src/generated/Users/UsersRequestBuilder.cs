...
namespace ApiSdk.Users
{
    ...
    public partial class UsersRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.UserItemRequestBuilder(PathParameters);
            ...
            commands.Add(builder.BuildCommunicationsNavCommand());
            ...
            commands.Add(builder.BuildDataSecurityAndGovernanceNavCommand());
            ...
            commands.Add(builder.BuildInvitedByNavCommand());
            ...
            commands.Add(builder.BuildRetrieveManagedDevicesWithAppInstallationIssuesNavCommand());
            ...
            commands.Add(builder.BuildSolutionsNavCommand());
        ...
        public Command BuildCountNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Count.CountRequestBuilder(PathParameters);
        ...
        public Command BuildCreateCommand()
        {
            ...
            command.Description = "Create a new user.The request body contains the user to create. At a minimum, you must specify the required properties for the user. You can optionally specify any other writable properties. This operation returns by default only a subset of the properties for each user. These default properties are noted in the Properties section. To get properties that are not returned by default, do a GET operation and specify the properties in a $select OData query option.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/user-post-users?view=graph-rest-beta";
        ...
        public Command BuildDeltaNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Delta.DeltaRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetByIdsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.GetByIds.GetByIdsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGetManagedAppBlockedUsersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.GetManagedAppBlockedUsers.GetManagedAppBlockedUsersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetUserOwnedObjectsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.GetUserOwnedObjects.GetUserOwnedObjectsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
...
#nullable restore
        ...
        public Command BuildValidatePasswordNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.ValidatePassword.ValidatePasswordRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildValidatePropertiesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.ValidateProperties.ValidatePropertiesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.UsersRequestBuilder.UsersRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.UsersRequestBuilder.UsersRequestBuilderGetQueryParameters>> requestConfiguration = default)
