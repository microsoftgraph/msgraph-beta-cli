...
using ApiSdk.Models;
using ApiSdk.Shares.Item.List.Activities;
using ApiSdk.Shares.Item.List.Columns;
using ApiSdk.Shares.Item.List.ContentTypes;
using ApiSdk.Shares.Item.List.CreatedByUser;
using ApiSdk.Shares.Item.List.Drive;
using ApiSdk.Shares.Item.List.Items;
using ApiSdk.Shares.Item.List.LastModifiedByUser;
using ApiSdk.Shares.Item.List.Operations;
using ApiSdk.Shares.Item.List.Permissions;
using ApiSdk.Shares.Item.List.Subscriptions;
...
namespace ApiSdk.Shares.Item.List
{
    ...
    public partial class ListRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildActivitiesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.Activities.ActivitiesRequestBuilder(PathParameters);
        ...
        public Command BuildColumnsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.Columns.ColumnsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildContentTypesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.ContentTypes.ContentTypesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildCreatedByUserNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.CreatedByUser.CreatedByUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildDriveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.Drive.DriveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildItemsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.Items.ItemsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildLastModifiedByUserNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.LastModifiedByUser.LastModifiedByUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            nonExecCommands.Add(builder.BuildMailboxSettingsNavCommand());
        ...
        public Command BuildOperationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.Operations.OperationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPermissionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.Permissions.PermissionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildSubscriptionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.Subscriptions.SubscriptionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Shares.Item.List.ListRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Shares.Item.List.ListRequestBuilder.ListRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Shares.Item.List.ListRequestBuilder.ListRequestBuilderGetQueryParameters>> requestConfiguration = default)
