...
using System;
namespace ApiSdk.Groups.Item.CalendarView.Item.ExceptionOccurrences.Item.Instances.Item.Extensions.Count
{
    /// <summary>
    ...
    public class CountRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.CalendarView.Item.ExceptionOccurrences.Item.Instances.Item.Extensions.Count.CountRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public CountRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/extensions/$count{?%24filter}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.CalendarView.Item.ExceptionOccurrences.Item.Instances.Item.Extensions.Count.CountRequestBuilder"/> and sets the default values.
        ...
        public CountRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/extensions/$count{?%24filter}", rawUrl)
        {
        }
        /// <summary>
        /// Get the number of the resource
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.CalendarView.Item.ExceptionOccurrences.Item.Instances.Item.Extensions.Count.CountRequestBuilder.CountRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.CalendarView.Item.ExceptionOccurrences.Item.Instances.Item.Extensions.Count.CountRequestBuilder.CountRequestBuilderGetQueryParameters>> requestConfiguration = default)
