...
using System;
namespace ApiSdk.Security.DataSecurityAndGovernance.SensitivityLabels.Item.Sublabels.ComputeInheritanceWithLabelIdsWithLocaleWithContentFormats
{
    /// <summary>
    ...
    public partial class ComputeInheritanceWithLabelIdsWithLocaleWithContentFormatsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Security.DataSecurityAndGovernance.SensitivityLabels.Item.Sublabels.ComputeInheritanceWithLabelIdsWithLocaleWithContentFormats.ComputeInheritanceWithLabelIdsWithLocaleWithContentFormatsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public ComputeInheritanceWithLabelIdsWithLocaleWithContentFormatsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel%2Did}/sublabels/computeInheritance(labelIds={labelIds},locale='{locale}',contentFormats={contentFormats})", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Security.DataSecurityAndGovernance.SensitivityLabels.Item.Sublabels.ComputeInheritanceWithLabelIdsWithLocaleWithContentFormats.ComputeInheritanceWithLabelIdsWithLocaleWithContentFormatsRequestBuilder"/> and sets the default values.
        ...
        public ComputeInheritanceWithLabelIdsWithLocaleWithContentFormatsRequestBuilder(string rawUrl) : base("{+baseurl}/security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel%2Did}/sublabels/computeInheritance(labelIds={labelIds},locale='{locale}',contentFormats={contentFormats})", rawUrl)
        {
        }
        /// <summary>
        /// Calculate the sensitivity label that should be inherited by an output artifact, given a set of sensitivity labels from input or referenced artifacts.
