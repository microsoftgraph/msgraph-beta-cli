...
using System;
namespace ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Activities.Item
{
    /// <summary>
    ...
    public class ItemActivityOLDItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Activities.Item.ItemActivityOLDItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/activities/{itemActivityOLD%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Activities.Item.ItemActivityOLDItemRequestBuilder"/> and sets the default values.
        ...
        public ItemActivityOLDItemRequestBuilder(string rawUrl) : base("{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/activities/{itemActivityOLD%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// The list of recent activities that took place on this item.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Activities.Item.ItemActivityOLDItemRequestBuilder.ItemActivityOLDItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Activities.Item.ItemActivityOLDItemRequestBuilder.ItemActivityOLDItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
