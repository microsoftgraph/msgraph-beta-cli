...
namespace ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.Runs.Item
{
    ...
    public partial class RunItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Read the properties and relationships of a run object.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/identitygovernance-run-get?view=graph-rest-beta";
        ...
        public Command BuildTaskProcessingResultsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.Runs.Item.TaskProcessingResults.TaskProcessingResultsRequestBuilder(PathParameters);
        ...
        public Command BuildUserProcessingResultsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.Runs.Item.UserProcessingResults.UserProcessingResultsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.Runs.Item.RunItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public RunItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/runs/{run%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.Runs.Item.RunItemRequestBuilder"/> and sets the default values.
        ...
        public RunItemRequestBuilder(string rawUrl) : base("{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/runs/{run%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Read the properties and relationships of a run object.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.Runs.Item.RunItemRequestBuilder.RunItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.Runs.Item.RunItemRequestBuilder.RunItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
