    ...
    public partial class RejectRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Communications.Calls.Item.Reject.RejectPostRequestBody>(global::ApiSdk.Communications.Calls.Item.Reject.RejectPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Communications.Calls.Item.Reject.RejectRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        public RejectRequestBuilder(string rawUrl) : base("{+baseurl}/communications/calls/{call%2Did}/reject", rawUrl)
        {
        }
        /// <summary>
        /// Enable a bot to reject an incoming call. The incoming call request can be an invite from a participant in a group call or a peer-to-peer call. If an invite to a group call is received, the notification contains the chatInfo and meetingInfo parameters. The bot is expected to answer or reject the call before the call times out. The current timeout value is 15 seconds. This API doesn&apos;t end existing calls that have already been answered. Use delete call to end a call.
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Communications.Calls.Item.Reject.RejectPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Communications.Calls.Item.Reject.RejectPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
