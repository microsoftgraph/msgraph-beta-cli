...
namespace ApiSdk.Policies.PermissionGrantPolicies.Item
{
    ...
    public partial class PermissionGrantPolicyItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        /// Delete a permissionGrantPolicy object.
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/permissiongrantpolicy-delete?view=graph-rest-beta" />
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildDeleteCommand()
        {
            var command = new Command("delete");
            command.Description = "Delete a permissionGrantPolicy object.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/permissiongrantpolicy-delete?view=graph-rest-beta";
        ...
        public Command BuildExcludesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Policies.PermissionGrantPolicies.Item.Excludes.ExcludesRequestBuilder(PathParameters);
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/permissiongrantpolicy-get?view=graph-rest-beta" />
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildGetCommand()
        {
            var command = new Command("get");
            command.Description = "Retrieve a single permissionGrantPolicy object.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/permissiongrantpolicy-get?view=graph-rest-beta";
            var permissionGrantPolicyIdOption = new Option<string>("--permission-grant-policy-id", description: "The unique identifier of permissionGrantPolicy") {
            };
            permissionGrantPolicyIdOption.IsRequired = true;
            command.AddOption(permissionGrantPolicyIdOption);
        ...
        public Command BuildIncludesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Policies.PermissionGrantPolicies.Item.Includes.IncludesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/permissiongrantpolicy-update?view=graph-rest-beta" />
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildPatchCommand()
        {
            var command = new Command("patch");
            command.Description = "Update properties of a  permissionGrantPolicy.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/permissiongrantpolicy-update?view=graph-rest-beta";
            var permissionGrantPolicyIdOption = new Option<string>("--permission-grant-policy-id", description: "The unique identifier of permissionGrantPolicy") {
            };
            permissionGrantPolicyIdOption.IsRequired = true;
            command.AddOption(permissionGrantPolicyIdOption);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Policies.PermissionGrantPolicies.Item.PermissionGrantPolicyItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Policies.PermissionGrantPolicies.Item.PermissionGrantPolicyItemRequestBuilder.PermissionGrantPolicyItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Policies.PermissionGrantPolicies.Item.PermissionGrantPolicyItemRequestBuilder.PermissionGrantPolicyItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.PermissionGrantPolicy body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.PermissionGrantPolicy body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class PermissionGrantPolicyItemRequestBuilderGetQueryParameters 
        {
