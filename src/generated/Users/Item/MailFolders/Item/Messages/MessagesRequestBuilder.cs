...
namespace ApiSdk.Users.Item.MailFolders.Item.Messages {
    ...
    public class MessagesRequestBuilder : BaseCliRequestBuilder {
        ...
        public MessagesRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get all the messages in the specified user&apos;s mailbox, or those messages in a specified folder in the mailbox.
        /// </summary>
