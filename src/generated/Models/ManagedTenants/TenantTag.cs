...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.ManagedTenants.TenantInfo>? Tenants { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.ManagedTenants.TenantInfo> Tenants { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.ManagedTenants.TenantTag"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.ManagedTenants.TenantTag CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.ManagedTenants.TenantTag();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "tenants", n => { Tenants = n.GetCollectionOfObjectValues<ApiSdk.Models.ManagedTenants.TenantInfo>(ApiSdk.Models.ManagedTenants.TenantInfo.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.ManagedTenants.TenantInfo>("tenants", Tenants);
        }
    }
}
