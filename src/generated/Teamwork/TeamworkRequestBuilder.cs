...
using ApiSdk.Teamwork.DetermineIfInteractionIsAllowed;
using ApiSdk.Teamwork.Devices;
using ApiSdk.Teamwork.SendActivityNotificationToRecipients;
using ApiSdk.Teamwork.TeamTemplates;
...
namespace ApiSdk.Teamwork
{
    ...
    public partial class TeamworkRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildDeletedChatsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.DeletedChats.DeletedChatsRequestBuilder(PathParameters);
        ...
        public Command BuildDeletedTeamsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.DeletedTeams.DeletedTeamsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildDetermineIfInteractionIsAllowedNavCommand()
        {
            var command = new Command("determine-if-interaction-is-allowed");
            command.Description = "Provides operations to call the determineIfInteractionIsAllowed method.";
            var builder = new global::ApiSdk.Teamwork.DetermineIfInteractionIsAllowed.DetermineIfInteractionIsAllowedRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildDevicesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.Devices.DevicesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Teamwork>(global::ApiSdk.Models.Teamwork.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildSendActivityNotificationToRecipientsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.SendActivityNotificationToRecipients.SendActivityNotificationToRecipientsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTeamsAppSettingsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamsAppSettings.TeamsAppSettingsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildTeamTemplatesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.TeamTemplates.TeamTemplatesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildWorkforceIntegrationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teamwork.WorkforceIntegrations.WorkforceIntegrationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Teamwork.TeamworkRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Teamwork.TeamworkRequestBuilder.TeamworkRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Teamwork.TeamworkRequestBuilder.TeamworkRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Teamwork body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Teamwork body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
