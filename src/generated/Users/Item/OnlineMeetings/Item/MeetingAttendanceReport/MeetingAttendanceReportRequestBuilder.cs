...
using ApiSdk.Models;
using ApiSdk.Users.Item.OnlineMeetings.Item.MeetingAttendanceReport.AttendanceRecords;
...
namespace ApiSdk.Users.Item.OnlineMeetings.Item.MeetingAttendanceReport
{
    ...
    public class MeetingAttendanceReportRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAttendanceRecordsNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.OnlineMeetings.Item.MeetingAttendanceReport.AttendanceRecords.AttendanceRecordsRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Users.Item.OnlineMeetings.Item.MeetingAttendanceReport.MeetingAttendanceReportRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public MeetingAttendanceReportRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/meetingAttendanceReport{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Users.Item.OnlineMeetings.Item.MeetingAttendanceReport.MeetingAttendanceReportRequestBuilder"/> and sets the default values.
        ...
        public MeetingAttendanceReportRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/meetingAttendanceReport{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property meetingAttendanceReport for users
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.OnlineMeetings.Item.MeetingAttendanceReport.MeetingAttendanceReportRequestBuilder.MeetingAttendanceReportRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.OnlineMeetings.Item.MeetingAttendanceReport.MeetingAttendanceReportRequestBuilder.MeetingAttendanceReportRequestBuilderGetQueryParameters>> requestConfiguration = default)
