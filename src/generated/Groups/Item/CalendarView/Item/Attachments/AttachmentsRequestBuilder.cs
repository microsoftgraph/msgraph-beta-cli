// <auto-generated/>
using ApiSdk.Groups.Item.CalendarView.Item.Attachments.Count;
using ApiSdk.Groups.Item.CalendarView.Item.Attachments.CreateUploadSession;
using ApiSdk.Groups.Item.CalendarView.Item.Attachments.Item;
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(Attachment body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/attachments", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
