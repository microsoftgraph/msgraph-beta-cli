...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.AssignedPlan"/> and sets the default values.
        /// </summary>
        public AssignedPlan()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.AssignedPlan"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.AssignedPlan CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.AssignedPlan();
        }
        /// <summary>
