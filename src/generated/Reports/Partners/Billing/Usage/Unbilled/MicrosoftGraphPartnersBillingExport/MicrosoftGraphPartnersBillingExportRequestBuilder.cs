    ...
    public class MicrosoftGraphPartnersBillingExportRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Reports.Partners.Billing.Usage.Unbilled.MicrosoftGraphPartnersBillingExport.ExportPostRequestBody>(ApiSdk.Reports.Partners.Billing.Usage.Unbilled.MicrosoftGraphPartnersBillingExport.ExportPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Reports.Partners.Billing.Usage.Unbilled.MicrosoftGraphPartnersBillingExport.MicrosoftGraphPartnersBillingExportRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Reports.Partners.Billing.Usage.Unbilled.MicrosoftGraphPartnersBillingExport.ExportPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Reports.Partners.Billing.Usage.Unbilled.MicrosoftGraphPartnersBillingExport.ExportPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
