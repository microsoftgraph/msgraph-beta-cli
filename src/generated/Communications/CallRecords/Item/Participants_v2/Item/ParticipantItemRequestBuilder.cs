...
namespace ApiSdk.Communications.CallRecords.Item.Participants_v2.Item
{
    ...
    public class ParticipantItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property participants_v2 for communications";
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property participants_v2 in communications";
            var callRecordIdOption = new Option<string>("--call-record-id", description: "The unique identifier of callRecord") {
            };
            callRecordIdOption.IsRequired = true;
            command.AddOption(callRecordIdOption);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Communications.CallRecords.Item.Participants_v2.Item.ParticipantItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public ParticipantItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/communications/callRecords/{callRecord%2Did}/participants_v2/{participant%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Communications.CallRecords.Item.Participants_v2.Item.ParticipantItemRequestBuilder"/> and sets the default values.
        ...
        public ParticipantItemRequestBuilder(string rawUrl) : base("{+baseurl}/communications/callRecords/{callRecord%2Did}/participants_v2/{participant%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property participants_v2 for communications
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Communications.CallRecords.Item.Participants_v2.Item.ParticipantItemRequestBuilder.ParticipantItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Communications.CallRecords.Item.Participants_v2.Item.ParticipantItemRequestBuilder.ParticipantItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.CallRecords.Participant body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.CallRecords.Participant body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
