...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.BulkResize.BulkResizePostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.BulkResize.BulkResizePostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.BulkResize.BulkResizePostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.BulkResize.BulkResizePostRequestBody();
        }
        /// <summary>
