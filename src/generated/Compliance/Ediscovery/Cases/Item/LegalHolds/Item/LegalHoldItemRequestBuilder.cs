...
using ApiSdk.Compliance.Ediscovery.Cases.Item.LegalHolds.Item.SiteSources;
using ApiSdk.Compliance.Ediscovery.Cases.Item.LegalHolds.Item.UnifiedGroupSources;
using ApiSdk.Compliance.Ediscovery.Cases.Item.LegalHolds.Item.UserSources;
...
namespace ApiSdk.Compliance.Ediscovery.Cases.Item.LegalHolds.Item
{
    ...
    public partial class LegalHoldItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Ediscovery.LegalHold>(global::ApiSdk.Models.Ediscovery.LegalHold.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildSiteSourcesNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the siteSources property of the microsoft.graph.ediscovery.legalHold entity.";
            var builder = new global::ApiSdk.Compliance.Ediscovery.Cases.Item.LegalHolds.Item.SiteSources.SiteSourcesRequestBuilder(PathParameters);
        ...
        public Command BuildUnifiedGroupSourcesNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the unifiedGroupSources property of the microsoft.graph.ediscovery.legalHold entity.";
            var builder = new global::ApiSdk.Compliance.Ediscovery.Cases.Item.LegalHolds.Item.UnifiedGroupSources.UnifiedGroupSourcesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildUserSourcesNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the userSources property of the microsoft.graph.ediscovery.legalHold entity.";
            var builder = new global::ApiSdk.Compliance.Ediscovery.Cases.Item.LegalHolds.Item.UserSources.UserSourcesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Compliance.Ediscovery.Cases.Item.LegalHolds.Item.LegalHoldItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public LegalHoldItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/compliance/ediscovery/cases/{case%2Did}/legalHolds/{legalHold%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Compliance.Ediscovery.Cases.Item.LegalHolds.Item.LegalHoldItemRequestBuilder"/> and sets the default values.
        ...
        public LegalHoldItemRequestBuilder(string rawUrl) : base("{+baseurl}/compliance/ediscovery/cases/{case%2Did}/legalHolds/{legalHold%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete a legalHold object.
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Compliance.Ediscovery.Cases.Item.LegalHolds.Item.LegalHoldItemRequestBuilder.LegalHoldItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Compliance.Ediscovery.Cases.Item.LegalHolds.Item.LegalHoldItemRequestBuilder.LegalHoldItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Ediscovery.LegalHold body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Ediscovery.LegalHold body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class LegalHoldItemRequestBuilderGetQueryParameters 
        {
