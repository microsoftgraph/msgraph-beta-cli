    ...
    public partial class GetMemberGroupsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.PermissionGrants.Item.GetMemberGroups.GetMemberGroupsPostRequestBody>(global::ApiSdk.PermissionGrants.Item.GetMemberGroups.GetMemberGroupsPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.PermissionGrants.Item.GetMemberGroups.GetMemberGroupsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public GetMemberGroupsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/permissionGrants/{resourceSpecificPermissionGrant%2Did}/getMemberGroups", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.PermissionGrants.Item.GetMemberGroups.GetMemberGroupsRequestBuilder"/> and sets the default values.
        ...
        public GetMemberGroupsRequestBuilder(string rawUrl) : base("{+baseurl}/permissionGrants/{resourceSpecificPermissionGrant%2Did}/getMemberGroups", rawUrl)
        {
        }
        /// <summary>
        /// Return all the group IDs for the groups that the specified user, group, service principal, organizational contact, device, or directory object is a member of. This function is transitive. This API returns up to 11,000 group IDs. If more than 11,000 results are available, it returns a 400 Bad Request error with the DirectoryResultSizeLimitExceeded error code. If you get the DirectoryResultSizeLimitExceeded error code, use the List group transitive memberOf API instead.
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.PermissionGrants.Item.GetMemberGroups.GetMemberGroupsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.PermissionGrants.Item.GetMemberGroups.GetMemberGroupsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
