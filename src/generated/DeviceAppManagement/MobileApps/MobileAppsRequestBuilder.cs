...
namespace ApiSdk.DeviceAppManagement.MobileApps {
    ...
    public class MobileAppsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildConvertFromMobileAppCatalogPackageWithMobileAppCatalogPackageIdRbCommand()
        {
            ...
            var builder = new ConvertFromMobileAppCatalogPackageWithMobileAppCatalogPackageIdRequestBuilder(PathParameters);
        ...
        public Command BuildGraphAndroidForWorkAppNavCommand()
        {
            ...
            var builder = new GraphAndroidForWorkAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGraphAndroidManagedStoreAppNavCommand()
        {
            ...
            var builder = new GraphAndroidManagedStoreAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildGraphMacOSPkgAppNavCommand()
        {
            ...
            var builder = new GraphMacOSPkgAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildGraphWindowsStoreAppNavCommand()
        {
            ...
            var builder = new GraphWindowsStoreAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildGraphWinGetAppNavCommand()
        {
            ...
            var builder = new GraphWinGetAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildValidateXmlNavCommand()
        {
            ...
            var builder = new ValidateXmlRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
