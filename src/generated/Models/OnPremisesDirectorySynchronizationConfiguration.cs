...
#nullable enable
        public ApiSdk.Models.OnPremisesAccidentalDeletionPrevention? AccidentalDeletionPrevention { get; set; }
#nullable restore
#else
        public ApiSdk.Models.OnPremisesAccidentalDeletionPrevention AccidentalDeletionPrevention { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.OnPremisesCurrentExportData? CurrentExportData { get; set; }
#nullable restore
#else
        public ApiSdk.Models.OnPremisesCurrentExportData CurrentExportData { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.OnPremisesWritebackConfiguration? WritebackConfiguration { get; set; }
#nullable restore
#else
        public ApiSdk.Models.OnPremisesWritebackConfiguration WritebackConfiguration { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.OnPremisesDirectorySynchronizationConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.OnPremisesDirectorySynchronizationConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.OnPremisesDirectorySynchronizationConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.OnPremisesDirectorySynchronizationConfiguration();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "accidentalDeletionPrevention", n => { AccidentalDeletionPrevention = n.GetObjectValue<ApiSdk.Models.OnPremisesAccidentalDeletionPrevention>(ApiSdk.Models.OnPremisesAccidentalDeletionPrevention.CreateFromDiscriminatorValue); } },
                { "anchorAttribute", n => { AnchorAttribute = n.GetStringValue(); } },
                { "applicationId", n => { ApplicationId = n.GetStringValue(); } },
                { "currentExportData", n => { CurrentExportData = n.GetObjectValue<ApiSdk.Models.OnPremisesCurrentExportData>(ApiSdk.Models.OnPremisesCurrentExportData.CreateFromDiscriminatorValue); } },
                ...
                { "writebackConfiguration", n => { WritebackConfiguration = n.GetObjectValue<ApiSdk.Models.OnPremisesWritebackConfiguration>(ApiSdk.Models.OnPremisesWritebackConfiguration.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.OnPremisesAccidentalDeletionPrevention>("accidentalDeletionPrevention", AccidentalDeletionPrevention);
            writer.WriteStringValue("anchorAttribute", AnchorAttribute);
            writer.WriteStringValue("applicationId", ApplicationId);
            writer.WriteObjectValue<ApiSdk.Models.OnPremisesCurrentExportData>("currentExportData", CurrentExportData);
            ...
            writer.WriteObjectValue<ApiSdk.Models.OnPremisesWritebackConfiguration>("writebackConfiguration", WritebackConfiguration);
