...
namespace ApiSdk.Models
{
    ...
    public partial class DeviceAndAppManagementAssignmentFilter : global::ApiSdk.Models.Entity, IParsable
    {
        /// <summary>Supported filter management types whether its devices or apps.</summary>
        public global::ApiSdk.Models.AssignmentFilterManagementType? AssignmentFilterManagementType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.PayloadByFilter>? Payloads { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.PayloadByFilter> Payloads { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.DeviceAndAppManagementAssignmentFilter"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.DeviceAndAppManagementAssignmentFilter CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            return mappingValue switch
            {
                ...
                _ => new global::ApiSdk.Models.DeviceAndAppManagementAssignmentFilter(),
            };
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "assignmentFilterManagementType", n => { AssignmentFilterManagementType = n.GetEnumValue<global::ApiSdk.Models.AssignmentFilterManagementType>(); } },
                { "createdDateTime", n => { CreatedDateTime = n.GetDateTimeOffsetValue(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "displayName", n => { DisplayName = n.GetStringValue(); } },
                { "lastModifiedDateTime", n => { LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                { "payloads", n => { Payloads = n.GetCollectionOfObjectValues<global::ApiSdk.Models.PayloadByFilter>(global::ApiSdk.Models.PayloadByFilter.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.AssignmentFilterManagementType>("assignmentFilterManagementType", AssignmentFilterManagementType);
            writer.WriteDateTimeOffsetValue("createdDateTime", CreatedDateTime);
            writer.WriteStringValue("description", Description);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.PayloadByFilter>("payloads", Payloads);
