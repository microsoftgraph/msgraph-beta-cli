...
using ApiSdk.Models;
using ApiSdk.Users.Item.ContactFolders.Item.ChildFolders.Item.Contacts.Item.Photo.Value;
...
using System;
namespace ApiSdk.Users.Item.ContactFolders.Item.ChildFolders.Item.Contacts.Item.Photo {
    /// <summary>
    ...
    public class PhotoRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public PhotoRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/childFolders/{contactFolder%2Did1}/contacts/{contact%2Did}/photo{?%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="PhotoRequestBuilder"/> and sets the default values.
        ...
        public PhotoRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/childFolders/{contactFolder%2Did1}/contacts/{contact%2Did}/photo{?%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Optional contact picture. You can get or set a photo for a contact.
