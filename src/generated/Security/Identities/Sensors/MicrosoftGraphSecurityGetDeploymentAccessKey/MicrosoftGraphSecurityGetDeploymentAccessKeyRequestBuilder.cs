...
namespace ApiSdk.Security.Identities.Sensors.MicrosoftGraphSecurityGetDeploymentAccessKey
{
    ...
    public partial class MicrosoftGraphSecurityGetDeploymentAccessKeyRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get the deployment access key associated with a Microsoft Defender for Identity, needed to install sensors associated with the workspace.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/security-sensor-getdeploymentaccesskey?view=graph-rest-beta";
