...
namespace ApiSdk.Models.Security
{
    ...
    public partial class AuditLogQuery : global::ApiSdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.Security.AuditLogRecord>? Records { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.Security.AuditLogRecord> Records { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.Security.AuditLogRecordType?>? RecordTypeFilters { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.Security.AuditLogRecordType?> RecordTypeFilters { get; set; }
#endif
...
#nullable restore
        ...
        public global::ApiSdk.Models.Security.AuditLogQueryStatus? Status { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.Security.AuditLogQuery"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.Security.AuditLogQuery CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.Security.AuditLogQuery();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "recordTypeFilters", n => { RecordTypeFilters = n.GetCollectionOfEnumValues<global::ApiSdk.Models.Security.AuditLogRecordType>()?.AsList(); } },
                { "records", n => { Records = n.GetCollectionOfObjectValues<global::ApiSdk.Models.Security.AuditLogRecord>(global::ApiSdk.Models.Security.AuditLogRecord.CreateFromDiscriminatorValue)?.AsList(); } },
                { "serviceFilters", n => { ServiceFilters = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "status", n => { Status = n.GetEnumValue<global::ApiSdk.Models.Security.AuditLogQueryStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.Security.AuditLogRecord>("records", Records);
            writer.WriteCollectionOfEnumValues<global::ApiSdk.Models.Security.AuditLogRecordType>("recordTypeFilters", RecordTypeFilters);
            writer.WriteCollectionOfPrimitiveValues<string>("serviceFilters", ServiceFilters);
            writer.WriteEnumValue<global::ApiSdk.Models.Security.AuditLogQueryStatus>("status", Status);
