...
using System;
namespace ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Workbook.Worksheets.Item.Tables.ItemAtWithIndex.ReapplyFilters
{
    /// <summary>
    ...
    public class ReapplyFiltersRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.Description = "Reapplies all the filters currently on the table.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/table-reapplyfilters?view=graph-rest-beta";
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Workbook.Worksheets.Item.Tables.ItemAtWithIndex.ReapplyFilters.ReapplyFiltersRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public ReapplyFiltersRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/itemAt(index={index})/reapplyFilters", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Workbook.Worksheets.Item.Tables.ItemAtWithIndex.ReapplyFilters.ReapplyFiltersRequestBuilder"/> and sets the default values.
        ...
        public ReapplyFiltersRequestBuilder(string rawUrl) : base("{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/itemAt(index={index})/reapplyFilters", rawUrl)
        {
        }
        /// <summary>
        /// Reapplies all the filters currently on the table.
