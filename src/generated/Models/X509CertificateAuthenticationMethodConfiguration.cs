...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.X509CertificateAuthorityScope>? CertificateAuthorityScopes { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.X509CertificateAuthorityScope> CertificateAuthorityScopes { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.X509CertificateIssuerHintsConfiguration? IssuerHintsConfiguration { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.X509CertificateIssuerHintsConfiguration IssuerHintsConfiguration { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "certificateAuthorityScopes", n => { CertificateAuthorityScopes = n.GetCollectionOfObjectValues<global::ApiSdk.Models.X509CertificateAuthorityScope>(global::ApiSdk.Models.X509CertificateAuthorityScope.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "issuerHintsConfiguration", n => { IssuerHintsConfiguration = n.GetObjectValue<global::ApiSdk.Models.X509CertificateIssuerHintsConfiguration>(global::ApiSdk.Models.X509CertificateIssuerHintsConfiguration.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.X509CertificateAuthorityScope>("certificateAuthorityScopes", CertificateAuthorityScopes);
            ...
            writer.WriteObjectValue<global::ApiSdk.Models.X509CertificateIssuerHintsConfiguration>("issuerHintsConfiguration", IssuerHintsConfiguration);
        }
    }
}
