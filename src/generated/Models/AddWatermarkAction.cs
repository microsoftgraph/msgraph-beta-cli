...
namespace ApiSdk.Models
{
    ...
    public class AddWatermarkAction : ApiSdk.Models.InformationProtectionAction, IParsable
...
#nullable restore
        ...
        public ApiSdk.Models.WatermarkLayout? Layout { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.AddWatermarkAction"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.AddWatermarkAction"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.AddWatermarkAction CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.AddWatermarkAction();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "layout", n => { Layout = n.GetEnumValue<ApiSdk.Models.WatermarkLayout>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.WatermarkLayout>("layout", Layout);
