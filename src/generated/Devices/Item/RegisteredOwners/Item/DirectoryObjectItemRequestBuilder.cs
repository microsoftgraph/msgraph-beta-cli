...
namespace ApiSdk.Devices.Item.RegisteredOwners.Item
{
    ...
    public partial class DirectoryObjectItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGraphEndpointByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Devices.Item.RegisteredOwners.Item.GraphEndpoint.GraphEndpointRequestBuilder(PathParameters);
        ...
        public Command BuildGraphServicePrincipalByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Devices.Item.RegisteredOwners.Item.GraphServicePrincipal.GraphServicePrincipalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGraphUserByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Devices.Item.RegisteredOwners.Item.GraphUser.GraphUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRefByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Devices.Item.RegisteredOwners.Item.Ref.RefRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Devices.Item.RegisteredOwners.Item.DirectoryObjectItemRequestBuilder"/> and sets the default values.
        /// </summary>
