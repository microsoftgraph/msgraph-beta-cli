...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.AccessPackageAssignments.Item.AccessPackage.IncompatibleGroups.Item
{
    ...
    public class GroupItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildRefByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.AccessPackageAssignments.Item.AccessPackage.IncompatibleGroups.Item.Ref.RefRequestBuilder(PathParameters);
        ...
        public Command BuildServiceProvisioningErrorsNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.AccessPackageAssignments.Item.AccessPackage.IncompatibleGroups.Item.ServiceProvisioningErrors.ServiceProvisioningErrorsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.IdentityGovernance.EntitlementManagement.AccessPackageAssignments.Item.AccessPackage.IncompatibleGroups.Item.GroupItemRequestBuilder"/> and sets the default values.
        /// </summary>
