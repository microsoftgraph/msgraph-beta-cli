...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceManagement.WindowsDriverUpdateProfiles.Item.Assign.AssignPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.DeviceManagement.WindowsDriverUpdateProfiles.Item.Assign.AssignPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.DeviceManagement.WindowsDriverUpdateProfiles.Item.Assign.AssignPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.DeviceManagement.WindowsDriverUpdateProfiles.Item.Assign.AssignPostRequestBody();
        }
        /// <summary>
