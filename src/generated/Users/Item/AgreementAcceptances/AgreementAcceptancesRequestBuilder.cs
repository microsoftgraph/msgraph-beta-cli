...
using ApiSdk.Models;
using ApiSdk.Users.Item.AgreementAcceptances.Count;
using ApiSdk.Users.Item.AgreementAcceptances.Item;
...
namespace ApiSdk.Users.Item.AgreementAcceptances {
    ...
    public class AgreementAcceptancesRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public AgreementAcceptancesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/agreementAcceptances{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="AgreementAcceptancesRequestBuilder"/> and sets the default values.
        ...
        public AgreementAcceptancesRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/agreementAcceptances{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Retrieve a user&apos;s agreementAcceptance objects.
