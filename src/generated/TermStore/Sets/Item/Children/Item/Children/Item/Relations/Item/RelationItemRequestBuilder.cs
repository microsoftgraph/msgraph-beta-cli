...
namespace ApiSdk.TermStore.Sets.Item.Children.Item.Children.Item.Relations.Item
{
    ...
    public class RelationItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildFromTermNavCommand()
        {
            ...
            var builder = new ApiSdk.TermStore.Sets.Item.Children.Item.Children.Item.Relations.Item.FromTerm.FromTermRequestBuilder(PathParameters);
        ...
        public Command BuildSetNavCommand()
        {
            ...
            var builder = new ApiSdk.TermStore.Sets.Item.Children.Item.Children.Item.Relations.Item.Set.SetRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildToTermNavCommand()
        {
            ...
            var builder = new ApiSdk.TermStore.Sets.Item.Children.Item.Children.Item.Relations.Item.ToTerm.ToTermRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.TermStore.Sets.Item.Children.Item.Children.Item.Relations.Item.RelationItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.TermStore.Sets.Item.Children.Item.Children.Item.Relations.Item.RelationItemRequestBuilder.RelationItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.TermStore.Sets.Item.Children.Item.Children.Item.Relations.Item.RelationItemRequestBuilder.RelationItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
