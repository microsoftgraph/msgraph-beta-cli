...
namespace ApiSdk.Models
{
    ...
    public class UnifiedRoleEligibilityScheduleInstance : ApiSdk.Models.UnifiedRoleScheduleInstanceBase, IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.UnifiedRoleEligibilityScheduleInstance"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.UnifiedRoleEligibilityScheduleInstance CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.UnifiedRoleEligibilityScheduleInstance();
        }
        /// <summary>
