    ...
    public class AddGroupRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Groups.Item.GroupLifecyclePolicies.Item.AddGroup.AddGroupPostRequestBody>(ApiSdk.Groups.Item.GroupLifecyclePolicies.Item.AddGroup.AddGroupPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.GroupLifecyclePolicies.Item.AddGroup.AddGroupRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Groups.Item.GroupLifecyclePolicies.Item.AddGroup.AddGroupPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Groups.Item.GroupLifecyclePolicies.Item.AddGroup.AddGroupPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
