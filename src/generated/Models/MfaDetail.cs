...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.MfaDetail"/> and sets the default values.
        /// </summary>
        public MfaDetail()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.MfaDetail"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.MfaDetail CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.MfaDetail();
        }
        /// <summary>
