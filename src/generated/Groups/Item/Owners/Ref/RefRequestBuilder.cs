...
namespace ApiSdk.Groups.Item.Owners.Ref
{
    ...
    public partial class RefRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Remove an owner from a Microsoft 365 group or a security group through the owners navigation property. When owners are assigned to a group, the last owner (a user object) of the group cannot be removed.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/group-delete-owners?view=graph-rest-beta";
