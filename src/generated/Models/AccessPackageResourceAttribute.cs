...
#nullable enable
        public ApiSdk.Models.AccessPackageResourceAttributeDestination? AttributeDestination { get; set; }
#nullable restore
#else
        public ApiSdk.Models.AccessPackageResourceAttributeDestination AttributeDestination { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.AccessPackageResourceAttributeSource? AttributeSource { get; set; }
#nullable restore
#else
        public ApiSdk.Models.AccessPackageResourceAttributeSource AttributeSource { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "attributeDestination", n => { AttributeDestination = n.GetObjectValue<ApiSdk.Models.AccessPackageResourceAttributeDestination>(ApiSdk.Models.AccessPackageResourceAttributeDestination.CreateFromDiscriminatorValue); } },
                { "attributeName", n => { AttributeName = n.GetStringValue(); } },
                { "attributeSource", n => { AttributeSource = n.GetObjectValue<ApiSdk.Models.AccessPackageResourceAttributeSource>(ApiSdk.Models.AccessPackageResourceAttributeSource.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.AccessPackageResourceAttributeDestination>("attributeDestination", AttributeDestination);
            writer.WriteStringValue("attributeName", AttributeName);
            writer.WriteObjectValue<ApiSdk.Models.AccessPackageResourceAttributeSource>("attributeSource", AttributeSource);
