...
namespace ApiSdk.Sites.Item.Onenote.Operations.Item {
    ...
    public class OnenoteOperationItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public OnenoteOperationItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/onenote/operations/{onenoteOperation%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="OnenoteOperationItemRequestBuilder"/> and sets the default values.
        ...
        public OnenoteOperationItemRequestBuilder(string rawUrl) : base("{+baseurl}/sites/{site%2Did}/onenote/operations/{onenoteOperation%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property operations for sites
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/sites/{site%2Did}/onenote/operations/{onenoteOperation%2Did}", PathParameters);
...
#nullable restore
        ...
        public RequestInformation ToPatchRequestInformation(OnenoteOperation body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.PATCH, "{+baseurl}/sites/{site%2Did}/onenote/operations/{onenoteOperation%2Did}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
