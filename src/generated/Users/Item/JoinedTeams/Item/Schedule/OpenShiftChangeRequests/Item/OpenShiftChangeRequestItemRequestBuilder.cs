...
using System;
namespace ApiSdk.Users.Item.JoinedTeams.Item.Schedule.OpenShiftChangeRequests.Item {
    /// <summary>
    ...
    public class OpenShiftChangeRequestItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public OpenShiftChangeRequestItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/openShiftChangeRequests/{openShiftChangeRequest%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new OpenShiftChangeRequestItemRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public OpenShiftChangeRequestItemRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/openShiftChangeRequests/{openShiftChangeRequest%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property openShiftChangeRequests for users
        /// </summary>
