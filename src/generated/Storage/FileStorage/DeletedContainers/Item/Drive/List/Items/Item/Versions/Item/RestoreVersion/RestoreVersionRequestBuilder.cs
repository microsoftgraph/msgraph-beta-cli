...
using System;
namespace ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.Items.Item.Versions.Item.RestoreVersion
{
    /// <summary>
    ...
    public class RestoreVersionRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.Items.Item.Versions.Item.RestoreVersion.RestoreVersionRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public RestoreVersionRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list/items/{listItem%2Did}/versions/{listItemVersion%2Did}/restoreVersion", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.Items.Item.Versions.Item.RestoreVersion.RestoreVersionRequestBuilder"/> and sets the default values.
        ...
        public RestoreVersionRequestBuilder(string rawUrl) : base("{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list/items/{listItem%2Did}/versions/{listItemVersion%2Did}/restoreVersion", rawUrl)
        {
        }
        /// <summary>
        /// Invoke action restoreVersion
