...
namespace ApiSdk.Models.ManagedTenants
{
    ...
    public partial class TenantCustomizedInformation : global::ApiSdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.ManagedTenants.TenantContactInformation>? Contacts { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.ManagedTenants.TenantContactInformation> Contacts { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.ManagedTenants.TenantCustomizedInformation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.ManagedTenants.TenantCustomizedInformation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.ManagedTenants.TenantCustomizedInformation();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "contacts", n => { Contacts = n.GetCollectionOfObjectValues<global::ApiSdk.Models.ManagedTenants.TenantContactInformation>(global::ApiSdk.Models.ManagedTenants.TenantContactInformation.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.ManagedTenants.TenantContactInformation>("contacts", Contacts);
