...
namespace ApiSdk.Users.Item.Presence
{
    ...
    public class PresenceRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildClearPresenceNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Presence.ClearPresence.ClearPresenceRequestBuilder(PathParameters);
        ...
        public Command BuildClearUserPreferredPresenceNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Presence.ClearUserPreferredPresence.ClearUserPreferredPresenceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSetPresenceNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Presence.SetPresence.SetPresenceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSetStatusMessageNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Presence.SetStatusMessage.SetStatusMessageRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSetUserPreferredPresenceNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Presence.SetUserPreferredPresence.SetUserPreferredPresenceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Users.Item.Presence.PresenceRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.Presence.PresenceRequestBuilder.PresenceRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.Presence.PresenceRequestBuilder.PresenceRequestBuilderGetQueryParameters>> requestConfiguration = default)
