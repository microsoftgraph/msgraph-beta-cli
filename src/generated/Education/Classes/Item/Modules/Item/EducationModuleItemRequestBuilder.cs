...
namespace ApiSdk.Education.Classes.Item.Modules.Item
{
    ...
    public partial class EducationModuleItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update an educationModule object in a class. Only teachers in the class can perform this operation. Note that you can't use a PATCH request to change the status of a module. Use the publish action to change the module status.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/educationmodule-update?view=graph-rest-beta";
            var educationClassIdOption = new Option<string>("--education-class-id", description: "The unique identifier of educationClass") {
            };
            educationClassIdOption.IsRequired = true;
            command.AddOption(educationClassIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.EducationModule>(global::ApiSdk.Models.EducationModule.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPinNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Classes.Item.Modules.Item.Pin.PinRequestBuilder(PathParameters);
        ...
        public Command BuildPublishNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Classes.Item.Modules.Item.Publish.PublishRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildResourcesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Classes.Item.Modules.Item.Resources.ResourcesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSetUpResourcesFolderNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Classes.Item.Modules.Item.SetUpResourcesFolder.SetUpResourcesFolderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUnpinNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Classes.Item.Modules.Item.Unpin.UnpinRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Education.Classes.Item.Modules.Item.EducationModuleItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Education.Classes.Item.Modules.Item.EducationModuleItemRequestBuilder.EducationModuleItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Education.Classes.Item.Modules.Item.EducationModuleItemRequestBuilder.EducationModuleItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.EducationModule body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.EducationModule body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
