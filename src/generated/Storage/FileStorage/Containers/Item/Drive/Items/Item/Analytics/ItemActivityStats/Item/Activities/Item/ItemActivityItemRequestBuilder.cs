...
using ApiSdk.Models;
using ApiSdk.Storage.FileStorage.Containers.Item.Drive.Items.Item.Analytics.ItemActivityStats.Item.Activities.Item.DriveItem;
...
using System;
namespace ApiSdk.Storage.FileStorage.Containers.Item.Drive.Items.Item.Analytics.ItemActivityStats.Item.Activities.Item
{
    /// <summary>
    ...
    public class ItemActivityItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDriveItemNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.Containers.Item.Drive.Items.Item.Analytics.ItemActivityStats.Item.Activities.Item.DriveItem.DriveItemRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.Containers.Item.Drive.Items.Item.Analytics.ItemActivityStats.Item.Activities.Item.ItemActivityItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public ItemActivityItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/analytics/itemActivityStats/{itemActivityStat%2Did}/activities/{itemActivity%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.Containers.Item.Drive.Items.Item.Analytics.ItemActivityStats.Item.Activities.Item.ItemActivityItemRequestBuilder"/> and sets the default values.
        ...
        public ItemActivityItemRequestBuilder(string rawUrl) : base("{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/analytics/itemActivityStats/{itemActivityStat%2Did}/activities/{itemActivity%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property activities for storage
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Storage.FileStorage.Containers.Item.Drive.Items.Item.Analytics.ItemActivityStats.Item.Activities.Item.ItemActivityItemRequestBuilder.ItemActivityItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Storage.FileStorage.Containers.Item.Drive.Items.Item.Analytics.ItemActivityStats.Item.Activities.Item.ItemActivityItemRequestBuilder.ItemActivityItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
