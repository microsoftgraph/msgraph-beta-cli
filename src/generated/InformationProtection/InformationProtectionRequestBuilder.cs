...
using ApiSdk.InformationProtection.Bitlocker;
using ApiSdk.InformationProtection.DataLossPreventionPolicies;
using ApiSdk.InformationProtection.DecryptBuffer;
using ApiSdk.InformationProtection.EncryptBuffer;
using ApiSdk.InformationProtection.Policy;
using ApiSdk.InformationProtection.SensitivityLabels;
using ApiSdk.InformationProtection.SensitivityPolicySettings;
using ApiSdk.InformationProtection.SignDigest;
using ApiSdk.InformationProtection.ThreatAssessmentRequests;
using ApiSdk.InformationProtection.VerifySignature;
...
namespace ApiSdk.InformationProtection
{
    ...
    public partial class InformationProtectionRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildBitlockerNavCommand()
        {
            ...
            var builder = new global::ApiSdk.InformationProtection.Bitlocker.BitlockerRequestBuilder(PathParameters);
        ...
        public Command BuildDataLossPreventionPoliciesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.InformationProtection.DataLossPreventionPolicies.DataLossPreventionPoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildDecryptBufferNavCommand()
        {
            ...
            var builder = new global::ApiSdk.InformationProtection.DecryptBuffer.DecryptBufferRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildEncryptBufferNavCommand()
        {
            ...
            var builder = new global::ApiSdk.InformationProtection.EncryptBuffer.EncryptBufferRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPolicyNavCommand()
        {
            ...
            var builder = new global::ApiSdk.InformationProtection.Policy.PolicyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildSensitivityLabelsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.InformationProtection.SensitivityLabels.SensitivityLabelsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildSensitivityPolicySettingsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.InformationProtection.SensitivityPolicySettings.SensitivityPolicySettingsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildSignDigestNavCommand()
        {
            ...
            var builder = new global::ApiSdk.InformationProtection.SignDigest.SignDigestRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildThreatAssessmentRequestsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.InformationProtection.ThreatAssessmentRequests.ThreatAssessmentRequestsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildVerifySignatureNavCommand()
        {
            ...
            var builder = new global::ApiSdk.InformationProtection.VerifySignature.VerifySignatureRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.InformationProtection.InformationProtectionRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.InformationProtection.InformationProtectionRequestBuilder.InformationProtectionRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.InformationProtection.InformationProtectionRequestBuilder.InformationProtectionRequestBuilderGetQueryParameters>> requestConfiguration = default)
