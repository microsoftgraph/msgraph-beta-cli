...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.Event>? ExceptionOccurrences { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.Event> ExceptionOccurrences { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "exceptionOccurrences", n => { ExceptionOccurrences = n.GetCollectionOfObjectValues<ApiSdk.Models.Event>(ApiSdk.Models.Event.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Event>("exceptionOccurrences", ExceptionOccurrences);
