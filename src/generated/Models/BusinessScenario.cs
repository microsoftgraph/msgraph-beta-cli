...
namespace ApiSdk.Models
{
    ...
    public class BusinessScenario : ApiSdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.BusinessScenarioPlanner? Planner { get; set; }
#nullable restore
#else
        public ApiSdk.Models.BusinessScenarioPlanner Planner { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.BusinessScenario"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.BusinessScenario CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.BusinessScenario();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "planner", n => { Planner = n.GetObjectValue<ApiSdk.Models.BusinessScenarioPlanner>(ApiSdk.Models.BusinessScenarioPlanner.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.BusinessScenarioPlanner>("planner", Planner);
