...
using ApiSdk.Models;
using ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.BulkUpload;
using ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Pause;
using ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.ProvisionOnDemand;
using ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Restart;
using ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Schema;
using ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Start;
using ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.ValidateCredentials;
...
namespace ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item
{
    ...
    public partial class SynchronizationJobItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildBulkUploadNavCommand()
        {
            ...
            var builder = new global::ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.BulkUpload.BulkUploadRequestBuilder(PathParameters);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property jobs in servicePrincipals";
            var servicePrincipalIdOption = new Option<string>("--service-principal-id", description: "The unique identifier of servicePrincipal") {
            };
            servicePrincipalIdOption.IsRequired = true;
            command.AddOption(servicePrincipalIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.SynchronizationJob>(global::ApiSdk.Models.SynchronizationJob.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPauseNavCommand()
        {
            ...
            var builder = new global::ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Pause.PauseRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildProvisionOnDemandNavCommand()
        {
            ...
            var builder = new global::ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.ProvisionOnDemand.ProvisionOnDemandRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRestartNavCommand()
        {
            ...
            var builder = new global::ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Restart.RestartRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSchemaNavCommand()
        {
            ...
            var builder = new global::ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Schema.SchemaRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
        ...
        public Command BuildStartNavCommand()
        {
            ...
            var builder = new global::ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Start.StartRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildValidateCredentialsByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.ValidateCredentials.ValidateCredentialsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.SynchronizationJobItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.SynchronizationJobItemRequestBuilder.SynchronizationJobItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.SynchronizationJobItemRequestBuilder.SynchronizationJobItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.SynchronizationJob body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.SynchronizationJob body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
