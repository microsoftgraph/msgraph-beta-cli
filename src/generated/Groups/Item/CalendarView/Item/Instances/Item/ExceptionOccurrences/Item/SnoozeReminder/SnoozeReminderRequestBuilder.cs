...
using System;
namespace ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.SnoozeReminder
{
    /// <summary>
    ...
    public partial class SnoozeReminderRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.SnoozeReminder.SnoozeReminderRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public SnoozeReminderRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/snoozeReminder", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.SnoozeReminder.SnoozeReminderRequestBuilder"/> and sets the default values.
        ...
        public SnoozeReminderRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/snoozeReminder", rawUrl)
        {
        }
        /// <summary>
        /// Postpone a reminder for an event in a user calendar until a new time.
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.SnoozeReminder.SnoozeReminderPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.SnoozeReminder.SnoozeReminderPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
