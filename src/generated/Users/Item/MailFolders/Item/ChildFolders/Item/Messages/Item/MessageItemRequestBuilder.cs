...
using ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.PermanentDelete;
...
namespace ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item
{
    ...
    public partial class MessageItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildMarkAsJunkNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.MarkAsJunk.MarkAsJunkRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMarkAsNotJunkNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.MarkAsNotJunk.MarkAsNotJunkRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMentionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Mentions.MentionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPermanentDeleteNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.PermanentDelete.PermanentDeleteRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUnsubscribeNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Unsubscribe.UnsubscribeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
