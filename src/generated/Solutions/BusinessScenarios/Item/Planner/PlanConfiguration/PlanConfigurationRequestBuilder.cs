...
using ApiSdk.Models;
using ApiSdk.Solutions.BusinessScenarios.Item.Planner.PlanConfiguration.Localizations;
...
namespace ApiSdk.Solutions.BusinessScenarios.Item.Planner.PlanConfiguration
{
    ...
    public partial class PlanConfigurationRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property planConfiguration for solutions";
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Read the properties and relationships of a plannerPlanConfiguration object.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/plannerplanconfiguration-get?view=graph-rest-beta";
            var businessScenarioIdOption = new Option<string>("--business-scenario-id", description: "The unique identifier of businessScenario") {
            };
            businessScenarioIdOption.IsRequired = true;
            command.AddOption(businessScenarioIdOption);
        ...
        public Command BuildLocalizationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Solutions.BusinessScenarios.Item.Planner.PlanConfiguration.Localizations.LocalizationsRequestBuilder(PathParameters);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the properties of a plannerPlanConfiguration object and its plannerPlanConfigurationLocalization collection for a businessScenario.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/plannerplanconfiguration-update?view=graph-rest-beta";
            var businessScenarioIdOption = new Option<string>("--business-scenario-id", description: "The unique identifier of businessScenario") {
            };
            businessScenarioIdOption.IsRequired = true;
            command.AddOption(businessScenarioIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.PlannerPlanConfiguration>(global::ApiSdk.Models.PlannerPlanConfiguration.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Solutions.BusinessScenarios.Item.Planner.PlanConfiguration.PlanConfigurationRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Solutions.BusinessScenarios.Item.Planner.PlanConfiguration.PlanConfigurationRequestBuilder.PlanConfigurationRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Solutions.BusinessScenarios.Item.Planner.PlanConfiguration.PlanConfigurationRequestBuilder.PlanConfigurationRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.PlannerPlanConfiguration body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.PlannerPlanConfiguration body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
