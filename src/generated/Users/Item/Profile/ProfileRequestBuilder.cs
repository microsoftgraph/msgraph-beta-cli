...
using ApiSdk.Models;
using ApiSdk.Users.Item.Profile.Account;
using ApiSdk.Users.Item.Profile.Addresses;
using ApiSdk.Users.Item.Profile.Anniversaries;
using ApiSdk.Users.Item.Profile.Awards;
using ApiSdk.Users.Item.Profile.Certifications;
using ApiSdk.Users.Item.Profile.EducationalActivities;
using ApiSdk.Users.Item.Profile.Emails;
using ApiSdk.Users.Item.Profile.Interests;
using ApiSdk.Users.Item.Profile.Languages;
using ApiSdk.Users.Item.Profile.Names;
using ApiSdk.Users.Item.Profile.Notes;
using ApiSdk.Users.Item.Profile.Patents;
using ApiSdk.Users.Item.Profile.Phones;
using ApiSdk.Users.Item.Profile.Positions;
using ApiSdk.Users.Item.Profile.Projects;
using ApiSdk.Users.Item.Profile.Publications;
using ApiSdk.Users.Item.Profile.Skills;
using ApiSdk.Users.Item.Profile.WebAccounts;
using ApiSdk.Users.Item.Profile.Websites;
...
namespace ApiSdk.Users.Item.Profile
{
    ...
    public partial class ProfileRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildAccountNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Profile.Account.AccountRequestBuilder(PathParameters);
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildAddressesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Profile.Addresses.AddressesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildAnniversariesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Profile.Anniversaries.AnniversariesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildAwardsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Profile.Awards.AwardsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildCertificationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Profile.Certifications.CertificationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildEducationalActivitiesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Profile.EducationalActivities.EducationalActivitiesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildEmailsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Profile.Emails.EmailsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildInterestsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Profile.Interests.InterestsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildLanguagesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Profile.Languages.LanguagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildNamesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Profile.Names.NamesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildNotesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Profile.Notes.NotesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Profile>(global::ApiSdk.Models.Profile.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildPatentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Profile.Patents.PatentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildPhonesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Profile.Phones.PhonesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildPositionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Profile.Positions.PositionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildProjectsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Profile.Projects.ProjectsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildPublicationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Profile.Publications.PublicationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildSkillsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Profile.Skills.SkillsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildWebAccountsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Profile.WebAccounts.WebAccountsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildWebsitesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Profile.Websites.WebsitesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.Profile.ProfileRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.Profile.ProfileRequestBuilder.ProfileRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.Profile.ProfileRequestBuilder.ProfileRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Profile body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Profile body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
