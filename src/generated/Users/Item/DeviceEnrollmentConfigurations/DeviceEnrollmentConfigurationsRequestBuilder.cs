...
namespace ApiSdk.Users.Item.DeviceEnrollmentConfigurations {
    ...
    public class DeviceEnrollmentConfigurationsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildCreateEnrollmentNotificationConfigurationNavCommand()
        {
            ...
            var builder = new CreateEnrollmentNotificationConfigurationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(DeviceEnrollmentConfiguration body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/users/{user%2Did}/deviceEnrollmentConfigurations", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
