...
namespace ApiSdk.Models.Security
{
    ...
    public partial class ProcessEvidence : global::ApiSdk.Models.Security.AlertEvidence, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The status of the detection. The possible values are: detected, blocked, prevented, unknownFutureValue.</summary>
        public global::ApiSdk.Models.Security.DetectionStatus? DetectionStatus { get; set; }
        /// <summary>Image file details.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.Security.FileDetails? ImageFile { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.Security.FileDetails ImageFile { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.Security.FileDetails? ParentProcessImageFile { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.Security.FileDetails ParentProcessImageFile { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.Security.UserAccount? UserAccount { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.Security.UserAccount UserAccount { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Models.Security.ProcessEvidence"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.Security.ProcessEvidence"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.Security.ProcessEvidence CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.Security.ProcessEvidence();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "detectionStatus", n => { DetectionStatus = n.GetEnumValue<global::ApiSdk.Models.Security.DetectionStatus>(); } },
                { "imageFile", n => { ImageFile = n.GetObjectValue<global::ApiSdk.Models.Security.FileDetails>(global::ApiSdk.Models.Security.FileDetails.CreateFromDiscriminatorValue); } },
                ...
                { "parentProcessImageFile", n => { ParentProcessImageFile = n.GetObjectValue<global::ApiSdk.Models.Security.FileDetails>(global::ApiSdk.Models.Security.FileDetails.CreateFromDiscriminatorValue); } },
                ...
                { "userAccount", n => { UserAccount = n.GetObjectValue<global::ApiSdk.Models.Security.UserAccount>(global::ApiSdk.Models.Security.UserAccount.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.Security.DetectionStatus>("detectionStatus", DetectionStatus);
            writer.WriteObjectValue<global::ApiSdk.Models.Security.FileDetails>("imageFile", ImageFile);
            ...
            writer.WriteObjectValue<global::ApiSdk.Models.Security.FileDetails>("parentProcessImageFile", ParentProcessImageFile);
            ...
            writer.WriteObjectValue<global::ApiSdk.Models.Security.UserAccount>("userAccount", UserAccount);
        }
    }
}
