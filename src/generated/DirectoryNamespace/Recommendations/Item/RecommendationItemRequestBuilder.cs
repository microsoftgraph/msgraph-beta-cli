...
using ApiSdk.DirectoryNamespace.Recommendations.Item.Complete;
using ApiSdk.DirectoryNamespace.Recommendations.Item.Dismiss;
using ApiSdk.DirectoryNamespace.Recommendations.Item.ImpactedResources;
using ApiSdk.DirectoryNamespace.Recommendations.Item.Postpone;
using ApiSdk.DirectoryNamespace.Recommendations.Item.Reactivate;
...
namespace ApiSdk.DirectoryNamespace.Recommendations.Item
{
    ...
    public partial class RecommendationItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildCompleteNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DirectoryNamespace.Recommendations.Item.Complete.CompleteRequestBuilder(PathParameters);
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property recommendations for directory";
        ...
        public Command BuildDismissNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DirectoryNamespace.Recommendations.Item.Dismiss.DismissRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildImpactedResourcesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DirectoryNamespace.Recommendations.Item.ImpactedResources.ImpactedResourcesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property recommendations in directory";
            var recommendationIdOption = new Option<string>("--recommendation-id", description: "The unique identifier of recommendation") {
            };
            recommendationIdOption.IsRequired = true;
            command.AddOption(recommendationIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Recommendation>(global::ApiSdk.Models.Recommendation.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPostponeNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DirectoryNamespace.Recommendations.Item.Postpone.PostponeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildReactivateNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DirectoryNamespace.Recommendations.Item.Reactivate.ReactivateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.DirectoryNamespace.Recommendations.Item.RecommendationItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DirectoryNamespace.Recommendations.Item.RecommendationItemRequestBuilder.RecommendationItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DirectoryNamespace.Recommendations.Item.RecommendationItemRequestBuilder.RecommendationItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Recommendation body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Recommendation body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class RecommendationItemRequestBuilderGetQueryParameters 
        {
