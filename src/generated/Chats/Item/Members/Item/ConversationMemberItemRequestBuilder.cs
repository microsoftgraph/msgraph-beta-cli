...
using System;
namespace ApiSdk.Chats.Item.Members.Item
{
    /// <summary>
    ...
    public class ConversationMemberItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Retrieve a conversationMember from a chat.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/chat-get-members?view=graph-rest-beta";
            var chatIdOption = new Option<string>("--chat-id", description: "The unique identifier of chat") {
            };
            chatIdOption.IsRequired = true;
            command.AddOption(chatIdOption);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Chats.Item.Members.Item.ConversationMemberItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public ConversationMemberItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/chats/{chat%2Did}/members/{conversationMember%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Chats.Item.Members.Item.ConversationMemberItemRequestBuilder"/> and sets the default values.
        ...
        public ConversationMemberItemRequestBuilder(string rawUrl) : base("{+baseurl}/chats/{chat%2Did}/members/{conversationMember%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Remove a conversationMember from a chat.
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Chats.Item.Members.Item.ConversationMemberItemRequestBuilder.ConversationMemberItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Chats.Item.Members.Item.ConversationMemberItemRequestBuilder.ConversationMemberItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
