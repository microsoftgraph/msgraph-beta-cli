...
using System;
namespace ApiSdk.Users.Item.DirectReports.Item.GraphOrgContact {
    /// <summary>
    ...
    public class GraphOrgContactRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public GraphOrgContactRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/directReports/{directoryObject%2Did}/graph.orgContact{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="GraphOrgContactRequestBuilder"/> and sets the default values.
        ...
        public GraphOrgContactRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/directReports/{directoryObject%2Did}/graph.orgContact{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.orgContact
