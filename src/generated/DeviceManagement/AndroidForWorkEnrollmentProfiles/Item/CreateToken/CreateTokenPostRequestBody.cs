...
namespace ApiSdk.DeviceManagement.AndroidForWorkEnrollmentProfiles.Item.CreateToken
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="CreateTokenPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="CreateTokenPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static CreateTokenPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
