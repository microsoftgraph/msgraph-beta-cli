...
namespace ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Reply
{
    ...
    public partial class ReplyRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/post-reply?view=graph-rest-beta" />
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildPostCommand()
        {
            var command = new Command("post");
            command.Description = "Reply to a post and add a new post to the specified thread in a group conversation.  You can specify both the parent conversation and thread in the request, or, you can specify just the parent thread without the parent conversation.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/post-reply?view=graph-rest-beta";
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Reply.ReplyPostRequestBody>(global::ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Reply.ReplyPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Reply.ReplyRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        public ReplyRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/conversations/{conversation%2Did}/threads/{conversationThread%2Did}/reply", rawUrl)
        {
        }
        /// <summary>
        /// Reply to a post and add a new post to the specified thread in a group conversation.  You can specify both the parent conversation and thread in the request, or, you can specify just the parent thread without the parent conversation.
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Reply.ReplyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Reply.ReplyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
