...
namespace ApiSdk.Models.WindowsUpdates
{
    ...
    public class OperationalInsightsConnection : ApiSdk.Models.WindowsUpdates.ResourceConnection, IParsable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.WindowsUpdates.OperationalInsightsConnection"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.WindowsUpdates.OperationalInsightsConnection"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.WindowsUpdates.OperationalInsightsConnection CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.WindowsUpdates.OperationalInsightsConnection();
        }
        /// <summary>
