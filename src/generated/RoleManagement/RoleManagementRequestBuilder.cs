...
using ApiSdk.Models;
using ApiSdk.RoleManagement.CloudPC;
using ApiSdk.RoleManagement.Defender;
using ApiSdk.RoleManagement.DeviceManagement;
using ApiSdk.RoleManagement.DirectoryNamespace;
using ApiSdk.RoleManagement.EnterpriseApps;
using ApiSdk.RoleManagement.EntitlementManagement;
using ApiSdk.RoleManagement.Exchange;
...
namespace ApiSdk.RoleManagement
{
    ...
    public partial class RoleManagementRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        /// Provides operations to manage the cloudPC property of the microsoft.graph.roleManagement entity.
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildCloudPCNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.CloudPC.CloudPCRequestBuilder(PathParameters);
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildDefenderNavCommand()
        {
            var command = new Command("defender");
            command.Description = "Provides operations to manage the defender property of the microsoft.graph.roleManagement entity.";
            var builder = new global::ApiSdk.RoleManagement.Defender.DefenderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildDeviceManagementNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.DeviceManagement.DeviceManagementRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildDirectoryNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.DirectoryNamespace.DirectoryRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
            nonExecCommands.Add(builder.BuildResourceNamespacesNavCommand());
            nonExecCommands.Add(builder.BuildRoleAssignmentApprovalsNavCommand());
            ...
            nonExecCommands.Add(builder.BuildRoleScheduleInstancesdirectoryScopeIdDirectoryScopeIdAppScopeIdAppScopeIdPrincipalIdPrincipalIdRoleDefinitionIdRoleDefinitionIdNavCommand());
            nonExecCommands.Add(builder.BuildRoleSchedulesdirectoryScopeIdDirectoryScopeIdAppScopeIdAppScopeIdPrincipalIdPrincipalIdRoleDefinitionIdRoleDefinitionIdNavCommand());
            nonExecCommands.Add(builder.BuildTransitiveRoleAssignmentsNavCommand());
            foreach (var cmd in execCommands)
            {
                command.AddCommand(cmd);
            }
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildEnterpriseAppsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EnterpriseApps.EnterpriseAppsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildEntitlementManagementNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EntitlementManagement.EntitlementManagementRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildExchangeNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.Exchange.ExchangeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.RoleManagement>(global::ApiSdk.Models.RoleManagement.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.RoleManagement.RoleManagementRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.RoleManagement.RoleManagementRequestBuilder.RoleManagementRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.RoleManagement.RoleManagementRequestBuilder.RoleManagementRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.RoleManagement body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.RoleManagement body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
