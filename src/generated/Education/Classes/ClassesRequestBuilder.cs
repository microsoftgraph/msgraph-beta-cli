...
namespace ApiSdk.Education.Classes
{
    ...
    public class ClassesRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new ApiSdk.Education.Classes.Item.EducationClassItemRequestBuilder(PathParameters);
        ...
        public Command BuildCountNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Classes.Count.CountRequestBuilder(PathParameters);
        ...
        public Command BuildDeltaNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Classes.Delta.DeltaRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Education.Classes.ClassesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Education.Classes.ClassesRequestBuilder.ClassesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Education.Classes.ClassesRequestBuilder.ClassesRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Models.EducationClass body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Models.EducationClass body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
