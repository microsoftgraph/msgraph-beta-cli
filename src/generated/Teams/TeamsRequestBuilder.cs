...
using ApiSdk.Models;
using ApiSdk.Teams.AllMessages;
using ApiSdk.Teams.Count;
using ApiSdk.Teams.GetAllMessages;
using ApiSdk.Teams.GetOpenShifts;
using ApiSdk.Teams.GetShifts;
using ApiSdk.Teams.GetTimesOff;
...
namespace ApiSdk.Teams
{
    ...
    public partial class TeamsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAllMessagesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.AllMessages.AllMessagesRequestBuilder(PathParameters);
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.TeamItemRequestBuilder(PathParameters);
            ...
            commands.Add(builder.BuildOwnersWithUserPrincipalNameRbCommand());
            ...
            commands.Add(builder.BuildTemplateDefinitionNavCommand());
        ...
        public Command BuildCountNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Count.CountRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetAllMessagesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.GetAllMessages.GetAllMessagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildGetOpenShiftsNavCommand()
        {
            var command = new Command("get-open-shifts");
            command.Description = "Provides operations to call the getOpenShifts method.";
            var builder = new global::ApiSdk.Teams.GetOpenShifts.GetOpenShiftsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildGetShiftsNavCommand()
        {
            var command = new Command("get-shifts");
            command.Description = "Provides operations to call the getShifts method.";
            var builder = new global::ApiSdk.Teams.GetShifts.GetShiftsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildGetTimesOffNavCommand()
        {
            var command = new Command("get-times-off");
            command.Description = "Provides operations to call the getTimesOff method.";
            var builder = new global::ApiSdk.Teams.GetTimesOff.GetTimesOffRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Teams.TeamsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Teams.TeamsRequestBuilder.TeamsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Teams.TeamsRequestBuilder.TeamsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Models.Team body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Models.Team body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
