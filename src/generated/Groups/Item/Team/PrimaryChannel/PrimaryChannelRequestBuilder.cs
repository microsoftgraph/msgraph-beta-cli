...
using ApiSdk.Groups.Item.Team.PrimaryChannel.AllMembers;
using ApiSdk.Groups.Item.Team.PrimaryChannel.Archive;
...
using ApiSdk.Groups.Item.Team.PrimaryChannel.Planner;
...
using ApiSdk.Groups.Item.Team.PrimaryChannel.Unarchive;
...
namespace ApiSdk.Groups.Item.Team.PrimaryChannel
{
    ...
    public partial class PrimaryChannelRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAllMembersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PrimaryChannel.AllMembers.AllMembersRequestBuilder(PathParameters);
        ...
        public Command BuildArchiveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PrimaryChannel.Archive.ArchiveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCompleteMigrationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PrimaryChannel.CompleteMigration.CompleteMigrationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PrimaryChannel.DoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalName.DoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildFilesFolderNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PrimaryChannel.FilesFolder.FilesFolderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildMembersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PrimaryChannel.Members.MembersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAddNavCommand());
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildMessagesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PrimaryChannel.Messages.MessagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPlannerNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PrimaryChannel.Planner.PlannerRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildProvisionEmailNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PrimaryChannel.ProvisionEmail.ProvisionEmailRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRemoveEmailNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PrimaryChannel.RemoveEmail.RemoveEmailRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSharedWithTeamsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PrimaryChannel.SharedWithTeams.SharedWithTeamsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildTabsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PrimaryChannel.Tabs.TabsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildUnarchiveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Team.PrimaryChannel.Unarchive.UnarchiveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Team.PrimaryChannel.PrimaryChannelRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public PrimaryChannelRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/team/primaryChannel{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Team.PrimaryChannel.PrimaryChannelRequestBuilder"/> and sets the default values.
        ...
        public PrimaryChannelRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/team/primaryChannel{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property primaryChannel for groups
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.Team.PrimaryChannel.PrimaryChannelRequestBuilder.PrimaryChannelRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.Team.PrimaryChannel.PrimaryChannelRequestBuilder.PrimaryChannelRequestBuilderGetQueryParameters>> requestConfiguration = default)
