...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.VisualProperties? VisualContent { get; set; }
#nullable restore
#else
        public ApiSdk.Models.VisualProperties VisualContent { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.PayloadTypes"/> and sets the default values.
        /// </summary>
        public PayloadTypes()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.PayloadTypes"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.PayloadTypes CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.PayloadTypes();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "visualContent", n => { VisualContent = n.GetObjectValue<ApiSdk.Models.VisualProperties>(ApiSdk.Models.VisualProperties.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.VisualProperties>("visualContent", VisualContent);
