...
namespace ApiSdk.Models {
    public class EducationAssignmentPointsGrade : EducationAssignmentGrade, IParsable {
        ...
        public float? EducationAssignmentPointsGradePoints { get; set; }
        /// <summary>Number of points a teacher is giving this submission object.</summary>
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"points", n => { EducationAssignmentPointsGradePoints = n.GetFloatValue(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteFloatValue("points", EducationAssignmentPointsGradePoints);
