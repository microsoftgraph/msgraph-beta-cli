...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class AndroidWorkProfileTrustedRootCertificate : ApiSdk.Models.DeviceConfiguration, IParsable
    {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.AndroidWorkProfileTrustedRootCertificate"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.AndroidWorkProfileTrustedRootCertificate"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.AndroidWorkProfileTrustedRootCertificate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.AndroidWorkProfileTrustedRootCertificate();
        }
        /// <summary>
