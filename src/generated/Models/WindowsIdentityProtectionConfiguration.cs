...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class WindowsIdentityProtectionConfiguration : ApiSdk.Models.DeviceConfiguration, IParsable
    {
        ...
        public ApiSdk.Models.ConfigurationUsage? PinLowercaseCharactersUsage { get; set; }
        ...
        /// <summary>Possible values of the ConfigurationUsage list.</summary>
        public ApiSdk.Models.ConfigurationUsage? PinSpecialCharactersUsage { get; set; }
        /// <summary>Possible values of the ConfigurationUsage list.</summary>
        public ApiSdk.Models.ConfigurationUsage? PinUppercaseCharactersUsage { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.WindowsIdentityProtectionConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.WindowsIdentityProtectionConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.WindowsIdentityProtectionConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.WindowsIdentityProtectionConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "pinLowercaseCharactersUsage", n => { PinLowercaseCharactersUsage = n.GetEnumValue<ApiSdk.Models.ConfigurationUsage>(); } },
                ...
                { "pinSpecialCharactersUsage", n => { PinSpecialCharactersUsage = n.GetEnumValue<ApiSdk.Models.ConfigurationUsage>(); } },
                { "pinUppercaseCharactersUsage", n => { PinUppercaseCharactersUsage = n.GetEnumValue<ApiSdk.Models.ConfigurationUsage>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.ConfigurationUsage>("pinLowercaseCharactersUsage", PinLowercaseCharactersUsage);
            ...
            writer.WriteEnumValue<ApiSdk.Models.ConfigurationUsage>("pinSpecialCharactersUsage", PinSpecialCharactersUsage);
            writer.WriteEnumValue<ApiSdk.Models.ConfigurationUsage>("pinUppercaseCharactersUsage", PinUppercaseCharactersUsage);
