...
namespace ApiSdk.Admin.Windows.Updates.UpdatePolicies.Item.ComplianceChanges.Item
{
    ...
    public class ComplianceChangeItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildUpdatePolicyNavCommand()
        {
            ...
            var builder = new ApiSdk.Admin.Windows.Updates.UpdatePolicies.Item.ComplianceChanges.Item.UpdatePolicy.UpdatePolicyRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Admin.Windows.Updates.UpdatePolicies.Item.ComplianceChanges.Item.ComplianceChangeItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Admin.Windows.Updates.UpdatePolicies.Item.ComplianceChanges.Item.ComplianceChangeItemRequestBuilder.ComplianceChangeItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Admin.Windows.Updates.UpdatePolicies.Item.ComplianceChanges.Item.ComplianceChangeItemRequestBuilder.ComplianceChangeItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.WindowsUpdates.ComplianceChange body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.WindowsUpdates.ComplianceChange body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
