...
using ApiSdk.Models;
using ApiSdk.Sites.Item.Items.Count;
using ApiSdk.Sites.Item.Items.Item;
...
using System;
namespace ApiSdk.Sites.Item.Items {
    /// <summary>
    ...
    public class ItemsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public ItemsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/items{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ItemsRequestBuilder"/> and sets the default values.
        ...
        public ItemsRequestBuilder(string rawUrl) : base("{+baseurl}/sites/{site%2Did}/items{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Used to address any item contained in this site. This collection cannot be enumerated.
