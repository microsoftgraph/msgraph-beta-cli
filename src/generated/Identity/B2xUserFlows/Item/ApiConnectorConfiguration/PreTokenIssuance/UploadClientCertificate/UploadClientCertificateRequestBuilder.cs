    ...
    public class UploadClientCertificateRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Identity.B2xUserFlows.Item.ApiConnectorConfiguration.PreTokenIssuance.UploadClientCertificate.UploadClientCertificatePostRequestBody>(ApiSdk.Identity.B2xUserFlows.Item.ApiConnectorConfiguration.PreTokenIssuance.UploadClientCertificate.UploadClientCertificatePostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Identity.B2xUserFlows.Item.ApiConnectorConfiguration.PreTokenIssuance.UploadClientCertificate.UploadClientCertificateRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Identity.B2xUserFlows.Item.ApiConnectorConfiguration.PreTokenIssuance.UploadClientCertificate.UploadClientCertificatePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Identity.B2xUserFlows.Item.ApiConnectorConfiguration.PreTokenIssuance.UploadClientCertificate.UploadClientCertificatePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
