...
namespace ApiSdk.App.Calls.Item
{
    ...
    public class CallItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAddLargeGalleryViewNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.AddLargeGalleryView.AddLargeGalleryViewRequestBuilder(PathParameters);
        ...
        public Command BuildAnswerNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.Answer.AnswerRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildAudioRoutingGroupsNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.AudioRoutingGroups.AudioRoutingGroupsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCancelMediaProcessingNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.CancelMediaProcessing.CancelMediaProcessingRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildChangeScreenSharingRoleNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.ChangeScreenSharingRole.ChangeScreenSharingRoleRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildContentSharingSessionsNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.ContentSharingSessions.ContentSharingSessionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildKeepAliveNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.KeepAlive.KeepAliveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMuteNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.Mute.MuteRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildOperationsNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.Operations.OperationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildParticipantsNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.Participants.ParticipantsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPlayPromptNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.PlayPrompt.PlayPromptRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRecordNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.Record.RecordRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRecordResponseNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.RecordResponse.RecordResponseRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRedirectNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.Redirect.RedirectRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRejectNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.Reject.RejectRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSendDtmfTonesNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.SendDtmfTones.SendDtmfTonesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSubscribeToToneNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.SubscribeToTone.SubscribeToToneRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTransferNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.Transfer.TransferRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUnmuteNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.Unmute.UnmuteRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUpdateRecordingStatusNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.UpdateRecordingStatus.UpdateRecordingStatusRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.App.Calls.Item.CallItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.App.Calls.Item.CallItemRequestBuilder.CallItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.App.Calls.Item.CallItemRequestBuilder.CallItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
