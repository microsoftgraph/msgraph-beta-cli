...
using ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.AcceptRecommendations;
using ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.ApplyDecisions;
using ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.BatchRecordDecisions;
using ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.ContactedReviewers;
using ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Decisions;
using ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Definition;
using ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.ResetDecisions;
using ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.SendReminder;
using ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Stages;
using ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Stop;
using ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.StopApplyDecisions;
...
using System;
namespace ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance
{
    /// <summary>
    ...
    public partial class InstanceRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAcceptRecommendationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.AcceptRecommendations.AcceptRecommendationsRequestBuilder(PathParameters);
        ...
        public Command BuildApplyDecisionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.ApplyDecisions.ApplyDecisionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildBatchRecordDecisionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.BatchRecordDecisions.BatchRecordDecisionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildContactedReviewersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.ContactedReviewers.ContactedReviewersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildDecisionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Decisions.DecisionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildDefinitionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Definition.DefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildResetDecisionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.ResetDecisions.ResetDecisionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSendReminderNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.SendReminder.SendReminderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildStagesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Stages.StagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildStopApplyDecisionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.StopApplyDecisions.StopApplyDecisionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildStopNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.Stop.StopRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.InstanceRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.InstanceRequestBuilder.InstanceRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.IdentityGovernance.AccessReviews.Decisions.Item.Instance.InstanceRequestBuilder.InstanceRequestBuilderGetQueryParameters>> requestConfiguration = default)
