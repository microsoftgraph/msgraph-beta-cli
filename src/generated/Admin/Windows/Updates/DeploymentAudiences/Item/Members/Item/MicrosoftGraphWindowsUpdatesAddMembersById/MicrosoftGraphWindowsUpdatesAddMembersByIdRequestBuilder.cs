...
using System;
namespace ApiSdk.Admin.Windows.Updates.DeploymentAudiences.Item.Members.Item.MicrosoftGraphWindowsUpdatesAddMembersById
{
    /// <summary>
    ...
    public partial class MicrosoftGraphWindowsUpdatesAddMembersByIdRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Admin.Windows.Updates.DeploymentAudiences.Item.Members.Item.MicrosoftGraphWindowsUpdatesAddMembersById.MicrosoftGraphWindowsUpdatesAddMembersByIdRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public MicrosoftGraphWindowsUpdatesAddMembersByIdRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/members/{updatableAsset%2Did}/microsoft.graph.windowsUpdates.addMembersById", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Admin.Windows.Updates.DeploymentAudiences.Item.Members.Item.MicrosoftGraphWindowsUpdatesAddMembersById.MicrosoftGraphWindowsUpdatesAddMembersByIdRequestBuilder"/> and sets the default values.
        ...
        public MicrosoftGraphWindowsUpdatesAddMembersByIdRequestBuilder(string rawUrl) : base("{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/members/{updatableAsset%2Did}/microsoft.graph.windowsUpdates.addMembersById", rawUrl)
        {
        }
        /// <summary>
        /// Add members of the same type to an updatableAssetGroup. You can also use the method addMembers to add members.
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Admin.Windows.Updates.DeploymentAudiences.Item.Members.Item.MicrosoftGraphWindowsUpdatesAddMembersById.AddMembersByIdPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Admin.Windows.Updates.DeploymentAudiences.Item.Members.Item.MicrosoftGraphWindowsUpdatesAddMembersById.AddMembersByIdPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
