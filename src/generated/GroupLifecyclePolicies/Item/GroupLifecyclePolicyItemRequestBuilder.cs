...
namespace ApiSdk.GroupLifecyclePolicies.Item
{
    ...
    public class GroupLifecyclePolicyItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAddGroupNavCommand()
        {
            ...
            var builder = new ApiSdk.GroupLifecyclePolicies.Item.AddGroup.AddGroupRequestBuilder(PathParameters);
        ...
        public Command BuildRemoveGroupNavCommand()
        {
            ...
            var builder = new ApiSdk.GroupLifecyclePolicies.Item.RemoveGroup.RemoveGroupRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.GroupLifecyclePolicies.Item.GroupLifecyclePolicyItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.GroupLifecyclePolicies.Item.GroupLifecyclePolicyItemRequestBuilder.GroupLifecyclePolicyItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.GroupLifecyclePolicies.Item.GroupLifecyclePolicyItemRequestBuilder.GroupLifecyclePolicyItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.GroupLifecyclePolicy body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.GroupLifecyclePolicy body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
