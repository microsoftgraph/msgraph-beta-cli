...
using ApiSdk.Models;
using ApiSdk.PrivilegedApproval.Item.RoleInfo.Assignments;
using ApiSdk.PrivilegedApproval.Item.RoleInfo.SelfActivate;
using ApiSdk.PrivilegedApproval.Item.RoleInfo.SelfDeactivate;
using ApiSdk.PrivilegedApproval.Item.RoleInfo.Settings;
using ApiSdk.PrivilegedApproval.Item.RoleInfo.Summary;
...
namespace ApiSdk.PrivilegedApproval.Item.RoleInfo
{
    ...
    public class RoleInfoRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAssignmentsNavCommand()
        {
            ...
            var builder = new ApiSdk.PrivilegedApproval.Item.RoleInfo.Assignments.AssignmentsRequestBuilder(PathParameters);
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property roleInfo for privilegedApproval";
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get roleInfo from privilegedApproval";
            var privilegedApprovalIdOption = new Option<string>("--privileged-approval-id", description: "The unique identifier of privilegedApproval") {
            };
            privilegedApprovalIdOption.IsRequired = true;
            command.AddOption(privilegedApprovalIdOption);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property roleInfo in privilegedApproval";
            var privilegedApprovalIdOption = new Option<string>("--privileged-approval-id", description: "The unique identifier of privilegedApproval") {
            };
            privilegedApprovalIdOption.IsRequired = true;
            command.AddOption(privilegedApprovalIdOption);
        ...
        public Command BuildSelfActivateNavCommand()
        {
            ...
            var builder = new ApiSdk.PrivilegedApproval.Item.RoleInfo.SelfActivate.SelfActivateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSelfDeactivateNavCommand()
        {
            ...
            var builder = new ApiSdk.PrivilegedApproval.Item.RoleInfo.SelfDeactivate.SelfDeactivateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSettingsNavCommand()
        {
            ...
            var builder = new ApiSdk.PrivilegedApproval.Item.RoleInfo.Settings.SettingsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSummaryNavCommand()
        {
            ...
            var builder = new ApiSdk.PrivilegedApproval.Item.RoleInfo.Summary.SummaryRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.PrivilegedApproval.Item.RoleInfo.RoleInfoRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public RoleInfoRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/privilegedApproval/{privilegedApproval%2Did}/roleInfo{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.PrivilegedApproval.Item.RoleInfo.RoleInfoRequestBuilder"/> and sets the default values.
        ...
        public RoleInfoRequestBuilder(string rawUrl) : base("{+baseurl}/privilegedApproval/{privilegedApproval%2Did}/roleInfo{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property roleInfo for privilegedApproval
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.PrivilegedApproval.Item.RoleInfo.RoleInfoRequestBuilder.RoleInfoRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.PrivilegedApproval.Item.RoleInfo.RoleInfoRequestBuilder.RoleInfoRequestBuilderGetQueryParameters>> requestConfiguration = default)
