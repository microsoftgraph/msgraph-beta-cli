...
namespace ApiSdk.Security.TriggerTypes.RetentionEventTypes.Item
{
    ...
    public partial class RetentionEventTypeItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.AddOption(retentionEventTypeIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                var retentionEventTypeId = invocationContext.ParseResult.GetValueForOption(retentionEventTypeIdOption);
                var ifMatch = invocationContext.ParseResult.GetValueForOption(ifMatchOption);
                var cancellationToken = invocationContext.GetCancellationToken();
                var reqAdapter = invocationContext.GetRequestAdapter();
                var requestInfo = ToDeleteRequestInformation(q => {
                });
                if (retentionEventTypeId is not null) requestInfo.PathParameters.Add("retentionEventType%2Did", retentionEventTypeId);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property retentionEventTypes in security";
            var retentionEventTypeIdOption = new Option<string>("--retention-event-type-id", description: "The unique identifier of retentionEventType") {
            };
            retentionEventTypeIdOption.IsRequired = true;
            command.AddOption(retentionEventTypeIdOption);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Security.TriggerTypes.RetentionEventTypes.Item.RetentionEventTypeItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.TriggerTypes.RetentionEventTypes.Item.RetentionEventTypeItemRequestBuilder.RetentionEventTypeItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.TriggerTypes.RetentionEventTypes.Item.RetentionEventTypeItemRequestBuilder.RetentionEventTypeItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Security.RetentionEventType body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Security.RetentionEventType body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
