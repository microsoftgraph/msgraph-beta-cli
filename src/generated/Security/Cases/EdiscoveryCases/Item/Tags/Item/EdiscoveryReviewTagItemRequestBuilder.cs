...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Tags.Item
{
    ...
    public class EdiscoveryReviewTagItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildChildTagsNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.Cases.EdiscoveryCases.Item.Tags.Item.ChildTags.ChildTagsRequestBuilder(PathParameters);
        ...
        public Command BuildParentNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.Cases.EdiscoveryCases.Item.Tags.Item.Parent.ParentRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Security.Cases.EdiscoveryCases.Item.Tags.Item.EdiscoveryReviewTagItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.Cases.EdiscoveryCases.Item.Tags.Item.EdiscoveryReviewTagItemRequestBuilder.EdiscoveryReviewTagItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.Cases.EdiscoveryCases.Item.Tags.Item.EdiscoveryReviewTagItemRequestBuilder.EdiscoveryReviewTagItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Security.EdiscoveryReviewTag body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Security.EdiscoveryReviewTag body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
