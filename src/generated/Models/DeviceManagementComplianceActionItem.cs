...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class DeviceManagementComplianceActionItem : ApiSdk.Models.Entity, IParsable
    {
        /// <summary>Scheduled Action Type Enum</summary>
        public ApiSdk.Models.DeviceManagementComplianceActionType? ActionType { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.DeviceManagementComplianceActionItem"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.DeviceManagementComplianceActionItem CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.DeviceManagementComplianceActionItem();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "actionType", n => { ActionType = n.GetEnumValue<ApiSdk.Models.DeviceManagementComplianceActionType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.DeviceManagementComplianceActionType>("actionType", ActionType);
