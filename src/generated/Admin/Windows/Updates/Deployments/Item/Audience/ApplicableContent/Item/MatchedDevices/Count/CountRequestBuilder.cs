...
namespace ApiSdk.Admin.Windows.Updates.Deployments.Item.Audience.ApplicableContent.Item.MatchedDevices.Count
{
    ...
    public class CountRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Admin.Windows.Updates.Deployments.Item.Audience.ApplicableContent.Item.MatchedDevices.Count.CountRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Admin.Windows.Updates.Deployments.Item.Audience.ApplicableContent.Item.MatchedDevices.Count.CountRequestBuilder.CountRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Admin.Windows.Updates.Deployments.Item.Audience.ApplicableContent.Item.MatchedDevices.Count.CountRequestBuilder.CountRequestBuilderGetQueryParameters>> requestConfiguration = default)
