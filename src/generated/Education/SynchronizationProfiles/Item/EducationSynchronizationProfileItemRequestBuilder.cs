...
namespace ApiSdk.Education.SynchronizationProfiles.Item
{
    ...
    public partial class EducationSynchronizationProfileItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildErrorsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.SynchronizationProfiles.Item.Errors.ErrorsRequestBuilder(PathParameters);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.EducationSynchronizationProfile>(global::ApiSdk.Models.EducationSynchronizationProfile.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPauseNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.SynchronizationProfiles.Item.Pause.PauseRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildProfileStatusNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.SynchronizationProfiles.Item.ProfileStatus.ProfileStatusRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildResetNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.SynchronizationProfiles.Item.Reset.ResetRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildResumeNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.SynchronizationProfiles.Item.Resume.ResumeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildStartNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.SynchronizationProfiles.Item.Start.StartRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUploadUrlNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.SynchronizationProfiles.Item.UploadUrl.UploadUrlRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Education.SynchronizationProfiles.Item.EducationSynchronizationProfileItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Education.SynchronizationProfiles.Item.EducationSynchronizationProfileItemRequestBuilder.EducationSynchronizationProfileItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Education.SynchronizationProfiles.Item.EducationSynchronizationProfileItemRequestBuilder.EducationSynchronizationProfileItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.EducationSynchronizationProfile body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.EducationSynchronizationProfile body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
