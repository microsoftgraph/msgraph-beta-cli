...
namespace ApiSdk.Policies.MobileAppManagementPolicies.Item.IncludedGroups.Item
{
    ...
    public class GroupItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildRefByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.MobileAppManagementPolicies.Item.IncludedGroups.Item.Ref.RefRequestBuilder(PathParameters);
        ...
        public Command BuildServiceProvisioningErrorsNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.MobileAppManagementPolicies.Item.IncludedGroups.Item.ServiceProvisioningErrors.ServiceProvisioningErrorsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Policies.MobileAppManagementPolicies.Item.IncludedGroups.Item.GroupItemRequestBuilder"/> and sets the default values.
        /// </summary>
