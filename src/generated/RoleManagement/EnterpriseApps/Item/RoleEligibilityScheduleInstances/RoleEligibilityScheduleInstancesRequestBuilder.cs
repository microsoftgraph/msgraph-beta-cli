...
namespace ApiSdk.RoleManagement.EnterpriseApps.Item.RoleEligibilityScheduleInstances {
    ...
    public class RoleEligibilityScheduleInstancesRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new UnifiedRoleEligibilityScheduleInstanceItemRequestBuilder(PathParameters);
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(UnifiedRoleEligibilityScheduleInstance body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleEligibilityScheduleInstances", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
