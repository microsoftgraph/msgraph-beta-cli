...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class MacOSPkgApp : ApiSdk.Models.MobileLobApp, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.MacOSAppScript? PostInstallScript { get; set; }
#nullable restore
#else
        public ApiSdk.Models.MacOSAppScript PostInstallScript { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.MacOSAppScript? PreInstallScript { get; set; }
#nullable restore
#else
        public ApiSdk.Models.MacOSAppScript PreInstallScript { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.MacOSPkgApp"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.MacOSPkgApp"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.MacOSPkgApp CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.MacOSPkgApp();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "postInstallScript", n => { PostInstallScript = n.GetObjectValue<ApiSdk.Models.MacOSAppScript>(ApiSdk.Models.MacOSAppScript.CreateFromDiscriminatorValue); } },
                { "preInstallScript", n => { PreInstallScript = n.GetObjectValue<ApiSdk.Models.MacOSAppScript>(ApiSdk.Models.MacOSAppScript.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.MacOSAppScript>("postInstallScript", PostInstallScript);
            writer.WriteObjectValue<ApiSdk.Models.MacOSAppScript>("preInstallScript", PreInstallScript);
