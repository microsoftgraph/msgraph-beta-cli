...
namespace ApiSdk.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item
{
    ...
    public partial class UnifiedRoleEligibilityScheduleRequestItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAppScopeNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item.AppScope.AppScopeRequestBuilder(PathParameters);
        ...
        public Command BuildCancelNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item.Cancel.CancelRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildDirectoryScopeNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item.DirectoryScope.DirectoryScopeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Read the properties and relationships of an unifiedRoleEligibilityScheduleRequest object.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/unifiedroleeligibilityschedulerequest-get?view=graph-rest-beta";
            var unifiedRoleEligibilityScheduleRequestIdOption = new Option<string>("--unified-role-eligibility-schedule-request-id", description: "The unique identifier of unifiedRoleEligibilityScheduleRequest") {
            };
            unifiedRoleEligibilityScheduleRequestIdOption.IsRequired = true;
            command.AddOption(unifiedRoleEligibilityScheduleRequestIdOption);
        ...
        public Command BuildPrincipalNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item.Principal.PrincipalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRoleDefinitionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item.RoleDefinition.RoleDefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTargetScheduleNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item.TargetSchedule.TargetScheduleRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item.UnifiedRoleEligibilityScheduleRequestItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item.UnifiedRoleEligibilityScheduleRequestItemRequestBuilder.UnifiedRoleEligibilityScheduleRequestItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item.UnifiedRoleEligibilityScheduleRequestItemRequestBuilder.UnifiedRoleEligibilityScheduleRequestItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
