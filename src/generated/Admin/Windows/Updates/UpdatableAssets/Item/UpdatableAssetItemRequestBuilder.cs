...
namespace ApiSdk.Admin.Windows.Updates.UpdatableAssets.Item
{
    ...
    public class UpdatableAssetItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildMicrosoftGraphWindowsUpdatesAddMembersByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.Admin.Windows.Updates.UpdatableAssets.Item.MicrosoftGraphWindowsUpdatesAddMembersById.MicrosoftGraphWindowsUpdatesAddMembersByIdRequestBuilder(PathParameters);
        ...
        public Command BuildMicrosoftGraphWindowsUpdatesAddMembersNavCommand()
        {
            ...
            var builder = new ApiSdk.Admin.Windows.Updates.UpdatableAssets.Item.MicrosoftGraphWindowsUpdatesAddMembers.MicrosoftGraphWindowsUpdatesAddMembersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMicrosoftGraphWindowsUpdatesRemoveMembersByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.Admin.Windows.Updates.UpdatableAssets.Item.MicrosoftGraphWindowsUpdatesRemoveMembersById.MicrosoftGraphWindowsUpdatesRemoveMembersByIdRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMicrosoftGraphWindowsUpdatesRemoveMembersNavCommand()
        {
            ...
            var builder = new ApiSdk.Admin.Windows.Updates.UpdatableAssets.Item.MicrosoftGraphWindowsUpdatesRemoveMembers.MicrosoftGraphWindowsUpdatesRemoveMembersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Admin.Windows.Updates.UpdatableAssets.Item.UpdatableAssetItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Admin.Windows.Updates.UpdatableAssets.Item.UpdatableAssetItemRequestBuilder.UpdatableAssetItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Admin.Windows.Updates.UpdatableAssets.Item.UpdatableAssetItemRequestBuilder.UpdatableAssetItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
