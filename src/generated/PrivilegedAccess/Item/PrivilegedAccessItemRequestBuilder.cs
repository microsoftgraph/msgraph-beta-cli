...
using ApiSdk.Models;
using ApiSdk.PrivilegedAccess.Item.Resources;
using ApiSdk.PrivilegedAccess.Item.RoleAssignmentRequests;
using ApiSdk.PrivilegedAccess.Item.RoleAssignments;
using ApiSdk.PrivilegedAccess.Item.RoleDefinitions;
using ApiSdk.PrivilegedAccess.Item.RoleSettings;
...
namespace ApiSdk.PrivilegedAccess.Item
{
    ...
    public partial class PrivilegedAccessItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete entity from privilegedAccess";
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get entity from privilegedAccess by key";
            var privilegedAccessIdOption = new Option<string>("--privileged-access-id", description: "The unique identifier of privilegedAccess") {
            };
            privilegedAccessIdOption.IsRequired = true;
            command.AddOption(privilegedAccessIdOption);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update entity in privilegedAccess";
            var privilegedAccessIdOption = new Option<string>("--privileged-access-id", description: "The unique identifier of privilegedAccess") {
            };
            privilegedAccessIdOption.IsRequired = true;
            command.AddOption(privilegedAccessIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.PrivilegedAccess>(global::ApiSdk.Models.PrivilegedAccess.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildResourcesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.PrivilegedAccess.Item.Resources.ResourcesRequestBuilder(PathParameters);
        ...
        public Command BuildRoleAssignmentRequestsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.PrivilegedAccess.Item.RoleAssignmentRequests.RoleAssignmentRequestsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRoleAssignmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.PrivilegedAccess.Item.RoleAssignments.RoleAssignmentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRoleDefinitionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.PrivilegedAccess.Item.RoleDefinitions.RoleDefinitionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRoleSettingsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.PrivilegedAccess.Item.RoleSettings.RoleSettingsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.PrivilegedAccess.Item.PrivilegedAccessItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.PrivilegedAccess.Item.PrivilegedAccessItemRequestBuilder.PrivilegedAccessItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.PrivilegedAccess.Item.PrivilegedAccessItemRequestBuilder.PrivilegedAccessItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.PrivilegedAccess body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.PrivilegedAccess body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class PrivilegedAccessItemRequestBuilderGetQueryParameters 
        {
