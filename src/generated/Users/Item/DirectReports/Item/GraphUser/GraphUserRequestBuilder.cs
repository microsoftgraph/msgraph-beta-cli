...
using System;
namespace ApiSdk.Users.Item.DirectReports.Item.GraphUser {
    /// <summary>
    ...
    public class GraphUserRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public GraphUserRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/directReports/{directoryObject%2Did}/graph.user{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="GraphUserRequestBuilder"/> and sets the default values.
        ...
        public GraphUserRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/directReports/{directoryObject%2Did}/graph.user{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.user
