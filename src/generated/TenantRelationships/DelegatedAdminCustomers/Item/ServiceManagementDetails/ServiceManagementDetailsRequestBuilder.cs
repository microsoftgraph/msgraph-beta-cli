...
namespace ApiSdk.TenantRelationships.DelegatedAdminCustomers.Item.ServiceManagementDetails
{
    ...
    public class ServiceManagementDetailsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new DelegatedAdminServiceManagementDetailItemRequestBuilder(PathParameters);
        ...
        public Command BuildCreateCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<DelegatedAdminServiceManagementDetail>(DelegatedAdminServiceManagementDetail.CreateFromDiscriminatorValue);
                if (model is null) {
