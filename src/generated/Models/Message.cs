...
namespace ApiSdk.Models
{
    ...
    public class Message : ApiSdk.Models.OutlookItem, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.Recipient>? BccRecipients { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.Recipient> BccRecipients { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.Recipient>? CcRecipients { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.Recipient> CcRecipients { get; set; }
#endif
...
#nullable restore
        ...
        public ApiSdk.Models.InferenceClassificationType? InferenceClassification { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.InternetMessageHeader>? InternetMessageHeaders { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.InternetMessageHeader> InternetMessageHeaders { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.Mention>? Mentions { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.Mention> Mentions { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.MentionsPreview? MentionsPreview { get; set; }
#nullable restore
#else
        public ApiSdk.Models.MentionsPreview MentionsPreview { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.Recipient>? ReplyTo { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.Recipient> ReplyTo { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.ItemBody? UniqueBody { get; set; }
#nullable restore
#else
        public ApiSdk.Models.ItemBody UniqueBody { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.Message"/> and sets the default values.
        /// </summary>
        public Message() : base()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.Message"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.Message CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "bccRecipients", n => { BccRecipients = n.GetCollectionOfObjectValues<ApiSdk.Models.Recipient>(ApiSdk.Models.Recipient.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                { "ccRecipients", n => { CcRecipients = n.GetCollectionOfObjectValues<ApiSdk.Models.Recipient>(ApiSdk.Models.Recipient.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                { "inferenceClassification", n => { InferenceClassification = n.GetEnumValue<ApiSdk.Models.InferenceClassificationType>(); } },
                { "internetMessageHeaders", n => { InternetMessageHeaders = n.GetCollectionOfObjectValues<ApiSdk.Models.InternetMessageHeader>(ApiSdk.Models.InternetMessageHeader.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                { "mentions", n => { Mentions = n.GetCollectionOfObjectValues<ApiSdk.Models.Mention>(ApiSdk.Models.Mention.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                { "replyTo", n => { ReplyTo = n.GetCollectionOfObjectValues<ApiSdk.Models.Recipient>(ApiSdk.Models.Recipient.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                { "uniqueBody", n => { UniqueBody = n.GetObjectValue<ApiSdk.Models.ItemBody>(ApiSdk.Models.ItemBody.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Recipient>("bccRecipients", BccRecipients);
            writer.WriteObjectValue<ApiSdk.Models.ItemBody>("body", Body);
            writer.WriteStringValue("bodyPreview", BodyPreview);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Recipient>("ccRecipients", CcRecipients);
            ...
            writer.WriteEnumValue<ApiSdk.Models.InferenceClassificationType>("inferenceClassification", InferenceClassification);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.InternetMessageHeader>("internetMessageHeaders", InternetMessageHeaders);
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Mention>("mentions", Mentions);
            writer.WriteObjectValue<ApiSdk.Models.MentionsPreview>("mentionsPreview", MentionsPreview);
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Recipient>("replyTo", ReplyTo);
            ...
            writer.WriteObjectValue<ApiSdk.Models.ItemBody>("uniqueBody", UniqueBody);
