...
using ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.Mentions;
...
namespace ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item
{
    ...
    public partial class PostItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAttachmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.Attachments.AttachmentsRequestBuilder(PathParameters);
        ...
        public Command BuildExtensionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.Extensions.ExtensionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildForwardNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.Forward.ForwardRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildInReplyToNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.InReplyTo.InReplyToRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildMentionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.Mentions.MentionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Post>(global::ApiSdk.Models.Post.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildReplyNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.Reply.ReplyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.PostItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.PostItemRequestBuilder.PostItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.PostItemRequestBuilder.PostItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Post body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Post body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
