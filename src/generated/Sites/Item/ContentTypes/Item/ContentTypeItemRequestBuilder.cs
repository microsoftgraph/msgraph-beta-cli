...
namespace ApiSdk.Sites.Item.ContentTypes.Item
{
    ...
    public class ContentTypeItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAssociateWithHubSitesNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.ContentTypes.Item.AssociateWithHubSites.AssociateWithHubSitesRequestBuilder(PathParameters);
        ...
        public Command BuildBaseNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.ContentTypes.Item.Base.BaseRequestBuilderEscaped(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildBaseTypesNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.ContentTypes.Item.BaseTypes.BaseTypesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildColumnLinksNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.ContentTypes.Item.ColumnLinks.ColumnLinksRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildColumnPositionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.ContentTypes.Item.ColumnPositions.ColumnPositionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildColumnsNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.ContentTypes.Item.Columns.ColumnsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildCopyToDefaultContentLocationNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.ContentTypes.Item.CopyToDefaultContentLocation.CopyToDefaultContentLocationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildIsPublishedNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.ContentTypes.Item.IsPublished.IsPublishedRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPublishNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.ContentTypes.Item.Publish.PublishRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUnpublishNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.ContentTypes.Item.Unpublish.UnpublishRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Sites.Item.ContentTypes.Item.ContentTypeItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Sites.Item.ContentTypes.Item.ContentTypeItemRequestBuilder.ContentTypeItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Sites.Item.ContentTypes.Item.ContentTypeItemRequestBuilder.ContentTypeItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
