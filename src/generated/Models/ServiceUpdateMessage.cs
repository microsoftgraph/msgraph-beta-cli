...
namespace ApiSdk.Models
{
    ...
    public partial class ServiceUpdateMessage : global::ApiSdk.Models.ServiceAnnouncementBase, IParsable
...
#nullable enable
        public List<global::ApiSdk.Models.ServiceAnnouncementAttachment>? Attachments { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.ServiceAnnouncementAttachment> Attachments { get; set; }
#endif
...
#nullable restore
        ...
        public global::ApiSdk.Models.ServiceUpdateCategory? Category { get; set; }
...
#nullable restore
        ...
        public global::ApiSdk.Models.ServiceUpdateSeverity? Severity { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.ServiceUpdateMessageViewpoint? ViewPoint { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.ServiceUpdateMessageViewpoint ViewPoint { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Models.ServiceUpdateMessage"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.ServiceUpdateMessage"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.ServiceUpdateMessage CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.ServiceUpdateMessage();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "attachments", n => { Attachments = n.GetCollectionOfObjectValues<global::ApiSdk.Models.ServiceAnnouncementAttachment>(global::ApiSdk.Models.ServiceAnnouncementAttachment.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "category", n => { Category = n.GetEnumValue<global::ApiSdk.Models.ServiceUpdateCategory>(); } },
                { "hasAttachments", n => { HasAttachments = n.GetBoolValue(); } },
                { "isMajorChange", n => { IsMajorChange = n.GetBoolValue(); } },
                { "services", n => { Services = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "severity", n => { Severity = n.GetEnumValue<global::ApiSdk.Models.ServiceUpdateSeverity>(); } },
                { "tags", n => { Tags = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "viewPoint", n => { ViewPoint = n.GetObjectValue<global::ApiSdk.Models.ServiceUpdateMessageViewpoint>(global::ApiSdk.Models.ServiceUpdateMessageViewpoint.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.ServiceAnnouncementAttachment>("attachments", Attachments);
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.ServiceUpdateCategory>("category", Category);
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.ServiceUpdateSeverity>("severity", Severity);
            writer.WriteCollectionOfPrimitiveValues<string>("tags", Tags);
            writer.WriteObjectValue<global::ApiSdk.Models.ServiceUpdateMessageViewpoint>("viewPoint", ViewPoint);
        }
    }
}
