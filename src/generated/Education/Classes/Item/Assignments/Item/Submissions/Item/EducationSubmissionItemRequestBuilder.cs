...
namespace ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item
{
    ...
    public class EducationSubmissionItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildExcuseNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.Excuse.ExcuseRequestBuilder(PathParameters);
        ...
        public Command BuildOutcomesNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.Outcomes.OutcomesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildReassignNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.Reassign.ReassignRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildResourcesNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.Resources.ResourcesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildReturnNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.Return.ReturnRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSetUpResourcesFolderNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.SetUpResourcesFolder.SetUpResourcesFolderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSubmitNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.Submit.SubmitRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSubmittedResourcesNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.SubmittedResources.SubmittedResourcesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildUnsubmitNavCommand()
        {
            ...
            var builder = new ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.Unsubmit.UnsubmitRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.EducationSubmissionItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.EducationSubmissionItemRequestBuilder.EducationSubmissionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.EducationSubmissionItemRequestBuilder.EducationSubmissionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
