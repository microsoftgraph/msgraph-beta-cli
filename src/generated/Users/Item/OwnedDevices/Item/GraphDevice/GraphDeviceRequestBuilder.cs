...
using System;
namespace ApiSdk.Users.Item.OwnedDevices.Item.GraphDevice {
    /// <summary>
    ...
    public class GraphDeviceRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public GraphDeviceRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/ownedDevices/{directoryObject%2Did}/graph.device{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="GraphDeviceRequestBuilder"/> and sets the default values.
        ...
        public GraphDeviceRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/ownedDevices/{directoryObject%2Did}/graph.device{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.device
