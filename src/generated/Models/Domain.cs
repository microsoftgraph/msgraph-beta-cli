...
namespace ApiSdk.Models
{
    ...
    public partial class Domain : global::ApiSdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.DirectoryObject>? DomainNameReferences { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.DirectoryObject> DomainNameReferences { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.InternalDomainFederation>? FederationConfiguration { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.InternalDomainFederation> FederationConfiguration { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.Domain? RootDomain { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.Domain RootDomain { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.DomainDnsRecord>? ServiceConfigurationRecords { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.DomainDnsRecord> ServiceConfigurationRecords { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.SharedEmailDomainInvitation>? SharedEmailDomainInvitations { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.SharedEmailDomainInvitation> SharedEmailDomainInvitations { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.DomainState? State { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.DomainState State { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.DomainDnsRecord>? VerificationDnsRecords { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.DomainDnsRecord> VerificationDnsRecords { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.Domain"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.Domain CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.Domain();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "domainNameReferences", n => { DomainNameReferences = n.GetCollectionOfObjectValues<global::ApiSdk.Models.DirectoryObject>(global::ApiSdk.Models.DirectoryObject.CreateFromDiscriminatorValue)?.AsList(); } },
                { "federationConfiguration", n => { FederationConfiguration = n.GetCollectionOfObjectValues<global::ApiSdk.Models.InternalDomainFederation>(global::ApiSdk.Models.InternalDomainFederation.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "rootDomain", n => { RootDomain = n.GetObjectValue<global::ApiSdk.Models.Domain>(global::ApiSdk.Models.Domain.CreateFromDiscriminatorValue); } },
                { "serviceConfigurationRecords", n => { ServiceConfigurationRecords = n.GetCollectionOfObjectValues<global::ApiSdk.Models.DomainDnsRecord>(global::ApiSdk.Models.DomainDnsRecord.CreateFromDiscriminatorValue)?.AsList(); } },
                { "sharedEmailDomainInvitations", n => { SharedEmailDomainInvitations = n.GetCollectionOfObjectValues<global::ApiSdk.Models.SharedEmailDomainInvitation>(global::ApiSdk.Models.SharedEmailDomainInvitation.CreateFromDiscriminatorValue)?.AsList(); } },
                { "state", n => { State = n.GetObjectValue<global::ApiSdk.Models.DomainState>(global::ApiSdk.Models.DomainState.CreateFromDiscriminatorValue); } },
                { "supportedServices", n => { SupportedServices = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "verificationDnsRecords", n => { VerificationDnsRecords = n.GetCollectionOfObjectValues<global::ApiSdk.Models.DomainDnsRecord>(global::ApiSdk.Models.DomainDnsRecord.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.DirectoryObject>("domainNameReferences", DomainNameReferences);
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.InternalDomainFederation>("federationConfiguration", FederationConfiguration);
            ...
            writer.WriteObjectValue<global::ApiSdk.Models.Domain>("rootDomain", RootDomain);
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.DomainDnsRecord>("serviceConfigurationRecords", ServiceConfigurationRecords);
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.SharedEmailDomainInvitation>("sharedEmailDomainInvitations", SharedEmailDomainInvitations);
            writer.WriteObjectValue<global::ApiSdk.Models.DomainState>("state", State);
            writer.WriteCollectionOfPrimitiveValues<string>("supportedServices", SupportedServices);
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.DomainDnsRecord>("verificationDnsRecords", VerificationDnsRecords);
        }
    }
}
