...
using ApiSdk.Models;
using ApiSdk.Shares.Item.List.Items.Item.Activities.Item.DriveItem.Content;
using ApiSdk.Shares.Item.List.Items.Item.Activities.Item.DriveItem.ContentStream;
...
using System;
namespace ApiSdk.Shares.Item.List.Items.Item.Activities.Item.DriveItem
{
    /// <summary>
    ...
    public partial class DriveItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildContentNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.Items.Item.Activities.Item.DriveItem.Content.ContentRequestBuilder(PathParameters);
        ...
        public Command BuildContentStreamNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the sharedDriveItem entity.";
            var builder = new global::ApiSdk.Shares.Item.List.Items.Item.Activities.Item.DriveItem.ContentStream.ContentStreamRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get driveItem from shares";
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Shares.Item.List.Items.Item.Activities.Item.DriveItem.DriveItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Shares.Item.List.Items.Item.Activities.Item.DriveItem.DriveItemRequestBuilder.DriveItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Shares.Item.List.Items.Item.Activities.Item.DriveItem.DriveItemRequestBuilder.DriveItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
