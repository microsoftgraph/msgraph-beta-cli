...
namespace ApiSdk.External.Connections.Item
{
    ...
    public partial class ExternalConnectionItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete an externalConnection.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/externalconnectors-externalconnection-delete?view=graph-rest-beta";
        ...
        public Command BuildGroupsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.External.Connections.Item.Groups.GroupsRequestBuilder(PathParameters);
        ...
        public Command BuildItemsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.External.Connections.Item.Items.ItemsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildOperationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.External.Connections.Item.Operations.OperationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.ExternalConnectors.ExternalConnection>(global::ApiSdk.Models.ExternalConnectors.ExternalConnection.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildQuotaNavCommand()
        {
            ...
            var builder = new global::ApiSdk.External.Connections.Item.Quota.QuotaRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSchemaNavCommand()
        {
            ...
            var builder = new global::ApiSdk.External.Connections.Item.Schema.SchemaRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
            foreach (var cmd in execCommands)
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.External.Connections.Item.ExternalConnectionItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.External.Connections.Item.ExternalConnectionItemRequestBuilder.ExternalConnectionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.External.Connections.Item.ExternalConnectionItemRequestBuilder.ExternalConnectionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.ExternalConnectors.ExternalConnection body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.ExternalConnectors.ExternalConnection body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ExternalConnectionItemRequestBuilderGetQueryParameters 
        {
