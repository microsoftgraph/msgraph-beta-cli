...
namespace ApiSdk.Users.Item.Insights.Shared.Item
{
    ...
    public class SharedInsightItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildLastSharedMethodNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.LastSharedMethodRequestBuilder(PathParameters);
        ...
        public Command BuildResourceNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Insights.Shared.Item.Resource.ResourceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Users.Item.Insights.Shared.Item.SharedInsightItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.Insights.Shared.Item.SharedInsightItemRequestBuilder.SharedInsightItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.Insights.Shared.Item.SharedInsightItemRequestBuilder.SharedInsightItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.SharedInsight body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.SharedInsight body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
