    ...
    public partial class AddCopyFromContentTypeHubRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Shares.Item.List.ContentTypes.AddCopyFromContentTypeHub.AddCopyFromContentTypeHubPostRequestBody>(global::ApiSdk.Shares.Item.List.ContentTypes.AddCopyFromContentTypeHub.AddCopyFromContentTypeHubPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Shares.Item.List.ContentTypes.AddCopyFromContentTypeHub.AddCopyFromContentTypeHubRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        public AddCopyFromContentTypeHubRequestBuilder(string rawUrl) : base("{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/addCopyFromContentTypeHub", rawUrl)
        {
        }
        /// <summary>
        /// Add or sync a copy of a published content type from the content type hub to a target site or a list. This method is part of the content type publishing changes to optimize the syncing of published content types to sites and lists, effectively switching from a &apos;push everywhere&apos; to &apos;pull as needed&apos; approach. The method allows users to pull content types directly from the content type hub to a site or list. For more information, see getCompatibleHubContentTypes and the blog post Syntex Product Updates – August 2021.
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Shares.Item.List.ContentTypes.AddCopyFromContentTypeHub.AddCopyFromContentTypeHubPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Shares.Item.List.ContentTypes.AddCopyFromContentTypeHub.AddCopyFromContentTypeHubPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
