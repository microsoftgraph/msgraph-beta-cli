...
namespace ApiSdk.Users.Item.Profile.Languages {
    ...
    public class LanguagesRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new LanguageProficiencyItemRequestBuilder(PathParameters);
        ...
        public Command BuildCreateCommand()
        {
            ...
            command.Description = "Use this API to create a new languageProficiency object in a user's profile.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/profile-post-languages?view=graph-rest-1.0";
        ...
        public Command BuildListCommand()
        {
            ...
            command.Description = "Retrieve a list of languageProficiency objects from a user's profile.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/profile-list-languages?view=graph-rest-1.0";
            var userIdOption = new Option<string>("--user-id", description: "The unique identifier of user. Use 'me' for the currently signed in user.") {
            };
            userIdOption.IsRequired = true;
            command.AddOption(userIdOption);
