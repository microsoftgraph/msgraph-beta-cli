...
namespace ApiSdk.App.Calls.Item.Transfer
{
    ...
    public partial class TransferRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.App.Calls.Item.Transfer.TransferPostRequestBody>(global::ApiSdk.App.Calls.Item.Transfer.TransferPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.App.Calls.Item.Transfer.TransferRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public TransferRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/app/calls/{call%2Did}/transfer", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.App.Calls.Item.Transfer.TransferRequestBuilder"/> and sets the default values.
        ...
        public TransferRequestBuilder(string rawUrl) : base("{+baseurl}/app/calls/{call%2Did}/transfer", rawUrl)
        {
        }
        /// <summary>
        /// Transfer an active peer-to-peer call or group call. A consultative transfer means that the transferor can inform the person they want to transfer the call to (the transferee), before the transfer is made. This is opposed to transfering the call directly.
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.App.Calls.Item.Transfer.TransferPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.App.Calls.Item.Transfer.TransferPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
