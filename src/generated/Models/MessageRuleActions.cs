...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.Recipient>? ForwardAsAttachmentTo { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.Recipient> ForwardAsAttachmentTo { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.Recipient>? ForwardTo { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.Recipient> ForwardTo { get; set; }
#endif
        ...
        public global::ApiSdk.Models.Importance? MarkImportance { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.Recipient>? RedirectTo { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.Recipient> RedirectTo { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Models.MessageRuleActions"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.MessageRuleActions"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ApiSdk.Models.MessageRuleActions CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.MessageRuleActions();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "forwardAsAttachmentTo", n => { ForwardAsAttachmentTo = n.GetCollectionOfObjectValues<global::ApiSdk.Models.Recipient>(global::ApiSdk.Models.Recipient.CreateFromDiscriminatorValue)?.AsList(); } },
                { "forwardTo", n => { ForwardTo = n.GetCollectionOfObjectValues<global::ApiSdk.Models.Recipient>(global::ApiSdk.Models.Recipient.CreateFromDiscriminatorValue)?.AsList(); } },
                { "markAsRead", n => { MarkAsRead = n.GetBoolValue(); } },
                { "markImportance", n => { MarkImportance = n.GetEnumValue<global::ApiSdk.Models.Importance>(); } },
                { "moveToFolder", n => { MoveToFolder = n.GetStringValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "permanentDelete", n => { PermanentDelete = n.GetBoolValue(); } },
                { "redirectTo", n => { RedirectTo = n.GetCollectionOfObjectValues<global::ApiSdk.Models.Recipient>(global::ApiSdk.Models.Recipient.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.Recipient>("forwardAsAttachmentTo", ForwardAsAttachmentTo);
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.Recipient>("forwardTo", ForwardTo);
            writer.WriteBoolValue("markAsRead", MarkAsRead);
            writer.WriteEnumValue<global::ApiSdk.Models.Importance>("markImportance", MarkImportance);
            writer.WriteStringValue("moveToFolder", MoveToFolder);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteBoolValue("permanentDelete", PermanentDelete);
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.Recipient>("redirectTo", RedirectTo);
