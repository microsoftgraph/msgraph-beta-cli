...
namespace ApiSdk.Admin.ServiceAnnouncement.Messages
{
    ...
    public partial class MessagesRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildArchiveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Admin.ServiceAnnouncement.Messages.Archive.ArchiveRequestBuilder(PathParameters);
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new global::ApiSdk.Admin.ServiceAnnouncement.Messages.Item.ServiceUpdateMessageItemRequestBuilder(PathParameters);
        ...
        public Command BuildCountNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Admin.ServiceAnnouncement.Messages.Count.CountRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCreateCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.ServiceUpdateMessage>(global::ApiSdk.Models.ServiceUpdateMessage.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildFavoriteNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Admin.ServiceAnnouncement.Messages.Favorite.FavoriteRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
...
#nullable restore
        ...
        public Command BuildMarkReadNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Admin.ServiceAnnouncement.Messages.MarkRead.MarkReadRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMarkUnreadNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Admin.ServiceAnnouncement.Messages.MarkUnread.MarkUnreadRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUnarchiveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Admin.ServiceAnnouncement.Messages.Unarchive.UnarchiveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Admin.ServiceAnnouncement.Messages.MessagesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Admin.ServiceAnnouncement.Messages.MessagesRequestBuilder.MessagesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Admin.ServiceAnnouncement.Messages.MessagesRequestBuilder.MessagesRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Models.ServiceUpdateMessage body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Models.ServiceUpdateMessage body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
