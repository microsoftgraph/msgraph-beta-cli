...
namespace ApiSdk.NetworkAccess.Settings.ForwardingOptions
{
    ...
    public partial class ForwardingOptionsRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Networkaccess.ForwardingOptions>(global::ApiSdk.Models.Networkaccess.ForwardingOptions.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.NetworkAccess.Settings.ForwardingOptions.ForwardingOptionsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.NetworkAccess.Settings.ForwardingOptions.ForwardingOptionsRequestBuilder.ForwardingOptionsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.NetworkAccess.Settings.ForwardingOptions.ForwardingOptionsRequestBuilder.ForwardingOptionsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Networkaccess.ForwardingOptions body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Networkaccess.ForwardingOptions body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
