    ...
    public class SetOrderRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Identity.B2xUserFlows.Item.UserAttributeAssignments.SetOrder.SetOrderPostRequestBody>(ApiSdk.Identity.B2xUserFlows.Item.UserAttributeAssignments.SetOrder.SetOrderPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Identity.B2xUserFlows.Item.UserAttributeAssignments.SetOrder.SetOrderRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Identity.B2xUserFlows.Item.UserAttributeAssignments.SetOrder.SetOrderPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Identity.B2xUserFlows.Item.UserAttributeAssignments.SetOrder.SetOrderPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
