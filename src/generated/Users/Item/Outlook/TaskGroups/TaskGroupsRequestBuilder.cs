...
namespace ApiSdk.Users.Item.Outlook.TaskGroups {
    ...
    public class TaskGroupsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public TaskGroupsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/outlook/taskGroups{?%24count,%24filter,%24orderby,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="TaskGroupsRequestBuilder"/> and sets the default values.
        ...
        public TaskGroupsRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/outlook/taskGroups{?%24count,%24filter,%24orderby,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get taskGroups from users
