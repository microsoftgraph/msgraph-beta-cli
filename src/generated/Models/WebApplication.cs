...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.ImplicitGrantSettings? ImplicitGrantSettings { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.ImplicitGrantSettings ImplicitGrantSettings { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.RedirectUriSettings>? RedirectUriSettings { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.RedirectUriSettings> RedirectUriSettings { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Models.WebApplication"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.WebApplication"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ApiSdk.Models.WebApplication CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.WebApplication();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "implicitGrantSettings", n => { ImplicitGrantSettings = n.GetObjectValue<global::ApiSdk.Models.ImplicitGrantSettings>(global::ApiSdk.Models.ImplicitGrantSettings.CreateFromDiscriminatorValue); } },
                { "logoutUrl", n => { LogoutUrl = n.GetStringValue(); } },
                { "oauth2AllowImplicitFlow", n => { Oauth2AllowImplicitFlow = n.GetBoolValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "redirectUriSettings", n => { RedirectUriSettings = n.GetCollectionOfObjectValues<global::ApiSdk.Models.RedirectUriSettings>(global::ApiSdk.Models.RedirectUriSettings.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::ApiSdk.Models.ImplicitGrantSettings>("implicitGrantSettings", ImplicitGrantSettings);
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.RedirectUriSettings>("redirectUriSettings", RedirectUriSettings);
