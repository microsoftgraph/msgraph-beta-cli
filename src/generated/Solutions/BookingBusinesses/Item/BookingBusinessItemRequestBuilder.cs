...
namespace ApiSdk.Solutions.BookingBusinesses.Item
{
    ...
    public partial class BookingBusinessItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAppointmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Solutions.BookingBusinesses.Item.Appointments.AppointmentsRequestBuilder(PathParameters);
        ...
        public Command BuildCalendarViewNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Solutions.BookingBusinesses.Item.CalendarView.CalendarViewRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildCustomersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Solutions.BookingBusinesses.Item.Customers.CustomersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildCustomQuestionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Solutions.BookingBusinesses.Item.CustomQuestions.CustomQuestionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/bookingbusiness-delete?view=graph-rest-beta" />
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "A collection of businesses in Microsoft Bookings. Read-only. Nullable.";
            var bookingBusinessIdOption = new Option<string>("--booking-business-id", description: "The unique identifier of bookingBusiness") {
            };
            bookingBusinessIdOption.IsRequired = true;
            command.AddOption(bookingBusinessIdOption);
        ...
        public Command BuildGetStaffAvailabilityNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Solutions.BookingBusinesses.Item.GetStaffAvailability.GetStaffAvailabilityRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildPublishNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Solutions.BookingBusinesses.Item.Publish.PublishRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildServicesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Solutions.BookingBusinesses.Item.Services.ServicesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildStaffMembersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Solutions.BookingBusinesses.Item.StaffMembers.StaffMembersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildUnpublishNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Solutions.BookingBusinesses.Item.Unpublish.UnpublishRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Solutions.BookingBusinesses.Item.BookingBusinessItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Solutions.BookingBusinesses.Item.BookingBusinessItemRequestBuilder.BookingBusinessItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Solutions.BookingBusinesses.Item.BookingBusinessItemRequestBuilder.BookingBusinessItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
