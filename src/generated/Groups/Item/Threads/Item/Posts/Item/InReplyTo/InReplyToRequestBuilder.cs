...
using ApiSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo.Mentions;
...
namespace ApiSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo
{
    ...
    public partial class InReplyToRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAttachmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo.Attachments.AttachmentsRequestBuilder(PathParameters);
        ...
        public Command BuildExtensionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo.Extensions.ExtensionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildForwardNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo.Forward.ForwardRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildMentionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo.Mentions.MentionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildReplyNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo.Reply.ReplyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo.InReplyToRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo.InReplyToRequestBuilder.InReplyToRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo.InReplyToRequestBuilder.InReplyToRequestBuilderGetQueryParameters>> requestConfiguration = default)
