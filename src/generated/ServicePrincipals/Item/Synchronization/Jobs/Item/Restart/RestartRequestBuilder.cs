    ...
    public class RestartRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Restart.RestartPostRequestBody>(ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Restart.RestartPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Restart.RestartRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Restart.RestartPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Restart.RestartPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
