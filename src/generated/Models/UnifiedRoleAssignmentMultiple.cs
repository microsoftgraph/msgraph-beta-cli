...
namespace ApiSdk.Models
{
    ...
    public partial class UnifiedRoleAssignmentMultiple : global::ApiSdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.AppScope>? AppScopes { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.AppScope> AppScopes { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.DirectoryObject>? DirectoryScopes { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.DirectoryObject> DirectoryScopes { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.DirectoryObject>? Principals { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.DirectoryObject> Principals { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.UnifiedRoleAssignmentMultiple"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.UnifiedRoleAssignmentMultiple CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.UnifiedRoleAssignmentMultiple();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "appScopes", n => { AppScopes = n.GetCollectionOfObjectValues<global::ApiSdk.Models.AppScope>(global::ApiSdk.Models.AppScope.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "directoryScopes", n => { DirectoryScopes = n.GetCollectionOfObjectValues<global::ApiSdk.Models.DirectoryObject>(global::ApiSdk.Models.DirectoryObject.CreateFromDiscriminatorValue)?.AsList(); } },
                { "displayName", n => { DisplayName = n.GetStringValue(); } },
                { "principalIds", n => { PrincipalIds = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "principals", n => { Principals = n.GetCollectionOfObjectValues<global::ApiSdk.Models.DirectoryObject>(global::ApiSdk.Models.DirectoryObject.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.AppScope>("appScopes", AppScopes);
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.DirectoryObject>("directoryScopes", DirectoryScopes);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteCollectionOfPrimitiveValues<string>("principalIds", PrincipalIds);
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.DirectoryObject>("principals", Principals);
