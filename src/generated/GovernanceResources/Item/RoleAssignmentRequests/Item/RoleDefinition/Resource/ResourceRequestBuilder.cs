...
using System;
namespace ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.RoleDefinition.Resource
{
    /// <summary>
    ...
    public partial class ResourceRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.RoleDefinition.Resource.ResourceRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public ResourceRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/governanceResources/{governanceResource%2Did}/roleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}/roleDefinition/resource{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.RoleDefinition.Resource.ResourceRequestBuilder"/> and sets the default values.
        ...
        public ResourceRequestBuilder(string rawUrl) : base("{+baseurl}/governanceResources/{governanceResource%2Did}/roleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}/roleDefinition/resource{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Read-only. The associated resource for the role definition.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.RoleDefinition.Resource.ResourceRequestBuilder.ResourceRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.RoleDefinition.Resource.ResourceRequestBuilder.ResourceRequestBuilderGetQueryParameters>> requestConfiguration = default)
