    ...
    public class ParseExpressionRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Applications.Item.Synchronization.Templates.Item.Schema.ParseExpression.ParseExpressionPostRequestBody>(ApiSdk.Applications.Item.Synchronization.Templates.Item.Schema.ParseExpression.ParseExpressionPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Applications.Item.Synchronization.Templates.Item.Schema.ParseExpression.ParseExpressionRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Applications.Item.Synchronization.Templates.Item.Schema.ParseExpression.ParseExpressionPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Applications.Item.Synchronization.Templates.Item.Schema.ParseExpression.ParseExpressionPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
