...
using ApiSdk.Applications.Count;
using ApiSdk.Applications.Delta;
using ApiSdk.Applications.GetByIds;
using ApiSdk.Applications.GetUserOwnedObjects;
...
namespace ApiSdk.Applications
{
    ...
    public partial class ApplicationsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.ApplicationItemRequestBuilder(PathParameters);
            ...
            commands.Add(builder.BuildConnectorGroupNavCommand());
        ...
        public Command BuildCountNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Count.CountRequestBuilder(PathParameters);
        ...
        public Command BuildDeltaNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Delta.DeltaRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetByIdsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.GetByIds.GetByIdsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGetUserOwnedObjectsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.GetUserOwnedObjects.GetUserOwnedObjectsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
...
#nullable restore
        ...
        public Command BuildValidatePropertiesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.ValidateProperties.ValidatePropertiesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Applications.ApplicationsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Applications.ApplicationsRequestBuilder.ApplicationsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Applications.ApplicationsRequestBuilder.ApplicationsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Models.Application body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Models.Application body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
