...
namespace ApiSdk.TenantRelationships.ManagedTenants.ManagementTemplates.Item {
    ...
    public class ManagementTemplateItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Read the properties and relationships of a managementTemplate object.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/managedtenants-managementtemplate-get?view=graph-rest-1.0";
            var managementTemplateIdOption = new Option<string>("--management-template-id", description: "The unique identifier of managementTemplate") {
            };
            managementTemplateIdOption.IsRequired = true;
            command.AddOption(managementTemplateIdOption);
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/tenantRelationships/managedTenants/managementTemplates/{managementTemplate%2Did}", PathParameters);
...
#nullable restore
        ...
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.ManagedTenants.ManagementTemplate body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.PATCH, "{+baseurl}/tenantRelationships/managedTenants/managementTemplates/{managementTemplate%2Did}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
