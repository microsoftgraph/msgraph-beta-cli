...
using ApiSdk.Solutions.BackupRestore.OneDriveForBusinessRestoreSessions.Item.DriveRestoreArtifactsBulkAdditionRequests;
...
namespace ApiSdk.Solutions.BackupRestore.OneDriveForBusinessRestoreSessions.Item
{
    ...
    public partial class OneDriveForBusinessRestoreSessionItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildDriveRestoreArtifactsBulkAdditionRequestsNavCommand()
        {
            var command = new Command("drive-restore-artifacts-bulk-addition-requests");
            command.Description = "Provides operations to manage the driveRestoreArtifactsBulkAdditionRequests property of the microsoft.graph.oneDriveForBusinessRestoreSession entity.";
            var builder = new global::ApiSdk.Solutions.BackupRestore.OneDriveForBusinessRestoreSessions.Item.DriveRestoreArtifactsBulkAdditionRequests.DriveRestoreArtifactsBulkAdditionRequestsRequestBuilder(PathParameters);
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/onedriveforbusinessrestoresession-update?view=graph-rest-beta" />
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
