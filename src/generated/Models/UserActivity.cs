...
namespace ApiSdk.Models
{
    ...
    public partial class UserActivity : global::ApiSdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.ActivityHistoryItem>? HistoryItems { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.ActivityHistoryItem> HistoryItems { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.VisualInfo? VisualElements { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.VisualInfo VisualElements { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.UserActivity"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.UserActivity CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.UserActivity();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "historyItems", n => { HistoryItems = n.GetCollectionOfObjectValues<global::ApiSdk.Models.ActivityHistoryItem>(global::ApiSdk.Models.ActivityHistoryItem.CreateFromDiscriminatorValue)?.AsList(); } },
                { "lastModifiedDateTime", n => { LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                { "status", n => { Status = n.GetEnumValue<global::ApiSdk.Models.Status>(); } },
                { "userTimezone", n => { UserTimezone = n.GetStringValue(); } },
                { "visualElements", n => { VisualElements = n.GetObjectValue<global::ApiSdk.Models.VisualInfo>(global::ApiSdk.Models.VisualInfo.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.ActivityHistoryItem>("historyItems", HistoryItems);
            ...
            writer.WriteObjectValue<global::ApiSdk.Models.VisualInfo>("visualElements", VisualElements);
        }
    }
}
