...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.AutoLabeling"/> and sets the default values.
        /// </summary>
        public AutoLabeling()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.AutoLabeling"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.AutoLabeling CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.AutoLabeling();
        }
        /// <summary>
