// <auto-generated/>
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp.ContentVersions.Item.Files.Item.Commit;
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp.ContentVersions.Item.Files.Item.RenewUpload;
...
using System;
namespace ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp.ContentVersions.Item.Files.Item
{
    /// <summary>
    ...
    public class MobileAppContentFileItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCommitNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp.ContentVersions.Item.Files.Item.Commit.CommitRequestBuilder(PathParameters);
        ...
        public Command BuildRenewUploadNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp.ContentVersions.Item.Files.Item.RenewUpload.RenewUploadRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp.ContentVersions.Item.Files.Item.MobileAppContentFileItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public MobileAppContentFileItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.macOSPkgApp/contentVersions/{mobileAppContent%2Did}/files/{mobileAppContentFile%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp.ContentVersions.Item.Files.Item.MobileAppContentFileItemRequestBuilder"/> and sets the default values.
        ...
        public MobileAppContentFileItemRequestBuilder(string rawUrl) : base("{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.macOSPkgApp/contentVersions/{mobileAppContent%2Did}/files/{mobileAppContentFile%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property files for deviceAppManagement
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp.ContentVersions.Item.Files.Item.MobileAppContentFileItemRequestBuilder.MobileAppContentFileItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp.ContentVersions.Item.Files.Item.MobileAppContentFileItemRequestBuilder.MobileAppContentFileItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.MobileAppContentFile body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.MobileAppContentFile body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
