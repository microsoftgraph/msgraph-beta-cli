...
namespace ApiSdk.Users.Item.Planner.Tasks.Item.Details {
    ...
    public class DetailsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public DetailsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/planner/tasks/{plannerTask%2Did}/details{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="DetailsRequestBuilder"/> and sets the default values.
        ...
        public DetailsRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/planner/tasks/{plannerTask%2Did}/details{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property details for users
