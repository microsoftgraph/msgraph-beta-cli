...
namespace ApiSdk.Models.Security
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public ApiSdk.Models.Security.AssignmentMethod? AssignmentMethod { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.Security.KeyValuePair>? ExtendedProperties { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.Security.KeyValuePair> ExtendedProperties { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.Security.LabelingOptions"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.Security.LabelingOptions"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.Security.LabelingOptions CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.Security.LabelingOptions();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "extendedProperties", n => { ExtendedProperties = n.GetCollectionOfObjectValues<ApiSdk.Models.Security.KeyValuePair>(ApiSdk.Models.Security.KeyValuePair.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Security.KeyValuePair>("extendedProperties", ExtendedProperties);
