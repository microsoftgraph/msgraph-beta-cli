...
namespace ApiSdk.TermStore.Sets.Item
{
    ...
    public class SetItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildChildrenNavCommand()
        {
            ...
            var builder = new ApiSdk.TermStore.Sets.Item.Children.ChildrenRequestBuilder(PathParameters);
        ...
        public Command BuildParentGroupNavCommand()
        {
            ...
            var builder = new ApiSdk.TermStore.Sets.Item.ParentGroup.ParentGroupRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildRelationsNavCommand()
        {
            ...
            var builder = new ApiSdk.TermStore.Sets.Item.Relations.RelationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildTermsNavCommand()
        {
            ...
            var builder = new ApiSdk.TermStore.Sets.Item.Terms.TermsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.TermStore.Sets.Item.SetItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.TermStore.Sets.Item.SetItemRequestBuilder.SetItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.TermStore.Sets.Item.SetItemRequestBuilder.SetItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
