...
using ApiSdk.IdentityGovernance.PrivilegedAccess.Group.AssignmentSchedules.Item.ActivatedUsing;
using ApiSdk.IdentityGovernance.PrivilegedAccess.Group.AssignmentSchedules.Item.Group;
using ApiSdk.IdentityGovernance.PrivilegedAccess.Group.AssignmentSchedules.Item.Principal;
...
namespace ApiSdk.IdentityGovernance.PrivilegedAccess.Group.AssignmentSchedules.Item
{
    ...
    public partial class PrivilegedAccessGroupAssignmentScheduleItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildActivatedUsingNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.PrivilegedAccess.Group.AssignmentSchedules.Item.ActivatedUsing.ActivatedUsingRequestBuilder(PathParameters);
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property assignmentSchedules for identityGovernance";
            ...
            command.AddOption(privilegedAccessGroupAssignmentScheduleIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                var privilegedAccessGroupAssignmentScheduleId = invocationContext.ParseResult.GetValueForOption(privilegedAccessGroupAssignmentScheduleIdOption);
                var ifMatch = invocationContext.ParseResult.GetValueForOption(ifMatchOption);
                var cancellationToken = invocationContext.GetCancellationToken();
                var reqAdapter = invocationContext.GetRequestAdapter();
                var requestInfo = ToDeleteRequestInformation(q => {
                });
                if (privilegedAccessGroupAssignmentScheduleId is not null) requestInfo.PathParameters.Add("privilegedAccessGroupAssignmentSchedule%2Did", privilegedAccessGroupAssignmentScheduleId);
        ...
        public Command BuildGroupNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the group property of the microsoft.graph.privilegedAccessGroupAssignmentSchedule entity.";
            var builder = new global::ApiSdk.IdentityGovernance.PrivilegedAccess.Group.AssignmentSchedules.Item.Group.GroupRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property assignmentSchedules in identityGovernance";
            var privilegedAccessGroupAssignmentScheduleIdOption = new Option<string>("--privileged-access-group-assignment-schedule-id", description: "The unique identifier of privilegedAccessGroupAssignmentSchedule") {
            };
            privilegedAccessGroupAssignmentScheduleIdOption.IsRequired = true;
            command.AddOption(privilegedAccessGroupAssignmentScheduleIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.PrivilegedAccessGroupAssignmentSchedule>(global::ApiSdk.Models.PrivilegedAccessGroupAssignmentSchedule.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPrincipalNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.PrivilegedAccess.Group.AssignmentSchedules.Item.Principal.PrincipalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.IdentityGovernance.PrivilegedAccess.Group.AssignmentSchedules.Item.PrivilegedAccessGroupAssignmentScheduleItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.IdentityGovernance.PrivilegedAccess.Group.AssignmentSchedules.Item.PrivilegedAccessGroupAssignmentScheduleItemRequestBuilder.PrivilegedAccessGroupAssignmentScheduleItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.IdentityGovernance.PrivilegedAccess.Group.AssignmentSchedules.Item.PrivilegedAccessGroupAssignmentScheduleItemRequestBuilder.PrivilegedAccessGroupAssignmentScheduleItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.PrivilegedAccessGroupAssignmentSchedule body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.PrivilegedAccessGroupAssignmentSchedule body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
