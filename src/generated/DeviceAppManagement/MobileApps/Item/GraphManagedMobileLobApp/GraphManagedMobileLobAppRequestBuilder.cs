...
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphManagedMobileLobApp.Assignments;
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphManagedMobileLobApp.Categories;
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphManagedMobileLobApp.ContentVersions;
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphManagedMobileLobApp.Relationships;
...
using System;
namespace ApiSdk.DeviceAppManagement.MobileApps.Item.GraphManagedMobileLobApp
{
    /// <summary>
    /// Casts the previous resource to managedMobileLobApp.
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class GraphManagedMobileLobAppRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildAssignmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphManagedMobileLobApp.Assignments.AssignmentsRequestBuilder(PathParameters);
        ...
        public Command BuildCategoriesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphManagedMobileLobApp.Categories.CategoriesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildContentVersionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphManagedMobileLobApp.ContentVersions.ContentVersionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRelationshipsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphManagedMobileLobApp.Relationships.RelationshipsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphManagedMobileLobApp.GraphManagedMobileLobAppRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphManagedMobileLobApp.GraphManagedMobileLobAppRequestBuilder.GraphManagedMobileLobAppRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphManagedMobileLobApp.GraphManagedMobileLobAppRequestBuilder.GraphManagedMobileLobAppRequestBuilderGetQueryParameters>> requestConfiguration = default)
