...
namespace ApiSdk.Teamwork.Devices.Item.Configuration
{
    ...
    public partial class ConfigurationRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property configuration for teamwork";
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property configuration in teamwork";
            var teamworkDeviceIdOption = new Option<string>("--teamwork-device-id", description: "The unique identifier of teamworkDevice") {
            };
            teamworkDeviceIdOption.IsRequired = true;
            command.AddOption(teamworkDeviceIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.TeamworkDeviceConfiguration>(global::ApiSdk.Models.TeamworkDeviceConfiguration.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Teamwork.Devices.Item.Configuration.ConfigurationRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public ConfigurationRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/teamwork/devices/{teamworkDevice%2Did}/configuration{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Teamwork.Devices.Item.Configuration.ConfigurationRequestBuilder"/> and sets the default values.
        ...
        public ConfigurationRequestBuilder(string rawUrl) : base("{+baseurl}/teamwork/devices/{teamworkDevice%2Did}/configuration{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property configuration for teamwork
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Teamwork.Devices.Item.Configuration.ConfigurationRequestBuilder.ConfigurationRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Teamwork.Devices.Item.Configuration.ConfigurationRequestBuilder.ConfigurationRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.TeamworkDeviceConfiguration body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.TeamworkDeviceConfiguration body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
