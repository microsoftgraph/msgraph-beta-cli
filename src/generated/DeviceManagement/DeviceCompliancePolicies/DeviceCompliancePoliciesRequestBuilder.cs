using ApiSdk.DeviceManagement.DeviceCompliancePolicies.Count;
using ApiSdk.DeviceManagement.DeviceCompliancePolicies.Item;
...
namespace ApiSdk.DeviceManagement.DeviceCompliancePolicies {
    ...
    public class DeviceCompliancePoliciesRequestBuilder : BaseCliRequestBuilder {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand() {
            ...
            commands.Add(builder.BuildScheduleActionsForRulesNavCommand());
            commands.Add(builder.BuildScheduledActionsForRuleNavCommand());
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create a new windows10CompliancePolicy object.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/intune-deviceconfig-windows10compliancepolicy-create?view=graph-rest-1.0";
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/intune-deviceconfig-androidcompliancepolicy-list?view=graph-rest-1.0" />
        /// </summary>
        public Command BuildListCommand() {
            var command = new Command("list");
            command.Description = "List properties and relationships of the androidCompliancePolicy objects.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/intune-deviceconfig-androidcompliancepolicy-list?view=graph-rest-1.0";
        ...
        public DeviceCompliancePoliciesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceManagement/deviceCompliancePolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// List properties and relationships of the androidCompliancePolicy objects.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<DeviceCompliancePoliciesRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<DeviceCompliancePoliciesRequestBuilderGetQueryParameters>();
