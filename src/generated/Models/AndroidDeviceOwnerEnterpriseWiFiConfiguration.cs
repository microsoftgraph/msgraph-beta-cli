...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class AndroidDeviceOwnerEnterpriseWiFiConfiguration : ApiSdk.Models.AndroidDeviceOwnerWiFiConfiguration, IParsable
    {
...
#nullable restore
        ...
        public ApiSdk.Models.AndroidEapType? EapType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.AndroidDeviceOwnerCertificateProfileBase? IdentityCertificateForClientAuthentication { get; set; }
#nullable restore
#else
        public ApiSdk.Models.AndroidDeviceOwnerCertificateProfileBase IdentityCertificateForClientAuthentication { get; set; }
#endif
        ...
        public ApiSdk.Models.NonEapAuthenticationMethodForPeap? InnerAuthenticationProtocolForPeap { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.AndroidDeviceOwnerTrustedRootCertificate? RootCertificateForServerValidation { get; set; }
#nullable restore
#else
        public ApiSdk.Models.AndroidDeviceOwnerTrustedRootCertificate RootCertificateForServerValidation { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.AndroidDeviceOwnerEnterpriseWiFiConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.AndroidDeviceOwnerEnterpriseWiFiConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.AndroidDeviceOwnerEnterpriseWiFiConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.AndroidDeviceOwnerEnterpriseWiFiConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "eapType", n => { EapType = n.GetEnumValue<ApiSdk.Models.AndroidEapType>(); } },
                { "identityCertificateForClientAuthentication", n => { IdentityCertificateForClientAuthentication = n.GetObjectValue<ApiSdk.Models.AndroidDeviceOwnerCertificateProfileBase>(ApiSdk.Models.AndroidDeviceOwnerCertificateProfileBase.CreateFromDiscriminatorValue); } },
                ...
                { "innerAuthenticationProtocolForPeap", n => { InnerAuthenticationProtocolForPeap = n.GetEnumValue<ApiSdk.Models.NonEapAuthenticationMethodForPeap>(); } },
                { "outerIdentityPrivacyTemporaryValue", n => { OuterIdentityPrivacyTemporaryValue = n.GetStringValue(); } },
                { "rootCertificateForServerValidation", n => { RootCertificateForServerValidation = n.GetObjectValue<ApiSdk.Models.AndroidDeviceOwnerTrustedRootCertificate>(ApiSdk.Models.AndroidDeviceOwnerTrustedRootCertificate.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.AndroidEapType>("eapType", EapType);
            writer.WriteObjectValue<ApiSdk.Models.AndroidDeviceOwnerCertificateProfileBase>("identityCertificateForClientAuthentication", IdentityCertificateForClientAuthentication);
            ...
            writer.WriteEnumValue<ApiSdk.Models.NonEapAuthenticationMethodForPeap>("innerAuthenticationProtocolForPeap", InnerAuthenticationProtocolForPeap);
            writer.WriteStringValue("outerIdentityPrivacyTemporaryValue", OuterIdentityPrivacyTemporaryValue);
            writer.WriteObjectValue<ApiSdk.Models.AndroidDeviceOwnerTrustedRootCertificate>("rootCertificateForServerValidation", RootCertificateForServerValidation);
