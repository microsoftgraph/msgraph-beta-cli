// <auto-generated/>
using ApiSdk.Connections.Item.Groups.Count;
using ApiSdk.Connections.Item.Groups.Item;
...
namespace ApiSdk.Connections.Item.Groups {
    ...
    public class GroupsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new ExternalGroupItemRequestBuilder(PathParameters);
        ...
        public GroupsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/connections/{externalConnection%2Did}/groups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="GroupsRequestBuilder"/> and sets the default values.
        ...
        public GroupsRequestBuilder(string rawUrl) : base("{+baseurl}/connections/{externalConnection%2Did}/groups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get groups from connections
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ExternalGroup body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ExternalGroup body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/connections/{externalConnection%2Did}/groups", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
