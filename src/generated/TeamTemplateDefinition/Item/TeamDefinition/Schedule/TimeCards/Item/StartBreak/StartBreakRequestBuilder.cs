    ...
    public class StartBreakRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Schedule.TimeCards.Item.StartBreak.StartBreakPostRequestBody>(ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Schedule.TimeCards.Item.StartBreak.StartBreakPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Schedule.TimeCards.Item.StartBreak.StartBreakRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Schedule.TimeCards.Item.StartBreak.StartBreakPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Schedule.TimeCards.Item.StartBreak.StartBreakPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
