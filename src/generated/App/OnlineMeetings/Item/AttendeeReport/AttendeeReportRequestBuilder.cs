...
namespace ApiSdk.App.OnlineMeetings.Item.AttendeeReport {
    ...
    {
        /// <summary>
        /// Get attendeeReport for the navigation property onlineMeetings from app
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildGetCommand()
        {
            var command = new Command("get");
            command.Description = "Get attendeeReport for the navigation property onlineMeetings from app";
        ...
        /// <summary>
        /// Update attendeeReport for the navigation property onlineMeetings in app
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildPutCommand()
        {
            var command = new Command("put");
            command.Description = "Update attendeeReport for the navigation property onlineMeetings in app";
            var onlineMeetingIdOption = new Option<string>("--online-meeting-id", description: "The unique identifier of onlineMeeting") {
            };
            onlineMeetingIdOption.IsRequired = true;
            command.AddOption(onlineMeetingIdOption);
