...
namespace ApiSdk.Models
{
    ...
    public partial class UserExperienceAnalyticsAnomaly : global::ApiSdk.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        public global::ApiSdk.Models.UserExperienceAnalyticsAnomalyType? AnomalyType { get; set; }
...
#nullable restore
        ...
        public global::ApiSdk.Models.UserExperienceAnalyticsAnomalySeverity? Severity { get; set; }
        /// <summary>Indicates the state of the anomaly. Eg: anomaly severity can be new, active, disabled, removed or other.</summary>
        public global::ApiSdk.Models.UserExperienceAnalyticsAnomalyState? State { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.UserExperienceAnalyticsAnomaly"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.UserExperienceAnalyticsAnomaly CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.UserExperienceAnalyticsAnomaly();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "anomalyType", n => { AnomalyType = n.GetEnumValue<global::ApiSdk.Models.UserExperienceAnalyticsAnomalyType>(); } },
                ...
                { "severity", n => { Severity = n.GetEnumValue<global::ApiSdk.Models.UserExperienceAnalyticsAnomalySeverity>(); } },
                { "state", n => { State = n.GetEnumValue<global::ApiSdk.Models.UserExperienceAnalyticsAnomalyState>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.UserExperienceAnalyticsAnomalyType>("anomalyType", AnomalyType);
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.UserExperienceAnalyticsAnomalySeverity>("severity", Severity);
            writer.WriteEnumValue<global::ApiSdk.Models.UserExperienceAnalyticsAnomalyState>("state", State);
        }
    }
}
