...
namespace ApiSdk.Models
{
    ...
    public class GovernanceRoleAssignmentRequest : ApiSdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.GovernanceRoleAssignmentRequestStatus? Status { get; set; }
#nullable restore
#else
        public ApiSdk.Models.GovernanceRoleAssignmentRequestStatus Status { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.GovernanceRoleAssignmentRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.GovernanceRoleAssignmentRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.GovernanceRoleAssignmentRequest();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "status", n => { Status = n.GetObjectValue<ApiSdk.Models.GovernanceRoleAssignmentRequestStatus>(ApiSdk.Models.GovernanceRoleAssignmentRequestStatus.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.GovernanceRoleAssignmentRequestStatus>("status", Status);
