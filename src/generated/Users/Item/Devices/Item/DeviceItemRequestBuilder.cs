...
using ApiSdk.Models;
using ApiSdk.Users.Item.Devices.Item.Commands;
using ApiSdk.Users.Item.Devices.Item.DeviceTemplate;
using ApiSdk.Users.Item.Devices.Item.Extensions;
using ApiSdk.Users.Item.Devices.Item.MemberOf;
using ApiSdk.Users.Item.Devices.Item.RegisteredOwners;
using ApiSdk.Users.Item.Devices.Item.RegisteredUsers;
using ApiSdk.Users.Item.Devices.Item.TransitiveMemberOf;
using ApiSdk.Users.Item.Devices.Item.UsageRights;
...
namespace ApiSdk.Users.Item.Devices.Item
{
    ...
    public partial class DeviceItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCommandsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Devices.Item.Commands.CommandsRequestBuilder(PathParameters);
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property devices for users";
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildDeviceTemplateNavCommand()
        {
            var command = new Command("device-template");
            command.Description = "Provides operations to manage the deviceTemplate property of the microsoft.graph.device entity.";
            var builder = new global::ApiSdk.Users.Item.Devices.Item.DeviceTemplate.DeviceTemplateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildExtensionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Devices.Item.Extensions.ExtensionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildMemberOfNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Devices.Item.MemberOf.MemberOfRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property devices in users";
            var userIdOption = new Option<string>("--user-id", description: "The unique identifier of user. Use 'me' for the currently signed in user.") {
            };
            userIdOption.IsRequired = true;
            command.AddOption(userIdOption);
        ...
        public Command BuildRegisteredOwnersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Devices.Item.RegisteredOwners.RegisteredOwnersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildRegisteredUsersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Devices.Item.RegisteredUsers.RegisteredUsersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            nonExecCommands.Add(builder.BuildGraphAppRoleAssignmentNavCommand());
        ...
        public Command BuildTransitiveMemberOfNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Devices.Item.TransitiveMemberOf.TransitiveMemberOfRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            nonExecCommands.Add(builder.BuildGraphAdministrativeUnitNavCommand());
        ...
        public Command BuildUsageRightsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Devices.Item.UsageRights.UsageRightsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.Devices.Item.DeviceItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.Devices.Item.DeviceItemRequestBuilder.DeviceItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.Devices.Item.DeviceItemRequestBuilder.DeviceItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
