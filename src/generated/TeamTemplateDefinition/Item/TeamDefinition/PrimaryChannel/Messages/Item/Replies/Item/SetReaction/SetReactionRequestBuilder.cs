    ...
    public class SetReactionRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.PrimaryChannel.Messages.Item.Replies.Item.SetReaction.SetReactionPostRequestBody>(ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.PrimaryChannel.Messages.Item.Replies.Item.SetReaction.SetReactionPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.PrimaryChannel.Messages.Item.Replies.Item.SetReaction.SetReactionRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.PrimaryChannel.Messages.Item.Replies.Item.SetReaction.SetReactionPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.PrimaryChannel.Messages.Item.Replies.Item.SetReaction.SetReactionPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
