...
namespace ApiSdk.Models
{
    ...
    public class ExactMatchDetectedSensitiveContent : ApiSdk.Models.DetectedSensitiveContentBase, IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.ExactMatchDetectedSensitiveContent"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.ExactMatchDetectedSensitiveContent CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.ExactMatchDetectedSensitiveContent();
        }
        /// <summary>
