...
namespace ApiSdk.Admin.Windows.Updates.Deployments.Item.Audience.ApplicableContent.Item.MatchedDevices.Item
{
    ...
    public class ApplicableContentDeviceMatchDeviceItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Admin.Windows.Updates.Deployments.Item.Audience.ApplicableContent.Item.MatchedDevices.Item.ApplicableContentDeviceMatchDeviceItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.WindowsUpdates.ApplicableContentDeviceMatch body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.WindowsUpdates.ApplicableContentDeviceMatch body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
