...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ShiftActivity>? ShiftItemActivities { get; set; }
#nullable restore
#else
        public List<ShiftActivity> ShiftItemActivities { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? ShiftItemDisplayName { get; set; }
#nullable restore
#else
        public string ShiftItemDisplayName { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? ShiftItemNotes { get; set; }
#nullable restore
#else
        public string ShiftItemNotes { get; set; }
#endif
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"activities", n => { ShiftItemActivities = n.GetCollectionOfObjectValues<ShiftActivity>(ShiftActivity.CreateFromDiscriminatorValue)?.ToList(); } },
                {"displayName", n => { ShiftItemDisplayName = n.GetStringValue(); } },
                {"notes", n => { ShiftItemNotes = n.GetStringValue(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ShiftActivity>("activities", ShiftItemActivities);
            writer.WriteStringValue("displayName", ShiftItemDisplayName);
            writer.WriteStringValue("notes", ShiftItemNotes);
        }
    }
}
