...
using ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.DataBodyRange;
using ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.Filter;
using ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.HeaderRowRange;
using ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.RangeNamespace;
using ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.TotalRowRange;
...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex
{
    ...
    public partial class ItemAtWithIndexRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDataBodyRangeNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.DataBodyRange.DataBodyRangeRequestBuilder(PathParameters);
        ...
        public Command BuildFilterNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.Filter.FilterRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildHeaderRowRangeNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.HeaderRowRange.HeaderRowRangeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRangeNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.RangeNamespace.RangeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTotalRowRangeNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.TotalRowRange.TotalRowRangeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex.ItemAtWithIndexRequestBuilder"/> and sets the default values.
        /// </summary>
