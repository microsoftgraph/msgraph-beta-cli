...
namespace ApiSdk.Chats.Item.Messages.Item
{
    ...
    public partial class ChatMessageItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildHostedContentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Chats.Item.Messages.Item.HostedContents.HostedContentsRequestBuilder(PathParameters);
        ...
        public Command BuildSetReactionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Chats.Item.Messages.Item.SetReaction.SetReactionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSoftDeleteNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Chats.Item.Messages.Item.SoftDelete.SoftDeleteRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUndoSoftDeleteNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Chats.Item.Messages.Item.UndoSoftDelete.UndoSoftDeleteRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUnsetReactionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Chats.Item.Messages.Item.UnsetReaction.UnsetReactionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Chats.Item.Messages.Item.ChatMessageItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Chats.Item.Messages.Item.ChatMessageItemRequestBuilder.ChatMessageItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Chats.Item.Messages.Item.ChatMessageItemRequestBuilder.ChatMessageItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
