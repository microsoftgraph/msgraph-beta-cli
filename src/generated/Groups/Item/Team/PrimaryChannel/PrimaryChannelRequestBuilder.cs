...
namespace ApiSdk.Groups.Item.Team.PrimaryChannel
{
    ...
    public class PrimaryChannelRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildArchiveNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Team.PrimaryChannel.Archive.ArchiveRequestBuilder(PathParameters);
        ...
        public Command BuildCompleteMigrationNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Team.PrimaryChannel.CompleteMigration.CompleteMigrationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Team.PrimaryChannel.DoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalName.DoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildFilesFolderNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Team.PrimaryChannel.FilesFolder.FilesFolderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildMembersNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Team.PrimaryChannel.Members.MembersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildMessagesNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Team.PrimaryChannel.Messages.MessagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildProvisionEmailNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Team.PrimaryChannel.ProvisionEmail.ProvisionEmailRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRemoveEmailNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Team.PrimaryChannel.RemoveEmail.RemoveEmailRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSharedWithTeamsNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Team.PrimaryChannel.SharedWithTeams.SharedWithTeamsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildTabsNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Team.PrimaryChannel.Tabs.TabsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildUnarchiveNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Team.PrimaryChannel.Unarchive.UnarchiveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.Team.PrimaryChannel.PrimaryChannelRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.Team.PrimaryChannel.PrimaryChannelRequestBuilder.PrimaryChannelRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.Team.PrimaryChannel.PrimaryChannelRequestBuilder.PrimaryChannelRequestBuilderGetQueryParameters>> requestConfiguration = default)
