...
namespace ApiSdk.RoleManagement.DeviceManagement
{
    ...
    public class DeviceManagementRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildResourceNamespacesNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.DeviceManagement.ResourceNamespaces.ResourceNamespacesRequestBuilder(PathParameters);
        ...
        public Command BuildRoleAssignmentsNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.DeviceManagement.RoleAssignments.RoleAssignmentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRoleDefinitionsNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.DeviceManagement.RoleDefinitions.RoleDefinitionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.RoleManagement.DeviceManagement.DeviceManagementRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.DeviceManagement.DeviceManagementRequestBuilder.DeviceManagementRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.DeviceManagement.DeviceManagementRequestBuilder.DeviceManagementRequestBuilderGetQueryParameters>> requestConfiguration = default)
