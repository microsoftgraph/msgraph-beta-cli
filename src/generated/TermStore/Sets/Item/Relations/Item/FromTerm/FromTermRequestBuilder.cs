...
using System;
namespace ApiSdk.TermStore.Sets.Item.Relations.Item.FromTerm
{
    /// <summary>
    ...
    public partial class FromTermRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.TermStore.Sets.Item.Relations.Item.FromTerm.FromTermRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public FromTermRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/termStore/sets/{set%2Did}/relations/{relation%2Did}/fromTerm{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.TermStore.Sets.Item.Relations.Item.FromTerm.FromTermRequestBuilder"/> and sets the default values.
        ...
        public FromTermRequestBuilder(string rawUrl) : base("{+baseurl}/termStore/sets/{set%2Did}/relations/{relation%2Did}/fromTerm{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// The from [term] of the relation. The term from which the relationship is defined. A null value would indicate the relation is directly with the [set].
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.TermStore.Sets.Item.Relations.Item.FromTerm.FromTermRequestBuilder.FromTermRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.TermStore.Sets.Item.Relations.Item.FromTerm.FromTermRequestBuilder.FromTermRequestBuilderGetQueryParameters>> requestConfiguration = default)
