...
namespace ApiSdk.Groups.Item.Threads.Item.Posts.Item
{
    ...
    public class PostItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAttachmentsNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Threads.Item.Posts.Item.Attachments.AttachmentsRequestBuilder(PathParameters);
        ...
        public Command BuildExtensionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Threads.Item.Posts.Item.Extensions.ExtensionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildForwardNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Threads.Item.Posts.Item.Forward.ForwardRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildInReplyToNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo.InReplyToRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildMentionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Threads.Item.Posts.Item.Mentions.MentionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildReplyNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Threads.Item.Posts.Item.Reply.ReplyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.Threads.Item.Posts.Item.PostItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.Threads.Item.Posts.Item.PostItemRequestBuilder.PostItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.Threads.Item.Posts.Item.PostItemRequestBuilder.PostItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
