...
using ApiSdk.Models;
using ApiSdk.Users.Item.CreatedObjects.GraphServicePrincipal.Count;
...
using System;
namespace ApiSdk.Users.Item.CreatedObjects.GraphServicePrincipal {
    /// <summary>
    ...
    public class GraphServicePrincipalRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public GraphServicePrincipalRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/createdObjects/graph.servicePrincipal{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="GraphServicePrincipalRequestBuilder"/> and sets the default values.
        ...
        public GraphServicePrincipalRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/createdObjects/graph.servicePrincipal{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get the items of type microsoft.graph.servicePrincipal in the microsoft.graph.directoryObject collection
