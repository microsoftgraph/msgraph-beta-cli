...
using System;
namespace ApiSdk.Users.Item.Calendars.Item.CalendarView.Item.Instances.Item.Extensions.Count {
    /// <summary>
    ...
    public class CountRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/extensions/$count{?%24filter}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="CountRequestBuilder"/> and sets the default values.
        ...
        public CountRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/extensions/$count{?%24filter}", rawUrl)
        {
        }
        /// <summary>
        /// Get the number of the resource
