...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.DeviceAppManagement.IosLobAppProvisioningConfigurations.HasPayloadLinks.HasPayloadLinksPostResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.DeviceAppManagement.IosLobAppProvisioningConfigurations.HasPayloadLinks.HasPayloadLinksPostResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.DeviceAppManagement.IosLobAppProvisioningConfigurations.HasPayloadLinks.HasPayloadLinksPostResponse();
        }
        /// <summary>
