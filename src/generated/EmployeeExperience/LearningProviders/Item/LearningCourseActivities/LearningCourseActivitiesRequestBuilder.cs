...
namespace ApiSdk.EmployeeExperience.LearningProviders.Item.LearningCourseActivities
{
    ...
    public class LearningCourseActivitiesRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new LearningCourseActivityItemRequestBuilder(PathParameters);
        ...
        public Command BuildCreateCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<LearningCourseActivity>(LearningCourseActivity.CreateFromDiscriminatorValue);
                if (model is null) {
