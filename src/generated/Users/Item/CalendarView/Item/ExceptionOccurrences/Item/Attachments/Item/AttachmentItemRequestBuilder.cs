...
using System;
namespace ApiSdk.Users.Item.CalendarView.Item.ExceptionOccurrences.Item.Attachments.Item {
    /// <summary>
    ...
    public class AttachmentItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public AttachmentItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/attachments/{attachment%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="AttachmentItemRequestBuilder"/> and sets the default values.
        ...
        public AttachmentItemRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/attachments/{attachment%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete an attachment from a user calendar event, message, Outlook task, or post.
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/exceptionOccurrences/{event%2Did1}/attachments/{attachment%2Did}", PathParameters);
