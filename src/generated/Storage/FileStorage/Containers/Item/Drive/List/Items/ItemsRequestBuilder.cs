...
using ApiSdk.Models;
using ApiSdk.Storage.FileStorage.Containers.Item.Drive.List.Items.Delta;
using ApiSdk.Storage.FileStorage.Containers.Item.Drive.List.Items.DeltaWithToken;
using ApiSdk.Storage.FileStorage.Containers.Item.Drive.List.Items.Item;
...
using System;
namespace ApiSdk.Storage.FileStorage.Containers.Item.Drive.List.Items
{
    /// <summary>
    ...
    public class ItemsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.Containers.Item.Drive.List.Items.Item.ListItemItemRequestBuilder(PathParameters);
        ...
        public Command BuildDeltaNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.Containers.Item.Drive.List.Items.Delta.DeltaRequestBuilder(PathParameters);
        ...
        public Command BuildDeltaWithTokenRbCommand()
        {
            ...
            command.Description = "Provides operations to call the delta method.";
            var builder = new ApiSdk.Storage.FileStorage.Containers.Item.Drive.List.Items.DeltaWithToken.DeltaWithTokenRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.Containers.Item.Drive.List.Items.ItemsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public ItemsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list/items{?%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.Containers.Item.Drive.List.Items.ItemsRequestBuilder"/> and sets the default values.
        ...
        public ItemsRequestBuilder(string rawUrl) : base("{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list/items{?%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// All items contained in the list.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Storage.FileStorage.Containers.Item.Drive.List.Items.ItemsRequestBuilder.ItemsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Storage.FileStorage.Containers.Item.Drive.List.Items.ItemsRequestBuilder.ItemsRequestBuilderGetQueryParameters>> requestConfiguration = default)
