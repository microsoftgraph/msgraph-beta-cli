...
namespace ApiSdk.TenantRelationships.ManagedTenants.AuditEvents {
    ...
    public class AuditEventsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildListCommand()
        {
            ...
            command.Description = "Get a list of the auditEvent objects and their properties.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/managedtenants-managedtenant-list-auditevents?view=graph-rest-1.0";
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(AuditEvent body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/tenantRelationships/managedTenants/auditEvents", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
