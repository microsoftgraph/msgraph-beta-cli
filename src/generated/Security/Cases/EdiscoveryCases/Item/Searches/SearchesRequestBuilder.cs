...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Searches {
    ...
    public class SearchesRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new EdiscoverySearchItemRequestBuilder(PathParameters);
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<SearchesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<SearchesRequestBuilderGetQueryParameters>> requestConfiguration = default)
