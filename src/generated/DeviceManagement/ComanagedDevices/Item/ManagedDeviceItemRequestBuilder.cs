...
namespace ApiSdk.DeviceManagement.ComanagedDevices.Item
{
    ...
    public partial class ManagedDeviceItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGetCloudPcRemoteActionResultsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.ComanagedDevices.Item.GetCloudPcRemoteActionResults.GetCloudPcRemoteActionResultsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetCloudPcReviewStatusNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.ComanagedDevices.Item.GetCloudPcReviewStatus.GetCloudPcReviewStatusRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSetCloudPcReviewStatusNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.ComanagedDevices.Item.SetCloudPcReviewStatus.SetCloudPcReviewStatusRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
