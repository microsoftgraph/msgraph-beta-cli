...
namespace ApiSdk.Models {
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="NoMfaOnRoleActivationAlertConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="NoMfaOnRoleActivationAlertConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new NoMfaOnRoleActivationAlertConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
