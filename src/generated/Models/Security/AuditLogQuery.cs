...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.Security.AuditLogRecord>? Records { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.Security.AuditLogRecord> Records { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.Security.AuditLogRecordType?>? RecordTypeFilters { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.Security.AuditLogRecordType?> RecordTypeFilters { get; set; }
#endif
...
#nullable restore
        ...
        public ApiSdk.Models.Security.AuditLogQueryStatus? Status { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.Security.AuditLogQuery"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.Security.AuditLogQuery CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.Security.AuditLogQuery();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "recordTypeFilters", n => { RecordTypeFilters = n.GetCollectionOfEnumValues<ApiSdk.Models.Security.AuditLogRecordType>()?.ToList(); } },
                { "records", n => { Records = n.GetCollectionOfObjectValues<ApiSdk.Models.Security.AuditLogRecord>(ApiSdk.Models.Security.AuditLogRecord.CreateFromDiscriminatorValue)?.ToList(); } },
                { "serviceFilters", n => { ServiceFilters = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                { "status", n => { Status = n.GetEnumValue<ApiSdk.Models.Security.AuditLogQueryStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Security.AuditLogRecord>("records", Records);
            writer.WriteCollectionOfEnumValues<ApiSdk.Models.Security.AuditLogRecordType>("recordTypeFilters", RecordTypeFilters);
            writer.WriteCollectionOfPrimitiveValues<string>("serviceFilters", ServiceFilters);
            writer.WriteEnumValue<ApiSdk.Models.Security.AuditLogQueryStatus>("status", Status);
