...
namespace ApiSdk.DeviceAppManagement.ManagedAppRegistrations.Item
{
    ...
    public class ManagedAppRegistrationItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildManagedAppLogCollectionRequestsNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.ManagedAppRegistrations.Item.ManagedAppLogCollectionRequests.ManagedAppLogCollectionRequestsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
