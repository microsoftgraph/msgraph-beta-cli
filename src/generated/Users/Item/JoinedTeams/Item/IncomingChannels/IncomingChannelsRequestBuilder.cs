...
using ApiSdk.Models;
using ApiSdk.Users.Item.JoinedTeams.Item.IncomingChannels.Count;
using ApiSdk.Users.Item.JoinedTeams.Item.IncomingChannels.Item;
...
using System;
namespace ApiSdk.Users.Item.JoinedTeams.Item.IncomingChannels {
    /// <summary>
    ...
    public class IncomingChannelsRequestBuilder : BaseCliRequestBuilder {
        ...
        public IncomingChannelsRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/incomingChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get the list of incoming channels (channels shared with a team).
        /// </summary>
