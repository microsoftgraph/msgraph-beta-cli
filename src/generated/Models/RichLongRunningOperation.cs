...
namespace ApiSdk.Models
{
    ...
    public class RichLongRunningOperation : ApiSdk.Models.LongRunningOperation, IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.RichLongRunningOperation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.RichLongRunningOperation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.RichLongRunningOperation();
        }
        /// <summary>
