...
using System;
namespace ApiSdk.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item.DirectoryScope
{
    /// <summary>
    ...
    public partial class DirectoryScopeRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item.DirectoryScope.DirectoryScopeRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public DirectoryScopeRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/roleManagement/directory/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest%2Did}/directoryScope{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item.DirectoryScope.DirectoryScopeRequestBuilder"/> and sets the default values.
        ...
        public DirectoryScopeRequestBuilder(string rawUrl) : base("{+baseurl}/roleManagement/directory/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest%2Did}/directoryScope{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// The directory object that is the scope of the role eligibility. Read-only. Supports $expand.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item.DirectoryScope.DirectoryScopeRequestBuilder.DirectoryScopeRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleRequests.Item.DirectoryScope.DirectoryScopeRequestBuilder.DirectoryScopeRequestBuilderGetQueryParameters>> requestConfiguration = default)
