...
namespace ApiSdk.EmployeeExperience.Communities {
    ...
    public class CommunitiesRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new CommunityItemRequestBuilder(PathParameters);
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(Community body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/employeeExperience/communities", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
