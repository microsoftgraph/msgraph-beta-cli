...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.PlannerRoster>? Rosters { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.PlannerRoster> Rosters { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "rosters", n => { Rosters = n.GetCollectionOfObjectValues<ApiSdk.Models.PlannerRoster>(ApiSdk.Models.PlannerRoster.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.PlannerRoster>("rosters", Rosters);
