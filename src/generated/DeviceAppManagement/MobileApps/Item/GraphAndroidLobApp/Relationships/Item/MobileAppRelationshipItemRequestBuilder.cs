...
using System;
namespace ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidLobApp.Relationships.Item
{
    /// <summary>
    ...
    public class MobileAppRelationshipItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidLobApp.Relationships.Item.MobileAppRelationshipItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public MobileAppRelationshipItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.androidLobApp/relationships/{mobileAppRelationship%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidLobApp.Relationships.Item.MobileAppRelationshipItemRequestBuilder"/> and sets the default values.
        ...
        public MobileAppRelationshipItemRequestBuilder(string rawUrl) : base("{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.androidLobApp/relationships/{mobileAppRelationship%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property relationships for deviceAppManagement
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidLobApp.Relationships.Item.MobileAppRelationshipItemRequestBuilder.MobileAppRelationshipItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidLobApp.Relationships.Item.MobileAppRelationshipItemRequestBuilder.MobileAppRelationshipItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
