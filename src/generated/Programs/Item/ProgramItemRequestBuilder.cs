...
using ApiSdk.Models;
using ApiSdk.Programs.Item.Controls;
...
namespace ApiSdk.Programs.Item
{
    ...
    public partial class ProgramItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildControlsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Programs.Item.Controls.ControlsRequestBuilder(PathParameters);
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get entity from programs by key";
            var programIdOption = new Option<string>("--program-id", description: "The unique identifier of program") {
            };
            programIdOption.IsRequired = true;
            command.AddOption(programIdOption);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Programs.Item.ProgramItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public ProgramItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/programs/{program%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Programs.Item.ProgramItemRequestBuilder"/> and sets the default values.
        ...
        public ProgramItemRequestBuilder(string rawUrl) : base("{+baseurl}/programs/{program%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// In the Microsoft Entra access reviews feature, delete a program object. Do not delete a program which still has programControl linked to it, those access reviews should first be deleted or unlinked from the program and linked to a different program.  Also, please note that the built-in default program cannot be deleted.
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Programs.Item.ProgramItemRequestBuilder.ProgramItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Programs.Item.ProgramItemRequestBuilder.ProgramItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ProgramItemRequestBuilderGetQueryParameters 
        {
