...
namespace ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item
{
    ...
    public class ChannelItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildArchiveNavCommand()
        {
            ...
            var builder = new ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.Archive.ArchiveRequestBuilder(PathParameters);
        ...
        public Command BuildCompleteMigrationNavCommand()
        {
            ...
            var builder = new ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.CompleteMigration.CompleteMigrationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameNavCommand()
        {
            ...
            var builder = new ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.DoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalName.DoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildFilesFolderNavCommand()
        {
            ...
            var builder = new ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.FilesFolder.FilesFolderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildMembersNavCommand()
        {
            ...
            var builder = new ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.Members.MembersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildMessagesNavCommand()
        {
            ...
            var builder = new ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.Messages.MessagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildProvisionEmailNavCommand()
        {
            ...
            var builder = new ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.ProvisionEmail.ProvisionEmailRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRemoveEmailNavCommand()
        {
            ...
            var builder = new ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.RemoveEmail.RemoveEmailRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSharedWithTeamsNavCommand()
        {
            ...
            var builder = new ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.SharedWithTeams.SharedWithTeamsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildTabsNavCommand()
        {
            ...
            var builder = new ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.Tabs.TabsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildUnarchiveNavCommand()
        {
            ...
            var builder = new ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.Unarchive.UnarchiveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.ChannelItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.ChannelItemRequestBuilder.ChannelItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.ChannelItemRequestBuilder.ChannelItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
