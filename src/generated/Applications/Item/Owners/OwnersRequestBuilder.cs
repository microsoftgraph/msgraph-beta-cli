...
using ApiSdk.Applications.Item.Owners.Count;
using ApiSdk.Applications.Item.Owners.GraphAppRoleAssignment;
using ApiSdk.Applications.Item.Owners.GraphEndpoint;
using ApiSdk.Applications.Item.Owners.GraphServicePrincipal;
using ApiSdk.Applications.Item.Owners.GraphUser;
using ApiSdk.Applications.Item.Owners.Item;
using ApiSdk.Applications.Item.Owners.Ref;
...
namespace ApiSdk.Applications.Item.Owners
{
    ...
    public partial class OwnersRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        /// Gets an item from the ApiSdk.applications.item.owners.item collection
        /// </summary>
        /// <returns>A Tuple&lt;List&lt;Command&gt;, List&lt;Command&gt;&gt;</returns>
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            var commands = new List<Command>();
            var builder = new global::ApiSdk.Applications.Item.Owners.Item.DirectoryObjectItemRequestBuilder(PathParameters);
        ...
        public Command BuildCountNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.Owners.Count.CountRequestBuilder(PathParameters);
        ...
        public Command BuildGraphAppRoleAssignmentNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.Owners.GraphAppRoleAssignment.GraphAppRoleAssignmentRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGraphEndpointNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.Owners.GraphEndpoint.GraphEndpointRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildGraphServicePrincipalNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.Owners.GraphServicePrincipal.GraphServicePrincipalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildGraphUserNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.Owners.GraphUser.GraphUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/application-list-owners?view=graph-rest-beta" />
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildListCommand()
        {
            var command = new Command("list");
            command.Description = "Retrieve a list of owners for an application that are directoryObject types.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/application-list-owners?view=graph-rest-beta";
...
#nullable restore
        ...
        public Command BuildRefNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.Owners.Ref.RefRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Applications.Item.Owners.OwnersRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public OwnersRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/applications/{application%2Did}/owners{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Applications.Item.Owners.OwnersRequestBuilder"/> and sets the default values.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Applications.Item.Owners.OwnersRequestBuilder.OwnersRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Applications.Item.Owners.OwnersRequestBuilder.OwnersRequestBuilderGetQueryParameters>> requestConfiguration = default)
