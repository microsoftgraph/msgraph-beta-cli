...
namespace ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Schedule.TimeCards {
    ...
    public class TimeCardsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildClockInNavCommand()
        {
            ...
            var builder = new ClockInRequestBuilder(PathParameters);
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new TimeCardItemRequestBuilder(PathParameters);
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(TimeCard body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/schedule/timeCards", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
