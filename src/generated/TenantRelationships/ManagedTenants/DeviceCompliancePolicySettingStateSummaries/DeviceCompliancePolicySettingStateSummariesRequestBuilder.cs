...
namespace ApiSdk.TenantRelationships.ManagedTenants.DeviceCompliancePolicySettingStateSummaries {
    ...
    public class DeviceCompliancePolicySettingStateSummariesRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new DeviceCompliancePolicySettingStateSummaryItemRequestBuilder(PathParameters);
        ...
        public Command BuildCreateCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<DeviceCompliancePolicySettingStateSummary>(DeviceCompliancePolicySettingStateSummary.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildListCommand()
        {
            ...
            command.Description = "Get a list of the deviceCompliancePolicySettingStateSummary objects and their properties.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/managedtenants-managedtenant-list-devicecompliancepolicysettingstatesummary?view=graph-rest-1.0";
