...
namespace ApiSdk.Models.Security
{
    ...
    public partial class DeviceEvidence : global::ApiSdk.Models.Security.AlertEvidence, IParsable
...
#nullable restore
        ...
        public global::ApiSdk.Models.Security.DefenderAvStatus? DefenderAvStatus { get; set; }
...
#nullable restore
        ...
        public global::ApiSdk.Models.Security.DeviceHealthStatus? HealthStatus { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.Security.LoggedOnUser>? LoggedOnUsers { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.Security.LoggedOnUser> LoggedOnUsers { get; set; }
#endif
...
#nullable restore
        ...
        public global::ApiSdk.Models.Security.OnboardingStatus? OnboardingStatus { get; set; }
...
#nullable restore
        ...
        public global::ApiSdk.Models.Security.DeviceRiskScore? RiskScore { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.Security.VmMetadata? VmMetadata { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.Security.VmMetadata VmMetadata { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Models.Security.DeviceEvidence"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.Security.DeviceEvidence"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.Security.DeviceEvidence CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.Security.DeviceEvidence();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "defenderAvStatus", n => { DefenderAvStatus = n.GetEnumValue<global::ApiSdk.Models.Security.DefenderAvStatus>(); } },
                { "deviceDnsName", n => { DeviceDnsName = n.GetStringValue(); } },
                { "dnsDomain", n => { DnsDomain = n.GetStringValue(); } },
                { "firstSeenDateTime", n => { FirstSeenDateTime = n.GetDateTimeOffsetValue(); } },
                { "healthStatus", n => { HealthStatus = n.GetEnumValue<global::ApiSdk.Models.Security.DeviceHealthStatus>(); } },
                ...
                { "loggedOnUsers", n => { LoggedOnUsers = n.GetCollectionOfObjectValues<global::ApiSdk.Models.Security.LoggedOnUser>(global::ApiSdk.Models.Security.LoggedOnUser.CreateFromDiscriminatorValue)?.AsList(); } },
                { "mdeDeviceId", n => { MdeDeviceId = n.GetStringValue(); } },
                { "ntDomain", n => { NtDomain = n.GetStringValue(); } },
                { "onboardingStatus", n => { OnboardingStatus = n.GetEnumValue<global::ApiSdk.Models.Security.OnboardingStatus>(); } },
                ...
                { "riskScore", n => { RiskScore = n.GetEnumValue<global::ApiSdk.Models.Security.DeviceRiskScore>(); } },
                { "version", n => { Version = n.GetStringValue(); } },
                { "vmMetadata", n => { VmMetadata = n.GetObjectValue<global::ApiSdk.Models.Security.VmMetadata>(global::ApiSdk.Models.Security.VmMetadata.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.Security.DefenderAvStatus>("defenderAvStatus", DefenderAvStatus);
            writer.WriteStringValue("deviceDnsName", DeviceDnsName);
            writer.WriteStringValue("dnsDomain", DnsDomain);
            writer.WriteDateTimeOffsetValue("firstSeenDateTime", FirstSeenDateTime);
            writer.WriteEnumValue<global::ApiSdk.Models.Security.DeviceHealthStatus>("healthStatus", HealthStatus);
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.Security.LoggedOnUser>("loggedOnUsers", LoggedOnUsers);
            writer.WriteStringValue("mdeDeviceId", MdeDeviceId);
            writer.WriteStringValue("ntDomain", NtDomain);
            writer.WriteEnumValue<global::ApiSdk.Models.Security.OnboardingStatus>("onboardingStatus", OnboardingStatus);
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.Security.DeviceRiskScore>("riskScore", RiskScore);
            writer.WriteStringValue("version", Version);
            writer.WriteObjectValue<global::ApiSdk.Models.Security.VmMetadata>("vmMetadata", VmMetadata);
        }
    }
}
