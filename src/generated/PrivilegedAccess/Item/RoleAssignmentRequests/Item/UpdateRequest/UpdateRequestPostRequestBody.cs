...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.PrivilegedAccess.Item.RoleAssignmentRequests.Item.UpdateRequest.UpdateRequestPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.PrivilegedAccess.Item.RoleAssignmentRequests.Item.UpdateRequest.UpdateRequestPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.PrivilegedAccess.Item.RoleAssignmentRequests.Item.UpdateRequest.UpdateRequestPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.PrivilegedAccess.Item.RoleAssignmentRequests.Item.UpdateRequest.UpdateRequestPostRequestBody();
        }
        /// <summary>
