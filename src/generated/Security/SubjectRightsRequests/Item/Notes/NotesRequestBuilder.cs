...
using ApiSdk.Models;
using ApiSdk.Security.SubjectRightsRequests.Item.Notes.Count;
using ApiSdk.Security.SubjectRightsRequests.Item.Notes.Item;
...
using System;
namespace ApiSdk.Security.SubjectRightsRequests.Item.Notes {
    /// <summary>
    ...
    public class NotesRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new AuthoredNoteItemRequestBuilder(PathParameters);
        ...
        public NotesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/notes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="NotesRequestBuilder"/> and sets the default values.
        ...
        public NotesRequestBuilder(string rawUrl) : base("{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/notes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get the list of authored notes associated with a subject rights request. 
