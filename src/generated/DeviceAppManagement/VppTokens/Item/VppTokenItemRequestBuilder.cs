...
namespace ApiSdk.DeviceAppManagement.VppTokens.Item
{
    ...
    public class VppTokenItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildRevokeLicensesNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.VppTokens.Item.RevokeLicenses.RevokeLicensesRequestBuilder(PathParameters);
        ...
        public Command BuildSyncLicensesNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceAppManagement.VppTokens.Item.SyncLicenses.SyncLicensesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceAppManagement.VppTokens.Item.VppTokenItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceAppManagement.VppTokens.Item.VppTokenItemRequestBuilder.VppTokenItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceAppManagement.VppTokens.Item.VppTokenItemRequestBuilder.VppTokenItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.VppToken body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.VppToken body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
