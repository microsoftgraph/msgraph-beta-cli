...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class MobileAppTroubleshootingAppTargetHistory : ApiSdk.Models.MobileAppTroubleshootingHistoryItem, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.MobileAppTroubleshootingAppTargetHistory"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.MobileAppTroubleshootingAppTargetHistory CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.MobileAppTroubleshootingAppTargetHistory();
        }
        /// <summary>
