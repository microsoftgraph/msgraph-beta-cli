...
using ApiSdk.Models;
using ApiSdk.Storage.FileStorage.Containers.Item.Drive.Activities.Item.DriveItem;
using ApiSdk.Storage.FileStorage.Containers.Item.Drive.Activities.Item.ListItem;
...
using System;
namespace ApiSdk.Storage.FileStorage.Containers.Item.Drive.Activities.Item
{
    /// <summary>
    ...
    public class ItemActivityOLDItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDriveItemNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.Containers.Item.Drive.Activities.Item.DriveItem.DriveItemRequestBuilder(PathParameters);
        ...
        public Command BuildListItemNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.Containers.Item.Drive.Activities.Item.ListItem.ListItemRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.Containers.Item.Drive.Activities.Item.ItemActivityOLDItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public ItemActivityOLDItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/activities/{itemActivityOLD%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.Containers.Item.Drive.Activities.Item.ItemActivityOLDItemRequestBuilder"/> and sets the default values.
        ...
        public ItemActivityOLDItemRequestBuilder(string rawUrl) : base("{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/activities/{itemActivityOLD%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property activities for storage
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Storage.FileStorage.Containers.Item.Drive.Activities.Item.ItemActivityOLDItemRequestBuilder.ItemActivityOLDItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Storage.FileStorage.Containers.Item.Drive.Activities.Item.ItemActivityOLDItemRequestBuilder.ItemActivityOLDItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
