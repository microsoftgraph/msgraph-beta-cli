...
namespace ApiSdk.Models
{
    ...
    public partial class OperationApprovalRequest : global::ApiSdk.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.IdentitySet? Approver { get; private set; }
#nullable restore
#else
        public global::ApiSdk.Models.IdentitySet Approver { get; private set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.IdentitySet? Requestor { get; private set; }
#nullable restore
#else
        public global::ApiSdk.Models.IdentitySet Requestor { get; private set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.OperationApprovalPolicyType?>? RequiredOperationApprovalPolicyTypes { get; private set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.OperationApprovalPolicyType?> RequiredOperationApprovalPolicyTypes { get; private set; }
#endif
        ...
        public global::ApiSdk.Models.OperationApprovalRequestStatus? Status { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.OperationApprovalRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.OperationApprovalRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.OperationApprovalRequest();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "approver", n => { Approver = n.GetObjectValue<global::ApiSdk.Models.IdentitySet>(global::ApiSdk.Models.IdentitySet.CreateFromDiscriminatorValue); } },
                ...
                { "requestor", n => { Requestor = n.GetObjectValue<global::ApiSdk.Models.IdentitySet>(global::ApiSdk.Models.IdentitySet.CreateFromDiscriminatorValue); } },
                { "requiredOperationApprovalPolicyTypes", n => { RequiredOperationApprovalPolicyTypes = n.GetCollectionOfEnumValues<global::ApiSdk.Models.OperationApprovalPolicyType>()?.AsList(); } },
                { "status", n => { Status = n.GetEnumValue<global::ApiSdk.Models.OperationApprovalRequestStatus>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.OperationApprovalRequestStatus>("status", Status);
        }
    }
}
