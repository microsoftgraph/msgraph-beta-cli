...
namespace ApiSdk.DeviceManagement.GroupPolicyDefinitions.Item.PreviousVersionDefinition
{
    ...
    public class PreviousVersionDefinitionRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCategoryNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.GroupPolicyDefinitions.Item.PreviousVersionDefinition.Category.CategoryRequestBuilder(PathParameters);
        ...
        public Command BuildDefinitionFileNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.GroupPolicyDefinitions.Item.PreviousVersionDefinition.DefinitionFile.DefinitionFileRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildNextVersionDefinitionNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.GroupPolicyDefinitions.Item.PreviousVersionDefinition.NextVersionDefinition.NextVersionDefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildPresentationsNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.GroupPolicyDefinitions.Item.PreviousVersionDefinition.Presentations.PresentationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceManagement.GroupPolicyDefinitions.Item.PreviousVersionDefinition.PreviousVersionDefinitionRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceManagement.GroupPolicyDefinitions.Item.PreviousVersionDefinition.PreviousVersionDefinitionRequestBuilder.PreviousVersionDefinitionRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceManagement.GroupPolicyDefinitions.Item.PreviousVersionDefinition.PreviousVersionDefinitionRequestBuilder.PreviousVersionDefinitionRequestBuilderGetQueryParameters>> requestConfiguration = default)
