...
using ApiSdk.Reports.GetApiUsageserviceAreaServiceAreaPeriodPeriodAppIdAppId;
...
namespace ApiSdk.Reports
{
    ...
    public partial class ReportsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildGetApiUsageserviceAreaServiceAreaPeriodPeriodAppIdAppIdNavCommand()
        {
            var command = new Command("get-api-usageservice-area-service-area-period-period-app-id-app-id");
            command.Description = "Provides operations to call the getApiUsage method.";
            var builder = new global::ApiSdk.Reports.GetApiUsageserviceAreaServiceAreaPeriodPeriodAppIdAppId.GetApiUsageserviceAreaServiceAreaPeriodPeriodAppIdAppIdRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildServiceActivityNavCommand()
        {
            ...
            nonExecCommands.Add(builder.BuildGetMetricsForConditionalAccessBlockedSignInWithInclusiveIntervalStartDateTimeWithExclusiveIntervalEndDateTimeWithAggregationIntervalInMinutesRbCommand());
