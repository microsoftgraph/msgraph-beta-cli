...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class WindowsPhone81SCEPCertificateProfile : ApiSdk.Models.WindowsPhone81CertificateProfileBase, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.WindowsPhone81TrustedRootCertificate? RootCertificate { get; set; }
#nullable restore
#else
        public ApiSdk.Models.WindowsPhone81TrustedRootCertificate RootCertificate { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.WindowsPhone81SCEPCertificateProfile"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.WindowsPhone81SCEPCertificateProfile"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.WindowsPhone81SCEPCertificateProfile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.WindowsPhone81SCEPCertificateProfile();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "rootCertificate", n => { RootCertificate = n.GetObjectValue<ApiSdk.Models.WindowsPhone81TrustedRootCertificate>(ApiSdk.Models.WindowsPhone81TrustedRootCertificate.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.WindowsPhone81TrustedRootCertificate>("rootCertificate", RootCertificate);
