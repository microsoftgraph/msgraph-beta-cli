    ...
    public class MicrosoftApplicationDataAccessRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.MicrosoftApplicationDataAccessSettings>(ApiSdk.Models.MicrosoftApplicationDataAccessSettings.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Organization.Item.Settings.MicrosoftApplicationDataAccess.MicrosoftApplicationDataAccessRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Organization.Item.Settings.MicrosoftApplicationDataAccess.MicrosoftApplicationDataAccessRequestBuilder.MicrosoftApplicationDataAccessRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Organization.Item.Settings.MicrosoftApplicationDataAccess.MicrosoftApplicationDataAccessRequestBuilder.MicrosoftApplicationDataAccessRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.MicrosoftApplicationDataAccessSettings body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.MicrosoftApplicationDataAccessSettings body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
