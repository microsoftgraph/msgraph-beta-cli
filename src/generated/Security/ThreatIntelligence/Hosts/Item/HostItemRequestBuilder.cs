...
namespace ApiSdk.Security.ThreatIntelligence.Hosts.Item
{
    ...
    public partial class HostItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildChildHostPairsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.ThreatIntelligence.Hosts.Item.ChildHostPairs.ChildHostPairsRequestBuilder(PathParameters);
        ...
        public Command BuildComponentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.ThreatIntelligence.Hosts.Item.Components.ComponentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildCookiesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.ThreatIntelligence.Hosts.Item.Cookies.CookiesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildHostPairsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.ThreatIntelligence.Hosts.Item.HostPairs.HostPairsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildParentHostPairsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.ThreatIntelligence.Hosts.Item.ParentHostPairs.ParentHostPairsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildPassiveDnsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.ThreatIntelligence.Hosts.Item.PassiveDns.PassiveDnsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildPassiveDnsReverseNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.ThreatIntelligence.Hosts.Item.PassiveDnsReverse.PassiveDnsReverseRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Security.Host>(global::ApiSdk.Models.Security.Host.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPortsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.ThreatIntelligence.Hosts.Item.Ports.PortsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildReputationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.ThreatIntelligence.Hosts.Item.Reputation.ReputationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSslCertificatesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.ThreatIntelligence.Hosts.Item.SslCertificates.SslCertificatesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildSubdomainsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.ThreatIntelligence.Hosts.Item.Subdomains.SubdomainsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildTrackersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.ThreatIntelligence.Hosts.Item.Trackers.TrackersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildWhoisNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.ThreatIntelligence.Hosts.Item.Whois.WhoisRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Security.ThreatIntelligence.Hosts.Item.HostItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.ThreatIntelligence.Hosts.Item.HostItemRequestBuilder.HostItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.ThreatIntelligence.Hosts.Item.HostItemRequestBuilder.HostItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Security.Host body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Security.Host body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
