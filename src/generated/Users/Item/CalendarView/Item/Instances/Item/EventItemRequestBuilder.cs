...
using ApiSdk.Models;
using ApiSdk.Users.Item.CalendarView.Item.Instances.Item.Accept;
using ApiSdk.Users.Item.CalendarView.Item.Instances.Item.Attachments;
using ApiSdk.Users.Item.CalendarView.Item.Instances.Item.Calendar;
using ApiSdk.Users.Item.CalendarView.Item.Instances.Item.Cancel;
using ApiSdk.Users.Item.CalendarView.Item.Instances.Item.Decline;
using ApiSdk.Users.Item.CalendarView.Item.Instances.Item.DismissReminder;
using ApiSdk.Users.Item.CalendarView.Item.Instances.Item.ExceptionOccurrences;
using ApiSdk.Users.Item.CalendarView.Item.Instances.Item.Extensions;
using ApiSdk.Users.Item.CalendarView.Item.Instances.Item.Forward;
using ApiSdk.Users.Item.CalendarView.Item.Instances.Item.PermanentDelete;
using ApiSdk.Users.Item.CalendarView.Item.Instances.Item.SnoozeReminder;
using ApiSdk.Users.Item.CalendarView.Item.Instances.Item.TentativelyAccept;
...
namespace ApiSdk.Users.Item.CalendarView.Item.Instances.Item
{
    ...
    public partial class EventItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAcceptNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CalendarView.Item.Instances.Item.Accept.AcceptRequestBuilder(PathParameters);
        ...
        public Command BuildAttachmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CalendarView.Item.Instances.Item.Attachments.AttachmentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCalendarNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CalendarView.Item.Instances.Item.Calendar.CalendarRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCancelNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CalendarView.Item.Instances.Item.Cancel.CancelRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDeclineNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CalendarView.Item.Instances.Item.Decline.DeclineRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDismissReminderNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CalendarView.Item.Instances.Item.DismissReminder.DismissReminderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildExceptionOccurrencesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CalendarView.Item.Instances.Item.ExceptionOccurrences.ExceptionOccurrencesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildExtensionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CalendarView.Item.Instances.Item.Extensions.ExtensionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildForwardNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CalendarView.Item.Instances.Item.Forward.ForwardRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPermanentDeleteNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CalendarView.Item.Instances.Item.PermanentDelete.PermanentDeleteRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSnoozeReminderNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CalendarView.Item.Instances.Item.SnoozeReminder.SnoozeReminderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTentativelyAcceptNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CalendarView.Item.Instances.Item.TentativelyAccept.TentativelyAcceptRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.CalendarView.Item.Instances.Item.EventItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}?endDateTime={endDateTime}&startDateTime={startDateTime}{&%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.CalendarView.Item.Instances.Item.EventItemRequestBuilder"/> and sets the default values.
        ...
        public EventItemRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}?endDateTime={endDateTime}&startDateTime={startDateTime}{&%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// The occurrences of a recurring series, if the event is a series master. This property includes occurrences that are part of the recurrence pattern and exceptions that have been modified. It doesn&apos;t include occurrences that have been canceled from the series. Navigation property. Read-only. Nullable.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.CalendarView.Item.Instances.Item.EventItemRequestBuilder.EventItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.CalendarView.Item.Instances.Item.EventItemRequestBuilder.EventItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
