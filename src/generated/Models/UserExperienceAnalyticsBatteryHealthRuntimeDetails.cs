...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class UserExperienceAnalyticsBatteryHealthRuntimeDetails : ApiSdk.Models.Entity, IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.UserExperienceAnalyticsBatteryHealthRuntimeDetails"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.UserExperienceAnalyticsBatteryHealthRuntimeDetails CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.UserExperienceAnalyticsBatteryHealthRuntimeDetails();
        }
        /// <summary>
