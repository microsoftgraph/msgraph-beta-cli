...
#nullable restore
        ...
        public global::ApiSdk.Models.Security.EventSource? EventSource { get; set; }
...
#nullable restore
        ...
        public global::ApiSdk.Models.Security.TimelineEventType? EventType { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Models.Security.TimelineEvent"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.Security.TimelineEvent"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ApiSdk.Models.Security.TimelineEvent CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.Security.TimelineEvent();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "eventSource", n => { EventSource = n.GetEnumValue<global::ApiSdk.Models.Security.EventSource>(); } },
                { "eventThreats", n => { EventThreats = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "eventType", n => { EventType = n.GetEnumValue<global::ApiSdk.Models.Security.TimelineEventType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.Security.EventSource>("eventSource", EventSource);
            writer.WriteCollectionOfPrimitiveValues<string>("eventThreats", EventThreats);
            writer.WriteEnumValue<global::ApiSdk.Models.Security.TimelineEventType>("eventType", EventType);
