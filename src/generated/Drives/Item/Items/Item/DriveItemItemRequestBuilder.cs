...
namespace ApiSdk.Drives.Item.Items.Item
{
    ...
    public class DriveItemItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildActivitiesNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.Activities.ActivitiesRequestBuilder(PathParameters);
        ...
        public Command BuildAnalyticsNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.Analytics.AnalyticsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildAssignSensitivityLabelNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.AssignSensitivityLabel.AssignSensitivityLabelRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCheckinNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.Checkin.CheckinRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildCheckoutNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.Checkout.CheckoutRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildChildrenNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.Children.ChildrenRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildContentNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.Content.ContentRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildContentStreamNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the drive entity.";
            var builder = new ApiSdk.Drives.Item.Items.Item.ContentStream.ContentStreamRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        public Command BuildCopyNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.Copy.CopyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildCreatedByUserNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.CreatedByUser.CreatedByUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildCreateLinkNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.CreateLink.CreateLinkRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildCreateUploadSessionNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.CreateUploadSession.CreateUploadSessionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDeltaNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.Delta.DeltaRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDeltaWithTokenRbCommand()
        {
            ...
            command.Description = "Provides operations to call the delta method.";
            var builder = new ApiSdk.Drives.Item.Items.Item.DeltaWithToken.DeltaWithTokenRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildExtractSensitivityLabelsNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.ExtractSensitivityLabels.ExtractSensitivityLabelsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildFollowNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.Follow.FollowRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRbCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildInviteNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.Invite.InviteRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildLastModifiedByUserNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.LastModifiedByUser.LastModifiedByUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            nonExecCommands.Add(builder.BuildMailboxSettingsNavCommand());
        ...
        public Command BuildListItemNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.ListItem.ListItemRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPermanentDeleteNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.PermanentDelete.PermanentDeleteRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPermissionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.Permissions.PermissionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPreviewNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.Preview.PreviewRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRestoreNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.Restore.RestoreRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRetentionLabelNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.RetentionLabel.RetentionLabelRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildSearchWithQRbCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.SearchWithQ.SearchWithQRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSubscriptionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.Subscriptions.SubscriptionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildThumbnailsNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.Thumbnails.ThumbnailsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildUnfollowNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.Unfollow.UnfollowRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildValidatePermissionNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.ValidatePermission.ValidatePermissionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildVersionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.Versions.VersionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildWorkbookNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.Workbook.WorkbookRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Drives.Item.Items.Item.DriveItemItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Drives.Item.Items.Item.DriveItemItemRequestBuilder.DriveItemItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Drives.Item.Items.Item.DriveItemItemRequestBuilder.DriveItemItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
