    ...
    public class ArticleIndicatorItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ArticleIndicator>(ArticleIndicator.CreateFromDiscriminatorValue);
                if (model is null) {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ArticleIndicator body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ArticleIndicator body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
