...
namespace ApiSdk.Groups
{
    ...
    public partial class GroupsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildEvaluateDynamicMembershipNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.EvaluateDynamicMembership.EvaluateDynamicMembershipRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGetUserOwnedObjectsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.GetUserOwnedObjects.GetUserOwnedObjectsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
