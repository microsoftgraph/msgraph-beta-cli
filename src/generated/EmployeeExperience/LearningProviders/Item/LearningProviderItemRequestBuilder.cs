...
namespace ApiSdk.EmployeeExperience.LearningProviders.Item
{
    ...
    public class LearningProviderItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildLearningContentsNavCommand()
        {
            ...
            var builder = new ApiSdk.EmployeeExperience.LearningProviders.Item.LearningContents.LearningContentsRequestBuilder(PathParameters);
        ...
        public Command BuildLearningContentsWithExternalIdRbCommand()
        {
            ...
            command.Description = "Provides operations to manage the learningContents property of the microsoft.graph.learningProvider entity.";
            var builder = new ApiSdk.EmployeeExperience.LearningProviders.Item.LearningContentsWithExternalId.LearningContentsWithExternalIdRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildLearningCourseActivitiesNavCommand()
        {
            ...
            var builder = new ApiSdk.EmployeeExperience.LearningProviders.Item.LearningCourseActivities.LearningCourseActivitiesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildLearningCourseActivitiesWithExternalcourseActivityIdRbCommand()
        {
            ...
            command.Description = "Provides operations to manage the learningCourseActivities property of the microsoft.graph.learningProvider entity.";
            var builder = new ApiSdk.EmployeeExperience.LearningProviders.Item.LearningCourseActivitiesWithExternalcourseActivityId.LearningCourseActivitiesWithExternalcourseActivityIdRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.LearningProvider>(ApiSdk.Models.LearningProvider.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.EmployeeExperience.LearningProviders.Item.LearningProviderItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.EmployeeExperience.LearningProviders.Item.LearningProviderItemRequestBuilder.LearningProviderItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.EmployeeExperience.LearningProviders.Item.LearningProviderItemRequestBuilder.LearningProviderItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.LearningProvider body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.LearningProvider body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
