...
using System;
namespace ApiSdk.Sites.Item.GetByPathWithPath.Permissions {
    /// <summary>
    ...
    public class PermissionsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public PermissionsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/permissions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="PermissionsRequestBuilder"/> and sets the default values.
        ...
        public PermissionsRequestBuilder(string rawUrl) : base("{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/permissions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get the permission resources from the permissions navigation property on a site.
