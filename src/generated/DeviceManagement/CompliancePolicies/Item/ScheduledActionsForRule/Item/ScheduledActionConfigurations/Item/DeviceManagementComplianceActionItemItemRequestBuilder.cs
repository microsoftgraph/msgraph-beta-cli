...
using System;
namespace ApiSdk.DeviceManagement.CompliancePolicies.Item.ScheduledActionsForRule.Item.ScheduledActionConfigurations.Item {
    /// <summary>
    ...
    /// </summary>
    public class DeviceManagementComplianceActionItemItemRequestBuilder : BaseCliRequestBuilder 
    {
        /// <summary>
        ...
        public Command BuildDeleteCommand()
        {
            ...
            var deviceManagementComplianceActionItemIdOption = new Option<string>("--device-management-compliance-action-item-id", description: "The unique identifier of deviceManagementComplianceActionItem") {
            };
            deviceManagementComplianceActionItemIdOption.IsRequired = true;
            command.AddOption(deviceManagementComplianceActionItemIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var deviceManagementComplianceActionItemId = invocationContext.ParseResult.GetValueForOption(deviceManagementComplianceActionItemIdOption);
                ...
                if (deviceManagementComplianceActionItemId is not null) requestInfo.PathParameters.Add("deviceManagementComplianceActionItem%2Did", deviceManagementComplianceActionItemId);
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "The list of scheduled action configurations for this compliance policy. This collection can contain a maximum of 100 elements.";
            var deviceManagementCompliancePolicyIdOption = new Option<string>("--device-management-compliance-policy-id", description: "The unique identifier of deviceManagementCompliancePolicy") {
            };
            deviceManagementCompliancePolicyIdOption.IsRequired = true;
            command.AddOption(deviceManagementCompliancePolicyIdOption);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<DeviceManagementComplianceActionItem>(DeviceManagementComplianceActionItem.CreateFromDiscriminatorValue);
                if (model is null) {
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/deviceManagement/compliancePolicies/{deviceManagementCompliancePolicy%2Did}/scheduledActionsForRule/{deviceManagementComplianceScheduledActionForRule%2Did}/scheduledActionConfigurations/{deviceManagementComplianceActionItem%2Did}", PathParameters);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<DeviceManagementComplianceActionItemItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<DeviceManagementComplianceActionItemItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(DeviceManagementComplianceActionItem body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(DeviceManagementComplianceActionItem body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.PATCH, "{+baseurl}/deviceManagement/compliancePolicies/{deviceManagementCompliancePolicy%2Did}/scheduledActionsForRule/{deviceManagementComplianceScheduledActionForRule%2Did}/scheduledActionConfigurations/{deviceManagementComplianceActionItem%2Did}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
