...
using ApiSdk.Privacy.SubjectRightsRequests.Item.ApproversWithUserPrincipalName;
using ApiSdk.Privacy.SubjectRightsRequests.Item.Collaborators;
using ApiSdk.Privacy.SubjectRightsRequests.Item.CollaboratorsWithUserPrincipalName;
...
namespace ApiSdk.Privacy.SubjectRightsRequests.Item
{
    ...
    public partial class SubjectRightsRequestItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildApproversNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Privacy.SubjectRightsRequests.Item.Approvers.ApproversRequestBuilder(PathParameters);
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildApproversWithUserPrincipalNameRbCommand()
        {
            var command = new Command("approvers-with-user-principal-name");
            command.Description = "Provides operations to manage the approvers property of the microsoft.graph.subjectRightsRequest entity.";
            var builder = new global::ApiSdk.Privacy.SubjectRightsRequests.Item.ApproversWithUserPrincipalName.ApproversWithUserPrincipalNameRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCollaboratorsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Privacy.SubjectRightsRequests.Item.Collaborators.CollaboratorsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildCollaboratorsWithUserPrincipalNameRbCommand()
        {
            var command = new Command("collaborators-with-user-principal-name");
            command.Description = "Provides operations to manage the collaborators property of the microsoft.graph.subjectRightsRequest entity.";
            var builder = new global::ApiSdk.Privacy.SubjectRightsRequests.Item.CollaboratorsWithUserPrincipalName.CollaboratorsWithUserPrincipalNameRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetFinalAttachmentNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Privacy.SubjectRightsRequests.Item.GetFinalAttachment.GetFinalAttachmentRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetFinalReportNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Privacy.SubjectRightsRequests.Item.GetFinalReport.GetFinalReportRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildNotesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Privacy.SubjectRightsRequests.Item.Notes.NotesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the properties of a subjectRightsRequest object.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/subjectrightsrequest-update?view=graph-rest-beta";
            var subjectRightsRequestIdOption = new Option<string>("--subject-rights-request-id", description: "The unique identifier of subjectRightsRequest") {
            };
            subjectRightsRequestIdOption.IsRequired = true;
            command.AddOption(subjectRightsRequestIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.SubjectRightsRequest>(global::ApiSdk.Models.SubjectRightsRequest.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildTeamNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Privacy.SubjectRightsRequests.Item.Team.TeamRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Privacy.SubjectRightsRequests.Item.SubjectRightsRequestItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Privacy.SubjectRightsRequests.Item.SubjectRightsRequestItemRequestBuilder.SubjectRightsRequestItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Privacy.SubjectRightsRequests.Item.SubjectRightsRequestItemRequestBuilder.SubjectRightsRequestItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.SubjectRightsRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.SubjectRightsRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
