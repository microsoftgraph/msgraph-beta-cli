...
namespace ApiSdk.Models
{
    ...
    public partial class Notification : global::ApiSdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.PayloadTypes? Payload { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.PayloadTypes Payload { get; set; }
#endif
        ...
        public global::ApiSdk.Models.Priority? Priority { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.TargetPolicyEndpoints? TargetPolicy { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.TargetPolicyEndpoints TargetPolicy { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.Notification"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.Notification CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.Notification();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "payload", n => { Payload = n.GetObjectValue<global::ApiSdk.Models.PayloadTypes>(global::ApiSdk.Models.PayloadTypes.CreateFromDiscriminatorValue); } },
                { "priority", n => { Priority = n.GetEnumValue<global::ApiSdk.Models.Priority>(); } },
                { "targetHostName", n => { TargetHostName = n.GetStringValue(); } },
                { "targetPolicy", n => { TargetPolicy = n.GetObjectValue<global::ApiSdk.Models.TargetPolicyEndpoints>(global::ApiSdk.Models.TargetPolicyEndpoints.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::ApiSdk.Models.PayloadTypes>("payload", Payload);
            writer.WriteEnumValue<global::ApiSdk.Models.Priority>("priority", Priority);
            writer.WriteStringValue("targetHostName", TargetHostName);
            writer.WriteObjectValue<global::ApiSdk.Models.TargetPolicyEndpoints>("targetPolicy", TargetPolicy);
        }
    }
}
