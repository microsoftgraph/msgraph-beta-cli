...
using System;
namespace ApiSdk.Users.Item.OwnedObjects.Item.GraphApplication {
    /// <summary>
    ...
    public class GraphApplicationRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public GraphApplicationRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/ownedObjects/{directoryObject%2Did}/graph.application{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="GraphApplicationRequestBuilder"/> and sets the default values.
        ...
        public GraphApplicationRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/ownedObjects/{directoryObject%2Did}/graph.application{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.application
