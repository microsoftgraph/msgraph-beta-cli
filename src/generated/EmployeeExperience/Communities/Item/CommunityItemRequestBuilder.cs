...
namespace ApiSdk.EmployeeExperience.Communities.Item {
    ...
    public class CommunityItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property communities for employeeExperience";
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property communities in employeeExperience";
            var communityIdOption = new Option<string>("--community-id", description: "The unique identifier of community") {
            };
            communityIdOption.IsRequired = true;
            command.AddOption(communityIdOption);
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/employeeExperience/communities/{community%2Did}", PathParameters);
...
#nullable restore
        ...
        public RequestInformation ToPatchRequestInformation(Community body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.PATCH, "{+baseurl}/employeeExperience/communities/{community%2Did}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
