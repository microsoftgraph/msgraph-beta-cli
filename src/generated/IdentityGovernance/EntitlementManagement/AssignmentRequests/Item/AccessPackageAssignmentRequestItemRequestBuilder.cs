...
using ApiSdk.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item.AccessPackageAssignment;
...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item
{
    ...
    public class AccessPackageAssignmentRequestItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAccessPackageAssignmentNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item.AccessPackageAssignment.AccessPackageAssignmentRequestBuilder(PathParameters);
        ...
        public Command BuildAccessPackageNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item.AccessPackage.AccessPackageRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildCancelNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item.Cancel.CancelRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildReprocessNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item.Reprocess.ReprocessRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRequestorNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item.Requestor.RequestorRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildResumeNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item.Resume.ResumeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item.AccessPackageAssignmentRequestItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item.AccessPackageAssignmentRequestItemRequestBuilder.AccessPackageAssignmentRequestItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item.AccessPackageAssignmentRequestItemRequestBuilder.AccessPackageAssignmentRequestItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
