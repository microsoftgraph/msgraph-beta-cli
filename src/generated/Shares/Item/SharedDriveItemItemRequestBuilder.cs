...
namespace ApiSdk.Shares.Item
{
    ...
    public partial class SharedDriveItemItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildCreatedByUserNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.CreatedByUser.CreatedByUserRequestBuilder(PathParameters);
        ...
        public Command BuildDriveItemNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.DriveItem.DriveItemRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildItemsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.Items.ItemsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildLastModifiedByUserNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.LastModifiedByUser.LastModifiedByUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            nonExecCommands.Add(builder.BuildMailboxSettingsNavCommand());
        ...
        public Command BuildListItemNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.ListItem.ListItemRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildListNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.ListRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.SharedDriveItem>(global::ApiSdk.Models.SharedDriveItem.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPermissionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.Permission.PermissionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            ...
            execCommands.Add(builder.BuildPatchCommand());
            nonExecCommands.Add(builder.BuildRevokeGrantsNavCommand());
            foreach (var cmd in execCommands)
            {
                command.AddCommand(cmd);
            }
        ...
        public Command BuildRootNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.Root.RootRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildContentNavCommand());
            nonExecCommands.Add(builder.BuildContentStreamNavCommand());
        ...
        public Command BuildSiteNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.Site.SiteRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Shares.Item.SharedDriveItemItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Shares.Item.SharedDriveItemItemRequestBuilder.SharedDriveItemItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Shares.Item.SharedDriveItemItemRequestBuilder.SharedDriveItemItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.SharedDriveItem body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.SharedDriveItem body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
