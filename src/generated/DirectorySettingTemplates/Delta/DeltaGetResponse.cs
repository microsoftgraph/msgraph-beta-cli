...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.DirectorySettingTemplates.Delta.DeltaGetResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.DirectorySettingTemplates.Delta.DeltaGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.DirectorySettingTemplates.Delta.DeltaGetResponse();
        }
        /// <summary>
