...
using ApiSdk.Models;
using ApiSdk.Users.Item.MemberOf.GraphDirectoryRole.Count;
...
using System;
namespace ApiSdk.Users.Item.MemberOf.GraphDirectoryRole {
    /// <summary>
    ...
    public class GraphDirectoryRoleRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public GraphDirectoryRoleRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/memberOf/graph.directoryRole{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="GraphDirectoryRoleRequestBuilder"/> and sets the default values.
        ...
        public GraphDirectoryRoleRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/memberOf/graph.directoryRole{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get the items of type microsoft.graph.directoryRole in the microsoft.graph.directoryObject collection
