...
namespace ApiSdk.Models
{
    ...
    public class ApplicationTemplate : ApiSdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.InformationalUrls? InformationalUrls { get; set; }
#nullable restore
#else
        public ApiSdk.Models.InformationalUrls InformationalUrls { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.SupportedClaimConfiguration? SupportedClaimConfiguration { get; set; }
#nullable restore
#else
        public ApiSdk.Models.SupportedClaimConfiguration SupportedClaimConfiguration { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.ApplicationTemplate"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.ApplicationTemplate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.ApplicationTemplate();
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.InformationalUrls>("informationalUrls", InformationalUrls);
            writer.WriteStringValue("logoUrl", LogoUrl);
            writer.WriteStringValue("publisher", Publisher);
            writer.WriteObjectValue<ApiSdk.Models.SupportedClaimConfiguration>("supportedClaimConfiguration", SupportedClaimConfiguration);
