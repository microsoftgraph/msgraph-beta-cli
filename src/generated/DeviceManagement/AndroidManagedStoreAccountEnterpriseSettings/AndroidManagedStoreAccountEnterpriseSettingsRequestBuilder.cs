    ...
    public class AndroidManagedStoreAccountEnterpriseSettingsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.AndroidManagedStoreAccountEnterpriseSettings>(ApiSdk.Models.AndroidManagedStoreAccountEnterpriseSettings.CreateFromDiscriminatorValue);
                if (model is null) {
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/deviceManagement/androidManagedStoreAccountEnterpriseSettings", PathParameters);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.AndroidManagedStoreAccountEnterpriseSettings body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.AndroidManagedStoreAccountEnterpriseSettings body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.PATCH, "{+baseurl}/deviceManagement/androidManagedStoreAccountEnterpriseSettings", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
