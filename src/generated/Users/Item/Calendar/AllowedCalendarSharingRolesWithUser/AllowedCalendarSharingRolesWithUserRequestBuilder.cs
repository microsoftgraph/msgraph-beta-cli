...
namespace ApiSdk.Users.Item.Calendar.AllowedCalendarSharingRolesWithUser {
    ...
    public class AllowedCalendarSharingRolesWithUserRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public AllowedCalendarSharingRolesWithUserRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/calendar/allowedCalendarSharingRoles(User='{User}'){?%24count,%24filter,%24search,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="AllowedCalendarSharingRolesWithUserRequestBuilder"/> and sets the default values.
        ...
        public AllowedCalendarSharingRolesWithUserRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/calendar/allowedCalendarSharingRoles(User='{User}'){?%24count,%24filter,%24search,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Invoke function allowedCalendarSharingRoles
