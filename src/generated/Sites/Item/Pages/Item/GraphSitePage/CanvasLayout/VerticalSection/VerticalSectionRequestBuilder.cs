...
using ApiSdk.Models;
using ApiSdk.Sites.Item.Pages.Item.GraphSitePage.CanvasLayout.VerticalSection.Webparts;
    ...
    public class VerticalSectionRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.VerticalSection>(ApiSdk.Models.VerticalSection.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public VerticalSectionRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/pages/{baseSitePage%2Did}/graph.sitePage/canvasLayout/verticalSection{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="VerticalSectionRequestBuilder"/> and sets the default values.
        ...
        public VerticalSectionRequestBuilder(string rawUrl) : base("{+baseurl}/sites/{site%2Did}/pages/{baseSitePage%2Did}/graph.sitePage/canvasLayout/verticalSection{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property verticalSection for sites
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.VerticalSection body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.VerticalSection body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
