...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.TeamworkDevice>? Devices { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.TeamworkDevice> Devices { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.TeamTemplate>? TeamTemplates { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.TeamTemplate> TeamTemplates { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "devices", n => { Devices = n.GetCollectionOfObjectValues<global::ApiSdk.Models.TeamworkDevice>(global::ApiSdk.Models.TeamworkDevice.CreateFromDiscriminatorValue)?.AsList(); } },
                { "isTeamsEnabled", n => { IsTeamsEnabled = n.GetBoolValue(); } },
                { "region", n => { Region = n.GetStringValue(); } },
                { "teamTemplates", n => { TeamTemplates = n.GetCollectionOfObjectValues<global::ApiSdk.Models.TeamTemplate>(global::ApiSdk.Models.TeamTemplate.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.TeamworkDevice>("devices", Devices);
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.TeamTemplate>("teamTemplates", TeamTemplates);
