...
namespace ApiSdk.DeviceAppManagement.MobileApps {
    ...
    public class MobileAppsRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "List properties and relationships of the iosVppApp objects.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/intune-apps-iosvppapp-list?view=graph-rest-1.0";
