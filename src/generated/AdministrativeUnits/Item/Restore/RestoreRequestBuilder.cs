...
using System;
namespace ApiSdk.AdministrativeUnits.Item.Restore
{
    /// <summary>
    ...
    public partial class RestoreRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.AdministrativeUnits.Item.Restore.RestorePostRequestBody>(global::ApiSdk.AdministrativeUnits.Item.Restore.RestorePostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.AdministrativeUnits.Item.Restore.RestoreRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public RestoreRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/restore", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.AdministrativeUnits.Item.Restore.RestoreRequestBuilder"/> and sets the default values.
        ...
        public RestoreRequestBuilder(string rawUrl) : base("{+baseurl}/administrativeUnits/{administrativeUnit%2Did}/restore", rawUrl)
        {
        }
        /// <summary>
        /// Restore a recently deleted directory object from deleted items. The following types are supported:- administrativeUnit- application- certificateBasedAuthPki- certificateAuthorityDetail- externalUserProfile- group- pendingExternalUserProfile- servicePrincipal- user If an item was accidentally deleted, you can fully restore the item. This isn&apos;t applicable to security groups, which are deleted permanently. Also, restoring an application doesn&apos;t restore the associated service principal automatically. You must call this API to explicitly restore the deleted service principal. A recently deleted item remains available for up to 30 days. After 30 days, the item is permanently deleted.
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.AdministrativeUnits.Item.Restore.RestorePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.AdministrativeUnits.Item.Restore.RestorePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
