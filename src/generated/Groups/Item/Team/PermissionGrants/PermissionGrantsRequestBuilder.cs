// <auto-generated/>
using ApiSdk.Groups.Item.Team.PermissionGrants.Count;
using ApiSdk.Groups.Item.Team.PermissionGrants.Item;
...
namespace ApiSdk.Groups.Item.Team.PermissionGrants {
    ...
    public class PermissionGrantsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public PermissionGrantsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/team/permissionGrants{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="PermissionGrantsRequestBuilder"/> and sets the default values.
        ...
        public PermissionGrantsRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/team/permissionGrants{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// List all resource-specific permission grants on the team. This list specifies the Microsoft Entra apps that have access to the team, along with the corresponding kind of resource-specific access that each app has.
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(ResourceSpecificPermissionGrant body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/groups/{group%2Did}/team/permissionGrants", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
