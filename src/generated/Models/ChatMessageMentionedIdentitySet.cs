...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.TeamworkTagIdentity? Tag { get; set; }
#nullable restore
#else
        public ApiSdk.Models.TeamworkTagIdentity Tag { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "tag", n => { Tag = n.GetObjectValue<ApiSdk.Models.TeamworkTagIdentity>(ApiSdk.Models.TeamworkTagIdentity.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.TeamworkTagIdentity>("tag", Tag);
        }
    }
}
