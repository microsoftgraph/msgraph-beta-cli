...
using System;
namespace ApiSdk.Sites.Item.Lists.Item.Permissions.Item.RevokeGrants
{
    /// <summary>
    ...
    public partial class RevokeGrantsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Sites.Item.Lists.Item.Permissions.Item.RevokeGrants.RevokeGrantsPostRequestBody>(global::ApiSdk.Sites.Item.Lists.Item.Permissions.Item.RevokeGrants.RevokeGrantsPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Sites.Item.Lists.Item.Permissions.Item.RevokeGrants.RevokeGrantsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public RevokeGrantsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/permissions/{permission%2Did}/revokeGrants", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Sites.Item.Lists.Item.Permissions.Item.RevokeGrants.RevokeGrantsRequestBuilder"/> and sets the default values.
        ...
        public RevokeGrantsRequestBuilder(string rawUrl) : base("{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/permissions/{permission%2Did}/revokeGrants", rawUrl)
        {
        }
        /// <summary>
        /// Revoke access to a listItem or driveItem granted via a sharing link by removing the specified recipient from the link.
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Sites.Item.Lists.Item.Permissions.Item.RevokeGrants.RevokeGrantsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Sites.Item.Lists.Item.Permissions.Item.RevokeGrants.RevokeGrantsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
