...
using ApiSdk.Chats.Item.Messages.Item.SetReaction;
using ApiSdk.Chats.Item.Messages.Item.SoftDelete;
using ApiSdk.Chats.Item.Messages.Item.UndoSoftDelete;
using ApiSdk.Chats.Item.Messages.Item.UnsetReaction;
...
namespace ApiSdk.Chats.Item.Messages.Item
{
    ...
    public class ChatMessageItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property messages for chats";
        ...
        public Command BuildHostedContentsNavCommand()
        {
            ...
            var builder = new ApiSdk.Chats.Item.Messages.Item.HostedContents.HostedContentsRequestBuilder(PathParameters);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property messages in chats";
            var chatIdOption = new Option<string>("--chat-id", description: "The unique identifier of chat") {
            };
            chatIdOption.IsRequired = true;
            command.AddOption(chatIdOption);
        ...
        public Command BuildRepliesNavCommand()
        {
            ...
            var builder = new ApiSdk.Chats.Item.Messages.Item.Replies.RepliesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildSetReactionNavCommand()
        {
            ...
            var builder = new ApiSdk.Chats.Item.Messages.Item.SetReaction.SetReactionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSoftDeleteNavCommand()
        {
            ...
            var builder = new ApiSdk.Chats.Item.Messages.Item.SoftDelete.SoftDeleteRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUndoSoftDeleteNavCommand()
        {
            ...
            var builder = new ApiSdk.Chats.Item.Messages.Item.UndoSoftDelete.UndoSoftDeleteRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUnsetReactionNavCommand()
        {
            ...
            var builder = new ApiSdk.Chats.Item.Messages.Item.UnsetReaction.UnsetReactionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Chats.Item.Messages.Item.ChatMessageItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public ChatMessageItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/chats/{chat%2Did}/messages/{chatMessage%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Chats.Item.Messages.Item.ChatMessageItemRequestBuilder"/> and sets the default values.
        ...
        public ChatMessageItemRequestBuilder(string rawUrl) : base("{+baseurl}/chats/{chat%2Did}/messages/{chatMessage%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property messages for chats
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Chats.Item.Messages.Item.ChatMessageItemRequestBuilder.ChatMessageItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Chats.Item.Messages.Item.ChatMessageItemRequestBuilder.ChatMessageItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
