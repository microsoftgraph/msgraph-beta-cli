...
namespace ApiSdk.Models
{
    ...
    public partial class DepIOSEnrollmentProfile : global::ApiSdk.Models.DepEnrollmentBaseProfile, IParsable
    {
...
#nullable restore
        ...
        public global::ApiSdk.Models.ITunesPairingMode? ITunesPairingMode { get; set; }
        /// <summary>Management certificates for Apple Configurator</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.ManagementCertificateWithThumbprint>? ManagementCertificates { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.ManagementCertificateWithThumbprint> ManagementCertificates { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Models.DepIOSEnrollmentProfile"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.DepIOSEnrollmentProfile"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.DepIOSEnrollmentProfile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.DepIOSEnrollmentProfile();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "iTunesPairingMode", n => { ITunesPairingMode = n.GetEnumValue<global::ApiSdk.Models.ITunesPairingMode>(); } },
                { "managementCertificates", n => { ManagementCertificates = n.GetCollectionOfObjectValues<global::ApiSdk.Models.ManagementCertificateWithThumbprint>(global::ApiSdk.Models.ManagementCertificateWithThumbprint.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.ITunesPairingMode>("iTunesPairingMode", ITunesPairingMode);
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.ManagementCertificateWithThumbprint>("managementCertificates", ManagementCertificates);
