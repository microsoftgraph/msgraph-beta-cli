...
using ApiSdk.AppCatalogs.TeamsApps.Item.AppDefinitions.Item.ColorIcon;
using ApiSdk.AppCatalogs.TeamsApps.Item.AppDefinitions.Item.DashboardCards;
using ApiSdk.AppCatalogs.TeamsApps.Item.AppDefinitions.Item.OutlineIcon;
...
namespace ApiSdk.AppCatalogs.TeamsApps.Item.AppDefinitions.Item
{
    ...
    public partial class TeamsAppDefinitionItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildBotNavCommand()
        {
            ...
            var builder = new global::ApiSdk.AppCatalogs.TeamsApps.Item.AppDefinitions.Item.Bot.BotRequestBuilder(PathParameters);
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildColorIconNavCommand()
        {
            var command = new Command("color-icon");
            command.Description = "Provides operations to manage the colorIcon property of the microsoft.graph.teamsAppDefinition entity.";
            var builder = new global::ApiSdk.AppCatalogs.TeamsApps.Item.AppDefinitions.Item.ColorIcon.ColorIconRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            nonExecCommands.Add(builder.BuildHostedContentNavCommand());
            execCommands.Add(builder.BuildPatchCommand());
            foreach (var cmd in execCommands)
            {
                command.AddCommand(cmd);
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildDashboardCardsNavCommand()
        {
            var command = new Command("dashboard-cards");
            command.Description = "Provides operations to manage the dashboardCards property of the microsoft.graph.teamsAppDefinition entity.";
            var builder = new global::ApiSdk.AppCatalogs.TeamsApps.Item.AppDefinitions.Item.DashboardCards.DashboardCardsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildOutlineIconNavCommand()
        {
            var command = new Command("outline-icon");
            command.Description = "Provides operations to manage the outlineIcon property of the microsoft.graph.teamsAppDefinition entity.";
            var builder = new global::ApiSdk.AppCatalogs.TeamsApps.Item.AppDefinitions.Item.OutlineIcon.OutlineIconRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.TeamsAppDefinition>(global::ApiSdk.Models.TeamsAppDefinition.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.AppCatalogs.TeamsApps.Item.AppDefinitions.Item.TeamsAppDefinitionItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.AppCatalogs.TeamsApps.Item.AppDefinitions.Item.TeamsAppDefinitionItemRequestBuilder.TeamsAppDefinitionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.AppCatalogs.TeamsApps.Item.AppDefinitions.Item.TeamsAppDefinitionItemRequestBuilder.TeamsAppDefinitionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.TeamsAppDefinition body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.TeamsAppDefinition body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
