...
namespace ApiSdk.Users.Item.Todo.Lists.Item.Tasks.Item.ChecklistItems
{
    ...
    public class ChecklistItemsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new ChecklistItemItemRequestBuilder(PathParameters);
        ...
        public Command BuildCreateCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ChecklistItem>(ChecklistItem.CreateFromDiscriminatorValue);
                if (model is null) {
