...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class Windows81GeneralConfiguration : ApiSdk.Models.DeviceConfiguration, IParsable
    {
...
#nullable restore
        ...
        public ApiSdk.Models.InternetSiteSecurityLevel? BrowserInternetSecurityLevel { get; set; }
        /// <summary>Possible values for site security level.</summary>
        public ApiSdk.Models.SiteSecurityLevel? BrowserIntranetSecurityLevel { get; set; }
...
#nullable restore
        ...
        /// <summary>Possible values for site security level.</summary>
        public ApiSdk.Models.SiteSecurityLevel? BrowserTrustedSitesSecurityLevel { get; set; }
        ...
        public ApiSdk.Models.UpdateClassification? MinimumAutoInstallClassification { get; set; }
        ...
        /// <summary>Possible values for automatic update classification.</summary>
        public ApiSdk.Models.UpdateClassification? UpdatesMinimumAutoInstallClassification { get; set; }
        ...
        public ApiSdk.Models.WindowsUserAccountControlSettings? UserAccountControlSettings { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.Windows81GeneralConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.Windows81GeneralConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.Windows81GeneralConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.Windows81GeneralConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "browserInternetSecurityLevel", n => { BrowserInternetSecurityLevel = n.GetEnumValue<ApiSdk.Models.InternetSiteSecurityLevel>(); } },
                { "browserIntranetSecurityLevel", n => { BrowserIntranetSecurityLevel = n.GetEnumValue<ApiSdk.Models.SiteSecurityLevel>(); } },
                ...
                { "browserTrustedSitesSecurityLevel", n => { BrowserTrustedSitesSecurityLevel = n.GetEnumValue<ApiSdk.Models.SiteSecurityLevel>(); } },
                ...
                { "minimumAutoInstallClassification", n => { MinimumAutoInstallClassification = n.GetEnumValue<ApiSdk.Models.UpdateClassification>(); } },
                ...
                { "updatesMinimumAutoInstallClassification", n => { UpdatesMinimumAutoInstallClassification = n.GetEnumValue<ApiSdk.Models.UpdateClassification>(); } },
                { "updatesRequireAutomaticUpdates", n => { UpdatesRequireAutomaticUpdates = n.GetBoolValue(); } },
                { "userAccountControlSettings", n => { UserAccountControlSettings = n.GetEnumValue<ApiSdk.Models.WindowsUserAccountControlSettings>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.InternetSiteSecurityLevel>("browserInternetSecurityLevel", BrowserInternetSecurityLevel);
            writer.WriteEnumValue<ApiSdk.Models.SiteSecurityLevel>("browserIntranetSecurityLevel", BrowserIntranetSecurityLevel);
            ...
            writer.WriteEnumValue<ApiSdk.Models.SiteSecurityLevel>("browserTrustedSitesSecurityLevel", BrowserTrustedSitesSecurityLevel);
            ...
            writer.WriteEnumValue<ApiSdk.Models.UpdateClassification>("minimumAutoInstallClassification", MinimumAutoInstallClassification);
            ...
            writer.WriteEnumValue<ApiSdk.Models.UpdateClassification>("updatesMinimumAutoInstallClassification", UpdatesMinimumAutoInstallClassification);
            writer.WriteBoolValue("updatesRequireAutomaticUpdates", UpdatesRequireAutomaticUpdates);
            writer.WriteEnumValue<ApiSdk.Models.WindowsUserAccountControlSettings>("userAccountControlSettings", UserAccountControlSettings);
