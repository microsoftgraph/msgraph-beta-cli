...
namespace ApiSdk.DeviceManagement.MicrosoftTunnelSites.Item.MicrosoftTunnelServers.Item {
    ...
    public class MicrosoftTunnelServerItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildCreateServerLogCollectionRequestNavCommand()
        {
            ...
            var builder = new CreateServerLogCollectionRequestRequestBuilder(PathParameters);
        ...
        public Command BuildGenerateServerLogCollectionRequestNavCommand()
        {
            ...
            var builder = new GenerateServerLogCollectionRequestRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
