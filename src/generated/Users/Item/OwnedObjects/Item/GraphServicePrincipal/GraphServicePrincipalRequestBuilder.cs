...
using System;
namespace ApiSdk.Users.Item.OwnedObjects.Item.GraphServicePrincipal {
    /// <summary>
    ...
    public class GraphServicePrincipalRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public GraphServicePrincipalRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/ownedObjects/{directoryObject%2Did}/graph.servicePrincipal{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="GraphServicePrincipalRequestBuilder"/> and sets the default values.
        ...
        public GraphServicePrincipalRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/ownedObjects/{directoryObject%2Did}/graph.servicePrincipal{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.servicePrincipal
