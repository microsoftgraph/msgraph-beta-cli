...
namespace ApiSdk.Groups.Item.Events.Item.ExceptionOccurrences.Count {
    ...
    public class CountRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/events/{event%2Did}/exceptionOccurrences/$count{?%24filter}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="CountRequestBuilder"/> and sets the default values.
        ...
        public CountRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/events/{event%2Did}/exceptionOccurrences/$count{?%24filter}", rawUrl)
        {
        }
        /// <summary>
        /// Get the number of the resource
