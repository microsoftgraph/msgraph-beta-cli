...
#nullable enable
        public List<ApiSdk.Models.Networkaccess.Device>? Value { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.Networkaccess.Device> Value { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "value", n => { Value = n.GetCollectionOfObjectValues<ApiSdk.Models.Networkaccess.Device>(ApiSdk.Models.Networkaccess.Device.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Networkaccess.Device>("value", Value);
        }
    }
}
