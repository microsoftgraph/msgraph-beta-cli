...
using ApiSdk.Models;
using ApiSdk.Users.Item.ContactFolders.Item.ChildFolders.Count;
using ApiSdk.Users.Item.ContactFolders.Item.ChildFolders.Delta;
using ApiSdk.Users.Item.ContactFolders.Item.ChildFolders.Item;
...
using System;
namespace ApiSdk.Users.Item.ContactFolders.Item.ChildFolders {
    /// <summary>
    ...
    public class ChildFoldersRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.ContactFolders.Item.ChildFolders.Item.ContactFolderItemRequestBuilder(PathParameters);
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(ContactFolder body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/childFolders", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
