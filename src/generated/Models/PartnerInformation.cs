...
namespace ApiSdk.Models
{
    ...
    public partial class PartnerInformation : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public global::ApiSdk.Models.PartnerTenantType? CompanyType { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Models.PartnerInformation"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.PartnerInformation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ApiSdk.Models.PartnerInformation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.PartnerInformation();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "companyType", n => { CompanyType = n.GetEnumValue<global::ApiSdk.Models.PartnerTenantType>(); } },
                { "helpUrl", n => { HelpUrl = n.GetStringValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "partnerTenantId", n => { PartnerTenantId = n.GetStringValue(); } },
                { "supportEmails", n => { SupportEmails = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "supportTelephones", n => { SupportTelephones = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.PartnerTenantType>("companyType", CompanyType);
