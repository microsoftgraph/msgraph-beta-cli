...
using ApiSdk.DeviceManagement.DepOnboardingSettings.Item.DefaultTvOSEnrollmentProfile;
using ApiSdk.DeviceManagement.DepOnboardingSettings.Item.DefaultVisionOSEnrollmentProfile;
...
namespace ApiSdk.DeviceManagement.DepOnboardingSettings.Item
{
    ...
    public partial class DepOnboardingSettingItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildDefaultIosEnrollmentProfileNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.DepOnboardingSettings.Item.DefaultIosEnrollmentProfile.DefaultIosEnrollmentProfileRequestBuilder(PathParameters);
        ...
        public Command BuildDefaultMacOsEnrollmentProfileNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.DepOnboardingSettings.Item.DefaultMacOsEnrollmentProfile.DefaultMacOsEnrollmentProfileRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildDefaultTvOSEnrollmentProfileNavCommand()
        {
            var command = new Command("default-tv-o-s-enrollment-profile");
            command.Description = "Provides operations to manage the defaultTvOSEnrollmentProfile property of the microsoft.graph.depOnboardingSetting entity.";
            var builder = new global::ApiSdk.DeviceManagement.DepOnboardingSettings.Item.DefaultTvOSEnrollmentProfile.DefaultTvOSEnrollmentProfileRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildDefaultVisionOSEnrollmentProfileNavCommand()
        {
            var command = new Command("default-vision-o-s-enrollment-profile");
            command.Description = "Provides operations to manage the defaultVisionOSEnrollmentProfile property of the microsoft.graph.depOnboardingSetting entity.";
            var builder = new global::ApiSdk.DeviceManagement.DepOnboardingSettings.Item.DefaultVisionOSEnrollmentProfile.DefaultVisionOSEnrollmentProfileRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildEnrollmentProfilesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.DepOnboardingSettings.Item.EnrollmentProfiles.EnrollmentProfilesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGenerateEncryptionPublicKeyNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.DepOnboardingSettings.Item.GenerateEncryptionPublicKey.GenerateEncryptionPublicKeyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGetEncryptionPublicKeyNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.DepOnboardingSettings.Item.GetEncryptionPublicKey.GetEncryptionPublicKeyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildImportedAppleDeviceIdentitiesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.DepOnboardingSettings.Item.ImportedAppleDeviceIdentities.ImportedAppleDeviceIdentitiesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.DepOnboardingSetting>(global::ApiSdk.Models.DepOnboardingSetting.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildShareForSchoolDataSyncServiceNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.DepOnboardingSettings.Item.ShareForSchoolDataSyncService.ShareForSchoolDataSyncServiceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSyncWithAppleDeviceEnrollmentProgramNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.DepOnboardingSettings.Item.SyncWithAppleDeviceEnrollmentProgram.SyncWithAppleDeviceEnrollmentProgramRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUnshareForSchoolDataSyncServiceNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.DepOnboardingSettings.Item.UnshareForSchoolDataSyncService.UnshareForSchoolDataSyncServiceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUploadDepTokenNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.DepOnboardingSettings.Item.UploadDepToken.UploadDepTokenRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.DeviceManagement.DepOnboardingSettings.Item.DepOnboardingSettingItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceManagement.DepOnboardingSettings.Item.DepOnboardingSettingItemRequestBuilder.DepOnboardingSettingItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceManagement.DepOnboardingSettings.Item.DepOnboardingSettingItemRequestBuilder.DepOnboardingSettingItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.DepOnboardingSetting body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.DepOnboardingSetting body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
