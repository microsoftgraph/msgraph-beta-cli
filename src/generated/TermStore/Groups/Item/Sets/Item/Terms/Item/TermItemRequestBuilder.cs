...
namespace ApiSdk.TermStore.Groups.Item.Sets.Item.Terms.Item
{
    ...
    public class TermItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildChildrenNavCommand()
        {
            ...
            var builder = new ApiSdk.TermStore.Groups.Item.Sets.Item.Terms.Item.Children.ChildrenRequestBuilder(PathParameters);
        ...
        public Command BuildRelationsNavCommand()
        {
            ...
            var builder = new ApiSdk.TermStore.Groups.Item.Sets.Item.Terms.Item.Relations.RelationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildSetNavCommand()
        {
            ...
            var builder = new ApiSdk.TermStore.Groups.Item.Sets.Item.Terms.Item.Set.SetRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.TermStore.Groups.Item.Sets.Item.Terms.Item.TermItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.TermStore.Groups.Item.Sets.Item.Terms.Item.TermItemRequestBuilder.TermItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.TermStore.Groups.Item.Sets.Item.Terms.Item.TermItemRequestBuilder.TermItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
