...
namespace ApiSdk.RoleManagement.EnterpriseApps.Item.RoleAssignmentScheduleInstances.Item
{
    ...
    public class UnifiedRoleAssignmentScheduleInstanceItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildActivatedUsingNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EnterpriseApps.Item.RoleAssignmentScheduleInstances.Item.ActivatedUsing.ActivatedUsingRequestBuilder(PathParameters);
        ...
        public Command BuildAppScopeNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EnterpriseApps.Item.RoleAssignmentScheduleInstances.Item.AppScope.AppScopeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDirectoryScopeNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EnterpriseApps.Item.RoleAssignmentScheduleInstances.Item.DirectoryScope.DirectoryScopeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.UnifiedRoleAssignmentScheduleInstance>(ApiSdk.Models.UnifiedRoleAssignmentScheduleInstance.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPrincipalNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EnterpriseApps.Item.RoleAssignmentScheduleInstances.Item.Principal.PrincipalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRoleDefinitionNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EnterpriseApps.Item.RoleAssignmentScheduleInstances.Item.RoleDefinition.RoleDefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.RoleManagement.EnterpriseApps.Item.RoleAssignmentScheduleInstances.Item.UnifiedRoleAssignmentScheduleInstanceItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.EnterpriseApps.Item.RoleAssignmentScheduleInstances.Item.UnifiedRoleAssignmentScheduleInstanceItemRequestBuilder.UnifiedRoleAssignmentScheduleInstanceItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.EnterpriseApps.Item.RoleAssignmentScheduleInstances.Item.UnifiedRoleAssignmentScheduleInstanceItemRequestBuilder.UnifiedRoleAssignmentScheduleInstanceItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.UnifiedRoleAssignmentScheduleInstance body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.UnifiedRoleAssignmentScheduleInstance body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
