...
namespace ApiSdk.Drives.Item.List.Items.Item
{
    ...
    public class ListItemItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildActivitiesNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.List.Items.Item.Activities.ActivitiesRequestBuilder(PathParameters);
        ...
        public Command BuildAnalyticsNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.List.Items.Item.Analytics.AnalyticsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCreatedByUserNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.List.Items.Item.CreatedByUser.CreatedByUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildCreateLinkNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.List.Items.Item.CreateLink.CreateLinkRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildDocumentSetVersionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.List.Items.Item.DocumentSetVersions.DocumentSetVersionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildFieldsNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.List.Items.Item.Fields.FieldsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRbCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.List.Items.Item.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildLastModifiedByUserNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.List.Items.Item.LastModifiedByUser.LastModifiedByUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            nonExecCommands.Add(builder.BuildMailboxSettingsNavCommand());
        ...
        public Command BuildVersionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.List.Items.Item.Versions.VersionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Drives.Item.List.Items.Item.ListItemItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Drives.Item.List.Items.Item.ListItemItemRequestBuilder.ListItemItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Drives.Item.List.Items.Item.ListItemItemRequestBuilder.ListItemItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
