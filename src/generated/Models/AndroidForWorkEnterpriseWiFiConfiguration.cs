...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class AndroidForWorkEnterpriseWiFiConfiguration : ApiSdk.Models.AndroidForWorkWiFiConfiguration, IParsable
    {
...
#nullable enable
        public ApiSdk.Models.AndroidForWorkCertificateProfileBase? IdentityCertificateForClientAuthentication { get; set; }
#nullable restore
#else
        public ApiSdk.Models.AndroidForWorkCertificateProfileBase IdentityCertificateForClientAuthentication { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.AndroidForWorkTrustedRootCertificate? RootCertificateForServerValidation { get; set; }
#nullable restore
#else
        public ApiSdk.Models.AndroidForWorkTrustedRootCertificate RootCertificateForServerValidation { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.AndroidForWorkEnterpriseWiFiConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.AndroidForWorkEnterpriseWiFiConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.AndroidForWorkEnterpriseWiFiConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.AndroidForWorkEnterpriseWiFiConfiguration();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "identityCertificateForClientAuthentication", n => { IdentityCertificateForClientAuthentication = n.GetObjectValue<ApiSdk.Models.AndroidForWorkCertificateProfileBase>(ApiSdk.Models.AndroidForWorkCertificateProfileBase.CreateFromDiscriminatorValue); } },
                ...
                { "rootCertificateForServerValidation", n => { RootCertificateForServerValidation = n.GetObjectValue<ApiSdk.Models.AndroidForWorkTrustedRootCertificate>(ApiSdk.Models.AndroidForWorkTrustedRootCertificate.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.AndroidForWorkCertificateProfileBase>("identityCertificateForClientAuthentication", IdentityCertificateForClientAuthentication);
            ...
            writer.WriteObjectValue<ApiSdk.Models.AndroidForWorkTrustedRootCertificate>("rootCertificateForServerValidation", RootCertificateForServerValidation);
