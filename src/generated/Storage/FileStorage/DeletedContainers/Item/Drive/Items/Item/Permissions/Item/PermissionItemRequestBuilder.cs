...
namespace ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Permissions.Item
{
    ...
    public class PermissionItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGrantNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Permissions.Item.Grant.GrantRequestBuilder(PathParameters);
        ...
        public Command BuildRevokeGrantsNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Permissions.Item.RevokeGrants.RevokeGrantsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Permissions.Item.PermissionItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Permissions.Item.PermissionItemRequestBuilder.PermissionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Permissions.Item.PermissionItemRequestBuilder.PermissionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
