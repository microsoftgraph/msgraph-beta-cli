...
namespace ApiSdk.DirectoryNamespace.InboundSharedUserProfiles.Item {
    ...
    public class InboundSharedUserProfileUserItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/inboundshareduserprofile-get?view=graph-rest-1.0" />
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildGetCommand()
        {
            var command = new Command("get");
            command.Description = "Read the properties of an inboundSharedUserProfile.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/inboundshareduserprofile-get?view=graph-rest-1.0";
            var inboundSharedUserProfileUserIdOption = new Option<string>("--inbound-shared-user-profile-user-id", description: "The unique identifier of inboundSharedUserProfile") {
            };
            inboundSharedUserProfileUserIdOption.IsRequired = true;
            command.AddOption(inboundSharedUserProfileUserIdOption);
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/directory/inboundSharedUserProfiles/{inboundSharedUserProfile%2DuserId}", PathParameters);
...
#nullable restore
        ...
        public RequestInformation ToPatchRequestInformation(InboundSharedUserProfile body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.PATCH, "{+baseurl}/directory/inboundSharedUserProfiles/{inboundSharedUserProfile%2DuserId}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
