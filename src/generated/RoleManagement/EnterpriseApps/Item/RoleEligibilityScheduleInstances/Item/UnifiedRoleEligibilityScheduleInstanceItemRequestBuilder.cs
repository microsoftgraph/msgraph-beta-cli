...
namespace ApiSdk.RoleManagement.EnterpriseApps.Item.RoleEligibilityScheduleInstances.Item
{
    ...
    public class UnifiedRoleEligibilityScheduleInstanceItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAppScopeNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EnterpriseApps.Item.RoleEligibilityScheduleInstances.Item.AppScope.AppScopeRequestBuilder(PathParameters);
        ...
        public Command BuildDirectoryScopeNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EnterpriseApps.Item.RoleEligibilityScheduleInstances.Item.DirectoryScope.DirectoryScopeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.UnifiedRoleEligibilityScheduleInstance>(ApiSdk.Models.UnifiedRoleEligibilityScheduleInstance.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPrincipalNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EnterpriseApps.Item.RoleEligibilityScheduleInstances.Item.Principal.PrincipalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRoleDefinitionNavCommand()
        {
            ...
            var builder = new ApiSdk.RoleManagement.EnterpriseApps.Item.RoleEligibilityScheduleInstances.Item.RoleDefinition.RoleDefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.RoleManagement.EnterpriseApps.Item.RoleEligibilityScheduleInstances.Item.UnifiedRoleEligibilityScheduleInstanceItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.EnterpriseApps.Item.RoleEligibilityScheduleInstances.Item.UnifiedRoleEligibilityScheduleInstanceItemRequestBuilder.UnifiedRoleEligibilityScheduleInstanceItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.RoleManagement.EnterpriseApps.Item.RoleEligibilityScheduleInstances.Item.UnifiedRoleEligibilityScheduleInstanceItemRequestBuilder.UnifiedRoleEligibilityScheduleInstanceItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.UnifiedRoleEligibilityScheduleInstance body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.UnifiedRoleEligibilityScheduleInstance body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
