    ...
    public class AcquireAccessTokenRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Applications.Item.Synchronization.AcquireAccessToken.AcquireAccessTokenPostRequestBody>(ApiSdk.Applications.Item.Synchronization.AcquireAccessToken.AcquireAccessTokenPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Applications.Item.Synchronization.AcquireAccessToken.AcquireAccessTokenRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Applications.Item.Synchronization.AcquireAccessToken.AcquireAccessTokenPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Applications.Item.Synchronization.AcquireAccessToken.AcquireAccessTokenPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
