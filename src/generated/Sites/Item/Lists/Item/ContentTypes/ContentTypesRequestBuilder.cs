...
using ApiSdk.Models;
using ApiSdk.Sites.Item.Lists.Item.ContentTypes.AddCopy;
using ApiSdk.Sites.Item.Lists.Item.ContentTypes.AddCopyFromContentTypeHub;
...
namespace ApiSdk.Sites.Item.Lists.Item.ContentTypes
{
    ...
    public partial class ContentTypesRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAddCopyFromContentTypeHubNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.ContentTypes.AddCopyFromContentTypeHub.AddCopyFromContentTypeHubRequestBuilder(PathParameters);
        ...
        public Command BuildAddCopyNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.ContentTypes.AddCopy.AddCopyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.ContentTypes.Item.ContentTypeItemRequestBuilder(PathParameters);
        ...
        public Command BuildCountNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.ContentTypes.Count.CountRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGetCompatibleHubContentTypesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.ContentTypes.GetCompatibleHubContentTypes.GetCompatibleHubContentTypesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildListCommand()
        {
            ...
            command.Description = "The collection of content types present in this list.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/list-list-contenttypes?view=graph-rest-beta";
            var siteIdOption = new Option<string>("--site-id", description: "The unique identifier of site") {
            };
            siteIdOption.IsRequired = true;
            command.AddOption(siteIdOption);
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Sites.Item.Lists.Item.ContentTypes.ContentTypesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Sites.Item.Lists.Item.ContentTypes.ContentTypesRequestBuilder.ContentTypesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Sites.Item.Lists.Item.ContentTypes.ContentTypesRequestBuilder.ContentTypesRequestBuilderGetQueryParameters>> requestConfiguration = default)
