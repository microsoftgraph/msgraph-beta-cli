...
using System;
namespace ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.OwnersWithUserPrincipalName
{
    /// <summary>
    ...
    public partial class OwnersWithUserPrincipalNameRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.OwnersWithUserPrincipalName.OwnersWithUserPrincipalNameRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public OwnersWithUserPrincipalNameRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/owners(userPrincipalName='{userPrincipalName}'){?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.OwnersWithUserPrincipalName.OwnersWithUserPrincipalNameRequestBuilder"/> and sets the default values.
        ...
        public OwnersWithUserPrincipalNameRequestBuilder(string rawUrl) : base("{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/owners(userPrincipalName='{userPrincipalName}'){?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// The list of this team&apos;s owners. Currently, when creating a team using application permissions, exactly one owner must be specified. When using user-delegated permissions, no owner can be specified (the current user is the owner). The owner must be specified as an object ID (GUID), not a UPN.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.OwnersWithUserPrincipalName.OwnersWithUserPrincipalNameRequestBuilder.OwnersWithUserPrincipalNameRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Teamwork.TeamTemplates.Item.Definitions.Item.TeamDefinition.OwnersWithUserPrincipalName.OwnersWithUserPrincipalNameRequestBuilder.OwnersWithUserPrincipalNameRequestBuilderGetQueryParameters>> requestConfiguration = default)
