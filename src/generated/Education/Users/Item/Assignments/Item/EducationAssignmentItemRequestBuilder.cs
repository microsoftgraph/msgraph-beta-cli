...
namespace ApiSdk.Education.Users.Item.Assignments.Item
{
    ...
    public partial class EducationAssignmentItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildActivateNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Users.Item.Assignments.Item.Activate.ActivateRequestBuilder(PathParameters);
        ...
        public Command BuildCategoriesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Users.Item.Assignments.Item.Categories.CategoriesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildDeactivateNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Users.Item.Assignments.Item.Deactivate.DeactivateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGradingCategoryNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Users.Item.Assignments.Item.GradingCategory.GradingCategoryRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGradingSchemeNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Users.Item.Assignments.Item.GradingScheme.GradingSchemeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPublishNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Users.Item.Assignments.Item.Publish.PublishRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildResourcesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Users.Item.Assignments.Item.Resources.ResourcesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRubricNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Users.Item.Assignments.Item.Rubric.RubricRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildSetUpFeedbackResourcesFolderNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Users.Item.Assignments.Item.SetUpFeedbackResourcesFolder.SetUpFeedbackResourcesFolderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSetUpResourcesFolderNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Users.Item.Assignments.Item.SetUpResourcesFolder.SetUpResourcesFolderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSubmissionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Users.Item.Assignments.Item.Submissions.SubmissionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Education.Users.Item.Assignments.Item.EducationAssignmentItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Education.Users.Item.Assignments.Item.EducationAssignmentItemRequestBuilder.EducationAssignmentItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Education.Users.Item.Assignments.Item.EducationAssignmentItemRequestBuilder.EducationAssignmentItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
