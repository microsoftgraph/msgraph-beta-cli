...
namespace ApiSdk.Users.Item.JoinedTeams.Item.PrimaryChannel {
    ...
    public class PrimaryChannelRequestBuilder : BaseCliRequestBuilder {
        ...
        public PrimaryChannelRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PrimaryChannelRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public PrimaryChannelRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property primaryChannel for users
        /// </summary>
