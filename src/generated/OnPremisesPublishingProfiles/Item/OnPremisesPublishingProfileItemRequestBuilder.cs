...
namespace ApiSdk.OnPremisesPublishingProfiles.Item
{
    ...
    public partial class OnPremisesPublishingProfileItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildAgentGroupsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.OnPremisesPublishingProfiles.Item.AgentGroups.AgentGroupsRequestBuilder(PathParameters);
        ...
        public Command BuildAgentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.OnPremisesPublishingProfiles.Item.Agents.AgentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildApplicationSegmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.OnPremisesPublishingProfiles.Item.ApplicationSegments.ApplicationSegmentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildConnectorGroupsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.OnPremisesPublishingProfiles.Item.ConnectorGroups.ConnectorGroupsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildConnectorsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.OnPremisesPublishingProfiles.Item.Connectors.ConnectorsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete entity from onPremisesPublishingProfiles";
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get entity from onPremisesPublishingProfiles by key";
            var onPremisesPublishingProfileIdOption = new Option<string>("--on-premises-publishing-profile-id", description: "The unique identifier of onPremisesPublishingProfile") {
            };
            onPremisesPublishingProfileIdOption.IsRequired = true;
            command.AddOption(onPremisesPublishingProfileIdOption);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update entity in onPremisesPublishingProfiles";
            var onPremisesPublishingProfileIdOption = new Option<string>("--on-premises-publishing-profile-id", description: "The unique identifier of onPremisesPublishingProfile") {
            };
            onPremisesPublishingProfileIdOption.IsRequired = true;
            command.AddOption(onPremisesPublishingProfileIdOption);
        ...
        public Command BuildPublishedResourcesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.OnPremisesPublishingProfiles.Item.PublishedResources.PublishedResourcesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.OnPremisesPublishingProfiles.Item.OnPremisesPublishingProfileItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.OnPremisesPublishingProfiles.Item.OnPremisesPublishingProfileItemRequestBuilder.OnPremisesPublishingProfileItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.OnPremisesPublishingProfiles.Item.OnPremisesPublishingProfileItemRequestBuilder.OnPremisesPublishingProfileItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.OnPremisesPublishingProfile body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.OnPremisesPublishingProfile body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
