...
using ApiSdk.DeviceManagement.VirtualEndpoint.SharedUseServicePlans;
    ...
    public class VirtualEndpointRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.VirtualEndpoint>(ApiSdk.Models.VirtualEndpoint.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildSharedUseServicePlansNavCommand()
        {
