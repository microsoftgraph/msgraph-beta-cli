...
using ApiSdk.Domains.Item.PromoteToInitial;
using ApiSdk.Domains.Item.RootDomain;
using ApiSdk.Domains.Item.ServiceConfigurationRecords;
using ApiSdk.Domains.Item.SharedEmailDomainInvitations;
...
namespace ApiSdk.Domains.Item
{
    ...
    public partial class DomainItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildDomainNameReferencesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Domains.Item.DomainNameReferences.DomainNameReferencesRequestBuilder(PathParameters);
        ...
        public Command BuildFederationConfigurationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Domains.Item.FederationConfiguration.FederationConfigurationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildForceDeleteNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Domains.Item.ForceDelete.ForceDeleteRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Domain>(global::ApiSdk.Models.Domain.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPromoteNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Domains.Item.Promote.PromoteRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildPromoteToInitialNavCommand()
        {
            var command = new Command("promote-to-initial");
            command.Description = "Provides operations to call the promoteToInitial method.";
            var builder = new global::ApiSdk.Domains.Item.PromoteToInitial.PromoteToInitialRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildRootDomainNavCommand()
        {
            var command = new Command("root-domain");
            command.Description = "Provides operations to manage the rootDomain property of the microsoft.graph.domain entity.";
            var builder = new global::ApiSdk.Domains.Item.RootDomain.RootDomainRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildServiceConfigurationRecordsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Domains.Item.ServiceConfigurationRecords.ServiceConfigurationRecordsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildSharedEmailDomainInvitationsNavCommand()
        {
            var command = new Command("shared-email-domain-invitations");
            command.Description = "Provides operations to manage the sharedEmailDomainInvitations property of the microsoft.graph.domain entity.";
            var builder = new global::ApiSdk.Domains.Item.SharedEmailDomainInvitations.SharedEmailDomainInvitationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildVerificationDnsRecordsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Domains.Item.VerificationDnsRecords.VerificationDnsRecordsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildVerifyNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Domains.Item.Verify.VerifyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Domains.Item.DomainItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Domains.Item.DomainItemRequestBuilder.DomainItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Domains.Item.DomainItemRequestBuilder.DomainItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Domain body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Domain body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
