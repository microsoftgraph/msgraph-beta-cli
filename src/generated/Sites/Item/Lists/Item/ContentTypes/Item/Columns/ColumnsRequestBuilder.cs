...
using ApiSdk.Models;
using ApiSdk.Sites.Item.Lists.Item.ContentTypes.Item.Columns.Count;
...
using System;
namespace ApiSdk.Sites.Item.Lists.Item.ContentTypes.Item.Columns {
    /// <summary>
    ...
    public class ColumnsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public ColumnsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/columns{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ColumnsRequestBuilder"/> and sets the default values.
        ...
        public ColumnsRequestBuilder(string rawUrl) : base("{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/columns{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// The collection of column definitions for this contentType.
