...
using ApiSdk.Contacts.GetUserOwnedObjects;
...
namespace ApiSdk.Contacts
{
    ...
    public partial class ContactsRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        /// Provides operations to manage the collection of orgContact entities.
        /// </summary>
        ...
        public Command BuildCountNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Contacts.Count.CountRequestBuilder(PathParameters);
        ...
        public Command BuildDeltaNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Contacts.Delta.DeltaRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetByIdsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Contacts.GetByIds.GetByIdsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGetUserOwnedObjectsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Contacts.GetUserOwnedObjects.GetUserOwnedObjectsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
...
#nullable restore
        ...
        public Command BuildValidatePropertiesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Contacts.ValidateProperties.ValidatePropertiesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Contacts.ContactsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Contacts.ContactsRequestBuilder.ContactsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Contacts.ContactsRequestBuilder.ContactsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Models.OrgContact body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Models.OrgContact body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
