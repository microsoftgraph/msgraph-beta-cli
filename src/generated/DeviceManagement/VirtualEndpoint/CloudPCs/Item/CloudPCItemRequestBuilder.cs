...
using ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.RetrieveCloudPCRemoteActionResults;
using ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.RetrieveReviewStatus;
using ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.RetrieveSnapshots;
...
namespace ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item
{
    ...
    public partial class CloudPCItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildChangeUserAccountTypeNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.ChangeUserAccountType.ChangeUserAccountTypeRequestBuilder(PathParameters);
        ...
        public Command BuildCreateSnapshotNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.CreateSnapshot.CreateSnapshotRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetCloudPcConnectivityHistoryNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.GetCloudPcConnectivityHistory.GetCloudPcConnectivityHistoryRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGetCloudPcLaunchInfoNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.GetCloudPcLaunchInfo.GetCloudPcLaunchInfoRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetFrontlineCloudPcAccessStateNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.GetFrontlineCloudPcAccessState.GetFrontlineCloudPcAccessStateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetSupportedCloudPcRemoteActionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.GetSupportedCloudPcRemoteActions.GetSupportedCloudPcRemoteActionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPowerOffNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.PowerOff.PowerOffRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPowerOnNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.PowerOn.PowerOnRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildReprovisionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.Reprovision.ReprovisionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildResizeNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.Resize.ResizeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRetrieveCloudPCRemoteActionResultsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.RetrieveCloudPCRemoteActionResults.RetrieveCloudPCRemoteActionResultsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRetrieveReviewStatusNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.RetrieveReviewStatus.RetrieveReviewStatusRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRetrieveSnapshotsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.RetrieveSnapshots.RetrieveSnapshotsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRetryPartnerAgentInstallationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.RetryPartnerAgentInstallation.RetryPartnerAgentInstallationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSetReviewStatusNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.SetReviewStatus.SetReviewStatusRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildStartNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.Start.StartRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildStopNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.Stop.StopRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
