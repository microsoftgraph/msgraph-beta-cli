...
using ApiSdk.Models;
using ApiSdk.RoleManagement.Exchange.CustomAppScopes;
using ApiSdk.RoleManagement.Exchange.ResourceNamespaces;
using ApiSdk.RoleManagement.Exchange.RoleAssignments;
using ApiSdk.RoleManagement.Exchange.RoleDefinitions;
using ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments;
...
namespace ApiSdk.RoleManagement.Exchange
{
    ...
    public partial class ExchangeRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCustomAppScopesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.Exchange.CustomAppScopes.CustomAppScopesRequestBuilder(PathParameters);
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property exchange for roleManagement";
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get exchange from roleManagement";
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property exchange in roleManagement";
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.UnifiedRbacApplication>(global::ApiSdk.Models.UnifiedRbacApplication.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildResourceNamespacesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.Exchange.ResourceNamespaces.ResourceNamespacesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRoleAssignmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.Exchange.RoleAssignments.RoleAssignmentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRoleDefinitionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.Exchange.RoleDefinitions.RoleDefinitionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildTransitiveRoleAssignmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.TransitiveRoleAssignmentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.RoleManagement.Exchange.ExchangeRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.RoleManagement.Exchange.ExchangeRequestBuilder.ExchangeRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.RoleManagement.Exchange.ExchangeRequestBuilder.ExchangeRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.UnifiedRbacApplication body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.UnifiedRbacApplication body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
