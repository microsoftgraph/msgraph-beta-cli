...
using ApiSdk.Models;
using ApiSdk.Users.Item.DeviceEnrollmentConfigurations.Item.Assign;
using ApiSdk.Users.Item.DeviceEnrollmentConfigurations.Item.Assignments;
using ApiSdk.Users.Item.DeviceEnrollmentConfigurations.Item.SetPriority;
...
namespace ApiSdk.Users.Item.DeviceEnrollmentConfigurations.Item
{
    ...
    public class DeviceEnrollmentConfigurationItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAssignmentsNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.DeviceEnrollmentConfigurations.Item.Assignments.AssignmentsRequestBuilder(PathParameters);
        ...
        public Command BuildAssignNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.DeviceEnrollmentConfigurations.Item.Assign.AssignRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSetPriorityNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.DeviceEnrollmentConfigurations.Item.SetPriority.SetPriorityRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Users.Item.DeviceEnrollmentConfigurations.Item.DeviceEnrollmentConfigurationItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public DeviceEnrollmentConfigurationItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Users.Item.DeviceEnrollmentConfigurations.Item.DeviceEnrollmentConfigurationItemRequestBuilder"/> and sets the default values.
        ...
        public DeviceEnrollmentConfigurationItemRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property deviceEnrollmentConfigurations for users
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.DeviceEnrollmentConfigurations.Item.DeviceEnrollmentConfigurationItemRequestBuilder.DeviceEnrollmentConfigurationItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.DeviceEnrollmentConfigurations.Item.DeviceEnrollmentConfigurationItemRequestBuilder.DeviceEnrollmentConfigurationItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.DeviceEnrollmentConfiguration body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.DeviceEnrollmentConfiguration body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
