...
namespace ApiSdk.Identity.ConditionalAccess.AuthenticationStrengths.Policies.Item
{
    ...
    public class AuthenticationStrengthPolicyItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCombinationConfigurationsNavCommand()
        {
            ...
            var builder = new ApiSdk.Identity.ConditionalAccess.AuthenticationStrengths.Policies.Item.CombinationConfigurations.CombinationConfigurationsRequestBuilder(PathParameters);
        ...
        public Command BuildUpdateAllowedCombinationsNavCommand()
        {
            ...
            var builder = new ApiSdk.Identity.ConditionalAccess.AuthenticationStrengths.Policies.Item.UpdateAllowedCombinations.UpdateAllowedCombinationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildUsageNavCommand()
        {
            ...
            var builder = new ApiSdk.Identity.ConditionalAccess.AuthenticationStrengths.Policies.Item.Usage.UsageRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Identity.ConditionalAccess.AuthenticationStrengths.Policies.Item.AuthenticationStrengthPolicyItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Identity.ConditionalAccess.AuthenticationStrengths.Policies.Item.AuthenticationStrengthPolicyItemRequestBuilder.AuthenticationStrengthPolicyItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Identity.ConditionalAccess.AuthenticationStrengths.Policies.Item.AuthenticationStrengthPolicyItemRequestBuilder.AuthenticationStrengthPolicyItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
