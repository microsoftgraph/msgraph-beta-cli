...
namespace ApiSdk.NetworkAccess.Settings.ConditionalAccess
{
    ...
    public partial class ConditionalAccessRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property conditionalAccess for networkAccess";
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Networkaccess.ConditionalAccessSettings>(global::ApiSdk.Models.Networkaccess.ConditionalAccessSettings.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.NetworkAccess.Settings.ConditionalAccess.ConditionalAccessRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public ConditionalAccessRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/networkAccess/settings/conditionalAccess{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.NetworkAccess.Settings.ConditionalAccess.ConditionalAccessRequestBuilder"/> and sets the default values.
        ...
        public ConditionalAccessRequestBuilder(string rawUrl) : base("{+baseurl}/networkAccess/settings/conditionalAccess{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property conditionalAccess for networkAccess
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.NetworkAccess.Settings.ConditionalAccess.ConditionalAccessRequestBuilder.ConditionalAccessRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.NetworkAccess.Settings.ConditionalAccess.ConditionalAccessRequestBuilder.ConditionalAccessRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Networkaccess.ConditionalAccessSettings body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Networkaccess.ConditionalAccessSettings body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ConditionalAccessRequestBuilderGetQueryParameters 
        {
