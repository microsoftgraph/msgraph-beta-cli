...
namespace ApiSdk.Users.Item.Messages.Item.Value {
    ...
    public class ContentRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/messages/{message%2Did}/$value{?%24format*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ContentRequestBuilder"/> and sets the default values.
        ...
        public ContentRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/messages/{message%2Did}/$value{?%24format*}", rawUrl)
        {
        }
        /// <summary>
        /// Get media content for the navigation property messages from users
