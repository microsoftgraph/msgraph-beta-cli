...
using System;
namespace ApiSdk.Users.Item.Onenote.Notebooks.Item.SectionGroups.Item.SectionGroups.Item {
    /// <summary>
    ...
    public class SectionGroupItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var sectionGroupId1 = invocationContext.ParseResult.GetValueForOption(sectionGroupId1Option);
                ...
                if (sectionGroupId1 is not null) requestInfo.PathParameters.Add("sectionGroup%2Did1", sectionGroupId1);
        ...
        public SectionGroupItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sectionGroups/{sectionGroup%2Did1}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="SectionGroupItemRequestBuilder"/> and sets the default values.
        ...
        public SectionGroupItemRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sectionGroups/{sectionGroup%2Did1}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// The section groups in the section. Read-only. Nullable.
