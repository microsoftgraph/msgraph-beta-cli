...
using ApiSdk.Chats.Item.CompleteMigration;
...
using ApiSdk.Chats.Item.Operations;
using ApiSdk.Chats.Item.PermissionGrants;
using ApiSdk.Chats.Item.PinnedMessages;
using ApiSdk.Chats.Item.RemoveAllAccessForUser;
...
namespace ApiSdk.Chats.Item
{
    ...
    public partial class ChatItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCompleteMigrationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Chats.Item.CompleteMigration.CompleteMigrationRequestBuilder(PathParameters);
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Soft-delete a chat. When invoked with delegated permissions, this operation only works for tenant admins and Teams service admins.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/chat-delete?view=graph-rest-beta";
        ...
        public Command BuildHideForUserNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Chats.Item.HideForUser.HideForUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildInstalledAppsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Chats.Item.InstalledApps.InstalledAppsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildLastMessagePreviewNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Chats.Item.LastMessagePreview.LastMessagePreviewRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildMarkChatReadForUserNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Chats.Item.MarkChatReadForUser.MarkChatReadForUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMarkChatUnreadForUserNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Chats.Item.MarkChatUnreadForUser.MarkChatUnreadForUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMembersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Chats.Item.Members.MembersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildMessagesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Chats.Item.Messages.MessagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildOperationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Chats.Item.Operations.OperationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPinnedMessagesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Chats.Item.PinnedMessages.PinnedMessagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildRemoveAllAccessForUserNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Chats.Item.RemoveAllAccessForUser.RemoveAllAccessForUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSendActivityNotificationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Chats.Item.SendActivityNotification.SendActivityNotificationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTabsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Chats.Item.Tabs.TabsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildUnhideForUserNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Chats.Item.UnhideForUser.UnhideForUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Chats.Item.ChatItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Chats.Item.ChatItemRequestBuilder.ChatItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Chats.Item.ChatItemRequestBuilder.ChatItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
