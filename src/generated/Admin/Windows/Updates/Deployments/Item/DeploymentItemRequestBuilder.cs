...
namespace ApiSdk.Admin.Windows.Updates.Deployments.Item
{
    ...
    public class DeploymentItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAudienceNavCommand()
        {
            ...
            var builder = new ApiSdk.Admin.Windows.Updates.Deployments.Item.Audience.AudienceRequestBuilder(PathParameters);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.WindowsUpdates.Deployment>(ApiSdk.Models.WindowsUpdates.Deployment.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Admin.Windows.Updates.Deployments.Item.DeploymentItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Admin.Windows.Updates.Deployments.Item.DeploymentItemRequestBuilder.DeploymentItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Admin.Windows.Updates.Deployments.Item.DeploymentItemRequestBuilder.DeploymentItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.WindowsUpdates.Deployment body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.WindowsUpdates.Deployment body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
