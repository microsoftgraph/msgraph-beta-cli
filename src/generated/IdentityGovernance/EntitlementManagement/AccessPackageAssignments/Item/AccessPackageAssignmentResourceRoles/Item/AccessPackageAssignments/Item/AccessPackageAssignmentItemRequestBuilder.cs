...
using System;
namespace ApiSdk.IdentityGovernance.EntitlementManagement.AccessPackageAssignments.Item.AccessPackageAssignmentResourceRoles.Item.AccessPackageAssignments.Item
{
    /// <summary>
    ...
    public class AccessPackageAssignmentItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGetCommand()
        {
            ...
            var accessPackageAssignmentId1Option = new Option<string>("--access-package-assignment-id1", description: "The unique identifier of accessPackageAssignment") {
            };
            accessPackageAssignmentId1Option.IsRequired = true;
            command.AddOption(accessPackageAssignmentId1Option);
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var accessPackageAssignmentId1 = invocationContext.ParseResult.GetValueForOption(accessPackageAssignmentId1Option);
                ...
                if (accessPackageAssignmentId1 is not null) requestInfo.PathParameters.Add("accessPackageAssignment%2Did1", accessPackageAssignmentId1);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.IdentityGovernance.EntitlementManagement.AccessPackageAssignments.Item.AccessPackageAssignmentResourceRoles.Item.AccessPackageAssignments.Item.AccessPackageAssignmentItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        public AccessPackageAssignmentItemRequestBuilder(string rawUrl) : base("{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment%2Did}/accessPackageAssignmentResourceRoles/{accessPackageAssignmentResourceRole%2Did}/accessPackageAssignments/{accessPackageAssignment%2Did1}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// The access package assignments resulting in this role assignment. Read-only. Nullable.
