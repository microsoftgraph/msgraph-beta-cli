...
#nullable enable
        public List<ApiSdk.Models.ProxiedDomain>? EnterpriseCloudResources { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.ProxiedDomain> EnterpriseCloudResources { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.IpRange>? EnterpriseIPRanges { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.IpRange> EnterpriseIPRanges { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.WindowsNetworkIsolationPolicy"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.WindowsNetworkIsolationPolicy"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.WindowsNetworkIsolationPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.WindowsNetworkIsolationPolicy();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "enterpriseCloudResources", n => { EnterpriseCloudResources = n.GetCollectionOfObjectValues<ApiSdk.Models.ProxiedDomain>(ApiSdk.Models.ProxiedDomain.CreateFromDiscriminatorValue)?.ToList(); } },
                { "enterpriseIPRanges", n => { EnterpriseIPRanges = n.GetCollectionOfObjectValues<ApiSdk.Models.IpRange>(ApiSdk.Models.IpRange.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.ProxiedDomain>("enterpriseCloudResources", EnterpriseCloudResources);
            writer.WriteCollectionOfPrimitiveValues<string>("enterpriseInternalProxyServers", EnterpriseInternalProxyServers);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.IpRange>("enterpriseIPRanges", EnterpriseIPRanges);
