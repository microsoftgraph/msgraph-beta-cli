    ...
    public class CreatePasswordSingleSignOnCredentialsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<CreatePasswordSingleSignOnCredentialsPostRequestBody>(CreatePasswordSingleSignOnCredentialsPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
