...
namespace ApiSdk.Models
{
    ...
    public partial class DeviceHealthScript : global::ApiSdk.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.DeviceHealthScriptParameter>? DetectionScriptParameters { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.DeviceHealthScriptParameter> DetectionScriptParameters { get; set; }
#endif
        /// <summary>Indicates the type of device script.</summary>
        public global::ApiSdk.Models.DeviceHealthScriptType? DeviceHealthScriptType { get; set; }
        /// <summary>List of run states for the device health script across all devices</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.DeviceHealthScriptDeviceState>? DeviceRunStates { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.DeviceHealthScriptDeviceState> DeviceRunStates { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.DeviceHealthScriptParameter>? RemediationScriptParameters { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.DeviceHealthScriptParameter> RemediationScriptParameters { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.DeviceHealthScriptRunSummary? RunSummary { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.DeviceHealthScriptRunSummary RunSummary { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.DeviceHealthScript"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.DeviceHealthScript CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.DeviceHealthScript();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "detectionScriptParameters", n => { DetectionScriptParameters = n.GetCollectionOfObjectValues<global::ApiSdk.Models.DeviceHealthScriptParameter>(global::ApiSdk.Models.DeviceHealthScriptParameter.CreateFromDiscriminatorValue)?.AsList(); } },
                { "deviceHealthScriptType", n => { DeviceHealthScriptType = n.GetEnumValue<global::ApiSdk.Models.DeviceHealthScriptType>(); } },
                { "deviceRunStates", n => { DeviceRunStates = n.GetCollectionOfObjectValues<global::ApiSdk.Models.DeviceHealthScriptDeviceState>(global::ApiSdk.Models.DeviceHealthScriptDeviceState.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "remediationScriptParameters", n => { RemediationScriptParameters = n.GetCollectionOfObjectValues<global::ApiSdk.Models.DeviceHealthScriptParameter>(global::ApiSdk.Models.DeviceHealthScriptParameter.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "runSummary", n => { RunSummary = n.GetObjectValue<global::ApiSdk.Models.DeviceHealthScriptRunSummary>(global::ApiSdk.Models.DeviceHealthScriptRunSummary.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.DeviceHealthScriptParameter>("detectionScriptParameters", DetectionScriptParameters);
            writer.WriteEnumValue<global::ApiSdk.Models.DeviceHealthScriptType>("deviceHealthScriptType", DeviceHealthScriptType);
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.DeviceHealthScriptDeviceState>("deviceRunStates", DeviceRunStates);
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.DeviceHealthScriptParameter>("remediationScriptParameters", RemediationScriptParameters);
            ...
            writer.WriteObjectValue<global::ApiSdk.Models.DeviceHealthScriptRunSummary>("runSummary", RunSummary);
