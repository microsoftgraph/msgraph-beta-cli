...
namespace ApiSdk.Admin.Windows.Updates.UpdatePolicies.Item.Audience.MicrosoftGraphWindowsUpdatesUpdateAudienceById
{
    ...
    public class MicrosoftGraphWindowsUpdatesUpdateAudienceByIdRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Admin.Windows.Updates.UpdatePolicies.Item.Audience.MicrosoftGraphWindowsUpdatesUpdateAudienceById.MicrosoftGraphWindowsUpdatesUpdateAudienceByIdRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Admin.Windows.Updates.UpdatePolicies.Item.Audience.MicrosoftGraphWindowsUpdatesUpdateAudienceById.UpdateAudienceByIdPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Admin.Windows.Updates.UpdatePolicies.Item.Audience.MicrosoftGraphWindowsUpdatesUpdateAudienceById.UpdateAudienceByIdPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
