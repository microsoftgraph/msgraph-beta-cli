...
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp.Assignments;
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp.Categories;
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp.ContentVersions;
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp.Relationships;
...
namespace ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp
{
    ...
    public partial class GraphMacOSPkgAppRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildAssignmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp.Assignments.AssignmentsRequestBuilder(PathParameters);
        ...
        public Command BuildCategoriesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp.Categories.CategoriesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildContentVersionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp.ContentVersions.ContentVersionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get the item of type microsoft.graph.mobileApp as microsoft.graph.macOSPkgApp";
        ...
        public Command BuildRelationshipsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp.Relationships.RelationshipsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp.GraphMacOSPkgAppRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp.GraphMacOSPkgAppRequestBuilder.GraphMacOSPkgAppRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSPkgApp.GraphMacOSPkgAppRequestBuilder.GraphMacOSPkgAppRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class GraphMacOSPkgAppRequestBuilderGetQueryParameters 
        {
