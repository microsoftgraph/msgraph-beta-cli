...
namespace ApiSdk.Users.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.Pages.Item.OnenotePatchContent {
    ...
    public class OnenotePatchContentRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public OnenotePatchContentRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/onenotePatchContent", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="OnenotePatchContentRequestBuilder"/> and sets the default values.
        ...
        public OnenotePatchContentRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/onenotePatchContent", rawUrl)
        {
        }
        /// <summary>
        /// Invoke action onenotePatchContent
