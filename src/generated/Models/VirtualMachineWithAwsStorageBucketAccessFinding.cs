...
namespace ApiSdk.Models
{
    ...
    public class VirtualMachineWithAwsStorageBucketAccessFinding : ApiSdk.Models.Finding, IParsable
...
#nullable enable
        public ApiSdk.Models.AuthorizationSystemResource? Ec2Instance { get; set; }
#nullable restore
#else
        public ApiSdk.Models.AuthorizationSystemResource Ec2Instance { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.VirtualMachineWithAwsStorageBucketAccessFinding"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.VirtualMachineWithAwsStorageBucketAccessFinding CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.VirtualMachineWithAwsStorageBucketAccessFinding();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "ec2Instance", n => { Ec2Instance = n.GetObjectValue<ApiSdk.Models.AuthorizationSystemResource>(ApiSdk.Models.AuthorizationSystemResource.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.AuthorizationSystemResource>("ec2Instance", Ec2Instance);
