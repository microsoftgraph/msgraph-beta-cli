// <auto-generated/>
using ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Count;
using ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Item;
...
using System;
namespace ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections {
    /// <summary>
    ...
    public class SectionsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public SectionsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sections{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="SectionsRequestBuilder"/> and sets the default values.
        ...
        public SectionsRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sections{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Retrieve a list of onenoteSection objects from the specified section group.
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(OnenoteSection body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sections", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
