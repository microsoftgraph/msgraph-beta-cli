    ...
    public class SitesRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCreateCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<BrowserSite>(BrowserSite.CreateFromDiscriminatorValue);
                if (model is null) {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(BrowserSite body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(BrowserSite body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
