...
namespace ApiSdk.Models
{
    ...
    public class CloudPcManagementGroupAssignmentTarget : ApiSdk.Models.CloudPcManagementAssignmentTarget, IParsable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.CloudPcManagementGroupAssignmentTarget"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.CloudPcManagementGroupAssignmentTarget"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.CloudPcManagementGroupAssignmentTarget CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.CloudPcManagementGroupAssignmentTarget();
        }
        /// <summary>
