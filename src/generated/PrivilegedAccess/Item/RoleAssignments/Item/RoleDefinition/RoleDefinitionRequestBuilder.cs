...
namespace ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.RoleDefinition
{
    ...
    public class RoleDefinitionRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildResourceNavCommand()
        {
            ...
            var builder = new ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.RoleDefinition.Resource.ResourceRequestBuilder(PathParameters);
        ...
        public Command BuildRoleSettingNavCommand()
        {
            ...
            var builder = new ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.RoleDefinition.RoleSetting.RoleSettingRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.RoleDefinition.RoleDefinitionRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.RoleDefinition.RoleDefinitionRequestBuilder.RoleDefinitionRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.PrivilegedAccess.Item.RoleAssignments.Item.RoleDefinition.RoleDefinitionRequestBuilder.RoleDefinitionRequestBuilderGetQueryParameters>> requestConfiguration = default)
