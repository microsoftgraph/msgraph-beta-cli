...
namespace ApiSdk.Users.Item.Onenote.SectionGroups.Item.SectionGroups.Item {
    ...
    public class SectionGroupItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public SectionGroupItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sectionGroups/{sectionGroup%2Did1}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="SectionGroupItemRequestBuilder"/> and sets the default values.
        ...
        public SectionGroupItemRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sectionGroups/{sectionGroup%2Did1}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// The section groups in the section. Read-only. Nullable.
