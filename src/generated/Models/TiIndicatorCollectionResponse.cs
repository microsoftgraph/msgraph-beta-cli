...
namespace ApiSdk.Models {
    ...
    public class TiIndicatorCollectionResponse : BaseCollectionPaginationCountResponse, IParsable 
...
#nullable restore
        ...
        public static new TiIndicatorCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new TiIndicatorCollectionResponse();
        }
        /// <summary>
