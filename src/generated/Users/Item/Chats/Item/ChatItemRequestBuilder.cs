...
using ApiSdk.Models;
using ApiSdk.Users.Item.Chats.Item.CompleteMigration;
...
namespace ApiSdk.Users.Item.Chats.Item
{
    ...
    public partial class ChatItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCompleteMigrationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Chats.Item.CompleteMigration.CompleteMigrationRequestBuilder(PathParameters);
        ...
        public Command BuildOperationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Chats.Item.Operations.OperationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRemoveAllAccessForUserNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Chats.Item.RemoveAllAccessForUser.RemoveAllAccessForUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
