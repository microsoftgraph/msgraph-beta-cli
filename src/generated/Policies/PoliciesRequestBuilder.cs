...
using ApiSdk.Models;
using ApiSdk.Policies.AccessReviewPolicy;
...
using ApiSdk.Policies.B2cAuthenticationMethodsPolicy;
...
using ApiSdk.Policies.DirectoryRoleAccessReviewPolicy;
using ApiSdk.Policies.ExternalIdentitiesPolicy;
using ApiSdk.Policies.FeatureRolloutPolicies;
using ApiSdk.Policies.FederatedTokenValidationPolicy;
using ApiSdk.Policies.HomeRealmDiscoveryPolicies;
using ApiSdk.Policies.IdentitySecurityDefaultsEnforcementPolicy;
using ApiSdk.Policies.MobileAppManagementPolicies;
using ApiSdk.Policies.MobileDeviceManagementPolicies;
...
using ApiSdk.Policies.ServicePrincipalCreationPolicies;
...
namespace ApiSdk.Policies
{
    ...
    public class PoliciesRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAccessReviewPolicyNavCommand()
        {
            var command = new Command("access-review-policy");
            command.Description = "Provides operations to manage the accessReviewPolicy property of the microsoft.graph.policyRoot entity.";
            var builder = new ApiSdk.Policies.AccessReviewPolicy.AccessReviewPolicyRequestBuilder(PathParameters);
        ...
        public Command BuildActivityBasedTimeoutPoliciesNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.ActivityBasedTimeoutPolicies.ActivityBasedTimeoutPoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildAdminConsentRequestPolicyNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.AdminConsentRequestPolicy.AdminConsentRequestPolicyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildAppManagementPoliciesNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.AppManagementPolicies.AppManagementPoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildAuthenticationFlowsPolicyNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.AuthenticationFlowsPolicy.AuthenticationFlowsPolicyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildAuthenticationMethodsPolicyNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.AuthenticationMethodsPolicy.AuthenticationMethodsPolicyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildAuthenticationStrengthPoliciesNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.AuthenticationStrengthPolicies.AuthenticationStrengthPoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
            nonExecCommands.Add(builder.BuildFindByMethodModeWithAuthenticationMethodModesRbCommand());
            execCommands.Add(builder.BuildListCommand());
            var cmds = builder.BuildCommand();
            execCommands.AddRange(cmds.Item1);
            nonExecCommands.AddRange(cmds.Item2);
        ...
        public Command BuildAuthorizationPolicyNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.AuthorizationPolicy.AuthorizationPolicyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildB2cAuthenticationMethodsPolicyNavCommand()
        {
            var command = new Command("b2c-authentication-methods-policy");
            command.Description = "Provides operations to manage the b2cAuthenticationMethodsPolicy property of the microsoft.graph.policyRoot entity.";
            var builder = new ApiSdk.Policies.B2cAuthenticationMethodsPolicy.B2cAuthenticationMethodsPolicyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildClaimsMappingPoliciesNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.ClaimsMappingPolicies.ClaimsMappingPoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildConditionalAccessPoliciesNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.ConditionalAccessPolicies.ConditionalAccessPoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildCrossTenantAccessPolicyNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.CrossTenantAccessPolicy.CrossTenantAccessPolicyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildDefaultAppManagementPolicyNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.DefaultAppManagementPolicy.DefaultAppManagementPolicyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildDeviceRegistrationPolicyNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.DeviceRegistrationPolicy.DeviceRegistrationPolicyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildDirectoryRoleAccessReviewPolicyNavCommand()
        {
            var command = new Command("directory-role-access-review-policy");
            command.Description = "Provides operations to manage the directoryRoleAccessReviewPolicy property of the microsoft.graph.policyRoot entity.";
            var builder = new ApiSdk.Policies.DirectoryRoleAccessReviewPolicy.DirectoryRoleAccessReviewPolicyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildExternalIdentitiesPolicyNavCommand()
        {
            var command = new Command("external-identities-policy");
            command.Description = "Provides operations to manage the externalIdentitiesPolicy property of the microsoft.graph.policyRoot entity.";
            var builder = new ApiSdk.Policies.ExternalIdentitiesPolicy.ExternalIdentitiesPolicyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildFeatureRolloutPoliciesNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.FeatureRolloutPolicies.FeatureRolloutPoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildFederatedTokenValidationPolicyNavCommand()
        {
            var command = new Command("federated-token-validation-policy");
            command.Description = "Provides operations to manage the federatedTokenValidationPolicy property of the microsoft.graph.policyRoot entity.";
            var builder = new ApiSdk.Policies.FederatedTokenValidationPolicy.FederatedTokenValidationPolicyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildHomeRealmDiscoveryPoliciesNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.HomeRealmDiscoveryPolicies.HomeRealmDiscoveryPoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildIdentitySecurityDefaultsEnforcementPolicyNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.IdentitySecurityDefaultsEnforcementPolicy.IdentitySecurityDefaultsEnforcementPolicyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildMobileAppManagementPoliciesNavCommand()
        {
            var command = new Command("mobile-app-management-policies");
            command.Description = "Provides operations to manage the mobileAppManagementPolicies property of the microsoft.graph.policyRoot entity.";
            var builder = new ApiSdk.Policies.MobileAppManagementPolicies.MobileAppManagementPoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildMobileDeviceManagementPoliciesNavCommand()
        {
            var command = new Command("mobile-device-management-policies");
            command.Description = "Provides operations to manage the mobileDeviceManagementPolicies property of the microsoft.graph.policyRoot entity.";
            var builder = new ApiSdk.Policies.MobileDeviceManagementPolicies.MobileDeviceManagementPoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.PolicyRoot>(ApiSdk.Models.PolicyRoot.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPermissionGrantPoliciesNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.PermissionGrantPolicies.PermissionGrantPoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRoleManagementPoliciesNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.RoleManagementPolicies.RoleManagementPoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRoleManagementPolicyAssignmentsNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.RoleManagementPolicyAssignments.RoleManagementPolicyAssignmentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildServicePrincipalCreationPoliciesNavCommand()
        {
            var command = new Command("service-principal-creation-policies");
            command.Description = "Provides operations to manage the servicePrincipalCreationPolicies property of the microsoft.graph.policyRoot entity.";
            var builder = new ApiSdk.Policies.ServicePrincipalCreationPolicies.ServicePrincipalCreationPoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildTokenIssuancePoliciesNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.TokenIssuancePolicies.TokenIssuancePoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildTokenLifetimePoliciesNavCommand()
        {
            ...
            var builder = new ApiSdk.Policies.TokenLifetimePolicies.TokenLifetimePoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Policies.PoliciesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Policies.PoliciesRequestBuilder.PoliciesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Policies.PoliciesRequestBuilder.PoliciesRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.PolicyRoot body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.PolicyRoot body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
