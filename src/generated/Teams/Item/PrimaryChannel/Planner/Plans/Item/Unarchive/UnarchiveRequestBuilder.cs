...
using System;
namespace ApiSdk.Teams.Item.PrimaryChannel.Planner.Plans.Item.Unarchive
{
    /// <summary>
    ...
    public partial class UnarchiveRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Teams.Item.PrimaryChannel.Planner.Plans.Item.Unarchive.UnarchivePostRequestBody>(global::ApiSdk.Teams.Item.PrimaryChannel.Planner.Plans.Item.Unarchive.UnarchivePostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Teams.Item.PrimaryChannel.Planner.Plans.Item.Unarchive.UnarchiveRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public UnarchiveRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/teams/{team%2Did}/primaryChannel/planner/plans/{plannerPlan%2Did}/unarchive", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Teams.Item.PrimaryChannel.Planner.Plans.Item.Unarchive.UnarchiveRequestBuilder"/> and sets the default values.
        ...
        public UnarchiveRequestBuilder(string rawUrl) : base("{+baseurl}/teams/{team%2Did}/primaryChannel/planner/plans/{plannerPlan%2Did}/unarchive", rawUrl)
        {
        }
        /// <summary>
        /// Unarchive a plannerPlan object. Unarchiving a plan, also unarchives the plannerTasks and plannerBuckets in the plan.  Only a plan that is archived can be unarchived.
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Teams.Item.PrimaryChannel.Planner.Plans.Item.Unarchive.UnarchivePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Teams.Item.PrimaryChannel.Planner.Plans.Item.Unarchive.UnarchivePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
