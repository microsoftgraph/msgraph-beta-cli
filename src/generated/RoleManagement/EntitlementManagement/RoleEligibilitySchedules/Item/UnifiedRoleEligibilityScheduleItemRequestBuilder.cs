...
namespace ApiSdk.RoleManagement.EntitlementManagement.RoleEligibilitySchedules.Item
{
    ...
    public partial class UnifiedRoleEligibilityScheduleItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAppScopeNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EntitlementManagement.RoleEligibilitySchedules.Item.AppScope.AppScopeRequestBuilder(PathParameters);
        ...
        public Command BuildDirectoryScopeNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EntitlementManagement.RoleEligibilitySchedules.Item.DirectoryScope.DirectoryScopeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPrincipalNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EntitlementManagement.RoleEligibilitySchedules.Item.Principal.PrincipalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRoleDefinitionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EntitlementManagement.RoleEligibilitySchedules.Item.RoleDefinition.RoleDefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.RoleManagement.EntitlementManagement.RoleEligibilitySchedules.Item.UnifiedRoleEligibilityScheduleItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.RoleManagement.EntitlementManagement.RoleEligibilitySchedules.Item.UnifiedRoleEligibilityScheduleItemRequestBuilder.UnifiedRoleEligibilityScheduleItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.RoleManagement.EntitlementManagement.RoleEligibilitySchedules.Item.UnifiedRoleEligibilityScheduleItemRequestBuilder.UnifiedRoleEligibilityScheduleItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
