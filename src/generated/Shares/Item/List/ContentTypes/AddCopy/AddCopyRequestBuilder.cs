    ...
    public class AddCopyRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Shares.Item.List.ContentTypes.AddCopy.AddCopyPostRequestBody>(ApiSdk.Shares.Item.List.ContentTypes.AddCopy.AddCopyPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Shares.Item.List.ContentTypes.AddCopy.AddCopyRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Shares.Item.List.ContentTypes.AddCopy.AddCopyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Shares.Item.List.ContentTypes.AddCopy.AddCopyPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
