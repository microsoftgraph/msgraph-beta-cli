...
namespace ApiSdk.DeviceManagement.VirtualEndpoint.SharedUseServicePlans.Item
{
    ...
    public class CloudPcSharedUseServicePlanItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property sharedUseServicePlans for deviceManagement";
            ...
            command.AddOption(cloudPcSharedUseServicePlanIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                var cloudPcSharedUseServicePlanId = invocationContext.ParseResult.GetValueForOption(cloudPcSharedUseServicePlanIdOption);
                var ifMatch = invocationContext.ParseResult.GetValueForOption(ifMatchOption);
                var cancellationToken = invocationContext.GetCancellationToken();
                var reqAdapter = invocationContext.GetRequestAdapter();
                var requestInfo = ToDeleteRequestInformation(q => {
                });
                if (cloudPcSharedUseServicePlanId is not null) requestInfo.PathParameters.Add("cloudPcSharedUseServicePlan%2Did", cloudPcSharedUseServicePlanId);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property sharedUseServicePlans in deviceManagement";
            var cloudPcSharedUseServicePlanIdOption = new Option<string>("--cloud-pc-shared-use-service-plan-id", description: "The unique identifier of cloudPcSharedUseServicePlan") {
            };
            cloudPcSharedUseServicePlanIdOption.IsRequired = true;
            command.AddOption(cloudPcSharedUseServicePlanIdOption);
