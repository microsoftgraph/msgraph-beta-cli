...
namespace ApiSdk.Communications.Presences.Item
{
    ...
    public partial class PresenceItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildClearPresenceNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Communications.Presences.Item.ClearPresence.ClearPresenceRequestBuilder(PathParameters);
        ...
        public Command BuildClearUserPreferredPresenceNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Communications.Presences.Item.ClearUserPreferredPresence.ClearUserPreferredPresenceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSetPresenceNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Communications.Presences.Item.SetPresence.SetPresenceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSetStatusMessageNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Communications.Presences.Item.SetStatusMessage.SetStatusMessageRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSetUserPreferredPresenceNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Communications.Presences.Item.SetUserPreferredPresence.SetUserPreferredPresenceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Communications.Presences.Item.PresenceItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Communications.Presences.Item.PresenceItemRequestBuilder.PresenceItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Communications.Presences.Item.PresenceItemRequestBuilder.PresenceItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class PresenceItemRequestBuilderGetQueryParameters 
        {
