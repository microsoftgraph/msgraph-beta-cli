...
namespace ApiSdk.Models.Security
{
    ...
    public class ProcessEvidence : ApiSdk.Models.Security.AlertEvidence, IParsable
...
#nullable enable
        public ApiSdk.Models.Security.FileDetails? ImageFile { get; set; }
#nullable restore
#else
        public ApiSdk.Models.Security.FileDetails ImageFile { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.Security.FileDetails? ParentProcessImageFile { get; set; }
#nullable restore
#else
        public ApiSdk.Models.Security.FileDetails ParentProcessImageFile { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.Security.ProcessEvidence"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.Security.ProcessEvidence"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.Security.ProcessEvidence CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.Security.ProcessEvidence();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "imageFile", n => { ImageFile = n.GetObjectValue<ApiSdk.Models.Security.FileDetails>(ApiSdk.Models.Security.FileDetails.CreateFromDiscriminatorValue); } },
                ...
                { "parentProcessImageFile", n => { ParentProcessImageFile = n.GetObjectValue<ApiSdk.Models.Security.FileDetails>(ApiSdk.Models.Security.FileDetails.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.Security.FileDetails>("imageFile", ImageFile);
            ...
            writer.WriteObjectValue<ApiSdk.Models.Security.FileDetails>("parentProcessImageFile", ParentProcessImageFile);
