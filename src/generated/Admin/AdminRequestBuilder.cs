...
using ApiSdk.Admin.AppsAndServices;
using ApiSdk.Admin.Dynamics;
using ApiSdk.Admin.Edge;
using ApiSdk.Admin.Entra;
using ApiSdk.Admin.Exchange;
using ApiSdk.Admin.Forms;
...
using ApiSdk.Admin.Teams;
using ApiSdk.Admin.Todo;
...
namespace ApiSdk.Admin
{
    ...
    public partial class AdminRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAppsAndServicesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Admin.AppsAndServices.AppsAndServicesRequestBuilder(PathParameters);
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildDynamicsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Admin.Dynamics.DynamicsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildEntraNavCommand()
        {
            var command = new Command("entra");
            command.Description = "Provides operations to manage the entra property of the microsoft.graph.admin entity.";
            var builder = new global::ApiSdk.Admin.Entra.EntraRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
            nonExecCommands.Add(builder.BuildUxSettingNavCommand());
            foreach (var cmd in execCommands)
            {
                command.AddCommand(cmd);
            }
        ...
        public Command BuildExchangeNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the exchange property of the microsoft.graph.admin entity.";
            var builder = new global::ApiSdk.Admin.Exchange.ExchangeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            nonExecCommands.Add(builder.BuildMailboxesNavCommand());
            nonExecCommands.Add(builder.BuildMessageTracesNavCommand());
            execCommands.Add(builder.BuildPatchCommand());
            foreach (var cmd in execCommands)
            {
                command.AddCommand(cmd);
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildFormsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Admin.Forms.FormsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildPeopleNavCommand()
        {
            ...
            nonExecCommands.Add(builder.BuildNamePronunciationNavCommand());
            execCommands.Add(builder.BuildPatchCommand());
            nonExecCommands.Add(builder.BuildProfileCardPropertiesNavCommand());
            nonExecCommands.Add(builder.BuildProfilePropertySettingsNavCommand());
            nonExecCommands.Add(builder.BuildProfileSourcesNavCommand());
            nonExecCommands.Add(builder.BuildProfileSourcesWithSourceIdRbCommand());
        ...
        public Command BuildTeamsNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the teams property of the microsoft.graph.admin entity.";
            var builder = new global::ApiSdk.Admin.Teams.TeamsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            ...
            nonExecCommands.Add(builder.BuildUserConfigurationsNavCommand());
            foreach (var cmd in execCommands)
            {
                command.AddCommand(cmd);
            }
        ...
        public Command BuildTodoNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Admin.Todo.TodoRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildWindowsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Admin.Windows.WindowsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
            nonExecCommands.Add(builder.BuildUpdatesNavCommand());
            foreach (var cmd in execCommands)
            {
                command.AddCommand(cmd);
            }
