...
namespace ApiSdk.Users.Item.Contacts {
    ...
    public class ContactsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public ContactsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/contacts{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ContactsRequestBuilder"/> and sets the default values.
        ...
        public ContactsRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/contacts{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get contacts in the user&apos;s mailbox. There are two scenarios where an app can get contacts in another user&apos;s contact folder:
