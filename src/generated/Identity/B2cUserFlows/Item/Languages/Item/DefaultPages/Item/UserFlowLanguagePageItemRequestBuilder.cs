...
namespace ApiSdk.Identity.B2cUserFlows.Item.Languages.Item.DefaultPages.Item
{
    ...
    public class UserFlowLanguagePageItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildContentNavCommand()
        {
            ...
            var builder = new ApiSdk.Identity.B2cUserFlows.Item.Languages.Item.DefaultPages.Item.Value.ContentRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Identity.B2cUserFlows.Item.Languages.Item.DefaultPages.Item.UserFlowLanguagePageItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Identity.B2cUserFlows.Item.Languages.Item.DefaultPages.Item.UserFlowLanguagePageItemRequestBuilder.UserFlowLanguagePageItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Identity.B2cUserFlows.Item.Languages.Item.DefaultPages.Item.UserFlowLanguagePageItemRequestBuilder.UserFlowLanguagePageItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
