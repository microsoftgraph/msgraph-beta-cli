...
using ApiSdk.Models;
using ApiSdk.Users.Item.OwnedDevices.Item.GraphAppRoleAssignment;
using ApiSdk.Users.Item.OwnedDevices.Item.GraphDevice;
using ApiSdk.Users.Item.OwnedDevices.Item.GraphEndpoint;
...
namespace ApiSdk.Users.Item.OwnedDevices.Item
{
    ...
    public partial class DirectoryObjectItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGraphAppRoleAssignmentByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.OwnedDevices.Item.GraphAppRoleAssignment.GraphAppRoleAssignmentRequestBuilder(PathParameters);
        ...
        public Command BuildGraphDeviceByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.OwnedDevices.Item.GraphDevice.GraphDeviceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGraphEndpointByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.OwnedDevices.Item.GraphEndpoint.GraphEndpointRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.OwnedDevices.Item.DirectoryObjectItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public DirectoryObjectItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/ownedDevices/{directoryObject%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.OwnedDevices.Item.DirectoryObjectItemRequestBuilder"/> and sets the default values.
        ...
        public DirectoryObjectItemRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/ownedDevices/{directoryObject%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Devices owned by the user. Read-only. Nullable. Supports $expand.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.OwnedDevices.Item.DirectoryObjectItemRequestBuilder.DirectoryObjectItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.OwnedDevices.Item.DirectoryObjectItemRequestBuilder.DirectoryObjectItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
