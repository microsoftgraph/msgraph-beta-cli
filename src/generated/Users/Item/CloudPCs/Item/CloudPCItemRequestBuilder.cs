...
using ApiSdk.Users.Item.CloudPCs.Item.RetrieveCloudPCRemoteActionResults;
using ApiSdk.Users.Item.CloudPCs.Item.RetrieveReviewStatus;
using ApiSdk.Users.Item.CloudPCs.Item.RetrieveSnapshots;
...
namespace ApiSdk.Users.Item.CloudPCs.Item
{
    ...
    public partial class CloudPCItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildChangeUserAccountTypeNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.ChangeUserAccountType.ChangeUserAccountTypeRequestBuilder(PathParameters);
        ...
        public Command BuildCreateSnapshotNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.CreateSnapshot.CreateSnapshotRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildEndGracePeriodNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.EndGracePeriod.EndGracePeriodRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetCloudPcConnectivityHistoryNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.GetCloudPcConnectivityHistory.GetCloudPcConnectivityHistoryRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGetCloudPcLaunchInfoNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.GetCloudPcLaunchInfo.GetCloudPcLaunchInfoRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetFrontlineCloudPcAccessStateNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.GetFrontlineCloudPcAccessState.GetFrontlineCloudPcAccessStateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetSupportedCloudPcRemoteActionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.GetSupportedCloudPcRemoteActions.GetSupportedCloudPcRemoteActionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPowerOffNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.PowerOff.PowerOffRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPowerOnNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.PowerOn.PowerOnRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRebootNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.Reboot.RebootRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRenameNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.Rename.RenameRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildReprovisionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.Reprovision.ReprovisionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildResizeNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.Resize.ResizeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRestoreNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.Restore.RestoreRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildRetrieveCloudPCRemoteActionResultsNavCommand()
        {
            var command = new Command("retrieve-cloud-p-c-remote-action-results");
            command.Description = "Provides operations to call the retrieveCloudPCRemoteActionResults method.";
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.RetrieveCloudPCRemoteActionResults.RetrieveCloudPCRemoteActionResultsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRetrieveReviewStatusNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.RetrieveReviewStatus.RetrieveReviewStatusRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildRetrieveSnapshotsNavCommand()
        {
            var command = new Command("retrieve-snapshots");
            command.Description = "Provides operations to call the retrieveSnapshots method.";
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.RetrieveSnapshots.RetrieveSnapshotsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRetryPartnerAgentInstallationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.RetryPartnerAgentInstallation.RetryPartnerAgentInstallationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSetReviewStatusNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.SetReviewStatus.SetReviewStatusRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildStartNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.Start.StartRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildStopNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.Stop.StopRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTroubleshootNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.CloudPCs.Item.Troubleshoot.TroubleshootRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.CloudPCs.Item.CloudPCItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.CloudPCs.Item.CloudPCItemRequestBuilder.CloudPCItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.CloudPCs.Item.CloudPCItemRequestBuilder.CloudPCItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
