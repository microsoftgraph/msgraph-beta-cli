    ...
    public class RecordDecisionsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.ApprovalWorkflowProviders.Item.BusinessFlows.Item.RecordDecisions.RecordDecisionsPostRequestBody>(ApiSdk.ApprovalWorkflowProviders.Item.BusinessFlows.Item.RecordDecisions.RecordDecisionsPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.ApprovalWorkflowProviders.Item.BusinessFlows.Item.RecordDecisions.RecordDecisionsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.ApprovalWorkflowProviders.Item.BusinessFlows.Item.RecordDecisions.RecordDecisionsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.ApprovalWorkflowProviders.Item.BusinessFlows.Item.RecordDecisions.RecordDecisionsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
