...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.Security.AnalyzedEmailAttachment>? Attachments { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.Security.AnalyzedEmailAttachment> Attachments { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.Security.AnalyzedEmailAuthenticationDetail? AuthenticationDetails { get; set; }
#nullable restore
#else
        public ApiSdk.Models.Security.AnalyzedEmailAuthenticationDetail AuthenticationDetails { get; set; }
#endif
...
#nullable restore
        ...
        public ApiSdk.Models.Security.AntispamDirectionality? Directionality { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.Security.AnalyzedEmailExchangeTransportRuleInfo>? ExchangeTransportRules { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.Security.AnalyzedEmailExchangeTransportRuleInfo> ExchangeTransportRules { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.Security.AnalyzedEmailDeliveryDetail? LatestDelivery { get; set; }
#nullable restore
#else
        public ApiSdk.Models.Security.AnalyzedEmailDeliveryDetail LatestDelivery { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.Security.AnalyzedEmailDeliveryDetail? OriginalDelivery { get; set; }
#nullable restore
#else
        public ApiSdk.Models.Security.AnalyzedEmailDeliveryDetail OriginalDelivery { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.Security.AnalyzedEmailSenderDetail? SenderDetail { get; set; }
#nullable restore
#else
        public ApiSdk.Models.Security.AnalyzedEmailSenderDetail SenderDetail { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.Security.ThreatType?>? ThreatTypes { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.Security.ThreatType?> ThreatTypes { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.Security.AnalyzedEmailUrl>? Urls { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.Security.AnalyzedEmailUrl> Urls { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.Security.AnalyzedEmail"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.Security.AnalyzedEmail CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.Security.AnalyzedEmail();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "attachments", n => { Attachments = n.GetCollectionOfObjectValues<ApiSdk.Models.Security.AnalyzedEmailAttachment>(ApiSdk.Models.Security.AnalyzedEmailAttachment.CreateFromDiscriminatorValue)?.ToList(); } },
                { "attachmentsCount", n => { AttachmentsCount = n.GetIntValue(); } },
                { "authenticationDetails", n => { AuthenticationDetails = n.GetObjectValue<ApiSdk.Models.Security.AnalyzedEmailAuthenticationDetail>(ApiSdk.Models.Security.AnalyzedEmailAuthenticationDetail.CreateFromDiscriminatorValue); } },
                ...
                { "directionality", n => { Directionality = n.GetEnumValue<ApiSdk.Models.Security.AntispamDirectionality>(); } },
                { "distributionList", n => { DistributionList = n.GetStringValue(); } },
                { "emailClusterId", n => { EmailClusterId = n.GetStringValue(); } },
                { "exchangeTransportRules", n => { ExchangeTransportRules = n.GetCollectionOfObjectValues<ApiSdk.Models.Security.AnalyzedEmailExchangeTransportRuleInfo>(ApiSdk.Models.Security.AnalyzedEmailExchangeTransportRuleInfo.CreateFromDiscriminatorValue)?.ToList(); } },
                { "internetMessageId", n => { InternetMessageId = n.GetStringValue(); } },
                { "language", n => { Language = n.GetStringValue(); } },
                { "latestDelivery", n => { LatestDelivery = n.GetObjectValue<ApiSdk.Models.Security.AnalyzedEmailDeliveryDetail>(ApiSdk.Models.Security.AnalyzedEmailDeliveryDetail.CreateFromDiscriminatorValue); } },
                { "loggedDateTime", n => { LoggedDateTime = n.GetDateTimeOffsetValue(); } },
                { "networkMessageId", n => { NetworkMessageId = n.GetStringValue(); } },
                { "originalDelivery", n => { OriginalDelivery = n.GetObjectValue<ApiSdk.Models.Security.AnalyzedEmailDeliveryDetail>(ApiSdk.Models.Security.AnalyzedEmailDeliveryDetail.CreateFromDiscriminatorValue); } },
                ...
                { "senderDetail", n => { SenderDetail = n.GetObjectValue<ApiSdk.Models.Security.AnalyzedEmailSenderDetail>(ApiSdk.Models.Security.AnalyzedEmailSenderDetail.CreateFromDiscriminatorValue); } },
                { "sizeInBytes", n => { SizeInBytes = n.GetIntValue(); } },
                { "spamConfidenceLevel", n => { SpamConfidenceLevel = n.GetStringValue(); } },
                { "subject", n => { Subject = n.GetStringValue(); } },
                { "threatTypes", n => { ThreatTypes = n.GetCollectionOfEnumValues<ApiSdk.Models.Security.ThreatType>()?.ToList(); } },
                { "urls", n => { Urls = n.GetCollectionOfObjectValues<ApiSdk.Models.Security.AnalyzedEmailUrl>(ApiSdk.Models.Security.AnalyzedEmailUrl.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Security.AnalyzedEmailAttachment>("attachments", Attachments);
            writer.WriteIntValue("attachmentsCount", AttachmentsCount);
            writer.WriteObjectValue<ApiSdk.Models.Security.AnalyzedEmailAuthenticationDetail>("authenticationDetails", AuthenticationDetails);
            ...
            writer.WriteEnumValue<ApiSdk.Models.Security.AntispamDirectionality>("directionality", Directionality);
            writer.WriteStringValue("distributionList", DistributionList);
            writer.WriteStringValue("emailClusterId", EmailClusterId);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Security.AnalyzedEmailExchangeTransportRuleInfo>("exchangeTransportRules", ExchangeTransportRules);
            writer.WriteStringValue("internetMessageId", InternetMessageId);
            writer.WriteStringValue("language", Language);
            writer.WriteObjectValue<ApiSdk.Models.Security.AnalyzedEmailDeliveryDetail>("latestDelivery", LatestDelivery);
            writer.WriteDateTimeOffsetValue("loggedDateTime", LoggedDateTime);
            writer.WriteStringValue("networkMessageId", NetworkMessageId);
            writer.WriteObjectValue<ApiSdk.Models.Security.AnalyzedEmailDeliveryDetail>("originalDelivery", OriginalDelivery);
            ...
            writer.WriteObjectValue<ApiSdk.Models.Security.AnalyzedEmailSenderDetail>("senderDetail", SenderDetail);
            writer.WriteIntValue("sizeInBytes", SizeInBytes);
            writer.WriteStringValue("spamConfidenceLevel", SpamConfidenceLevel);
            writer.WriteStringValue("subject", Subject);
            writer.WriteCollectionOfEnumValues<ApiSdk.Models.Security.ThreatType>("threatTypes", ThreatTypes);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Security.AnalyzedEmailUrl>("urls", Urls);
