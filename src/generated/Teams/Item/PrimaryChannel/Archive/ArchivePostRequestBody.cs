...
namespace ApiSdk.Teams.Item.PrimaryChannel.Archive
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Teams.Item.PrimaryChannel.Archive.ArchivePostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Teams.Item.PrimaryChannel.Archive.ArchivePostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Teams.Item.PrimaryChannel.Archive.ArchivePostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Teams.Item.PrimaryChannel.Archive.ArchivePostRequestBody();
        }
        /// <summary>
