    ...
    public class UploadNewVersionRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.DeviceManagement.GroupPolicyUploadedDefinitionFiles.Item.UploadNewVersion.UploadNewVersionPostRequestBody>(ApiSdk.DeviceManagement.GroupPolicyUploadedDefinitionFiles.Item.UploadNewVersion.UploadNewVersionPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceManagement.GroupPolicyUploadedDefinitionFiles.Item.UploadNewVersion.UploadNewVersionRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.DeviceManagement.GroupPolicyUploadedDefinitionFiles.Item.UploadNewVersion.UploadNewVersionPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.DeviceManagement.GroupPolicyUploadedDefinitionFiles.Item.UploadNewVersion.UploadNewVersionPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
