...
using ApiSdk.Groups.Item.Sites.Item.Onenote.Notebooks;
using ApiSdk.Groups.Item.Sites.Item.Onenote.Operations;
using ApiSdk.Groups.Item.Sites.Item.Onenote.Pages;
using ApiSdk.Groups.Item.Sites.Item.Onenote.Resources;
using ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups;
using ApiSdk.Groups.Item.Sites.Item.Onenote.Sections;
...
using System;
namespace ApiSdk.Groups.Item.Sites.Item.Onenote
{
    /// <summary>
    /// Provides operations to manage the onenote property of the microsoft.graph.site entity.
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class OnenoteRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildNotebooksNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.Onenote.Notebooks.NotebooksRequestBuilder(PathParameters);
        ...
        public Command BuildOperationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.Onenote.Operations.OperationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPagesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.Onenote.Pages.PagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Onenote>(global::ApiSdk.Models.Onenote.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildResourcesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.Onenote.Resources.ResourcesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildSectionGroupsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups.SectionGroupsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildSectionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.Onenote.Sections.SectionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Sites.Item.Onenote.OnenoteRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.Sites.Item.Onenote.OnenoteRequestBuilder.OnenoteRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.Sites.Item.Onenote.OnenoteRequestBuilder.OnenoteRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Onenote body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Onenote body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
