...
using ApiSdk.DeviceManagement.Templates.Item.Categories;
using ApiSdk.DeviceManagement.Templates.Item.CompareWithTemplateId;
using ApiSdk.DeviceManagement.Templates.Item.CreateInstance;
using ApiSdk.DeviceManagement.Templates.Item.MigratableTo;
using ApiSdk.DeviceManagement.Templates.Item.Settings;
...
namespace ApiSdk.DeviceManagement.Templates.Item
{
    ...
    public partial class DeviceManagementTemplateItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCategoriesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.Templates.Item.Categories.CategoriesRequestBuilder(PathParameters);
        ...
        public Command BuildCompareWithTemplateIdRbCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.Templates.Item.CompareWithTemplateId.CompareWithTemplateIdRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCreateInstanceNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.Templates.Item.CreateInstance.CreateInstanceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property templates for deviceManagement";
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildMigratableToNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.Templates.Item.MigratableTo.MigratableToRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property templates in deviceManagement";
            var deviceManagementTemplateIdOption = new Option<string>("--device-management-template-id", description: "The unique identifier of deviceManagementTemplate") {
            };
            deviceManagementTemplateIdOption.IsRequired = true;
            command.AddOption(deviceManagementTemplateIdOption);
        ...
        public Command BuildSettingsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.Templates.Item.Settings.SettingsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.DeviceManagement.Templates.Item.DeviceManagementTemplateItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceManagement.Templates.Item.DeviceManagementTemplateItemRequestBuilder.DeviceManagementTemplateItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceManagement.Templates.Item.DeviceManagementTemplateItemRequestBuilder.DeviceManagementTemplateItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
