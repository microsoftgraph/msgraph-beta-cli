...
namespace ApiSdk.Users.Item.OnlineMeetings.Item.AttendanceReports.Item {
    ...
    public class MeetingAttendanceReportItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public MeetingAttendanceReportItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/attendanceReports/{meetingAttendanceReport%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="MeetingAttendanceReportItemRequestBuilder"/> and sets the default values.
        ...
        public MeetingAttendanceReportItemRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/attendanceReports/{meetingAttendanceReport%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property attendanceReports for users
