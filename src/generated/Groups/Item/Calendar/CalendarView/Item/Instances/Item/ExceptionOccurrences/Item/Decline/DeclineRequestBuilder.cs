...
using System;
namespace ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Decline
{
    /// <summary>
    ...
    public partial class DeclineRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Decline.DeclinePostRequestBody>(global::ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Decline.DeclinePostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Decline.DeclineRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public DeclineRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/decline", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Decline.DeclineRequestBuilder"/> and sets the default values.
        ...
        public DeclineRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/decline", rawUrl)
        {
        }
        /// <summary>
        /// Decline invitation to the specified event in a user calendar. If the event allows proposals for new times, on declining the event, an invitee can choose to suggest an alternative time by including the proposedNewTime parameter. For more information on how to propose a time, and how to receive and accept a new time proposal, see Propose new meeting times.
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Decline.DeclinePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.ExceptionOccurrences.Item.Decline.DeclinePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
