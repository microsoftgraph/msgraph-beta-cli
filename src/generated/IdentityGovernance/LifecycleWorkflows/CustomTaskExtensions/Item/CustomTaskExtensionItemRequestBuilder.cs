...
namespace ApiSdk.IdentityGovernance.LifecycleWorkflows.CustomTaskExtensions.Item
{
    ...
    public class CustomTaskExtensionItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCreatedByNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.LifecycleWorkflows.CustomTaskExtensions.Item.CreatedBy.CreatedByRequestBuilder(PathParameters);
        ...
        public Command BuildLastModifiedByNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.LifecycleWorkflows.CustomTaskExtensions.Item.LastModifiedBy.LastModifiedByRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            nonExecCommands.Add(builder.BuildMailboxSettingsNavCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.IdentityGovernance.LifecycleWorkflows.CustomTaskExtensions.Item.CustomTaskExtensionItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.IdentityGovernance.LifecycleWorkflows.CustomTaskExtensions.Item.CustomTaskExtensionItemRequestBuilder.CustomTaskExtensionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.IdentityGovernance.LifecycleWorkflows.CustomTaskExtensions.Item.CustomTaskExtensionItemRequestBuilder.CustomTaskExtensionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.IdentityGovernance.CustomTaskExtension body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.IdentityGovernance.CustomTaskExtension body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
