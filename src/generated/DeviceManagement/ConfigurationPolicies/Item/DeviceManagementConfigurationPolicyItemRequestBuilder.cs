...
using ApiSdk.DeviceManagement.ConfigurationPolicies.Item.Assign;
using ApiSdk.DeviceManagement.ConfigurationPolicies.Item.Assignments;
using ApiSdk.DeviceManagement.ConfigurationPolicies.Item.ClearEnrollmentTimeDeviceMembershipTarget;
using ApiSdk.DeviceManagement.ConfigurationPolicies.Item.CreateCopy;
using ApiSdk.DeviceManagement.ConfigurationPolicies.Item.Reorder;
using ApiSdk.DeviceManagement.ConfigurationPolicies.Item.RetrieveEnrollmentTimeDeviceMembershipTarget;
using ApiSdk.DeviceManagement.ConfigurationPolicies.Item.RetrieveLatestUpgradeDefaultBaselinePolicy;
using ApiSdk.DeviceManagement.ConfigurationPolicies.Item.SetEnrollmentTimeDeviceMembershipTarget;
using ApiSdk.DeviceManagement.ConfigurationPolicies.Item.Settings;
...
using System;
namespace ApiSdk.DeviceManagement.ConfigurationPolicies.Item
{
    /// <summary>
    ...
    public partial class DeviceManagementConfigurationPolicyItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAssignmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.ConfigurationPolicies.Item.Assignments.AssignmentsRequestBuilder(PathParameters);
        ...
        public Command BuildAssignNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.ConfigurationPolicies.Item.Assign.AssignRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildClearEnrollmentTimeDeviceMembershipTargetNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.ConfigurationPolicies.Item.ClearEnrollmentTimeDeviceMembershipTarget.ClearEnrollmentTimeDeviceMembershipTargetRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildCreateCopyNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.ConfigurationPolicies.Item.CreateCopy.CreateCopyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property configurationPolicies for deviceManagement";
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "List of all Configuration policies";
            var deviceManagementConfigurationPolicyIdOption = new Option<string>("--device-management-configuration-policy-id", description: "The unique identifier of deviceManagementConfigurationPolicy") {
            };
            deviceManagementConfigurationPolicyIdOption.IsRequired = true;
            command.AddOption(deviceManagementConfigurationPolicyIdOption);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property configurationPolicies in deviceManagement";
            var deviceManagementConfigurationPolicyIdOption = new Option<string>("--device-management-configuration-policy-id", description: "The unique identifier of deviceManagementConfigurationPolicy") {
            };
            deviceManagementConfigurationPolicyIdOption.IsRequired = true;
            command.AddOption(deviceManagementConfigurationPolicyIdOption);
        ...
        public Command BuildReorderNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.ConfigurationPolicies.Item.Reorder.ReorderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRetrieveEnrollmentTimeDeviceMembershipTargetNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.ConfigurationPolicies.Item.RetrieveEnrollmentTimeDeviceMembershipTarget.RetrieveEnrollmentTimeDeviceMembershipTargetRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRetrieveLatestUpgradeDefaultBaselinePolicyNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.ConfigurationPolicies.Item.RetrieveLatestUpgradeDefaultBaselinePolicy.RetrieveLatestUpgradeDefaultBaselinePolicyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSetEnrollmentTimeDeviceMembershipTargetNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.ConfigurationPolicies.Item.SetEnrollmentTimeDeviceMembershipTarget.SetEnrollmentTimeDeviceMembershipTargetRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSettingsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceManagement.ConfigurationPolicies.Item.Settings.SettingsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.DeviceManagement.ConfigurationPolicies.Item.DeviceManagementConfigurationPolicyItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceManagement.ConfigurationPolicies.Item.DeviceManagementConfigurationPolicyItemRequestBuilder.DeviceManagementConfigurationPolicyItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceManagement.ConfigurationPolicies.Item.DeviceManagementConfigurationPolicyItemRequestBuilder.DeviceManagementConfigurationPolicyItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
