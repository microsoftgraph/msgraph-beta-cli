...
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsUniversalAppX.Assignments;
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsUniversalAppX.Categories;
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsUniversalAppX.CommittedContainedApps;
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsUniversalAppX.ContentVersions;
using ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsUniversalAppX.Relationships;
...
namespace ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsUniversalAppX
{
    ...
    public partial class GraphWindowsUniversalAppXRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildAssignmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsUniversalAppX.Assignments.AssignmentsRequestBuilder(PathParameters);
        ...
        public Command BuildCategoriesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsUniversalAppX.Categories.CategoriesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildCommittedContainedAppsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsUniversalAppX.CommittedContainedApps.CommittedContainedAppsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildContentVersionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsUniversalAppX.ContentVersions.ContentVersionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRelationshipsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsUniversalAppX.Relationships.RelationshipsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsUniversalAppX.GraphWindowsUniversalAppXRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsUniversalAppX.GraphWindowsUniversalAppXRequestBuilder.GraphWindowsUniversalAppXRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphWindowsUniversalAppX.GraphWindowsUniversalAppXRequestBuilder.GraphWindowsUniversalAppXRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class GraphWindowsUniversalAppXRequestBuilderGetQueryParameters 
        {
