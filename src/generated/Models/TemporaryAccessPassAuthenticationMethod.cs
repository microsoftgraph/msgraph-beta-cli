...
namespace ApiSdk.Models
{
    ...
    public class TemporaryAccessPassAuthenticationMethod : ApiSdk.Models.AuthenticationMethod, IParsable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.TemporaryAccessPassAuthenticationMethod"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.TemporaryAccessPassAuthenticationMethod"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.TemporaryAccessPassAuthenticationMethod CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.TemporaryAccessPassAuthenticationMethod();
        }
        /// <summary>
