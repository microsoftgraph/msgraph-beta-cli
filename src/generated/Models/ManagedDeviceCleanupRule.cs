...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class ManagedDeviceCleanupRule : ApiSdk.Models.Entity, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.ManagedDeviceCleanupRule"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.ManagedDeviceCleanupRule CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.ManagedDeviceCleanupRule();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "deviceCleanupRulePlatformType", n => { DeviceCleanupRulePlatformType = n.GetEnumValue<ApiSdk.Models.DeviceCleanupRulePlatformType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.DeviceCleanupRulePlatformType>("deviceCleanupRulePlatformType", DeviceCleanupRulePlatformType);
