    ...
    public partial class SharedCookiesRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCreateCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.BrowserSharedCookie>(global::ApiSdk.Models.BrowserSharedCookie.CreateFromDiscriminatorValue);
                if (model is null) {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Admin.Edge.InternetExplorerMode.SiteLists.Item.SharedCookies.SharedCookiesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Admin.Edge.InternetExplorerMode.SiteLists.Item.SharedCookies.SharedCookiesRequestBuilder.SharedCookiesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Admin.Edge.InternetExplorerMode.SiteLists.Item.SharedCookies.SharedCookiesRequestBuilder.SharedCookiesRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Models.BrowserSharedCookie body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Models.BrowserSharedCookie body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
