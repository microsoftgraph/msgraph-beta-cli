...
using ApiSdk.Models;
using ApiSdk.Users.Item.Devices.Item.TransitiveMemberOf.Item.GraphAdministrativeUnit;
using ApiSdk.Users.Item.Devices.Item.TransitiveMemberOf.Item.GraphGroup;
...
using System;
namespace ApiSdk.Users.Item.Devices.Item.TransitiveMemberOf.Item
{
    /// <summary>
    ...
    public partial class DirectoryObjectItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGraphAdministrativeUnitByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Devices.Item.TransitiveMemberOf.Item.GraphAdministrativeUnit.GraphAdministrativeUnitRequestBuilder(PathParameters);
        ...
        public Command BuildGraphGroupByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Devices.Item.TransitiveMemberOf.Item.GraphGroup.GraphGroupRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.Devices.Item.TransitiveMemberOf.Item.DirectoryObjectItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public DirectoryObjectItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/devices/{device%2Did}/transitiveMemberOf/{directoryObject%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.Devices.Item.TransitiveMemberOf.Item.DirectoryObjectItemRequestBuilder"/> and sets the default values.
        ...
        public DirectoryObjectItemRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/devices/{device%2Did}/transitiveMemberOf/{directoryObject%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Groups and administrative units that this device is a member of. This operation is transitive. Supports $expand.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.Devices.Item.TransitiveMemberOf.Item.DirectoryObjectItemRequestBuilder.DirectoryObjectItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.Devices.Item.TransitiveMemberOf.Item.DirectoryObjectItemRequestBuilder.DirectoryObjectItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
