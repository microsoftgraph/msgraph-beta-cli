    ...
    public class RestartRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Applications.Item.Synchronization.Jobs.Item.Restart.RestartPostRequestBody>(ApiSdk.Applications.Item.Synchronization.Jobs.Item.Restart.RestartPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Applications.Item.Synchronization.Jobs.Item.Restart.RestartRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Applications.Item.Synchronization.Jobs.Item.Restart.RestartPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Applications.Item.Synchronization.Jobs.Item.Restart.RestartPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
