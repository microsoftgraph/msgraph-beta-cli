...
namespace ApiSdk.Users.Item.Messages.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder : BaseCliRequestBuilder {
        ...
        public AttachmentsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/messages/{message%2Did}/attachments{?%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AttachmentsRequestBuilder and sets the default values.
        /// </summary>
