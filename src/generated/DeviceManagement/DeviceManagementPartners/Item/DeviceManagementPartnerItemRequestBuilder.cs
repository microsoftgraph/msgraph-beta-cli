    ...
    public class DeviceManagementPartnerItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.DeviceManagementPartner>(ApiSdk.Models.DeviceManagementPartner.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildTerminateNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.DeviceManagementPartners.Item.Terminate.TerminateRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceManagement.DeviceManagementPartners.Item.DeviceManagementPartnerItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceManagement.DeviceManagementPartners.Item.DeviceManagementPartnerItemRequestBuilder.DeviceManagementPartnerItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceManagement.DeviceManagementPartners.Item.DeviceManagementPartnerItemRequestBuilder.DeviceManagementPartnerItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.DeviceManagementPartner body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.DeviceManagementPartner body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
