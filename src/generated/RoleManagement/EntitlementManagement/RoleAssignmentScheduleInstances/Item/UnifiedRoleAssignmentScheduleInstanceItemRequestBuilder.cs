...
namespace ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentScheduleInstances.Item
{
    ...
    public partial class UnifiedRoleAssignmentScheduleInstanceItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildActivatedUsingNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentScheduleInstances.Item.ActivatedUsing.ActivatedUsingRequestBuilder(PathParameters);
        ...
        public Command BuildAppScopeNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentScheduleInstances.Item.AppScope.AppScopeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDirectoryScopeNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentScheduleInstances.Item.DirectoryScope.DirectoryScopeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPrincipalNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentScheduleInstances.Item.Principal.PrincipalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRoleDefinitionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentScheduleInstances.Item.RoleDefinition.RoleDefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentScheduleInstances.Item.UnifiedRoleAssignmentScheduleInstanceItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public UnifiedRoleAssignmentScheduleInstanceItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/roleManagement/entitlementManagement/roleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstance%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentScheduleInstances.Item.UnifiedRoleAssignmentScheduleInstanceItemRequestBuilder"/> and sets the default values.
        ...
        public UnifiedRoleAssignmentScheduleInstanceItemRequestBuilder(string rawUrl) : base("{+baseurl}/roleManagement/entitlementManagement/roleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstance%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property roleAssignmentScheduleInstances for roleManagement
