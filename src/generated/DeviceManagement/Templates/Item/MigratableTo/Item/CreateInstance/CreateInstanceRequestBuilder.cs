    ...
    public class CreateInstanceRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.DeviceManagement.Templates.Item.MigratableTo.Item.CreateInstance.CreateInstancePostRequestBody>(ApiSdk.DeviceManagement.Templates.Item.MigratableTo.Item.CreateInstance.CreateInstancePostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceManagement.Templates.Item.MigratableTo.Item.CreateInstance.CreateInstanceRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.DeviceManagement.Templates.Item.MigratableTo.Item.CreateInstance.CreateInstancePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.DeviceManagement.Templates.Item.MigratableTo.Item.CreateInstance.CreateInstancePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
