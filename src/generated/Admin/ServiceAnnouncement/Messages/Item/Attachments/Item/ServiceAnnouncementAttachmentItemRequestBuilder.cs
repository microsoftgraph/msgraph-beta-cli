...
namespace ApiSdk.Admin.ServiceAnnouncement.Messages.Item.Attachments.Item
{
    ...
    public class ServiceAnnouncementAttachmentItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildContentNavCommand()
        {
            ...
            var builder = new ApiSdk.Admin.ServiceAnnouncement.Messages.Item.Attachments.Item.Content.ContentRequestBuilder(PathParameters);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.ServiceAnnouncementAttachment>(ApiSdk.Models.ServiceAnnouncementAttachment.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Admin.ServiceAnnouncement.Messages.Item.Attachments.Item.ServiceAnnouncementAttachmentItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Admin.ServiceAnnouncement.Messages.Item.Attachments.Item.ServiceAnnouncementAttachmentItemRequestBuilder.ServiceAnnouncementAttachmentItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Admin.ServiceAnnouncement.Messages.Item.Attachments.Item.ServiceAnnouncementAttachmentItemRequestBuilder.ServiceAnnouncementAttachmentItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.ServiceAnnouncementAttachment body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.ServiceAnnouncementAttachment body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
