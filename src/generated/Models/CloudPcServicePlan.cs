...
namespace ApiSdk.Models
{
    ...
    public class CloudPcServicePlan : ApiSdk.Models.Entity, IParsable
...
#nullable restore
        ...
        public ApiSdk.Models.CloudPcServicePlanType? Type { get; set; }
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.CloudPcServicePlan"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.CloudPcServicePlan CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.CloudPcServicePlan();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "type", n => { Type = n.GetEnumValue<ApiSdk.Models.CloudPcServicePlanType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.CloudPcServicePlanType>("type", Type);
