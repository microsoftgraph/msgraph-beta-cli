...
using ApiSdk.Models;
using ApiSdk.Sites.Item.Onenote.Notebooks;
using ApiSdk.Sites.Item.Onenote.Operations;
using ApiSdk.Sites.Item.Onenote.Pages;
...
namespace ApiSdk.Sites.Item.Onenote
{
    ...
    public partial class OnenoteRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get onenote from sites";
            var siteIdOption = new Option<string>("--site-id", description: "The unique identifier of site") {
            };
            siteIdOption.IsRequired = true;
            command.AddOption(siteIdOption);
        ...
        public Command BuildNotebooksNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Onenote.Notebooks.NotebooksRequestBuilder(PathParameters);
        ...
        public Command BuildOperationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Onenote.Operations.OperationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPagesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Onenote.Pages.PagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildResourcesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Onenote.Resources.ResourcesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildSectionGroupsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Onenote.SectionGroups.SectionGroupsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildSectionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Onenote.Sections.SectionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Sites.Item.Onenote.OnenoteRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public OnenoteRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/onenote{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Sites.Item.Onenote.OnenoteRequestBuilder"/> and sets the default values.
        ...
        public OnenoteRequestBuilder(string rawUrl) : base("{+baseurl}/sites/{site%2Did}/onenote{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property onenote for sites
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Sites.Item.Onenote.OnenoteRequestBuilder.OnenoteRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Sites.Item.Onenote.OnenoteRequestBuilder.OnenoteRequestBuilderGetQueryParameters>> requestConfiguration = default)
