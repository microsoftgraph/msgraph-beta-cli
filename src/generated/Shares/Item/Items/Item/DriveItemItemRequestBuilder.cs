...
namespace ApiSdk.Shares.Item.Items.Item
{
    ...
    public class DriveItemItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildContentNavCommand()
        {
            ...
            var builder = new ApiSdk.Shares.Item.Items.Item.Content.ContentRequestBuilder(PathParameters);
        ...
        public Command BuildContentStreamNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the sharedDriveItem entity.";
            var builder = new ApiSdk.Shares.Item.Items.Item.ContentStream.ContentStreamRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Shares.Item.Items.Item.DriveItemItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Shares.Item.Items.Item.DriveItemItemRequestBuilder.DriveItemItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Shares.Item.Items.Item.DriveItemItemRequestBuilder.DriveItemItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
