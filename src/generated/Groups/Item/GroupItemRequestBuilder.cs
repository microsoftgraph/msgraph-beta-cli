...
namespace ApiSdk.Groups.Item
{
    ...
    public partial class GroupItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDeletePasswordSingleSignOnCredentialsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.DeletePasswordSingleSignOnCredentials.DeletePasswordSingleSignOnCredentialsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildEndpointsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Endpoints.EndpointsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildEvaluateDynamicMembershipByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.EvaluateDynamicMembership.EvaluateDynamicMembershipRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetPasswordSingleSignOnCredentialsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.GetPasswordSingleSignOnCredentials.GetPasswordSingleSignOnCredentialsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
