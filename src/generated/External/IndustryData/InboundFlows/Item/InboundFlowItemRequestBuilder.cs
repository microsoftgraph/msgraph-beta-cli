...
namespace ApiSdk.External.IndustryData.InboundFlows.Item
{
    ...
    public class InboundFlowItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDataConnectorNavCommand()
        {
            ...
            var builder = new ApiSdk.External.IndustryData.InboundFlows.Item.DataConnector.DataConnectorRequestBuilder(PathParameters);
        ...
        public Command BuildYearNavCommand()
        {
            ...
            var builder = new ApiSdk.External.IndustryData.InboundFlows.Item.Year.YearRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.External.IndustryData.InboundFlows.Item.InboundFlowItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.External.IndustryData.InboundFlows.Item.InboundFlowItemRequestBuilder.InboundFlowItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.External.IndustryData.InboundFlows.Item.InboundFlowItemRequestBuilder.InboundFlowItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.IndustryData.InboundFlow body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.IndustryData.InboundFlow body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
