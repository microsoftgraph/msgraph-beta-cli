...
using ApiSdk.Groups.Item.Calendar.CalendarView.Item.ExceptionOccurrences;
...
namespace ApiSdk.Groups.Item.Calendar.CalendarView.Item
{
    ...
    public class EventItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAcceptNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Calendar.CalendarView.Item.Accept.AcceptRequestBuilder(PathParameters);
        ...
        public Command BuildAttachmentsNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Calendar.CalendarView.Item.Attachments.AttachmentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCancelNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Calendar.CalendarView.Item.Cancel.CancelRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDeclineNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Calendar.CalendarView.Item.Decline.DeclineRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDismissReminderNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Calendar.CalendarView.Item.DismissReminder.DismissReminderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildExceptionOccurrencesNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Calendar.CalendarView.Item.ExceptionOccurrences.ExceptionOccurrencesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildExtensionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Calendar.CalendarView.Item.Extensions.ExtensionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildForwardNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Calendar.CalendarView.Item.Forward.ForwardRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildInstancesNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.InstancesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            nonExecCommands.Add(builder.BuildDeltaNavCommand());
        ...
        public Command BuildSnoozeReminderNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Calendar.CalendarView.Item.SnoozeReminder.SnoozeReminderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTentativelyAcceptNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Calendar.CalendarView.Item.TentativelyAccept.TentativelyAcceptRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.Calendar.CalendarView.Item.EventItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}?endDateTime={endDateTime}&startDateTime={startDateTime}{&%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.Calendar.CalendarView.Item.EventItemRequestBuilder"/> and sets the default values.
        ...
        public EventItemRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}?endDateTime={endDateTime}&startDateTime={startDateTime}{&%24select}", rawUrl)
        {
        }
        /// <summary>
        /// The calendar view for the calendar. Navigation property. Read-only.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.Calendar.CalendarView.Item.EventItemRequestBuilder.EventItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.Calendar.CalendarView.Item.EventItemRequestBuilder.EventItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
