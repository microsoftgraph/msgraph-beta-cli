...
using ApiSdk.Models;
using ApiSdk.Sites.Item.Lists.Item.Items.Item.Activities;
...
using ApiSdk.Sites.Item.Lists.Item.Items.Item.LastModifiedByUser;
using ApiSdk.Sites.Item.Lists.Item.Items.Item.Permissions;
...
namespace ApiSdk.Sites.Item.Lists.Item.Items.Item
{
    ...
    public partial class ListItemItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildActivitiesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.Items.Item.Activities.ActivitiesRequestBuilder(PathParameters);
        ...
        public Command BuildAnalyticsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.Items.Item.Analytics.AnalyticsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCreatedByUserNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.Items.Item.CreatedByUser.CreatedByUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildCreateLinkNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.Items.Item.CreateLink.CreateLinkRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Removes an item from a list.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/listitem-delete?view=graph-rest-beta";
        ...
        public Command BuildDocumentSetVersionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.Items.Item.DocumentSetVersions.DocumentSetVersionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildDriveItemNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.Items.Item.DriveItem.DriveItemRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildFieldsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.Items.Item.Fields.FieldsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRbCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.Items.Item.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Returns the metadata for an item in a list.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/listitem-get?view=graph-rest-beta";
            var siteIdOption = new Option<string>("--site-id", description: "The unique identifier of site") {
            };
            siteIdOption.IsRequired = true;
            command.AddOption(siteIdOption);
        ...
        public Command BuildLastModifiedByUserNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.Items.Item.LastModifiedByUser.LastModifiedByUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            nonExecCommands.Add(builder.BuildMailboxSettingsNavCommand());
        ...
        public Command BuildPermissionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.Items.Item.Permissions.PermissionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildVersionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.Items.Item.Versions.VersionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Sites.Item.Lists.Item.Items.Item.ListItemItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Sites.Item.Lists.Item.Items.Item.ListItemItemRequestBuilder.ListItemItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Sites.Item.Lists.Item.Items.Item.ListItemItemRequestBuilder.ListItemItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
