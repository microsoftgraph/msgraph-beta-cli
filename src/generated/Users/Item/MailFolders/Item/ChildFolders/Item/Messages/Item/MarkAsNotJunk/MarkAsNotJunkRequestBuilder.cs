...
namespace ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.MarkAsNotJunk
{
    ...
    public partial class MarkAsNotJunkRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildPostCommand()
        {
            ...
            command.Description = "Mark a message as not junk. This API removes the sender from the list of blocked senders and moves the message to the Inbox folder, when moveToInbox is true.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/message-markasnotjunk?view=graph-rest-beta";
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.MarkAsNotJunk.MarkAsNotJunkPostRequestBody>(global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.MarkAsNotJunk.MarkAsNotJunkPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.MarkAsNotJunk.MarkAsNotJunkRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public MarkAsNotJunkRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/markAsNotJunk", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.MarkAsNotJunk.MarkAsNotJunkRequestBuilder"/> and sets the default values.
        ...
        public MarkAsNotJunkRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/markAsNotJunk", rawUrl)
        {
        }
        /// <summary>
        /// Mark a message as not junk. This API removes the sender from the list of blocked senders and moves the message to the Inbox folder, when moveToInbox is true.
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.MarkAsNotJunk.MarkAsNotJunkPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.MarkAsNotJunk.MarkAsNotJunkPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
