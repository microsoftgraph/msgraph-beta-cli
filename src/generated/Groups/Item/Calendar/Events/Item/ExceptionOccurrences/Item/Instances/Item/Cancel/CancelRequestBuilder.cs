...
using System;
namespace ApiSdk.Groups.Item.Calendar.Events.Item.ExceptionOccurrences.Item.Instances.Item.Cancel
{
    /// <summary>
    ...
    public partial class CancelRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Groups.Item.Calendar.Events.Item.ExceptionOccurrences.Item.Instances.Item.Cancel.CancelPostRequestBody>(global::ApiSdk.Groups.Item.Calendar.Events.Item.ExceptionOccurrences.Item.Instances.Item.Cancel.CancelPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Calendar.Events.Item.ExceptionOccurrences.Item.Instances.Item.Cancel.CancelRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public CancelRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/cancel", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Calendar.Events.Item.ExceptionOccurrences.Item.Instances.Item.Cancel.CancelRequestBuilder"/> and sets the default values.
        ...
        public CancelRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/exceptionOccurrences/{event%2Did1}/instances/{event%2Did2}/cancel", rawUrl)
        {
        }
        /// <summary>
        /// This action allows the organizer of a meeting to send a cancellation message and cancel the event.  The action moves the event to the Deleted Items folder. The organizer can also cancel an occurrence of a recurring meeting by providing the occurrence event ID. An attendee calling this action gets an error (HTTP 400 Bad Request), with the followingerror message: &apos;Your request can&apos;t be completed. You need to be an organizer to cancel a meeting.&apos; This action differs from Delete in that Cancel is available to only the organizer, and letsthe organizer send a custom message to the attendees about the cancellation.
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Groups.Item.Calendar.Events.Item.ExceptionOccurrences.Item.Instances.Item.Cancel.CancelPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Groups.Item.Calendar.Events.Item.ExceptionOccurrences.Item.Instances.Item.Cancel.CancelPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
