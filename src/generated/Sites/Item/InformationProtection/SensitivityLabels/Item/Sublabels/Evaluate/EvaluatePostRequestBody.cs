...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Sites.Item.InformationProtection.SensitivityLabels.Item.Sublabels.Evaluate.EvaluatePostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Sites.Item.InformationProtection.SensitivityLabels.Item.Sublabels.Evaluate.EvaluatePostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Sites.Item.InformationProtection.SensitivityLabels.Item.Sublabels.Evaluate.EvaluatePostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Sites.Item.InformationProtection.SensitivityLabels.Item.Sublabels.Evaluate.EvaluatePostRequestBody();
        }
        /// <summary>
