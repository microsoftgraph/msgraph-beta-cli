...
namespace ApiSdk.Models
{
    ...
    public partial class AndroidForWorkSettings : global::ApiSdk.Models.Entity, IParsable
    {
        /// <summary>Bind status of the tenant with the Google EMM API</summary>
        public global::ApiSdk.Models.AndroidForWorkBindStatus? BindStatus { get; set; }
        ...
        public global::ApiSdk.Models.AndroidForWorkEnrollmentTarget? EnrollmentTarget { get; set; }
        ...
        public global::ApiSdk.Models.AndroidForWorkSyncStatus? LastAppSyncStatus { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.AndroidForWorkSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.AndroidForWorkSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.AndroidForWorkSettings();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "bindStatus", n => { BindStatus = n.GetEnumValue<global::ApiSdk.Models.AndroidForWorkBindStatus>(); } },
                { "deviceOwnerManagementEnabled", n => { DeviceOwnerManagementEnabled = n.GetBoolValue(); } },
                { "enrollmentTarget", n => { EnrollmentTarget = n.GetEnumValue<global::ApiSdk.Models.AndroidForWorkEnrollmentTarget>(); } },
                { "lastAppSyncDateTime", n => { LastAppSyncDateTime = n.GetDateTimeOffsetValue(); } },
                { "lastAppSyncStatus", n => { LastAppSyncStatus = n.GetEnumValue<global::ApiSdk.Models.AndroidForWorkSyncStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.AndroidForWorkBindStatus>("bindStatus", BindStatus);
            writer.WriteBoolValue("deviceOwnerManagementEnabled", DeviceOwnerManagementEnabled);
            writer.WriteEnumValue<global::ApiSdk.Models.AndroidForWorkEnrollmentTarget>("enrollmentTarget", EnrollmentTarget);
            writer.WriteDateTimeOffsetValue("lastAppSyncDateTime", LastAppSyncDateTime);
            writer.WriteEnumValue<global::ApiSdk.Models.AndroidForWorkSyncStatus>("lastAppSyncStatus", LastAppSyncStatus);
