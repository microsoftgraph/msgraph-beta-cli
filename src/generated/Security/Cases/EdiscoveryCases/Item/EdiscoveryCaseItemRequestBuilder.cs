...
using ApiSdk.Security.Cases.EdiscoveryCases.Item.CaseMembers;
...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item
{
    ...
    public partial class EdiscoveryCaseItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        /// Provides operations to manage the caseMembers property of the microsoft.graph.security.ediscoveryCase entity.
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildCaseMembersNavCommand()
        {
            var command = new Command("case-members");
            command.Description = "Provides operations to manage the caseMembers property of the microsoft.graph.security.ediscoveryCase entity.";
            var builder = new global::ApiSdk.Security.Cases.EdiscoveryCases.Item.CaseMembers.CaseMembersRequestBuilder(PathParameters);
        ...
        public Command BuildCustodiansNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.CustodiansRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete an ediscoveryCase object.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/security-casesroot-delete-ediscoverycases?view=graph-rest-beta";
        ...
        public Command BuildLegalHoldsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Cases.EdiscoveryCases.Item.LegalHolds.LegalHoldsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildMicrosoftGraphSecurityCloseNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Cases.EdiscoveryCases.Item.MicrosoftGraphSecurityClose.MicrosoftGraphSecurityCloseRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildMicrosoftGraphSecurityReopenNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Cases.EdiscoveryCases.Item.MicrosoftGraphSecurityReopen.MicrosoftGraphSecurityReopenRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildNoncustodialDataSourcesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Cases.EdiscoveryCases.Item.NoncustodialDataSources.NoncustodialDataSourcesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildOperationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Cases.EdiscoveryCases.Item.Operations.OperationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the properties of an ediscoveryCase object.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/security-ediscoverycase-update?view=graph-rest-beta";
            var ediscoveryCaseIdOption = new Option<string>("--ediscovery-case-id", description: "The unique identifier of ediscoveryCase") {
            };
            ediscoveryCaseIdOption.IsRequired = true;
            command.AddOption(ediscoveryCaseIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Security.EdiscoveryCase>(global::ApiSdk.Models.Security.EdiscoveryCase.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildReviewSetsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Cases.EdiscoveryCases.Item.ReviewSets.ReviewSetsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildSearchesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Cases.EdiscoveryCases.Item.Searches.SearchesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildSettingsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Cases.EdiscoveryCases.Item.Settings.SettingsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildTagsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Cases.EdiscoveryCases.Item.Tags.TagsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Security.Cases.EdiscoveryCases.Item.EdiscoveryCaseItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.Cases.EdiscoveryCases.Item.EdiscoveryCaseItemRequestBuilder.EdiscoveryCaseItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.Cases.EdiscoveryCases.Item.EdiscoveryCaseItemRequestBuilder.EdiscoveryCaseItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Security.EdiscoveryCase body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Security.EdiscoveryCase body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
