...
namespace ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item
{
    ...
    public class WorkflowItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCreatedByNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.CreatedBy.CreatedByRequestBuilder(PathParameters);
        ...
        public Command BuildExecutionScopeNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.ExecutionScope.ExecutionScopeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildLastModifiedByNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.LastModifiedBy.LastModifiedByRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            nonExecCommands.Add(builder.BuildMailboxSettingsNavCommand());
        ...
        public Command BuildMicrosoftGraphIdentityGovernanceActivateNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.MicrosoftGraphIdentityGovernanceActivate.MicrosoftGraphIdentityGovernanceActivateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildMicrosoftGraphIdentityGovernanceCreateNewVersionNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.MicrosoftGraphIdentityGovernanceCreateNewVersion.MicrosoftGraphIdentityGovernanceCreateNewVersionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMicrosoftGraphIdentityGovernanceRestoreNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.MicrosoftGraphIdentityGovernanceRestore.MicrosoftGraphIdentityGovernanceRestoreRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.IdentityGovernance.Workflow>(ApiSdk.Models.IdentityGovernance.Workflow.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildRunsNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.Runs.RunsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildTaskReportsNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.TaskReports.TaskReportsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildTasksNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.Tasks.TasksRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildUserProcessingResultsNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.UserProcessingResults.UserProcessingResultsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildVersionsNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.Versions.VersionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.WorkflowItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.WorkflowItemRequestBuilder.WorkflowItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.WorkflowItemRequestBuilder.WorkflowItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.IdentityGovernance.Workflow body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.IdentityGovernance.Workflow body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
