...
namespace ApiSdk.Users.Item.AppRoleAssignments {
    ...
    public class AppRoleAssignmentsRequestBuilder : BaseCliRequestBuilder {
        ...
        public AppRoleAssignmentsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/appRoleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AppRoleAssignmentsRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public AppRoleAssignmentsRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/appRoleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Represents the app roles a user has been granted for an application. Supports $expand.
        /// </summary>
