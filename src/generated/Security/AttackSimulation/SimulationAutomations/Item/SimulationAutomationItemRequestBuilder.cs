...
namespace ApiSdk.Security.AttackSimulation.SimulationAutomations.Item
{
    ...
    public class SimulationAutomationItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildRunsNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.AttackSimulation.SimulationAutomations.Item.Runs.RunsRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Security.AttackSimulation.SimulationAutomations.Item.SimulationAutomationItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.AttackSimulation.SimulationAutomations.Item.SimulationAutomationItemRequestBuilder.SimulationAutomationItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.AttackSimulation.SimulationAutomations.Item.SimulationAutomationItemRequestBuilder.SimulationAutomationItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.SimulationAutomation body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.SimulationAutomation body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
