...
namespace ApiSdk.Models
{
    ...
    public partial class FederatedIdentityCredential : global::ApiSdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.FederatedIdentityExpression? ClaimsMatchingExpression { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.FederatedIdentityExpression ClaimsMatchingExpression { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.FederatedIdentityCredential"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.FederatedIdentityCredential CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.FederatedIdentityCredential();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "claimsMatchingExpression", n => { ClaimsMatchingExpression = n.GetObjectValue<global::ApiSdk.Models.FederatedIdentityExpression>(global::ApiSdk.Models.FederatedIdentityExpression.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::ApiSdk.Models.FederatedIdentityExpression>("claimsMatchingExpression", ClaimsMatchingExpression);
