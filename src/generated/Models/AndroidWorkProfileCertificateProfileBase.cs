...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class AndroidWorkProfileCertificateProfileBase : ApiSdk.Models.DeviceConfiguration, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.AndroidWorkProfileTrustedRootCertificate? RootCertificate { get; set; }
#nullable restore
#else
        public ApiSdk.Models.AndroidWorkProfileTrustedRootCertificate RootCertificate { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.AndroidWorkProfileCertificateProfileBase"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.AndroidWorkProfileCertificateProfileBase"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.AndroidWorkProfileCertificateProfileBase CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            return mappingValue switch
            {
                ...
                _ => new ApiSdk.Models.AndroidWorkProfileCertificateProfileBase(),
            };
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "rootCertificate", n => { RootCertificate = n.GetObjectValue<ApiSdk.Models.AndroidWorkProfileTrustedRootCertificate>(ApiSdk.Models.AndroidWorkProfileTrustedRootCertificate.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.AndroidWorkProfileTrustedRootCertificate>("rootCertificate", RootCertificate);
