...
namespace ApiSdk.Models.Networkaccess
{
    ...
    public class Headers : IAdditionalDataHolder, IParsable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.Networkaccess.Headers"/> and sets the default values.
        /// </summary>
        public Headers()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.Networkaccess.Headers"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.Networkaccess.Headers CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.Networkaccess.Headers();
        }
        /// <summary>
