...
using ApiSdk.Models;
using ApiSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Count;
using ApiSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item;
...
using System;
namespace ApiSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.Pages {
    /// <summary>
    ...
    public class PagesRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public PagesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/pages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="PagesRequestBuilder"/> and sets the default values.
        ...
        public PagesRequestBuilder(string rawUrl) : base("{+baseurl}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/pages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// The collection of pages in the section.  Read-only. Nullable.
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(OnenotePage body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/pages", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
