...
using ApiSdk.Communications.Calls.Item.Record;
...
using ApiSdk.Communications.Calls.Item.StartRecording;
using ApiSdk.Communications.Calls.Item.StartTranscription;
using ApiSdk.Communications.Calls.Item.StopRecording;
using ApiSdk.Communications.Calls.Item.StopTranscription;
...
namespace ApiSdk.Communications.Calls.Item
{
    ...
    public partial class CallItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildRecordNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Communications.Calls.Item.Record.RecordRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildStartRecordingNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Communications.Calls.Item.StartRecording.StartRecordingRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildStartTranscriptionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Communications.Calls.Item.StartTranscription.StartTranscriptionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildStopRecordingNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Communications.Calls.Item.StopRecording.StopRecordingRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildStopTranscriptionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Communications.Calls.Item.StopTranscription.StopTranscriptionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
