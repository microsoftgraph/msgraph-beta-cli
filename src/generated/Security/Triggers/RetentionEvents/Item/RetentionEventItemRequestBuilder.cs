...
namespace ApiSdk.Security.Triggers.RetentionEvents.Item
{
    ...
    public class RetentionEventItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildRetentionEventTypeNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.Triggers.RetentionEvents.Item.RetentionEventType.RetentionEventTypeRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Security.Triggers.RetentionEvents.Item.RetentionEventItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.Triggers.RetentionEvents.Item.RetentionEventItemRequestBuilder.RetentionEventItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.Triggers.RetentionEvents.Item.RetentionEventItemRequestBuilder.RetentionEventItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Security.RetentionEvent body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Security.RetentionEvent body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
