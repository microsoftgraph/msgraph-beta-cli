...
namespace ApiSdk.Users.Item.Planner.Plans.Item.Tasks.Item
{
    ...
    public partial class PlannerTaskItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAssignedToTaskBoardFormatNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Planner.Plans.Item.Tasks.Item.AssignedToTaskBoardFormat.AssignedToTaskBoardFormatRequestBuilder(PathParameters);
        ...
        public Command BuildBucketTaskBoardFormatNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Planner.Plans.Item.Tasks.Item.BucketTaskBoardFormat.BucketTaskBoardFormatRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildDetailsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Planner.Plans.Item.Tasks.Item.Details.DetailsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildProgressTaskBoardFormatNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Planner.Plans.Item.Tasks.Item.ProgressTaskBoardFormat.ProgressTaskBoardFormatRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.Planner.Plans.Item.Tasks.Item.PlannerTaskItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public PlannerTaskItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.Planner.Plans.Item.Tasks.Item.PlannerTaskItemRequestBuilder"/> and sets the default values.
        ...
        public PlannerTaskItemRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property tasks for users
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.Planner.Plans.Item.Tasks.Item.PlannerTaskItemRequestBuilder.PlannerTaskItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.Planner.Plans.Item.Tasks.Item.PlannerTaskItemRequestBuilder.PlannerTaskItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
