...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class MacOSAzureAdSingleSignOnExtension : ApiSdk.Models.MacOSSingleSignOnExtension, IParsable
    {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.MacOSAzureAdSingleSignOnExtension"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.MacOSAzureAdSingleSignOnExtension"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.MacOSAzureAdSingleSignOnExtension CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.MacOSAzureAdSingleSignOnExtension();
        }
        /// <summary>
