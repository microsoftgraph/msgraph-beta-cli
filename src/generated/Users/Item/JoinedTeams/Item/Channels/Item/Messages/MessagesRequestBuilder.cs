...
using ApiSdk.Models;
using ApiSdk.Users.Item.JoinedTeams.Item.Channels.Item.Messages.Count;
using ApiSdk.Users.Item.JoinedTeams.Item.Channels.Item.Messages.Delta;
using ApiSdk.Users.Item.JoinedTeams.Item.Channels.Item.Messages.Item;
...
namespace ApiSdk.Users.Item.JoinedTeams.Item.Channels.Item.Messages {
    ...
    public class MessagesRequestBuilder : BaseCliRequestBuilder {
        ...
        public MessagesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}/messages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MessagesRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public MessagesRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}/messages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Retrieve the list of messages (without the replies) in a channel of a team.  To get the replies for a message, call the list message replies or the get message reply API.  This method supports federation. To list channel messages in application context, the request must be made from the tenant that the channel owner belongs to (represented by the tenantId property on the channel).
        /// </summary>
