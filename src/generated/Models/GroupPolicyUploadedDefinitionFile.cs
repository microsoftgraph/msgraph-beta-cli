...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class GroupPolicyUploadedDefinitionFile : ApiSdk.Models.GroupPolicyDefinitionFile, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.GroupPolicyOperation>? GroupPolicyOperations { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.GroupPolicyOperation> GroupPolicyOperations { get; set; }
#endif
...
#nullable restore
        ...
        public ApiSdk.Models.GroupPolicyUploadedDefinitionFileStatus? Status { get; set; }
        /// <summary>The uploaded time of the uploaded ADMX file.</summary>
        public DateTimeOffset? UploadDateTime { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.GroupPolicyUploadedDefinitionFile"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.GroupPolicyUploadedDefinitionFile"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.GroupPolicyUploadedDefinitionFile CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.GroupPolicyUploadedDefinitionFile();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "groupPolicyOperations", n => { GroupPolicyOperations = n.GetCollectionOfObjectValues<ApiSdk.Models.GroupPolicyOperation>(ApiSdk.Models.GroupPolicyOperation.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                { "status", n => { Status = n.GetEnumValue<ApiSdk.Models.GroupPolicyUploadedDefinitionFileStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.GroupPolicyOperation>("groupPolicyOperations", GroupPolicyOperations);
            ...
            writer.WriteEnumValue<ApiSdk.Models.GroupPolicyUploadedDefinitionFileStatus>("status", Status);
