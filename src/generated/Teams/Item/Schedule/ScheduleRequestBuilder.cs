...
using ApiSdk.Models;
using ApiSdk.Teams.Item.Schedule.DayNotes;
...
using ApiSdk.Teams.Item.Schedule.ShiftsRoleDefinitions;
using ApiSdk.Teams.Item.Schedule.SwapShiftsChangeRequests;
using ApiSdk.Teams.Item.Schedule.TimeCards;
...
namespace ApiSdk.Teams.Item.Schedule
{
    ...
    public partial class ScheduleRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDayNotesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Schedule.DayNotes.DayNotesRequestBuilder(PathParameters);
        ...
        public Command BuildOfferShiftRequestsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Schedule.OfferShiftRequests.OfferShiftRequestsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildOpenShiftChangeRequestsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Schedule.OpenShiftChangeRequests.OpenShiftChangeRequestsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildOpenShiftsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Schedule.OpenShifts.OpenShiftsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPutCommand()
        {
            ...
            command.Description = "Create or replace a schedule object. The schedule creation process conforms to the One API guideline for resource based long running operations (RELO).When clients use the PUT method, if the schedule is provisioned, the operation replaces the schedule; otherwise, the operation starts the schedule provisioning process in the background. During schedule provisioning, clients can use the GET method to get the schedule and look at the provisionStatus property for the current state of the provisioning. If the provisioning failed, clients can get additional information from the provisionStatusCode property. Clients can also inspect the configuration of the schedule.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/team-put-schedule?view=graph-rest-beta";
            var teamIdOption = new Option<string>("--team-id", description: "The unique identifier of team") {
            };
            teamIdOption.IsRequired = true;
            command.AddOption(teamIdOption);
        ...
        public Command BuildSchedulingGroupsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Schedule.SchedulingGroups.SchedulingGroupsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildShareNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Schedule.Share.ShareRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildShiftsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Schedule.Shifts.ShiftsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildShiftsRoleDefinitionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Schedule.ShiftsRoleDefinitions.ShiftsRoleDefinitionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildSwapShiftsChangeRequestsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Schedule.SwapShiftsChangeRequests.SwapShiftsChangeRequestsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildTimeCardsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Schedule.TimeCards.TimeCardsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildTimeOffReasonsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Schedule.TimeOffReasons.TimeOffReasonsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildTimeOffRequestsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Schedule.TimeOffRequests.TimeOffRequestsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildTimesOffNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Teams.Item.Schedule.TimesOff.TimesOffRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Teams.Item.Schedule.ScheduleRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Teams.Item.Schedule.ScheduleRequestBuilder.ScheduleRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Teams.Item.Schedule.ScheduleRequestBuilder.ScheduleRequestBuilderGetQueryParameters>> requestConfiguration = default)
