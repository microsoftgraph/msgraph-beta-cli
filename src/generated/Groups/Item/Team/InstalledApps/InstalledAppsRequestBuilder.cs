...
namespace ApiSdk.Groups.Item.Team.InstalledApps {
    ...
    public class InstalledAppsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public InstalledAppsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/team/installedApps{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="InstalledAppsRequestBuilder"/> and sets the default values.
        ...
        public InstalledAppsRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/team/installedApps{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Retrieve the list of apps installed in the specified team.
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(TeamsAppInstallation body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/groups/{group%2Did}/team/installedApps", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
