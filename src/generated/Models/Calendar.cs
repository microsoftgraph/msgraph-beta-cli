...
namespace ApiSdk.Models
{
    ...
    public class Calendar : ApiSdk.Models.Entity, IParsable
...
#nullable enable
        public List<ApiSdk.Models.OnlineMeetingProviderType?>? AllowedOnlineMeetingProviders { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.OnlineMeetingProviderType?> AllowedOnlineMeetingProviders { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.CalendarPermission>? CalendarPermissions { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.CalendarPermission> CalendarPermissions { get; set; }
#endif
...
#nullable restore
        ...
        public ApiSdk.Models.CalendarColor? Color { get; set; }
        ...
        public ApiSdk.Models.OnlineMeetingProviderType? DefaultOnlineMeetingProvider { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.EmailAddress? Owner { get; set; }
#nullable restore
#else
        public ApiSdk.Models.EmailAddress Owner { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.Calendar"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.Calendar CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.Calendar();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "allowedOnlineMeetingProviders", n => { AllowedOnlineMeetingProviders = n.GetCollectionOfEnumValues<ApiSdk.Models.OnlineMeetingProviderType>()?.ToList(); } },
                { "calendarGroupId", n => { CalendarGroupId = n.GetStringValue(); } },
                { "calendarPermissions", n => { CalendarPermissions = n.GetCollectionOfObjectValues<ApiSdk.Models.CalendarPermission>(ApiSdk.Models.CalendarPermission.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                { "color", n => { Color = n.GetEnumValue<ApiSdk.Models.CalendarColor>(); } },
                { "defaultOnlineMeetingProvider", n => { DefaultOnlineMeetingProvider = n.GetEnumValue<ApiSdk.Models.OnlineMeetingProviderType>(); } },
                ...
                { "owner", n => { Owner = n.GetObjectValue<ApiSdk.Models.EmailAddress>(ApiSdk.Models.EmailAddress.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfEnumValues<ApiSdk.Models.OnlineMeetingProviderType>("allowedOnlineMeetingProviders", AllowedOnlineMeetingProviders);
            writer.WriteStringValue("calendarGroupId", CalendarGroupId);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.CalendarPermission>("calendarPermissions", CalendarPermissions);
            ...
            writer.WriteEnumValue<ApiSdk.Models.CalendarColor>("color", Color);
            writer.WriteEnumValue<ApiSdk.Models.OnlineMeetingProviderType>("defaultOnlineMeetingProvider", DefaultOnlineMeetingProvider);
            ...
            writer.WriteObjectValue<ApiSdk.Models.EmailAddress>("owner", Owner);
