...
namespace ApiSdk.Organization.Item.Branding
{
    ...
    public partial class BrandingRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildBackgroundImageNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Organization.Item.Branding.BackgroundImage.BackgroundImageRequestBuilder(PathParameters);
        ...
        public Command BuildBannerLogoNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the organization entity.";
            var builder = new global::ApiSdk.Organization.Item.Branding.BannerLogo.BannerLogoRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        public Command BuildCustomCSSNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the organization entity.";
            var builder = new global::ApiSdk.Organization.Item.Branding.CustomCSS.CustomCSSRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        public Command BuildFaviconNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the organization entity.";
            var builder = new global::ApiSdk.Organization.Item.Branding.Favicon.FaviconRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Retrieve the default organizational branding object, if the Accept-Language header is set to 0 or default. If no default organizational branding object exists, this method returns a 404 Not Found error. If the Accept-Language header is set to an existing locale identified by the value of its id, this method retrieves the branding for the specified locale. This method retrieves only non-Stream properties, for example, usernameHintText and signInPageText. To retrieve Stream types of the default branding, for example, bannerLogo and backgroundImage, use the GET organizationalBrandingLocalization method.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/organizationalbranding-get?view=graph-rest-beta";
            var organizationIdOption = new Option<string>("--organization-id", description: "The unique identifier of organization") {
            };
            organizationIdOption.IsRequired = true;
            command.AddOption(organizationIdOption);
        ...
        public Command BuildHeaderLogoNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the organization entity.";
            var builder = new global::ApiSdk.Organization.Item.Branding.HeaderLogo.HeaderLogoRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        public Command BuildLocalizationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Organization.Item.Branding.Localizations.LocalizationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.OrganizationalBranding>(global::ApiSdk.Models.OrganizationalBranding.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildSquareLogoDarkNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the organization entity.";
            var builder = new global::ApiSdk.Organization.Item.Branding.SquareLogoDark.SquareLogoDarkRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        public Command BuildSquareLogoNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the organization entity.";
            var builder = new global::ApiSdk.Organization.Item.Branding.SquareLogo.SquareLogoRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Organization.Item.Branding.BrandingRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Organization.Item.Branding.BrandingRequestBuilder.BrandingRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Organization.Item.Branding.BrandingRequestBuilder.BrandingRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.OrganizationalBranding body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.OrganizationalBranding body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
