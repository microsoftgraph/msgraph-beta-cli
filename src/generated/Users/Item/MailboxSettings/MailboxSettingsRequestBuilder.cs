...
namespace ApiSdk.Users.Item.MailboxSettings {
    ...
    public class MailboxSettingsRequestBuilder : BaseCliRequestBuilder {
        ...
        public MailboxSettingsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/mailboxSettings{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MailboxSettingsRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public MailboxSettingsRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/mailboxSettings{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Settings for the primary mailbox of the signed-in user. You can get or update settings for sending automatic replies to incoming messages, locale, and time zone. Returned only on $select.
        /// </summary>
