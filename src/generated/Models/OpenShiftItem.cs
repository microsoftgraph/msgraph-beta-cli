...
namespace ApiSdk.Models {
    public class OpenShiftItem : ShiftItem, IParsable {
        ...
        public int? OpenShiftItemOpenSlotCount { get; set; }
        /// <summary>Count of the number of slots for the given open shift.</summary>
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"openSlotCount", n => { OpenShiftItemOpenSlotCount = n.GetIntValue(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteIntValue("openSlotCount", OpenShiftItemOpenSlotCount);
