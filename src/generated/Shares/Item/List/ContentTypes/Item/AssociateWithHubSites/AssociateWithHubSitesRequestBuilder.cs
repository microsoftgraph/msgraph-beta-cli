    ...
    public class AssociateWithHubSitesRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Shares.Item.List.ContentTypes.Item.AssociateWithHubSites.AssociateWithHubSitesPostRequestBody>(ApiSdk.Shares.Item.List.ContentTypes.Item.AssociateWithHubSites.AssociateWithHubSitesPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Shares.Item.List.ContentTypes.Item.AssociateWithHubSites.AssociateWithHubSitesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Shares.Item.List.ContentTypes.Item.AssociateWithHubSites.AssociateWithHubSitesPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Shares.Item.List.ContentTypes.Item.AssociateWithHubSites.AssociateWithHubSitesPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
