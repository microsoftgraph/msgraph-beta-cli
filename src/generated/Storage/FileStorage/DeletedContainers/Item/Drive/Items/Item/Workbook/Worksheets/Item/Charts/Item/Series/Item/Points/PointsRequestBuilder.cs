...
namespace ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Workbook.Worksheets.Item.Charts.Item.Series.Item.Points
{
    ...
    public class PointsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new WorkbookChartPointItemRequestBuilder(PathParameters);
        ...
        public Command BuildCreateCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<WorkbookChartPoint>(WorkbookChartPoint.CreateFromDiscriminatorValue);
                if (model is null) {
