...
namespace ApiSdk.Applications.Item
{
    ...
    public partial class ApplicationItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildAddKeyNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.AddKey.AddKeyRequestBuilder(PathParameters);
        ...
        public Command BuildAddPasswordNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.AddPassword.AddPasswordRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildAppManagementPoliciesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.AppManagementPolicies.AppManagementPoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCheckMemberGroupsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.CheckMemberGroups.CheckMemberGroupsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildCheckMemberObjectsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.CheckMemberObjects.CheckMemberObjectsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildConnectorGroupNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.ConnectorGroup.ConnectorGroupRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildCreatedOnBehalfOfNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.CreatedOnBehalfOf.CreatedOnBehalfOfRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildExtensionPropertiesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.ExtensionProperties.ExtensionPropertiesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildFederatedIdentityCredentialsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.FederatedIdentityCredentials.FederatedIdentityCredentialsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildFederatedIdentityCredentialsWithNameRbCommand()
        {
            ...
            command.Description = "Provides operations to manage the federatedIdentityCredentials property of the microsoft.graph.application entity.";
            var builder = new global::ApiSdk.Applications.Item.FederatedIdentityCredentialsWithName.FederatedIdentityCredentialsWithNameRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGetMemberGroupsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.GetMemberGroups.GetMemberGroupsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetMemberObjectsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.GetMemberObjects.GetMemberObjectsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildHomeRealmDiscoveryPoliciesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.HomeRealmDiscoveryPolicies.HomeRealmDiscoveryPoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildLogoNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.Logo.LogoRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildOwnersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.Owners.OwnersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Application>(global::ApiSdk.Models.Application.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildRemoveKeyNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.RemoveKey.RemoveKeyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRemovePasswordNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.RemovePassword.RemovePasswordRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRestoreNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.Restore.RestoreRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSetVerifiedPublisherNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.SetVerifiedPublisher.SetVerifiedPublisherRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSynchronizationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.Synchronization.SynchronizationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildTokenIssuancePoliciesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.TokenIssuancePolicies.TokenIssuancePoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildTokenLifetimePoliciesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.TokenLifetimePolicies.TokenLifetimePoliciesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildUnsetVerifiedPublisherNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Applications.Item.UnsetVerifiedPublisher.UnsetVerifiedPublisherRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Applications.Item.ApplicationItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Applications.Item.ApplicationItemRequestBuilder.ApplicationItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Applications.Item.ApplicationItemRequestBuilder.ApplicationItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Application body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Application body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
