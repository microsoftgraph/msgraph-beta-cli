...
using ApiSdk.Models;
using ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.AllMembers;
...
using ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.Planner;
...
namespace ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item
{
    ...
    public partial class ChannelItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAllMembersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.AllMembers.AllMembersRequestBuilder(PathParameters);
        ...
        public Command BuildArchiveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.Archive.ArchiveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCompleteMigrationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.CompleteMigration.CompleteMigrationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property channels for teamTemplateDefinition";
        ...
        public Command BuildDoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameNavCommand()
        {
            ...
            var builder = new global::ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.DoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalName.DoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildFilesFolderNavCommand()
        {
            ...
            var builder = new global::ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.FilesFolder.FilesFolderRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildMembersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.Members.MembersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAddNavCommand());
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildMessagesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.Messages.MessagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property channels in teamTemplateDefinition";
            var teamTemplateDefinitionIdOption = new Option<string>("--team-template-definition-id", description: "The unique identifier of teamTemplateDefinition") {
            };
            teamTemplateDefinitionIdOption.IsRequired = true;
            command.AddOption(teamTemplateDefinitionIdOption);
        ...
        public Command BuildPlannerNavCommand()
        {
            ...
            var builder = new global::ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.Planner.PlannerRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildProvisionEmailNavCommand()
        {
            ...
            var builder = new global::ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.ProvisionEmail.ProvisionEmailRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRemoveEmailNavCommand()
        {
            ...
            var builder = new global::ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.RemoveEmail.RemoveEmailRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSharedWithTeamsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.SharedWithTeams.SharedWithTeamsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildTabsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.Tabs.TabsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildUnarchiveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.Unarchive.UnarchiveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.ChannelItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.ChannelItemRequestBuilder.ChannelItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.TeamTemplateDefinition.Item.TeamDefinition.Channels.Item.ChannelItemRequestBuilder.ChannelItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
