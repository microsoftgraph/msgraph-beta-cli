...
namespace ApiSdk.EmployeeExperience
{
    ...
    public class EmployeeExperienceRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCommunitiesNavCommand()
        {
            ...
            var builder = new ApiSdk.EmployeeExperience.Communities.CommunitiesRequestBuilder(PathParameters);
        ...
        public Command BuildEngagementAsyncOperationsNavCommand()
        {
            ...
            var builder = new ApiSdk.EmployeeExperience.EngagementAsyncOperations.EngagementAsyncOperationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildGoalsNavCommand()
        {
            ...
            var builder = new ApiSdk.EmployeeExperience.Goals.GoalsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.EmployeeExperience>(ApiSdk.Models.EmployeeExperience.CreateFromDiscriminatorValue);
                if (model is null) {
