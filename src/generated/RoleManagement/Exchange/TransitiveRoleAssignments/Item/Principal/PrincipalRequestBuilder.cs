...
using System;
namespace ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.Principal
{
    /// <summary>
    ...
    public partial class PrincipalRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.Principal.PrincipalRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public PrincipalRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/roleManagement/exchange/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}/principal{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.Principal.PrincipalRequestBuilder"/> and sets the default values.
        ...
        public PrincipalRequestBuilder(string rawUrl) : base("{+baseurl}/roleManagement/exchange/transitiveRoleAssignments/{unifiedRoleAssignment%2Did}/principal{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Referencing the assigned principal. Read-only. Supports $expand except for the Exchange provider.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.Principal.PrincipalRequestBuilder.PrincipalRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.RoleManagement.Exchange.TransitiveRoleAssignments.Item.Principal.PrincipalRequestBuilder.PrincipalRequestBuilderGetQueryParameters>> requestConfiguration = default)
