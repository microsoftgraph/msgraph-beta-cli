...
namespace ApiSdk.Users.Item.OnlineMeetings.Item.Transcripts.Item
{
    ...
    public class CallTranscriptItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildContentNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.OnlineMeetings.Item.Transcripts.Item.Content.ContentRequestBuilder(PathParameters);
        ...
        public Command BuildMetadataContentNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the user entity.";
            var builder = new ApiSdk.Users.Item.OnlineMeetings.Item.Transcripts.Item.MetadataContent.MetadataContentRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Users.Item.OnlineMeetings.Item.Transcripts.Item.CallTranscriptItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.OnlineMeetings.Item.Transcripts.Item.CallTranscriptItemRequestBuilder.CallTranscriptItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.OnlineMeetings.Item.Transcripts.Item.CallTranscriptItemRequestBuilder.CallTranscriptItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
