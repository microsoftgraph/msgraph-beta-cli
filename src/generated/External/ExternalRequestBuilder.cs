...
using ApiSdk.External.AuthorizationSystems;
using ApiSdk.External.Connections;
using ApiSdk.External.IndustryData;
...
namespace ApiSdk.External
{
    ...
    public partial class ExternalRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildAuthorizationSystemsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.External.AuthorizationSystems.AuthorizationSystemsRequestBuilder(PathParameters);
        ...
        public Command BuildConnectionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.External.Connections.ConnectionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildIndustryDataNavCommand()
        {
            ...
            var builder = new global::ApiSdk.External.IndustryData.IndustryDataRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            ...
            nonExecCommands.Add(builder.BuildSourceSystemsNavCommand());
            nonExecCommands.Add(builder.BuildYearsNavCommand());
            foreach (var cmd in execCommands)
            {
                command.AddCommand(cmd);
            }
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.ExternalConnectors.External>(global::ApiSdk.Models.ExternalConnectors.External.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.External.ExternalRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.External.ExternalRequestBuilder.ExternalRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.External.ExternalRequestBuilder.ExternalRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.ExternalConnectors.External body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.ExternalConnectors.External body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
