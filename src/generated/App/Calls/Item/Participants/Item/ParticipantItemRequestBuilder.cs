...
namespace ApiSdk.App.Calls.Item.Participants.Item
{
    ...
    public class ParticipantItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildMuteNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.Participants.Item.Mute.MuteRequestBuilder(PathParameters);
        ...
        public Command BuildStartHoldMusicNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.Participants.Item.StartHoldMusic.StartHoldMusicRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildStopHoldMusicNavCommand()
        {
            ...
            var builder = new ApiSdk.App.Calls.Item.Participants.Item.StopHoldMusic.StopHoldMusicRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.App.Calls.Item.Participants.Item.ParticipantItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.App.Calls.Item.Participants.Item.ParticipantItemRequestBuilder.ParticipantItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.App.Calls.Item.Participants.Item.ParticipantItemRequestBuilder.ParticipantItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
