    ...
    public class PostponeRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.DirectoryNamespace.Recommendations.Item.Postpone.PostponePostRequestBody>(ApiSdk.DirectoryNamespace.Recommendations.Item.Postpone.PostponePostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DirectoryNamespace.Recommendations.Item.Postpone.PostponeRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.DirectoryNamespace.Recommendations.Item.Postpone.PostponePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.DirectoryNamespace.Recommendations.Item.Postpone.PostponePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
