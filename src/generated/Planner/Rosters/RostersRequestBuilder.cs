...
namespace ApiSdk.Planner.Rosters {
    ...
    public class RostersRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildCreateCommand()
        {
            ...
            command.Description = "Create a new plannerRoster object.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/planner-post-rosters?view=graph-rest-1.0";
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(PlannerRoster body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/planner/rosters", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
