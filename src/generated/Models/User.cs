...
#nullable restore
        ...
        public List<Message> Messages { get; set; }
#endif
        /// <summary>The primary cellular telephone number for the user. Read-only for users synced from on-premises directory. Maximum length is 64 characters. Returned by default. Supports $filter (eq, ne, not, ge, le, in, startsWith, and eq on null values) and $search.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? UserAgeGroup { get; set; }
#nullable restore
#else
        public string UserAgeGroup { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<AgreementAcceptance>? UserAgreementAcceptances { get; set; }
#nullable restore
#else
        public List<AgreementAcceptance> UserAgreementAcceptances { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<AppRoleAssignment>? UserAppRoleAssignments { get; set; }
#nullable restore
#else
        public List<AppRoleAssignment> UserAppRoleAssignments { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<AssignedLicense>? UserAssignedLicenses { get; set; }
#nullable restore
#else
        public List<AssignedLicense> UserAssignedLicenses { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<AssignedPlan>? UserAssignedPlans { get; set; }
#nullable restore
#else
        public List<AssignedPlan> UserAssignedPlans { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.Authentication? UserAuthentication { get; set; }
#nullable restore
#else
        public ApiSdk.Models.Authentication UserAuthentication { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.AuthorizationInfo? UserAuthorizationInfo { get; set; }
#nullable restore
#else
        public ApiSdk.Models.AuthorizationInfo UserAuthorizationInfo { get; set; }
#endif
        /// <summary>The birthday of the user. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Returned only on $select.</summary>
        public DateTimeOffset? UserBirthday { get; set; }
        /// <summary>The telephone numbers for the user. NOTE: Although this is a string collection, only one number can be set for this property. Read-only for users synced from on-premises directory. Returned by default. Supports $filter (eq, not, ge, le, startsWith).</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<string>? UserBusinessPhones { get; set; }
#nullable restore
#else
        public List<string> UserBusinessPhones { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.Calendar? UserCalendar { get; set; }
#nullable restore
#else
        public ApiSdk.Models.Calendar UserCalendar { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<CalendarGroup>? UserCalendarGroups { get; set; }
#nullable restore
#else
        public List<CalendarGroup> UserCalendarGroups { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.Calendar>? UserCalendars { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.Calendar> UserCalendars { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Event>? UserCalendarView { get; set; }
#nullable restore
#else
        public List<Event> UserCalendarView { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? UserConsentProvidedForMinor { get; set; }
#nullable restore
#else
        public string UserConsentProvidedForMinor { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ContactFolder>? UserContactFolders { get; set; }
#nullable restore
#else
        public List<ContactFolder> UserContactFolders { get; set; }
#endif
...
#endif
        /// <summary>The date and time the user was created, in ISO 8601 format and in UTC time. The value cannot be modified and is automatically populated when the entity is created. Nullable. For on-premises users, the value represents when they were first created in Azure AD. Property is null for some users created before June 2018 and on-premises users that were synced to Azure AD before June 2018. Read-only. Returned only on $select. Supports $filter (eq, ne, not , ge, le, in).</summary>
        public DateTimeOffset? UserCreatedDateTime { get; set; }
        /// <summary>Directory objects that were created by the user. Read-only. Nullable.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<DirectoryObject>? UserCreatedObjects { get; set; }
#nullable restore
#else
        public List<DirectoryObject> UserCreatedObjects { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? UserCreationType { get; set; }
#nullable restore
#else
        public string UserCreationType { get; set; }
#endif
...
#endif
        /// <summary>The limit on the maximum number of devices that the user is permitted to enroll. Allowed values are 5 or 1000.</summary>
        public int? UserDeviceEnrollmentLimit { get; set; }
        /// <summary>The list of troubleshooting events for this user.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<DeviceManagementTroubleshootingEvent>? UserDeviceManagementTroubleshootingEvents { get; set; }
#nullable restore
#else
        public List<DeviceManagementTroubleshootingEvent> UserDeviceManagementTroubleshootingEvents { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<DirectoryObject>? UserDirectReports { get; set; }
#nullable restore
#else
        public List<DirectoryObject> UserDirectReports { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.Drive? UserDrive { get; set; }
#nullable restore
#else
        public ApiSdk.Models.Drive UserDrive { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.Drive>? UserDrives { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.Drive> UserDrives { get; set; }
#endif
        /// <summary>The date and time when the user was hired or will start work in case of a future hire. Returned only on $select. Supports $filter (eq, ne, not , ge, le, in).</summary>
        public DateTimeOffset? UserEmployeeHireDate { get; set; }
        /// <summary>The employee identifier assigned to the user by the organization. The maximum length is 16 characters. Returned only on $select. Supports $filter (eq, ne, not , ge, le, in, startsWith, and eq on null values).</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#endif
        /// <summary>The date and time when the user left or will leave the organization. To read this property, the calling app must be assigned the User-LifeCycleInfo.Read.All permission. To write this property, the calling app must be assigned the User.Read.All and User-LifeCycleInfo.ReadWrite.All permissions. To read this property in delegated scenarios, the admin needs one of the following Azure AD roles: Lifecycle Workflows Administrator, Global Reader, or Global Administrator. To write this property in delegated scenarios, the admin needs the Global Administrator role. Supports $filter (eq, ne, not , ge, le, in). For more information, see Configure the employeeLeaveDateTime property for a user.</summary>
        public DateTimeOffset? UserEmployeeLeaveDateTime { get; set; }
        /// <summary>Represents organization data (e.g. division and costCenter) associated with a user. Returned only on $select. Supports $filter (eq, ne, not , ge, le, in).</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.EmployeeOrgData? UserEmployeeOrgData { get; set; }
#nullable restore
#else
        public ApiSdk.Models.EmployeeOrgData UserEmployeeOrgData { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Extension>? UserExtensions { get; set; }
#nullable restore
#else
        public List<Extension> UserExtensions { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? UserExternalUserState { get; set; }
#nullable restore
#else
        public string UserExternalUserState { get; set; }
#endif
        /// <summary>Shows the timestamp for the latest change to the externalUserState property. Returned only on $select. Supports $filter (eq, ne, not , in).</summary>
        public DateTimeOffset? UserExternalUserStateChangeDateTime { get; set; }
        /// <summary>The fax number of the user. Returned only on $select. Supports $filter (eq, ne, not , ge, le, in, startsWith, and eq on null values).</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Site>? UserFollowedSites { get; set; }
#nullable restore
#else
        public List<Site> UserFollowedSites { get; set; }
#endif
...
#endif
        /// <summary>The hire date of the user. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Returned only on $select.  Note: This property is specific to SharePoint Online. We recommend using the native employeeHireDate property to set and update hire date values using Microsoft Graph APIs.</summary>
        public DateTimeOffset? UserHireDate { get; set; }
        /// <summary>Represents the identities that can be used to sign in to this user account. An identity can be provided by Microsoft (also known as a local account), by organizations, or by social identity providers such as Facebook, Google, and Microsoft, and tied to a user account. May contain multiple items with the same signInType value. Returned only on $select. Supports $filter (eq) including on null values, only where the signInType is not userPrincipalName.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ObjectIdentity>? UserIdentities { get; set; }
#nullable restore
#else
        public List<ObjectIdentity> UserIdentities { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<string>? UserImAddresses { get; set; }
#nullable restore
#else
        public List<string> UserImAddresses { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.InferenceClassification? UserInferenceClassification { get; set; }
#nullable restore
#else
        public ApiSdk.Models.InferenceClassification UserInferenceClassification { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public OfficeGraphInsights? UserInsights { get; set; }
#nullable restore
#else
        public OfficeGraphInsights UserInsights { get; set; }
#endif
...
#endif
        /// <summary>Do not use – reserved for future use.</summary>
        public bool? UserIsResourceAccount { get; set; }
        /// <summary>The user&apos;s job title. Maximum length is 128 characters. Returned by default. Supports $filter (eq, ne, not , ge, le, in, startsWith, and eq on null values).</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Team>? UserJoinedTeams { get; set; }
#nullable restore
#else
        public List<Team> UserJoinedTeams { get; set; }
#endif
        /// <summary>The time when this Azure AD user last changed their password or when their password was created, whichever date the latest action was performed. The date and time information uses ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Returned only on $select.</summary>
        public DateTimeOffset? UserLastPasswordChangeDateTime { get; set; }
        /// <summary>Used by enterprise applications to determine the legal age group of the user. This property is read-only and calculated based on ageGroup and consentProvidedForMinor properties. Allowed values: null, MinorWithOutParentalConsent, MinorWithParentalConsent, MinorNoParentalConsentRequired, NotAdult and Adult. Refer to the legal age group property definitions for further information. Returned only on $select.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? UserLegalAgeGroupClassification { get; set; }
#nullable restore
#else
        public string UserLegalAgeGroupClassification { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<LicenseAssignmentState>? UserLicenseAssignmentStates { get; set; }
#nullable restore
#else
        public List<LicenseAssignmentState> UserLicenseAssignmentStates { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.LicenseDetails>? UserLicenseDetails { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.LicenseDetails> UserLicenseDetails { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.MailboxSettings? UserMailboxSettings { get; set; }
#nullable restore
#else
        public ApiSdk.Models.MailboxSettings UserMailboxSettings { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<MailFolder>? UserMailFolders { get; set; }
#nullable restore
#else
        public List<MailFolder> UserMailFolders { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? UserMailNickname { get; set; }
#nullable restore
#else
        public string UserMailNickname { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ManagedAppRegistration>? UserManagedAppRegistrations { get; set; }
#nullable restore
#else
        public List<ManagedAppRegistration> UserManagedAppRegistrations { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ManagedDevice>? UserManagedDevices { get; set; }
#nullable restore
#else
        public List<ManagedDevice> UserManagedDevices { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public DirectoryObject? UserManager { get; set; }
#nullable restore
#else
        public DirectoryObject UserManager { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<DirectoryObject>? UserMemberOf { get; set; }
#nullable restore
#else
        public List<DirectoryObject> UserMemberOf { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? UserMySite { get; set; }
#nullable restore
#else
        public string UserMySite { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<OAuth2PermissionGrant>? UserOauth2PermissionGrants { get; set; }
#nullable restore
#else
        public List<OAuth2PermissionGrant> UserOauth2PermissionGrants { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.Onenote? UserOnenote { get; set; }
#nullable restore
#else
        public ApiSdk.Models.Onenote UserOnenote { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<OnlineMeeting>? UserOnlineMeetings { get; set; }
#nullable restore
#else
        public List<OnlineMeeting> UserOnlineMeetings { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? UserOnPremisesDistinguishedName { get; set; }
#nullable restore
#else
        public string UserOnPremisesDistinguishedName { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? UserOnPremisesDomainName { get; set; }
#nullable restore
#else
        public string UserOnPremisesDomainName { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.OnPremisesExtensionAttributes? UserOnPremisesExtensionAttributes { get; set; }
#nullable restore
#else
        public ApiSdk.Models.OnPremisesExtensionAttributes UserOnPremisesExtensionAttributes { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? UserOnPremisesImmutableId { get; set; }
#nullable restore
#else
        public string UserOnPremisesImmutableId { get; set; }
#endif
        /// <summary>Indicates the last time at which the object was synced with the on-premises directory; for example: 2013-02-16T03:04:54Z. The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z. Read-only. Returned only on $select. Supports $filter (eq, ne, not, ge, le, in).</summary>
        public DateTimeOffset? UserOnPremisesLastSyncDateTime { get; set; }
        /// <summary>Errors when using Microsoft synchronization product during provisioning. Returned only on $select. Supports $filter (eq, not, ge, le).</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<OnPremisesProvisioningError>? UserOnPremisesProvisioningErrors { get; set; }
#nullable restore
#else
        public List<OnPremisesProvisioningError> UserOnPremisesProvisioningErrors { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? UserOnPremisesSamAccountName { get; set; }
#nullable restore
#else
        public string UserOnPremisesSamAccountName { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? UserOnPremisesSecurityIdentifier { get; set; }
#nullable restore
#else
        public string UserOnPremisesSecurityIdentifier { get; set; }
#endif
        /// <summary>true if this user object is currently being synced from an on-premises Active Directory (AD); otherwise the user isn&apos;t being synced and can be managed in Azure Active Directory (Azure AD). Read-only. Returned only on $select. Supports $filter (eq, ne, not, in, and eq on null values).</summary>
        public bool? UserOnPremisesSyncEnabled { get; set; }
        /// <summary>Contains the on-premises userPrincipalName synchronized from the on-premises directory. The property is only populated for customers who are synchronizing their on-premises directory to Azure Active Directory via Azure AD Connect. Read-only. Returned only on $select. Supports $filter (eq, ne, not, ge, le, in, startsWith).</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? UserOnPremisesUserPrincipalName { get; set; }
#nullable restore
#else
        public string UserOnPremisesUserPrincipalName { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<string>? UserOtherMails { get; set; }
#nullable restore
#else
        public List<string> UserOtherMails { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public OutlookUser? UserOutlook { get; set; }
#nullable restore
#else
        public OutlookUser UserOutlook { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<DirectoryObject>? UserOwnedDevices { get; set; }
#nullable restore
#else
        public List<DirectoryObject> UserOwnedDevices { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<DirectoryObject>? UserOwnedObjects { get; set; }
#nullable restore
#else
        public List<DirectoryObject> UserOwnedObjects { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? UserPasswordPolicies { get; set; }
#nullable restore
#else
        public string UserPasswordPolicies { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.PasswordProfile? UserPasswordProfile { get; set; }
#nullable restore
#else
        public ApiSdk.Models.PasswordProfile UserPasswordProfile { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<string>? UserPastProjects { get; set; }
#nullable restore
#else
        public List<string> UserPastProjects { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Person>? UserPeople { get; set; }
#nullable restore
#else
        public List<Person> UserPeople { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ProfilePhoto>? UserPhotos { get; set; }
#nullable restore
#else
        public List<ProfilePhoto> UserPhotos { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public PlannerUser? UserPlanner { get; set; }
#nullable restore
#else
        public PlannerUser UserPlanner { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.Presence? UserPresence { get; set; }
#nullable restore
#else
        public ApiSdk.Models.Presence UserPresence { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.UserPrint? UserPrint { get; set; }
#nullable restore
#else
        public ApiSdk.Models.UserPrint UserPrint { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ProvisionedPlan>? UserProvisionedPlans { get; set; }
#nullable restore
#else
        public List<ProvisionedPlan> UserProvisionedPlans { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<DirectoryObject>? UserRegisteredDevices { get; set; }
#nullable restore
#else
        public List<DirectoryObject> UserRegisteredDevices { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<string>? UserResponsibilities { get; set; }
#nullable restore
#else
        public List<string> UserResponsibilities { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<string>? UserSchools { get; set; }
#nullable restore
#else
        public List<string> UserSchools { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ScopedRoleMembership>? UserScopedRoleMemberOf { get; set; }
#nullable restore
#else
        public List<ScopedRoleMembership> UserScopedRoleMemberOf { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? UserSecurityIdentifier { get; set; }
#nullable restore
#else
        public string UserSecurityIdentifier { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.UserSettings? UserSettings { get; set; }
#nullable restore
#else
        public ApiSdk.Models.UserSettings UserSettings { get; set; }
#endif
        /// <summary>Do not use in Microsoft Graph. Manage this property through the Microsoft 365 admin center instead. Represents whether the user should be included in the Outlook global address list. See Known issue.</summary>
        public bool? UserShowInAddressList { get; set; }
        /// <summary>Get the last signed-in date and request ID of the sign-in for a given user. Read-only.Returned only on $select. Supports $filter (eq, ne, not, ge, le) but not with any other filterable properties. Note: Details for this property require an Azure AD Premium P1/P2 license and the AuditLog.Read.All permission.This property is not returned for a user who has never signed in or last signed in before April 2020.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.SignInActivity? UserSignInActivity { get; set; }
#nullable restore
#else
        public ApiSdk.Models.SignInActivity UserSignInActivity { get; set; }
#endif
        /// <summary>Any refresh tokens or sessions tokens (session cookies) issued before this time are invalid, and applications will get an error when using an invalid refresh or sessions token to acquire a delegated access token (to access APIs such as Microsoft Graph).  If this happens, the application will need to acquire a new refresh token by making a request to the authorize endpoint. Read-only. Use revokeSignInSessions to reset. Returned only on $select.</summary>
        public DateTimeOffset? UserSignInSessionsValidFromDateTime { get; set; }
        /// <summary>A list for the user to enumerate their skills. Returned only on $select.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.UserTeamwork? UserTeamwork { get; set; }
#nullable restore
#else
        public ApiSdk.Models.UserTeamwork UserTeamwork { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.Todo? UserTodo { get; set; }
#nullable restore
#else
        public ApiSdk.Models.Todo UserTodo { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<DirectoryObject>? UserTransitiveMemberOf { get; set; }
#nullable restore
#else
        public List<DirectoryObject> UserTransitiveMemberOf { get; set; }
#endif
...
#nullable restore
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                ...
                {"aboutMe", n => { UserAboutMe = n.GetStringValue(); } },
                {"accountEnabled", n => { UserAccountEnabled = n.GetBoolValue(); } },
                {"activities", n => { UserActivities = n.GetCollectionOfObjectValues<UserActivity>(UserActivity.CreateFromDiscriminatorValue)?.ToList(); } },
                {"ageGroup", n => { UserAgeGroup = n.GetStringValue(); } },
                {"agreementAcceptances", n => { UserAgreementAcceptances = n.GetCollectionOfObjectValues<AgreementAcceptance>(AgreementAcceptance.CreateFromDiscriminatorValue)?.ToList(); } },
                {"appRoleAssignments", n => { UserAppRoleAssignments = n.GetCollectionOfObjectValues<AppRoleAssignment>(AppRoleAssignment.CreateFromDiscriminatorValue)?.ToList(); } },
                {"assignedLicenses", n => { UserAssignedLicenses = n.GetCollectionOfObjectValues<AssignedLicense>(AssignedLicense.CreateFromDiscriminatorValue)?.ToList(); } },
                {"assignedPlans", n => { UserAssignedPlans = n.GetCollectionOfObjectValues<AssignedPlan>(AssignedPlan.CreateFromDiscriminatorValue)?.ToList(); } },
                {"authentication", n => { UserAuthentication = n.GetObjectValue<ApiSdk.Models.Authentication>(ApiSdk.Models.Authentication.CreateFromDiscriminatorValue); } },
                {"authorizationInfo", n => { UserAuthorizationInfo = n.GetObjectValue<ApiSdk.Models.AuthorizationInfo>(ApiSdk.Models.AuthorizationInfo.CreateFromDiscriminatorValue); } },
                {"birthday", n => { UserBirthday = n.GetDateTimeOffsetValue(); } },
                {"businessPhones", n => { UserBusinessPhones = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                {"calendar", n => { UserCalendar = n.GetObjectValue<ApiSdk.Models.Calendar>(ApiSdk.Models.Calendar.CreateFromDiscriminatorValue); } },
                {"calendarGroups", n => { UserCalendarGroups = n.GetCollectionOfObjectValues<CalendarGroup>(CalendarGroup.CreateFromDiscriminatorValue)?.ToList(); } },
                {"calendars", n => { UserCalendars = n.GetCollectionOfObjectValues<ApiSdk.Models.Calendar>(ApiSdk.Models.Calendar.CreateFromDiscriminatorValue)?.ToList(); } },
                {"calendarView", n => { UserCalendarView = n.GetCollectionOfObjectValues<Event>(Event.CreateFromDiscriminatorValue)?.ToList(); } },
                {"chats", n => { UserChats = n.GetCollectionOfObjectValues<Chat>(Chat.CreateFromDiscriminatorValue)?.ToList(); } },
                {"city", n => { UserCity = n.GetStringValue(); } },
                {"companyName", n => { UserCompanyName = n.GetStringValue(); } },
                {"consentProvidedForMinor", n => { UserConsentProvidedForMinor = n.GetStringValue(); } },
                {"contactFolders", n => { UserContactFolders = n.GetCollectionOfObjectValues<ContactFolder>(ContactFolder.CreateFromDiscriminatorValue)?.ToList(); } },
                {"contacts", n => { UserContacts = n.GetCollectionOfObjectValues<Contact>(Contact.CreateFromDiscriminatorValue)?.ToList(); } },
                {"country", n => { UserCountry = n.GetStringValue(); } },
                {"createdDateTime", n => { UserCreatedDateTime = n.GetDateTimeOffsetValue(); } },
                {"createdObjects", n => { UserCreatedObjects = n.GetCollectionOfObjectValues<DirectoryObject>(DirectoryObject.CreateFromDiscriminatorValue)?.ToList(); } },
                {"creationType", n => { UserCreationType = n.GetStringValue(); } },
                {"department", n => { UserDepartment = n.GetStringValue(); } },
                {"deviceEnrollmentLimit", n => { UserDeviceEnrollmentLimit = n.GetIntValue(); } },
                {"deviceManagementTroubleshootingEvents", n => { UserDeviceManagementTroubleshootingEvents = n.GetCollectionOfObjectValues<DeviceManagementTroubleshootingEvent>(DeviceManagementTroubleshootingEvent.CreateFromDiscriminatorValue)?.ToList(); } },
                {"directReports", n => { UserDirectReports = n.GetCollectionOfObjectValues<DirectoryObject>(DirectoryObject.CreateFromDiscriminatorValue)?.ToList(); } },
                {"displayName", n => { UserDisplayName = n.GetStringValue(); } },
                {"drive", n => { UserDrive = n.GetObjectValue<ApiSdk.Models.Drive>(ApiSdk.Models.Drive.CreateFromDiscriminatorValue); } },
                {"drives", n => { UserDrives = n.GetCollectionOfObjectValues<ApiSdk.Models.Drive>(ApiSdk.Models.Drive.CreateFromDiscriminatorValue)?.ToList(); } },
                {"employeeHireDate", n => { UserEmployeeHireDate = n.GetDateTimeOffsetValue(); } },
                {"employeeId", n => { UserEmployeeId = n.GetStringValue(); } },
                {"employeeLeaveDateTime", n => { UserEmployeeLeaveDateTime = n.GetDateTimeOffsetValue(); } },
                {"employeeOrgData", n => { UserEmployeeOrgData = n.GetObjectValue<ApiSdk.Models.EmployeeOrgData>(ApiSdk.Models.EmployeeOrgData.CreateFromDiscriminatorValue); } },
                {"employeeType", n => { UserEmployeeType = n.GetStringValue(); } },
                {"events", n => { UserEvents = n.GetCollectionOfObjectValues<Event>(Event.CreateFromDiscriminatorValue)?.ToList(); } },
                {"extensions", n => { UserExtensions = n.GetCollectionOfObjectValues<Extension>(Extension.CreateFromDiscriminatorValue)?.ToList(); } },
                {"externalUserState", n => { UserExternalUserState = n.GetStringValue(); } },
                {"externalUserStateChangeDateTime", n => { UserExternalUserStateChangeDateTime = n.GetDateTimeOffsetValue(); } },
                {"faxNumber", n => { UserFaxNumber = n.GetStringValue(); } },
                {"followedSites", n => { UserFollowedSites = n.GetCollectionOfObjectValues<Site>(Site.CreateFromDiscriminatorValue)?.ToList(); } },
                {"givenName", n => { UserGivenName = n.GetStringValue(); } },
                {"hireDate", n => { UserHireDate = n.GetDateTimeOffsetValue(); } },
                {"identities", n => { UserIdentities = n.GetCollectionOfObjectValues<ObjectIdentity>(ObjectIdentity.CreateFromDiscriminatorValue)?.ToList(); } },
                {"imAddresses", n => { UserImAddresses = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                {"inferenceClassification", n => { UserInferenceClassification = n.GetObjectValue<ApiSdk.Models.InferenceClassification>(ApiSdk.Models.InferenceClassification.CreateFromDiscriminatorValue); } },
                {"insights", n => { UserInsights = n.GetObjectValue<OfficeGraphInsights>(OfficeGraphInsights.CreateFromDiscriminatorValue); } },
                {"interests", n => { UserInterests = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                {"isResourceAccount", n => { UserIsResourceAccount = n.GetBoolValue(); } },
                {"jobTitle", n => { UserJobTitle = n.GetStringValue(); } },
                {"joinedTeams", n => { UserJoinedTeams = n.GetCollectionOfObjectValues<Team>(Team.CreateFromDiscriminatorValue)?.ToList(); } },
                {"lastPasswordChangeDateTime", n => { UserLastPasswordChangeDateTime = n.GetDateTimeOffsetValue(); } },
                {"legalAgeGroupClassification", n => { UserLegalAgeGroupClassification = n.GetStringValue(); } },
                {"licenseAssignmentStates", n => { UserLicenseAssignmentStates = n.GetCollectionOfObjectValues<LicenseAssignmentState>(LicenseAssignmentState.CreateFromDiscriminatorValue)?.ToList(); } },
                {"licenseDetails", n => { UserLicenseDetails = n.GetCollectionOfObjectValues<ApiSdk.Models.LicenseDetails>(ApiSdk.Models.LicenseDetails.CreateFromDiscriminatorValue)?.ToList(); } },
                {"mail", n => { UserMail = n.GetStringValue(); } },
                {"mailboxSettings", n => { UserMailboxSettings = n.GetObjectValue<ApiSdk.Models.MailboxSettings>(ApiSdk.Models.MailboxSettings.CreateFromDiscriminatorValue); } },
                {"mailFolders", n => { UserMailFolders = n.GetCollectionOfObjectValues<MailFolder>(MailFolder.CreateFromDiscriminatorValue)?.ToList(); } },
                {"mailNickname", n => { UserMailNickname = n.GetStringValue(); } },
                {"managedAppRegistrations", n => { UserManagedAppRegistrations = n.GetCollectionOfObjectValues<ManagedAppRegistration>(ManagedAppRegistration.CreateFromDiscriminatorValue)?.ToList(); } },
                {"managedDevices", n => { UserManagedDevices = n.GetCollectionOfObjectValues<ManagedDevice>(ManagedDevice.CreateFromDiscriminatorValue)?.ToList(); } },
                {"manager", n => { UserManager = n.GetObjectValue<DirectoryObject>(DirectoryObject.CreateFromDiscriminatorValue); } },
                {"memberOf", n => { UserMemberOf = n.GetCollectionOfObjectValues<DirectoryObject>(DirectoryObject.CreateFromDiscriminatorValue)?.ToList(); } },
                {"messages", n => { UserMessages = n.GetCollectionOfObjectValues<Message>(Message.CreateFromDiscriminatorValue)?.ToList(); } },
                {"mobilePhone", n => { UserMobilePhone = n.GetStringValue(); } },
                {"mySite", n => { UserMySite = n.GetStringValue(); } },
                {"oauth2PermissionGrants", n => { UserOauth2PermissionGrants = n.GetCollectionOfObjectValues<OAuth2PermissionGrant>(OAuth2PermissionGrant.CreateFromDiscriminatorValue)?.ToList(); } },
                {"officeLocation", n => { UserOfficeLocation = n.GetStringValue(); } },
                {"onenote", n => { UserOnenote = n.GetObjectValue<ApiSdk.Models.Onenote>(ApiSdk.Models.Onenote.CreateFromDiscriminatorValue); } },
                {"onlineMeetings", n => { UserOnlineMeetings = n.GetCollectionOfObjectValues<OnlineMeeting>(OnlineMeeting.CreateFromDiscriminatorValue)?.ToList(); } },
                {"onPremisesDistinguishedName", n => { UserOnPremisesDistinguishedName = n.GetStringValue(); } },
                {"onPremisesDomainName", n => { UserOnPremisesDomainName = n.GetStringValue(); } },
                {"onPremisesExtensionAttributes", n => { UserOnPremisesExtensionAttributes = n.GetObjectValue<ApiSdk.Models.OnPremisesExtensionAttributes>(ApiSdk.Models.OnPremisesExtensionAttributes.CreateFromDiscriminatorValue); } },
                {"onPremisesImmutableId", n => { UserOnPremisesImmutableId = n.GetStringValue(); } },
                {"onPremisesLastSyncDateTime", n => { UserOnPremisesLastSyncDateTime = n.GetDateTimeOffsetValue(); } },
                {"onPremisesProvisioningErrors", n => { UserOnPremisesProvisioningErrors = n.GetCollectionOfObjectValues<OnPremisesProvisioningError>(OnPremisesProvisioningError.CreateFromDiscriminatorValue)?.ToList(); } },
                {"onPremisesSamAccountName", n => { UserOnPremisesSamAccountName = n.GetStringValue(); } },
                {"onPremisesSecurityIdentifier", n => { UserOnPremisesSecurityIdentifier = n.GetStringValue(); } },
                {"onPremisesSyncEnabled", n => { UserOnPremisesSyncEnabled = n.GetBoolValue(); } },
                {"onPremisesUserPrincipalName", n => { UserOnPremisesUserPrincipalName = n.GetStringValue(); } },
                {"otherMails", n => { UserOtherMails = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                {"outlook", n => { UserOutlook = n.GetObjectValue<OutlookUser>(OutlookUser.CreateFromDiscriminatorValue); } },
                {"ownedDevices", n => { UserOwnedDevices = n.GetCollectionOfObjectValues<DirectoryObject>(DirectoryObject.CreateFromDiscriminatorValue)?.ToList(); } },
                {"ownedObjects", n => { UserOwnedObjects = n.GetCollectionOfObjectValues<DirectoryObject>(DirectoryObject.CreateFromDiscriminatorValue)?.ToList(); } },
                {"passwordPolicies", n => { UserPasswordPolicies = n.GetStringValue(); } },
                {"passwordProfile", n => { UserPasswordProfile = n.GetObjectValue<ApiSdk.Models.PasswordProfile>(ApiSdk.Models.PasswordProfile.CreateFromDiscriminatorValue); } },
                {"pastProjects", n => { UserPastProjects = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                {"people", n => { UserPeople = n.GetCollectionOfObjectValues<Person>(Person.CreateFromDiscriminatorValue)?.ToList(); } },
                {"photo", n => { UserPhoto = n.GetObjectValue<ProfilePhoto>(ProfilePhoto.CreateFromDiscriminatorValue); } },
                {"photos", n => { UserPhotos = n.GetCollectionOfObjectValues<ProfilePhoto>(ProfilePhoto.CreateFromDiscriminatorValue)?.ToList(); } },
                {"planner", n => { UserPlanner = n.GetObjectValue<PlannerUser>(PlannerUser.CreateFromDiscriminatorValue); } },
                {"postalCode", n => { UserPostalCode = n.GetStringValue(); } },
                {"preferredDataLocation", n => { UserPreferredDataLocation = n.GetStringValue(); } },
                {"preferredLanguage", n => { UserPreferredLanguage = n.GetStringValue(); } },
                {"preferredName", n => { UserPreferredName = n.GetStringValue(); } },
                {"presence", n => { UserPresence = n.GetObjectValue<ApiSdk.Models.Presence>(ApiSdk.Models.Presence.CreateFromDiscriminatorValue); } },
                {"userPrincipalName", n => { UserPrincipalName = n.GetStringValue(); } },
                {"print", n => { UserPrint = n.GetObjectValue<ApiSdk.Models.UserPrint>(ApiSdk.Models.UserPrint.CreateFromDiscriminatorValue); } },
                {"provisionedPlans", n => { UserProvisionedPlans = n.GetCollectionOfObjectValues<ProvisionedPlan>(ProvisionedPlan.CreateFromDiscriminatorValue)?.ToList(); } },
                {"proxyAddresses", n => { UserProxyAddresses = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                {"registeredDevices", n => { UserRegisteredDevices = n.GetCollectionOfObjectValues<DirectoryObject>(DirectoryObject.CreateFromDiscriminatorValue)?.ToList(); } },
                {"responsibilities", n => { UserResponsibilities = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                {"schools", n => { UserSchools = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                {"scopedRoleMemberOf", n => { UserScopedRoleMemberOf = n.GetCollectionOfObjectValues<ScopedRoleMembership>(ScopedRoleMembership.CreateFromDiscriminatorValue)?.ToList(); } },
                {"securityIdentifier", n => { UserSecurityIdentifier = n.GetStringValue(); } },
                {"settings", n => { UserSettings = n.GetObjectValue<ApiSdk.Models.UserSettings>(ApiSdk.Models.UserSettings.CreateFromDiscriminatorValue); } },
                {"showInAddressList", n => { UserShowInAddressList = n.GetBoolValue(); } },
                {"signInActivity", n => { UserSignInActivity = n.GetObjectValue<ApiSdk.Models.SignInActivity>(ApiSdk.Models.SignInActivity.CreateFromDiscriminatorValue); } },
                {"signInSessionsValidFromDateTime", n => { UserSignInSessionsValidFromDateTime = n.GetDateTimeOffsetValue(); } },
                {"skills", n => { UserSkills = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
                {"state", n => { UserState = n.GetStringValue(); } },
                {"streetAddress", n => { UserStreetAddress = n.GetStringValue(); } },
                {"surname", n => { UserSurname = n.GetStringValue(); } },
                {"teamwork", n => { UserTeamwork = n.GetObjectValue<ApiSdk.Models.UserTeamwork>(ApiSdk.Models.UserTeamwork.CreateFromDiscriminatorValue); } },
                {"todo", n => { UserTodo = n.GetObjectValue<ApiSdk.Models.Todo>(ApiSdk.Models.Todo.CreateFromDiscriminatorValue); } },
                {"transitiveMemberOf", n => { UserTransitiveMemberOf = n.GetCollectionOfObjectValues<DirectoryObject>(DirectoryObject.CreateFromDiscriminatorValue)?.ToList(); } },
                {"userType", n => { UserType = n.GetStringValue(); } },
                {"usageLocation", n => { UserUsageLocation = n.GetStringValue(); } },
                {"userPrincipalName", n => { UserUserPrincipalName = n.GetStringValue(); } },
                {"userType", n => { UserUserType = n.GetStringValue(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteStringValue("aboutMe", UserAboutMe);
            writer.WriteBoolValue("accountEnabled", UserAccountEnabled);
            writer.WriteCollectionOfObjectValues<UserActivity>("activities", UserActivities);
            writer.WriteStringValue("ageGroup", UserAgeGroup);
            writer.WriteCollectionOfObjectValues<AgreementAcceptance>("agreementAcceptances", UserAgreementAcceptances);
            writer.WriteCollectionOfObjectValues<AppRoleAssignment>("appRoleAssignments", UserAppRoleAssignments);
            writer.WriteCollectionOfObjectValues<AssignedLicense>("assignedLicenses", UserAssignedLicenses);
            writer.WriteCollectionOfObjectValues<AssignedPlan>("assignedPlans", UserAssignedPlans);
            writer.WriteObjectValue<ApiSdk.Models.Authentication>("authentication", UserAuthentication);
            writer.WriteObjectValue<ApiSdk.Models.AuthorizationInfo>("authorizationInfo", UserAuthorizationInfo);
            writer.WriteDateTimeOffsetValue("birthday", UserBirthday);
            writer.WriteCollectionOfPrimitiveValues<string>("businessPhones", UserBusinessPhones);
            writer.WriteObjectValue<ApiSdk.Models.Calendar>("calendar", UserCalendar);
            writer.WriteCollectionOfObjectValues<CalendarGroup>("calendarGroups", UserCalendarGroups);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Calendar>("calendars", UserCalendars);
            writer.WriteCollectionOfObjectValues<Event>("calendarView", UserCalendarView);
            writer.WriteCollectionOfObjectValues<Chat>("chats", UserChats);
            writer.WriteStringValue("city", UserCity);
            writer.WriteStringValue("companyName", UserCompanyName);
            writer.WriteStringValue("consentProvidedForMinor", UserConsentProvidedForMinor);
            writer.WriteCollectionOfObjectValues<ContactFolder>("contactFolders", UserContactFolders);
            writer.WriteCollectionOfObjectValues<Contact>("contacts", UserContacts);
            writer.WriteStringValue("country", UserCountry);
            writer.WriteDateTimeOffsetValue("createdDateTime", UserCreatedDateTime);
            writer.WriteCollectionOfObjectValues<DirectoryObject>("createdObjects", UserCreatedObjects);
            writer.WriteStringValue("creationType", UserCreationType);
            writer.WriteStringValue("department", UserDepartment);
            writer.WriteIntValue("deviceEnrollmentLimit", UserDeviceEnrollmentLimit);
            writer.WriteCollectionOfObjectValues<DeviceManagementTroubleshootingEvent>("deviceManagementTroubleshootingEvents", UserDeviceManagementTroubleshootingEvents);
            writer.WriteCollectionOfObjectValues<DirectoryObject>("directReports", UserDirectReports);
            writer.WriteStringValue("displayName", UserDisplayName);
            writer.WriteObjectValue<ApiSdk.Models.Drive>("drive", UserDrive);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Drive>("drives", UserDrives);
            writer.WriteDateTimeOffsetValue("employeeHireDate", UserEmployeeHireDate);
            writer.WriteStringValue("employeeId", UserEmployeeId);
            writer.WriteDateTimeOffsetValue("employeeLeaveDateTime", UserEmployeeLeaveDateTime);
            writer.WriteObjectValue<ApiSdk.Models.EmployeeOrgData>("employeeOrgData", UserEmployeeOrgData);
            writer.WriteStringValue("employeeType", UserEmployeeType);
            writer.WriteCollectionOfObjectValues<Event>("events", UserEvents);
            writer.WriteCollectionOfObjectValues<Extension>("extensions", UserExtensions);
            writer.WriteStringValue("externalUserState", UserExternalUserState);
            writer.WriteDateTimeOffsetValue("externalUserStateChangeDateTime", UserExternalUserStateChangeDateTime);
            writer.WriteStringValue("faxNumber", UserFaxNumber);
            writer.WriteCollectionOfObjectValues<Site>("followedSites", UserFollowedSites);
            writer.WriteStringValue("givenName", UserGivenName);
            writer.WriteDateTimeOffsetValue("hireDate", UserHireDate);
            writer.WriteCollectionOfObjectValues<ObjectIdentity>("identities", UserIdentities);
            writer.WriteCollectionOfPrimitiveValues<string>("imAddresses", UserImAddresses);
            writer.WriteObjectValue<ApiSdk.Models.InferenceClassification>("inferenceClassification", UserInferenceClassification);
            writer.WriteObjectValue<OfficeGraphInsights>("insights", UserInsights);
            writer.WriteCollectionOfPrimitiveValues<string>("interests", UserInterests);
            writer.WriteBoolValue("isResourceAccount", UserIsResourceAccount);
            writer.WriteStringValue("jobTitle", UserJobTitle);
            writer.WriteCollectionOfObjectValues<Team>("joinedTeams", UserJoinedTeams);
            writer.WriteDateTimeOffsetValue("lastPasswordChangeDateTime", UserLastPasswordChangeDateTime);
            writer.WriteStringValue("legalAgeGroupClassification", UserLegalAgeGroupClassification);
            writer.WriteCollectionOfObjectValues<LicenseAssignmentState>("licenseAssignmentStates", UserLicenseAssignmentStates);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.LicenseDetails>("licenseDetails", UserLicenseDetails);
            writer.WriteStringValue("mail", UserMail);
            writer.WriteObjectValue<ApiSdk.Models.MailboxSettings>("mailboxSettings", UserMailboxSettings);
            writer.WriteCollectionOfObjectValues<MailFolder>("mailFolders", UserMailFolders);
            writer.WriteStringValue("mailNickname", UserMailNickname);
            writer.WriteCollectionOfObjectValues<ManagedAppRegistration>("managedAppRegistrations", UserManagedAppRegistrations);
            writer.WriteCollectionOfObjectValues<ManagedDevice>("managedDevices", UserManagedDevices);
            writer.WriteObjectValue<DirectoryObject>("manager", UserManager);
            writer.WriteCollectionOfObjectValues<DirectoryObject>("memberOf", UserMemberOf);
            writer.WriteCollectionOfObjectValues<Message>("messages", UserMessages);
            writer.WriteStringValue("mobilePhone", UserMobilePhone);
            writer.WriteStringValue("mySite", UserMySite);
            writer.WriteCollectionOfObjectValues<OAuth2PermissionGrant>("oauth2PermissionGrants", UserOauth2PermissionGrants);
            writer.WriteStringValue("officeLocation", UserOfficeLocation);
            writer.WriteObjectValue<ApiSdk.Models.Onenote>("onenote", UserOnenote);
            writer.WriteCollectionOfObjectValues<OnlineMeeting>("onlineMeetings", UserOnlineMeetings);
            writer.WriteStringValue("onPremisesDistinguishedName", UserOnPremisesDistinguishedName);
            writer.WriteStringValue("onPremisesDomainName", UserOnPremisesDomainName);
            writer.WriteObjectValue<ApiSdk.Models.OnPremisesExtensionAttributes>("onPremisesExtensionAttributes", UserOnPremisesExtensionAttributes);
            writer.WriteStringValue("onPremisesImmutableId", UserOnPremisesImmutableId);
            writer.WriteDateTimeOffsetValue("onPremisesLastSyncDateTime", UserOnPremisesLastSyncDateTime);
            writer.WriteCollectionOfObjectValues<OnPremisesProvisioningError>("onPremisesProvisioningErrors", UserOnPremisesProvisioningErrors);
            writer.WriteStringValue("onPremisesSamAccountName", UserOnPremisesSamAccountName);
            writer.WriteStringValue("onPremisesSecurityIdentifier", UserOnPremisesSecurityIdentifier);
            writer.WriteBoolValue("onPremisesSyncEnabled", UserOnPremisesSyncEnabled);
            writer.WriteStringValue("onPremisesUserPrincipalName", UserOnPremisesUserPrincipalName);
            writer.WriteCollectionOfPrimitiveValues<string>("otherMails", UserOtherMails);
            writer.WriteObjectValue<OutlookUser>("outlook", UserOutlook);
            writer.WriteCollectionOfObjectValues<DirectoryObject>("ownedDevices", UserOwnedDevices);
            writer.WriteCollectionOfObjectValues<DirectoryObject>("ownedObjects", UserOwnedObjects);
            writer.WriteStringValue("passwordPolicies", UserPasswordPolicies);
            writer.WriteObjectValue<ApiSdk.Models.PasswordProfile>("passwordProfile", UserPasswordProfile);
            writer.WriteCollectionOfPrimitiveValues<string>("pastProjects", UserPastProjects);
            writer.WriteCollectionOfObjectValues<Person>("people", UserPeople);
            writer.WriteObjectValue<ProfilePhoto>("photo", UserPhoto);
            writer.WriteCollectionOfObjectValues<ProfilePhoto>("photos", UserPhotos);
            writer.WriteObjectValue<PlannerUser>("planner", UserPlanner);
            writer.WriteStringValue("postalCode", UserPostalCode);
            writer.WriteStringValue("preferredDataLocation", UserPreferredDataLocation);
            writer.WriteStringValue("preferredLanguage", UserPreferredLanguage);
            writer.WriteStringValue("preferredName", UserPreferredName);
            writer.WriteObjectValue<ApiSdk.Models.Presence>("presence", UserPresence);
            writer.WriteStringValue("userPrincipalName", UserPrincipalName);
            writer.WriteObjectValue<ApiSdk.Models.UserPrint>("print", UserPrint);
            writer.WriteCollectionOfObjectValues<ProvisionedPlan>("provisionedPlans", UserProvisionedPlans);
            writer.WriteCollectionOfPrimitiveValues<string>("proxyAddresses", UserProxyAddresses);
            writer.WriteCollectionOfObjectValues<DirectoryObject>("registeredDevices", UserRegisteredDevices);
            writer.WriteCollectionOfPrimitiveValues<string>("responsibilities", UserResponsibilities);
            writer.WriteCollectionOfPrimitiveValues<string>("schools", UserSchools);
            writer.WriteCollectionOfObjectValues<ScopedRoleMembership>("scopedRoleMemberOf", UserScopedRoleMemberOf);
            writer.WriteStringValue("securityIdentifier", UserSecurityIdentifier);
            writer.WriteObjectValue<ApiSdk.Models.UserSettings>("settings", UserSettings);
            writer.WriteBoolValue("showInAddressList", UserShowInAddressList);
            writer.WriteObjectValue<ApiSdk.Models.SignInActivity>("signInActivity", UserSignInActivity);
            writer.WriteDateTimeOffsetValue("signInSessionsValidFromDateTime", UserSignInSessionsValidFromDateTime);
            writer.WriteCollectionOfPrimitiveValues<string>("skills", UserSkills);
            writer.WriteStringValue("state", UserState);
            writer.WriteStringValue("streetAddress", UserStreetAddress);
            writer.WriteStringValue("surname", UserSurname);
            writer.WriteObjectValue<ApiSdk.Models.UserTeamwork>("teamwork", UserTeamwork);
            writer.WriteObjectValue<ApiSdk.Models.Todo>("todo", UserTodo);
            writer.WriteCollectionOfObjectValues<DirectoryObject>("transitiveMemberOf", UserTransitiveMemberOf);
            writer.WriteStringValue("userType", UserType);
            writer.WriteStringValue("usageLocation", UserUsageLocation);
            writer.WriteStringValue("userPrincipalName", UserUserPrincipalName);
            writer.WriteStringValue("userType", UserUserType);
        }
    }
}
