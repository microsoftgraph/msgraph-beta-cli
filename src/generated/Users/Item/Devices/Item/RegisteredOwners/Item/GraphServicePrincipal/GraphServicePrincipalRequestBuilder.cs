...
using System;
namespace ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item.GraphServicePrincipal
{
    /// <summary>
    ...
    public partial class GraphServicePrincipalRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item.GraphServicePrincipal.GraphServicePrincipalRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public GraphServicePrincipalRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}/graph.servicePrincipal{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item.GraphServicePrincipal.GraphServicePrincipalRequestBuilder"/> and sets the default values.
        ...
        public GraphServicePrincipalRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}/graph.servicePrincipal{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.servicePrincipal
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item.GraphServicePrincipal.GraphServicePrincipalRequestBuilder.GraphServicePrincipalRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item.GraphServicePrincipal.GraphServicePrincipalRequestBuilder.GraphServicePrincipalRequestBuilderGetQueryParameters>> requestConfiguration = default)
