    ...
    public class WindowsDefenderScanRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.DeviceManagement.ManagedDevices.Item.WindowsDefenderScan.WindowsDefenderScanPostRequestBody>(ApiSdk.DeviceManagement.ManagedDevices.Item.WindowsDefenderScan.WindowsDefenderScanPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceManagement.ManagedDevices.Item.WindowsDefenderScan.WindowsDefenderScanRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.DeviceManagement.ManagedDevices.Item.WindowsDefenderScan.WindowsDefenderScanPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.DeviceManagement.ManagedDevices.Item.WindowsDefenderScan.WindowsDefenderScanPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
