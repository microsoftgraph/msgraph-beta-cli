...
using System;
namespace ApiSdk.Admin.Windows.Updates.DeploymentAudiences.Item.Members.Item.MicrosoftGraphWindowsUpdatesAddMembers
{
    /// <summary>
    ...
    public partial class MicrosoftGraphWindowsUpdatesAddMembersRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Admin.Windows.Updates.DeploymentAudiences.Item.Members.Item.MicrosoftGraphWindowsUpdatesAddMembers.AddMembersPostRequestBody>(global::ApiSdk.Admin.Windows.Updates.DeploymentAudiences.Item.Members.Item.MicrosoftGraphWindowsUpdatesAddMembers.AddMembersPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Admin.Windows.Updates.DeploymentAudiences.Item.Members.Item.MicrosoftGraphWindowsUpdatesAddMembers.MicrosoftGraphWindowsUpdatesAddMembersRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public MicrosoftGraphWindowsUpdatesAddMembersRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/members/{updatableAsset%2Did}/microsoft.graph.windowsUpdates.addMembers", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Admin.Windows.Updates.DeploymentAudiences.Item.Members.Item.MicrosoftGraphWindowsUpdatesAddMembers.MicrosoftGraphWindowsUpdatesAddMembersRequestBuilder"/> and sets the default values.
        ...
        public MicrosoftGraphWindowsUpdatesAddMembersRequestBuilder(string rawUrl) : base("{+baseurl}/admin/windows/updates/deploymentAudiences/{deploymentAudience%2Did}/members/{updatableAsset%2Did}/microsoft.graph.windowsUpdates.addMembers", rawUrl)
        {
        }
        /// <summary>
        /// Add members to an updatableAssetGroup. You can add azureADDevice resources as members, but may not add updatableAssetGroup resources as members. Adding a Microsoft Entra device as a member of an updatable asset group automatically creates an azureADDevice object, if it does not already exist. You can also use the method addMembersById to add members.
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Admin.Windows.Updates.DeploymentAudiences.Item.Members.Item.MicrosoftGraphWindowsUpdatesAddMembers.AddMembersPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.Admin.Windows.Updates.DeploymentAudiences.Item.Members.Item.MicrosoftGraphWindowsUpdatesAddMembers.AddMembersPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
