...
namespace ApiSdk.Print.PrinterShares.Item.AllowedGroups.Item
{
    ...
    public class GroupItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildRefByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.Print.PrinterShares.Item.AllowedGroups.Item.Ref.RefRequestBuilder(PathParameters);
        ...
        public Command BuildServiceProvisioningErrorsNavCommand()
        {
            ...
            var builder = new ApiSdk.Print.PrinterShares.Item.AllowedGroups.Item.ServiceProvisioningErrors.ServiceProvisioningErrorsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Print.PrinterShares.Item.AllowedGroups.Item.GroupItemRequestBuilder"/> and sets the default values.
        /// </summary>
