...
namespace ApiSdk.Print.Printers.Item.Jobs.Item
{
    ...
    public class PrintJobItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAbortNavCommand()
        {
            ...
            var builder = new ApiSdk.Print.Printers.Item.Jobs.Item.Abort.AbortRequestBuilder(PathParameters);
        ...
        public Command BuildCancelNavCommand()
        {
            ...
            var builder = new ApiSdk.Print.Printers.Item.Jobs.Item.Cancel.CancelRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildCancelPrintJobNavCommand()
        {
            ...
            var builder = new ApiSdk.Print.Printers.Item.Jobs.Item.CancelPrintJob.CancelPrintJobRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDocumentsNavCommand()
        {
            ...
            var builder = new ApiSdk.Print.Printers.Item.Jobs.Item.Documents.DocumentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildRedirectNavCommand()
        {
            ...
            var builder = new ApiSdk.Print.Printers.Item.Jobs.Item.Redirect.RedirectRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildStartNavCommand()
        {
            ...
            var builder = new ApiSdk.Print.Printers.Item.Jobs.Item.Start.StartRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildStartPrintJobNavCommand()
        {
            ...
            var builder = new ApiSdk.Print.Printers.Item.Jobs.Item.StartPrintJob.StartPrintJobRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTasksNavCommand()
        {
            ...
            var builder = new ApiSdk.Print.Printers.Item.Jobs.Item.Tasks.TasksRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Print.Printers.Item.Jobs.Item.PrintJobItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Print.Printers.Item.Jobs.Item.PrintJobItemRequestBuilder.PrintJobItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Print.Printers.Item.Jobs.Item.PrintJobItemRequestBuilder.PrintJobItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
