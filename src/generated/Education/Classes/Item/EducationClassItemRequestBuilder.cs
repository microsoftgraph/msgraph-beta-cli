...
using ApiSdk.Education.Classes.Item.GetRecentlyModifiedSubmissions;
...
namespace ApiSdk.Education.Classes.Item
{
    ...
    public partial class EducationClassItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAssignmentCategoriesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Classes.Item.AssignmentCategories.AssignmentCategoriesRequestBuilder(PathParameters);
        ...
        public Command BuildAssignmentDefaultsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Classes.Item.AssignmentDefaults.AssignmentDefaultsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildAssignmentSettingsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Classes.Item.AssignmentSettings.AssignmentSettingsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildAssignmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Classes.Item.Assignments.AssignmentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildGetRecentlyModifiedSubmissionsNavCommand()
        {
            var command = new Command("get-recently-modified-submissions");
            command.Description = "Provides operations to call the getRecentlyModifiedSubmissions method.";
            var builder = new global::ApiSdk.Education.Classes.Item.GetRecentlyModifiedSubmissions.GetRecentlyModifiedSubmissionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGroupNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Classes.Item.Group.GroupRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildMembersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Classes.Item.Members.MembersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildModulesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Classes.Item.Modules.ModulesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.EducationClass>(global::ApiSdk.Models.EducationClass.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildSchoolsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Classes.Item.Schools.SchoolsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildTeachersNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Education.Classes.Item.Teachers.TeachersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Education.Classes.Item.EducationClassItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Education.Classes.Item.EducationClassItemRequestBuilder.EducationClassItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Education.Classes.Item.EducationClassItemRequestBuilder.EducationClassItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.EducationClass body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.EducationClass body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
