...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class WindowsManagedAppProtection : ApiSdk.Models.ManagedAppPolicy, IParsable
    {
        /// <summary>Data can be transferred from/to these classes of apps</summary>
        public ApiSdk.Models.WindowsManagedAppDataTransferLevel? AllowedInboundDataTransferSources { get; set; }
        /// <summary>Represents the level to which the device&apos;s clipboard may be shared between apps</summary>
        public ApiSdk.Models.WindowsManagedAppClipboardSharingLevel? AllowedOutboundClipboardSharingLevel { get; set; }
        /// <summary>Data can be transferred from/to these classes of apps</summary>
        public ApiSdk.Models.WindowsManagedAppDataTransferLevel? AllowedOutboundDataTransferDestinations { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.WindowsManagedAppProtection"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.WindowsManagedAppProtection"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.WindowsManagedAppProtection CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.WindowsManagedAppProtection();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "allowedInboundDataTransferSources", n => { AllowedInboundDataTransferSources = n.GetEnumValue<ApiSdk.Models.WindowsManagedAppDataTransferLevel>(); } },
                { "allowedOutboundClipboardSharingLevel", n => { AllowedOutboundClipboardSharingLevel = n.GetEnumValue<ApiSdk.Models.WindowsManagedAppClipboardSharingLevel>(); } },
                { "allowedOutboundDataTransferDestinations", n => { AllowedOutboundDataTransferDestinations = n.GetEnumValue<ApiSdk.Models.WindowsManagedAppDataTransferLevel>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.WindowsManagedAppDataTransferLevel>("allowedInboundDataTransferSources", AllowedInboundDataTransferSources);
            writer.WriteEnumValue<ApiSdk.Models.WindowsManagedAppClipboardSharingLevel>("allowedOutboundClipboardSharingLevel", AllowedOutboundClipboardSharingLevel);
            writer.WriteEnumValue<ApiSdk.Models.WindowsManagedAppDataTransferLevel>("allowedOutboundDataTransferDestinations", AllowedOutboundDataTransferDestinations);
