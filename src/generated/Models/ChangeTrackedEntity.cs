...
namespace ApiSdk.Models {
    public class ChangeTrackedEntity : Entity, IParsable {
        ...
        public DateTimeOffset? ChangeTrackedEntityCreatedDateTime { get; private set; }
        /// <summary>Identity of the person who last modified the entity.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public IdentitySet? ChangeTrackedEntityLastModifiedBy { get; private set; }
#nullable restore
#else
        public IdentitySet ChangeTrackedEntityLastModifiedBy { get; private set; }
#endif
        /// <summary>The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z</summary>
        public DateTimeOffset? ChangeTrackedEntityLastModifiedDateTime { get; private set; }
        /// <summary>The Timestamp type represents date and time information using ISO 8601 format and is always in UTC time. For example, midnight UTC on Jan 1, 2014 is 2014-01-01T00:00:00Z</summary>
...
#nullable restore
        ...
        public new IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers()) {
                {"createdDateTime", n => { ChangeTrackedEntityCreatedDateTime = n.GetDateTimeOffsetValue(); } },
                {"lastModifiedBy", n => { ChangeTrackedEntityLastModifiedBy = n.GetObjectValue<IdentitySet>(IdentitySet.CreateFromDiscriminatorValue); } },
                {"lastModifiedDateTime", n => { ChangeTrackedEntityLastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
