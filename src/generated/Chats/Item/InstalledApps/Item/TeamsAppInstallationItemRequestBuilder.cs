...
namespace ApiSdk.Chats.Item.InstalledApps.Item
{
    ...
    public class TeamsAppInstallationItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/chat-delete-installedapps?view=graph-rest-beta" />
        /// </summary>
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/chat-get-installedapps?view=graph-rest-beta" />
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildGetCommand()
        {
            var command = new Command("get");
            command.Description = "Get an app installed in a chat.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/chat-get-installedapps?view=graph-rest-beta";
            var chatIdOption = new Option<string>("--chat-id", description: "The unique identifier of chat") {
            };
            chatIdOption.IsRequired = true;
            command.AddOption(chatIdOption);
        ...
        public Command BuildTeamsAppDefinitionNavCommand()
        {
            ...
            var builder = new ApiSdk.Chats.Item.InstalledApps.Item.TeamsAppDefinition.TeamsAppDefinitionRequestBuilder(PathParameters);
        ...
        public Command BuildTeamsAppNavCommand()
        {
            ...
            var builder = new ApiSdk.Chats.Item.InstalledApps.Item.TeamsApp.TeamsAppRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUpgradeNavCommand()
        {
            ...
            var builder = new ApiSdk.Chats.Item.InstalledApps.Item.Upgrade.UpgradeRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Chats.Item.InstalledApps.Item.TeamsAppInstallationItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Chats.Item.InstalledApps.Item.TeamsAppInstallationItemRequestBuilder.TeamsAppInstallationItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Chats.Item.InstalledApps.Item.TeamsAppInstallationItemRequestBuilder.TeamsAppInstallationItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
