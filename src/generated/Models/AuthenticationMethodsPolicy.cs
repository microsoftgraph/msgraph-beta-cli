...
namespace ApiSdk.Models
{
    ...
    public class AuthenticationMethodsPolicy : ApiSdk.Models.Entity, IParsable
...
#nullable enable
        public List<ApiSdk.Models.AuthenticationMethodConfiguration>? AuthenticationMethodConfigurations { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.AuthenticationMethodConfiguration> AuthenticationMethodConfigurations { get; set; }
#endif
...
#nullable restore
        ...
        public ApiSdk.Models.AuthenticationMethodsPolicyMigrationState? PolicyMigrationState { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.AuthenticationMethodsPolicy"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.AuthenticationMethodsPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.AuthenticationMethodsPolicy();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "authenticationMethodConfigurations", n => { AuthenticationMethodConfigurations = n.GetCollectionOfObjectValues<ApiSdk.Models.AuthenticationMethodConfiguration>(ApiSdk.Models.AuthenticationMethodConfiguration.CreateFromDiscriminatorValue)?.ToList(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "displayName", n => { DisplayName = n.GetStringValue(); } },
                { "lastModifiedDateTime", n => { LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                { "policyMigrationState", n => { PolicyMigrationState = n.GetEnumValue<ApiSdk.Models.AuthenticationMethodsPolicyMigrationState>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.AuthenticationMethodConfiguration>("authenticationMethodConfigurations", AuthenticationMethodConfigurations);
            writer.WriteStringValue("description", Description);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteEnumValue<ApiSdk.Models.AuthenticationMethodsPolicyMigrationState>("policyMigrationState", PolicyMigrationState);
