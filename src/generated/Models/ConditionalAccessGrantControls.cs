...
#nullable enable
        public ApiSdk.Models.AuthenticationStrengthPolicy? AuthenticationStrength { get; set; }
#nullable restore
#else
        public ApiSdk.Models.AuthenticationStrengthPolicy AuthenticationStrength { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.ConditionalAccessGrantControl?>? BuiltInControls { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.ConditionalAccessGrantControl?> BuiltInControls { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.ConditionalAccessGrantControls"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.ConditionalAccessGrantControls"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.ConditionalAccessGrantControls CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.ConditionalAccessGrantControls();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "authenticationStrength", n => { AuthenticationStrength = n.GetObjectValue<ApiSdk.Models.AuthenticationStrengthPolicy>(ApiSdk.Models.AuthenticationStrengthPolicy.CreateFromDiscriminatorValue); } },
                { "builtInControls", n => { BuiltInControls = n.GetCollectionOfEnumValues<ApiSdk.Models.ConditionalAccessGrantControl>()?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.AuthenticationStrengthPolicy>("authenticationStrength", AuthenticationStrength);
            writer.WriteCollectionOfEnumValues<ApiSdk.Models.ConditionalAccessGrantControl>("builtInControls", BuiltInControls);
