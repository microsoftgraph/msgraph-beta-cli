...
using ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.Cancel;
using ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.Resource;
using ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.RoleDefinition;
using ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.Subject;
using ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.UpdateRequest;
...
using System;
namespace ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item
{
    /// <summary>
    ...
    public partial class GovernanceRoleAssignmentRequestItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildCancelNavCommand()
        {
            ...
            var builder = new global::ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.Cancel.CancelRequestBuilder(PathParameters);
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property roleAssignmentRequests for governanceResources";
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property roleAssignmentRequests in governanceResources";
            var governanceResourceIdOption = new Option<string>("--governance-resource-id", description: "The unique identifier of governanceResource") {
            };
            governanceResourceIdOption.IsRequired = true;
            command.AddOption(governanceResourceIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.GovernanceRoleAssignmentRequest>(global::ApiSdk.Models.GovernanceRoleAssignmentRequest.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildResourceNavCommand()
        {
            ...
            var builder = new global::ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.Resource.ResourceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildRoleDefinitionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.RoleDefinition.RoleDefinitionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSubjectNavCommand()
        {
            ...
            var builder = new global::ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.Subject.SubjectRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
        ...
        public Command BuildUpdateRequestNavCommand()
        {
            ...
            var builder = new global::ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.UpdateRequest.UpdateRequestRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.GovernanceRoleAssignmentRequestItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public GovernanceRoleAssignmentRequestItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/governanceResources/{governanceResource%2Did}/roleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.GovernanceRoleAssignmentRequestItemRequestBuilder"/> and sets the default values.
        ...
        public GovernanceRoleAssignmentRequestItemRequestBuilder(string rawUrl) : base("{+baseurl}/governanceResources/{governanceResource%2Did}/roleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property roleAssignmentRequests for governanceResources
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.GovernanceRoleAssignmentRequestItemRequestBuilder.GovernanceRoleAssignmentRequestItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.GovernanceResources.Item.RoleAssignmentRequests.Item.GovernanceRoleAssignmentRequestItemRequestBuilder.GovernanceRoleAssignmentRequestItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.GovernanceRoleAssignmentRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.GovernanceRoleAssignmentRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
