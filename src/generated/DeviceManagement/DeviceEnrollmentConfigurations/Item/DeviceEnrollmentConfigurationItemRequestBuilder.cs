...
namespace ApiSdk.DeviceManagement.DeviceEnrollmentConfigurations.Item
{
    ...
    public class DeviceEnrollmentConfigurationItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAssignmentsNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.DeviceEnrollmentConfigurations.Item.Assignments.AssignmentsRequestBuilder(PathParameters);
        ...
        public Command BuildAssignNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.DeviceEnrollmentConfigurations.Item.Assign.AssignRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSetPriorityNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.DeviceEnrollmentConfigurations.Item.SetPriority.SetPriorityRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceManagement.DeviceEnrollmentConfigurations.Item.DeviceEnrollmentConfigurationItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceManagement.DeviceEnrollmentConfigurations.Item.DeviceEnrollmentConfigurationItemRequestBuilder.DeviceEnrollmentConfigurationItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceManagement.DeviceEnrollmentConfigurations.Item.DeviceEnrollmentConfigurationItemRequestBuilder.DeviceEnrollmentConfigurationItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
