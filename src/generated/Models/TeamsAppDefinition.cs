...
namespace ApiSdk.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public ApiSdk.Models.TeamsAppInstallationScopes? AllowedInstallationScopes { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.TeamsAppIcon? ColorIcon { get; set; }
#nullable restore
#else
        public ApiSdk.Models.TeamsAppIcon ColorIcon { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.TeamsAppDashboardCardDefinition>? DashboardCards { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.TeamsAppDashboardCardDefinition> DashboardCards { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.TeamsAppIcon? OutlineIcon { get; set; }
#nullable restore
#else
        public ApiSdk.Models.TeamsAppIcon OutlineIcon { get; set; }
#endif
...
#nullable restore
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "allowedInstallationScopes", n => { AllowedInstallationScopes = n.GetEnumValue<ApiSdk.Models.TeamsAppInstallationScopes>(); } },
                ...
                { "colorIcon", n => { ColorIcon = n.GetObjectValue<ApiSdk.Models.TeamsAppIcon>(ApiSdk.Models.TeamsAppIcon.CreateFromDiscriminatorValue); } },
                { "createdBy", n => { CreatedBy = n.GetObjectValue<ApiSdk.Models.IdentitySet>(ApiSdk.Models.IdentitySet.CreateFromDiscriminatorValue); } },
                { "dashboardCards", n => { DashboardCards = n.GetCollectionOfObjectValues<ApiSdk.Models.TeamsAppDashboardCardDefinition>(ApiSdk.Models.TeamsAppDashboardCardDefinition.CreateFromDiscriminatorValue)?.ToList(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "displayName", n => { DisplayName = n.GetStringValue(); } },
                { "lastModifiedDateTime", n => { LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                { "outlineIcon", n => { OutlineIcon = n.GetObjectValue<ApiSdk.Models.TeamsAppIcon>(ApiSdk.Models.TeamsAppIcon.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.TeamsAppInstallationScopes>("allowedInstallationScopes", AllowedInstallationScopes);
            ...
            writer.WriteObjectValue<ApiSdk.Models.TeamsAppIcon>("colorIcon", ColorIcon);
            writer.WriteObjectValue<ApiSdk.Models.IdentitySet>("createdBy", CreatedBy);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.TeamsAppDashboardCardDefinition>("dashboardCards", DashboardCards);
            writer.WriteStringValue("description", Description);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteObjectValue<ApiSdk.Models.TeamsAppIcon>("outlineIcon", OutlineIcon);
