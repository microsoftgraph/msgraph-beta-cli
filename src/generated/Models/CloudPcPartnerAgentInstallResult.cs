...
#nullable restore
        ...
        public global::ApiSdk.Models.CloudPcPartnerAgentInstallStatus? InstallStatus { get; set; }
...
#nullable restore
        ...
        public global::ApiSdk.Models.CloudPcPartnerAgentName? PartnerAgentName { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Models.CloudPcPartnerAgentInstallResult"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.CloudPcPartnerAgentInstallResult"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ApiSdk.Models.CloudPcPartnerAgentInstallResult CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.CloudPcPartnerAgentInstallResult();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "installStatus", n => { InstallStatus = n.GetEnumValue<global::ApiSdk.Models.CloudPcPartnerAgentInstallStatus>(); } },
                { "isThirdPartyPartner", n => { IsThirdPartyPartner = n.GetBoolValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "partnerAgentName", n => { PartnerAgentName = n.GetEnumValue<global::ApiSdk.Models.CloudPcPartnerAgentName>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.CloudPcPartnerAgentInstallStatus>("installStatus", InstallStatus);
            writer.WriteBoolValue("isThirdPartyPartner", IsThirdPartyPartner);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteEnumValue<global::ApiSdk.Models.CloudPcPartnerAgentName>("partnerAgentName", PartnerAgentName);
