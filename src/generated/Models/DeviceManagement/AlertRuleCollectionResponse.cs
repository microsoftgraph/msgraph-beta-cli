...
#nullable enable
        public List<AlertRule>? Value { get; set; }
#nullable restore
#else
        public List<AlertRule> Value { get; set; }
#endif
        ...
        public static new AlertRuleCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new AlertRuleCollectionResponse();
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<AlertRule>("value", Value);
        }
    }
}
