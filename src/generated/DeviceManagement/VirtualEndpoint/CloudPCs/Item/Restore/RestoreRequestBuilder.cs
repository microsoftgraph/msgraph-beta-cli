    ...
    public class RestoreRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.Restore.RestorePostRequestBody>(ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.Restore.RestorePostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.Restore.RestoreRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.Restore.RestorePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.DeviceManagement.VirtualEndpoint.CloudPCs.Item.Restore.RestorePostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
