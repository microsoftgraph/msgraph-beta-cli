...
using ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item.GraphAppRoleAssignment;
using ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item.GraphEndpoint;
using ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item.GraphServicePrincipal;
using ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item.GraphUser;
using ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item.Ref;
...
namespace ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item
{
    ...
    public partial class DirectoryObjectItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGraphAppRoleAssignmentByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item.GraphAppRoleAssignment.GraphAppRoleAssignmentRequestBuilder(PathParameters);
        ...
        public Command BuildGraphEndpointByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item.GraphEndpoint.GraphEndpointRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGraphServicePrincipalByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item.GraphServicePrincipal.GraphServicePrincipalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGraphUserByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item.GraphUser.GraphUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildRefByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item.Ref.RefRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.Devices.Item.RegisteredOwners.Item.DirectoryObjectItemRequestBuilder"/> and sets the default values.
        /// </summary>
