...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Searches.Item
{
    ...
    public partial class EdiscoverySearchItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildAdditionalSourcesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Cases.EdiscoveryCases.Item.Searches.Item.AdditionalSources.AdditionalSourcesRequestBuilder(PathParameters);
        ...
        public Command BuildAddToReviewSetOperationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Cases.EdiscoveryCases.Item.Searches.Item.AddToReviewSetOperation.AddToReviewSetOperationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCustodianSourcesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Cases.EdiscoveryCases.Item.Searches.Item.CustodianSources.CustodianSourcesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildLastEstimateStatisticsOperationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Cases.EdiscoveryCases.Item.Searches.Item.LastEstimateStatisticsOperation.LastEstimateStatisticsOperationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMicrosoftGraphSecurityEstimateStatisticsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Cases.EdiscoveryCases.Item.Searches.Item.MicrosoftGraphSecurityEstimateStatistics.MicrosoftGraphSecurityEstimateStatisticsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildMicrosoftGraphSecurityExportReportNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Cases.EdiscoveryCases.Item.Searches.Item.MicrosoftGraphSecurityExportReport.MicrosoftGraphSecurityExportReportRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMicrosoftGraphSecurityExportResultNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Cases.EdiscoveryCases.Item.Searches.Item.MicrosoftGraphSecurityExportResult.MicrosoftGraphSecurityExportResultRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMicrosoftGraphSecurityPurgeDataNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Cases.EdiscoveryCases.Item.Searches.Item.MicrosoftGraphSecurityPurgeData.MicrosoftGraphSecurityPurgeDataRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildNoncustodialSourcesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Cases.EdiscoveryCases.Item.Searches.Item.NoncustodialSources.NoncustodialSourcesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Security.EdiscoverySearch>(global::ApiSdk.Models.Security.EdiscoverySearch.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Security.Cases.EdiscoveryCases.Item.Searches.Item.EdiscoverySearchItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.Cases.EdiscoveryCases.Item.Searches.Item.EdiscoverySearchItemRequestBuilder.EdiscoverySearchItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.Cases.EdiscoveryCases.Item.Searches.Item.EdiscoverySearchItemRequestBuilder.EdiscoverySearchItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Security.EdiscoverySearch body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Security.EdiscoverySearch body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
