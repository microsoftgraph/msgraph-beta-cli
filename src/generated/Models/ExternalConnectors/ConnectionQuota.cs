...
namespace ApiSdk.Models.ExternalConnectors
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.ExternalConnectors.ConnectionQuota"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.ExternalConnectors.ConnectionQuota CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.ExternalConnectors.ConnectionQuota();
        }
        /// <summary>
