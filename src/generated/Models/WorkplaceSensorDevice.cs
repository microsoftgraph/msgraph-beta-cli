...
namespace ApiSdk.Models
{
    ...
    public partial class WorkplaceSensorDevice : global::ApiSdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.WorkplaceSensor>? Sensors { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.WorkplaceSensor> Sensors { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.WorkplaceSensorDevice"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.WorkplaceSensorDevice CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.WorkplaceSensorDevice();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "sensors", n => { Sensors = n.GetCollectionOfObjectValues<global::ApiSdk.Models.WorkplaceSensor>(global::ApiSdk.Models.WorkplaceSensor.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.WorkplaceSensor>("sensors", Sensors);
