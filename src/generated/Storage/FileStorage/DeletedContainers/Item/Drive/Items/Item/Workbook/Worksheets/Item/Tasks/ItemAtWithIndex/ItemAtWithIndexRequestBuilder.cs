...
namespace ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Workbook.Worksheets.Item.Tasks.ItemAtWithIndex
{
    ...
    public class ItemAtWithIndexRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildChangesNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Workbook.Worksheets.Item.Tasks.ItemAtWithIndex.Changes.ChangesRequestBuilder(PathParameters);
        ...
        public Command BuildCommentNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Workbook.Worksheets.Item.Tasks.ItemAtWithIndex.Comment.CommentRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.Items.Item.Workbook.Worksheets.Item.Tasks.ItemAtWithIndex.ItemAtWithIndexRequestBuilder"/> and sets the default values.
        /// </summary>
