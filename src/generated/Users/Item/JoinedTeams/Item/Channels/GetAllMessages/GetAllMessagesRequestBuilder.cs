...
namespace ApiSdk.Users.Item.JoinedTeams.Item.Channels.GetAllMessages {
    ...
    public class GetAllMessagesRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetAllMessagesRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/getAllMessages(){?model*,%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", rawUrl) {
        }
        /// <summary>
        /// Invoke function getAllMessages
        /// </summary>
