...
using System;
namespace ApiSdk.Users.Item.JoinedTeams.Item.PrimaryChannel.RemoveEmail {
    /// <summary>
    ...
    public class RemoveEmailRequestBuilder : BaseCliRequestBuilder {
        ...
        public RemoveEmailRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel/removeEmail", rawUrl) {
        }
        /// <summary>
        /// Remove the email address of a channel. You can remove an email address only if it was provisioned using the provisionEmail method or through the Microsoft Teams client.
        /// </summary>
