...
using ApiSdk.Models;
using ApiSdk.Users.Item.Chats.Item.Tabs.Item.TeamsApp;
...
using System;
namespace ApiSdk.Users.Item.Chats.Item.Tabs.Item {
    /// <summary>
    ...
    public class TeamsTabItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public TeamsTabItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/tabs/{teamsTab%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="TeamsTabItemRequestBuilder"/> and sets the default values.
        ...
        public TeamsTabItemRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/tabs/{teamsTab%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Remove (unpin) a tab from the specified chat. 
