...
using ApiSdk.Communications.OnlineMeetings.GetAllRecordings;
using ApiSdk.Communications.OnlineMeetings.GetAllTranscripts;
...
#nullable restore
        ...
        public RequestInformation ToPostRequestInformation(OnlineMeeting body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/communications/onlineMeetings", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
