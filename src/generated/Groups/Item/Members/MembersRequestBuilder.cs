...
using ApiSdk.Groups.Item.Members.GraphApplication;
using ApiSdk.Groups.Item.Members.GraphDevice;
using ApiSdk.Groups.Item.Members.GraphGroup;
using ApiSdk.Groups.Item.Members.GraphOrgContact;
using ApiSdk.Groups.Item.Members.GraphServicePrincipal;
using ApiSdk.Groups.Item.Members.GraphUser;
...
namespace ApiSdk.Groups.Item.Members
{
    ...
    public partial class MembersRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Members.Item.DirectoryObjectItemRequestBuilder(PathParameters);
        ...
        public Command BuildCountNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Members.Count.CountRequestBuilder(PathParameters);
        ...
        public Command BuildGraphApplicationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Members.GraphApplication.GraphApplicationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGraphDeviceNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Members.GraphDevice.GraphDeviceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildGraphGroupNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Members.GraphGroup.GraphGroupRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildGraphOrgContactNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Members.GraphOrgContact.GraphOrgContactRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildGraphServicePrincipalNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Members.GraphServicePrincipal.GraphServicePrincipalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildGraphUserNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Members.GraphUser.GraphUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildListCommand()
        {
            ...
            command.Description = "Get a list of the group's direct members. A group can have users, contacts, devices, service principals, and other groups as members. This operation isn't transitive.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/group-list-members?view=graph-rest-beta";
...
#nullable restore
        ...
        public Command BuildRefNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Members.Ref.RefRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Members.MembersRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public MembersRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/members{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Members.MembersRequestBuilder"/> and sets the default values.
        ...
        public MembersRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/members{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get a list of the group&apos;s direct members. A group can have users, contacts, devices, service principals, and other groups as members. This operation isn&apos;t transitive.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.Members.MembersRequestBuilder.MembersRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.Members.MembersRequestBuilder.MembersRequestBuilderGetQueryParameters>> requestConfiguration = default)
