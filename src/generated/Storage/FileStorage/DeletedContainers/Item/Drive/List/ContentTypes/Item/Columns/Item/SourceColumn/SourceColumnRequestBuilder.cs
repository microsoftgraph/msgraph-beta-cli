...
using System;
namespace ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.ContentTypes.Item.Columns.Item.SourceColumn
{
    /// <summary>
    ...
    public class SourceColumnRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.ContentTypes.Item.Columns.Item.SourceColumn.SourceColumnRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public SourceColumnRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list/contentTypes/{contentType%2Did}/columns/{columnDefinition%2Did}/sourceColumn{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.ContentTypes.Item.Columns.Item.SourceColumn.SourceColumnRequestBuilder"/> and sets the default values.
        ...
        public SourceColumnRequestBuilder(string rawUrl) : base("{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/drive/list/contentTypes/{contentType%2Did}/columns/{columnDefinition%2Did}/sourceColumn{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// The source column for content type column.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.ContentTypes.Item.Columns.Item.SourceColumn.SourceColumnRequestBuilder.SourceColumnRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Storage.FileStorage.DeletedContainers.Item.Drive.List.ContentTypes.Item.Columns.Item.SourceColumn.SourceColumnRequestBuilder.SourceColumnRequestBuilderGetQueryParameters>> requestConfiguration = default)
