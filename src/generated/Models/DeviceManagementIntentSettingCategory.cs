...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class DeviceManagementIntentSettingCategory : ApiSdk.Models.DeviceManagementSettingCategory, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.DeviceManagementIntentSettingCategory"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.DeviceManagementIntentSettingCategory CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.DeviceManagementIntentSettingCategory();
        }
        /// <summary>
