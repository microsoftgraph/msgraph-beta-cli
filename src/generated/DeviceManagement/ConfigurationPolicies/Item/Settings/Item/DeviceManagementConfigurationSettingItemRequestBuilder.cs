// <auto-generated/>
using ApiSdk.DeviceManagement.ConfigurationPolicies.Item.Settings.Item.SettingDefinitions;
...
using System;
namespace ApiSdk.DeviceManagement.ConfigurationPolicies.Item.Settings.Item
{
    /// <summary>
    ...
    public class DeviceManagementConfigurationSettingItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildSettingDefinitionsNavCommand()
        {
            ...
            var builder = new ApiSdk.DeviceManagement.ConfigurationPolicies.Item.Settings.Item.SettingDefinitions.SettingDefinitionsRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceManagement.ConfigurationPolicies.Item.Settings.Item.DeviceManagementConfigurationSettingItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public DeviceManagementConfigurationSettingItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceManagement/configurationPolicies/{deviceManagementConfigurationPolicy%2Did}/settings/{deviceManagementConfigurationSetting%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceManagement.ConfigurationPolicies.Item.Settings.Item.DeviceManagementConfigurationSettingItemRequestBuilder"/> and sets the default values.
        ...
        public DeviceManagementConfigurationSettingItemRequestBuilder(string rawUrl) : base("{+baseurl}/deviceManagement/configurationPolicies/{deviceManagementConfigurationPolicy%2Did}/settings/{deviceManagementConfigurationSetting%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property settings for deviceManagement
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceManagement.ConfigurationPolicies.Item.Settings.Item.DeviceManagementConfigurationSettingItemRequestBuilder.DeviceManagementConfigurationSettingItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceManagement.ConfigurationPolicies.Item.Settings.Item.DeviceManagementConfigurationSettingItemRequestBuilder.DeviceManagementConfigurationSettingItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
