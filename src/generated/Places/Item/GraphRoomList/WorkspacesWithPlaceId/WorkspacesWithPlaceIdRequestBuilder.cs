...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/places/{place%2Did}/graph.roomList/workspaces(placeId='{placeId}')", PathParameters);
...
#nullable restore
        ...
        public RequestInformation ToPatchRequestInformation(Workspace body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.PATCH, "{+baseurl}/places/{place%2Did}/graph.roomList/workspaces(placeId='{placeId}')", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
        ...
        /// Get workspaces from places
        /// </summary>
        public class WorkspacesWithPlaceIdRequestBuilderGetQueryParameters 
        {
