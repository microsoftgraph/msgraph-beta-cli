...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class DeviceCompliancePolicyState : ApiSdk.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.DeviceCompliancePolicySettingState>? SettingStates { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.DeviceCompliancePolicySettingState> SettingStates { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.DeviceCompliancePolicyState"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.DeviceCompliancePolicyState CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.DeviceCompliancePolicyState();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "settingStates", n => { SettingStates = n.GetCollectionOfObjectValues<ApiSdk.Models.DeviceCompliancePolicySettingState>(ApiSdk.Models.DeviceCompliancePolicySettingState.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.DeviceCompliancePolicySettingState>("settingStates", SettingStates);
