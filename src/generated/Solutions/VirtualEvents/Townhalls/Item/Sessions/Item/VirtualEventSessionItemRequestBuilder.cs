...
namespace ApiSdk.Solutions.VirtualEvents.Townhalls.Item.Sessions.Item
{
    ...
    public class VirtualEventSessionItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAttendanceReportsNavCommand()
        {
            ...
            var builder = new ApiSdk.Solutions.VirtualEvents.Townhalls.Item.Sessions.Item.AttendanceReports.AttendanceReportsRequestBuilder(PathParameters);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.VirtualEventSession>(ApiSdk.Models.VirtualEventSession.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPresentersNavCommand()
        {
            ...
            var builder = new ApiSdk.Solutions.VirtualEvents.Townhalls.Item.Sessions.Item.Presenters.PresentersRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildRegistrationsNavCommand()
        {
            ...
            var builder = new ApiSdk.Solutions.VirtualEvents.Townhalls.Item.Sessions.Item.Registrations.RegistrationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildRegistrationsWithEmailRbCommand()
        {
            ...
            command.Description = "Provides operations to manage the registrations property of the microsoft.graph.virtualEventSession entity.";
            var builder = new ApiSdk.Solutions.VirtualEvents.Townhalls.Item.Sessions.Item.RegistrationsWithEmail.RegistrationsWithEmailRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildRegistrationsWithUserIdRbCommand()
        {
            ...
            command.Description = "Provides operations to manage the registrations property of the microsoft.graph.virtualEventSession entity.";
            var builder = new ApiSdk.Solutions.VirtualEvents.Townhalls.Item.Sessions.Item.RegistrationsWithUserId.RegistrationsWithUserIdRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Solutions.VirtualEvents.Townhalls.Item.Sessions.Item.VirtualEventSessionItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Solutions.VirtualEvents.Townhalls.Item.Sessions.Item.VirtualEventSessionItemRequestBuilder.VirtualEventSessionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Solutions.VirtualEvents.Townhalls.Item.Sessions.Item.VirtualEventSessionItemRequestBuilder.VirtualEventSessionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.VirtualEventSession body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.VirtualEventSession body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
