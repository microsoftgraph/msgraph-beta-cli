...
using ApiSdk.Groups.Item.Sites.Delta;
...
namespace ApiSdk.Groups.Item.Sites
{
    ...
    public partial class SitesRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAddNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Add.AddRequestBuilder(PathParameters);
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.SiteItemRequestBuilder(PathParameters);
            ...
            commands.Add(builder.BuildContentModelsNavCommand());
            commands.Add(builder.BuildContentTypesNavCommand());
            commands.Add(builder.BuildCreatedByUserNavCommand());
            commands.Add(builder.BuildDocumentProcessingJobsNavCommand());
            ...
            commands.Add(builder.BuildPageTemplatesNavCommand());
        ...
        public Command BuildCountNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Count.CountRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildDeltaNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Delta.DeltaRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetAllSitesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.GetAllSites.GetAllSitesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
...
#nullable restore
        ...
        public Command BuildRemoveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Remove.RemoveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.Sites.SitesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.Sites.SitesRequestBuilder.SitesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.Sites.SitesRequestBuilder.SitesRequestBuilderGetQueryParameters>> requestConfiguration = default)
