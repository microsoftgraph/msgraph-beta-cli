...
namespace ApiSdk.Models
{
    ...
    public class AddContentHeaderAction : ApiSdk.Models.InformationProtectionAction, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The alignment property</summary>
        public ApiSdk.Models.ContentAlignment? Alignment { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.AddContentHeaderAction"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.AddContentHeaderAction"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.AddContentHeaderAction CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.AddContentHeaderAction();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "alignment", n => { Alignment = n.GetEnumValue<ApiSdk.Models.ContentAlignment>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.ContentAlignment>("alignment", Alignment);
