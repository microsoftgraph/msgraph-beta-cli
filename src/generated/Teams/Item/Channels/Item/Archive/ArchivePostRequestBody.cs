...
namespace ApiSdk.Teams.Item.Channels.Item.Archive
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Teams.Item.Channels.Item.Archive.ArchivePostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Teams.Item.Channels.Item.Archive.ArchivePostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Teams.Item.Channels.Item.Archive.ArchivePostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Teams.Item.Channels.Item.Archive.ArchivePostRequestBody();
        }
        /// <summary>
