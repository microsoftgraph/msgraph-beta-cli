...
namespace ApiSdk.Users.Item.MailFolders.Item.UserConfigurations {
    ...
    public class UserConfigurationsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public UserConfigurationsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/userConfigurations{?%24count,%24filter,%24orderby,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="UserConfigurationsRequestBuilder"/> and sets the default values.
        ...
        public UserConfigurationsRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/userConfigurations{?%24count,%24filter,%24orderby,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// Get userConfigurations from users
