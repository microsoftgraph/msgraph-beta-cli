...
using ApiSdk.App.OnlineMeetings.Item.AiInsights;
using ApiSdk.App.OnlineMeetings.Item.AlternativeRecording;
using ApiSdk.App.OnlineMeetings.Item.AttendanceReports;
using ApiSdk.App.OnlineMeetings.Item.AttendeeReport;
using ApiSdk.App.OnlineMeetings.Item.BroadcastRecording;
using ApiSdk.App.OnlineMeetings.Item.GetVirtualAppointmentJoinWebUrl;
using ApiSdk.App.OnlineMeetings.Item.MeetingAttendanceReport;
using ApiSdk.App.OnlineMeetings.Item.Recording;
using ApiSdk.App.OnlineMeetings.Item.Recordings;
using ApiSdk.App.OnlineMeetings.Item.Registration;
using ApiSdk.App.OnlineMeetings.Item.SendVirtualAppointmentReminderSms;
using ApiSdk.App.OnlineMeetings.Item.SendVirtualAppointmentSms;
using ApiSdk.App.OnlineMeetings.Item.Transcripts;
...
namespace ApiSdk.App.OnlineMeetings.Item
{
    ...
    public partial class OnlineMeetingItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        /// Provides operations to manage the aiInsights property of the microsoft.graph.onlineMeeting entity.
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildAiInsightsNavCommand()
        {
            var command = new Command("ai-insights");
            command.Description = "Provides operations to manage the aiInsights property of the microsoft.graph.onlineMeeting entity.";
            var builder = new global::ApiSdk.App.OnlineMeetings.Item.AiInsights.AiInsightsRequestBuilder(PathParameters);
        ...
        public Command BuildAlternativeRecordingNavCommand()
        {
            ...
            var builder = new global::ApiSdk.App.OnlineMeetings.Item.AlternativeRecording.AlternativeRecordingRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildAttendanceReportsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.App.OnlineMeetings.Item.AttendanceReports.AttendanceReportsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildAttendeeReportNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the commsApplication entity.";
            var builder = new global::ApiSdk.App.OnlineMeetings.Item.AttendeeReport.AttendeeReportRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        public Command BuildBroadcastRecordingNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the commsApplication entity.";
            var builder = new global::ApiSdk.App.OnlineMeetings.Item.BroadcastRecording.BroadcastRecordingRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        public Command BuildGetVirtualAppointmentJoinWebUrlNavCommand()
        {
            ...
            var builder = new global::ApiSdk.App.OnlineMeetings.Item.GetVirtualAppointmentJoinWebUrl.GetVirtualAppointmentJoinWebUrlRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildMeetingAttendanceReportNavCommand()
        {
            ...
            var builder = new global::ApiSdk.App.OnlineMeetings.Item.MeetingAttendanceReport.MeetingAttendanceReportRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.OnlineMeeting>(global::ApiSdk.Models.OnlineMeeting.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildRecordingNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the media for the commsApplication entity.";
            var builder = new global::ApiSdk.App.OnlineMeetings.Item.Recording.RecordingRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPutCommand());
        ...
        public Command BuildRecordingsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.App.OnlineMeetings.Item.Recordings.RecordingsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildRegistrationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.App.OnlineMeetings.Item.Registration.RegistrationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildSendVirtualAppointmentReminderSmsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.App.OnlineMeetings.Item.SendVirtualAppointmentReminderSms.SendVirtualAppointmentReminderSmsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSendVirtualAppointmentSmsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.App.OnlineMeetings.Item.SendVirtualAppointmentSms.SendVirtualAppointmentSmsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTranscriptsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.App.OnlineMeetings.Item.Transcripts.TranscriptsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.App.OnlineMeetings.Item.OnlineMeetingItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public OnlineMeetingItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.App.OnlineMeetings.Item.OnlineMeetingItemRequestBuilder"/> and sets the default values.
        ...
        public OnlineMeetingItemRequestBuilder(string rawUrl) : base("{+baseurl}/app/onlineMeetings/{onlineMeeting%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property onlineMeetings for app
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.App.OnlineMeetings.Item.OnlineMeetingItemRequestBuilder.OnlineMeetingItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.App.OnlineMeetings.Item.OnlineMeetingItemRequestBuilder.OnlineMeetingItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.OnlineMeeting body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.OnlineMeeting body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
