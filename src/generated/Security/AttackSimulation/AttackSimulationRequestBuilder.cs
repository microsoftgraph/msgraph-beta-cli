...
using ApiSdk.Models;
using ApiSdk.Security.AttackSimulation.EndUserNotifications;
using ApiSdk.Security.AttackSimulation.LandingPages;
using ApiSdk.Security.AttackSimulation.LoginPages;
using ApiSdk.Security.AttackSimulation.Operations;
using ApiSdk.Security.AttackSimulation.Payloads;
using ApiSdk.Security.AttackSimulation.SimulationAutomations;
using ApiSdk.Security.AttackSimulation.Simulations;
using ApiSdk.Security.AttackSimulation.TrainingCampaigns;
using ApiSdk.Security.AttackSimulation.Trainings;
...
namespace ApiSdk.Security.AttackSimulation
{
    ...
    public partial class AttackSimulationRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildEndUserNotificationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.AttackSimulation.EndUserNotifications.EndUserNotificationsRequestBuilder(PathParameters);
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Provides tenants capability to launch a simulated and realistic phishing attack and learn from it.";
        ...
        public Command BuildLandingPagesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.AttackSimulation.LandingPages.LandingPagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildLoginPagesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.AttackSimulation.LoginPages.LoginPagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildOperationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.AttackSimulation.Operations.OperationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.AttackSimulationRoot>(global::ApiSdk.Models.AttackSimulationRoot.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPayloadsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.AttackSimulation.Payloads.PayloadsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildSimulationAutomationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.AttackSimulation.SimulationAutomations.SimulationAutomationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildSimulationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.AttackSimulation.Simulations.SimulationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildTrainingCampaignsNavCommand()
        {
            var command = new Command("training-campaigns");
            command.Description = "Provides operations to manage the trainingCampaigns property of the microsoft.graph.attackSimulationRoot entity.";
            var builder = new global::ApiSdk.Security.AttackSimulation.TrainingCampaigns.TrainingCampaignsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildTrainingsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.AttackSimulation.Trainings.TrainingsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Security.AttackSimulation.AttackSimulationRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.AttackSimulation.AttackSimulationRequestBuilder.AttackSimulationRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.AttackSimulation.AttackSimulationRequestBuilder.AttackSimulationRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.AttackSimulationRoot body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.AttackSimulationRoot body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
