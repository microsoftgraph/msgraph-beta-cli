...
namespace ApiSdk.RoleManagement.EnterpriseApps.Item.ResourceNamespaces.Item {
    ...
    public class UnifiedRbacResourceNamespaceItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildImportResourceActionsNavCommand()
        {
            ...
            var builder = new ImportResourceActionsRequestBuilder(PathParameters);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<UnifiedRbacResourceNamespace>(UnifiedRbacResourceNamespace.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildResourceActionsNavCommand()
        {
            ...
            var builder = new ResourceActionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}", PathParameters);
...
#nullable restore
        ...
        public RequestInformation ToPatchRequestInformation(UnifiedRbacResourceNamespace body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.PATCH, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
