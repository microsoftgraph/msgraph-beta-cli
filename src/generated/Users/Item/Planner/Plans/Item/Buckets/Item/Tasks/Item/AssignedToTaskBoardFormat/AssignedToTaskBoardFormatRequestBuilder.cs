...
namespace ApiSdk.Users.Item.Planner.Plans.Item.Buckets.Item.Tasks.Item.AssignedToTaskBoardFormat {
    ...
    public class AssignedToTaskBoardFormatRequestBuilder : BaseCliRequestBuilder {
        ...
        public AssignedToTaskBoardFormatRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}/assignedToTaskBoardFormat{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property assignedToTaskBoardFormat for users
        /// </summary>
