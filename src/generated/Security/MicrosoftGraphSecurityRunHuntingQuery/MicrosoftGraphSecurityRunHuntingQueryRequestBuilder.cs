    ...
    public class MicrosoftGraphSecurityRunHuntingQueryRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Security.MicrosoftGraphSecurityRunHuntingQuery.RunHuntingQueryPostRequestBody>(ApiSdk.Security.MicrosoftGraphSecurityRunHuntingQuery.RunHuntingQueryPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Security.MicrosoftGraphSecurityRunHuntingQuery.MicrosoftGraphSecurityRunHuntingQueryRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Security.MicrosoftGraphSecurityRunHuntingQuery.RunHuntingQueryPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Security.MicrosoftGraphSecurityRunHuntingQuery.RunHuntingQueryPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
