...
namespace ApiSdk.Users.Item.JoinedTeams.Item.AllChannels {
    ...
    public class AllChannelsRequestBuilder : BaseCliRequestBuilder {
        ...
        public AllChannelsRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/allChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get the list of channels either in this team or shared with this team (incoming channels).
        /// </summary>
