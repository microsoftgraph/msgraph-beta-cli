using ApiSdk.DeviceManagement.DeviceEnrollmentConfigurations.Count;
...
namespace ApiSdk.DeviceManagement.DeviceEnrollmentConfigurations {
    ...
    /// </summary>
    public class DeviceEnrollmentConfigurationsRequestBuilder : BaseCliRequestBuilder {
        /// <summary>
        /// Provides operations to manage the deviceEnrollmentConfigurations property of the microsoft.graph.deviceManagement entity.
        /// </summary>
        public Tuple<List<Command>, List<Command>> BuildCommand() {
            ...
            commands.Add(builder.BuildSetPriorityNavCommand());
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/intune-onboarding-deviceenrollmentwindowshelloforbusinessconfiguration-create?view=graph-rest-1.0" />
        /// </summary>
        public Command BuildCreateCommand() {
            var command = new Command("create");
            command.Description = "Create a new deviceEnrollmentWindowsHelloForBusinessConfiguration object.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/intune-onboarding-deviceenrollmentwindowshelloforbusinessconfiguration-create?view=graph-rest-1.0";
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/intune-onboarding-deviceenrollmentlimitconfiguration-list?view=graph-rest-1.0" />
        /// </summary>
        public Command BuildListCommand() {
            var command = new Command("list");
            command.Description = "List properties and relationships of the deviceEnrollmentLimitConfiguration objects.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/intune-onboarding-deviceenrollmentlimitconfiguration-list?view=graph-rest-1.0";
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<DeviceEnrollmentConfigurationsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<DeviceEnrollmentConfigurationsRequestBuilderGetQueryParameters>();
