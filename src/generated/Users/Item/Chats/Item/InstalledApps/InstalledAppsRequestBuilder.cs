...
using ApiSdk.Models;
using ApiSdk.Users.Item.Chats.Item.InstalledApps.Count;
using ApiSdk.Users.Item.Chats.Item.InstalledApps.Item;
...
using System;
namespace ApiSdk.Users.Item.Chats.Item.InstalledApps {
    /// <summary>
    ...
    public class InstalledAppsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public InstalledAppsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/installedApps{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="InstalledAppsRequestBuilder"/> and sets the default values.
        ...
        public InstalledAppsRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/installedApps{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl)
        {
        }
        /// <summary>
        /// List all app installations within a chat. If the chat is associated with an onlineMeeting instance, then, effectively, the teamsApps installed in the meeting will be listed.
