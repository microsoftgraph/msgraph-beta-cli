...
using ApiSdk.DirectoryNamespace.AuthenticationMethodDevices.HardwareOathDevices.Item.AssignTo;
...
using System;
namespace ApiSdk.DirectoryNamespace.AuthenticationMethodDevices.HardwareOathDevices.Item
{
    /// <summary>
    ...
    public partial class HardwareOathTokenAuthenticationMethodDeviceItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAssignToNavCommand()
        {
            ...
            var builder = new global::ApiSdk.DirectoryNamespace.AuthenticationMethodDevices.HardwareOathDevices.Item.AssignTo.AssignToRequestBuilder(PathParameters);
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Read the properties and relationships of a hardwareOathTokenAuthenticationMethodDevice object.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/hardwareoathtokenauthenticationmethoddevice-get?view=graph-rest-beta";
            var hardwareOathTokenAuthenticationMethodDeviceIdOption = new Option<string>("--hardware-oath-token-authentication-method-device-id", description: "The unique identifier of hardwareOathTokenAuthenticationMethodDevice") {
            };
            hardwareOathTokenAuthenticationMethodDeviceIdOption.IsRequired = true;
            command.AddOption(hardwareOathTokenAuthenticationMethodDeviceIdOption);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the properties of a hardwareOathTokenAuthenticationMethodDevice object. The token needs to unassigned.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/hardwareoathtokenauthenticationmethoddevice-update?view=graph-rest-beta";
            var hardwareOathTokenAuthenticationMethodDeviceIdOption = new Option<string>("--hardware-oath-token-authentication-method-device-id", description: "The unique identifier of hardwareOathTokenAuthenticationMethodDevice") {
            };
            hardwareOathTokenAuthenticationMethodDeviceIdOption.IsRequired = true;
            command.AddOption(hardwareOathTokenAuthenticationMethodDeviceIdOption);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.DirectoryNamespace.AuthenticationMethodDevices.HardwareOathDevices.Item.HardwareOathTokenAuthenticationMethodDeviceItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public HardwareOathTokenAuthenticationMethodDeviceItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/directory/authenticationMethodDevices/hardwareOathDevices/{hardwareOathTokenAuthenticationMethodDevice%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.DirectoryNamespace.AuthenticationMethodDevices.HardwareOathDevices.Item.HardwareOathTokenAuthenticationMethodDeviceItemRequestBuilder"/> and sets the default values.
        ...
        public HardwareOathTokenAuthenticationMethodDeviceItemRequestBuilder(string rawUrl) : base("{+baseurl}/directory/authenticationMethodDevices/hardwareOathDevices/{hardwareOathTokenAuthenticationMethodDevice%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete a Hardware OATH token. Token needs to be unassigned.
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DirectoryNamespace.AuthenticationMethodDevices.HardwareOathDevices.Item.HardwareOathTokenAuthenticationMethodDeviceItemRequestBuilder.HardwareOathTokenAuthenticationMethodDeviceItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.DirectoryNamespace.AuthenticationMethodDevices.HardwareOathDevices.Item.HardwareOathTokenAuthenticationMethodDeviceItemRequestBuilder.HardwareOathTokenAuthenticationMethodDeviceItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
