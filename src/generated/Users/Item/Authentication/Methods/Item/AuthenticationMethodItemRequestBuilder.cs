...
namespace ApiSdk.Users.Item.Authentication.Methods.Item
{
    ...
    public class AuthenticationMethodItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDisableSmsSignInNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Authentication.Methods.Item.DisableSmsSignIn.DisableSmsSignInRequestBuilder(PathParameters);
        ...
        public Command BuildEnableSmsSignInNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Authentication.Methods.Item.EnableSmsSignIn.EnableSmsSignInRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildResetPasswordNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Authentication.Methods.Item.ResetPassword.ResetPasswordRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Users.Item.Authentication.Methods.Item.AuthenticationMethodItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.Authentication.Methods.Item.AuthenticationMethodItemRequestBuilder.AuthenticationMethodItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.Authentication.Methods.Item.AuthenticationMethodItemRequestBuilder.AuthenticationMethodItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.AuthenticationMethod body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.AuthenticationMethod body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
