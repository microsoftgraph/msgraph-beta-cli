...
namespace ApiSdk.Security.ThreatIntelligence.WhoisRecords.Item
{
    ...
    public class WhoisRecordItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildHistoryNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.ThreatIntelligence.WhoisRecords.Item.History.HistoryRequestBuilder(PathParameters);
        ...
        public Command BuildHostNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.ThreatIntelligence.WhoisRecords.Item.Host.HostRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Security.ThreatIntelligence.WhoisRecords.Item.WhoisRecordItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.ThreatIntelligence.WhoisRecords.Item.WhoisRecordItemRequestBuilder.WhoisRecordItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.ThreatIntelligence.WhoisRecords.Item.WhoisRecordItemRequestBuilder.WhoisRecordItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Security.WhoisRecord body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Security.WhoisRecord body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
