...
using ApiSdk.Models;
using ApiSdk.Sites.Item.Lists.Item.Activities;
...
using ApiSdk.Sites.Item.Lists.Item.Permissions;
...
namespace ApiSdk.Sites.Item.Lists.Item
{
    ...
    public partial class ListItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildActivitiesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.Activities.ActivitiesRequestBuilder(PathParameters);
        ...
        public Command BuildColumnsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.Columns.ColumnsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildContentTypesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.ContentTypes.ContentTypesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildCreatedByUserNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.CreatedByUser.CreatedByUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildDriveNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.Drive.DriveRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// Find more info here <see href="https://learn.microsoft.com/graph/api/list-get?view=graph-rest-beta" />
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildGetCommand()
        {
            var command = new Command("get");
            command.Description = "Return the metadata for a list.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/list-get?view=graph-rest-beta";
            var siteIdOption = new Option<string>("--site-id", description: "The unique identifier of site") {
            };
            siteIdOption.IsRequired = true;
            command.AddOption(siteIdOption);
        ...
        public Command BuildItemsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.Items.ItemsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildLastModifiedByUserNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.LastModifiedByUser.LastModifiedByUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            nonExecCommands.Add(builder.BuildMailboxSettingsNavCommand());
        ...
        public Command BuildOperationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.Operations.OperationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.List>(global::ApiSdk.Models.List.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildPermissionsNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the permissions property of the microsoft.graph.list entity.";
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.Permissions.PermissionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildSubscriptionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.Lists.Item.Subscriptions.SubscriptionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Sites.Item.Lists.Item.ListItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/lists/{list%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Sites.Item.Lists.Item.ListItemRequestBuilder"/> and sets the default values.
        ...
        public ListItemRequestBuilder(string rawUrl) : base("{+baseurl}/sites/{site%2Did}/lists/{list%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property lists for sites
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Sites.Item.Lists.Item.ListItemRequestBuilder.ListItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Sites.Item.Lists.Item.ListItemRequestBuilder.ListItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.List body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.List body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
