...
namespace ApiSdk.DeviceAppManagement.MobileAppConfigurations {
    ...
    public class MobileAppConfigurationsRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new ManagedDeviceMobileAppConfigurationItemRequestBuilder(PathParameters);
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<MobileAppConfigurationsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<MobileAppConfigurationsRequestBuilderGetQueryParameters>> requestConfiguration = default)
