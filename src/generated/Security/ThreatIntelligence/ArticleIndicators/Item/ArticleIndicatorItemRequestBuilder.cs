...
namespace ApiSdk.Security.ThreatIntelligence.ArticleIndicators.Item
{
    ...
    public class ArticleIndicatorItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildArtifactNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.ThreatIntelligence.ArticleIndicators.Item.Artifact.ArtifactRequestBuilder(PathParameters);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.Security.ArticleIndicator>(ApiSdk.Models.Security.ArticleIndicator.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Security.ThreatIntelligence.ArticleIndicators.Item.ArticleIndicatorItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.ThreatIntelligence.ArticleIndicators.Item.ArticleIndicatorItemRequestBuilder.ArticleIndicatorItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.ThreatIntelligence.ArticleIndicators.Item.ArticleIndicatorItemRequestBuilder.ArticleIndicatorItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Security.ArticleIndicator body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Security.ArticleIndicator body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
