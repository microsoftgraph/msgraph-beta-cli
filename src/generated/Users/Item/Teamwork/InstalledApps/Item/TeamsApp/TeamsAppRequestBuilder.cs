...
namespace ApiSdk.Users.Item.Teamwork.InstalledApps.Item.TeamsApp {
    ...
    public class TeamsAppRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public TeamsAppRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/teamwork/installedApps/{userScopeTeamsAppInstallation%2Did}/teamsApp{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="TeamsAppRequestBuilder"/> and sets the default values.
        ...
        public TeamsAppRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/teamwork/installedApps/{userScopeTeamsAppInstallation%2Did}/teamsApp{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// The app that is installed.
