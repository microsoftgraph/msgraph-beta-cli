...
using System;
namespace ApiSdk.Groups.Item.Onenote.Operations.Item {
    /// <summary>
    ...
    public class OnenoteOperationItemRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public OnenoteOperationItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/onenote/operations/{onenoteOperation%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="OnenoteOperationItemRequestBuilder"/> and sets the default values.
        ...
        public OnenoteOperationItemRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/onenote/operations/{onenoteOperation%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property operations for groups
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.DELETE, "{+baseurl}/groups/{group%2Did}/onenote/operations/{onenoteOperation%2Did}", PathParameters);
...
#nullable restore
        ...
        public RequestInformation ToPatchRequestInformation(OnenoteOperation body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        {
            ...
            var requestInfo = new RequestInformation(Method.PATCH, "{+baseurl}/groups/{group%2Did}/onenote/operations/{onenoteOperation%2Did}", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
            return requestInfo;
        }
