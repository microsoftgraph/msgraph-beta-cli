...
namespace ApiSdk.Shares.Item.Items.Item.Content {
    ...
    public class ContentRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get content for the navigation property items from shares";
        ...
        public Command BuildPutCommand()
        {
            ...
            command.Description = "Update content for the navigation property items in shares";
            var sharedDriveItemIdOption = new Option<string>("--shared-drive-item-id", description: "The unique identifier of sharedDriveItem") {
            };
            sharedDriveItemIdOption.IsRequired = true;
            command.AddOption(sharedDriveItemIdOption);
