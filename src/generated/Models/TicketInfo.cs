...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.TicketInfo"/> and sets the default values.
        /// </summary>
        public TicketInfo()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.TicketInfo"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.TicketInfo CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.TicketInfo();
        }
        /// <summary>
