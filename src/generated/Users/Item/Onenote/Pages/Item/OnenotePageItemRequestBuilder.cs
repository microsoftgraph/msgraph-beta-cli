...
namespace ApiSdk.Users.Item.Onenote.Pages.Item
{
    ...
    public partial class OnenotePageItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildContentNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Onenote.Pages.Item.Content.ContentRequestBuilder(PathParameters);
        ...
        public Command BuildCopyToSectionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Onenote.Pages.Item.CopyToSection.CopyToSectionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildOnenotePatchContentNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Onenote.Pages.Item.OnenotePatchContent.OnenotePatchContentRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildParentNotebookNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Onenote.Pages.Item.ParentNotebook.ParentNotebookRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildParentSectionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Onenote.Pages.Item.ParentSection.ParentSectionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPreviewNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Users.Item.Onenote.Pages.Item.Preview.PreviewRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Users.Item.Onenote.Pages.Item.OnenotePageItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.Onenote.Pages.Item.OnenotePageItemRequestBuilder.OnenotePageItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Users.Item.Onenote.Pages.Item.OnenotePageItemRequestBuilder.OnenotePageItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
