...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.DeviceManagement.ConfigurationPolicies.Item.Assign.AssignPostResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.DeviceManagement.ConfigurationPolicies.Item.Assign.AssignPostResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.DeviceManagement.ConfigurationPolicies.Item.Assign.AssignPostResponse();
        }
        /// <summary>
